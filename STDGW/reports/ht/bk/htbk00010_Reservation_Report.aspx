...
<%
    ...
    DataTable dtDTL = ESysLib.TableReadOpenCursor("crm.sp_sel_htbk00010_rpt", l_parameter);
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2010-11-27T00:41:30Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=653 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td colspan=3 class=xl24>Ms.<%=dtDTL.Rows[0][20]%></td>
  <td>To:</td>
  <td colspan=3 class=xl24><%=dtDTL.Rows[0][8]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=8 height=17 class=xl24 style='height:12.75pt'>Dear&nbsp;&nbsp;<%=dtDTL.Rows[0][8]%>,</td>
 </tr>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl27>Arrive</td>
  <td class=xl27>Depart</td>
 ...
 <%
     for (int i = 0; i < dtDTL.Rows.Count; i++)
     {
          %>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl28 style='height:12.75pt'><%=dtDTL.Rows[i][0]%></td>
  <td class=xl29><%=dtDTL.Rows[i][1]%></td>
  <td class=xl29 align=right x:num><%=dtDTL.Rows[i][2]%></td>
  <td class=xl29><%=dtDTL.Rows[i][3]%></td>
  <td class=xl29><%=dtDTL.Rows[i][4]%></td>
  <td class=xl29 align=right x:num><%=dtDTL.Rows[0][5]%></td>
  <td class=xl29 align=right x:num><%=dtDTL.Rows[i][6]%></td>
  <td class=xl29>&nbsp;</td>
 </tr>
 <%
	}
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td colspan=7 class=xl24><%=dtDTL.Rows[0][13]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 style='height:12.75pt'>Payment</td>
  <td colspan=7 class=xl24><%=dtDTL.Rows[0][14]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td colspan=7 style='mso-ignore:colspan' x:num><%=dtDTL.Rows[0][15]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 style='height:12.75pt'>Credit Card Type :</td>
  <td colspan=7 class=xl24><%=dtDTL.Rows[0][16]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl31 style='height:12.75pt'>Credit Card Number:</td>
  <td colspan=7 class=xl38 x:num><%=dtDTL.Rows[0][17]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 style='height:12.75pt'>Expiry Date :</td>
  <td colspan=7 class=xl39 x:str><%=dtDTL.Rows[0][18]%></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=3 height=17 class=xl24 style='height:12.75pt'>Sales &amp; Marketing
  Department</td>
