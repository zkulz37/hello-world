...
<%
   ...
   string  l_tht_room_allocate_pk= Request.QueryString["p_tht_room_allocate_pk"];
	...
	string l_dtfrom= Request.QueryString["p_dtfrom"];
	string  l_dtto= Request.QueryString["p_dtto"];
	string l_parameter = "'" +  l_tht_room_allocate_pk + "','" + l_cashier_pk + "','" +l_dtfrom + "','" +  l_dtto + "'";
	string l_parameter_1= "'888','" + l_cashier_pk + "','" +l_dtfrom + "','" +  l_dtto + "'";
	
    DataTable dtHotel,dtGolf;
    dtHotel = ESysLib.TableReadOpenCursor("crm.sp_rpt_htfo00100_hotel",l_parameter);
    dtGolf = ESysLib.TableReadOpenCursor("crm.sp_rpt_htfo00100_golf_send",l_parameter);
...
<link rel=File-List href="rpt_htfo00100_print_Hotel_Golf_files/filelist.xml">
<link rel=Edit-Time-Data
href="rpt_htfo00100_print_Hotel_Golf_files/editdata.mso">
<link rel=OLE-Object-Data
href="rpt_htfo00100_print_Hotel_Golf_files/oledata.mso">
<!--[if !mso]>
<style>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2072 style='border-collapse:
 ...
 <tr height=31 style='height:23.25pt'>
  ...
  valign=top><!--[if gte vml 1]><v:shapetype id="_x0000_t75" coordsize="21600,21600"
   ...
   <v:imagedata src="rpt_htfo00100_print_Hotel_Golf_files/image001.jpg"
    o:title="logo"/>
  ...
  src="rpt_htfo00100_print_Hotel_Golf_files/image002.jpg" v:shapes="_x0000_s1026"></span><![endif]><span
  ...
  <td width=41 style='width:31pt' align=left valign=top><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="rpt_htfo00100_print_Hotel_Golf_files/image003.jpg"
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    ...
    src="rpt_htfo00100_print_Hotel_Golf_files/image005.jpg" v:shapes="_x0000_s1030"></td>
   </tr>
   <tr>
    <td height=28></td>
    <td></td>
    <td align=left valign=top><img width=86 height=28
    src="rpt_htfo00100_print_Hotel_Golf_files/image006.jpg" v:shapes="_x0000_s1031"></td>
   </tr>
   <tr>
    <td height=5></td>
   </tr>
...
%>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td colspan=2 class=xl70 style='border-right:1.0pt solid black' x:num><%=dtHotel.Rows[0][20]%></td>
  <td colspan=24 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
