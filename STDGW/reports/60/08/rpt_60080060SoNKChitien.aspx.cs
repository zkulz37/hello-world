...
public partial class rpt_60080060SoNKChitien : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

         ESysLib.SetUser(Session["APP_DBUSER"].ToString());      
        string TemplateFile = "rpt_60080060SoNKChitien.xls";
        string TempFile = "../../../system/temp/rpt_60080060SoNKChitien_" + Session["User_ID"].ToString() + ".xls";
		...
		//Response.Write(para);
		// Response.End();
		DataTable dt = ESysLib.TableReadOpenCursor("ac_rpt_60080060_nkchitien",para);
