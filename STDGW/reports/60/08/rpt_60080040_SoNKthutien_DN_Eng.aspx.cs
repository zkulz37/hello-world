...
public partial class rpt_60080040_SoNKthutien_DN_Eng : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

        ESysLib.SetUser(Session["APP_DBUSER"].ToString());  
        string TemplateFile = "rpt_60080040_SoNKthutien_DN_Eng.xls";
        string TempFile = "../../../system/temp/rpt_60080040_SoNKthutien_DN_Eng_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt = ESysLib.TableReadOpenCursor("AC_sp_rpt_60080040_NKthu_Viet",para);
        ...
        "    WHERE PK = '"+p_company_pk+"' " ;
			...
			exSheet.Cells[5,1].Value = "From date : "+p_dt_from+" To "+p_dt_to;
			exSheet.Cells[15,6].Value = dt.Rows[0]["todate_Eng"].ToString(); 
