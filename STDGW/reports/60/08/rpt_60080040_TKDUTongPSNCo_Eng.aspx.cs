...
public partial class rpt_60080040_TKDUTongPSNCo_Eng : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

         ESysLib.SetUser(Session["APP_DBUSER"].ToString());
        string TemplateFile = "rpt_60080040_TKDUTongPSNCo_Eng.xls";
        string TempFile = "../../../system/temp/rpt_60080040_TKDUTongPSNCo_Eng_" + Session["User_ID"].ToString() + ".xls";
		...
		// Response.Write(para);
		// Response.End();	
		DataTable dt = ESysLib.TableReadOpenCursor("AC_rpt_60080040_TKDUTPSN",para);
		...
		//	p_dt_to = dt.Rows[0]["dt_to"].ToString();
			...
			//exSheet.Cells[1,1].WrapText = true;
			//exSheet.Range[1,1,1,1].Autofit();
			//exSheet.Cells[1,1].Autofit();
			...
			//exSheet.Cells[11,5].Value = dt.Rows[0]["debitbookamount"].ToString()	; 
