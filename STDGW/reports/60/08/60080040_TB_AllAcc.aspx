...
<%
   ...
   // string p_xls_ccy_format = "";
	...
	if (p_report_type=="2")
	{
        ...
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_OP*" + p_rate + ",DR_OP/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_OP*" + p_rate + ",CR_OP/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_PS*" + p_rate + ",DR_PS/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_PS*" + p_rate + ",CR_PS/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_ACC*" + p_rate + ",DR_ACC/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_ACC, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_ACC*" + p_rate + ",CR_ACC/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_ACC, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_BL*" + p_rate + ",DR_BL/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_BL, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_BL*" + p_rate + ",CR_BL/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_BL, " +
        ...
        SQL_SUM = "SELECT 1,                  TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_OP)*" + p_rate + ",SUM(DR_OP)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_OP)*" + p_rate + ",SUM(CR_OP)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_PS)*" + p_rate + ",SUM(DR_PS)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_PS)*" + p_rate + ",SUM(CR_PS)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_ACC)*" + p_rate + ",SUM(DR_ACC)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_ACC, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_ACC)*" + p_rate + ",SUM(CR_ACC)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_ACC, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_BL)*" + p_rate + ",SUM(DR_BL)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_BL, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_BL)*" + p_rate + ",SUM(CR_BL)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_BL " +
    ...
    else
    {
        ...
        //SQL= "SELECT '',PK, (DECODE (bold_yn, 'B', '<b>', 'I', '<i>', '')|| LPAD(ac_cd, 6 + (ac_level - 1)*12, '&' || 'nbsp;&'||'nbsp;')|| DECODE (bold_yn, 'B', '</b>', 'I', '</i></span>', '')) AC_CD, AC_NM_V, AC_NM_E, AC_NM_K, AC_LEVEL,             TRIM(TO_CHAR(DECODE('"+p_ccy+"','VND',DR_OP*"+p_rate+",DR_OP/"+p_rate+"),DECODE('"+p_ccy+"','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_OP, " +
        SQL = "SELECT '',PK, (DECODE (bold_yn, 'B', '<b>', 'I', '<i>', '')|| ac_cd|| DECODE (bold_yn, 'B', '</b>', 'I', '</i></span>', '')) AC_CD, AC_NM_V, AC_NM_E, AC_NM_K, AC_LEVEL,             TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_OP*" + p_rate + ",DR_OP/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_OP*" + p_rate + ",CR_OP/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_PS*" + p_rate + ",DR_PS/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',CR_PS*" + p_rate + ",CR_PS/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',DR_ACC*" + p_rate + ",DR_ACC/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_ACC, " +
       ...
       "                              AND A.AC_LEVEL = B.PRN_LEVEL(+) " +
        ...
        SQL_SUM = "SELECT 1, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_OP)*" + p_rate + ",SUM(DR_OP)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_OP)*" + p_rate + ",SUM(CR_OP)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_OP, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_PS)*" + p_rate + ",SUM(DR_PS)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(CR_PS)*" + p_rate + ",SUM(CR_PS)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) CR_PS, " +
        "                 TRIM(TO_CHAR(DECODE('" + p_ccy + "','VND',SUM(DR_ACC)*" + p_rate + ",SUM(DR_ACC)/" + p_rate + "),DECODE('" + p_ccy + "','VND',ac_SF_GET_FORMAT('ACBG0040'),'9,999,999,999,990.99'))) DR_ACC, " +
    ...
    //Response.End(); 
    DataTable dt_detail = ESysLib.TableReadOpenCursor("ac_sel_60080040_1", l_parameter);
  ...
  <%
    ...
    //{
		for(i=1;i<dt_detail.Rows.Count;i++)
		{
            ...
            _color = dt_detail.Rows[i][20].ToString();
            _class = "#" + _color.Substring(6,2) + _color.Substring(4,2) + _color.Substring(2,2);
