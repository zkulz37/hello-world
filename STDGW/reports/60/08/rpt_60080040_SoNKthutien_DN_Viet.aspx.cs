...
public partial class rpt_60080040_SoNKthutien_DN_Viet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

          ESysLib.SetUser(Session["APP_DBUSER"].ToString());  
        string TemplateFile = "rpt_60080040_SoNKthutien_DN_Viet.xls";
        string TempFile = "../../../system/temp/rpt_60080040_SoNKthutien_DN_Viet_" + Session["User_ID"].ToString() + ".xls";
