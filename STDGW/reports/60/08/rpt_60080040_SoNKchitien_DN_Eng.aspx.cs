...
public partial class rpt_60080040_SoNKchitien_DN_Eng : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

               ESysLib.SetUser(Session["APP_DBUSER"].ToString());   
        string TemplateFile = "rpt_60080040_SoNKchitien_DN_Eng.xls";
        string TempFile = "../../../system/temp/rpt_60080040_SoNKchitien_DN_Eng_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt = ESysLib.TableReadOpenCursor("AC_rpt_60080040_NKChitien",para);
