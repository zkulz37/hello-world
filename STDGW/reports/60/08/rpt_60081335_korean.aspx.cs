...
public partial class rpt_60081335_korean : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60081335_korean.xls";
        string TempFile = "../../../system/temp/rpt_60081335_korean_" + Session["User_ID"].ToString() + ".xls";
       ...
       for (int l_addrow = 1; l_addrow < dt.Rows.Count ; l_addrow++)
		...
		for (int i = 0; i < dt.Rows.Count;i++)
        {
			...
			exSheet.Cells[8 + i, 1].Value = dt.Rows[i]["prn_kacnm"].ToString();
			...
			if (dt.Rows[i]["closing_usd"].ToString() !="")
				{
					exSheet.Cells[8 + i, 6].Value  =double.Parse( dt.Rows[i]["closing_usd"].ToString());
			...
			if (dt.Rows[i]["openning_usd"].ToString() !="")
				{
					...
					exSheet.Cells[8 + i, 7].Value  =double.Parse( dt.Rows[i]["openning_usd"].ToString());
			...
			if (dt.Rows[i]["closing_won"].ToString() !="")
				{
					...
					exSheet.Cells[8 + i, 8].Value  =double.Parse( dt.Rows[i]["closing_won"].ToString());
