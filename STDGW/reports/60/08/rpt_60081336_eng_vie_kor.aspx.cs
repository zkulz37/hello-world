...
public partial class rpt_60081336_eng_vie_kor : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60081336_eng_vie_kor.xls";
        string TempFile = "../../../system/temp/rpt_60081336_eng_vie_kor_" + Session["User_ID"].ToString() + ".xls";
		...
		for (int i = 0; i < dt.Rows.Count;i++)
				{
					...
					int rs = int.Parse(dt.Rows[i]["code"].ToString());
					   if(rs >=500)
						{
								exSheet.Cells[21 + i, 1].Value = dt.Rows[i]["prn_acnm"].ToString();
								exSheet.Cells[21 + i, 2].Value = dt.Rows[i]["prn_lacnm"].ToString();
								exSheet.Cells[21 + i, 3].Value = dt.Rows[i]["prn_kacnm"].ToString();
								exSheet.Cells[21 + i, 4].Value  =  dt.Rows[i]["code"].ToString();//Group
								exSheet.Cells[21 + i, 4].HorizontalAlignment = XlHAlign.xlHAlignCenter;
								exSheet.Cells[21 + i, 5].Value  =  dt.Rows[i]["header"].ToString();//itemcode
								exSheet.Cells[21 + i, 5].HorizontalAlignment = XlHAlign.xlHAlignCenter;
								
								
								if (dt.Rows[i]["closing"].ToString() !="")
									{
										
										exSheet.Cells[21 + i, 6].Value  =double.Parse( dt.Rows[i]["closing"].ToString());
										exSheet.Cells[21 + i, 6].NumberFormat = "#,##0.00";
										exSheet.Cells[21 + i, 6].HorizontalAlignment = XlHAlign.xlHAlignRight;
									}
								if (dt.Rows[i]["openning"].ToString() !="")
									{
										
										exSheet.Cells[21 + i, 7].Value  =double.Parse( dt.Rows[i]["openning"].ToString());
										exSheet.Cells[21 + i, 7].NumberFormat = "#,##0.00";
										exSheet.Cells[21 + i, 7].HorizontalAlignment = XlHAlign.xlHAlignRight;
									}
								if (dt.Rows[i]["font_stype"].ToString() !="")
								{
									if (dt.Rows[i]["font_stype"].ToString() =="B")
									{
										exSheet.Cells[i + 21,1, i + 21,7].Font.Bold = true;
									}
									if (dt.Rows[i]["font_stype"].ToString() =="I")
									{
										exSheet.Cells[i + 21,1, i + 21,7].Font.Italic = true;
									}	
				...
				for (int j = 0; j < dt.Rows.Count;j++)
				{
					...
					int rs1 = int.Parse(dt.Rows[j]["code"].ToString());
					   if(rs1 >=300&& rs1<500)
						{
								exSheet.Cells[15 + j, 1].Value = dt.Rows[j]["prn_acnm"].ToString();
								exSheet.Cells[15 + j, 2].Value = dt.Rows[j]["prn_lacnm"].ToString();
								exSheet.Cells[15 + j, 3].Value = dt.Rows[j]["prn_kacnm"].ToString();
								exSheet.Cells[15 + j, 4].Value  =  dt.Rows[j]["code"].ToString();//Group
								exSheet.Cells[15 + j, 4].HorizontalAlignment = XlHAlign.xlHAlignLeft;
								exSheet.Cells[15 + j, 5].Value  =  dt.Rows[j]["header"].ToString();//itemcode
							
								exSheet.Cells[15 + j, 5].HorizontalAlignment = XlHAlign.xlHAlignLeft;
								
								
								if (dt.Rows[j]["closing"].ToString() !="")
									{
										
										exSheet.Cells[15 + j, 6].Value  =double.Parse( dt.Rows[j]["closing"].ToString());
										exSheet.Cells[15 + j, 6].NumberFormat = "#,##0.00";
										exSheet.Cells[17 + j, 6].HorizontalAlignment = XlHAlign.xlHAlignRight;
									}
								if (dt.Rows[j]["openning"].ToString() !="")
									{
										
										exSheet.Cells[15 + j, 7].Value  =double.Parse( dt.Rows[j]["openning"].ToString());
										exSheet.Cells[15 + j, 7].NumberFormat = "#,##0.00";
										exSheet.Cells[15 + j, 7].HorizontalAlignment = XlHAlign.xlHAlignRight;
									}
								...
								if (dt.Rows[j]["font_stype"].ToString() !="")
								{
									...
									{
										exSheet.Cells[j + 15,1, j + 15,7].Font.Bold = true;
									}
									if (dt.Rows[j]["font_stype"].ToString() =="I")
									{
										exSheet.Cells[j + 15,1, j + 15,7].Font.Italic = true;
									}	
											//Color colorValueFrmHex = ColorTranslator.FromHtml(dt.Rows[i]["prn_color"].ToString());
											//exSheet.Cells[i + 10,1, i + 10,9].Interior.Color = colorValueFrmHex;
								}
					   ...
					   if(rs2 >=100&& rs2 <300)
						{
								...
								if (dt.Rows[c]["closing"].ToString() !="")
									{
										...
										exSheet.Cells[10 + c, 6].Value  =double.Parse( dt.Rows[c]["closing"].ToString());
								...
								if (dt.Rows[c]["openning"].ToString() !="")
									{
										...
										exSheet.Cells[10 + c, 7].Value  =double.Parse( dt.Rows[c]["openning"].ToString());
								...
								if (dt.Rows[c]["font_stype"].ToString() !="")
								{
									...
									{
										exSheet.Cells[c + 10,1, c + 10,7].Font.Bold = true;
									}
									if (dt.Rows[c]["font_stype"].ToString() =="I")
									{
										exSheet.Cells[c + 10,1, c+ 10,7].Font.Italic = true;
									}	
											//Color colorValueFrmHex = ColorTranslator.FromHtml(dt.Rows[i]["prn_color"].ToString());
											//exSheet.Cells[i + 10,1, i + 10,9].Interior.Color = colorValueFrmHex;
								}
