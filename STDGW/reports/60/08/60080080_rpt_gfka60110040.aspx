...
<%
    ...
    SQL = "SELECT  " +
        ...
        "        TO_NUMBER(DECODE(ac_GET_DRCRTYPE(" + l_company_pk + ",M.TAC_ABACCTCODE_PK),'C','-1','1')) CRDR " +
    ...
    //    "                            AND B.TCO_COMPANY_PK = " + l_company_pk + " " +
        ...
        "         TO_NUMBER(DECODE(AC_GET_DRCRTYPE(" + l_company_pk + ",D.TAC_ABACCTCODE_PK),'C','-1','1')) CRDR " +
