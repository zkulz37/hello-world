...
public partial class rpt_60080040_TKDUPSN_Viet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

           ESysLib.SetUser(Session["APP_DBUSER"].ToString());  
        string TemplateFile = "rpt_60080040_TKDUPSN_Viet.xls";
        string TempFile = "../../../system/temp/rpt_60080040_TKDUPSN_Viet_" + Session["User_ID"].ToString() + ".xls";
        ...
        "    WHERE PK = '"+p_company_pk+"' " ;
			...
			exSheet.Cells[17,6].Value = "Date : "+ dt.Rows[0]["todate"].ToString(); 
			exSheet.Cells[11,8].Value = p_total_book_amt;
			exSheet.Cells[13,7].Value = dt.Rows[0]["creditbookamount"].ToString();	
