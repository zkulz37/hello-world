...
public partial class rpt_60081342_PL1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60081342_PL1.xls";
        string TempFile = "../../../system/temp/rpt_60081342_PL1_" + Session["User_ID"].ToString() + ".xls";
		 ...
		 for (int i = 1; i < dt.Rows.Count;i++)
		 {
			for(int col=0;col<=5;col++)
			{
				...
				if (dt.Rows[i]["jan_this"].ToString() !="")
				{
					...
					exSheet.Cells[_row + i, 4].Value = l_usd_amt;
					exSheet.Cells[_row + i, 4].NumberFormat = "#,##0.00";
				}
