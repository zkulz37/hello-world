...
public partial class rpt_60080040_TKDUTongPSNCo_Viet : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

         ESysLib.SetUser(Session["APP_DBUSER"].ToString());
        string TemplateFile = "rpt_60080040_TKDUTongPSNCo_Viet.xls";
        string TempFile = "../../../system/temp/rpt_60080040_TKDUTongPSNCo_Viet_" + Session["User_ID"].ToString() + ".xls";
		...
		//	p_dt_to = dt.Rows[0]["dt_to"].ToString();
			...
			exSheet.Cells[15,4].Value =dt.Rows[0]["todate"].ToString();
        ...
        for (int l_row = 1; l_row <= dt.Rows.Count; l_row++)
        {
			...
			{              
				...
				if(dt.Rows[l_row - 1]["total_credit"].ToString()!="")
					{
						exSheet.Cells[10+ l_row, col + 1].Value = double.Parse(dt.Rows[l_row - 1]["total_debit"].ToString());		
							l_total_debit=l_total_debit+double.Parse(dt.Rows[l_row - 1]["total_debit"].ToString());
					}									
		...
		exSheet.Cells[11 + l_cnt, 5].Value=l_total_debit;
