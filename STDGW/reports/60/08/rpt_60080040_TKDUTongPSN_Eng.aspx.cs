...
public partial class rpt_60080040_TKDUTongPSN_Eng : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {

         ESysLib.SetUser(Session["APP_DBUSER"].ToString());
        string TemplateFile = "rpt_60080040_TKDUTongPSN_Eng.xls";
        string TempFile = "../../../system/temp/rpt_60080040_TKDUTongPSN_Eng_" + Session["User_ID"].ToString() + ".xls";
		...
		//	p_dt_to = dt.Rows[0]["dt_to"].ToString();
			...
			exSheet.Cells[13,4].Value =dt.Rows[0]["todateE"].ToString();
			//exSheet.Cells[11,8].Value = p_total_book_amt;
			exSheet.Cells[11,5].Value = dt.Rows[0]["creditbookamount"].ToString();	
			//exSheet.Cells[12,4].Value = dt.Rows[0]["debitbookamount"].ToString()	; 
