...
public partial class rpt_60060010_pkt2 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60060010_pkt2.xls";
        string TempFile = "../../../system/temp/rpt_60060010_pkt2_" + Session["User_ID"].ToString() + ".xls";
	...
	string Inword = "";
		...
		DataTable dt_detail = ESysLib.TableReadOpenCursor("ac_sel_60060010_pkt2",l_seq);
