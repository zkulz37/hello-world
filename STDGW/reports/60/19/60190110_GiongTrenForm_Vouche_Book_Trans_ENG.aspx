...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1785 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=2 class=xl45>Status :</td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  width:51pt'>Voucher No</td>
  <td rowspan=2 class=xl50 width=68 style='border-bottom:.5pt solid black;
  width:51pt'>Proposed Date</td>
  <td rowspan=2 class=xl50 width=75 style='border-bottom:.5pt solid black;
  width:56pt'>Proposed By</td>
  ...
  none'>Credit</td>
  <td rowspan=2 class=xl50 width=89 style='border-bottom:.5pt solid black;
  width:67pt'>CMF Balance</td>
  <td rowspan=2 class=xl58 style='border-bottom:.5pt solid black'>Customer</td>
  <td colspan=2 class=xl46 style='border-right:.5pt solid black;border-left:
  none'>Description</td>
  <td rowspan=2 class=xl58 style='border-bottom:.5pt solid black'>PL</td>
  <td rowspan=2 class=xl58 style='border-bottom:.5pt solid black'>Item Control</td>
  <td rowspan=2 class=xl58 style='border-bottom:.5pt solid black'>Enclose</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl29 style='height:15.0pt'>Trans</td>
  <td class=xl29>Book</td>
  <td class=xl29>trans</td>
  <td class=xl29>book</td>
