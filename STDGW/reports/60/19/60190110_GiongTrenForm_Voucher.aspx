...
<link rel=File-List href="rptaaa1_files/filelist.xml">
<link rel=Edit-Time-Data href="rptaaa1_files/editdata.mso">
<link rel=OLE-Object-Data href="rptaaa1_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2010-03-01T06:36:28Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1609 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=15 height=20 class=xl26 width=1609 style='height:15.0pt;
  width:1207pt'><%= p_cmp_name %></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=15 height=20 class=xl44 style='height:15.0pt'><%= p_cmp_add %></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl25 colspan=2 style='height:15.0pt;mso-ignore:colspan'>hi&#7879;u
  tài kho&#7843;n :</td>
  <td colspan=2 class=xl44><%= p_acc_code %></td>
  <td colspan=11 class=xl44><%= p_acc_name %></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl25 style='height:15.0pt'>Ngày :</td>
  <td colspan=4 class=xl45><%= p_dt_from %> ~<span style='mso-spacerun:yes'> 
  </span><%= p_dt_to %></td>
  <td class=xl27></td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=40 class=xl56 style='border-bottom:.5pt solid black;
  ...
  width:56pt'>Ng&#432;&#7901;i &#272;&#7873;<br>
    Xu&#7845;t</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>T&#7927; Giá</td>
  <td rowspan=2 class=xl48 width=89 style='border-bottom:.5pt solid black;
  width:67pt'>S&#7889; d&#432; &#272;&#7847;u K&#7923;(Ghi S&#7893;)</td>
  <td colspan=2 class=xl46 style='border-right:.5pt solid black'>Ghi S&#7893;</td>
  <td rowspan=2 class=xl48 width=89 style='border-bottom:.5pt solid black;
  width:67pt'>S&#7889; d&#432; Cu&#7889;i K&#7923;(Ghi S&#7893;)</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>Khách Hàng</td>
  <td colspan=2 class=xl58 style='border-right:.5pt solid black;border-left:
  none'>Ghi Chú</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>PL</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>Mã Ki&#7875;m
  Soát</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>Kèm Theo</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl29 style='height:15.0pt'>N&#7907;</td>
  <td class=xl29>Có</td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl43 style='height:20.1pt'><%= dtDetail.Rows[i][0].ToString()%></td>
  <td class=xl30><%= dtDetail.Rows[i][1].ToString()%></td>
  <td class=xl30><%= dtDetail.Rows[i][2].ToString()%></td>
  <td class=xl31><%= dtDetail.Rows[i][3].ToString()%></td>
  <td class=xl30><%= dtDetail.Rows[i][4].ToString()%></td>
  <td class=xl32 x:num><span style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i][5].ToString()%></td>
  <td class=xl32 x:num><span style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i][6].ToString()%></td>
  <td class=xl32 x:num><span
  style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i][8].ToString()%></td>
  <td class=xl32 x:num><font color="#FF0000" style='mso-ignore:color'><span
  style='mso-spacerun:yes'>  </span><%= dtDetail.Rows[i][10].ToString()%></font></td>
  <td class=xl33><%= dtDetail.Rows[i][11].ToString()%></td>
  <td class=xl31><%= dtDetail.Rows[i][12].ToString()%></td>
  <td class=xl31><%= dtDetail.Rows[i][13].ToString()%></td>
  <td class=xl31><%= dtDetail.Rows[i][19].ToString()%></td>
  <td class=xl31><%= dtDetail.Rows[i][20].ToString()%></td>
  <td class=xl34><%= dtDetail.Rows[i][21].ToString()%></td>
 </tr>
 <%
     }
     else
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl31><%= dtDetail.Rows[i][3].ToString()%></td>
  <td class=xl30><%= dtDetail.Rows[i][4].ToString()%></td>
  <td class=xl32 x:num><span style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i-1][10].ToString()%></td>
  <td class=xl32 x:num><span style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i][6].ToString()%></td>
  <td class=xl32 x:num><span
  style='mso-spacerun:yes'> </span><%= dtDetail.Rows[i][8].ToString()%></td>
  <td class=xl32 x:num><font color="#FF0000" style='mso-ignore:color'><span
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 colspan=11 class=xl35 style='height:15.0pt;mso-ignore:colspan'></td>
  <td colspan=4 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=4 rowspan=2 height=40 class=xl50 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;height:30.0pt'>T&#7893;ng</td>
  <td rowspan=2 class=xl56 style='border-bottom:.5pt solid black'>T&#7927; Giá</td>
  <td rowspan=2 class=xl48 width=89 style='border-bottom:.5pt solid black;
  width:67pt'>S&#7889; d&#432; &#272;&#7847;u K&#7923;(Ghi S&#7893;)</td>
  <td colspan=2 class=xl46 style='border-right:.5pt solid black'>Ghi S&#7893;</td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl40 x:num><%= dtSum.Rows[1][4].ToString()%></td>
  <td class=xl40 x:num><%= dtSum.Rows[1][5].ToString()%></td>
  <td class=xl40 x:num><font color="#FF0000" style='mso-ignore:
