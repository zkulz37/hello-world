...
public partial class rpt_60120120_rpt_import_VAT_out_156 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60120120_rpt_import_VAT_out_156.xls";
        string TempFile = "../../../system/temp/rpt_60120120_rpt_import_VAT_out_156_" + Session["User_ID"].ToString() + ".xls";
       ...
       IRange range;
		...
		exSheet.Cells["B8"].Value  = "Kỳ tính thuế: Tháng "+l_month+" năm "+l_year;
		exSheet.Cells["D10"].Value  = l_lname;
		exSheet.Cells["D11"].Value  = l_tax_code;
...
//============================================================================================================================================================				
		...
		{
			stt4 += 1;
			exSheet.Cells[_row4 + i, 2].Value = stt4;
			//exSheet.Cells[_row4 + i, 3].Value = dt_4.Rows[i]["Ma_HD"].ToString();
			exSheet.Cells[_row4 + i, 3].Value = dt_4.Rows[i]["FORM_NUMBER"].ToString();
			exSheet.Cells[_row4 + i, 4].Value = dt_4.Rows[i]["seri_no"].ToString();
			exSheet.Cells[_row4 + i, 5].Value = dt_4.Rows[i]["invoice_no"].ToString();
			exSheet.Cells[_row4 + i, 6].Value = dt_4.Rows[i]["invoice_date"].ToString();
			exSheet.Cells[_row4 + i, 7].Value = dt_4.Rows[i]["partner_name"].ToString();
			exSheet.Cells[_row4 + i, 8].Value = dt_4.Rows[i]["tax_code"].ToString();
			exSheet.Cells[_row4 + i, 9].Value = dt_4.Rows[i]["tco_ciitem_nm"].ToString();
			exSheet.Cells[_row4 + i, 10].Value = decimal.Parse(dt_4.Rows[i]["net_amt"].ToString());
			exSheet.Cells[_row4 + i, 11].Value = decimal.Parse(dt_4.Rows[i]["tax_amt"].ToString());
			exSheet.Cells[_row4 + i, 12].Value = dt_4.Rows[i]["note"].ToString();
			...
			exSheet.Cells[29 + i, 10].Value = NetAmt_Total_4;
			exSheet.Cells[29 + i, 11].Value = TaxAmt_Total_4;
		} 		
//============================================================================================================================================================				
        ...
        {
            exSheet.Range["A26"].Rows.EntireRow.Insert();//insert row new of sheet
        }
		...
		{
			stt3 += 1;
			exSheet.Cells[_row3 + i, 2].Value = stt3;
			//exSheet.Cells[_row3 + i, 3].Value = dt_3.Rows[i]["Ma_HD"].ToString();
			exSheet.Cells[_row3 + i, 3].Value = dt_3.Rows[i]["FORM_NUMBER"].ToString();
			exSheet.Cells[_row3 + i, 4].Value = dt_3.Rows[i]["seri_no"].ToString();
			exSheet.Cells[_row3 + i, 5].Value = dt_3.Rows[i]["invoice_no"].ToString();
			exSheet.Cells[_row3 + i, 6].Value = dt_3.Rows[i]["invoice_date"].ToString();
			exSheet.Cells[_row3 + i, 7].Value = dt_3.Rows[i]["partner_name"].ToString();
			exSheet.Cells[_row3 + i, 8].Value = dt_3.Rows[i]["tax_code"].ToString();
			exSheet.Cells[_row3 + i, 9].Value = dt_3.Rows[i]["tco_ciitem_nm"].ToString();
			exSheet.Cells[_row3 + i, 10].Value = decimal.Parse(dt_3.Rows[i]["net_amt"].ToString());
			exSheet.Cells[_row3 + i, 11].Value = decimal.Parse(dt_3.Rows[i]["tax_amt"].ToString());
			exSheet.Cells[_row3 + i, 12].Value = dt_3.Rows[i]["note"].ToString();
			...
			exSheet.Cells[26 + i, 10].Value = NetAmt_Total_3;
			exSheet.Cells[26 + i, 11].Value = TaxAmt_Total_3;
		} 
//============================================================================================================================================================		
		...
		for (int i = 0; i < dt_2.Rows.Count;i++)
		{
			...
			exSheet.Cells[_row2 + i, 12].Value = dt_2.Rows[i]["note"].ToString();
			...
			exSheet.Cells[23 + i, 10].Value = NetAmt_Total_2;
			exSheet.Cells[23 + i, 11].Value = TaxAmt_Total_2;
		} 
...
//===============================================================================================================================================================		
		...
		for (int i = 0; i < dt.Rows.Count;i++)
		{
			...
			exSheet.Cells[_row + i, 12].Value = dt.Rows[i]["note"].ToString();
			...
			exSheet.Cells[20 + i, 10].Value = NetAmt_Total_1;
			exSheet.Cells[20 + i, 11].Value = TaxAmt_Total_1;
		} 	
