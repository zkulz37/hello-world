...
<%
    ...
    DataTable dt_none = ESysLib.TableReadOpenCursor("ac_rpt_60120120_2", l_parameter);
   ...
   // DataTable dt_0 = ESysLib.TableReadOpen(SQL0);
    ...
    DataTable dt_0 = ESysLib.TableReadOpenCursor("ac_rpt_60120120_2", l_parameter);	
   ...
   // DataTable dt_5 = ESysLib.TableReadOpen(SQL5);
    ...
    DataTable dt_5 = ESysLib.TableReadOpenCursor("ac_rpt_60120120_2", l_parameter);	
   ...
   // Response.End();
    DataTable dt_10 = ESysLib.TableReadOpenCursor("ac_rpt_60120120_2", l_parameter);	
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1093 style='border-collapse:
 ...
 <%      
     for (int i = 0; i < dt_none.Rows.Count; i++)
     {
         ...
         seri = dt_none.Rows[i][3].ToString();
         invoice_dt = dt_none.Rows[i][4].ToString();
         invoice_date = invoice_dt.Substring(6, 2) + "/" + invoice_dt.Substring(4, 2) + "/" + invoice_dt.Substring(0, 4);
         invoice_no = dt_none.Rows[i][5].ToString();
         cust_name = dt_none.Rows[i][7].ToString();
         cust_tax = dt_none.Rows[i][8].ToString();
         cust_addr = dt_none.Rows[i][9].ToString();
         item = dt_none.Rows[i][10].ToString();
         tax_rate = dt_none.Rows[i][12].ToString();
         net_amt = dt_none.Rows[i][13].ToString();
         vat_amt = dt_none.Rows[i][14].ToString();
         voucher = dt_none.Rows[i][15].ToString();
         vat_note = dt_none.Rows[i][16].ToString();
         if (net_amt.Trim() != "")
 ...
 <%
     if (dt_0.Rows.Count > 0)
     {
         for (int i = 0; i < dt_0.Rows.Count; i++)
         {
             ...
             seri = dt_0.Rows[i][3].ToString();
             invoice_dt = dt_0.Rows[i][4].ToString();
             invoice_date = invoice_dt.Substring(6, 2) + "/" + invoice_dt.Substring(4, 2) + "/" + invoice_dt.Substring(0, 4);
             invoice_no = dt_0.Rows[i][5].ToString();
             cust_name = dt_0.Rows[i][7].ToString();
             cust_tax = dt_0.Rows[i][8].ToString();
             cust_addr = dt_0.Rows[i][9].ToString();
             item = dt_0.Rows[i][10].ToString();
             tax_rate = dt_0.Rows[i][11].ToString();
             net_amt = dt_0.Rows[i][13].ToString();
             vat_amt = dt_0.Rows[i][14].ToString();
             voucher = dt_0.Rows[i][15].ToString();
             vat_note = dt_0.Rows[i][16].ToString();
             if (net_amt.Trim() != "")
...
%> 
  ...
  <%
    if(dt_5.Rows.Count > 0)
    {
        for(int i=0;i< dt_5.Rows.Count; i++)
        {
            ...
            seri = dt_5.Rows[i][3].ToString();
            invoice_dt = dt_5.Rows[i][4].ToString();
            invoice_date = invoice_dt.Substring(6,2) +"/" + invoice_dt.Substring(4,2)+ "/" + invoice_dt.Substring(0,4);
            invoice_no = dt_5.Rows[i][5].ToString();
            cust_name = dt_5.Rows[i][7].ToString();
            cust_tax = dt_5.Rows[i][8].ToString();
            cust_addr = dt_5.Rows[i][9].ToString();
            item = dt_5.Rows[i][10].ToString();
            tax_rate = dt_5.Rows[i][12].ToString();
            net_amt = dt_5.Rows[i][13].ToString();
            vat_amt = dt_5.Rows[i][14].ToString();
            voucher = dt_5.Rows[i][15].ToString();
            vat_note  = dt_5.Rows[i][16].ToString();
            if(net_amt.Trim() != "")
 ...
 <tr class=xl2414075 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 class=xl2914075 style='height:17.25pt;border-top:none'>4.Hà<span
