...
<%
    ...
    SQL0 += "ORDER BY (SELECT substr(ac_pro_commoncode_ord('EACBK041','',''), 1,length(ac_pro_commoncode_ord('EACBK041','',''))-1) FROM DUAL) ";
    //Response.Write(SQL0);
    //Response.End();
   ...
   // DataTable dt_0 = ESysLib.TableReadOpen(SQL0);
    ...
    SQL5 += "ORDER BY (SELECT substr(ac_pro_commoncode_ord('EACBK041','',''), 1,length(ac_pro_commoncode_ord('EACBK041','',''))-1) FROM DUAL) ";
    ...
    SQL10 += "ORDER BY (SELECT substr(ac_pro_commoncode_ord('EACBK041','',''), 1,length(ac_pro_commoncode_ord('EACBK041','',''))-1) FROM DUAL) ";
    //DataTable dt_10 = ESysLib.TableReadOpen(SQL10);
     ...
     DataTable dt_10 = ESysLib.TableReadOpenCursor("ac_rpt_60120120_1", l_parameter); // sp_sel_gflv00020_1
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1093 style='border-collapse:
 ...
 <% 
     l_parameter = "'" + p_com + "','" + p_month + "','1','ALL','" + p_ccy + "','" + p_status + "','" + p_cust_pk + "','" + l_invoiceno + "','" + l_ac_cd + "','" + p_tac_hgtrh_pk + "','" + p_voucherno + "','" + p_BalType + "','" + p_dtfr + "','" + p_dtto + "','" + p_voucher_type + "'";
     DataTable dt_invalid = new DataTable();//ESysLib.TableReadOpenCursor("ac_rpt_gflv00020_2", l_parameter);	
 ...
 %>
  <tr class=xl2411410 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 class=xl3711410 style='height:17.25pt'><%=stt_invalid%></td>
  <td class=xl3811410><%=seri%></td>
  <td class=xl3811410><%=invoice_no%></td>
  <td class=xl3811410><%=invoice_date%></td>
  <td class=xl3811410><%=cust_name%></td>
