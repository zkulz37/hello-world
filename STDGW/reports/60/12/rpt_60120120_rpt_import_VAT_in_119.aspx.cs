...
public partial class rpt_60120120_rpt_import_VAT_in_119 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_60120120_rpt_import_VAT_in_119.xls";
        string TempFile = "../../../system/temp/rpt_60120120_rpt_import_VAT_in_119_" + Session["User_ID"].ToString() + ".xls";
       ...
       IRange range;
		...
		exSheet.Cells["D8"].Value  = l_lname;
		exSheet.Cells["D9"].Value  = l_tax_code;
...
//===============================================================================================================================================================		
		...
		for (int l_addrow = 0; l_addrow < dt.Rows.Count-1; l_addrow++)
        {
			...
			exSheet.Range[17 + l_addrow+ 1, 1].Rows.EntireRow.Insert();
        }
		...
		if(Mot>1||Hai>1)
		{
			exSheet.Cells[26 + Mot + Hai, 6].Value = NetAmt_Total_1;// + NetAmt_Total_2;
			exSheet.Cells[27 + Mot + Hai, 6].Value = TaxAmt_Total_1;// + TaxAmt_Total_2;
		}
		else
		{
			exSheet.Cells[26, 6].Value = NetAmt_Total_1;// + NetAmt_Total_2;
			exSheet.Cells[27, 6].Value = TaxAmt_Total_1;// + TaxAmt_Total_2;
		}
		/**/
