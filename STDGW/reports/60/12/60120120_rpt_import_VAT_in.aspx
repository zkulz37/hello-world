...
<% 
    ...
    SQLD += "         a.invoice_date, a.invoice_no, a.tco_buspartner_pk, decode('"+VAT_YN+"','N',a.BUSPARTNER_LNM,b.partner_name) PARTNER_LNAME,";
    SQLD += "         decode('"+VAT_YN+"','Y',b.tax_code,a.tax_code),b.ADDR1|| b.ADDR2||b.ADDR3 address, a.tco_ciitem_nm, a.ccy, a.tax_rate, nvl(a.net_amt,0), ";
    SQLD += "         nvl(a.tax_amt,0), decode('" + p_voucher_type + "',1,h.voucherno,h.VOUCHERNO_APP) ,a.vat_note, to_char(h.tr_date,'yyyymmdd') tr_date";
    ...
    SQLD += "     AND a.TR_DATE between '"+ p_From +"' and '"+ p_To+"' ";
    ...
    SQLD += "ORDER BY (SELECT substr(ac_pro_commoncode_ord('EACBK041','',''), 1,length(ac_pro_commoncode_ord('EACBK041','',''))-1) FROM DUAL) ";
    ...
    SQL0 += "         a.invoice_date, a.invoice_no, a.tco_buspartner_pk, decode('"+VAT_YN+"','N',a.BUSPARTNER_LNM,b.partner_name) PARTNER_LNAME, ";
    SQL0 += "         decode('"+VAT_YN+"','Y',b.tax_code,a.tax_code),b.ADDR1|| b.ADDR2||b.ADDR3 address, a.tco_ciitem_nm, a.ccy, a.tax_rate, nvl(a.net_amt,0), ";
    SQL0 += "         nvl(a.tax_amt,0), decode('" + p_voucher_type + "',1,h.voucherno,h.VOUCHERNO_APP), a.vat_note, to_char(h.tr_date,'yyyymmdd') tr_date";
    ...
    SQL0 += "     AND a.TR_DATE between '"+ p_From +"' and '"+ p_To+"' ";
    ...
    //SQL0 += "     AND sf_get_paymentbank_yn(a.tac_hgtrh_pk) = 'Y' ";  
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1850 class=xl236525
 ...
 <tr height=34 style='height:25.5pt'>
  ...
  <td class=xl536525 style='border-left:none; mso-number-format:General;' x:num><%=tax_rate %></td>
...
%>
 ...
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl236525 style='height:15.0pt'></td>
  <td class=xl356525 width=64 style='border-top:none;width:48pt'><%=stt0%></td>
  <td class=xl356525 width=78 style='border-top:none;border-left:none;
  width:59pt'><%=seri%></td>
  <td class=xl356525 width=67 style='border-top:none;border-left:none;
  width:50pt'><%=invoice_no%></td>
  <td class=xl356525 width=86 style='border-top:none;border-left:none;
  width:65pt'><%=invoice_date%></td>
  <td class=xl356525 width=297 style='border-top:none;border-left:none;
  width:223pt'><%=cust_name%></td>
  <td class=xl366525 width=125 style='border-top:none;border-left:none;
  width:94pt'><%=cust_tax%></td>
  <td class=xl356525 width=139 style='border-top:none;border-left:none;
  width:104pt'><%=item%></td>
  <td class=xl376525 width=135 style='border-top:none;border-left:none;
  width:101pt' x:num><%=net_amt%></td>
  <td class=xl386525 width=73 style='border-top:none;border-left:none;
  width:55pt' x:num></td>
  <td class=xl716525 width=161 style='border-top:none;border-left:none;
  width:121pt' x:num><%=vat_amt %></td>
  <td class=xl356525 width=178 style='border-top:none;border-left:none;
  width:134pt' x:str><%=voucher %>(<%=seq%>)(<%=vat_note%>)</td>
  <td class=xl236525></td>
  <td class=xl236525></td>
  <td class=xl506525></td>
  <td class=xl506525></td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl356525 width=139 style='border-top:none;border-left:none;
  width:104pt'>&nbsp;</td>
  <td class=xl386525 width=135 style='border-top:none;border-left:none;
  width:101pt' x:num><%=net_none %></td>
  <td class=xl386525 width=73 style='border-top:none;border-left:none;
  width:55pt' x:str ></td>
  <td class=xl716525 width=161 style='border-top:none;border-left:none;
  width:121pt' x:num><%=vat_none%></td>
  <td class=xl356525 width=178 style='border-top:none;border-left:none;
...
<% } %>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl236525 style='height:15.0pt'></td>
  <td colspan=11 class=xl346525 width=1403 style='width:1054pt'>5. Hàng hóa, dịch vụ không phải tổng hợp trên tờ khai 01/GTGT:</td>
  <td class=xl236525></td>
  <td class=xl236525></td>
  <td class=xl506525></td>
  <td class=xl506525></td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl256525 style='mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%=net_none+net_0 %> </td>
  <td class=xl256525></td>
  <td class=xl236525></td>
  <td class=xl266525></td>
  <td class=xl696525></td>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  vào: </td>
  <td class=xl256525 style='mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%=vat_none + vat_0%></td>
  <td class=xl256525></td>
  <td class=xl236525></td>
  <td class=xl266525></td>
  <td class=xl696525></td>
