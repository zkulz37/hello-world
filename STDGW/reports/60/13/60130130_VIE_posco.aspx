...
<%
    ...
    DataTable dt = ESysLib.TableReadOpenCursor("AC_rpt_sel_60130130", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1917 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=20 height=30 class=xl69 style='height:22.5pt'>DANH SÁCH TÀI SẢN CỐ ĐỊNH</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=20 height=20 class=xl79 style='height:15.0pt'>Từ ngày <%=p_date_from%> đến ngày <%=p_date_to%></td>
 </tr>
 <tr class=xl71 height=22 style='mso-height-source:userset;height:16.5pt'>
  <td rowspan=2 height=39 class=xl67 style='border-bottom:.5pt solid black;  height:29.25pt;border-top:none'>STT</td>
  <td rowspan=2 class=xl88 width=59 style='border-bottom:.5pt solid black;  border-top:none;width:44pt'>Trạng<br>    <span style='mso-spacerun:yes'> </span>thái</td>
  <td rowspan=2 class=xl67 style='border-bottom:.5pt solid black;border-top:  none'>Mã tài sản</td>
  <td rowspan=2 class=xl67 style='border-bottom:.5pt solid black;border-top:  none'>Tên tài sản</td>
  <td rowspan=2 class=xl67 style='border-bottom:.5pt solid black;border-top:  none'>Loại</td>
  <td rowspan=2 class=xl88 width=63 style='border-bottom:.5pt solid black;  border-top:none;width:47pt'>Ngày<br><span style='mso-spacerun:yes'> </span>sử dụng</td>
  <td colspan=2 class=xl70 style='border-left:none'>Nguyên giá đầu kỳ</td>
  <td colspan=2 class=xl70 style='border-left:none'>TS tăng trong kỳ</td>
  <td colspan=2 class=xl70 style='border-left:none'>TS giảm trong kỳ</td>
  <td colspan=2 class=xl70 style='border-left:none'>Nguyên giá cuối kỳ</td>
  <td colspan=2 class=xl70 style='border-left:none'>Trị giá khấu hao</td>
  <td colspan=2 class=xl70 style='border-left:none'>Trị giá khấu hao lũy kế</td>
  <td colspan=2 class=xl70 style='border-left:none'>Trị giá còn lại</td>
 </tr>
