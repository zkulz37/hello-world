...
<table x:str border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <%
     ...
     string SQL7 = "SELECT   ac_get_accd (d.tac_abacctcode_pk, 2) accd, " +
         "         ac_get_acnm (d.tac_abacctcode_pk, 2, 'ENG'), d.remark2, d.remark2, " +
         "         +DECODE (drcr_type, " +
         ...
         "             AND b.del_if = 0 " +
         "          UNION ALL " +
         "          SELECT ac_get_buspartner_id(tco_buspartner_pk) buspartner_id, a.buspartner_lnm, a.pk tac_hgtrd_pk " +
         "            FROM tac_hgtrd a " +
         "           WHERE a.del_if = 0 " +
	...
	SQL7 =  "SELECT " +
        "       (CASE " +
        "           WHEN ac_gfos_cust_yn (a.tac_abacctcode_pk) = 'Y' " +
        "           THEN " +
        "              ac_get_buspartner_info (tco_buspartner_pk) " +
        "           ELSE " +
        ...
        "                 ) " +
        "        END) " +
        "          c0, a.REMARK2 c1, ac_get_accd (a.tac_abacctcode_pk, 2) c2 ,decode(DRCR_TYPE,'D',TR_BOOKAMT,0) c3 ,decode(DRCR_TYPE,'C',TR_BOOKAMT,0)  c4, a.pk " +
        "  FROM tac_hgtrd a " +
