...
<table x:str border=0 cellpadding=0 cellspacing=0 width=833 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl50 style='height:19.5pt'>BÁO CÁO KẾT QUẢ HOẠT
  ĐỘNG KINH DANH</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl73 style='height:19.5pt'>Quý <%=l_outquater %> Năm <%=l_curYYYY%></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Giai đoạn từ
  <%=l_date_fr %> đến <%=l_date_to %></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
