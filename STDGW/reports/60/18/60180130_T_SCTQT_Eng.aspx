...
SQL = "SELECT   b.ac_nm,b.ac_knm,b.ac_lnm,b.ac_cd, TO_CHAR(SUM (debit_amt),ac_sf_get_format ('ACBG0040')) total_debit, TO_CHAR(SUM (credit_amt),ac_sf_get_format ('ACBG0040')) total_credit,  ";
SQL += "         TO_CHAR(TO_NUMBER (" + p_open_bal +") + SUM ( sum (debit_amt) - sum(credit_amt) )OVER (ORDER BY b.ac_cd), ac_sf_get_format ('ACBG0040')) AS closingbalance ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1029 style='border-collapse:
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl26 style='height:19.5pt'>From date<%= p_dt_from %> to date <%= p_dt_to %></td>
 </tr>
 ...
 <tr class=xl43 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  height:14.25pt'>Account name/Local Description</td>
  <td rowspan=2 class=xl67 width=54 style='border-bottom:.5pt solid black;
  width:41pt'>Account Code</td>
 ...
 <tr class=xl43 height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <td class=xl30 id="_x0000_s1030" x:autofilter="all">Receipt</td>
  <td class=xl30 id="_x0000_s1031" x:autofilter="all">Payment</td>
  <td class=xl30 id="_x0000_s1032" x:autofilter="all">Balance</td>
 </tr>
 <tr class=xl50 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  style='mso-spacerun:yes'> </span>Opening
  Balance</td>
...
%> 
 <tr class=xl50 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl53 width=222 style='border-left:none;width:167pt'>Arising Amount</td>
  <td class=xl52 style='border-left:none'>&nbsp;</td>
 ...
 <tr class=xl50 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl53 width=222 style='border-top:none;border-left:none;width:167pt'>Closing balance</td>
  <td class=xl52 style='border-top:none;border-left:none'>&nbsp;</td>
...
<tr height=23 style='height:17.25pt'>
  <td height=23 class=xl32 style='height:17.25pt'><%= v4 %></td>
  <td colspan=2 class=xl32><%= v5 %></td>
  <td class=xl32></td>
  <td colspan=3 class=xl32><%= v6 %></td>
 </tr>
 <tr height=23 style='height:17.25pt'>
  <td height=23 class=xl31 style='height:17.25pt'><%= g4 %></td>
  <td colspan=2 class=xl31><%= g5 %></td>
  <td class=xl31></td>
  <td colspan=3 class=xl31><%= g6 %></td>
 </tr>
<tr height=23 style='height:17.25pt'>
...
<tr height=23 style='height:17.25pt'>
  ...
  <td colspan=3 class=xl32></td>
   ...
   <tr height=23 style='height:17.25pt'>
  <td height=23 class=xl32 style='height:17.25pt'><%= n4 %></td>
  <td colspan=2 class=xl32><%= n5 %></td>
  <td class=xl32></td>
  <td colspan=3 class=xl32><%= n6 %></td>
 </tr>
