...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1096 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl72 style='height:19.5pt'>(Direct Method/Theo phương pháp trực tiếp)</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td class=xl27></td>
 </tr>
  <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl72 style='height:19.5pt'>End the of year <%= l_curYYYY %>(Kết thúc năm <%= l_curYYYY %>)</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
