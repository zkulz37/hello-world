...
<%
	...
	if (l_status == "2")
    {
		...
		p_status_bal = "Tiền ghi sổ";
        p_status_bal_trans = "Số dư cuối kỳ";
    }
	else if (l_status == "0") 
    {
		p_status = "Đã duyệt";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1967 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl26 style='height:15.0pt'></td>
  <td class=xl29 colspan=3 style='mso-ignore:colspan'>Từ ngày:<font class="font9">
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=2 class=xl50 style='border-right:.5pt solid black;border-left:
  none'>Diễn giải</td>
  <td rowspan=2 class=xl46 style='border-bottom:.5pt solid black'>Dự án</td>
  <td rowspan=2 class=xl46 style='border-bottom:.5pt solid black'>Chi tiết quản lý</td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl31>Ghi sổ</td>
  <td class=xl31>Tiếng anh</td>
  <td class=xl31>Tiếng việt</td>
 </tr>
  <%		
	int i = 0;
