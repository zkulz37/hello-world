...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1480 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <td class=xl29 width=138 style='width:104pt'>Form: B 01 - DN</td>
 ...
 <tr class=xl30 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  x:str>(Issued with Decision No. 15/2006/QĐ-BTC<span style='mso-spacerun:yes'> </span></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl36></td>
  <td colspan=3 class=xl84>dated March 20, 2006 by Ministry of Finance)</td>
 ...
 <tr height=26 style='height:19.5pt'>
  <td colspan=5 height=26 class=xl85 style='height:19.5pt'>BALANCE SHEET</td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
  <td class=xl25></td>
 </tr>
 <tr class=xl30 height=20 style='height:15.0pt'>
  <td colspan=5 height=20 class=xl86 style='height:15.0pt'>As at <%=l_date_to%></td>
  <td colspan=4 class=xl30 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl32 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  style='mso-spacerun:yes'> </span>(Currency:<%=trsScale %> VND)<span
 ...
 <tr class=xl30 height=53 style='mso-height-source:userset;height:39.75pt'>
  <td height=53 class=xl41 style='height:39.75pt'>ASSETS</td>
  <td class=xl42 width=54 style='width:41pt'>CODE
   </td>
  <td class=xl44 width=61 style='width:46pt'>NOTES</td>
  <td class=xl45>CLOSING</td>
  <td class=xl46>OPENNING</td>
  <td colspan=4 class=xl30 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl32 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
 </tr>
 ...
 <tr class=xl30 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl90 style='height:19.5pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
 ...
 <tr class=xl30 height=53 style='mso-height-source:userset;height:39.75pt'>
  <td height=53 class=xl41 style='height:39.75pt'>RESOURCE</td>
  <td class=xl42 width=54 style='width:41pt'>CODE
    </td>
  <td class=xl44 width=61 style='width:46pt'>NOTES 
    </td>
  <td class=xl61 x:str x:fmla="=+D8"><span
  style='mso-spacerun:yes'> </span>CLOSING<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl61 x:str x:fmla="=+E8"><span
  style='mso-spacerun:yes'> </span>OPENNING<span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=4 class=xl30 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl32 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
...
%>
 ...
 <tr class=xl30 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl54 style='height:18.0pt'>OFF BALANCE SHEET ITEMS</td>
  <td class=xl51></td>
  <td colspan=3 class=xl30 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl32 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
 ...
 <tr class=xl30 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl66 style='height:18.0pt'>ITEMS</td>
  <td class=xl67>&nbsp;</td>
  <td class=xl67>Notes</td>
  <td class=xl68 x:str x:fmla="=+D13"><span
  style='mso-spacerun:yes'> </span>CLOSING<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl69 x:str x:fmla="=+E13"><span
  style='mso-spacerun:yes'> </span>OPENNING<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl51></td>
  <td colspan=3 class=xl30 style='mso-ignore:colspan'></td>
 ...
 <%
     ...
     if (dt_detail.Rows.Count > 0)
     {
      ...
      %>
 <tr class=xl30 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl94 style='height:18.0pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl87>At dated <%=l_date_to%></td>
  <td class=xl71></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
  <td class=xl25></td>
 ...
 <%
  ...
  %>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl74 style='height:18.0pt'><%=l_colK_1%></td>
  <td class=xl75 colspan=2 style='mso-ignore:colspan'><%=l_colK_2%></td>
 ...
 <tr class=xl77 height=21 style='height:15.75pt'>
  ...
  <td colspan=2 class=xl78><%=l_colE_1%></td>
  <td colspan=2 class=xl89 x:str><span
  style='mso-spacerun:yes'> </span><%=l_colE_1%><span
  style='mso-spacerun:yes'> </span></td>
