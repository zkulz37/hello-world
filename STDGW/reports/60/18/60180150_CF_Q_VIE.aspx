...
<link rel=File-List href="rptIncome_files/filelist.xml">
<link rel=Edit-Time-Data href="rptIncome_files/editdata.mso">
<link rel=OLE-Object-Data href="rptIncome_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>PCVINA002</o:LastAuthor>
  <o:LastPrinted>2009-01-22T04:03:04Z</o:LastPrinted>
  <o:Created>2010-01-23T02:35:41Z</o:Created>
  <o:LastSaved>2010-01-23T02:35:41Z</o:LastSaved>
    ...
    <x:WorksheetOptions>
     ...
     <x:Panes>
      <x:Pane>
       ...
       <x:RangeSelection>$D$15:$E$15</x:RangeSelection>
      </x:Pane>
     </x:Panes>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=833 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl49>20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
  <td class=xl36></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl50 style='height:19.5pt'>BÁO CÁO LƯU CHUYỂN TIỀN TỆ</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl73 style='height:19.5pt'><b>(Theo phương pháp trực tiếp)</b></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Quý <%=l_outquater %> Năm <%=l_curYYYY%></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Giai đoạn từ <%=l_date_fr %> đến <%=l_date_to %></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td class=xl37>(Đơn vị tính:<%=trsScale %> VND)</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td rowspan=2 height=42 class=xl51 style='height:31.5pt'>Chỉ tiêu</td>
  <td rowspan=2 class=xl68>Mã số</td>
  <td class=xl71 width=61 style='width:46pt'>Thuyết</td>
  <td colspan=2 class=xl52 style='border-right:.5pt solid black'
  x:str><span style='mso-spacerun:yes'> </span>Quý <%=l_outquater %><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl72 style='height:15.75pt'>minh</td>
  <td class=xl61 x:str><span style='mso-spacerun:yes'> 
  </span>Năm (<%=l_curYYYY%>)<span style='mso-spacerun:yes'>  </span></td>
  <td class=xl62 width=138 style='width:104pt' x:str><span
  style='mso-spacerun:yes'>  </span>Năm (<%=l_lastYYYY%>)<span
  style='mso-spacerun:yes'>  </span></td>
  <td class=xl41></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl63 style='height:15.75pt' x:num>1</td>
  <td class=xl63 style='border-left:none' x:num>2</td>
  <td class=xl70 width=61 style='border-left:none;width:46pt' x:num>3</td>
  <td class=xl64 width=138 style='border-left:none;width:104pt' x:num>4</td>
  <td class=xl64 width=138 style='border-left:none;width:104pt' x:num>5</td>
  <td class=xl41></td>
  <td class=xl27></td>
 </tr>
 <%
 ...
 <tr class=xl42 height=21 style='height:15.75pt'>
  <td height=21 class=xl65 style='height:15.75pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i][1].ToString() %><%=strEnd%></td>
  <td class=xl66 style='border-top:none;border-left:none'><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
  <td class=xl66 style='border-top:none;border-left:none'><%=strBegin%><%= dt_detail.Rows[i][7].ToString() %><%=strEnd%></td>
  <td class=xl67 style='border-top:none;border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][9].ToString() %><%=strEnd%></td>
  <td class=xl67 style='border-top:none;border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][10].ToString() %><%=strEnd%></td>
  <td class=xl33></td>
  <td class=xl42></td>
 </tr>
 <%
 ...
 <tr class=xl42 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl44 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl44 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl45></td>
  <td class=xl42></td>
 </tr>
 ...
 <%
  ...
  %>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl40 style='height:15.75pt'><%=l_colV_1%></td>
  <td colspan=2 class=xl39><%=l_colV_2%></td>
  <td colspan=2 class=xl54 x:str><%=l_colV_3%></td>
  <td class=xl46></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl47 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl35><%=l_colE_2%></td>
  <td colspan=2 class=xl55 x:str><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl40 style='height:15.75pt'><%=l_colN_1%></td>
  <td colspan=3 class=xl56 style='border-right:.5pt solid black'><%=l_colN_2%></td>
  <td colspan=2 class=xl59 style='border-left:none' x:str><span
  style='mso-spacerun:yes'> </span><%=l_colN_3%><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl43><!-----------------------------><!--END OF OUTPUT FROM EXCEL PUBLISH AS WEB PAGE WIZARD--><!-----------------------------></td>
 </tr>
