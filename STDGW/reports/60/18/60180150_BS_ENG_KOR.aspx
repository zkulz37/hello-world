...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1236 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <td colspan=3 class=xl96 width=281 style='width:212pt'>Form: B 01 - DN</td>
 ...
 <tr class=xl29 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl104 style='height:19.5pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
  <td class=xl104 style='border-top:none;border-left:none'><%=strBegin%><%= dt_detail.Rows[i][2].ToString() %><%=strEnd%></td>
...
%>
 ...
 <tr class=xl29 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl100 style='height:18.0pt'>OFF BALANCE SHEET
 ...
 <tr height=43 style='height:32.25pt'>
  <td height=43 class=xl70 style='height:32.25pt'>ITEMS</td>
 ...
 <%
     ...
     if (dt_detail.Rows.Count > 0)
     {
      ...
      %>
 <tr class=xl29 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl109 style='height:19.5pt'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
  <td class=xl75 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i][2].ToString() %><%=strEnd%></td>
