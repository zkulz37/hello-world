...
<%
    ...
    string SQLAC = "SELECT pk, ac_cd, ac_lnm, UPPER(drcr_type)  FROM tac_localcode ";
    ...
    string SQLB   = " select nvl(a.tac_abacctcode_pk, b.tac_abacctcode_pk) tac_abacctcode_pk ";
           ...
           // SQLB += "           and CCY = '" + ccy + "'";
            SQLB += "           and STD_YMD > sf_get_lastclosemm ('" + d_from + "', '" + com_pk + "') ";
            ...
            SQLB += "           and TAC_ABACCTCODE_PK = '" + ac_pk + "' ";
            //SQLB += "           and CCY = 'VND' ";
            SQLB += "           and STD_YM = substr(sf_get_lastclosemm ('" + d_from + "', '" + com_pk + "'),1,6) ";
            SQLB += "           and tr_status IN (DECODE ('" + status + "', '0', '0', DECODE ('" + status + "', '2', '0', '')), ";
            SQLB += "                             DECODE ('" + status + "', '2', '2', ''), ";
            SQLB += "                             DECODE ('" + status + "', '2', '4', DECODE ('" + status + "', '4', '4', '')) ";
            SQLB += "                            )) b ";
            ...
            */
    string SQLB = " SELECT SF_GET_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','D','BOOK') DR_BOOK, SF_GET_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','C','BOOK') CR_BOOK FROM DUAL ";
            ...
            */
            ...
            = "SELECT TO_CHAR(H.TR_DATE,'DD/MM/YYYY') TRANS_DATE, H.VOUCHERNO, " +
                "H.REMARK, H.REMARK2,ac_sf_a_get_accd1(DECODE(D.DRCR_TYPE,'D',DECODE(R.DRCR_TYPE,'C',R.TAC_ABACCTCODE_PK_DR,R.TAC_ABACCTCODE_PK_CR), " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1374 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=4 class=xl79 width=426 style='width:319pt'>Form number: S03a				
</td>
  <td class=xl24 width=63 style='width:47pt'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=5 height=20 class=xl76 style='height:15.0pt'><%=address %></td>
  <td colspan=4 class=xl78  >(Issued with Decision No. 15/2006/QĐ-BTC				
</td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=5 height=20 class=xl76 style='height:15.0pt'>TAX CODE: <%=tax_code %></td>
  <td colspan=4 class=xl78>dated March 20, 2006 by Ministry of Finance)				
</td>
  <td class=xl24></td>
 </tr>
 <tr height=35 style='height:26.25pt'>
  <td colspan=9 height=35 class=xl77 style='height:26.25pt'>ACCOUNT BOOK DETAIL</td>
  <td class=xl24></td>
 </tr>
 <tr height=27 style='height:20.25pt'>
  <td colspan=9 height=27 class=xl80 style='height:20.25pt'>From date
  <%=from_date%> to date <%=to_date%></td>
  <td class=xl24></td>
 </tr>
 <tr class=xl25 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl26 style='height:18.75pt'>Account code</td>
  <td class=xl27><%=ac_cd %></td>
  <td colspan=2 class=xl55>Account name: </td>
  <td colspan=5 class=xl27><%=ac_nm %></td>
  <td class=xl25></td>
 </tr>
 <tr class=xl25 height=21 style='height:15.75pt'>
  <td height=21 class=xl26 style='height:15.75pt'>Subject: </td>
  <td colspan=2 class=xl26></td>
  <td colspan=4 class=xl26 style='mso-ignore:colspan'></td>
  <td class=xl55>Unit</td>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  height:31.5pt;border-top:none;width:62pt'>Date entered</td>
  <td colspan=2 class=xl81 width=185 style='border-right:.5pt solid black;
  border-left:none;width:139pt'>Voucher</td>
  <td rowspan=2 class=xl74 width=271 style='border-bottom:.5pt solid black;
  border-top:none;width:203pt'>Description</td>
 
  <td rowspan=2 class=xl74 width=75 style='border-bottom:.5pt solid black;
  border-top:none;width:56pt'>Account code</td>
  <td colspan=2 class=xl81 width=214 style='border-right:.5pt solid black;
  border-left:none;width:160pt'>Amount Trans</td>
  <td colspan=2 class=xl83 width=212 style='border-right:.5pt solid black;
  border-left:none;width:159pt'>Balance</td>
  <td class=xl49>Notes</td>
 </tr>
 <tr class=xl25 height=21 style='height:15.75pt'>
  <td height=21 class=xl34 width=96 style='height:15.75pt;width:72pt'>No.</td>
  <td class=xl34 width=89 style='width:67pt'>Date</td>
  <td class=xl34 width=107 style='width:80pt'>Debit</td>
  <td class=xl34 width=107 style='width:80pt'>Credit</td>
  <td class=xl34 width=105 style='width:79pt'>Debit</td>
  <td class=xl34 width=107 style='width:80pt'>Credit</td>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl36>&nbsp;</td>
  <td class=xl36>&nbsp;</td>
  <td class=xl61 width=271 style='width:203pt'>Opening Balance</td>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl64>&nbsp;</td>
  <td class=xl65>&nbsp;</td>
  <td class=xl68 width=271 style='border-top:none;border-left:none;width:203pt'>Total Amount Incurred
</td>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl38  style="border-top:.5pt hairline windowtext;">&nbsp;</td>
  <td class=xl62 width=271 style='border-top:none;border-left:none;width:203pt'>Closing Balance</td>
 ...
 <tr class=xl43 height=21 style='height:15.75pt'>
  <td colspan=8 height=21 class=xl71 style='height:15.75pt'>The book are…. pages , number from page 01 to page……							
</td>
  <td class=xl42></td>
  <td class=xl43></td>
  <td class=xl42></td>
 ...
 <tr class=xl43 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl72>Date <%= d_to.Substring(6, 2)%> month <%= d_to.Substring(4, 2)%> year <%= d_to.Substring(0, 4)%></td>
  <td class=xl45></td>
  <td class=xl42></td>
 </tr>
<%
 ...
 <tr class=xl43 height=23 style='height:17.25pt'>
  <td colspan=3 height=23 class=xl46 style='height:17.25pt'><%= v4 %></td>
  <td colspan=1 height=23 class=xl46 style='height:17.25pt'><%= v5 %></td>
  <td class=xl46><%= v6 %></td>
  <td class=xl46></td>
 ...
 <tr class=xl43 height=23 style='height:17.25pt'>
  <td colspan=3 height=23 class=xl48 style='height:17.25pt'><%=g4 %></td>
  <td colspan=1 height=23 class=xl48 style='height:17.25pt'><%=g5 %></td>
  <td class=xl48><%=g6%></td>
  <td class=xl48></td>
...
<tr class=xl43 height=23 style='height:17.25pt'>
  <td colspan=3 height=23 class=xl46 style='height:17.25pt'><%= n4 %></td>
  <td colspan=1 height=23 class=xl46 style='height:17.25pt'><%= n5 %></td>
  <td class=xl46><%= n6 %></td>
  <td class=xl46></td>
