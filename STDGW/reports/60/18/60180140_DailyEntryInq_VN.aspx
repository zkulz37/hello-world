...
SQL = SQL + "    AND ((TRIM('" + l_Seq +"')  IS NULL) OR (H.pk = TRIM('" + l_Seq +"') ))  ";
    ...
    SQL = " SELECT  a.pk,  ";
    SQL = SQL + "        TO_CHAR (a.tr_date, AC_SF_GET_FORMAT ('ACAB0300')) TRDATE, a.voucherno, d.ac_cd, ";
    ...
    SQL = SQL + "        DECODE (b.drcr_type,'D', TO_CHAR (b.tr_bookamt, AC_SF_GET_FORMAT ('ACBG0040')),'') tr_bookD, ";
    SQL = SQL + "        DECODE (b.drcr_type,'C', TO_CHAR (b.tr_bookamt, AC_SF_GET_FORMAT ('ACBG0040')),'') tr_bookC, ";
    SQL = SQL + "        b.remark, b.remark2, ";
    SQL = SQL + "        AC_SF_A_GET_AGTRITEM(b.pk), TO_CHAR (a.tr_date, 'YYYYMMDD') TRDATE1, ";
    SQL = SQL + "        AC_SF_A_GET_AGTRITEM(b.pk), TO_CHAR (a.tr_enclose, 'YYYYMMDD') ENCLOSE ";
