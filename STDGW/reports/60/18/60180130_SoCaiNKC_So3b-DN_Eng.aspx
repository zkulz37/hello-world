...
SQL += "                                 START WITH pk = " + p_acc_pk_arr + "))) ";
   ...
   SQL +=     "     , r2.remark2 remark2, r2.remark remark " ;
    SQL +=    "     , sf_a_get_accd(tac_abacctcode_pk, '" + l_company_pk + "') acc_code, decode(DRCR_TYPE,'D',r2.tr_bookamt,0)  debit_amt " ;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1217 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=8 height=30 class=xl70 style='height:22.5pt' >GENERAL LEDGER<span style='mso-spacerun:yes'> </span></td>
  <td class=xl25></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=8 height=26 class=xl71 style='height:19.5pt'>To date <%= p_dt_from %>
