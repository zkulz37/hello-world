...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1050 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=6 height=26 class=xl61 style='height:19.5pt'>CASH FLOWS/LƯU CHUYỂN TIỀN TỆ</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=6 height=21 class=xl35 style='height:15.75pt'><b>(Direct Method/Theo phương pháp trực tiếp)</b></td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=6 height=21 class=xl35 style='height:15.75pt'>Quater <%= l_outquater  %> Of <%= l_curYYYY %>(Quý <%= l_outquater  %> Năm <%= l_curYYYY %>)</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  none' x:str>Quater <%= l_outquater  %> / Quý  <%= l_outquater  %> </td>
  <td class=xl26></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  </span>Year/Năm(<%=l_curYYYY%>)<span style='mso-spacerun:yes'>  </span></td>
  <td class=xl43 width=138 style='width:104pt' x:str><span
  style='mso-spacerun:yes'>  </span>Year/Năm(<%=l_lastYYYY%>)<span
