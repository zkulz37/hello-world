...
<table x:str border=0 cellpadding=0 cellspacing=0 width=833 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Quater  <%=l_outquater %>  Of  <%=l_curYYYY%></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl48 height=21 style='height:15.75pt'>
  <td height=21 class=xl50 style='height:15.75pt'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
