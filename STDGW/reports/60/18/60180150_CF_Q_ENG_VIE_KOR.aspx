...
<%
    ...
    if (dt.Rows.Count > 0)
    {
        ...
        l_outquater = dt.Rows[0][6].ToString();
    }
    ...
    //Response.End();
    string SQL_TEMP = "ac_sel_60180150_1";
...
<link rel=File-List href="rprEVK_files/filelist.xml">
<link rel=Edit-Time-Data href="rprEVK_files/editdata.mso">
<link rel=OLE-Object-Data href="rprEVK_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>PCVINA002</o:LastAuthor>
  <o:LastPrinted>2009-01-22T04:03:04Z</o:LastPrinted>
  <o:Created>2010-01-23T05:41:35Z</o:Created>
  <o:LastSaved>2010-01-23T08:06:20Z</o:LastSaved>
    ...
    <x:WorksheetOptions>
     ...
     <x:Panes>
      <x:Pane>
       ...
       <x:RangeSelection>$E$16:$I$16</x:RangeSelection>
      </x:Pane>
     </x:Panes>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1096 style='border-collapse:
 ...
 <col class=xl24 width=206 span=3 style='mso-width-source:userset;mso-width-alt:
 7533;width:155pt'>
 ...
 width:55pt'>
 <col class=xl26 width=112 span=2 style='mso-width-source:userset;mso-width-alt:
 4096;width:84pt'>
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl28 width=206 style='height:19.5pt;width:155pt'><%=l_cmp_name%></td>
  <td class=xl28 width=206 style='width:155pt'></td>
  <td class=xl25 width=206 style='width:155pt'></td>
  <td class=xl29 width=42 style='width:32pt'></td>
  <td class=xl30 width=73 style='width:55pt'></td>
  <td colspan=2 class=xl57 width=224 style='width:168pt'>Form/Mẫu số: B03 - DN</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=5 class=xl58>dated March 20, 2006 by Ministry of Finance(Ngày 20
  tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
  <td class=xl34></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl59 style='height:19.5pt'>CASH FLOWS/LƯU CHUYỂN TIỀN TỆ</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl35 style='height:15.75pt'><b>(Direct Method/Theo phương pháp trực tiếp)</b></td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl35 style='height:15.75pt'>Quater <%= l_outquater  %> Of  <%= l_curYYYY %>(Quý <%= l_outquater  %> Năm <%= l_curYYYY %>)</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl35 style='height:15.75pt'>Date <%=l_date_fr %> To <%=l_date_to %>(Ngày <%=l_date_fr %> đến <%=l_date_to %>)</td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td colspan=2 class=xl51>(Đơn vị tính:<%=trsScale %> VND)</td>
  <td class=xl26></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td rowspan=2 height=42 class=xl60 style='border-bottom:.5pt solid black;
  height:31.5pt'>Items</td>
  <td rowspan=2 class=xl60 style='border-bottom:.5pt solid black'>Chỉ Tiêu</td>
  <td rowspan=2 class=xl60 style='border-bottom:.5pt solid black'>Items(Korean)</td>
  <td rowspan=2 class=xl60 style='border-bottom:.5pt solid black'>Code</td>
  <td rowspan=2 class=xl69 width=73 style='border-bottom:.5pt solid black;
  width:55pt'>Notes</td>
  <td colspan=2 class=xl62 style='border-right:.5pt solid black;border-left:
  none' x:str><span style='mso-spacerun:yes'> 
  </span>Quater <%= l_outquater  %> / Quý  <%= l_outquater  %> <span style='mso-spacerun:yes'>  </span></td>
  <td class=xl26></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl40 style='height:15.75pt' x:str><span
  style='mso-spacerun:yes'>   </span>Year(<%=l_curYYYY%>)<span
  style='mso-spacerun:yes'>  </span></td>
  <td class=xl41 width=112 style='width:84pt' x:str><span
  style='mso-spacerun:yes'>  </span>Year(<%=l_curYYYY%>)<span
  style='mso-spacerun:yes'>  </span></td>
  <td class=xl39></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt' x:num>1</td>
  ...
  x:num>5</td>
  <td class=xl44 width=112 style='width:84pt' x:num>6</td>
  <td class=xl44 width=112 style='width:84pt' x:num>7</td>
  <td class=xl39></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <%
 ...
 <tr class=xl45 height=21 style='height:15.75pt'>
  <td height=21 class=xl47 style='height:15.75pt'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
  <td class=xl48><%=strBegin%><%= dt_detail.Rows[i][1].ToString() %><%=strEnd%></td>
  <td class=xl48><%=strBegin%><%= dt_detail.Rows[i][2].ToString() %><%=strEnd%></td>
  <td class=xl49><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
  <td class=xl49><%=strBegin%><%= dt_detail.Rows[i][7].ToString() %><%=strEnd%></td>
  <td class=xl50 x:num><%=strBegin%><%= dt_detail.Rows[i][9].ToString() %><%=strEnd%></td>
  <td class=xl50 x:num><%=strBegin%><%= dt_detail.Rows[i][10].ToString() %><%=strEnd%></td>
  <td class=xl32></td>
 ...
 <tr class=xl45 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 colspan=2 class=xl51 style='height:15.75pt;mso-ignore:colspan'></td>
  <td colspan=2 class=xl38 style='mso-ignore:colspan'></td>
  <td class=xl52 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl52 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl53></td>
  <td class=xl32></td>
  <td colspan=2 class=xl45 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl39 x:str><span
 ...
 <tr class=xl55 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  style='mso-spacerun:yes'>   </span></td>
  <td colspan=5 class=xl64 x:str><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl65 style='border-right:.5pt solid black'>&nbsp;</td>
  <td colspan=4 class=xl68 style='border-left:none' x:str="  "><span
  style='mso-spacerun:yes'>    </span></td>
  <td class=xl46><!-----------------------------><!--END OF OUTPUT FROM EXCEL PUBLISH AS WEB PAGE WIZARD--><!-----------------------------></td>
 </tr>
