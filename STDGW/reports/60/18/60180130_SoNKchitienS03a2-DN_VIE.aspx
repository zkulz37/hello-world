...
<%
	...
	SQL += "       ac_sf_a_get_accd1 (r.tac_abacctcode_pk_dr,"+l_company_pk+") dr_code, ";
	SQL += "       ac_sf_a_get_accd1 (r.tac_abacctcode_pk_cr,"+l_company_pk+") cr_code, ";
	...
	SQL += "   AND r.tac_abacctcode_pk_cr IN (  select pk from tac_abacctcode where del_if =0 and  USE_YN ='Y' and TAC_LOCALCODE_PK in     (SELECT hg.TAC_localCODE_PK  FROM TAC_HGDDBAL_local hg WHERE hg.DEL_IF =0 AND hg.tco_company_pk =  '"+ l_company_pk +"'  AND hg.tac_localcode_pk in ( SELECT pk ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1175 style='border-collapse:
 ...
 <tr class=xl26 height=21 style='height:15.75pt'>
  ...
  <td rowspan="2" class=xl25 style='border-left:none'>Diễn giải</td>
