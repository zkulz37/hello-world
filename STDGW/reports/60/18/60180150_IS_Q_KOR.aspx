...
<table x:str border=0 cellpadding=0 cellspacing=0 width=833 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl59 style='height:19.5pt'>INCOME STATEMENT</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl72 style='height:19.5pt'>Quater  <%=l_outquater %>  Year  <%=l_curYYYY%></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
