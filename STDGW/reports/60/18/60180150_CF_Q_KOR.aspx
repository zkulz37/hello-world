...
<%
    ...
    string l_cmp_name = "";
    string l_cmp_add = "";
    string l_cmp_taxcode = "", l_outquater="";
    int i;
...
<link rel=File-List href="endIS_E_files/filelist.xml">
<link rel=Edit-Time-Data href="endIS_E_files/editdata.mso">
<link rel=OLE-Object-Data href="endIS_E_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>PCVINA002</o:LastAuthor>
  <o:LastPrinted>2009-01-22T04:03:04Z</o:LastPrinted>
  <o:Created>2010-01-23T02:35:41Z</o:Created>
  <o:LastSaved>2010-01-23T09:08:16Z</o:LastSaved>
    ...
    <x:WorksheetOptions>
     ...
     <x:Panes>
      <x:Pane>
       ...
       <x:RangeSelection>$D$16:$E$16</x:RangeSelection>
      </x:Pane>
     </x:Panes>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=833 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl32 width=138 style='width:104pt'>Form: B03 - DN</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl58 x:str="(Issued with Decision No. 15/2006/QĐ-BTC ">(Issued
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl58>dated March 20, 2006 by Ministry of Finance)</td>
  <td class=xl36></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl59 style='height:19.5pt'>CASH  FLOWS</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'><b>(Direct Method)</b></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Quater  <%=l_outquater %>  Year  <%=l_curYYYY%></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Date <%=l_date_fr %> To <%=l_date_to %></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td class=xl37>(Currency:<%=trsScale %> VND)</td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  height:31.5pt'>Item(KOREAN)</td>
  <td rowspan=2 class=xl60 style='border-bottom:.5pt solid black'>Code</td>
  <td rowspan=2 class=xl70 width=61 style='border-bottom:.5pt solid black;
  width:46pt'>Notes</td>
  <td colspan=2 class=xl62 style='border-right:.5pt solid black;border-left:
  none' x:str><span style='mso-spacerun:yes'>  </span>Quater <%=l_outquater %><span style='mso-spacerun:yes'>  </span></td>
  <td class=xl26></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt' x:str><span
  style='mso-spacerun:yes'>   </span>Year (<%=l_curYYYY%>)<span
  style='mso-spacerun:yes'>   </span></td>
  <td class=xl43 width=138 style='width:104pt' x:str><span
  style='mso-spacerun:yes'>   </span>Year (<%=l_lastYYYY%>)<span
  style='mso-spacerun:yes'>   </span></td>
  <td class=xl41></td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl46 width=61 style='width:46pt' x:num>3</td>
  <td class=xl47 width=138 style='width:104pt' x:num>4</td>
  <td class=xl47 width=138 style='width:104pt' x:num>5</td>
  <td class=xl41></td>
  <td class=xl27></td>
 </tr>
 <%
 ...
 %>
 <tr class=xl48 height=21 style='height:15.75pt'>
  <td height=21 class=xl50 style='height:15.75pt'><%=strBegin%><%= dt_detail.Rows[i][2].ToString() %><%=strEnd%></td>
  <td class=xl51><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
  <td class=xl51><%=strBegin%><%= dt_detail.Rows[i][7].ToString() %><%=strEnd%></td>
 ...
 <tr class=xl48 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 style='height:15.75pt'></td>
  <td colspan=2 class=xl40 style='mso-ignore:colspan'></td>
  <td class=xl53 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl53 x:num="0"><span style='mso-spacerun:yes'>   </span></td>
  <td class=xl54></td>
  <td class=xl48></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl38 style='height:15.75pt'></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl35>As at <%=l_date_to %></td>
  <td class=xl25></td>
  <td class=xl27></td>
 </tr>
 <%
  ...
  %>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl40 style='height:15.75pt'><%=l_colK_1%></td>
  <td colspan=2 class=xl39><%=l_colK_2%></td>
  <td colspan=2 class=xl64 x:str><span
 ...
 <tr class=xl56 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl65 x:str><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl66 style='border-right:.5pt solid black'>&nbsp;</td>
  <td colspan=2 class=xl69 style='border-left:none' x:str="  "><span
  style='mso-spacerun:yes'>    </span></td>
  <td class=xl49><!-----------------------------><!--END OF OUTPUT FROM EXCEL PUBLISH AS WEB PAGE WIZARD--><!-----------------------------></td>
 </tr>
