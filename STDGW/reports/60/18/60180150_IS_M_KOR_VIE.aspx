...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1050 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan=2 class=xl59 width=276 style='width:208pt'>Mẫu số: B03 - DN</td>
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=6 height=26 class=xl61 style='height:19.5pt'>INCOME STATEMENT /
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl42 x:str=" Month (01/2010) "><span style='mso-spacerun:yes'> 
  </span>Month (<%=l_curYYYY%>)<span style='mso-spacerun:yes'>  </span></td>
  <td class=xl43 width=138 style='width:104pt' x:str=" Month (01/2009) "><span
 ...
 <tr class=xl47 height=21 style='height:15.75pt'>
  <td height=21 class=xl49 style='height:15.75pt'><%=strBegin%><%= dt_detail.Rows[i][2].ToString() %><%=strEnd%></td>
