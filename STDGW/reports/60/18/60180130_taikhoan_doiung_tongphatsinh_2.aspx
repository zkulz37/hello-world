...
<table x:str border=0 cellpadding=0 cellspacing=0 width=995 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=5 height=30 class=xl52 style='height:22.5pt'>TÀI KHOẢN ĐỐI ỨNG TỔNG PHÁT SINH CÓ</td>
  <td class=xl24></td>
 </tr>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl40 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><span style='mso-spacerun:yes'></span><%= p_open_bal_cr_xls%><span style='mso-spacerun:yes'></span></td>
  <td class=xl24></td>
 </tr>
  <%			
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl43 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><span style='mso-spacerun:yes'></span><%= p_credit_xls %></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl40 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><font color="#FF0000" style='mso-ignore:color'><span style='mso-spacerun:yes'>  </span><%= p_close_bal_cr_xls %></font></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
