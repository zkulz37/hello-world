...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1217 style='border-collapse:
 ...
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  style='mso-spacerun:yes'> </span>Form number: S03a						
</td>
 </tr>
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td class=xl26></td>
  <td class=xl31 colspan=4 align=left style='mso-ignore:colspan'  >(Issued with Decision No. 15/2006/QĐ-BTC			
<span  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td colspan=4 height=21 class=xl68 style='height:15.75pt'>Tax code:<%= p_cmp_taxcode %></td>
  <td class=xl24></td>
  <td class=xl31 colspan=4 align=left style='mso-ignore:colspan'>dated March 20, 2006 by Ministry of Finance)			
</td>
 </tr>
 <tr height=30 style='height:22.5pt'>
  <td colspan=8 height=30 class=xl70 style='height:22.5pt' >LEDGER<span style='mso-spacerun:yes'> </span></td>
  <td class=xl25></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=8 height=26 class=xl71 style='height:19.5pt'>From date <%= p_dt_from %>
  to date <%= p_dt_to %></td>
  <td class=xl25></td>
 </tr>
 ...
 <tr class=xl33 height=21 style='height:15.75pt'>
  ...
  <td class=xl67 id="_x0000_s1034" x:autofilter="all"></td>
 </tr>
 <tr class=xl31 height=21 style='height:15.75pt'>
 ...
 <tr class=xl31 >
  ...
  <td class=xl56 align=left width=292 style='border-left:none;width:219pt'><%=dt_detail.Rows[i][11].ToString()%></td>
 </tr>
 <% }
 else
{ %>
 <tr class=xl31>
  ...
  <td class=xl57 align=left width=292 style='width:219pt'><%=dt_detail.Rows[i][11].ToString()%></td>
 </tr>
 <%
			}
		}
...
<span style='mso-spacerun:yes'> </span></td>
 ...
 <tr class=xl31 height=21 style='height:15.75pt'>
  ...
  <td class=xl51>&nbsp;</td>
  <td class=xl52>&nbsp;</td>
  <td class=xl53 width=292 style='width:219pt'>Closing Balance</td>
 ...
 <tr class=xl31 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl71>Date <%= l_date_to.Substring(6, 2) %> month <%= l_date_to.Substring(4, 2) %> year <%= l_date_to.Substring(0, 4) %></td>
  <td class=xl31></td>
 </tr>
<%
    SQL = "SELECT   " +
