...
<%
	...
	SQL = SQL +  "   FROM TAC_ABDEPOMT C, TCO_BUSPARTNER B";
	...
	= "select tb.seq, tb.voucherno, tb.voucherno_app, max(tb.buspartner_lnm) buspartner_lnm, max(tb.remark2) remark2,    " + 
        ...
        "  ac_get_accd(a.tac_abacctcode_pk, '" + p_compk + "') ac_dr, '' ac_cr,   " +
        ...
        "  (select p.partner_id from tco_buspartner p,  tfn_eppaytr e where e.tfn_eppaytrh_pk = t.pk and e.del_if = 0 and  p.pk = e.tco_buspartner_pk and rownum=1 ) partner_id      " +
        ...
        "  ac_get_accd(a.tac_abacctcode_pk, '" + p_compk + "') ac_cr,    " +
