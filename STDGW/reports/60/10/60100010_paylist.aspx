...
<%
    ...
    string p_approve            = ""+ Request["l_approve"];
    string p_date               = "";
    string p_cmp_name           = "";
    string p_cmp_add            = "";
    string p_cmp_taxcode        = "";
    string p_bal_opt = Request["bal_opt"];
    string p_current_dt = DateTime.Today.ToShortDateString();
    float  p_famt   = 0;
	float  p_amt    = 0;
/*            "          UNION " +
            ...
            "                 AND a.table_nm = 'TAC_EMPADVREQ' AND a.table_pk = b.pk " +
            "                 AND b.charger_pk = c.pk AND a.confirm_yn = '"+p_approve+"' " +
    ...
    if (p_bal_opt == "0")
    {
        SQL = "SELECT   seq, voucherno, prps_date, appr_date, appr_no, customer, tr_ccy " +
            "       , SUM(tr_famt) tr_famt, SUM(tr_amt) tr_amt,serial_no,invoice_no ,invoice_date, due_date, tr_remark " +
            ...
            "               , DECODE(h.tr_date_seq, '', '', h.tr_date_seq) appr_no " +
            ...
            "               , t.tr_remark, t.tr_remark2, t.reject_remark , t.invoice_no, t.serial_no " +
            "            FROM tfn_eppay t, tac_hgtrh h, tac_hgtrd d " +
            "           WHERE d.tac_hgtrh_pk = h.pk AND t.tac_hgtrd_pk = d.pk " +
            "                 AND t.del_if = 0 AND h.del_if = 0 AND d.del_if = 0 " +
    ...
    else if(p_bal_opt=="1")    
    {
        SQL = "SELECT   seq, voucherno, prps_date, appr_date, appr_no, customer, tr_ccy " +
            ...
            "                                                                     customer " +
            "               , a.tr_ccy, NVL(a.tr_famt, 0), NVL(a.tr_amt, 0), a.pay_date " +
            "               , b.req_date, a.tr_remark, a.tr_remark2, a.reject_remark , a.invoice_no, a.serial_no  " +
            "            FROM tfn_eppay a, tac_empadvreq b, tac_employee_adv c " +
            "           WHERE a.del_if = 0 AND b.del_if = 0 AND c.del_if = 0 " +
            "                 AND a.table_nm = 'TAC_EMPADVREQ' AND a.table_pk = b.pk " +
            "                 AND b.charger_pk = c.pk AND a.confirm_yn = '"+p_approve+"' " +
    ...
    else if (p_bal_opt == "2")
    {
        SQL = "SELECT   seq, voucherno, prps_date, appr_date, appr_no, customer, tr_ccy " +
            ...
            "                                                                     customer " +
            "               , a.tr_ccy, NVL(a.tr_famt, 0), NVL(a.tr_amt, 0), a.pay_date " +
            "               , b.req_date, a.tr_remark, a.tr_remark2, a.reject_remark , t.invoice_no, t.serial_no " +
            "            FROM tfn_eppay a, tac_empadvreq b, tac_employee_adv c " +
            "           WHERE a.del_if = 0 AND b.del_if = 0 AND c.del_if = 0 " +
            "                 AND a.table_nm = 'TAC_EMPADVREQ' AND a.table_pk = b.pk " +
            "                 AND b.charger_pk = c.pk AND a.confirm_yn = '"+p_approve+"' " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1795 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=18 height=30 class=xl48  style='height:22.5pt;
  width:1066pt'>PAYABLE LIST</td>
 </tr>
 <tr class=xl25 height=20 style='height:15.0pt'>
  <td colspan=18 height=20 class=xl49 width=1422 style='height:15.0pt;
 ...
 <tr class=xl25 height=20 style='height:15.0pt'>
  ...
  <td rowspan=2 class=xl43 width=75 style='width:56pt'>Serial </td>
  <td rowspan=2 class=xl43 width=75 style='width:56pt'>NoInvoice No</td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=7 class=xl58 width=613 style='border-right:.5pt solid black;
...
%>
 <tr height=40 style='height:30.0pt'>
  <td height=40 class=xl38 width=64 style='height:30.0pt;width:48pt' x:num><%= dt3.Rows[i]["seq"].ToString()%></td>
  <td class=xl39 width=88 style='border-left:none;width:66pt'><%= dt3.Rows[i]["voucherno"].ToString()%></td>
  <td class=xl38 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["prps_date"].ToString()%></td>
  <td class=xl38 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["appr_date"].ToString()%></td>
  <td class=xl40 width=44 style='border-left:none;width:33pt'><%= dt3.Rows[i]["appr_no"].ToString()%></td>
  <td class=xl40 width=0 style='border-left:none'>&nbsp;</td>
  <td class=xl40 width=0 style='border-left:none'>&nbsp;</td>
  <td class=xl39 width=201 style='border-left:none;width:151pt'><%= dt3.Rows[i]["customer"].ToString()%></td>
  <td class=xl38 width=49 style='border-top:none;border-left:none;width:37pt'><%= dt3.Rows[i]["tr_ccy"].ToString()%></td>
  <td class=xl41 width=110 style='border-left:none;width:83pt' x:num><%= dt3.Rows[i]["tr_famt"].ToString()%></td>
  
  <td class=xl61 width=103 style='border-left:none;width:77pt' x:num><%= dt3.Rows[i]["tr_amt"].ToString()%></td>
  <td class=xl39 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["serial_no"].ToString()%></td>
  <td class=xl39 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["invoice_no"].ToString()%></td>
  <td class=xl40 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["invoice_date"].ToString()%></td>
  <td class=xl40 width=75 style='border-left:none;width:56pt'><%= dt3.Rows[i]["due_date"].ToString()%></td>
  <td class=xl39 width=204 style='border-left:none;width:153pt'><%= dt3.Rows[i]["tr_remark"].ToString()%></td>
  <td class=xl39 width=215 style='border-left:none;width:161pt'><%= dt3.Rows[i]["reject_remark"].ToString()%></td>
...
%>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl42 width=110 style='border-top:none;border-left:none;width:83pt'
  x:num></td>
  <td class=xl62 width=103 style='border-top:none;border-left:none;width:77pt'
  x:num><%=l_sum_book_cust%></td>
  <td colspan=7 class=xl58 width=613 style='border-right:.5pt solid black;
  border-left:none;width:459pt'>&nbsp;</td>
 </tr> 
