...
<% 
    ...
    SQL = 	" select voucherno, trans_dt, item_code, item_name, uom," +
			...
			" round((ap_tramt+imp_amt+nvl(books_amt_allocate,0))/ap_qty,0) unitprice ,imp_amt,imp_famt,tr_date_ord,ac_nm" + 
			" from ( " +
            ...
            "    p.partner_name, a.invoice_no, to_char(to_date(a.invoice_date, 'YYYYMMDD'), 'DD/MM/YYYY') invoice_date, a.remark2, c.ac_cd,c.ac_nm, w.wh_name, d.po_no slip_no,round(nvl(d.ap_trfamt,0) + nvl(d.impvat_famt,0)) total_trans,round(nvl(d.ap_tramt,0)+nvl(d.impvat_amt,0)) total_book,a.tr_date as tr_date_ord,  " +
            ...
            "and (d.tco_item_pk like '" + p_item_pk + "' or '" + p_item_pk + "' is null ) " +
			...
			"and (a.invoice_no like '" + p_invoice_no + "' or '" + p_invoice_no + "' is null ) " +
            " ) order by tr_date_ord ";//,ac_cd, item_code  
			//Response.Write(SQL);
        //Response.End();
		DataTable dtItem;		
		para="'" + ls_std_ym + "','" + ls_std_ym_to  + "','" + ls_tco_company_pk + "','" + ls_tin_warehouse_pk + "' ,'" + ls_ac_cd + "','" + p_plcenter_pk + "','" + p_item_pk + "','" + p_voucherno + "','" + p_cust_pk + "','" + p_takein_no + "','" + p_invoice_no + "'";
		 dtItem = ESysLib.TableReadOpenCursor("ac_rpt_60090140_accrued",para);
		//Response.Write(para);
        //Response.End();	
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1716 style='border-collapse:
 ...
 <col class=xl65 width=80 style='mso-width-source:userset;mso-width-alt:3413;
 width:60pt'>
 <col class=xl65 width=378 style='mso-width-source:userset;mso-width-alt:7224;
 width:130'>
 <col class=xl65 width=0 style='display:none;mso-width-source:userset;
 mso-width-alt:5077'>
 <col class=xl65 width=0 style='display:none;mso-width-source:userset;
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl65 width=80 style='width:60pt'></td>
  <td class=xl65 width=378 style='width:260'></td>
  <td class=xl65 width=0></td>
  <td class=xl65 width=0></td>
 </tr>
 ...
 <tr class=xl74 height=65 style='mso-height-source:userset;height:48.75pt'>
  ...
  <td class=xl75>Acc No</td>
  <td class=xl75>Acc Name</td>
...
%>
 <tr class=xl74 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl87><%=dtItem.Rows[i]["ac_cd"] %></td>
  <td class=xl90><%=dtItem.Rows[i]["ac_nm"] %></td>
 ...
 <tr class=xl74 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl90><%=dtItem.Rows[i][16] %></td>
  <td class=xl87><%=dtItem.Rows[i]["ac_cd"] %></td>
  <td class=xl87><%=dtItem.Rows[i]["ac_nm"] %></td>
  <td class=xl89><%=dtItem.Rows[i][17] %></td>
  <td class=xl89><%=dtItem.Rows[i][19] %></td>
 </tr>
 <% 
