...
<%
 ...
 sSQL
    = "select (select w.wh_name from tlg_in_warehouse w where rownum = 1 and w.pk in (select d.tlg_in_warehouse_pk  " + 
 ...
 sSQL1
	= " SELECT b.item_code || '    :   ' ||b.item_name, a.ap_unit, to_char (a.ap_qty, '999,999,999,999,990.99'),   " + 
        ...
        "  from tac_crdad a, tlg_it_item b, tac_crda c " +
        " where a.del_if = 0 and a.tlg_it_item_pk=b.pk and a.tac_crda_pk = '" + pk + "' and a.tac_crda_pk = c.pk " +
