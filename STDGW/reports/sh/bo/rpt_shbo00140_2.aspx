...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2010-03-30T04:26:34Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=876 style='border-collapse:
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=13 height=30 class=xl36 width=876 style='height:22.5pt;
  width:658pt'>Colorant Packing Instruction and Record Batch No. Civil Official Book</td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 colspan=9 class=xl25 style='height:18.0pt;mso-ignore:colspan'></td>
  <td class=xl26></td>
  <td colspan=2 class=xl38>Date<font class="font9"><span
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td colspan=2 class=xl38>Page<font class="font9"> :<span
 ...
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  <td colspan=2 height=29 class=xl31 style='height:21.75pt'>Issued Date</td>
  <td colspan=2 class=xl32>Entered Date</td>
  <td colspan=2 class=xl31>Batch No.</td>
  <td colspan=2 class=xl31>Batch Q'ty</td>
  <td colspan=3 class=xl31>Total Instructed Q'ty</td>
  ...
  <%
     ...
     for (int i = 0; i < dt1.Rows.Count; i++)
     {
        ...
        %>
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  <td colspan=2 height=29 class=xl35 style='height:21.75pt'><%=dt1.Rows[i][1] %></td>
  <td colspan=2 class=xl35><%=dt1.Rows[i][2] %></td>
  <td colspan=2 class=xl35><%=dt1.Rows[i][3] %></td>
  <td colspan=2 class=xl33 x:num><%=dt1.Rows[i][4] %></td>
  <td colspan=3 class=xl33 x:num><%=total2 %></td>
 ...
 <tr height=27 style='mso-height-source:userset;height:20.25pt'>
  ...
  <td colspan=2 class=xl29>Total</td>
  <td colspan=2 class=xl30 x:num><%=total1 %></td>
  <td colspan=3 class=xl30 x:num><%=total2 %></td>
  <td colspan=2 class=xl28>&nbsp;</td>
 </tr>
