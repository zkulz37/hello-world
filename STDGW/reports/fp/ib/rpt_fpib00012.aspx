...
<body link="blue" vlink="purple">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="947" style='border-collapse: collapse;
        table-layout: fixed; width: 712pt'>
        ...
        <tr height="30" style='mso-height-source: userset; height: 22.5pt'>
            <td height="30" class="xl24" colspan="12" width="270" style='height: 22.5pt; mso-ignore: colspan;
                width: 203pt'>
                Style : <font class="font6">
                    <%=strStyle%>
                </font>
            </td>
        </tr>
        <tr height="30" style='mso-height-source: userset; height: 22.5pt'>
            <td height="30" class="xl30" style='height: 22.5pt; border-top: none'>
                W/P ID</td>
            <td class="xl28">
                W/P Name</td>
            <td class="xl28">
            ...
            <td class="xl35" style='border-top: none; border-left: none'>
                Task ID</td>
            <td class="xl36" width="77" style='width: 100pt'>
                Task Name</td>
            <td class="xl28">
                ST Time</td>
            <td class="xl35" style='border-top: none; border-left: none'>
        ...
        <%
            DataTable dt, dts;
            //dt = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpib00012", "'" + style_pk + "'", "'" + lang + "'");
            ...
            //---------------------
            int[] arrID_count = new int[50];
            int[] arrOpSeq_count = new int[50];
            //--------------------
            int strID_count = 1;
            int strOpSeq_count = 1;
            //-------------------- 
            int a = 0, b = 0;
            //------------------- W/P ID -------------------
            for (int y = 0; y < dt.Rows.Count; y++)
            {
                if (strID == "" || strID == null)
                {
                    strID = dt.Rows[y]["wp_id"].ToString();
                    strID_count = 1;
                }
                else
                {
                    if (dt.Rows[y]["wp_id"].ToString().Trim() != strID.Trim())
                    {
            ...
            {
                if (strOpSeq == "" || strOpSeq == null)
                {
                    strOpSeq = dt.Rows[z]["op_seq"].ToString();
                    strOpSeq_count = 1;
                }
                else
                {
                    if (dt.Rows[z]["op_seq"].ToString().Trim() != strOpSeq.Trim())
                    {
                        arrOpSeq_count[b] = strOpSeq_count;
                        strOpSeq_count = 1;
                        b++;
                        strOpSeq = dt.Rows[z]["op_seq"].ToString();
                    }
        ...
        <tr height="15" style='mso-height-source: userset; height: 11.25pt'>
            <td height="15" class="xl33" style='height: 11.25pt'>
            </td>
            <td class="xl34">
            </td>
            <td class="xl34" style='border-left: none'>
            </td>
            <td class="xl34" style='border-left: none'>
            </td>
            <td class="xl34" style='border-left: none'>
            ...
            <td class="xl33" style='border-left: none'>
            </td>
            <td class="xl34">
            </td>
            <td class="xl42" align="right" x:num>
                <%=StTime%>
            </td>
        ...
        <tr height="17" style='height: 12.75pt'>
            <%
                ...
                {
            %>
            <td rowspan="<%=arrID_count[a]%>" height="17" class="xl40" style='height: 12.75pt;
                border-top: none'>
                <%=dt.Rows[i]["wp_id"]%>
            </td>
            <td rowspan="<%=arrID_count[a]%>" class="xl37" width="193" style='border-left: none'>
                <%=dt.Rows[i]["wp_name"]%>
            </td>
            <td rowspan="<%=arrID_count[a]%>" class="xl38" align="right" style='border-left: none'
                x:num>
                <%=dt.Rows[i]["avg_time"]%>
            </td>
            <% 
            ...
            <%
                ...
                { 
            %>
            <td rowspan="<%=arrOpSeq_count[b]%>" class="xl40" align="right" style='border-left: none'
                x:num>
                <%=dt.Rows[i]["op_seq"]%>
            </td>
            <td rowspan="<%=arrOpSeq_count[b]%>" class="xl38" align="right" style='border-left: none'
                x:num>
                <%=dt.Rows[i]["op_time"]%>
            </td>
            <% 
            ...
            %>
            <td class="xl40" align="right" style='border-left: none' x:num>
                <%=dt.Rows[i]["task_seq"]%>
            </td>
            <td class="xl38" align="right" style='border-left: none' x:num>
                <%=dt.Rows[i]["task_time"]%>
            </td>
            <td class="xl40" style='border-left: none'>
                <%=dt.Rows[i]["task_id"]%>
            </td>
            ...
            <td class="xl39" align="right" x:num>
                <%=dt.Rows[i]["point_time"]%>
            </td>
        </tr>
        <%
            }
