...
<% 
    ...
    DataTable dt, dt1;
    dt = ESysLib.TableReadOpenCursor("LG_RPT_FPFA00300", "'" + master_pk + "'");
    dt1 = ESysLib.TableReadOpenCursor("LG_RPT_FPFA00300_1", "'" + master_pk + "'");       
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1678 style='border-collapse:
 ...
 <tr class=xl24 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  width:827pt'>REPORT CUTTING W/I</td>
 </tr>
 <tr class=xl24 height=39 style='mso-height-source:userset;height:29.25pt'>
 ...
 <tr class=xl24 height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  <td class=xl46 rowspan=2>*WI<%= dt.Rows[0]["slip_no"]%>*</td>
  <td class=xl24></td>
 </tr>
