...
<% 
    ...
    DataTable dt, dt1;
    dt = ESysLib.TableReadOpenCursor("LG_RPT_FPFA00370", "'" + master_pk + "'");
    dt1 = ESysLib.TableReadOpenCursor("LG_RPT_FPFA00370_1", "'" + master_pk + "'");       
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1678 style='border-collapse:
 ...
 <tr class=xl24 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  width:827pt'>REPORT CUTTING ITEM OUT REQ</td>
 </tr>
 <tr class=xl24 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  class="font8"> </font><font class="font7">Date:</font><font class="font8"> </font><font
  class="font9"><%= dt.Rows[0]["wi_fr_date"]%> ~ <%= dt.Rows[0]["wi_to_date"]%></font></td>
 </tr>
 <tr class=xl24 height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  <td class=xl46 rowspan=2>*REQ<%= dt.Rows[0]["slip_no"]%>*</td>
  <td class=xl24></td>
 </tr>
 ...
 <tr class=xl24 height=59 style='mso-height-source:userset;height:44.25pt'>
  ...
  <td class=xl37 x:num><%= dt1.Rows[i]["wi_qty"] %></td>
