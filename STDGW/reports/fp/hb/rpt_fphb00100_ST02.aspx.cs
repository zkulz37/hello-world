...
public partial class rpt_fphb00100_ST02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fphb00100_ST02.xls";
        string TempFile = "../../../system/temp/rpt_fphb00100_ST02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fphb00100_ST02", para);	
        ...
        for (i = 0; i < dtDetail.Rows.Count; i++)
        {
			...
			exSheet.Cells[l_pos+i,11].Value = dtDetail.Rows[i]["PUR_PRICE"]; 
			exSheet.Cells[l_pos+i,12].Value = dtDetail.Rows[i]["item_amount"]; 
			exSheet.Cells[l_pos+i,13].Value = dtDetail.Rows[i]["description"]; 			 
        }
