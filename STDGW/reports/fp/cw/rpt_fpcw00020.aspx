...
<%        
    ...
    dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fpcw00020", l_array_wi_pk);    

    /*****************************************************************/
    string p_po_no = "", p_cust_name = "" ,  p_group = "" , p_size = "" , p_style_no = "", p_style_name = "" , p_t_a = "" , p_leather = "" ;


    dt_master = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fpcw00020_1", l_array_wi_pk);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1253 style='border-collapse:
 ...
 <% 
  ...
  <%} %>
  <td class=xl24 style='border-top:none;border-left:none'>aaa<%=dt.Rows[i]["component"].ToString()%></td>
