...
<%    
    ...
    DataTable  dt1, dt2;
    dt1 = ESysLib.TableReadOpenCursor("lg_rpt_fppr00022_dorco", para);
    dt2 = ESysLib.TableReadOpenCursor("lg_rpt_fppr00022_1_dorco", para);
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1230 style='border-collapse:
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=4 rowspan=2 class=xl79>PHIẾU NHẬP KHO</td>
  <td class=xl36></td>
 ...
 <tr height=83 style='mso-height-source:userset;height:62.25pt'>
  ...
  <td class=xl60 width=68 style='width:51pt'><%= dt2.Rows[i]["in_uom"]%></td>
  <td class=xl61 width=86 style='width:65pt' x:num><%= dt2.Rows[i]["in_qty"]%></td>
