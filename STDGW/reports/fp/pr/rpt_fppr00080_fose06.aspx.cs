...
public partial class rpt_fppr00080_fose06 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fppr00080_fose06.xls";
        string TempFile = "../../../system/temp/rpt_fppr00080_fose06_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose06" , para);
