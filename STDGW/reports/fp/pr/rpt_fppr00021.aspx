...
<%    
    ...
    dt1 = ESysLib.TableReadOpenCursor("lg_rpt_fppr00020_1", para);
    dt2 = ESysLib.TableReadOpenCursor("lg_rpt_fppr00020_2", para);
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="rpt_fppr00021(1)_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_fppr00021(1)_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_fppr00021(1)_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2011-11-24T02:12:12Z</o:LastPrinted>
  <o:Created>2011-11-15T06:42:07Z</o:Created>
  <o:LastSaved>2011-11-24T02:12:17Z</o:LastSaved>
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>Prod Incoming Slip</x:Name>
    <x:WorksheetOptions>
     <x:Print>
      <x:ValidPrinterInfo/>
      <x:Scale>85</x:Scale>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1049 style='border-collapse:
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:51px'><img width=107 height=51
  src="rpt_fppr00021(1)_files/image002.jpg" v:shapes="_x0000_s8193"></span><![endif]><span
 ...
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  class="font8">SX </font><font class="font14">(PROD INCOMING)</font></td>
 ...
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td class=xl38 style='border-top:none;border-left:none'><%=dt1.Rows[0]["prod_dd"] %>/<%=dt1.Rows[0]["prod_mm"] %>/<%=dt1.Rows[0]["prod_yy"] %></td>
  <td colspan=2 class=xl33 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl72 width=120 style='height:22.5pt;width:91pt'>Chuy&#7873;n
  SX<font class="font7"> Line</font></td>
  <td colspan=2 class=xl67><%=dt1.Rows[0]["line_name"] %></td>
  <td colspan=2 class=xl69>Kho<font class="font7"> </font><font class="font6">nh&#7853;p</font><font
  class="font7"> In W/H</font><font class="font5"><span
  style='mso-spacerun:yes'></span></font></td>
  <td colspan=2 class=xl66><%=dt1.Rows[0]["wh_name"] %></td>
  <td class=xl39></td>
  <td class=xl29></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=2 class=xl70>S&#7889; P/O <font class="font7">PO No</font></td>
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  &#272;&#7889;i chi&#7871;u<font class="font5"><br>
    Ref No.</font></td>
  <td class=xl62 width=90 style='border-top:none;border-left:none;width:68pt'>Mã Hàng<br>
    <font class="font7">Item Code</font></td>
  <td class=xl62 width=280 style='border-top:none;border-left:none;width:210pt'>Tên Hàng<br>
  ...
  <td class=xl65 width=95 style='border-top:none;border-left:none;width:71pt'>Số lượng<font class="font7"><br>
    Quantity</font></td>
  <td class=xl65 width=95 style='border-top:none;border-left:none;width:71pt'>Số Lô<br>
    <font class="font7">Lot No</font></td>
  <td class=xl61 width=100 style='border-top:none;border-left:none;width:75pt'>Ghi Chú <br>
 ...
 <%
     ...
     {
         total = total + CommondLib.ConvertToDbl(dt2.Rows[i]["in_qty"]);
        %>
<tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl43 width=90 style='border-left:none;width:68pt' x:num><%=dt2.Rows[i]["item_code"] %></td>
  <td class=xl44 width=280 style='border-left:none;width:210pt'><%=dt2.Rows[i]["item_name"] %></td>
  <td class=xl43 width=50 style='border-left:none;width:38pt'><%=dt2.Rows[i]["uom"] %></td>
  <td class=xl45 width=95 style='border-top:none;border-left:none;width:71pt'
  x:num><%=dt2.Rows[i]["in_qty"] %></td>
  <td class=xl43 width=95 style='border-top:none;border-left:none;width:71pt'><%=dt2.Rows[i]["lot_no"] %></td>
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  ...
  c&#7897;ng <font class="font12">Total</font></td>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  colspan-rowspan;height:110.25pt;width:465pt'><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="rpt_fppr00021(1)_files/image003.gif" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=421 height=127 src="rpt_fppr00021(1)_files/image003.gif"
