...
<%    
	...
	string to_date = p_to_date.Substring(6, 2) + "/" + p_to_date.Substring(4, 2) + "/" + p_to_date.Substring(0, 4);
	
    string factory_pk = Request.QueryString["factory_pk"];
    string factory_name = Request.QueryString["factory_name"];	
	
	string para = "'" + p_from_date + "','" + p_to_date + "','" + factory_pk + "'";
	
    DataTable dt;
    dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fppr00094_1", para); 	
...
<link rel=File-List href="rpt_fppr00094_1_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_fppr00094_1_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_fppr00094_1_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2011-01-18T07:23:55Z</o:LastSaved>
...
.xl27
	...
	border-bottom:1.0pt hairline windowtext;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1160 style='border-collapse:
 ...
 <col class=xl24 width=40 span=29 style='mso-width-source:userset;mso-width-alt:
 1462;width:30pt'>
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  <td colspan=29 height=37 class=xl25 width=1160 style='height:27.75pt;
  width:870pt'>PREPARATION STATUS BY LINE</td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl36 style='height:15.75pt'><%=factory_name%></td>
  <td colspan=18 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl25>Date</td>
  <td colspan=5 class=xl36><%=fr_date%>~<%=to_date%></td>
 </tr>
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl26 style='height:30.0pt;border-top:none'>Line</td>
  <td class=xl26 style='border-top:none;border-left:none'>P/O</td>
...
<%
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=40 class=xl32 style='height:30.0pt'><%=dt.Rows[i]["line_id"]%></td>
  <td rowspan=2 class=xl34><%=dt.Rows[i]["ref_po_no"]%></td>
...
%> 
 <tr height=13 style='height:9.75pt'>
  <td height=13 colspan=29 class=xl24 style='height:9.75pt;mso-ignore:colspan'></td>
 </tr>
