...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1030 style='border-collapse:
 ...
 <tr height=37 style='mso-height-source:userset;height:27.75pt'>
  ...
  width:785pt'>P/O LINE PREPARATION <%=p_page%></td>
 </tr>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl39 style='height:30.0pt;border-top:none'>P/O</td>
  <td class=xl26>Style</td>
  <td class=xl26>Spec</td>
  <td class=xl26>Ord Plan</td>
  <td class=xl26>Cut Qty</td>
  <td class=xl26>Pre Target</td>
  <td class=xl26>Sew Qty</td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:30.0pt'><%=dt.Rows[i]["ref_po_no"]%></td>
  <td rowspan=2 class=xl32 style='border-bottom:.5pt solid black'><%=dt.Rows[i]["item_code"]%></td>
  <td rowspan=2 class=xl32 style='border-bottom:.5pt solid black'><%=dt.Rows[i]["spec_id"]%></td>
  <td rowspan=2 class=xl34 style='border-bottom:.5pt solid black' x:num><%=dt.Rows[i]["ord_target"]%></td>
  <td rowspan=2 class=xl34 style='border-bottom:.5pt solid black' x:num><%=dt.Rows[i]["cut_qty"]%></td>
  <td rowspan=2 class=xl34 style='border-bottom:.5pt solid black' x:num><%=dt.Rows[i]["daily_target"]%></td>
