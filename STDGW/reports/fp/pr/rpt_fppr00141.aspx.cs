...
public partial class reports_rpt_fppr00141 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fppr00141.xls";
        string TempFile = "../../../system/temp/rpt_fppr00141_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtHeader = ESysLib.TableReadOpenCursor("lg_rpt_fppr00141_1"   , para);
		
        para = "'" + p_wh_pk + "','" + p_from_date + "','" + p_to_date + "','" + p_ref_no_line + "','" + p_item + "'";
	
        DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00141" , para);
