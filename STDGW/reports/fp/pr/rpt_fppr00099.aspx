...
<%
	DataTable dt_header;
    dt_header = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fppr00099_1");
	...
	DataTable dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fppr00099", _para);
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=964 style='border-collapse:
 ...
 <tr height=43 style='mso-height-source:userset;height:32.25pt'>
  ...
  width:495pt'>PREPARATION REPORT</td>
 ...
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
  ...
  <td colspan=2 class=xl37 style='border-left:none'>Sewing</td>
 </tr>
 <tr height=18 style='mso-height-source:userset;height:13.5pt'>
...
<% 
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  <td class=xl64 style='border-bottom:2.0pt double black;border-top:none;border-left:none' x:num><%=s_cut_wh%></td>
  <td class=xl64 style='border-bottom:2.0pt double black;border-top:none' x:num ><%=s_total_cut_out_qty%></td>
  ...
  <td class=xl64 style='border-bottom:2.0pt double black;background:#CCFFFF;border-top:none;border-left:none' x:num><%=s_pre_wh%></td>
  <td class=xl64 style='border-bottom:2.0pt double black;background:#CCFFFF;border-top:none' x:num><%=s_total_pre_out_qty%></td>
...
<%	
		...
		s_sew_in_line  		= s_sew_in_line  	  + Convert.ToInt32(dt.Rows[i]["sew_in_line"].ToString()       ) ;		
...
%>
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none;border-left:none' x:num><%=dt.Rows[i]["cut_in_line"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none' x:num><%=dt.Rows[i]["total_cut_qty"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none;border-left:none' x:num><%=dt.Rows[i]["cut_wh"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none' x:num><%=dt.Rows[i]["total_cut_out_qty"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;background:#CCFFFF;border-top:none;border-left:none' x:num><%=dt.Rows[i]["pre_in_line"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;background:#CCFFFF;border-top:none' x:num><%=dt.Rows[i]["total_pre_qty"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;background:#CCFFFF;border-top:none;border-left:none' x:num><%=dt.Rows[i]["pre_wh"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;background:#CCFFFF;border-top:none' x:num><%=dt.Rows[i]["total_pre_out_qty"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none;border-left:none' x:num><%=dt.Rows[i]["sew_in_line"]%></td>
  <td class=xl62 style='border-bottom:.5pt solid black;border-top:none' x:num><%=dt.Rows[i]["sew_qty"]%></td>
