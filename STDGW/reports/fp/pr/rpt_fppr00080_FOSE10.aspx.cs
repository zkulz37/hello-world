...
public partial class rpt_fppr00080_FOSE10 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fppr00080_FOSE10.xls";
        string TempFile = "../../../system/temp/rpt_fppr00080_FOSE10_" + Session["User_ID"].ToString() + ".xls";
		...
		int pos = 7 ;
		int i   = 0  ;		  						
		DataTable dtHeader = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose10_1_hd" , para);
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose10_1_dt" , para);
	//xSheet.Cells["C10"].Value = para;
		for (int idx = 0; idx < dtHeader.Rows.Count; idx++){
			exSheet.Cells[6,4 + idx].Value = dtHeader.Rows[idx][0];
		}
        ...
        {								
			...
			exSheet.Cells[pos + i, 3 ].Value = "=SUM(D"+(pos+i)+":BA"+(pos+i)+")";
			
			exSheet.Cells[pos + i, 4 ].Value = dtDetail.Rows[i]["cl01"];			
			exSheet.Cells[pos + i, 5 ].Value = dtDetail.Rows[i]["cl02"];	
			
			exSheet.Cells[pos + i, 6 ].Value = dtDetail.Rows[i]["cl03"];	
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["cl04"];	
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["cl05"];	 
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["cl06"];		
			exSheet.Cells[pos + i,10 ].Value = dtDetail.Rows[i]["cl07"];	 			
			exSheet.Cells[pos + i,11 ].Value = dtDetail.Rows[i]["cl08"];	
			exSheet.Cells[pos + i,12 ].Value = dtDetail.Rows[i]["cl09"];	
	
			exSheet.Cells[pos + i,13 ].Value = dtDetail.Rows[i]["cl10"];	 
			exSheet.Cells[pos + i,14 ].Value = dtDetail.Rows[i]["cl11"];	
			exSheet.Cells[pos + i,15 ].Value = dtDetail.Rows[i]["cl12"];	 

			exSheet.Cells[pos + i,16 ].Value = dtDetail.Rows[i]["cl13"];	
			exSheet.Cells[pos + i,17 ].Value = dtDetail.Rows[i]["cl14"];	
			exSheet.Cells[pos + i,18 ].Value = dtDetail.Rows[i]["cl15"];	
			exSheet.Cells[pos + i,19 ].Value = dtDetail.Rows[i]["cl16"];	
			exSheet.Cells[pos + i,20 ].Value = dtDetail.Rows[i]["cl17"];	
			exSheet.Cells[pos + i,21 ].Value = dtDetail.Rows[i]["cl18"];	
			exSheet.Cells[pos + i,22 ].Value = dtDetail.Rows[i]["cl19"];	
			exSheet.Cells[pos + i,23 ].Value = dtDetail.Rows[i]["cl20"];	
			
			exSheet.Cells[pos + i,24 ].Value = dtDetail.Rows[i]["cl21"];	
			exSheet.Cells[pos + i,25 ].Value = dtDetail.Rows[i]["cl22"];	
			exSheet.Cells[pos + i,26 ].Value = dtDetail.Rows[i]["cl23"];	
			exSheet.Cells[pos + i,27 ].Value = dtDetail.Rows[i]["cl24"];	
			exSheet.Cells[pos + i,28 ].Value = dtDetail.Rows[i]["cl25"];	
			exSheet.Cells[pos + i,29 ].Value = dtDetail.Rows[i]["cl26"];	
			exSheet.Cells[pos + i,30 ].Value = dtDetail.Rows[i]["cl27"];	
			exSheet.Cells[pos + i,31 ].Value = dtDetail.Rows[i]["cl28"];	
			exSheet.Cells[pos + i,32 ].Value = dtDetail.Rows[i]["cl29"];	
			exSheet.Cells[pos + i,33 ].Value = dtDetail.Rows[i]["cl30"];	
			exSheet.Cells[pos + i,34 ].Value = dtDetail.Rows[i]["cl31"];	
			exSheet.Cells[pos + i,35 ].Value = dtDetail.Rows[i]["cl32"];	
			exSheet.Cells[pos + i,36 ].Value = dtDetail.Rows[i]["cl33"];	
			exSheet.Cells[pos + i,37 ].Value = dtDetail.Rows[i]["cl34"];	
			exSheet.Cells[pos + i,38 ].Value = dtDetail.Rows[i]["cl35"];	
			exSheet.Cells[pos + i,39 ].Value = dtDetail.Rows[i]["cl36"];	
		...
		pos = 7 ;
		i   = 0 ;		  						
		dtHeader = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose10_2_hd" , para);
		dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose10_2_dt" , para);
		...
		dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose10_3_dt" , para);
