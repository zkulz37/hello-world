...
public partial class rpt_fppr00080_fose09 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fppr00080_fose09.xls";
        string TempFile = "../../../system/temp/rpt_fppr00080_fose09_" + Session["User_ID"].ToString() + ".xls";
      ...
      string 	p_from_dt = Request.QueryString["p_from_dt"];
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fppr00080_fose09" , para);
