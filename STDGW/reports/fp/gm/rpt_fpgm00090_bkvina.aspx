...
<%
    ...
    string _prod_date = _date.Substring(0, 4) + "/" + _date.Substring(4, 2) + "/" + _date.Substring(5, 2);
    string _process_pk = Request.QueryString["process_pk"];
    string _process_name = Request.QueryString["process_name"];

    DataTable dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fpgm00090_bkvina", _date, _process_pk);
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1344 style='border-collapse:
 ...
 <tr class=xl31 height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <td class=xl34><%=_process_name%></td>
  <td colspan=2 class=xl32 style='mso-ignore:colspan'></td>
  <td class=xl55></td>
