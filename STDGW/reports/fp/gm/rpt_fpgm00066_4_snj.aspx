...
<%
    ...
    dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_fpgm00066_4_snj", _date);
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=windows-1252">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="rpt_fpgm00066_3_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_fpgm00066_3_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_fpgm00066_3_files/oledata.mso">
<!--[if gte mso 9]><xml>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1465 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td height=30 class=xl43 style='height:22.5pt'></td>
  <td></td>
  <td colspan=5 class=xl75 style='border-right:.5pt solid black'>DAILY PRODUCTION REPORT</td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Prod. Qty</td>
   <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Shift 01</td>
    <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Shift 02</td>
    
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Defect</td>
  
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>B</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>C</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Cutter</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Meding</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Damage</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Back-Set</td>
  <td rowspan=2 class=xl71 style='border-bottom:.5pt hairline black'>Washing</td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  x:fmla="=SUM(J<%=_start_group %>:J<%=(_row-1) %>)"></td>
    <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(K<%=_start_group %>:K<%=(_row-1) %>)"></td>
   
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(L<%=_start_group %>:L<%=(_row-1)%>)"></td>
  
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(M<%=_start_group %>:M<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(N<%=_start_group %>:N<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(O<%=_start_group %>:O<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(P<%=_start_group %>:P<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(Q<%=_start_group %>:Q<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(R<%=_start_group %>:R<%=(_row-1)%>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(S<%=_start_group %>:S<%=(_row-1)%>)"></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["shift_01"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["shift_02"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["defect_qty"]%></td>
  
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["b_qty"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["c_qty"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["cutter"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["mending"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["damage"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["back_setting"]%></td>
  <td class=xl68 style='border-top:none;border-left:none' x:num><%=dt.Rows[i]["washing"]%></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(K<%=_start_group %>:K<%=(_row) %>)"></td>
  <td class=xl69 style='border-top:none;border-left:none' x:num
  x:fmla="=SUM(L<%=_start_group %>:L<%=(_row)%>)"></td>
  <td colspan=6 class=xl45 style='mso-ignore:colspan'></td>
