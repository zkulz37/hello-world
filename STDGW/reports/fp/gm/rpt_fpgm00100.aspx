...
<%
    ...
    DateTime date = Convert.ToDateTime(System.DateTime.ParseExact(p_date, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture).ToString("MM/dd/yyyy"));

	DataTable dt1;
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpgm00100", para);  
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="fpgm00100_files/filelist.xml">
<link rel=Edit-Time-Data href="fpgm00100_files/editdata.mso">
<link rel=OLE-Object-Data href="fpgm00100_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2011-03-07T08:16:16Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=950 style='border-collapse:
 ...
 <tr height=47 style='mso-height-source:userset;height:35.25pt'>
  ...
  height:95px'>
  <img width=84 height=60 src="..\..\..\system\binary\ViewFile.aspx?img_pk=<%=dt1.Rows[0]["tco_stitemphoto_pk"]%>&table_name=TCO_STITEMPHOTO" v:shapes="_x0000_s3073">
  </span><![endif]><span style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=3 rowspan=3 height=105 class=xl37 width=185 style='height:78.75pt;
    width:139pt'>&nbsp;</td>
   </tr>
  </table>
  </span></td>
  <td colspan=16 class=xl34 width=765 style='border-right:2.0pt double black;
  width:578pt'>Component
  Balance</td>
 </tr>
 <tr class=xl25 height=29 style='mso-height-source:userset;height:21.75pt'>
  <td colspan=5 height=29 class=xl46 style='height:21.75pt'><font class="font11">P/O No :</font><font
  class="font10"><%= dt1.Rows[0]["ref_po_no"] %></font></td>
  <td colspan=6 class=xl57 style='border-right:.5pt solid black'><font class="font11">Style :</font><font
  class="font10"><%= dt1.Rows[0]["style_name"] %></font></td>
  <td colspan=5 class=xl53 style='border-right:2.0pt double black'>Buyer :<font class="font10"><%= dt1.Rows[0]["partner_name"] %></font></td>
 </tr>
 <tr class=xl25 height=29 style='mso-height-source:userset;height:21.75pt'>
  <td colspan=5 height=29 class=xl62 style='border-right:.5pt solid black;
  height:21.75pt'><font class="font11">W/P
  Type:</font><font class="font10"><%= dt1.Rows[0]["wp_type"] %></font></td>
  <td colspan=3 class=xl60 style='border-right:.5pt solid black;border-left:
  none'><font class="font11">Spec :</font><font
  class="font10"><%= dt1.Rows[0]["spec"] %></font></td>
  <td colspan=3 class=xl60 style='border-right:.5pt solid black;border-left:
  none'><font class="font11">Target :</font><font
  class="font10"><%= dt1.Rows[0]["plan_qty"] %></font></td>
  <td colspan=5 class=xl55 style='border-right:2.0pt double black'><font class="font11">Date :</font><font
  class="font10"><%= dt1.Rows[0]["prod_date"] %>
  </font></td>
 </tr>
 <tr class=xl25 height=45 style='mso-height-source:userset;height:33.75pt'>
  ...
  <td width=100 style='width:75pt' align=left valign=top><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="fpgm00100_files/image003.png" o:title=""/>
  ...
  <td class=xl27 width=45 style='border-top:none;border-left:none;width:34pt'>BF<br>
    Qty</td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(0).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(1).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(2).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(3).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(4).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(5).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(6).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(7).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(8).ToString("dd-MMM") %></td>
  <td class=xl29 width=45 style='border-top:none;border-left:none;width:34pt'><%= date.AddDays(9).ToString("dd-MMM") %></td>
 ...
 <%
	...
	DataTable dt2;
    dt2 = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpgm00100_1", para);  
	int a = 0; 
	for( int i = 0; i < dt2.Rows.Count; i++)
	{
 %>
 <tr class=xl28 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td rowspan=2 height=50 class=xl65 style='border-bottom:2.0pt double navy;
  height:37.5pt;border-top:none' x:num><%= i+1 %></td>
  <td rowspan=2 class=xl51 width=60 style='border-bottom:2.0pt double navy;
  border-top:none;width:45pt'><%= dt2.Rows[i]["group_id"] %></td>
  <td rowspan=2 class=xl67 style='border-bottom:2.0pt double navy;border-top:
  ...
  <td rowspan=2 class=xl69 width=90 style='border-bottom:2.0pt double navy;
  border-top:none;width:68pt'><%= dt2.Rows[i]["comp_name"] %></td>
  <td rowspan=2 class=xl40 style='border-bottom:2.0pt double navy;border-top:
  none' x:num><%= dt2.Rows[i]["input_qty"] %></td>
  <td rowspan=2 class=xl49 style='border-bottom:2.0pt double navy;border-top:
  none' x:num><%= dt2.Rows[i]["req_qty"] %></td>
  <td rowspan=2 class=xl42 style='border-bottom:2.0pt double navy;border-top:
  ...
  <td rowspan=2 class=xl44 style='border-bottom:2.0pt double navy;border-top:
