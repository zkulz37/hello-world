...
<%
	...
	DataTable dt1;
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpip00030_1", para);  
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=10018 style='border-collapse:
 ...
 <col width=39 style='mso-width-source:userset;mso-width-alt:1826;width:29pt'>
 ...
 <%
	...
	{
 %>
 <tr rowspan="<%= arrRG_count[a] %>" class=xl28 height=65 style='mso-height-source:userset;height:48.75pt'>
             <%  if (strRG != dt1.Rows[i]["line_id"].ToString())
                {
            %> 
  <td height=65 class=<% if(i % 2 == 0)
				{ %>
				xl31
			 <%	}
				else
