...
<%
	...
	DataTable dt1;
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpip00040_1", para);  
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=10018 style='border-collapse:
 ...
 <col width=63 style='mso-width-source:userset;mso-width-alt:3304;width:47pt'>
 <col width=91 style='mso-width-source:userset;mso-width-alt:3328;width:68pt'>
 <col width=66 style='mso-width-source:userset;mso-width-alt:6413;width:50pt'>
 ...
 <tr class=xl28 height=65 style='mso-height-source:userset;height:48.75pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td>
	<img width=84 height=60 src="..\..\..\system\binary\ViewFile.aspx?img_pk=<%=dt1.Rows[i]["tco_stitemphoto_pk"]%>&table_name=TCO_STITEMPHOTO"  v:shapes="_x0000_s1025">
	</td>
   </tr>
   <tr>
    <td height=1></td>
