...
<%
	...
	DataTable dt1;
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_fpip00040", para);  
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=16318 style='border-collapse:
 collapse;table-layout:fixed;width:760pt'>
 <col width=39 style='mso-width-source:userset;mso-width-alt:1426;width:29pt'>
 <col width=263 style='mso-width-source:userset;mso-width-alt:3304;width:47pt'>
 <col width=91 style='mso-width-source:userset;mso-width-alt:3328;width:68pt'>
 <col width=466 style='mso-width-source:userset;mso-width-alt:4013;width:50pt'>
 <col width=54 style='mso-width-source:userset;mso-width-alt:5974;width:41pt'>
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  ...
  width:760pt'>PROD PLAN ENTRY</td>
 </tr>
 ...
 <%
	//======================
        ...
        for (int y = 0; y < dt1.Rows.Count; y++)
        {
            if (strRG == "" || strRG == null)
            {
                strRG = dt1.Rows[y]["routing_group"].ToString().Trim();
                strRG_count = 1;
            }
            else
            {
                if (dt1.Rows[y]["routing_group"].ToString().Trim() != strRG.Trim())
                {
 ...
 <tr class=xl28 height=65 style='mso-height-source:userset;height:48.75pt'>
             <%  if (strRG != dt1.Rows[i]["routing_group"].ToString())
                {
            %> 
  <td rowspan="<%= arrRG_count[a] %>" height=65 class=<% if(i % 2 == 0)
			 ...
			 <%	}
				...
				{ %>
					xl37
				<% } %> style='height:48.75pt' x:num><%=dt1.Rows[i]["routing_group"]%></td>
                <%                         
                    strRG = dt1.Rows[i]["routing_group"].ToString();
                    a++;
                }
            %> 
  <td class=<% if(i % 2 == 0)
