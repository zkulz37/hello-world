...
<%
	...
	= "select a.dept_NM,a.EMP_ID,a.full_name,to_char(to_date(a.JOIN_DT,'yyyymmdd'),'dd/mm/yyyy') " + 
		...
		",(select m.THR_EMP_PK " + 
        "    , sum(case when m.WORK_DT <= e.END_PROBATION then nvl(m.WORK_TIME,0)/8 else 0 end ) wt_70 " +
        "    , sum(case when m.WORK_DT > e.END_PROBATION then nvl(m.WORK_TIME,0)/8 else 0 end ) wt_100 " +
        ...
        "(select ta.THR_EMP_PK , sum(nvl(ta.ABSENCE_TIME,0)/8) abs " +
        "from thr_absence_ur ta " +
        "where ta.DEL_IF=0 " +
        "and ta.ABSENCE_DT between '"+p_from_dt+"' and '"+p_to_dt+"' " +
        "group by ta.THR_EMP_PK) abs "+
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2320 style='border-collapse:
 ...
 <tr height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  <td></td>
  <td colspan=4 class=xl30 style='mso-ignore:colspan'></td>
  <td class=xl33>WORKING SUMMARY <% if (p_tco_dept_pk!="ALL") 
 ...
 <tr class=xl24 height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  <%
   ...
   %>
  <td class=xl26 rowspan="2" style='border-left:none;font-style:italic;'>WD</td>
  <td class=xl26 rowspan="2" style='border-left:none;font-style:italic;'>WD 70</td>
  <td class=xl26 rowspan="2" style='border-left:none;font-style:italic;'>ABS</td>
  <td class=xl26 style='font-style:italic;'>OT(H)</td>
  <td class=xl26 style='font-style:italic;'>NT(H)</td>
  <td class=xl26 style='font-style:italic;'>HT(H)</td>
 ...
 <tr class=xl24 height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  <td class=xl26 style='border-top:none;font-style:italic;'>T&#259;ng ca</td>
  <td class=xl26 style='border-top:none;font-style:italic;'>Ca &#273;êm</td>
  <td class=xl26 style='border-top:none;font-style:italic;'>Ngày l&#7877;</td>
