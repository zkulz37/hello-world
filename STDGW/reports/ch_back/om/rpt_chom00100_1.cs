...
public partial class rpt_chom00100_1 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_chom00100_1.xls";
        string TempFile = "../../../system/temp/rpt_chom00100_1_" + Session["User_ID"].ToString() + ".xls";
    ...
    = " SELECT TO_CHAR(SYSDATE,'dd/mm/yyyy'),c.ORG_NM,gp.WORKGROUP_NM,A.EMP_ID, A.FULL_NAME,GW.WORK_DT,WS.SHIFT,WS.Remark " +
        ...
        "                FROM THR_TIME_MACHINE_UR D,THR_EXTRA_TIME_UR H,THR_EMPLOYEE V " +
        ...
        "               FROM THR_ABSENCE_UR E,THR_EMPLOYEE F " +
        ...
        "                    OR '" + p_search_temp + "' IS NULL) " +
        "       AND DECODE('" + p_confirm + "','ALL','" + p_confirm + "',NVL(GW.APPROVE_UR_YN,'N')) = '" + p_confirm + "'              " +
