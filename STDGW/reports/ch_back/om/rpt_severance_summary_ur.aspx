...
<%
   ...
   string SQL
	= "select a.THR_GROUP_NM,  " +                                  //1
        ...
        "where a.del_if=0 and a.work_mon='" + p_work_mon + "' and NVL(A.severance_amt,0) > 0 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1592 style='border-collapse:
 ...
 width:101pt'>
 <col class=xl24 width=109 style='mso-width-source:userset;mso-width-alt:4937;
 width:82pt'>
 <col class=xl24 width=109 span=6 style='mso-width-source:userset;mso-width-alt:
 2816;width:58pt'>
 <col class=xl24 width=109 style='mso-width-source:userset;mso-width-alt:4937;
 width:59pt'>
 <tr height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <td class=xl38 width=73 style='width:55pt'>SEVERANCE AMOUNT SUMMARY IN <%=dt_Com.Rows[0][4].ToString()%></td>
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td class=xl24></td>
  <td class=xl25></td>
  <td class=xl39>T&#7892;NG TIỀN TRỢ CẤP THÔI VIỆC THÁNG <%=dt_Com.Rows[0][5].ToString()%></td>
  <td class=xl24></td>
 ...
 <tr class=xl28 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  width:101pt'>Severance Months<br>
    <font class="font10">Số tháng làm việc</font></td>
  <td rowspan=2 class=xl44 width=109 style='border-bottom:.5pt solid black;
  width:82pt'>Severance Amt<br>
    <font class="font10">Trợ cấp thôi việc</font></td>
...
<%
 ...
 <tr class=xl29 height=34 style='mso-height-source:userset;height:25.5pt'>
  ...
  <td class=xl33 x:num  style='mso-number-format:"_\(* \#\,\#\#0\.00_\)\;_\(* \\\(\#\,\#\#0\.00\\\)\;_\(* \0022-\0022??_\)\;_\(\@_\)"'><span
 ...
 <tr class=xl34 height=34 style='mso-height-source:userset;height:25.5pt'>
  ...
  <td class=xl36 style='border-left:none;mso-number-format:"_\(* \#\,\#\#0\.00_\)\;_\(* \\\(\#\,\#\#0\.00\\\)\;_\(* \0022-\0022??_\)\;_\(\@_\)";' x:num><span
