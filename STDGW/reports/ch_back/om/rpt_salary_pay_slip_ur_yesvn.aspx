...
<%
   ...
   string SQL
	= "select c.PARTNER_LNAME,  " +                                  //0
        ...
        "ROUND(NVL(A.ABS_TMP_L1,0),3), " +                                    //22
        "ROUND(NVL(A.ABS_TMP_L2,0),3), " +                                    //23
        "ROUND(NVL(A.ABS_TMP_L1_AMT,0) + NVL(A.ABS_TMP_L2_AMT,0),3), " +      //24 tong tien vang phep nam
        ...
        "ROUND(NVL(A.ST_L1,0) + nvl(A.HT_L1,0)+ nvl(A.OHT_L1,0)+ nvl(A.OST_L1,0),3), " +                       //31
        "ROUND(NVL(A.ST_L2,0) + nvl(A.HT_L2,0)+ nvl(A.OHT_L2,0)+ nvl(A.OST_L2,0),3), " +                       //32
        "ROUND(NVL(A.ST_L1_AMT,0) + nvl(A.HT_L1_AMT,0)+ nvl(A.OHT_L1_AMT,0) + nvl(A.ST_L2_AMT,0) + nvl(A.HT_L2_AMT,0)+ nvl(A.OHT_L2_AMT,0) + nvl(A.OST_L1_AMT,0)+ nvl(A.OST_L2_AMT,0),3), " +     //33
        ...
        "ROUND(NVL(A.SOCIAL_AMT,0) + nvl(A.HEALTH_AMT,0)+NVL(A.UNEMP_INS,0),3) ,  " +           //66
        ...
        "round(NVL(A.ALLOW_AMT1_L1,0),3),  " +                                  //74
        "ROUND(NVL(A.ALLOW_AMT2_L1,0),3),  " +                                  //75
        "ROUND(NVL(A.ALLOW_AMT3_L1,0),3),  " +                                  //76
        "ROUND(NVL(A.ALLOW_AMT4_L1,0),3),  " +                                  //77
        "ROUND(NVL(A.ALLOW_AMT5_L1,0),3),  " +                                  //78
        "ROUND(NVL(A.ALLOW_AMT6_L1,0),3),  " +                                  //79
        "ROUND(NVL(A.ALLOW_AMT7_L1,0),3),  " +                                  //80
        "ROUND(NVL(A.ALLOW_AMT8_L1,0),3) , " +                                  //81
        "0,  " +                                  //82
        "ROUND(NVL(A.INS_SALARY,0),3)  " +                                  //83
        "from thr_month_salary a,comm.tco_org b,comm.tco_company c " +         
...
//Response.End();
	...
	= "   SELECT MAX (code1), MAX (code2), MAX (code3), MAX (code4), MAX (code5), " + 
        ...
        "        FROM (SELECT DECODE (code, 'A1', initcap(a.code_nm), '') AS code1, " +
        "                     DECODE (code, 'A2', initcap(a.code_nm), '') AS code2, " +
        "                     DECODE (code, 'A3', initcap(a.code_nm), '') AS code3, " +
    ...
    <x:PageBreaks>
     <x:RowBreaks>
      <% 
        ...
        {
            if (p_status=="A")
                irow+=48 - (8-icol_Allow) - (8-icol_Allowk)-2 ;
            else
                irow+=48 - (8-icol_Allow) - (8-icol_Allowk) ;
            %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=503 style='border-collapse:
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  BH(<font class="font12">Ins Salary</font><font class="font8">)</font></td>
  <td class=xl39>:</td>
  <td colspan=4 class=xl92 style='border-right:.5pt solid black;border-left:
  none;border-bottom:none' x:num><span style='mso-spacerun:yes'>              
  </span><%=dt_Emp.Rows[i][83].ToString() %></td>
 </tr>
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 class=xl37 colspan=2 style='height:17.25pt;mso-ignore:colspan;border-top:none'>L&#432;&#417;ng
  (<font class="font12">Salary</font><font class="font8">)</font></td>
  <td class=xl39  style='border-top:none'>:</td>
  <td colspan=4 class=xl92 style='border-right:.5pt solid black;border-left:
  none;border-top:none' x:num><span style='mso-spacerun:yes'>              
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td class=xl54 style='border-top:none' x:num colspan=4><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][75].ToString() %></td>
  <td class=xl57 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][76].ToString() %></td>
  <td  class=xl59 style='mso-ignore:colspan'></td>
  <td class=xl60 x:num><span style='mso-spacerun:yes'>   
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][77].ToString() %></td>
  <td class=xl59 style='mso-ignore:colspan'></td>
  <td class=xl60 x:num><span style='mso-spacerun:yes'>   
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][78].ToString() %></td>
  <td class=xl59 style='mso-ignore:colspan'></td>
  <td class=xl60 x:num><span style='mso-spacerun:yes'>   
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][79].ToString() %></td>
  <td  class=xl59 style='mso-ignore:colspan'></td>
  <td class=xl60 x:num><span style='mso-spacerun:yes'>   
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl34>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][80].ToString() %></td>
  <td class=xl59 style='mso-ignore:colspan'></td>
  <td class=xl60 x:num><span style='mso-spacerun:yes'></span><%=dt_Emp.Rows[i][17].ToString() %></td>
 </tr>
 <%} %>
 <%
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl42>:</td>
  <td colspan=2 class=xl91 style='border-right:.5pt solid black;border-left:none' x:num><%=dt_Emp.Rows[i][81].ToString() %></td>
  <td class=xl62>&nbsp;</td>
 ...
 <tr class=xl25 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td class=xl47 colspan=2 style='border-left:none'>Thời Gian</td>
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl39>:</td>
  <td class=xl50 style='border-left:none'colspan=2  x:num><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  hết hàng (<font class="font12">Temp Absence</font><font class="font8">)</font></td>
  <td class=xl34>:</td>
  <td class=xl30 style='border-left:none' x:num colspan=2><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  phép năm (ALE Absence)</td>
  <td class=xl34>:</td>
  <td class=xl30 style='border-left:none' colspan=2 x:num><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  class="font8">)</font></td>
  <td class=xl34>:</td>
  <td class=xl30 colspan=2 style='border-left:none' x:num><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl26 colspan=2 style='height:15.75pt;mso-ignore:colspan'>T&#259;ng
  ca CN/l&#7877; (<font class="font12">Overtime 2.0</font><font class="font8">)</font></td>
  <td class=xl34>:</td>
  <td class=xl30 colspan=2 style='border-left:none' x:num><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  class="font8">)</font></td>
  <td class=xl34>:</td>
  <td colspan=2 class=xl30 style='border-left:none' x:num><span
 ...
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl42>:</td>
  <td class=xl52 colspan=2 style='border-left:none' x:num><span
 ...
 <%
    ...
    %>  
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl37 colspan=2 style='height:15.75pt;mso-ignore:colspan'><%=dt_Allowk.Rows[0][0].ToString() %>(<font class="font12">P.C tay nghề</font><font class="font8">)</font></td>
  <td class=xl39 style='border-top:none'>:</td>
 ...
 <%
    ...
    %>  
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl26 colspan=2 style='height:15.75pt;mso-ignore:colspan'><%=dt_Allowk.Rows[0][1].ToString() %>(<font class="font12">P.C chuyên cần</font><font class="font8">)</font></td>
  <td class=xl34>:</td>
 ...
 <%
    ...
    %>  
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl26 colspan=2 style='height:15.75pt;mso-ignore:colspan'><%=dt_Allowk.Rows[0][2].ToString() %> (<font class="font12">P.C nhà ở</font><font class="font8">)</font></td>
  <td class=xl34>:</td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 ...
 <%
    ...
    %>  
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl26 colspan=2 style='height:15.75pt;mso-ignore:colspan'><%=dt_Allowk.Rows[0][3].ToString() %> (<font class="font12">P.C độc hại</font><font class="font8">)</font></td>
  <td class=xl34>:</td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 ...
 <%} %>
 <tr class=xl25 height=23 style='mso-height-source:userset;height:15.75pt'>
  <td height=23 class=xl40 colspan=2 style='border-bottom:none;height:15.75pt;mso-ignore:colspan'>Bảo hiểm (<font class="font12">Insurance AMT</font><font class="font8">)</font></td>
