...
<%
	...
	= "select to_char(sysdate,'dd/mm/yyyy') ,org_nm,workgroup_nm,emp_id,full_name,w_date " + 
        ...
        ",TIME_IN,TIME_OUT,WORK_TIME,OVT,HT,NT,NT2 " +
        ...
        "         SUM (DECODE (h.ot_type, 'HT', NVL (h.ot_time, 0), 0)) AS ht , t.seq as s1, a.seq as s2" +
        "   FROM thr_time_machine_ur d, " +
        "         thr_extra_time_ur h, " +
        "         thr_wg_sch_detail g, " +
        "         thr_employee v, " +
        "         thr_work_group a, " +
        ...
        "     AND (DECODE ('" + p_nation + "', 'ALL', v.NATION , '01','01') =  v.NATION or ( '" + p_nation + "' ='02' and v.NATION <> '01'))" +
        ...
        "          OR '" + p_tco_org_pk + "' = 'ALL' " +
        "         ) " +
        " GROUP BY  t.seq , a.seq, g.thr_emp_pk, g.work_dt) hr " +
        " ORDER BY w_date, NVL (hr.s1, 0), NVL (hr.s2, 0), emp_id ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1262 style='border-collapse:
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl31 style='border-top:none;border-left:none'>Gi&#7901; &#273;êm 45%</td>
  <td class=xl25></td>
 </tr>
 <% 
     string s_format;
