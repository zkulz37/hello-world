...
<%
    ...
    string l_parameter = "";
    l_parameter = "'" + l_eva_master_pk + "','" + l_org_pk + "','" + l_eva_group + "','" + l_empployee + "','" + l_eva_status + "','" + l_final_grade + "','" + l_review_pk1 + "','" + l_review_pk2 + "'";
...
<link rel=File-List href="Copy%20of%20EvalResultInquiry3_files/filelist.xml">
<link rel=Edit-Time-Data
href="Copy%20of%20EvalResultInquiry3_files/editdata.mso">
<link rel=OLE-Object-Data
href="Copy%20of%20EvalResultInquiry3_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>PCVINA002</o:Author>
  <o:LastAuthor>VST</o:LastAuthor>
  <o:LastPrinted>2009-07-09T09:37:25Z</o:LastPrinted>
  <o:Created>2009-07-09T09:34:23Z</o:Created>
  <o:LastSaved>2013-10-24T07:20:48Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=3474 style='border-collapse:
 collapse;table-layout:fixed;width:2599pt'>
 ...
 width:54pt'>
 <col class=xl24 width=55 span=18 style='mso-width-source:userset;mso-width-alt:
 2011;width:41pt'>
 <col class=xl24 width=164 span=2 style='mso-width-source:userset;mso-width-alt:
 5997;width:123pt'>
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  <td colspan=34 class=xl44 width=2306 style='border-right:.5pt solid black;
  border-left:none;width:1722pt'>Score</td>
 </tr>
 ...
 <tr height=54 style='mso-height-source:userset;height:40.5pt'>
  <td height=54 class=xl29 style='height:40.5pt'><% = dt.Rows[i]["dept"]%>&nbsp;</td>
  <td class=xl30><% = dt.Rows[i]["org_nm"]%>&nbsp;</td>
  <td class=xl30><% = dt.Rows[i]["emp_id"]%>&nbsp;</td>
  <td class=xl30><% = dt.Rows[i]["full_name"]%>&nbsp;</td>
  <td class=xl30 x:string><% = dt.Rows[i]["join_dt"]%>&nbsp;</td>
  <td class=xl30><% = dt.Rows[i]["work_month"]%>&nbsp;</td>
  ...
  <td class=xl31><% = dt.Rows[i]["final_grade"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["second_a"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["a_rank2"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["a_grade2"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["second_c"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["c_rank2"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["c_grade2"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["second_t"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["second_rank"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["second_grade"]%>&nbsp;</td>
  <td class=xl47 width=164 style='width:123pt'><% = dt.Rows[i]["opinion_eva_l2"]%>fdfkadjfladjfladjfladjfladjfladjflafdjfal;fdfadfa</td>
  <td class=xl31><% = dt.Rows[i]["opinion_pos_l2"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["first_a"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["a_rank1"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["a_grade1"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["first_c"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["c_rank1"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["c_grade1"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["first_t"]%>&nbsp;</td>
  <td class=xl32><% = dt.Rows[i]["first_rank"]%>&nbsp;</td>
  <td class=xl33 style='border-top:none'><% = dt.Rows[i]["first_grade"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["opinion_eva_l1"]%>&nbsp;</td>
  <td class=xl31><% = dt.Rows[i]["opinion_pos_l1"]%>&nbsp;</td>
  <td class=xl34><% = dt.Rows[i]["self_a"]%>&nbsp;</td>
  <td class=xl34><% = dt.Rows[i]["self_c"]%>&nbsp;</td>
  <td class=xl34><% = dt.Rows[i]["self_t"]%>&nbsp;</td>
 </tr>
 <%
     } %>
 <tr height=15 style='height:11.25pt'>
  <td height=15 colspan=46 class=xl24 style='height:11.25pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=15 style='height:11.25pt'>
  <td height=15 colspan=16 class=xl24 style='height:11.25pt;mso-ignore:colspan'></td>
  <td class=xl35></td>
  <td colspan=29 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
