...
<%
	...
	= "select a.EMP_ID as c0 " + 
        ...
        ",(select decode(e.code,'04','X','05','X','') from vhr_hr_code e where id='HR0001' and code=b.contract_type ) as c11 " +
        ",(select decode(e.code,'04','','05','','X') from vhr_hr_code e where id='HR0001' and code=b.contract_type ) as c12 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1018 style='border-collapse:
 ...
 <tr height=16 style='height:12.0pt'>
  <td height=16 colspan=4 class=xl25 style='height:12.0pt;mso-ignore:colspan'></td>
  <td class=xl29 colspan=8 style='mso-ignore:colspan'><span
  style='mso-spacerun:yes'>                         </span>(DS CNV
  GIA HẠN HỢP ĐỒNG THÁNG  <%=p_work_mon.Substring(4,2) + "/" +  p_work_mon.Substring(0,4)%>)</td>
  <td class=xl25></td>
  <td class=xl27></td>
  <td class=xl25></td>
  <td class=xl28></td>
