...
<%
    ...
    string sql_kind = "select v.CODE_NM,v.CODE_FNM from VHR_HR_CODE v where  v.id='HR0001' and v.code='" + p_contract_type + "'";
    ...
    string SQL = "select d.org_nm,c.workgroup_nm " + 
        ...
        "   ,to_char(to_date(b.end_probation,'yyyymmdd') - nvl(g.num_3,-1),'dd/mm/yyyy')  a12" +
        "   ,(select TO_CHAR(ADD_MONTHS (to_date(b.end_probation,'yyyymmdd') - nvl(g.num_3,-1),nvl(t.num_1,0))+ nvl(t.num_3,0),'dd/mm/yyyy') from vhr_hr_code t where t.id='HR0001' and t.code=NVL(B.NEXT_CONTRACT,ct_next.code)) a13 " +
