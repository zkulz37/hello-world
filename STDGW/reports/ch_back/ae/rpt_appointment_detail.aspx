...
<%
    ...
    = "SELECT 0 as c0, " + 
        ...
        "             ) " +
        "         ORDER BY  a.THR_EMPLOYEE_PK, nvl(a.TIMES,1) ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1843 style='border-collapse:
 ...
 <tr height=73 style='mso-height-source:userset;height:54.75pt'>
  <td colspan=15 height=73 class=xl82 width=1779 style='height:54.75pt;
 ...
 <tr height=20 style='height:15.0pt'>
  <td height=20 colspan=16 class=xl68 style='height:15.0pt;mso-ignore:colspan'></td>
 </tr>
