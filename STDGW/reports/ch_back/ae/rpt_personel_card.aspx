...
<span class=SpellE><span class=GramE><%= dt_name.Rows[0][1].ToString() %> </span></span> </b><span
...
7'>                                                                                    </span><%= dt_name.Rows[22][1].ToString() %>, ngày <%= dt_total.Rows[0][1].ToString() %> tháng <%= dt_total.Rows[i][2].ToString() %> năm <%= dt_total.Rows[i][3].ToString() %></p>
...
<%= dt_name.Rows[4][1].ToString() %><span style='mso-spacerun:yes'>    </span><span
style='mso-spacerun:yes'>                              </span><span
style='mso-tab-count:1'>                           </span>Điện thoại: <%= dt_name.Rows[5][1].ToString() %></span></p>
...
<p class=MsoNormal style='text-align:justify;line-height:15.0pt;mso-line-height-rule:
exactly'><span style='mso-bidi-font-size:11.0pt'>Địa chỉ:  <%= dt_name.Rows[6][1].ToString() %><o:p></o:p></span></p>
...
xã hội, y tế, thất nghiệp: <%= dt_name.Rows[18][1].ToString() %><o:p></o:p></span></p>
...
style='mso-spacerun:yes'>  </span>Hợp đồng này làm tại <%= dt_name.Rows[4][1].ToString() %> ngày
