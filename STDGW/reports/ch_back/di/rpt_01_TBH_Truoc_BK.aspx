...
<%
    ...
    string SQL = " select  " 
        ...
        + ",(select v.code_fnm from vhr_hr_code v where v.id='HR0049' and v.code='11') as noicongtac22 "
         + ",a.full_name as hoten23, nvl(a.social_no,'          ') socialno24  "
...
<link rel=File-List href="rpt_01_TBH_Truoc_Simone_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_01_TBH_Truoc_Simone_files/editdata.mso">
<!--[if !mso]>
<style>
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-07-17T03:50:00Z</o:LastSaved>
  <o:Pages>1</o:Pages>
  <o:Words>172</o:Words>
...
mso-ansi-language:EN-US;mso-bidi-font-weight:bold'> kèm theo Q</span></i><i
style='mso-bidi-font-style:normal'><span style='font-size:10.0pt;font-family:
...
<p class=MsoNormal align=center style='margin-left:334.5pt;text-align:center'><i
style='mso-bidi-font-style:normal'><span style='font-size:10.0pt;mso-ansi-language:
EN-US;mso-bidi-font-weight:bold'>BHXH <span class=spelle><span
...
normal'><span style='font-size:10.0pt;mso-bidi-font-family:"\.VnTime";
mso-ansi-language:EN-US;mso-bidi-font-weight:bold'> 21/01/2008 <span
...
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Wingdings 2";
mso-ascii-font-family:"Times New Roman";mso-hansi-font-family:"Times New Roman";
mso-ansi-language:PT-BR;mso-char-type:symbol;mso-symbol-font-family:"Wingdings 2"'><% if (dt_total.Rows[i][2].ToString()=="X") 
                                                Response.Write("T");
                                         else
                                                Response.Write("£");
                                         %><span
...
style='mso-tab-count:1'>        </span>Dân tộc: <%=dt_total.Rows[i][4].ToString() %><span
style='mso-tab-count:1'>            </span>Quốc tịch: <%=dt_total.Rows[i][5].ToString() %><o:p></o:p></span></p>
...
0in;margin-left:10.9pt;margin-bottom:.0001pt;text-align:justify;tab-stops:250.7pt 386.95pt'><span
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
EN-US'>5. Giấy CMND số: <%=dt_total.Rows[i][8].ToString() %><span
style='mso-tab-count:1'>                 </span>Nơi cấp: <%=dt_total.Rows[i][9].ToString() %><span
style='mso-tab-count:1'>      </span>Ngày cấp: <%=dt_total.Rows[i][10].ToString() %><o:p></o:p></span></p>

<p class=MsoNormal style='margin-top:3.0pt;margin-right:5.6pt;margin-bottom:
0in;margin-left:10.9pt;margin-bottom:.0001pt;text-align:justify'><span lang=FR
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
FR'>6. Hợp đồng lao động (hoặc hợp đồng làm việc): Số <%=dt_total.Rows[i][19].ToString() %> có
hiệu lực từ ngày <%=dt_total.Rows[i][20].ToString().Substring(0,2).ToString() %> tháng 
<%=dt_total.Rows[i][20].ToString().Substring(3,2).ToString() %> năm <%=dt_total.Rows[i][20].ToString().Substring(6,4).ToString() %>.
<o:p></o:p></span></p>
...
0in;margin-left:10.9pt;margin-bottom:.0001pt;text-align:justify'><span lang=FR
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
FR'>8. Cơ quan, đơn vị: <%=dt_total.Rows[i][16].ToString() %><span
...
0in;margin-left:10.9pt;margin-bottom:.0001pt;text-align:justify'><span lang=SV
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
SV'>10. Nơi đăng ký khám chữa bệnh ban đầu: <%=dt_total.Rows[i][12].ToString() %><span
style='mso-spacerun:yes'> </span><o:p></o:p></span></p>
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width="99%"
 ...
 <tr style='mso-yfti-irow:2'>
  ...
  padding:0in 5.75pt 0in 5.75pt'><b><span lang=IT style='font-size:14.0pt;
  font-family:"Times New Roman";mso-fareast-font-family:"Times New Roman";
  mso-ansi-language:IT;mso-fareast-language:VI;mso-bidi-language:AR-SA;
  mso-bidi-font-weight:bold'><%=dt_total.Rows[i][13].ToString() %></span></b>
  ...
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.75pt 0in 5.75pt'><b><span
  lang=IT style='font-size:14.0pt;font-family:"Times New Roman";mso-fareast-font-family:
  "Times New Roman";mso-ansi-language:IT;mso-fareast-language:VI;mso-bidi-language:
  AR-SA'><%=dt_total.Rows[i][14].ToString() %></span></b>
  <p class=MsoNormal style='margin-top:6.0pt;margin-right:5.6pt;margin-bottom:
  ...
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.75pt 0in 5.75pt'><span
  lang=IT style='font-size:10.0pt;font-family:"Times New Roman";mso-fareast-font-family:
  "Times New Roman";mso-ansi-language:IT;mso-fareast-language:VI;mso-bidi-language:
  AR-SA;mso-bidi-font-weight:bold'><%=dt_total.Rows[i][18].ToString() %></span>
  <p class=MsoNormal style='margin-top:6.0pt;margin-right:5.6pt;margin-bottom:
  0in;margin-left:0in;margin-bottom:.0001pt'><span lang=IT style='font-size:
  10.0pt;font-family:"Times New Roman";mso-ansi-language:IT;mso-bidi-font-weight:
  bold'><o:p>&nbsp;</o:p></span></p>
 ...
 <tr style='mso-yfti-irow:3'>
  ...
  lang=IT style='font-size:10.0pt;font-family:"Times New Roman";mso-fareast-font-family:
  "Times New Roman";mso-ansi-language:IT;mso-fareast-language:VI;mso-bidi-language:
  AR-SA;mso-bidi-font-weight:bold'><%=dt_total.Rows[i][17].ToString() %></span>
  <p class=MsoNormal style='margin-top:6.0pt;margin-right:5.6pt;margin-bottom:
  0in;margin-left:0in;margin-bottom:.0001pt'><span lang=IT style='font-size:
  10.0pt;font-family:"Times New Roman";mso-ansi-language:IT;mso-bidi-font-weight:
  bold'><o:p>&nbsp;</o:p></span></p>
