...
<% 
     ...
     {
        string strEmp_PK=dt_total.Rows[i][0].ToString();
...
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:PT-BR'><%=dt_total.Rows[i][4].ToString() %>, ngày 01 <span style='mso-spacerun:yes'> 
</span>tháng <%if (dt_total.Rows[i][3].ToString()!="") 
                                        Response.Write(dt_total.Rows[i][3].ToString().Substring(0,2));
                                    %>  năm <%if (dt_total.Rows[i][3].ToString()!="") 
...
PT-BR'><%=dt_total.Rows[i][1].ToString() %><o:p></o:p></span></b></p>
