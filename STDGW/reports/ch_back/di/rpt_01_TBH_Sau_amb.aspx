...
<%
    ...
    string SQL = " select a.pk  " 
        ...
        + ",to_char(to_date(nvl(a.BEGIN_CONTRACT,a.begin_probation),'yyyymmdd'),'mm/yyyy') as tuthang "
...
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:PT-BR'><%=dt_total.Rows[i][4].ToString() %>, ngày ....... tháng ....... năm 20.....<o:p></o:p></span></i></p>
