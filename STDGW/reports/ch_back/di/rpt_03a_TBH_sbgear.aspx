...
<%
 ...
 string SQL
	= "select ins_type.char_3 " + 
        ...
        ",decode(nvl(a.TRA_THE_YN,'N'),'Y','X','') as c37 " +
        ",(case when nvl(a.LUONG_CU,0) =0 and nvl(a.LUONG_MOI,0) >0 then 1 else 0 end) as xhyttang38" +
        ",(case when  nvl(a.LUONG_CU,0) >0 and nvl(a.LUONG_MOI,0) =0 then 1 else 0 end) as xhytgiam39" +
        ",(case when  nvl(a.LUONG_CU,0) =0 and nvl(a.LUONG_MOI,0) >0 then 1 else 0 end) as tntang40" +
        ",(case when  nvl(a.LUONG_CU,0) >0 and nvl(a.LUONG_MOI,0) =0  then 1 else 0 end) as tngiam41 " + 
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=3045 style='border-collapse:
 collapse;table-layout:fixed;width:2290pt'>
 <col class=xl24 width=35 style='mso-width-source:userset;mso-width-alt:995;
 width:26pt'>
 <col class=xl24 width=77 style='mso-width-source:userset;mso-width-alt:2190;
 width:58pt'>
 <col class=xl24 width=201 style='mso-width-source:userset;mso-width-alt:5717;
 width:151pt'>
 <col class=xl24 width=150 style='mso-width-source:userset;mso-width-alt:4266;
 width:113pt'>
 <col class=xl24 width=77 style='mso-width-source:userset;mso-width-alt:2190;
 width:58pt'>
 <col class=xl24 width=100 style='mso-width-source:userset;mso-width-alt:2844;
 width:75pt'>
 <col class=xl24 width=57 span=4 style='mso-width-source:userset;mso-width-alt:
 1621;width:43pt'>
 <col class=xl24 width=100 style='mso-width-source:userset;mso-width-alt:2844;
 width:75pt'>
 <col class=xl24 width=57 span=4 style='mso-width-source:userset;mso-width-alt:
 ...
 2190;width:58pt'>
 <col class=xl24 width=55 style='mso-width-source:userset;mso-width-alt:1564;
 width:41pt'>
 ...
 width:63pt'>
 <col class=xl24 width=108 span=6 style='mso-width-source:userset;mso-width-alt:
 3072;width:81pt'>
 <col class=xl24 width=84 style='mso-width-source:userset;mso-width-alt:2389;
 width:63pt'>
 <col class=xl24 width=93 span=6 style='mso-width-source:userset;mso-width-alt:
 2645;width:70pt'>
 <col class=xl24 width=53 span=4 style='mso-width-source:userset;mso-width-alt:
 1507;width:40pt'>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>T/g hiện hành</td>
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>BHXH, BHTN</td>
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>9000000</td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>10800000 </td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>13000000</td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>13000000 </td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>01/05/2010</td>
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>BHYT</td>
  <td  style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>1000000000</td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>1000000000 </td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>1000000000 </td>
  <td style='font-size:10.0pt;border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num>13000000 </td>
 ...
 <tr class=xl53 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td rowspan=2 colspan=2 class=xl143 width=40 style='width:30pt'
  ...
  <td rowspan=4 class=xl140 width=156 style='border-bottom:.5pt solid black;
  width:117pt'>Số LĐ BHXH, BHYT tăng</td>
  <td rowspan=4 class=xl140 width=156 style='border-bottom:.5pt solid black;
  width:117pt'>Số LĐ BHXH , BHYT giảm</td>
  <td rowspan=4 class=xl140 width=156 style='border-bottom:.5pt solid black;
  width:117pt'>Số LĐ BHTN tăng</td>
   <td rowspan=4 class=xl140 width=156 style='border-bottom:.5pt solid black;
  width:117pt'>Số LĐ BHTN giảm</td>
 </tr>
 ...
 <tr class=xl53 height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  tháng<br>
   ...
   <td rowspan=2 class=xl139 width=53 style='border-top:none;width:40pt'>Trả thẻ</td>
    <td rowspan=2 class=xl139 width=53 style='border-top:none;width:40pt'>Nội
  dung</td>
 ...
 <tr class=xl53 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl54 style='border-top:none;border-left:none' >19</td>
  ...
  <td class=xl54 style='border-top:none;border-left:none' >N</td>
  <td class=xl54 style='border-top:none;border-left:none' >O</td>
  <td class=xl54 style='border-top:none;border-left:none' >P</td>
  <td class=xl54 style='border-top:none;border-left:none' >Q</td>
 </tr>
 <% 
    ...
    double dXHYTTANGT = 0, dXHYTGIAMT = 0, dTNTANGT = 0, dTNGIAMT = 0;    
    ...
    for (int i=0;i<irow_emp;i++)
    {
        ...
        dXHYTTANGT += double.Parse(dt_Emp.Rows[i][37].ToString());
        dXHYTGIAMT += double.Parse(dt_Emp.Rows[i][38].ToString());
        dTNTANGT += double.Parse(dt_Emp.Rows[i][39].ToString());
        dTNGIAMT += double.Parse(dt_Emp.Rows[i][40].ToString());
 ...
 <tr class=xl92 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl103 style='border-left:none'><%=dt_Emp.Rows[i][19].ToString() %></td>
  <td class=xl103 style='border-left:none'><%=dt_Emp.Rows[i][36].ToString() %></td>
  ...
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][32].ToString() %></td>
   <td class=xl104 style='border-left:none' ><span
 ...
 <tr class=xl93 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl114 style='border-top:none;border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dXHYTTANGT %> </td>
  <td class=xl114 style='border-top:none;border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dXHYTGIAMT %> </td>
  <td class=xl114 style='border-top:none;border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dTNTANGT %> </td>
  <td class=xl114 style='border-top:none;border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dTNGIAMT %> </td>
 </tr>
