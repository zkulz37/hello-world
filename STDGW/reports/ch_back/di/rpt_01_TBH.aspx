...
<%
    ...
    string SQL = " select  " 
        ...
        + ",(case when substr(BEGIN_CONTRACT,-2) > '15' then to_char(add_months(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),1),'mm/yyyy') else  to_char(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),'mm/yyyy') end) as tuthang13  "
        + ",(case when substr(BEGIN_CONTRACT,-2) > '15' then to_char(add_months(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),1),'mm/yyyy') else  to_char(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),'mm/yyyy') end) as denthang14 "
        ...
        + ",(Select TO_CHAR(s.salary_level2,'999,999,999') from THR_SALARY_MANAGE s where s.del_if=0 and s.thr_emp_pk=a.pk and s.work_mon=(case when substr(BEGIN_CONTRACT,-2) > '15' then to_char(add_months(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),1),'yyyymm') else  to_char(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),'yyyymm') end)) as salary18  "
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width="99%"
 ...
 <tr style='mso-yfti-irow:3'>
  ...
  0in;margin-left:0in;margin-bottom:.0001pt'><span lang=IT style='font-size:
  10.0pt;font-family:"Times New Roman";mso-ansi-language:IT;mso-bidi-font-weight:
  bold'><o:p><%=dt_total.Rows[i][17].ToString() %></o:p></span></p>
  </td>
  <td width="10%" valign=top style='width:10.92%;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
...
<%} //ket thuc mat truoc hoac hai mat %>
<%  if (rpt_type=="2") //in hai mat 
    {
 %>
...
margin-bottom:0in;margin-left:10.9pt;margin-bottom:.0001pt;text-align:center'><span
class=spelle><b><span style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:EN-US'>(Ký và đóng dấu)</span></b></span></p>
...
<%} //ket thuc in mat sau hoac hai mat  %>
<%  if (i==num_row-1) 
    {%>
<p class=MsoNormal style='margin-right:5.6pt;text-align:justify'><span
