...
<%
string l_tco_org,p_month,l_work_group,l_search,p_include, p_nation;
...
string SQL
    = "select a.NATION " + 
        ...
        "   + nvl(ins.LUONG_BHTN,0) * (nvl(unemp_rate,0)+nvl(unemp_com_rate,0))/100 as c13 " +
        ...
        "                        OR '"+l_tco_org+"' = 'ALL') " +
        "                     " +
        "   and (('"+l_search+"'='1' and upper(a.emp_id) like  '%' || upper('"+l_temp+"')) " +
        "         or ('"+l_search+"'='2' and upper(a.id_num) like  '%' || upper('"+l_temp+"')) " +
        "         or ('"+l_search+"'='3' and upper(a.FULL_NAME ) like  '%' || upper('"+l_temp+"'))) " +
        "          " +
