...
<%
    ...
    string SQL = " select  " 
        ...
        + ",(select p.ADDR1 from tco_company p where p.del_if=0 and p.pk=c.tco_company_pk) as diachi "
        ...
        + ",to_char(to_date(a.BEGIN_CONTRACT,'yyyymmdd'),'dd/mm/yyyy') as kyngay23 "
...
mso-ansi-language:IT'></span></span></b><![endif]><b><span lang=IT style='mso-bidi-font-size:
14.0pt;font-family:"Times New Roman";mso-ansi-language:IT'>12. Quá trình đóng, chưa
hưởng BHXH một lần và BH thất nghiệp<o:p></o:p></span></b></p>
