...
xmlns="http://www.w3.org/TR/REC-html40" dir="mon">
<%
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1033 style='border-collapse:
 ...
 <tr class=xl27 height=27 style='height:20.25pt'>
  <td colspan=13 height=27 class=xl88 style='height:20.25pt'>DANH SÁCH NGƯỜI LAO ĐỘNG HƯỞNG CHẾ ĐỘ THAI SẢN</td>
 </tr>
 <%
     string w = "I";
 ...
 <tr height=18 style='height:13.5pt'>
  ...
  <td class=xl77 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl77 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl79 style='border-top:none;border-left:none;mso-text-control:shrinktofit' x:num
