...
<%
    ...
    string SQL = " select  " 
        ...
        + ",(select v.code_fnm from vhr_hr_code v where v.id='HR0049' and v.code='11') as noicongtac21 "
        + ",a.contract_no as sohopdong22 "
        + ",to_char(to_date(nvl(a.BEGIN_CONTRACT,a.BEGIN_PROBATION),'yyyymmdd'),'dd/mm/yyyy') as kyngay23 "
        + ",(select lower(v.code_fnm) from vhr_hr_code v where v.id='HR0001' and v.code=a.contract_type)  as loaihopdong24 "
        + "from thr_employee a "
        + "where a.del_if=0  "
       + "and a.pk in (" + emp_pk + ") " ;
...
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
FR'>6. Hợp đồng lao động (hoặc hợp đồng làm việc): Số <%=dt_total.Rows[i][22].ToString() %> có hiệu lực từ ngày <%=dt_total.Rows[i][23].ToString().Substring(0,2).ToString() %> tháng <%=dt_total.Rows[i][23].ToString().Substring(3,2).ToString() %> năm <%=dt_total.Rows[i][23].ToString().Substring(6,4).ToString() %>. Loại hợp đồng <%=dt_total.Rows[i][24].ToString()%><o:p></o:p></span></p>
...
<p class=MsoNormal style='margin-top:0in;margin-right:5.6pt;margin-bottom:0in;
margin-left:.5in;margin-bottom:.0001pt;text-align:justify;text-indent:.5in'><b><span
style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";mso-ansi-language:
EN-US'><span style='mso-tab-count:4'>                                      </span></span></b><span
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:PT-BR'>(Ký và đóng dấu)</span><span lang=PT-BR
...
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:PT-BR'><%=dt_total.Rows[i][21].ToString() %>, ngày ....... tháng ....... năm 20.....<o:p></o:p></span></i></p>
...
bộ thẩm định<span style='mso-tab-count:1'>                                       </span>Giám
...
lang=PT-BR style='mso-bidi-font-size:14.0pt;font-family:"Times New Roman";
mso-ansi-language:PT-BR'>(Ký ghi rõ họ tên)<span style='mso-tab-count:1'> </span><span
style='mso-tab-count:4'>                                      </span><span
style='mso-spacerun:yes'>    </span>(Ký và đóng dấu)</span><span lang=PT-BR
style='mso-ansi-language:PT-BR'><o:p></o:p></span></p>
