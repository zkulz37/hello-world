...
<%
   ...
   string p_status_emp         = Request["p_status_emp"].ToString();
   ...
   string SQL
    = "select       c.org_nm " + 
        ...
        "              ,(SELECT V.CODE_NM FROM VHR_HR_CODE V WHERE V.ID='HR0090' AND V.CODE =  a.STATUS) " +
        "              ,(SELECT K.FULL_NAME FROM THR_EMPLOYEE K WHERE K.DEL_IF=0 AND K.PK = b.APPROVER_PK) " +
        ...
        "                and decode('"+ p_status_emp +"','ALL', 'ALL', a.STATUS )='"+ p_status_emp +"' " +
...
<link rel=File-List href="rpt_traniee_management_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_traniee_management_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_traniee_management_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>ty-ml</o:Author>
  <o:LastAuthor>welcome</o:LastAuthor>
  <o:LastPrinted>2011-09-05T02:01:38Z</o:LastPrinted>
  <o:Created>2008-05-23T07:19:16Z</o:Created>
  <o:LastSaved>2011-09-05T02:32:02Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2577 style='border-collapse:
 collapse;table-layout:fixed;width:1935pt'>
 ...
 width:89pt'>
 <col class=xl65 width=106 span=2 style='mso-width-source:userset;mso-width-alt:
 3876;width:80pt'>
 ...
 width:117pt'>
 <col class=xl65 width=125 style='mso-width-source:userset;mso-width-alt:4571;
 width:94pt'>
 <col class=xl65 width=143 style='mso-width-source:userset;mso-width-alt:5229;
 width:107pt'>
 <tr height=68 style='mso-height-source:userset;height:51.0pt'>
  <td colspan=21 height=68 class=xl87 width=2577 style='height:51.0pt;
  width:1935pt'>TRAINEE MANAGEMENT<br>
    <font class="font11">Qu&#7843;n lý nhân viên &#273;&#432;&#7907;c &#273;ào
  t&#7841;o</font></td>
 </tr>
 ...
 <tr class=xl66 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl68>Status</td>
  <td class=xl68>Approver</td>
 </tr>
 <tr class=xl66 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl70>Tr&#7841;ng thái</td>
  <td class=xl70>Ng&#432;&#7901;i ch&#7845;p thu&#7853;n</td>
 </tr>
  <% 
      int count = 0;
 ...
 <tr class=xl71 height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <td class=xl81 style='border-top:none;border-left:none'><% = dt_total.Rows[i][4].ToString()%></td>
  ...
  <td class=xl85><% = dt_total.Rows[i][10].ToString()%></td>
  ...
  <td class=xl84 x:num><% = dt_total.Rows[i][14].ToString()%></td>
  <td class=xl84 x:num><% = dt_total.Rows[i][15].ToString()%></td>
  <td class=xl85><% = dt_total.Rows[i][16].ToString()%></td>
  <td class=xl75><% = dt_total.Rows[i][17].ToString()%></td>
  <td class=xl75><% = dt_total.Rows[i][18].ToString()%></td>
  <td class=xl75><% = dt_total.Rows[i][19].ToString()%></td>
 </tr>
 <%} %>
