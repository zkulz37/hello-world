...
public partial class reports_hd_ah_rpt_terminal_info : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_org_pk, p_wg_pk, p_nation, p_search_by, p_search_temp, p_date, p_emp_type, p_thr_ws_pk;
        ...
        string para = "'" + p_org_pk + "','" + p_wg_pk + "','" + p_nation + "','" + p_search_by + "','" + p_search_temp + "','" + p_date + "','" + p_emp_type + "','" + p_thr_ws_pk + "'";
        DataTable dt_emp = ESysLib.TableReadOpenCursor("HR_sel_terminal_data", para);
