...
<%
    string p_tco_dept_pk, p_thr_group_pk, p_status, p_emp_id, p_work_mon, p_from_dt, p_to_dt, p_dept_nm, p_salary_period, p_nation, p_lstEmpID, p_option_input;
    ...
    p_option_input = Request["l_option_input"].ToString();
...
*/
    ...
    if (int.Parse(p_option_input) == 1 && p_lstEmpID !="")
    {
        dt_Emp = ESysLib.TableReadOpenCursor("hr_rpt_employee_payroll_pdf", para);
    }
    
    if (int.Parse(p_option_input) == 0)
    {
