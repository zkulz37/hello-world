...
<%
    ...
    string SQL = "";
      ...
      SQL = "select a.dept_NM,a.EMP_ID,a.full_name,to_char(to_date(a.JOIN_DT,'yyyymmdd'),'dd/mm/yyyy') " +
        ...
        ",decode(b.D1,0,'',b.D1) || decode(nvl(b.N1,0),0,'',' N' || b.N1)|| decode(nvl(b.NT2_1,0),0,'',' N<sup>2</sup>' || b.NT2_1)	 " +
        ",decode(b.D2,0,'',b.D2) || decode(nvl(b.N2,0),0,'',' N' || b.N2)|| decode(nvl(b.NT2_2,0),0,'',' N<sup>2</sup>' || b.NT2_2)	 " +
        ",decode(b.D3,0,'',b.D3) || decode(nvl(b.N3,0),0,'',' N' || b.N3)|| decode(nvl(b.NT2_3,0),0,'',' N<sup>2</sup>' || b.NT2_3)	 " +
        ",decode(b.D4,0,'',b.D4) || decode(nvl(b.N4,0),0,'',' N' || b.N4)|| decode(nvl(b.NT2_4,0),0,'',' N<sup>2</sup>' || b.NT2_4)	 " +
        ",decode(b.D5,0,'',b.D5) || decode(nvl(b.N5,0),0,'',' N' || b.N5)|| decode(nvl(b.NT2_5,0),0,'',' N<sup>2</sup>' || b.NT2_5)	 " +
        ",decode(b.D6,0,'',b.D6) || decode(nvl(b.N6,0),0,'',' N' || b.N6)|| decode(nvl(b.NT2_6,0),0,'',' N<sup>2</sup>' || b.NT2_6)	 " +
        ",decode(b.D7,0,'',b.D7) || decode(nvl(b.N7,0),0,'',' N' || b.N7)|| decode(nvl(b.NT2_7,0),0,'',' N<sup>2</sup>' || b.NT2_7)	 " +
        ",decode(b.D8,0,'',b.D8) || decode(nvl(b.N8,0),0,'',' N' || b.N8)|| decode(nvl(b.NT2_8,0),0,'',' N<sup>2</sup>' || b.NT2_8)	 " +
        ",decode(b.D9,0,'',b.D9) || decode(nvl(b.N9,0),0,'',' N' || b.N9)|| decode(nvl(b.NT2_9,0),0,'',' N<sup>2</sup>' || b.NT2_9)	 " +
        ",decode(b.D10,0,'',b.D10) || decode(nvl(b.N10,0),0,'',' N' || b.N10)|| decode(nvl(b.NT2_10,0),0,'',' N<sup>2</sup>' || b.NT2_10)	 " +
        ",decode(b.D11,0,'',b.D11) || decode(nvl(b.N11,0),0,'',' N' || b.N11)|| decode(nvl(b.NT2_11,0),0,'',' N<sup>2</sup>' || b.NT2_11)	 " +
        ",decode(b.D12,0,'',b.D12) || decode(nvl(b.N12,0),0,'',' N' || b.N12)|| decode(nvl(b.NT2_12,0),0,'',' N<sup>2</sup>'|| b.NT2_12)	 " +
        ",decode(b.D13,0,'',b.D13) || decode(nvl(b.N13,0),0,'',' N' || b.N13)|| decode(nvl(b.NT2_13,0),0,'',' N<sup>2</sup>' || b.NT2_13)	 " +
        ",decode(b.D14,0,'',b.D14) || decode(nvl(b.N14,0),0,'',' N' || b.N14)|| decode(nvl(b.NT2_14,0),0,'',' N<sup>2</sup>' || b.NT2_14)	 " +
        ",decode(b.D15,0,'',b.D15) || decode(nvl(b.N15,0),0,'',' N' || b.N15)|| decode(nvl(b.NT2_15,0),0,'',' N<sup>2</sup>' || b.NT2_15)	 " +
        ",decode(b.D16,0,'',b.D16) || decode(nvl(b.N16,0),0,'',' N' || b.N16)|| decode(nvl(b.NT2_16,0),0,'',' N<sup>2</sup>' || b.NT2_16)	 " +
        ",decode(b.D17,0,'',b.D17) || decode(nvl(b.N17,0),0,'',' N' || b.N17)|| decode(nvl(b.NT2_17,0),0,'',' N<sup>2</sup>' || b.NT2_17)	 " +
        ",decode(b.D18,0,'',b.D18) || decode(nvl(b.N18,0),0,'',' N' || b.N18)|| decode(nvl(b.NT2_18,0),0,'',' N<sup>2</sup>' || b.NT2_18)	 " +
        ",decode(b.D19,0,'',b.D19) || decode(nvl(b.N19,0),0,'',' N' || b.N19)|| decode(nvl(b.NT2_19,0),0,'',' N<sup>2</sup>' || b.NT2_19)	 " +
        ",decode(b.D20,0,'',b.D20) || decode(nvl(b.N20,0),0,'',' N' || b.N20)|| decode(nvl(b.NT2_20,0),0,'',' N<sup>2</sup>' || b.NT2_20)	 " +
        ",decode(b.D21,0,'',b.D21) || decode(nvl(b.N21,0),0,'',' N' || b.N21)|| decode(nvl(b.NT2_21,0),0,'',' N<sup>2</sup>' || b.NT2_21)	 " +
        ",decode(b.D22,0,'',b.D22) || decode(nvl(b.N22,0),0,'',' N' || b.N22)|| decode(nvl(b.NT2_22,0),0,'',' N<sup>2</sup>' || b.NT2_22)	 " +
        ",decode(b.D23,0,'',b.D23) || decode(nvl(b.N23,0),0,'',' N' || b.N23)|| decode(nvl(b.NT2_23,0),0,'',' N<sup>2</sup>' || b.NT2_23)	 " +
        ",decode(b.D24,0,'',b.D24) || decode(nvl(b.N24,0),0,'',' N' || b.N24)|| decode(nvl(b.NT2_24,0),0,'',' N<sup>2</sup>' || b.NT2_24)	 " +
        ",decode(b.D25,0,'',b.D25) || decode(nvl(b.N25,0),0,'',' N' || b.N25)|| decode(nvl(b.NT2_25,0),0,'',' N<sup>2</sup>' || b.NT2_25)	 " +
        ",decode(b.D26,0,'',b.D26) || decode(nvl(b.N26,0),0,'',' N' || b.N26)|| decode(nvl(b.NT2_26,0),0,'',' N<sup>2</sup>' || b.NT2_26)	 " +
        ",decode(b.D27,0,'',b.D27) || decode(nvl(b.N27,0),0,'',' N' || b.N27)|| decode(nvl(b.NT2_27,0),0,'',' N<sup>2</sup>' || b.NT2_27)	 " +
        ",decode(b.D28,0,'',b.D28) || decode(nvl(b.N28,0),0,'',' N' || b.N28)|| decode(nvl(b.NT2_28,0),0,'',' N<sup>2</sup>' || b.NT2_28)	 " +
        ",decode(b.D29,0,'',b.D29) || decode(nvl(b.N29,0),0,'',' N' || b.N29)|| decode(nvl(b.NT2_29,0),0,'',' N<sup>2</sup>' || b.NT2_29)	 " +
        ",decode(b.D30,0,'',b.D30) || decode(nvl(b.N30,0),0,'',' N' || b.N30)|| decode(nvl(b.NT2_30,0),0,'',' N<sup>2</sup>' || b.NT2_30)	 " +
        ",decode(b.D31,0,'',b.D31) || decode(nvl(b.N31,0),0,'',' N' || b.N31)|| decode(nvl(b.NT2_31,0),0,'',' N<sup>2</sup>' || b.NT2_31)	 " +
        ",round(nvl(a.TOTAL_WD,0)/8,3) " +
        ",b.TOTAL_OT " +
        ",b.TOTAL_NT30 " +
		",b.TOTAL_NT45 " +
		",b.TOTAL_NT60 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2320 style='border-collapse:
 ...
 <col width=60 span="<%=iDate_Num%>" style='mso-width-source:userset;mso-width-alt:2000;
 width:45pt'>
 <col width=50 style='mso-width-source:userset;mso-width-alt:2000;width:45pt'>
 <col width=50 span=3 style='mso-width-source:userset;mso-width-alt:2000;
 width:45pt'>
 <col width=56 span=8 style='mso-width-source:userset;mso-width-alt:2048;
 width:42pt'>
 <col width=53 span=4 style='mso-width-source:userset;mso-width-alt:2000;
 width:40pt'>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  ...
  valign=top><!--[if gte vml 1]><v:shapetype id="_x0000_t75" coordsize="21600,21600"
   ...
   <v:imagedata src="..\..\..\system\binary\ViewFile.aspx?img_pk=<%=dt_Com.Rows[0][3].ToString()%>&table_name=<%=Session["APP_DBUSER"].ToString()%>.tco_bpphoto" o:title="vinagenuwin"/>
 ...
 <tr class=xl24 height=36 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl54 colspan=4 style='font-style:italic;'>NT</td>
  <td class=xl54 style='font-style:italic;'>Holiday</td>
  <td class=xl54 style='font-style:italic;'>Sun</td>
 ...
 <tr class=xl24 height=36 style='mso-height-source:userset;height:35.0pt'>
  ...
  <td class=xl54 style='border-top:none;font-style:italic;'>Ca <br> &#273;êm 30% </td>
  <td class=xl54 style='border-top:none;font-style:italic;'>Ca <br> &#273;êm 65% </td>
  <td class=xl54 style='border-top:none;font-style:italic;'>Ca <br> &#273;êm 80% </td>
  <td class=xl54 style='border-top:none;font-style:italic;'>Ca <br> &#273;êm 110% </td>
  <td class=xl54 style='border-top:none;font-style:italic;'>Ngày <br> l&#7877;</td>
  <td class=xl54 style='border-top:none;font-style:italic;'>Chủ nhật</td>
 ...
 <tr class=xl27 height=42 style='mso-height-source:userset;height:31.5pt'>
  ...
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black;border-top:
  none' x:num><%= dt_Emp.Rows[i][74].ToString() %></td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black;border-top:
  none' x:num><%= dt_Emp.Rows[i][75].ToString() %></td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black;border-top:
  none' x:num><%= dt_Emp.Rows[i][76].ToString() %></td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black;border-top:
  none' x:num><%= dt_Emp.Rows[i][77].ToString() %></td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black;border-top:
  none'>&nbsp;</td>
 </tr>
 <tr class=xl27 height=42 style='mso-height-source:userset;height:31.5pt'>
