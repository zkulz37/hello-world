...
public partial class rpt_detail_list_n : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ESysLib.SetUser(Session["APP_DBUSER"].ToString());

        string TemplateFile = "rpt_detail_list_n.xls";
        string TempFile = "../../../system/temp/rpt_detail_list_n_" + Session["User_ID"].ToString() + ".xls";
