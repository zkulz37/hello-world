...
<%
   ...
   string SQL
	= "SELECT to_char(sysdate,'dd/mm/yyyy'),C.ORG_NM,GP.WORKGROUP_NM ,A.EMP_ID, A.FULL_NAME " + 
        ...
        "       ,WKD.OVT,WKD.HT,WKD.NT,hr_code.code_nm " +
        ...
        SQL = SQL + "                 OR '"+p_tco_org_pk+"' = 'ALL') "+
        "        ) ABS " +
        " WHERE A.DEL_IF = 0 AND GP.DEL_IF=0 AND GW.DEL_IF=0 AND WS.DEL_IF=0 AND C.DEL_IF=0" +
        ...
        "   AND A.TCO_ORG_PK = C.PK AND GW.THR_WG_PK=GP.PK " +
