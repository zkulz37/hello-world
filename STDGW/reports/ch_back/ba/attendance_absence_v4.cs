...
public partial class attendance_absence_v4 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "attendance_absence_v4.xls";
        string TempFile = "../../../system/temp/attendance_absence_v4_" + Session["User_ID"].ToString() + ".xls";
