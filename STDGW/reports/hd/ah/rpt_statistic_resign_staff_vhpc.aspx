...
string p_work_mon,p_from,p_to,p_option;    
 ...
 string SQL
    = "SELECT DECODE(S.EMPLOYEE_TYPE,'01','OFFICE','FACTORY')  " + 
        ...
        ",NVL(W.WT_TMP_L1,0) " +
		",ROUND(NVL(S.WT_L1_AMT,0)+ NVL(S.WT_L2_AMT,0)+ NVL(S.HOL_DAY_L1_AMT,0)+ NVL(S.HOL_DAY_L2_AMT,0),0) SALARY_MON " +
        ...
        ",ROUND(NVL(S.SEVERANCE_AMT,0),0) COMPENSATE " +
        ...
        "ORDER BY S.EMPLOYEE_TYPE , S.DEPT_NM" ;
...
<link rel=File-List href="rpt_statistic_resign_staff_vhpc_files/filelist.xml">
<link rel=Edit-Time-Data
href="rpt_statistic_resign_staff_vhpc_files/editdata.mso">
<link rel=OLE-Object-Data
href="rpt_statistic_resign_staff_vhpc_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>HR_PHU</o:Author>
  <o:LastAuthor>welcome</o:LastAuthor>
  <o:LastPrinted>2011-02-18T01:50:46Z</o:LastPrinted>
  <o:Created>2011-02-08T01:52:52Z</o:Created>
  <o:LastSaved>2011-02-18T01:53:38Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1805 style='border-collapse:
 collapse;table-layout:fixed;width:1352pt'>
 ...
 width:77pt'>
 <col class=xl92 width=76 style='mso-width-source:userset;mso-width-alt:2779;
 width:57pt'>
<col class=xl103 width=76  style='mso-width-source:userset;mso-width-alt:
 2779;width:57pt'>
 <col class=xl103 width=104  style='mso-width-source:userset;mso-width-alt:
 3803;width:78pt'>
 <col class=xl103 width=76 span=6 style='mso-width-source:userset;mso-width-alt:
 2779;width:57pt'>
 <col class=xl103 width=103 span=2 style='mso-width-source:userset;mso-width-alt:
 3766;width:77pt'>
 ...
 <tr height=31 style='height:23.25pt'>
  ...
  <td class=xl94 width=103 style='width:77pt'></td>
 ...
 <tr height=31 style='height:23.25pt'>
  <td height=31 class=xl114 colspan=3 style='height:23.25pt;mso-ignore:colspan'>MONTH:
 ...
 <tr height=62 style='mso-height-source:userset;height:46.5pt'>
  <td colspan=18 height=62 class=xl122 width=1654 style='height:46.5pt;
  width:1239pt'>RESIGN STAFF<font class="font12"><br>
 ...
 <tr height=31 style='height:23.25pt'>
  ...
  <td class=xl97></td>
  <td class=xl87></td>
  <td colspan=10 class=xl104 style='mso-ignore:colspan'></td>
  <td class=xl71></td>
  <td colspan=2 class=xl70 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=31 style='height:23.25pt'>
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td rowspan=2 height=73 class=xl124 style='border-bottom:1.0pt solid black;
  height:54.75pt;border-top:none'>NO.</td>
  ...
  <td rowspan=2 class=xl116 style='border-bottom:1.0pt solid black;border-top:
  none'>DEPARTMENT</td>
  <td rowspan=2 class=xl128 style='border-bottom:1.0pt solid black;border-top:
  none' x:str="SALARY"><span style='mso-spacerun:yes'> </span>SALARY<span
  style='mso-spacerun:yes'> </span></td>
  <td rowspan=2 class=xl118 width=76 style='border-bottom:1.0pt solid black;
  border-top:none;width:57pt'>RESIGN<br>
    DATE</td>
  <td colspan=10 class=xl130 style='border-right:1.0pt solid black;border-left:
 ...
 <tr height=48 style='mso-height-source:userset;height:36.0pt'>
  <td height=48 class=xl105 width=76 style='height:36.0pt;border-left:none;
  ...
  x:str="MONTH&#10;BASIC&#10;SALARY"><span
  style='mso-spacerun:yes'> </span>MONTH<br>
    BASIC<br>
  ...
  style='mso-spacerun:yes'> </span></td>
  <td class=xl105 width=103 style='border-left:none;width:77pt'
  x:str="COMPENSATE"><span style='mso-spacerun:yes'> </span>COMPENSATE<span
  style='mso-spacerun:yes'> </span></td>
 ...
 <%
     ...
     for (int i = 0; i < irow_emp; i++)
     {
         ...
         s2 = s2 + Double.Parse(dt_Emp.Rows[i][16].ToString());
         total1 += Double.Parse(dt_Emp.Rows[i][5].ToString());
         total2 += Double.Parse(dt_Emp.Rows[i][16].ToString());
         if (flag)
         {
  %>
 <tr height=25 style='height:18.75pt'>
  <td colspan=18 height=25 class=xl134 style='border-right:1.0pt solid black;
 ...
 <tr height=24 style='height:18.0pt'>
  <td height=24 class=xl73 style='height:18.0pt;border-top:none'><%= count %></td>
  <td class=xl113><%=dt_Emp.Rows[i][1].ToString()%></td>
  <td class=xl111 x:str><span
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][2].ToString()%><span style='mso-spacerun:yes'> </span></td>
  <td class=xl74 style='border-left:none' x:st><span
  ...
  <td class=xl93 x:num><span style='mso-spacerun:yes'>           </span><%=dt_Emp.Rows[i][7].ToString()%>
  </td>
  <td class=xl93 style='border-left:none' x:num><span
 ...
 <tr height=25 style='height:18.75pt'>
  <td colspan=3 height=25 class=xl136 style='border-right:1.0pt solid black;
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  <td colspan=3 height=38 class=xl120 style='height:28.5pt'>Grand TOTAL</td>
