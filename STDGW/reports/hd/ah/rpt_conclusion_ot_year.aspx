...
<%
    ...
    = "select decode(e.EMPLOYEE_TYPE, '01', 'OFFICE', 'FACTORY'),case when a.pay_rate in (300,200,150) then 'OT '||a.pay_rate else 'NT '||a.pay_rate end " + 
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0101' and '"+ p_year +"'||'0131' then nvl(a.OT_TIME,0) else 0 end) mon01 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0201' and '"+ p_year +"'||'0229' then nvl(a.OT_TIME,0) else 0 end) mon02 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0301' and '"+ p_year +"'||'0331' then nvl(a.OT_TIME,0) else 0 end) mon03 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0401' and '"+ p_year +"'||'0430' then nvl(a.OT_TIME,0) else 0 end) mon04 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0501' and '"+ p_year +"'||'0531' then nvl(a.OT_TIME,0) else 0 end) mon05 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0601' and '"+ p_year +"'||'0630' then nvl(a.OT_TIME,0) else 0 end) mon06 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0701' and '"+ p_year +"'||'0731' then nvl(a.OT_TIME,0) else 0 end) mon07 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0801' and '"+ p_year +"'||'0831' then nvl(a.OT_TIME,0) else 0 end) mon08 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0901' and '"+ p_year +"'||'0930' then nvl(a.OT_TIME,0) else 0 end) mon09 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'1001' and '"+ p_year +"'||'1031' then nvl(a.OT_TIME,0) else 0 end) mon10 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'1101' and '"+ p_year +"'||'1130' then nvl(a.OT_TIME,0) else 0 end) mon11 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'1201' and '"+ p_year +"'||'1231' then nvl(a.OT_TIME,0) else 0 end) mon12 " +
        ",sum(case when a.WORK_DT between '"+ p_year +"'||'0101' and '"+ p_year +"'||'1231' then nvl(a.OT_TIME,0) else 0 end) total " +
...
//-----------------total --------------------
    ...
    = "select count(mon1.thr_emp_pk),count(mon2.thr_emp_pk),count(mon3.thr_emp_pk),count(mon4.thr_emp_pk),count(mon5.thr_emp_pk), " + 
        ...
        "from thr_employee e, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0101' and '" + p_year + "'||'0131' group by a.THR_EMP_PK) mon1, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0201' and '" + p_year + "'||'0229' group by a.THR_EMP_PK) mon2, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0301' and '" + p_year + "'||'0331' group by a.THR_EMP_PK) mon3, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0401' and '" + p_year + "'||'0430' group by a.THR_EMP_PK) mon4, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0501' and '" + p_year + "'||'0531' group by a.THR_EMP_PK) mon5, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0601' and '" + p_year + "'||'0630' group by a.THR_EMP_PK) mon6, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0701' and '" + p_year + "'||'0731' group by a.THR_EMP_PK) mon7, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0801' and '" + p_year + "'||'0831' group by a.THR_EMP_PK) mon8, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'0901' and '" + p_year + "'||'0930' group by a.THR_EMP_PK) mon9, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'1001' and '" + p_year + "'||'1031' group by a.THR_EMP_PK) mon10, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'1101' and '" + p_year + "'||'1130' group by a.THR_EMP_PK) mon11, " +
        "(select a.thr_emp_pk from thr_extra_time a where a.del_if=0 and a.work_dt between '" + p_year + "'||'1201' and '" + p_year + "'||'1231' group by a.THR_EMP_PK) mon12 " +
        "where e.del_if=0  " +
