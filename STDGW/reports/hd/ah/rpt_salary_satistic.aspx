...
<%
    ...
    = "select g.ORG_NM,v.CODE, " +
        ...
        "  from thr_month_salary s, vhr_hr_code v, comm.tco_org g " +
        "  where v.id= 'HR0133' and s.DEL_IF=0 and g.DEL_IF=0 and g.pk= s.TCO_DEPT_PK and s.WORK_MON='"+p_work_mon+"' " +
        "  group by g.P_PK, g.ORG_NM, v.CODE " +
        "  order by g.ORG_NM, v.code ";
