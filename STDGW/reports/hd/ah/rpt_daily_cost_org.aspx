...
<%
    ...
    = "select  b.org_nm c3,count(*) c4 " +
        ...
        " from thr_daily_cost a,tco_org b,thr_employee c "+
        "where a.del_if=0 and b.del_if=0 and c.del_if=0 " +
        "and a.thr_emp_pk=c.pk and a.tco_org_pk=b.pk " +
        ...
        "group by nvl(b.seq,1000),b.org_nm " +
        "order by nvl(b.seq,1000),b.org_nm ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=3722 style='border-collapse:
 ...
 <tr class=xl27 height=128 style='mso-height-source:userset;height:96.0pt'>
  ...
  <td class=xl30 width=0>Organization<br>
