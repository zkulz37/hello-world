...
<%
   ...
   string SQL
	= "select  " + 
        ...
        ",c17 " +
        "from  " +
        "(select max(b.ORG_LEVEL1_nm) as c1 " +
        ",max(b.ORG_LEVEL2_nm) as c2 " +
        ",max(b.DEPT_nm)  as c3 " +
        ",b.EMPLOYEE_TYPE as c4 " +
		",max(b.org_level1_id) as org_level1_id" +
		",max(b.org_level2_id) as org_level2_id" +
		",max(b.dept_id) as dept_id " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'01',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'01',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'01',1,0)))),10) c5 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'02',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'02',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'02',1,0)))),10) c6 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'03',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'03',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'03',1,0)))),10) c7 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'04',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'04',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'04',1,0)))),10) c8 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'05',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'05',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'05',1,0)))),10) c9 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'06',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'06',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'06',1,0)))),10) c10 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'07',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'07',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'07',1,0)))),10) c11 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'08',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'08',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'08',1,0)))),10) c12 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'09',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'09',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'09',1,0)))),10) c13 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'10',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'10',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'10',1,0)))),10) c14 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'11',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'11',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'11',1,0)))),10) c15 " +
        ",round(sum(decode(b.work_mon,'" + l_year + "' ||'12',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "' ||'12',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "' ||'12',1,0)))),10) c16 " +
        ",round(sum(decode(substr(b.work_mon,1,4),'" + l_year + "',round(b.gross_amt,10),0))/(decode(sum(decode(b.work_mon,'" + l_year + "',round(b.gross_amt,10),0)),0,1,sum(decode(b.work_mon,'" + l_year + "',1,0)))),10) c17 " +
        " from thr_month_salary b " +
        "where b.del_if=0 and b.work_mon like '" + l_year + "%' and nvl(b.net_amt,0)>=0 and b.ORG_LEVEL1_PK is not null " +
        "group by b.ORG_LEVEL1_PK,b.ORG_LEVEL2_PK,b.TCO_DEPT_PK,b.ORG_LEVEL1_id,b.ORG_LEVEL2_id,b.DEPT_id,b.EMPLOYEE_TYPE " + 
        "union all " +
        "select  max(b.ORG_LEVEL1_nm) as c1 " +
        ",'WW' as c2 " +
        ",'WW' as c3 " +
        ...
        " from thr_month_salary b " +
        "where b.del_if=0 and b.work_mon like '" + l_year + "%'  and nvl(b.net_amt,0)>=0 and b.ORG_LEVEL1_PK is not null " +
        " group by b.ORG_LEVEL1_PK,b.ORG_LEVEL1_id,b.EMPLOYEE_TYPE " +
        "union all " +
        "select  max(b.ORG_LEVEL1_nm) as c1 " +
        ",'WW' as c2 " +
        ",'WW' as c3 " +
        ...
        " from thr_month_salary b " +
        "where b.del_if=0 and b.work_mon like '" + l_year + "%'  and nvl(b.net_amt,0)>=0 and b.ORG_LEVEL1_PK is not null " +
        " group by b.ORG_LEVEL1_PK,b.ORG_LEVEL1_id " +
        "union all " +
        "select 'WW' as c1 " +
        ",'WW' as c2 " +
        ",'WW' as c3 " +
