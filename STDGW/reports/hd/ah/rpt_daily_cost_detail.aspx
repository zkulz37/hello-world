...
<%
    ...
    string SQL
     = "select  b.org_nm c1,a.emp_id c2,c.full_name c3,pl.pl_nm c4 " +
         ",round(nvl(a.SALARY,0)) c5, round(nvl(a.TOTAL_ALLOWANCE,0)) c6,nvl(a.WT,0) c7,nvl(a.ABS_PAY,0) c8 " +
         ",round(nvl(a.WT_AMT,0)+nvl(a.ABS_PAY_AMT,0)) c9 " +
         ",nvl(a.TOTAL_OT,0) c10,round(nvl(a.TOTAL_OT_AMT,0)) c11,round(nvl(a.INS_EMPLOYEE,0)) c12,round(nvl(a.INS_COMPANY,0)) c13 " +
         ",round(nvl(a.COMPANY_COST,0)) c14,nvl(A.EX_RATE,1) c15,to_char(to_date(a.work_dt,'yyyymmdd'),'DD-MON-YYYY') c16" +
         ...
         "order by nvl(b.seq,1000),b.org_nm,c.emp_id ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=3722 style='border-collapse:
 ...
 <col class=xl24 width=0 style='mso-width-source:userset;mso-width-alt:9000'>
 <col class=xl24 width=0 style='mso-width-source:userset;mso-width-alt:2779'>
 <col class=xl24 width=0 style='mso-width-source:userset;mso-width-alt:8000'>
 <col class=xl24 width=0 style='mso-width-source:userset;mso-width-alt:10240'>
 <col class=xl24 width=0 style='mso-width-source:userset;mso-width-alt:3840'>
 ...
 width:53pt'>
 <col class=xl24 width=108 span=4 style='mso-width-source:userset;mso-width-alt:
 3949;width:81pt'>
 ...
 <tr height=35 style='height:26.25pt'>
  <td colspan=3 height=35 class=xl39 style='height:26.25pt'>Work Date:<%=dt_Emp.Rows[0][15].ToString()%></td>
  <td class=xl25>Ex Rate:<%=dt_Emp.Rows[0][14].ToString()%></td>
  <td class=xl24></td>
  <td class=xl26></td>
 ...
 <tr class=xl27 height=128 style='mso-height-source:userset;height:96.0pt'>
  ...
  <td class=xl29 width=0>Organization<br>
    <font class="font11">Bộ phận</font></td>
  <td class=xl29 width=0>Emp ID<br>
    <font class="font11">Mã NV</font></td>
  <td class=xl30 width=0>Full Name<br>
 ...
 for (i = 0; i < irow_emp; i++)
 {
     ...
     Total[12] += double.Parse(dt_Emp.Rows[i][12].ToString());
     Total[13] += double.Parse(dt_Emp.Rows[i][13].ToString());
%>
 <tr class=xl32 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl43 x:num><%=dt_Emp.Rows[i][4].ToString()%></td>
  <td class=xl43 x:num><%=dt_Emp.Rows[i][5].ToString()%></td>
  <td class=xl44 x:num><%=dt_Emp.Rows[i][6].ToString()%></td>
  <td class=xl44 x:num><%=dt_Emp.Rows[i][7].ToString()%></td>
  ...
  <td class=xl43 x:num><%=dt_Emp.Rows[i][12].ToString()%></td>
  <td class=xl43 x:num><%=dt_Emp.Rows[i][13].ToString()%></td>
 ...
 <tr class=xl35 height=39 style='mso-height-source:userset;height:29.25pt'>
  <td colspan=5 height=39 class=xl40 style='border-right:.5pt solid black;
  height:29.25pt'>TOTAL</td>
  <td class=xl36 align=center x:num><%=Total[4]%></td>
  <td class=xl36 align=right x:num><%=Total[5]%></td>
  <td class=xl37 align=right x:num><%=Total[6]%></td>
  <td class=xl37 align=right x:num><%=Total[7]%></td>
  <td class=xl36 align=right x:num><%=Total[8]%></td>
  <td class=xl37 align=right x:num><%=Total[9]%></td>
  <td class=xl36 align=right x:num><%=Total[10]%></td>
  <td class=xl36 align=right x:num><%=Total[11]%></td>
  <td class=xl36 align=right x:num><%=Total[12]%></td>
  <td class=xl36 align=right x:num><%=Total[13]%></td>
