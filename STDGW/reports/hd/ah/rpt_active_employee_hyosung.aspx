...
<%  
	...
	= "select (SELECT   max(T.org_nm) " + 
        ...
        "                                    START WITH t.pk=e.tco_org_pk " +
        "                                    CONNECT BY PRIOR t.p_pk=t.pk) AS dept,G.ORG_NM org_nm " +
        ...
        "where E.DEL_IF=0 " +
        "and G.DEL_IF=0 and e.nation='01' " +
...
<table border=0 cellpadding=0 cellspacing=0 width=1390 style='border-collapse:
 ...
 <tr height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  <td class=xl70 style='border-left:none'>Plant</td>
  <td class=xl70 style='border-left:none'>Department</td>
  <td class=xl70 style='border-left:none'>Section</td>
 ...
 <tr height=27 style='mso-height-source:userset;height:20.25pt'>
  ...
  <td class=xl74 style='border-top:none;border-left:none'><%=dt_emp.Rows[i][11].ToString() %></td>
