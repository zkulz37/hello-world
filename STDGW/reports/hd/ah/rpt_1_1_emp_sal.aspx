...
<%
   ...
   string SQL
	= "select  " + 
        ...
        ",sum(decode(a.work_mon,'" + l_year + "' ||'01',1,0)) c5 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'02',1,0)) c6 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'03',1,0)) c7 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'04',1,0)) c8 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'05',1,0)) c9 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'06',1,0)) c10 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'07',1,0)) c11 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'08',1,0)) c12 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'09',1,0)) c13 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'10',1,0)) c14 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'11',1,0)) c15 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'12',1,0)) c16 " +
        ",sum(decode(substr(a.work_mon,1,4),'" + l_year + "',1,0)) c17 " +
		...
		",max(a.org_level1_id) as org_level1_id" +
		",'WW' as org_level2_id" +
		",'WW' as dept_id " +",sum(decode(a.work_mon,'" + l_year + "' ||'01',1,0)) c5 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'02',1,0)) c6 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'03',1,0)) c7 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'04',1,0)) c8 " +
        ",sum(decode(a.work_mon,'" + l_year + "' ||'05',1,0)) c9 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2127 style='border-collapse:
 ...
 width:119pt'>
 <col class=xl84 width=85 span=3 style='mso-width-source:userset;mso-width-alt:
 2720;width:64pt'>
 <col class=xl102 width=85 span=10 style='mso-width-source:userset;mso-width-alt:
 2720;width:64pt'>
