...
<%
    ...
    string p_to, p_org, p_status, p_nation, p_month, p_rate;
    ...
    = "select " + 
        ...
        ",sum(nvl(a.OT_TIME,0)) as total_13 " +
        ",round(max(nvl(s.TOTAL_OT_L1_AMT,0) + nvl(s.TOTAL_OT_L2_AMT,0)),0) as total_amt_14 " +
        "from thr_extra_time a, thr_employee b, comm.tco_org c, thr_month_salary s " +
        ...
        "and a.WORK_DT between to_char(add_months(to_date('" + p_month + "','yyyymm'),-1),'yyyymm')||'16' and '" + p_month + "'||'15'  " +
            ...
            "union all " +
        "select decode(t.EMPLOYEE_TYPE,'01','OFFICE','FACTORY')  " +
        " , t.EMP_ID " +
        " , t.FULL_NAME  " +
        " ,(select max(code_nm) from vhr_hr_code where id='HR0008' and code=t.POS_TYPE) as position_3 " +
        " ,d.org_nm " +
        " , max(g.salary_level2),0,0,0,0,0,0,0,0,round(sum(nvl(k.adj_amt,0)),0) " +
        "from thr_employee t , comm.tco_org d, thr_salary_adjustment k, thr_month_salary g " +
        "where t.del_if=0 and d.del_if=0 and k.del_if=0 and g.del_if(+)=0 " +
        "and k.thr_emp_pk = g.thr_emp_pk(+)  " +
        "and g.work_mon = '" + p_month + "' " +
        "and t.TCO_ORG_PK = d.pk " +
        "and k.thr_emp_pk = t.pk " +
        "and k.adj_dt between to_char(add_months(to_date('" + p_month + "','yyyymm'),-1),'yyyymm')||'16' and '" + p_month + "'||'15' " +
        "and k.adj_type ='02' " +
        "and t.thr_wg_pk=61 " +
        "group by t.EMP_ID, t.FULL_NAME, t.POS_TYPE, t.EMPLOYEE_TYPE, d.ORG_NM  " +
        "order by 1 desc " ;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1447 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  </v:shapetype><v:shape id="Picture_x0020_1" o:spid="_x0000_s1043" type="#_x0000_t75"
   style='position:absolute;margin-left:6.75pt;margin-top:3.75pt;width:156pt;
   height:39pt;z-index:1;visibility:visible'>
   <v:imagedata src="rpt_overtime_detail_vhpc_files/image001.png" o:title=""/>
  ...
  position:absolute;z-index:1;margin-left:9px;margin-top:5px;width:208px;
  height:52px'><img width=208 height=52
  src="rpt_overtime_detail_vhpc_files/image002.jpg" v:shapes="Picture_x0020_1"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td height=20 width=63 style='height:15.0pt;width:47pt'></td>
   </tr>
  </table>
  </span></td>
 ...
 <tr height=32 style='mso-height-source:userset;height:24.0pt'>
  ...
  <td class=xl87 style='border-top:none'>vnd</td>
  <td class=xl90></td>
  <td colspan=2 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='height:16.5pt'>
  ...
  <td class=xl87 style='border-top:none'>vnd</td>
  <td class=xl88 style='border-left:none'>ex rate</td>
  <td colspan=2 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='height:16.5pt'>
  ...
  style='mso-spacerun:yes'>           </span><%= gtotal[9]/count/Double.Parse(p_rate.ToString()) %> </td>
  <td class=xl87 style='border-top:none'>usd</td>
