...
<%
    ...
    string SQL
     = "select (SELECT   max(T.org_nm)    " +
         ...
         "    ,sum( case when substr(f_get_month(S.LEFT_DT),-2)='01' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_01 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='01' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_01 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='02' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_02 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='02' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_02 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='03' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_03 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='03' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_03 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='04' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_04 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='04' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_04 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='05' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_05 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='05' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_05 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='06' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_06 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='06' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_06 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='07' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_07 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='07' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_07 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='08' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_08 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='08' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_08 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='09' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_09 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='09' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_09 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='10' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_10 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='10' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_10 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='11' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_11 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='11' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_11 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='12' and nvl(S.EMPLOYEE_TYPE,' ')='01' then 1 else 0 end ) wt_s_12 " +
         "    ,sum( case when substr(F_GET_MONTH(S.LEFT_DT),-2)='12' and nvl(S.EMPLOYEE_TYPE,' ')='02' then 1 else 0 end ) wt_w_12 " +
         "from thr_employee s " +
         "where S.DEL_IF=0  and s.nation='01' " +
         "and f_get_month(S.LEFT_DT) like '" + p_year + "%' " +
