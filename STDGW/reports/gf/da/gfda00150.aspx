...
<% 
    ...
    SQL
	= "select pk, PARTNER_NAME, NVL(ADDR1, '') , TAX_CODE from tco_company where del_if = 0 " ;
    ...
    SQL
        = "select a.voucherno, to_char(to_date(a.tr_date, 'YYYYMMDD'), 'DD/MM/YYYY') trans_dt, i.item_code, i.item_name, i.uom,  " +
            "    d.ap_qty, d.ap_uprice, d.ap_trfamt, d.ap_tramt, d.impvat_famt, d.impvat_amt, v.pl_cd, v.pl_nm, p.partner_id,   " +
            "    p.partner_name, a.invoice_no, a.invoice_date, a.remark2, c.ac_cd, w.wh_name  " +
            "from tco_item i, tac_crdad d, tac_crda a,   " +
            ...
            " order by c.ac_cd, a.tr_date, i.item_code  ";
