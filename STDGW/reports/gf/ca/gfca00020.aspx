...
SQL
    ...
    {        
        Response.Write("There is not data to print out!!!");
        Response.End();
    }
	SQL = "";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=938 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl51 align=right style='border-top:none;border-left:.5pt solid black' x:str>Nợ <%=ls_accdr %></td>
  <td class=xl43 style="mso-number-format:'<%=l_xls_book_ccy%>';" x:num><%=dtMaster.Rows[0][11]%></td>  
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl43 style="mso-number-format:'<%=l_xls_book_ccy%>';" x:num><%=dtMaster.Rows[0][9]%></td>  
 </tr>
 <tr height=30 style='height:22.5pt'>
  ...
  <td class=xl43 style="mso-number-format:'<%=l_xls_book_ccy%>';" x:num><%=dtMaster.Rows[0][10]%></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl80 style='border-top:none;border-left:none' x:num><%=dtMaster.Rows[0][12] %>%</td>
  <td class=xl84 style='border-top:none;border-left:none'>&nbsp;</td>
