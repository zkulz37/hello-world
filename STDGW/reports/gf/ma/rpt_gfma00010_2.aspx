...
<%
  ...
  string SQL_EACAB044 = "SELECT   char_1, char_2, char_3,char_4, code " +
        ...
        "    WHERE a.pk = b.tac_commcode_master_pk AND a.ID = 'EACAB044' " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=914 style='border-collapse:
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <%
		Response.Write(dt.Rows[0]["TCO_BPPHOTO_PK"].ToString());
		Response.End();
   %>
  </table>
  </span></td>
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td colspan=4 height=22 class=xl27 style='height:17.1pt'>GI&#7844;Y
  &#272;&#7872; NGH&#7882; T&#7840;M &#7912;NG</td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td colspan=4 height=22 class=xl28 style='height:17.1pt'>(ADVANCE REQUEST)</td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td height=22 class=xl24 colspan=3 style='height:17.1pt;mso-ignore:colspan'>&#272;&#7873;
  ngh&#7883; cho t&#7841;m &#7913;ng<span style='mso-spacerun:yes'> 
  </span>s&#7889; ti&#7873;n <font class="font10">(Advance Amount)</font><font
  class="font6"> : </font><font class="font11"><%=dt.Rows[0]["tr_amt1"].ToString() %></font></td>
  <td class=xl24></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td height=22 class=xl24 colspan=2 style='height:17.1pt;mso-ignore:colspan'>Vi&#7871;t
  b&#7857;ng ch&#7919; <font class="font10">(By words): </font><font
  class="font9"><%
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  do t&#7841;m &#7913;ng <font class="font10"><span
  style='mso-spacerun:yes'> </span>(Reasons): </font><font class="font11"><%=dt.Rows[0]["l_description"].ToString() %></font></td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td height=22 class=xl24 colspan=2 style='height:17.1pt;mso-ignore:colspan'>Th&#7901;i
  h&#7841;n thanh toán: <font class="font11"><%=dt.Rows[0]["req_date"].ToString() %></font></td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
