...
<%
 ...
 %>
<table x:str border=0 cellpadding=0 cellspacing=0 width=6156 style='border-collapse:collapse;table-layout:fixed;width:4637pt'>
...
<!------------------------------------------------------------------------------------------------> 
 ...
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt'> 
   
   <%      
        if ( p_Loai=="96" && p_Thang=="01" )//nua nam lan I
           _class = "";
       else //if (p_Loai == "96" && p_Thang != "01")
           _class = ";display:none";     
    %>            
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "02")//nua nam lan I
           _class = "";
       else //if (p_Loai == "96" && p_Thang != "02")
           _class = ";display:none";     
    %>    
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "03") //nua nam lan I
        _class = ""; 
      else// if (p_Loai == "96" && p_Thang != "03")
        _class = ";display:none";
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "04")//nua nam lan I
        _class = "";
       else //if (p_Loai == "96" && p_Thang != "04")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "05")//nua nam lan I
        _class = "";
       else// if (p_Loai == "96" && p_Thang != "05")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "06")//nua nam lan I
        _class = "";
       else// if (p_Loai == "96" && p_Thang != "06")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
<%      
    if (p_Loai == "96" && p_Thang == "07")//nua nam lan I
        _class = "";
       else //if (p_Loai == "96" && p_Thang != "07")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'> 
<%      
    if (p_Loai == "96" && p_Thang == "08")//nua nam lan I
        _class = "";
       else //if (p_Loai == "96" && p_Thang != "08")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
<%      
    if (p_Loai == "96" && p_Thang == "09")//nua nam lan I
        _class = "";
       else //if (p_Loai == "96" && p_Thang != "09")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
<%      
    if (p_Loai == "96" && p_Thang == "10")//nua nam lan I
        _class = "";
       else //if (p_Loai == "96" && p_Thang != "10")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
<%      
    if (p_Loai == "96" && p_Thang == "11")//nua nam lan I
        _class = "";
       else// if (p_Loai == "96" && p_Thang != "11")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
<%      
    if (p_Loai == "96" && p_Thang == "12")//nua nam lan I
        _class = "";
       else// if (p_Loai == "96" && p_Thang != "12")
        _class = ";display:none";  
    %> 
 <col width=110 span=1 style='mso-width-source:userset;mso-width-alt:4022; width:83pt<%=_class %>'>  
...
<!--------------------------------------------------------------------------------------------------->
 ...
 <col width=110 span=39 style='mso-width-source:userset;mso-width-alt:4022;width:83pt'>
 <col width=64 span=19 style='width:48pt'>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl24 colspan=2 width=325 style='height:12.75pt;mso-ignore:colspan;width:244pt'><%=p_company_name%></td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=62 style='height:12.75pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl24 colspan=2 style='height:12.75pt;mso-ignore:colspan'><%=p_cmp_add%></td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=58 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=34 style='height:25.5pt;mso-xlrowspan:2'>
  <td height=34 colspan=62 style='height:25.5pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=43 height=33 class=xl41 style='height:24.95pt'>Budget Draft
  Inquiry</td>
 ...
 <tr height=20 style='height:15.0pt'>
  <td colspan=43 height=20 class=xl25 style='height:15.0pt'>&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Từ
  ngày <%=p_From%> đến ngày <%=p_To%></td>
  <td colspan=19 class=xl40 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=18 style='height:13.5pt'>
  <td height=18 colspan=62 style='height:13.5pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl27>&nbsp;</td>
  <td class=xl27>&nbsp;</td>
  <td colspan=13 class=xl42 style='border-right:.5pt solid black'>Budget</td>
  <td colspan=13 class=xl45 style='border-right:.5pt solid black;border-left:
  none'>Phát Sinh</td>
  <td colspan=13 class=xl45 style='border-right:1.0pt solid black;border-left:
  none'>Chênh Lệch</td>
  <td colspan=19 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl28 height=22 style='height:16.5pt'>
  <td height=22 class=xl29 style='height:16.5pt'>Mã</td>
  <td class=xl30>Tên</td>
  <td class=xl30>Mã TK</td>
  <td class=xl30>Tên TK</td>
  <td class=xl30>Tổng</td>
  <td class=xl30>Tháng 1</td>
  <td class=xl30>Tháng 2</td>
  <td class=xl30>Tháng 3</td>
  <td class=xl30>Tháng 4</td>
  <td class=xl30>Tháng 5</td>
  <td class=xl30>Tháng 6</td>
  <td class=xl30>Tháng 7</td>
  <td class=xl30>Tháng 8</td>
  <td class=xl30>Tháng 9</td>
  <td class=xl30>Tháng 10</td>
  <td class=xl30>Tháng 11</td>
  <td class=xl30>Tháng 12</td>
  <td class=xl30>Tổng</td>
  <td class=xl30>Tháng 1</td>
  <td class=xl30>Tháng 2</td>
  <td class=xl30>Tháng 3</td>
