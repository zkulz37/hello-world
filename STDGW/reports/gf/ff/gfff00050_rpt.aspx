...
<%
	...
	int l_width_VIE =0;
    int l_width_KOR =0;
	string l_display_ENG ="";
    string l_display_VIE ="";
	string l_display_KOR ="";
	...
	switch(l_lang)
	{
		case "VIE":
			...
			l_width_VIE =180;
			l_width_KOR =0;
			l_display_ENG ="display:none;display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_VIE="mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_KOR="display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
		break;
        case "ENG":
			l_width_ENG =180;
			l_width_VIE =0;
			l_width_KOR =0;
			l_display_ENG ="mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_VIE="display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_KOR="display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
		break; 
		case "KOR":
			l_width_ENG =0;
			l_width_VIE =0;
			l_width_KOR =180;
			l_display_ENG ="display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_VIE="display:none;mso-width-source:userset;mso-width-alt:6582; width:135pt";
			l_display_KOR="mso-width-source:userset;mso-width-alt:6582; width:135pt";
		break; 
		case "KOR-VIE":
			l_width_ENG =0;
			l_width_VIE =180;
   ...
   String p_xls_ccy_format ="";
    ...
    SQL = " SELECT  decode( '" + l_lang + "', 'ENG', code_nm, 'KOR',code_fnm , 'VIE', code_Lnm, 'KOR-VIE',code_fnm || '/' || code_Lnm, 'ENG-VIE',code_nm|| '/' || code_Lnm,'ENG-VIE-KOR', code_nm|| '/' || code_fnm ||  '/' ||    code_Lnm, 'ENG-KOR', code_nm|| '/' || code_fnm  ) code_nm ";
    SQL += "    FROM tco_abcode a, tco_abcodegrp b";
    SQL += "   WHERE a.tco_abcodegrp_pk = b.pk";
    SQL += "     AND b.ID = 'ACBG0150'";
    SQL += "     AND a.use_if = 1";
    SQL += "     AND a.del_if = 0";
    SQL += "     AND b.del_if = 0";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1961 style='border-collapse:
 ...
 width:47pt'>
  <col class=xl24 width=180 style= <%=l_display_VIE%>>
 <col class=xl24 width=180 style=<%=l_display_ENG%> >
 <col class=xl24 width=180 style=<%=l_display_KOR%>>
 ...
 <tr class=xl34 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td width=0 style='width:135pt' align=left valign=top></td>
  <td class=xl34 width=180 style='width:135pt'></td>
  <td class=xl34 width=180 style='width:135pt'></td>
  <td class=xl34 width=180 style='width:77pt'></td>
 ...
 <tr class=xl34 height=27 style='height:20.25pt'>
  ...
  <td colspan=16 class=xl42><%=p_tittle %></td>
  <td class=xl34></td>
 </tr>
 <tr class=xl34 height=21 style='height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'></td>
  <td colspan=16 class=xl43>T&#7915; <%= p_date_frm %> &#273;&#7871;n <%= p_date_to%></td>
  <td class=xl34></td>
 </tr>
 ...
 <tr class=xl34 height=17 style='height:12.75pt'>
  ...
  <td rowspan=2  width=180 class=xl33>Code</td>
  <td rowspan=2  width=180 class=xl33>Kho&#7843;n m&#7909;c<span
  style='mso-spacerun:yes'>  </span>(VIE)</td>
  <td rowspan=2 width=180 class=xl33>Item (ENG)</td>
  <td rowspan=2 class=xl33>Item (KOR)</td>
...
<%
     SQL = "SELECT HEADER,SF_A_GET_ACCD_st2(A.TAC_STCODE_PK, '" + l_company_pk + "'), " +
              ...
              "            ROUND( sf_gfff00050_1(A.PK,'" + l_date_from + "',A.TCO_COMPANY_PK,'" + l_status + "','ACC','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Accumlate, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'01',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Jan, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'02',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Feb, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'03',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Mar, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'04',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Apr, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'05',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_May, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'06',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Jun, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'07',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Jul, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'08',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Aug, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'09',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Sep, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'10',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Oct, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'11',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Nov, " +
              "            ROUND( sf_gfff00050_1(A.PK,'" + p_year + "'||'12',A.TCO_COMPANY_PK,'" + l_status + "','MONTH','" + l_rate1 + "','" + l_rate2 + "','" + l_rate3 + "'),2) sum_Dec " +
              "              " +
              "        FROM TAC_KAFINANCEFORM_ST A " +
              "       WHERE A.DEL_IF = 0 " +
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl28 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][2].ToString() %></td>
  <td class=xl28 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][3].ToString() %></td>
  <td class=xl28 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][4].ToString() %></td>
