...
*/
    ...
    //Response.End();
    DataTable dt = ESysLib.TableReadOpenCursor("acnt.SP_SEL_gfff00020_1", l_parameter);
    l_parameter = "'" + l_compk + "','" + l_lang + "','" + l_date_fr + "','" + l_date_to + "','" + l_status + "','" + l_current + "','" + l_rate + "','" + l_level + "','" + l_possum + "','" + l_accd + "','" + l_check_sum + "','" + l_pacctype + "'";
    DataTable dtTotal = ESysLib.TableReadOpenCursor("acnt.SP_SEL_gfff00020_1", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-12-28T07:41:03Z</o:LastSaved>
    ...
    <x:WorksheetOptions>
     ...
     <x:Panes>
      ...
      <x:Pane>
       ...
       <x:RangeSelection>$C$14:$D$14</x:RangeSelection>
      </x:Pane>
     </x:Panes>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1740 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl26 width=245 style='height:15.75pt;width:184pt'><%=l_company %>
  </td>
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=12 height=26 class=xl29 style='height:19.5pt'>Từ tháng
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl35 style='height:15.0pt'><%=tag_begin%><%=dt.Rows[i]["ac_cd"]%><%=tag_end%></td>
  <td class=xl35><%=tag_begin%><%=dt.Rows[i]["nm"]%><%=tag_end%></td>
  <td class=xl36 width=245 style='width:184pt'><%=tag_begin%><%=dt.Rows[i]["ac_knm"]%><%=tag_end%></td>
  <td class=xl36 width=69 style='width:52pt'>Level <%=tag_begin%><%=dt.Rows[i]["ac_level"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["dr_op"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["cr_op"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["dr_ps"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["cr_ps"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["dr_acc"]%><%=tag_end%></td>
  <td class=xl38 x:num><%=tag_begin%><%=dt.Rows[i]["cr_acc"]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i]["dr_bl"]%><%=tag_end%></td>
  <td class=xl38 x:num><%=tag_begin%><%=dt.Rows[i]["cr_bl"]%><%=tag_end%></td>
 </tr>
 <%
 ...
 <tr class=xl25 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl41 x:num><%=sum1%></td>
  <td class=xl41 x:num><%=sum2%></td>
  <td class=xl41 x:num><%=sum3%></td>
  <td class=xl41 x:num><%=sum4%></td>
  <td class=xl41 x:num><%=sum5%></td>
  <td class=xl42 x:num><%=sum6%></td>
  <td class=xl41 x:num><%=sum7%></td>
  <td class=xl42 x:num><%=sum8%></td>
 </tr>
