...
public partial class rpt_gfbr00040_KEB_GiayLinhTienMat_excel_pattern : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_gfbr00040_KEB_GiayLinhTienMat_excel_pattern.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_KEB_GiayLinhTienMat_excel_pattern_" + Session["User_ID"].ToString() + ".xls";
	...
	p_Amt1 = dt_Amount.Rows[0][14].ToString();
		...
		else//usd
		{
			if(p_Amt1.Length >=15)
			{
				...
				exSheet.Cells[12, 25].Value = p_Amt1[p_Amt1.Length - 15];
			}
			if(p_Amt1.Length >=14)
			{
				
				exSheet.Cells[12, 24].Value = p_Amt1[p_Amt1.Length - 14];
			}
			if(p_Amt1.Length >=12)
				{
		...
		if(p_Ccy=="VND")
		{
			exSheet.Cells[8, 16].Value = p_Amt1;
