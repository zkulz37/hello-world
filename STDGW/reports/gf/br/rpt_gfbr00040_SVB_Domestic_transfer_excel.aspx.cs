...
public partial class rpt_gfbr00040_SVB_Domestic_transfer_excel : System.Web.UI.Page
{
...
string l_Seq = Request["p_Seq"];
    ...
    string p_TaxCode = "";
        ...
        string TemplateFile = "rpt_gfbr00040_SVB_Domestic_transfer_excel.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_SVB_Domestic_transfer_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[6,2].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[3,8].Value ="..."+p_Date+"...";	
				exSheet.Cells[3,10].Value ="/.."+p_Month+"...";
				exSheet.Cells[3,11].Value ="/.."+p_Year+"...";
			exSheet.Cells[10,2].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[16,12].Value = p_Amt.Trim();			//money
			exSheet.Cells[13,9].Value = p_C_Bank;
			exSheet.Cells[21,9].Value =p_Remark; //"NỘI DUNG NỘP(Details):"+
			exSheet.Cells[3,14].Value =p_TaxCode;
			exSheet.Cells[18,12].Value =Inword; 
			exSheet.Cells[13,10].Value = p_C_Add;
			//exSheet.Cells[13,9].Value = p_C_Acc_Nm;
			exSheet.Cells[9,4].Value =p_D_Bank ;	//p_D_Acc_No		
			exSheet.Cells[10,9].Value = p_C_Acc_No ;	//p_C_Acc_Nm
			exSheet.Cells[6,9].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			/*/----------------page 2---------------------
