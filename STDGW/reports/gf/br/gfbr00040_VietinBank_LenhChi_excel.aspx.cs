...
using NativeExcel;
public partial class gfbr00040_VietinBank_LenhChi_excel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_Remark = "";
        string p_Remark_ENG = "";
		string TemplateFile = "gfbr00040_VietinBank_LenhChi_excel.xls";
        string TempFile = "../../../system/temp/gfbr00040_VietinBank_LenhChi_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[6,23].Value =p_Date;	
			...
			exSheet.Cells[11,5].Value =Inword;			
			exSheet.Cells[17,2].Value =p_Remark;
			exSheet.Cells[11,21].Value = p_Amt;
			exSheet.Cells[11,31].Value = p_Ccy;
       }
