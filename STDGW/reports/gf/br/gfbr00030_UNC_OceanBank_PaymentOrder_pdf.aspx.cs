...
public partial class gfbr00030_UNC_OceanBank_PaymentOrder_pdf: System.Web.UI.Page
{
    ...
    string p_So = "";
        ...
        string TemplateFile = "gfbr00030_UNC_OceanBank_PaymentOrder_pdf.xls";
        string TempFile = "../../../system/temp/gfbr00030_UNC_OceanBank_PaymentOrder_pdf_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			 ...
			 exSheet.Cells[5,7].Value =p_Amt+" "+p_Ccy;
			 exSheet.Cells[6,2].Value = p_D_Acc_Nm;
			 if(Inword.Length > 23)
			 {
				Inword_Legth = Inword.Length - 23;
				exSheet.Cells[6,7].Value = Inword.Substring(0,23);
				exSheet.Cells[7,7].Value = Inword.Substring(23,Inword_Legth);
			 }
			 else
			 {
				exSheet.Cells[6,7].Value = Inword;
			 }
			 
			 exSheet.Cells[7,2].Value = p_D_Add;
			 exSheet.Cells[8,2].Value = p_D_Bank;
			 exSheet.Cells[10,2].Value = p_C_Acc_No;
			 exSheet.Cells[11,2].Value = p_C_Acc_Nm;
			 exSheet.Cells[12,2].Value = p_C_Add;
			 exSheet.Cells[13,2].Value = p_C_Bank;
			 ...
			 // else
			 // {
				exSheet.Cells[10,6].Value = p_Remark;
			 // }
		}     
