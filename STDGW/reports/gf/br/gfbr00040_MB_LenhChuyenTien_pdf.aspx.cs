...
public partial class gfbr00040_MB_LenhChuyenTien_pdf : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "gfbr00040_MB_LenhChuyenTien_pdf.xls";
        string TempFile = "../../../system/temp/gfbr00040_MB_LenhChuyenTien_pdf_" + Session["User_ID"].ToString() + ".xls";
    ...
    if (dt_Amount.Rows.Count > 0)
    {
        ...
        p_Amt1 = dt_Amount.Rows[0][15].ToString().Trim();
		...
		exSheet.Cells[9, 3].Value = p_D_Acc_Nm;
        exSheet.Cells[9, 5].Value = "Số TK (A/c number): "+p_D_Acc_No;
        exSheet.Cells[11, 3].Value = p_D_Add;
        exSheet.Cells[13, 4].Value = p_Ccy+" "+ p_Amt1;
        exSheet.Cells[15, 4].Value = Inword+" ./.";
		exSheet.Cells[20, 3].Value = p_C_Bank;
		exSheet.Cells[22, 3].Value = "";
		exSheet.Cells[23, 3].Value = p_C_Acc_Nm;
		exSheet.Cells[24, 5].Value = p_C_Acc_No;
		exSheet.Cells[25, 3].Value = p_C_Add;
        exSheet.Cells[26, 2].Value = p_Remark;
