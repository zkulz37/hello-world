...
public partial class rpt_gfbr00040_Woori_DonXinGiaoDichNgoaiTe_excel : System.Web.UI.Page
{
    ...
    string p_TaxCode = "";
        ...
        string TemplateFile = "rpt_gfbr00040_Woori_DonXinGiaoDichNgoaiTe_excel.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_Woori_DonXinGiaoDichNgoaiTe_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[5,3].Value = p_D_Acc_Nm;
			exSheet.Cells[11,3].Value = p_Phone;				
			exSheet.Cells[13,3].Value = p_Amt;
			exSheet.Cells[9,4].Value =p_D_Add;	
