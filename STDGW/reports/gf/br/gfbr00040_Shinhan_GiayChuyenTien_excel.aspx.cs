...
public partial class gfbr00040_Shinhan_GiayChuyenTien_excel : System.Web.UI.Page
{
    ...
    string p_Branch_Benefi = "";
        ...
        string TemplateFile = "gfbr00040_Shinhan_GiayChuyenTien_excel.xls";
        string TempFile = "../../../system/temp/gfbr00040_Shinhan_GiayChuyenTien_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			...
			exSheet.Cells[13,12].Value = ".."+p_Date+"../"+p_Month+"../.."+p_Year+"...";
			exSheet.Cells[17,5].Value = p_Amt.Trim();
			exSheet.Cells[18,5].Value =Inword; 			
			exSheet.Cells[21,6].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[24,8].Value = p_Add_Appli;
			exSheet.Cells[23,8].Value = p_Tel_No;
			exSheet.Cells[25,7].Value = p_D_Acc_No;
			exSheet.Cells[15,3].Value = p_D_Acc_No; 
			//exSheet.Cells[13,12].Value =p_Date;				
			exSheet.Cells[27,7].Value = p_C_Acc_Nm;
			exSheet.Cells[33,9].Value = p_C_Acc_No ;
										
			exSheet.Cells[30,8].Value = p_C_Bank;
			exSheet.Cells[31,8].Value = p_Branch_Benefi;
			exSheet.Cells[37,5].Value = p_Remark;
       }
