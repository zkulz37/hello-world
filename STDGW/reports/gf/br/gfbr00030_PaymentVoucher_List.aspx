...
for (i=0;i<dt_hgtrh_pk.Rows.Count;i++)
{
	...
	if(i_tmp <6)
	{
		i_row_break = i_row_break +25;
	}
	else
	{
		i_row_break = i_row_break +25+ i_tmp;
	}
%>
      <x:RowBreak>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=661 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=4 class=xl42>Seq: <font class="font6"><%= dt_hgtrh_pk.Rows[k][0].ToString() %></font></td>
 </tr>
...
%>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl26 style='height:17.25pt'>Payment Reason/Lý
  do chi:</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td colspan=3 class=xl29>RECEIVER</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl29 style='height:12.75pt'>
      Giám &#273;&#7889;c</td>
  <td colspan=2 class=xl29>K&#7871; tóan tr&#432;&#7903;ng</td>
  <td class=xl29>Th&#7911; qu&#7929;</td>
  <td colspan=2 class=xl29>Ng&#432;&#7901;i l&#7853;p phi&#7871;u</td>
  <td colspan=3 class=xl29>Ng&#432;&#7901;i nh&#7853;n ti&#7873;n</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  ...
  <td colspan=2 class=xl30>(Ký, họ tên)</td>
  <td colspan=3 class=xl30>(Ký, họ tên)</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
