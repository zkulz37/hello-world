...
public partial class gfbr00040_ACB_Payment_Order_pdf : System.Web.UI.Page
{
	...
	string p_D_Branch = "";
        ...
        string TemplateFile = "gfbr00040_ACB_Payment_Order_pdf.xls";
        string TempFile = "../../../system/temp/gfbr00040_ACB_Payment_Order_pdf_" + Session["User_ID"].ToString() + ".xls";
		...
		//exSheet.Cells["O1"].Value = p_So;
		exSheet.Cells["J2"].Value = p_Date;
		exSheet.Cells["F5"].Value = p_D_Acc_Nm;				
		exSheet.Cells["E6"].Value = p_D_Acc_No;
		exSheet.Cells["N6"].Value = p_D_Branch;
		exSheet.Cells["F9"].Value = p_C_Acc_Nm;
		exSheet.Cells["F10"].Value = p_C_Acc_No;
		exSheet.Cells["F12"].Value = p_C_Bank;
		exSheet.Cells["F13"].Value = Inword;
		exSheet.Cells["N13"].Value = p_Amt+" "+p_Ccy;
		exSheet.Cells["E14"].Value = p_Remark;
