...
public partial class rpt_gfbr00040_VIB_GiayNopTien_excel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_gfbr00040_VIB_GiayNopTien_excel.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_VIB_GiayNopTien_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[6,21].Value =p_Date;	
			exSheet.Cells[8,3].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[10,3].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[11,3].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[11,22].Value = p_Amt;
			exSheet.Cells[11,27].Value = p_Ccy;
			exSheet.Cells[12,3].Value = p_C_Bank;	//p_D_Acc_No
			exSheet.Cells[13,3].Value =Inword;
			exSheet.Cells[15,3].Value =p_Remark_ENG;
			
			//----------------page 2---------------------
			exSheet.Cells[32,21].Value =p_Date;	
			exSheet.Cells[34,3].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[36,3].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[37,3].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[37,22].Value = p_Amt;
			exSheet.Cells[37,27].Value = p_Ccy;
			exSheet.Cells[38,3].Value = p_C_Bank;	//p_D_Acc_No
			exSheet.Cells[39,3].Value =Inword;
			exSheet.Cells[41,3].Value =p_Remark_ENG;
       }
