...
<%
    string l_seq = Request.QueryString["seq"]; 
...
<link rel=File-List href="rptRVPay_files/filelist.xml">
<link rel=Edit-Time-Data href="rptRVPay_files/editdata.mso">
<link rel=OLE-Object-Data href="rptRVPay_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>Administrator</o:Author>
  <o:LastAuthor>PCVINA002</o:LastAuthor>
  <o:LastPrinted>2010-01-28T08:40:20Z</o:LastPrinted>
  <o:Created>2008-07-02T01:53:26Z</o:Created>
  <o:LastSaved>2010-01-28T08:50:32Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=751 style='border-collapse:
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=6 height=33 class=xl34 width=486 style='height:24.95pt;
  width:365pt'><%=p_cmp_name %></td>
  <td colspan=4 class=xl35 width=211 style='width:159pt'>Form No/Mẫu số: 01-TT</td>
  <td class=xl24 width=54 style='width:41pt'></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td colspan=6 height=20 class=xl36 style='height:15.0pt'><%= p_cmp_add  %></td>
  <td colspan=4 class=xl37>Voucher No/Số: <font class="font6"><%= p_voucher_no%></font></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td colspan=2 height=20 class=xl38 style='height:15.0pt'>Tax Code/MST:</td>
  <td colspan=4 class=xl38><%= p_cmp_taxcode %></td>
  <td colspan=2 class=xl26>Sequences:</td>
  <td colspan=2 class=xl40 x:num><font class="font6"><%= l_seq %></td>
  <td class=xl24></td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  <td colspan=6 rowspan=5 height=104 class=xl39 width=486 style='height:78.8pt;
  width:365pt'>PAYMENT VOUCHER/ PHIẾU CHI NGÂN HÀNG<br>
    <font class="font9"><br>
...
%>
  ...
  <td colspan=3 class=xl40><%= tmp2 %></td>
  <td class=xl24></td>
 </tr>
  <%
		}
...
%>
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  <td colspan=4 height=22 class=xl27 style='height:16.5pt'>Payer Name/ Họ tên
  người nộp tiền:</td>
  <td colspan=6 class=xl41><%= p_person %></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 height=20 class=xl27 style='height:15.0pt'>Address/ Địa chỉ:</td>
  <td colspan=7 class=xl41><%= p_addr %></td>
  <td class=xl24></td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=3 height=21 class=xl27 style='height:15.75pt'>Object/ Đơn vị:</td>
  <td colspan=7 class=xl41><%= p_buspartner_lnm%></td>
  <td class=xl24></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl27 style='height:17.25pt'>Receive Reason/Lý
  do nộp:</td>
  <td colspan=7 class=xl42><%= p_remark%></td>
  <td class=xl24></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl27 style='height:17.25pt'></td>
  <td colspan=7 class=xl42><%= p_remark2 %></td>
  <td class=xl24></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=3 height=24 class=xl27 style='height:18.0pt'>Total Amt/ Số tiền:</td>
  <td colspan=3 class=xl43><%= p_fmt_amount %></td>
  <td class=xl25></td>
  <td colspan=2 class=xl44>Rate/Tỷ giá:</td>
  <td class=xl28 align=right x:num><%= p_rate %></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 rowspan=2 height=40 class=xl27 style='height:30.0pt'>In Word/
  Bằng chữ:</td>
  <td colspan=7 class=xl45 width=506 style='width:380pt'><%= p_amt_vn%></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=7 height=20 class=xl46 style='height:15.0pt'><%= p_amt_en%></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
 ...
 <%
    SQL = "select   " +
      ...
      for (int k = 0; k < dt1.Rows.Count; k++)
      {
       ...
       %> 
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl30 style='height:12.75pt'><%= e1 %></td>
  <td colspan=2 class=xl30><%= e2 %></td>
  <td class=xl30><%= e3 %></td>
  <td class=xl30><%= e4 %></td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl30 style='height:12.75pt'><%= v1 %></td>
  <td colspan=2 class=xl30><%= v2 %></td>
  <td class=xl30><%= v3 %></td>
  <td class=xl30><%= v4 %></td>
  <td colspan=2 class=xl30></td>
  <td colspan=2 class=xl30></td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl32 style='height:12.75pt'>(<%= g1 %>)</td>
  <td colspan=2 class=xl32>(<%= g2 %>)</td>
  <td class=xl32>(<%= g3 %>)</td>
  <td class=xl32>(<%= g4 %>)</td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 rowspan=4 height=97 class=xl49 style='height:72.75pt'>A</td>
  <td colspan=2 rowspan=4 class=xl49>B</td>
  <td rowspan=4 class=xl49>C</td>
  <td rowspan=4 class=xl50></td>
  <td colspan=2 rowspan=4 class=xl50></td>
  <td colspan=2 rowspan=4 class=xl50></td>
  <td rowspan=4 class=xl47></td>
 </tr>
 ...
 <tr height=107 style='mso-height-source:userset;height:80.25pt'>
  <td colspan=11 height=107 class=xl47 style='height:80.25pt'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td colspan=10 height=17 class=xl48 style='height:12.75pt'>Payment Received
  (In Word)/Đã nhận đủ số tiền ( bằng chữ ):……………………………………………………………………..</td>
  <td class=xl24></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
