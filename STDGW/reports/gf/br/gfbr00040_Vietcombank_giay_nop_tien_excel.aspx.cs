...
public partial class gfbr00040_Vietcombank_giay_nop_tien_excel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "gfbr00040_Vietcombank_giay_nop_tien_excel.xls";
        string TempFile = "../../../system/temp/gfbr00040_Vietcombank_giay_nop_tien_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			...
			exSheet.Cells[8,4].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[8,11].Value = p_Amt;
			exSheet.Cells[8,14].Value = p_Ccy;
			exSheet.Cells[16,4].Value =p_Remark_ENG;
			exSheet.Cells[9,4].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[9,9].Value ="Bằng chữ ( In words) :" +Inword;
			exSheet.Cells[15,4].Value =p_D_Add;	//p_C_Bank
			//exSheet.Cells[16,4].Value =p_D_Bank ;	//p_D_Acc_No		
