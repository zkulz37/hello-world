...
<%
 ...
 SQL
	= "select h.pk  " + 
        ...
        " and h.pk IN (" + l_seq + ") " +
        "	order by h.pk asc   " ;
DataTable dt_hgtrhpk_lst = ESysLib.TableReadOpen(SQL);
...
<link rel=File-List href="56789_files/filelist.xml">
<link rel=Edit-Time-Data href="56789_files/editdata.mso">
<link rel=OLE-Object-Data href="56789_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2008-10-04T08:04:49Z</o:LastSaved>
   ...
   <x:ExcelWorksheet>
    ...
    <x:PageBreaks>
     <x:RowBreaks>
       <%
int i_row_break =0;
for (i=0;i<dt_hgtrhpk_lst.Rows.Count;i++)
{
	i_row_break = 48 * (i + 1) ;
%>
      <x:RowBreak>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=748 style='border-collapse:
 ...
 <%
 string l_hgtrh_pk = "";
 for(j = 0 ; j < dt_hgtrhpk_lst.Rows.Count; j++)
 {
	l_hgtrh_pk = dt_hgtrhpk_lst.Rows[j][0].ToString();
 ...
 <tr height=33 style='mso-height-source:userset;height:24.95pt'>
  <td colspan=6 height=33 class=xl43 width=475 style='height:24.95pt;
  width:358pt'><%=p_cmp_name %></td>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  <td colspan=6 rowspan=5 height=102 class=xl41 width=475 style='height:76.9pt;
  width:358pt'>PAYMENT VOUCHER/ <%= p_voucher_name %><br>
    <font class="font9"><br>
...
%>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  ch&#7919;:</td>
  <td colspan=7 class=xl34 width=508 style='width:382pt'><%= p_amt_vn%></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=7 class=xl34 width=508 style='width:382pt;mso-text-control:shrinktofit;white-space:nowrap;'><%= p_amt_en%></td>
  <td class=xl24></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl29 style='height:12.75pt'>GENERAL DIRECTOR</td>
  <td colspan=2 class=xl29>DIRECTOR CFO</td>
  <td class=xl29>CHIEF ACC</td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl29 style='height:12.75pt'>T&#7893;ng giám
  &#273;&#7889;c</td>
  <td colspan=2 class=xl29>Giám &#273;&#7889;c tài chính</td>
 ...
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl30 style='height:12.75pt'>(Ký, h&#7885; tên,
  &#273;óng d&#7845;u)</td>
  <td colspan=2 class=xl30>(Ký, h&#7885; tên, &#273;óng d&#7845;u)</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl24></td>
   ...
   <%
	int l_empty = 0;
	if(int.Parse(dt_hgtrh_pk.Rows[0][1].ToString()) > 5)	
		l_empty = int.Parse(dt_hgtrh_pk.Rows[0][1].ToString()) - 5;
	else
		l_empty = 0;
	  for( i = 0; i < 48 - (27 + l_empty); i++)
		{
 %>
<tr height=17 style='height:12.75pt'>
