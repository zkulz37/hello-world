...
public partial class gfbr00040_WooriBank_DonXinChuyenTien_pdf : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "gfbr00040_WooriBank_DonXinChuyenTien_pdf.xls";
        string TempFile = "../../../system/temp/gfbr00040_WooriBank_DonXinChuyenTien_pdf_" + Session["User_ID"].ToString() + ".xls";
    ...
    if (dt_Amount.Rows.Count > 0)
    {
		...
		exSheet.Cells[5, 24].Value = p_Date+"/"+p_Month+"/"+p_Year;
