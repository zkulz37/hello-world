...
public partial class gfbr00040_Shinhan_GiayChuyenTien2_excel_pattern : System.Web.UI.Page
{
    ...
    string p_D_Add = "";
        ...
        string TemplateFile = "gfbr00040_Shinhan_GiayChuyenTien2_excel_pattern.xls";
        string TempFile = "../../../system/temp/gfbr00040_Shinhan_GiayChuyenTien2_excel_pattern_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	exSheet.Cells[7,3].Value = p_Ccy;
			exSheet.Cells[7,4].Value = p_Amt;
			exSheet.Cells[8,3].Value =Inword; 			
			exSheet.Cells[11,3].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[12,3].Value = p_Add_Appli;
			exSheet.Cells[12,10].Value = p_Tel_No;
			exSheet.Cells[15,1].Value = p_Ccy;
			exSheet.Cells[15,3].Value = p_D_Acc_No; 
			exSheet.Cells[2,11].Value =p_Date;				
			exSheet.Cells[26,3].Value = p_C_Acc_Nm;
			exSheet.Cells[27,3].Value = p_C_Acc_No ;
			exSheet.Cells[26,4].Value =p_D_Bank ;										
			exSheet.Cells[20,3].Value = p_C_Bank;
			exSheet.Cells[21,3].Value = p_Add_Appli;
			exSheet.Cells[31,1].Value = p_Remark;
       }
