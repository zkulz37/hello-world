...
public partial class gfbr00040_VietinBank_LenhChi_excel_pattern : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "gfbr00040_VietinBank_LenhChi_excel_pattern.xls";
        string TempFile = "../../../system/temp/gfbr00040_VietinBank_LenhChi_excel_pattern_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[6,22].Value =p_Date;	
			exSheet.Cells[8,3].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[9,3].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[10,3].Value =p_D_Bank ;	//p_D_Acc_No
			exSheet.Cells[13,3].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[14,3].Value = p_C_Acc_No ;	//p_C_Acc_Nm
			exSheet.Cells[15,3].Value = p_C_Bank;
			exSheet.Cells[11,4].Value =Inword;			
			exSheet.Cells[16,2].Value =p_Remark_ENG;
			exSheet.Cells[11,20].Value = p_Amt;
			exSheet.Cells[11,30].Value = p_Ccy;
			
			

			
			
			//exSheet.Cells[8,4].Value =p_D_Add;	//p_C_Bank
				
			//exSheet.Cells[15,4].Value = p_C_Acc_No ;	//p_C_Acc_Nm
