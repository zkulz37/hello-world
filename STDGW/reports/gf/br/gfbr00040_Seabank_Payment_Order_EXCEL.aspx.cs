...
public partial class gfbr00040_Seabank_Payment_Order_EXCEL: System.Web.UI.Page
{
    ...
    string p_C_Provice = "";    
        ...
        string TemplateFile = "gfbr00040_Seabank_Payment_Order_EXCEL.xls";
        string TempFile = "../../../system/temp/gfbr00040_Seabank_Payment_Order_EXCEL_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells["F2"].Value =p_Date;	
			exSheet.Cells["B3"].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells["B4"].Value = p_D_Acc_No; 
			exSheet.Cells["B5"].Value = p_D_Bank; 
			//exSheet.Cells["B6"].Value =p_D_Provice;
			exSheet.Cells["B7"].Value =p_C_Acc_Nm;
			exSheet.Cells["B8"].Value = p_C_Acc_No ;
			exSheet.Cells["B9"].Value = p_C_Bank;	
			//exSheet.Cells["B10"].Value = p_C_Provice;
			exSheet.Cells["B11"].Value =Inword;
			exSheet.Cells["E11"].Value =p_Amt+" "+p_Ccy;
			exSheet.Cells["B12"].Value =p_Remark;
		}     
