...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1605 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=40 class=xl53 width=62 style='border-bottom:.5pt solid black;
  height:30.0pt;border-top:none;width:47pt'>STT</td>
  <td colspan=2 class=xl56 width=175 style='border-right:.5pt solid black;
  border-left:none;width:131pt'>Nội dung</td>
  <td rowspan=2 class=xl58 width=67 style='border-bottom:.5pt solid black;
  border-top:none;width:50pt'>Cấp</td>
  <td rowspan=2 class=xl53 width=93 style='border-bottom:.5pt solid black;
  border-top:none;width:70pt'>Mã chương</td>
  <td colspan=2 rowspan=2 class=xl56 width=94 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;width:70pt'>Khoản</td>
  <td class=xl30 width=105 style='width:79pt' x:str="Mã ">Mã<span
  style='mso-spacerun:yes'> </span></td>
  <td rowspan=2 class=xl53 width=92 style='border-bottom:.5pt solid black;
  border-top:none;width:69pt' x:str="Kỳ thuế ">Kỳ thuế<span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=2 rowspan=2 class=xl56 width=114 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;width:86pt'>Số tiền (VND)</td>
  <td colspan=11 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
 ...
 <tr height=54 style='mso-height-source:userset;height:40.5pt'>
  ...
  <td colspan=2 class=xl69 width=94 style='border-right:.5pt solid black;  border-left:none;width:70pt'>&nbsp;</td>
