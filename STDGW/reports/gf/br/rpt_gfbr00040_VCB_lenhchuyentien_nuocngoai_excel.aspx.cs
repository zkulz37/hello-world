...
public partial class rpt_gfbr00040_VCB_lenhchuyentien_nuocngoai_excel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_gfbr00040_VCB_lenhchuyentien_nuocngoai_excel.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_VCB_lenhchuyentien_nuocngoai_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[9,8].Value =p_Date;		
			exSheet.Cells[10,10].Value = p_Amt;
			exSheet.Cells[14,8].Value = p_Amt;
			exSheet.Cells[10,15].Value = p_Ccy;
			exSheet.Cells[14,11].Value = p_Ccy;
			exSheet.Cells[13,10].Value = p_C_Acc_No ;
			exSheet.Cells[30,7].Value =p_Remark;
			exSheet.Cells[11,9].Value = Inword;
			exSheet.Cells[18,8].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[20,7].Value =p_D_Add;	
			exSheet.Cells[24,8].Value =p_D_Bank ;					
			exSheet.Cells[28,4].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[27,13].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[29,7].Value = p_C_Add;						
			exSheet.Cells[25,9].Value = p_C_Bank;
