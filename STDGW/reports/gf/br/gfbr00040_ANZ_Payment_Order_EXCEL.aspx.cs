...
public partial class gfbr00040_ANZ_Payment_Order_EXCEL: System.Web.UI.Page
{
    ...
    string p_C_Provice = "";    
        ...
        string TemplateFile = "gfbr00040_ANZ_Payment_Order_EXCEL.xls";
        string TempFile = "../../../system/temp/gfbr00040_ANZ_Payment_Order_EXCEL_" + Session["User_ID"].ToString() + ".xls";
        ...
        {    
			...
			p_D_Provice = dt.Rows[0]["PROVINCE_CT"].ToString();
			p_C_Provice = dt.Rows[0]["PROVINCE"].ToString();
        }
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells["I5"].Value =p_Date;	
			exSheet.Cells["O29"].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells["BF18"].Value = p_D_Acc_No; 
			// exSheet.Cells["B5"].Value = p_D_Bank; 
			// //exSheet.Cells["B6"].Value =p_D_Provice;
			exSheet.Cells["O40"].Value =p_C_Acc_Nm;
			exSheet.Cells["O44"].Value = p_C_Acc_No ;
			exSheet.Cells["S46"].Value = p_C_Bank;	
			// //exSheet.Cells["B10"].Value = p_C_Provice;
			exSheet.Cells["AC14"].Value =Inword;
			exSheet.Cells["I14"].Value = p_Ccy;
			exSheet.Cells["O14"].Value = p_Amt;
			exSheet.Cells["O33"].Value = p_D_Add;
			exSheet.Cells["O42"].Value = p_C_Add;
			exSheet.Cells["O50"].Value =p_Remark;
		}     
