...
public partial class rpt_gfbr00040_Vietcombank_giayruttien_excel : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_gfbr00040_Vietcombank_giayruttien_excel.xls";
        string TempFile = "../../../system/temp/rpt_gfbr00040_Vietcombank_giayruttien_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	
			exSheet.Cells[2,1].Value ="Ngày (Date): "+p_Date;		   
			exSheet.Cells[6,4].Value = p_D_Acc_No;  //p_D_Acc_No
			exSheet.Cells[6,11].Value = p_Amt;
			exSheet.Cells[6,12].Value = p_Ccy;
			exSheet.Cells[16,2].Value ="NỘI DUNG NỘP(Details):"+p_Remark_ENG;
			exSheet.Cells[7,4].Value = p_D_Acc_Nm;	//p_D_Acc_Nm
			exSheet.Cells[7,9].Value ="Bằng chữ ( In words) :" +Inword;
			...
			exSheet.Cells[11,4].Value = p_C_Acc_Nm;	//p_D_Acc_Nm
			/*/----------------page 2---------------------
