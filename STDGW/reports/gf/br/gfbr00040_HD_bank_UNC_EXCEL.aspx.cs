...
public partial class gfbr00040_HD_bank_UNC_EXCEL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        string TemplateFile = "gfbr00040_HD_bank_UNC_EXCEL.xls";
        string TempFile = "../../../system/temp/gfbr00040_HD_bank_UNC_EXCEL_" + Session["User_ID"].ToString() + ".xls";
    ...
    if (dt_Amount.Rows.Count > 0)
    {
		...
		exSheet.Cells[3, 7].Value = p_Date+"/"+p_Month+"/"+p_Year;
        exSheet.Cells[5, 2].Value = p_D_Acc_Nm;
        exSheet.Cells[6, 2].Value = p_D_Acc_No;
        exSheet.Cells[7, 2].Value = p_D_Bank;
        //exSheet.Cells[5, 8].Value = p_D_Add;
        exSheet.Cells[10, 2].Value = p_C_Acc_Nm;
        exSheet.Cells[11, 2].Value = p_C_Acc_No;
        exSheet.Cells[12, 2].Value = p_C_Bank;
		//exSheet.Cells[8, 8].Value = p_D_Add;
        
       exSheet.Cells[16, 9].Value = p_Ccy;
        exSheet.Cells[17, 9].Value = p_Amt1;
        exSheet.Cells[15, 2].Value = p_Remark;
		exSheet.Cells[18, 2].Value = Inword;
		
		exSheet.Cells[32, 7].Value = p_Date+"/"+p_Month+"/"+p_Year;
        exSheet.Cells[34, 2].Value = p_D_Acc_Nm;
        exSheet.Cells[35, 2].Value = p_D_Acc_No;
        exSheet.Cells[36, 2].Value = p_D_Bank;
        //exSheet.Cells[26, 8].Value = p_D_Add;
        exSheet.Cells[39, 2].Value = p_C_Acc_Nm;
        exSheet.Cells[40, 2].Value = p_C_Acc_No;
        exSheet.Cells[41, 2].Value = p_C_Bank;
		//exSheet.Cells[29, 8].Value = p_D_Add;
        exSheet.Cells[47, 2].Value = Inword;
        exSheet.Cells[46, 9].Value = p_Amt1;
        exSheet.Cells[45, 9].Value = p_Ccy;
        exSheet.Cells[44, 2].Value = p_Remark;
