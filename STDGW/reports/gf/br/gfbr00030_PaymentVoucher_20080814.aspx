...
SQL += "sf_a_get_accd (d.tac_abacctcode_pk)|| ' : '|| TRIM(TO_CHAR(SUM(d.books_amt),DECODE('"+ p_book_ccy +"','VND','9,999,999,999,999','9,999,999,999,999.99'))) ";
SQL += "    FROM tac_bprvpvd d ";
SQL += "   WHERE d.del_if = 0 AND d.tac_bprvpv_pk = " + p_table_pk;
SQL += "GROUP BY d.drcr_type, d.tac_abacctcode_pk ";
SQL += "ORDER BY d.drcr_type DESC ";
*/
	SQL = " SELECT   d.drcr_type, ";
SQL += "sf_a_get_accd (d.tac_abacctcode_pk)|| ' : '|| TRIM(TO_CHAR(SUM(d.TR_BOOKAMT),DECODE('"+ p_book_ccy +"','VND','9,999,999,999,999','9,999,999,999,999.99'))) ";
...
/*
	DataTable dt_sql = ESysLib.TableReadOpen(SQL);
    DataTable dt3 = new DataTable();
    dt3 = dt_sql.Clone();
    int[] vat_index = new int[10];
	int vat_count=0;
	for(i=0;i<dt_sql.Rows.Count;i++)
	{
        
        if (dt_sql.Rows[i][0].ToString() == "D")
        {
            if (dt_sql.Rows[i][1].ToString().Substring(0,3)=="133")
            {
                vat_index[vat_count]=i;
                vat_count++;
            }
            else
            {
                dt3.ImportRow(dt_sql.Rows[i]);
            }
        }
        else//Credit
        {
            if (vat_count > 0)
            {
                ...
                {
                    dt3.ImportRow(dt_sql.Rows[vat_index[j]]); 
                }
                vat_count = 0;
            }
            dt3.ImportRow(dt_sql.Rows[i]);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=661 style='border-collapse:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td colspan=4 class=xl42>Voucher No/S&#7889;: <font class="font6">PC000002</font></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
 ...
 <tr height=21 style='mso-height-source:userset;height:15.95pt'>
  ...
  width:346pt'>PAYMENT VOUCHER/ PHI&#7870;U CHI<br>
    <font class="font10"><br>
    </font><font class="font7">Day/Ng&agrave;y <%= p_ngay %> Month/Th&aacute;ng <%= p_thang%> Year/N&#259;m <%= p_nam%></font></td>
<%
...
%>
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  <td colspan=4 height=22 class=xl26 style='height:16.5pt'>Receiver/ H&#7885;
  t&ecirc;n ng&#432;&#7901;i nh&#7853;n ti&#7873;n:</td>
 ...
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl26 style='height:17.25pt'>Payment Reason/L&yacute;
  do chi:</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl29>PAYER</td>
  <td colspan=2 class=xl29>PREPARE BY</td>
  <td colspan=3 class=xl29>CASHIER</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl29>Ng&#432;&#7901;i n&#7897;p ti&#7873;n</td>
  <td colspan=2 class=xl29>Ng&#432;&#7901;i l&#7853;p phi&#7871;u</td>
  <td colspan=3 class=xl29>Th&#7911; qu&#7929;</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
