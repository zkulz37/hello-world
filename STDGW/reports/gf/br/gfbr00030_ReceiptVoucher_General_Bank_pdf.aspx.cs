...
public partial class gfbr00030_ReceiptVoucher_General_Bank_pdf : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
      ...
      ESysLib.SetUser(Session["APP_DBUSER"].ToString());
        ...
        string TemplateFile = "gfbr00030_ReceiptVoucher_General_Bank_pdf.xls";
        string TempFile = "../../../system/temp/gfbr00030_ReceiptVoucher_General_Bank_pdf_" + Session["User_ID"].ToString() + ".xls";
        ...
        exSheet.Cells[1, 1].Value = p_cmp_name;
		  exSheet.Cells[14, 10].Value = p_ccy;
