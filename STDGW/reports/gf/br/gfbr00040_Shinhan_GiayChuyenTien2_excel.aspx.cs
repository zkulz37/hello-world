...
public partial class gfbr00040_Shinhan_GiayChuyenTien2_excel : System.Web.UI.Page
{
    ...
    string p_D_Add = "";
        ...
        string TemplateFile = "gfbr00040_Shinhan_GiayChuyenTien2_excel.xls";
        string TempFile = "../../../system/temp/gfbr00040_Shinhan_GiayChuyenTien2_excel_" + Session["User_ID"].ToString() + ".xls";
      ...
      if (dt.Rows.Count > 0)   
       {	exSheet.Cells[7,3].Value = p_Ccy;
			exSheet.Cells[7,4].Value = p_Amt.Trim();
			...
			exSheet.Cells[21,3].Value = p_Branch_Benefi;
