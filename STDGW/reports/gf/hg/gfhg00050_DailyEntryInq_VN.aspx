...
SQL = SQL + "        SF_A_GET_AGTRITEM(b.pk), a.tr_enclose  ENCLOSE ";
...
SQL = SQL + "      ORDER BY trdate1, pk ";
    ...
    SQL = SQL + "                          (SELECT A.PK, AC_CD, DECODE(DRCR_TYPE,'D',1,-1) DC, B.FONT_STYPE BOLD_YN, B.PRN_COLOR COLOR, ";
    SQL = SQL + "                                  DECODE('ENG','ENG',AC_NM,'VIE', AC_LNM,'KOR', AC_KNM) AC_NM";
    SQL = SQL + "                             FROM TAC_ABACCTCODE A, TAC_KAFINANCEFORM_LEVEL B";
