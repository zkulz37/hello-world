...
<%
	...
	string SQL = " SELECT PARTNER_LNAME,ADDR1, ADDR2, TAX_CODE FROM TCO_COMPANY WHERE PK = '" + l_company + "' ";
...
SQL = SQL + " FROM DUAL ";
    ...
    SQL = " SELECT   h.pk, TO_CHAR (h.tr_date, sf_get_format ('ACAB0300')) tr_date, ";
    SQL = SQL + "         h.voucherno, sf_a_get_accd (r.tac_abacctcode_pk_cr, " + l_company + ") dr, ";
    SQL = SQL + "         sf_a_get_accd (r.tac_abacctcode_pk_dr, " + l_company + ") cr, r.tr_bookamt, ";
    SQL = SQL + "         r.remark, r.remark2, ";
    SQL = SQL + "         sf_get_buspartner_id (r.tco_buspartner_pk) partner_cd, ";
    SQL = SQL + "         sf_get_buspartner_nm (r.tco_buspartner_pk) partner_nm, AC_GET_PLID_FROM_PLCENTER(r.TAC_ABPLCENTER_PK) PL_CD, AC_GET_PL_FROM_PLCENTER(r.TAC_ABPLCENTER_PK) PL_NM ";
    SQL = SQL + "    FROM tac_hgtrh h, tac_hgtrd_ref r ";
    SQL = SQL + "   WHERE h.del_if = 0 ";
    SQL = SQL + "     AND r.del_if = 0 ";
    SQL = SQL + "     AND h.pk = r.tac_hgtrh_pk ";
    SQL = SQL + "     AND r.drcr_type = 'C' ";
    ...
    SQL = SQL + "     AND h.tr_status IN (0, " + l_Status + " ) ";
    ...
    SQL = SQL + "     and ((r.tco_buspartner_pk = '" + l_partner_pk + "') or ('" + l_partner_pk + "' is null))  ";
    SQL = SQL + "     and ((r.tac_abacctcode_pk_dr = '" + p_acpk + "' or '" + p_acpk + "' is null) OR (r.tac_abacctcode_pk_cr = '" + p_acpk + "' or '" + p_acpk + "' is null))  ";
...
<!--[if gte mso 9]><xml>
 ...
 <x:ExcelName>
  ...
  <x:Formula>='S&#7893; NKC (Mau so S03a-DN) (2)'!$A$8:$K$23</x:Formula>
 </x:ExcelName>
 <x:ExcelName>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1180 style='border-collapse: collapse;table-layout:fixed;width:885pt'>
 <col class=xl24 width=81 style='mso-width-source:userset;mso-width-alt:2962; width:61pt'>
 <col class=xl24 width=103 style='mso-width-source:userset;mso-width-alt:3766; width:77pt'>
 <col class=xl24 width=83 style='mso-width-source:userset;mso-width-alt:3035; width:62pt'>
 <col class=xl24 width=285 style='mso-width-source:userset;mso-width-alt: 10422;width:214pt'>
 <col class=xl24 width=0 style='display:none;mso-width-source:userset; mso-width-alt: 10422;width:214pt'>
 <col class=xl24 width=0 style='display:none;mso-width-source:userset; mso-width-alt:2560'>
 <col class=xl24 width=68 style='mso-width-source:userset;mso-width-alt::2486; width:51pt'>
 <col class=xl24 width=0 style='display:none;mso-width-source:userset; mso-width-alt:1609'>
 <col class=xl24 width=68 style='mso-width-source:userset;mso-width-alt:2486; width:51pt'>
 <col class=xl24 width=143 style='mso-width-source:userset;mso-width-alt:5229; width:107pt'>
 <col class=xl24 width=64 style='width:48pt'>
 <col class=xl24 width=68 style='mso-width-source:userset;mso-width-alt:3000; width:51pt'>
 <col class=xl24 width=143 style='mso-width-source:userset;mso-width-alt:10000; width:107pt'>
 <col class=xl24 width=68 style='mso-width-source:userset;mso-width-alt:2500; width:51pt'>
 <col class=xl24 width=143 style='mso-width-source:userset;mso-width-alt:6000; width:107pt'>
 ...
 <tr class=xl35 height=21 style='height:15.75pt'>
  ...
  <td class=xl32 colspan=2 style='border-bottom:.5pt solid black'>Khách hàng</td>
  <td class=xl32 colspan=2 style='border-bottom:.5pt solid black'>PL</td>
 </tr>
 <tr class=xl35 height=21 style='height:15.75pt'>
  <td height=21 class=xl36 id="_x0000_s1025" x:autofilter="all"
  x:autofilterrange="$A$8:$K$22" style='height:15.75pt'>ghi s&#7893;</td>
  ...
  <td class=xl36 id="Td1" x:autofilter="all" style='border-left:none'>Mã</td>
  <td class=xl36 id="Td2" x:autofilter="all" style='border-left:none'>Tên</td>
  <td class=xl36 id="Td1" x:autofilter="all" style='border-left:none'>Mã</td>
  <td class=xl36 id="Td2" x:autofilter="all" style='border-left:none'>Tên</td>
 </tr>
<%
...
%> 
 <tr class=xl30 height=<%= l_row_height %>  style='mso-height-source:userset;'>
  ...
  <td class=xl48 style='border-top:none;border-left:none' ><%= dt_detail.Rows[i][0].ToString() %></td>
  <td class=xl48 style='border-top:none;border-left:none' ><%= dt_detail.Rows[i][8].ToString() %></td>
  <td class=xl48 style='border-top:none;border-left:none' ><%= dt_detail.Rows[i][9].ToString() %></td>
  <td class=xl48 style='border-top:none;border-left:none' ><%= dt_detail.Rows[i][10].ToString() %></td>
  <td class=xl48 style='border-top:none;border-left:none' ><%= dt_detail.Rows[i][11].ToString() %></td>
 </tr>
<%
	}//for
	}//if
...
%> 
 <tr class=xl30 height=21 style='height:15.75pt'>
  ...
  <td class=xl44 width=68 style='width:51pt;border-top:.5pt solid black;'>&nbsp;</td>
  <td class=xl45 x:num style='border-top:.5pt solid black;'><%= l_total_book_amt %></td>
  <td class=xl51 style='border-left:none;border-top:.5pt solid black;'>&nbsp;</td>
  <td class=xl51 style='border-left:none;border-top:.5pt solid black;'>&nbsp;</td>
  <td class=xl51 style='border-left:none;border-top:.5pt solid black;'>&nbsp;</td>
  <td class=xl51 style='border-left:none;border-top:.5pt solid black;'>&nbsp;</td>
  <td class=xl51 style='border-left:none;border-top:.5pt solid black;'>&nbsp;</td>
