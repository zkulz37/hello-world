...
SQL = SQL + " TO_CHAR(NVL(SUM(DECODE(D.DRCR_TYPE, 'D', D.TR_BOOKAMT)), 0), sf_a_get_bookformat('ACBG0040')) DR_AMOUNT, ";
SQL = SQL + " TO_CHAR(NVL(SUM(DECODE(D.DRCR_TYPE, 'C', D.TR_BOOKAMT)), 0), sf_a_get_bookformat('ACBG0040')) CR_AMOUNT ";
