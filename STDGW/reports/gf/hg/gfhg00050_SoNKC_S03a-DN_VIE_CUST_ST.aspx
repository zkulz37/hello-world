...
SQL = SQL + " FROM DUAL ";
    ...
    SQL = SQL + "         sf_get_buspartner_nm (r.tco_buspartner_pk) partner_nm, d.c1 ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1180 style='border-collapse:
 ...
 <tr class=xl35 height=21 style='height:15.75pt'>
  ...
  <td class=xl36 id="Td2" x:autofilter="all" style='border-left:none'>Khách hàng</td>
  <td class=xl36 id="Td3" x:autofilter="all" style='border-left:none'>cổ phiếu</td>
 </tr>
<%
	string trs_date = "";
	string trs_date_dsp = "";
