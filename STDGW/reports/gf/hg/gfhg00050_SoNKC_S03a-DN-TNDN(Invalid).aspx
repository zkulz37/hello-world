...
*/
    ...
    SQL = SQL + "SELECT H.PK, TO_CHAR(H.TR_DATE,SF_GET_FORMAT ('ACAB0300')) tr_date_fmt, H.VOUCHERNO, ";
SQL = SQL + "    AC_GET_ACCD(R.TAC_ABACCTCODE_PK_DR," + l_company + ") dracc,  AC_GET_ACCD(R.TAC_ABACCTCODE_PK_CR," + l_company + ") cracc, ";
...
SQL = SQL + "SELECT H.PK, TO_CHAR(H.TR_DATE,SF_GET_FORMAT ('ACAB0300')) TR_DATE_FMT, H.VOUCHERNO, ";
SQL = SQL + "    AC_GET_ACCD(R.TAC_ABACCTCODE_PK_CR," + l_company + ") DRACC,  AC_GET_ACCD(R.TAC_ABACCTCODE_PK_DR," + l_company + ") CRACC, ";
SQL = SQL + "    R.TR_BOOKAMT, R.REMARK , R.REMARK2 ,H.TR_DATE  ";
SQL = SQL + "    FROM TAC_HGTRH H,  TAC_HGTRD_REF R,TAC_HGTRDITEM a ";
SQL = SQL + "    WHERE H.DEL_IF = 0  ";
SQL = SQL + "    AND R.DEL_IF = 0 ";
