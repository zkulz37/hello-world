...
SQL = SQL + "    round(R.TR_BOOKAMT, 2) TR_BOOKAMT, R.REMARK , R.REMARK2  ";
...
SQL = "  SELECT  TO_CHAR(round(SUM(D.TR_BOOKAMT), 2),'" + l_bookformat + "')    ";
...
SQL = " SELECT  TO_CHAR(round(SUM(R.TR_BOOKAMT),2),'" + l_bookformat + "') ";
SQL = SQL + "    FROM TAC_HGTRH H,  TAC_HGTRD_REF R ";
SQL = SQL + "    WHERE H.DEL_IF = 0  ";
SQL = SQL + "    AND R.DEL_IF = 0 ";
SQL = SQL + "    AND H.PK = R.TAC_HGTRH_PK ";
