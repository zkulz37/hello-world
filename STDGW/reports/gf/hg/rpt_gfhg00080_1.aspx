...
<%
  ...
  ///---Get company information-------------------------------------------------------------------------------
    ...
    string SQL1 = " SELECT PARTNER_NAME, ADDR1, ADDR2, TAX_CODE,TCO_BPPHOTO_PK FROM comm.TCO_COMPANY WHERE PK = '" + p_Company + "' ";
  ...
  string l_parameter = "'" + p_Company + "','" + p_from + "','" + p_to + "','" +  p_Status  + "','" + p_VCNo + "','" + p_Seq + "'";
    ...
    DataTable dt_detail = ESysLib.TableReadOpenCursor("acnt.sp_sel_gfhg00080_2",l_parameter);
