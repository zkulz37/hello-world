 ...
 <tr class=xl25 height=29 style='mso-height-source:userset;height:21.75pt'>
  ...
  <%
     ...
     string SQL7 = "SELECT   sf_a_get_accd (d.tac_abacctcode_pk, 2) accd, " +
         "         sf_a_get_acnm (d.tac_abacctcode_pk, 2, 'ENG'), d.remark, d.remark2, " +
         "         +DECODE (drcr_type, " +
         ...
         "          UNION ALL " +
         "          SELECT sf_get_buspartner_id(a.tco_buspartner_pk) buspartner_id, a.buspartner_lnm, a.pk tac_hgtrd_pk " +
         "            FROM tac_hgtrd a " +
         "           WHERE a.del_if = 0 " +
