...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1247 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=9 height=30 class=xl76 style='height:22.5pt'>SỔ TIỀN GỬI NGÂN HÀNG</td>
  <td class=xl39></td>
 </tr>
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl87>Ngày <%= l_date_to.Substring(6, 2) %> tháng <%= l_date_to.Substring(4, 2) %> năm <%= l_date_to.Substring(0, 4) %></td>
  <td class=xl30></td>
 </tr>
 <%
    SQL = "SELECT   " +
