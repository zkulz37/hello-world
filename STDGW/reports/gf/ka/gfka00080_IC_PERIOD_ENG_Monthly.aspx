...
<link rel=File-List href="gfka00080_IC_PERIOD_ENG_Monthly_files/filelist.xml">
<link rel=Edit-Time-Data
href="gfka00080_IC_PERIOD_ENG_Monthly_files/editdata.mso">
<link rel=OLE-Object-Data
href="gfka00080_IC_PERIOD_ENG_Monthly_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>Thu Hien</o:LastAuthor>
  <o:LastSaved>2008-12-18T07:34:24Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=937 style='border-collapse:
 ...
 <tr class=xl28 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td colspan=3 class=xl58 width=414 style='width:312pt'>Form: B 02 - DN</td>
 </tr>
 ...
 <tr class=xl28 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl59>20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
 </tr>
 ...
 <tr class=xl28 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=6 height=26 class=xl60 style='height:19.5pt'>INCOME STATEMENT</td>
 </tr>
 ...
 <tr>
  ...
  <td x:num class=xl46><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl46><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl47><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl47><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl48><%=tag_begin%><%=dt.Rows[i][8].ToString()%><%=tag_end%></td>
 </tr>
 <%
     }
     else
 ...
 <tr>
  <td class=xl45><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl46 x:num><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl46><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  ...
  <td class=xl65 x:num><%=tag_begin%><%=dt.Rows[i][8].ToString()%><%=tag_end%></td>
 </tr>
 <%
     }
 }
         %>
 <tr class=xl30>
  <tdclass=xl49><%=tag_begin%><%=dt.Rows[i][1].ToString()%><%=tag_end%></td>
  ...
  <td class=xl52 x:num><%=tag_begin%><%=dt.Rows[i][8].ToString()%><%=tag_end%></td>
 </tr>
 <tr class=xl28 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl24 style='height:19.5pt'></td>
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl53 align=right x:num="0"><span style='mso-spacerun:yes'>  
  </span></td>
  <td class=xl53 align=right x:num="0"><span style='mso-spacerun:yes'>  
  </span></td>
  <td class=xl26></td>
 ...
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl26></td>
  <td colspan=2 class=xl61>At dated<span style='mso-spacerun:yes'> 
  </span><%=to_dt_e %></td>
 </tr>
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 style='height:15.75pt'>Repairer by</td>
  <td colspan=3 class=xl62
  x:str="Chief Accountant                                ">Chief
  Accountant<span
  style='mso-spacerun:yes'>                                </span></td>
  <td colspan=2 class=xl37>General Director</td>
 </tr>
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'>(Sign, Fullname)</td>
  <td colspan=2 class=xl34>(Sign, Fullname)</td>
  <td class=xl26></td>
  <td colspan=2 class=xl63 x:str="(Sign, Fullname, Stamp)"><span
 ...
 <tr class=xl54 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl55 style='height:15.75pt'>NGUYEN VAN</td>
  <td colspan=2 class=xl55>NGUYỄN VĂN A</td>
  <td class=xl54></td>
  <td colspan=2 class=xl64 x:str="LAM VAN"><span
