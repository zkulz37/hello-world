...
<%
  ...
  DataTable dt = ESysLib.TableReadOpenCursor("SP_SEL_GRD_FINANCE_STATEMENT2",l_parameter);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan=3 class=xl31 width=138 style='width:104pt'>Form: B 03 - DN</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=6 class=xl51>(Issued with Decision No. 15/2006/QĐ-BTC</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=6 class=xl51>dated March 20, 2006 by Ministry of Finance)</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl52 style='height:19.5pt'>CASH FLOW /BÁO CÁO LƯU CHUYỂN TIỀN TỆ</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl53 style='height:15.75pt'>Form <%=fr_dt %> to
  <%=to_dt %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td colspan=3 class=xl36>(Unit: <%=l_Scale1%> <%=l_ccy%>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td rowspan=2 height=42 class=xl54 style='border-bottom:.5pt solid black;
  height:31.5pt'>Items</td>
   <td rowspan=2 height=42 class=xl54 style='border-bottom:.5pt solid black;
  height:31.5pt'>Chỉ Tiêu</td>
  <td rowspan=2 height=42 class=xl54 style='border-bottom:.5pt solid black;
  height:31.5pt'>Chỉ Tiêu(Korean)</td>
  <td rowspan=2 class=xl54 style='border-bottom:.5pt solid black'>Code</td>
  <td rowspan=2 class=xl54 style='border-bottom:.5pt solid black'>Notes</td>
  <td colspan=2 class=xl56 style='border-right:.5pt solid black;border-left:
  none' x:str="This month"><span style='mso-spacerun:yes'> </span>This
  month<span style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 style='height:15.75pt' x:str="This year"><span
  style='mso-spacerun:yes'> </span>This year<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl37 x:str="Previous year"><span
  style='mso-spacerun:yes'> </span>Previous year<span
  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl38 style='height:15.75pt' x:num>1</td>
  <td height=21 class=xl38 style='height:15.75pt' x:num>2</td>
  <td height=21 class=xl38 style='height:15.75pt' x:num>3</td>
  <td class=xl39 x:num>4</td>
  <td class=xl40 width=61 style='width:46pt' x:num>5</td>
  <td class=xl40 width=138 style='width:104pt' x:num>6</td>
  <td class=xl40 width=138 style='width:104pt' x:num>7</td>
 </tr>
 <%
    string tag_begin="";
    string tag_end="";
    ...
    for (i = 0; i < dt.Rows.Count - 1; i++)
    {
        ...
        string tmp11 = dt.Rows[i][7].ToString();
        if (!tmp11.Equals(""))
        {
            if (Convert.ToDecimal(tmp11) < 8)
            {
                l_amt_08_1 = l_amt_08_1 + (Decimal)dt.Rows[i][9];
                l_amt_08_2 = l_amt_08_2 + (Decimal)dt.Rows[i][10];
            }
            if (Convert.ToDecimal(tmp11) >= 8 && Convert.ToDecimal(tmp11) < 20)
            {
            ...
            {
                l_amt_40_1 = l_amt_40_1 + (Decimal)dt.Rows[i][9];
                l_amt_40_2 = l_amt_40_2 + (Decimal)dt.Rows[i][10];
            }
            l_amt_50_1 = l_amt_20_1 + l_amt_30_1 + l_amt_40_1;
            l_amt_50_2 = l_amt_20_2 + l_amt_30_2 + l_amt_40_2;
 ...
 <tr class=xl41 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl62><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
 ...
 <tr class=xl41>
  ...
  <td class=xl45><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl45><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl46 x:str><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  ...
  %>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_08_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_08_2%><%=tag_end%></td>
  <%      break;
      case "20":
  %>
   <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_20_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_20_2%><%=tag_end%></td>
  <%      break;
      case "30":
  %>
    <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_30_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_30_2%><%=tag_end%></td>
  <%      break;
      case "40":
  %>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_40_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_40_2%><%=tag_end%></td>
   <%      break;
      case "50":
  %>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_50_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_50_2%><%=tag_end%></td>
  <%      break;
      case "70":
  %>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_70_1%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_70_2%><%=tag_end%></td>
  
  <% break;
          default:          
    %>
   <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
  <%
      break;
} %>
 </tr> 
 ...
 <tr class=xl41>
  ...
  <td class=xl48><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl55><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl55><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'><%=l_col1_1%>/<%=l_col1_3%></td>
  <td colspan=3 class=xl59><%=l_col2_1%>/<%=l_col2_3%><span
  style='mso-spacerun:yes'></span></td>
  <td colspan=3 class=xl34><%=l_col3_1%>/<%=l_col3_3%></td>
 </tr>
 <tr class=xl50 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl49 style='height:18.0pt'>(Sign, Fullname)/(Ký, họ tên)</td>
  <td colspan=2 class=xl33>(Sign, Fullname)/(Ký, họ tên)</td>
  <td colspan=4 class=xl60 ><span
  style='mso-spacerun:yes'> </span>(Sign, Fullname, Stamp)/(Ký, họ tên, đóng dấu)<span
  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl61><span
  style='mso-spacerun:yes'> </span><%=name2%><span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=3 class=xl58><span
  style='mso-spacerun:yes'> </span><b><%=name3%></b><span
  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'></td>
