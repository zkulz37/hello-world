...
if (l_rpt_Option == "DRCR")
{
	...
	SQL += " r1.tr_amt debit_tramt, 0 credit_tramt, v.pl_cd " ;
	...
	SQL += " 0 debit_tramt, R2.tr_amt credit_tramt, v.pl_cd " ;
...
else if (l_rpt_Option == "FIFO")
{
    ...
    SQL += " UNION ALL  SELECT TO_CHAR(h.tr_date, 'DD/MM/YYYY') tr_date_fmt, h.voucherno " +
       ...
       "     , sf_a_get_accd(tac_abacctcode_pk, '" + l_company_pk + "') acc_code, decode(DRCR_TYPE,'D',r2.tr_bookamt,0) debit_amt " +
       "     , decode(DRCR_TYPE,'C',r2.tr_bookamt,0) credit_amt, h.pk, h.tr_date, r2.pk r_pk, " +
	   " decode(DRCR_TYPE, 'D', r2.tr_amt,0) debit_tramt, decode(DRCR_TYPE, 'C', r2.tr_amt,0) credit_tramt, v.pl_cd " +
       "  FROM tac_hgtrh h, tac_hgtrd r2, v_abplcenter v " +
       " WHERE h.del_if = 0 AND r2.del_if = 0 AND h.pk = r2.tac_hgtrh_pk " +
       "       AND io_yn = 'Y' " +
       "   AND R2.tac_abacctcode_pk IN (" + p_acc_pk_arr + ") " +
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>gfka00020_SocaiNKC_S03b-DN_Cost</x:Name>
    <x:WorksheetOptions>
...
<<table x:str border=0 cellpadding=0 cellspacing=0 width=1083 style='border-collapse:
 ...
 <%
     string l_dd = DateTime.Today.Day.ToString();
     string l_mm = DateTime.Today.Month.ToString();
     string l_yy = DateTime.Today.Year.ToString();
 %>
 <tr class=xl2521394 height=21 style='height:15.75pt'>
  <td height=21 class=xl2521394 style='height:15.75pt'></td>
  <td class=xl2521394></td>
  <td class=xl2521394></td>
  <td class=xl2521394></td>
  <td colspan=3 class=xl2821394>Ngày <%=l_dd%> tháng <%=l_mm%> năm <%=l_yy %></td>
  <td class=xl2821394></td>
  <td class=xl2821394></td>
  <td class=xl2821394></td>
  <td class=xl2521394></td>
 ...
 <tr class=xl2621394 height=21 style='height:15.75pt'>
  <td height=21 class=xl2621394 style='height:15.75pt'></td>
  <td class=xl6621394 width=100 style='width:75pt'></td>
  <td class=xl2621394></td>
  <td class=xl6621394 width=292 style='width:219pt'></td>
  <td class=xl6621394 width=63 style='width:47pt'></td>
  <td colspan=3 class=xl6621394 width=369 style='width:276pt'></td>
  <td class=xl2621394></td>
  <td class=xl2621394></td>
  <td class=xl2621394></td>
 </tr>
