...
<%
    ...
    string sp3 = "ac_sel_expense_plcenter_sum";
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-10-08T07:48:54Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2652 style='border-collapse:
 collapse;table-layout:fixed;width:1988pt'>
 ...
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  <td colspan=4 height=26 class=xl44 width=450 style='height:20.1pt;width:338pt'><%=l_cmp_name %></td>
  <td class=xl36 width=218 style='width:164pt'></td>
  <td colspan=2 class=xl45 width=341 style='width:256pt'></td>
  <td class=xl37 width=144 style='width:108pt'></td>
 ...
 <tr class=xl29 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  Unit Name</td>
  <td class=xl27 id="_x0000_s1053" x:autofilter="all">Acc. Code</td>
 ...
 <%
     string l_abcenter_pk = "", l_plc_cd = "";
      ...
      for (i = 0; i < dt2.Rows.Count; i++)
      {
          ...
          l_plc_cd = dt2.Rows[i][0].ToString();
          
          SQL
          = "select pk from tac_abcenter where PLC_CD like '" + l_plc_cd + "' ";
          DataTable dt3 = ESysLib.TableReadOpen(SQL);
          
          l_abcenter_pk = dt3.Rows[0][0].ToString();
          //Response.Write(l_abcenter_pk);
          //Response.End();  
          l_parameter = "'" + l_parameter1 + "', ";
          l_parameter += "'" + l_parameter2 + "', ";
          l_parameter += "'" + l_parameter3 + "', ";
          l_parameter += "'" + l_parameter4 + "', ";
          l_parameter += "'" + l_abcenter_pk + "', ";
          l_parameter += "'" + l_parameter6 + "', ";          
          l_parameter += "'" + l_parameter7 + "' ";
          //Response.Write(dt2.Rows.Count);
          //Response.End();
          DataTable dt = ESysLib.TableReadOpenCursor("ac_sel_60080190_exp_plunit", l_parameter);
...
%>          
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl31 style='border-top:none;border-left:none'><%= dt.Rows[j][4]%></td>
  <td class=xl32 style='border-top:none;border-left:none'><%= dt.Rows[j][5]%></td>
...
<tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][1]%></td>
