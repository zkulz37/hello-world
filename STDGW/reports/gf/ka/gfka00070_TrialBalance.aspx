...
<%
    ...
    //Response.End();
    DataTable dt = ESysLib.TableReadOpenCursor("ACNT.SP_SEL_GRD_DTL_GENERAL_LEDGER2", l_parameter);
    l_parameter = "'" + l_compk + "','" + l_lang + "','" + l_date_fr + "','" + l_date_to + "','" + l_status + "','" + l_current + "','" + l_rate + "','" + l_level + "','" + l_possum + "','" + l_accd + "','" + l_check_sum + "','" + l_pacctype + "'";
    DataTable dtTotal = ESysLib.TableReadOpenCursor("acnt.SP_SEL_GRD_DTL_GENERAL_LEDGER2", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1740 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=12 height=30 class=xl45 style='height:22.5pt'>BẢNG CÂN ĐỐI SỐ PHÁT SINH - TRIAL BALANCE</td>
 </tr>
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl35 style='height:15.0pt'><%=tag_begin%><%=dt.Rows[i][24]%><%=tag_end%></td>
  <td class=xl35><%=tag_begin%><%=dt.Rows[i][2]%><%=tag_end%></td>
  <td class=xl36 width=245 style='width:184pt'><%=tag_begin%><%=dt.Rows[i][25]%><%=tag_end%></td>
  <td class=xl36 width=69 style='width:52pt'> <%=tag_begin%>Level  <%=dt.Rows[i][23]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][3]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][4]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][7]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][8]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][11]%><%=tag_end%></td>
  <td class=xl38 x:num><%=tag_begin%><%=dt.Rows[i][12]%><%=tag_end%></td>
  <td class=xl37 x:num><%=tag_begin%><%=dt.Rows[i][15]%><%=tag_end%></td>
  <td class=xl38 x:num><%=tag_begin%><%=dt.Rows[i][16]%><%=tag_end%></td>
 </tr>
 <%
     }
 ...
 <tr class=xl25 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl41 x:num><span style='mso-spacerun:yes'> </span><%=dtTotal.Rows[i][2]%><span
  ...
  <td class=xl42 x:num><span style='mso-spacerun:yes'> </span><%=dtTotal.Rows[i][14]%><span
  style='mso-spacerun:yes'>   </span></td>
 </tr>
  <%
      }
