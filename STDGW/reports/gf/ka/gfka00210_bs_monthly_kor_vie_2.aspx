...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1791 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  <%
      ...
      {   
         %>
  <td height=21 class=xl46 style='height:15.75pt;border-top:none'><%=strBegin %><%= dt.Rows[i][2].ToString()%><%=strEnd %></td>
  <td class=xl52 style='border-top:none;border-left:none'></td>
  <td class=xl46 style='border-top:none;border-left:none'><%= dt.Rows[i][1].ToString()%><%=strEnd %></td>
  <td class=xl52 style='border-top:none;border-left:none'></td>
  <td class=xl53 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][6].ToString()%><%=strEnd %> </td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][7].ToString()%><%=strEnd %> </td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][8].ToString()%><%=strEnd %></td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][9].ToString()%><%=strEnd %></td>
  <td class=xl55 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][10].ToString()%><%=strEnd %>
  </td>
 ...
 <%  
  ...
  <td class=xl52 style='border-top:none;border-left:none'><%= dt.Rows[i][2].ToString()%><%=strEnd %></td>
  <td class=xl46 style='border-top:none;border-left:none'></td>
  <td class=xl52 style='border-top:none;border-left:none'><%= dt.Rows[i][1].ToString()%><%=strEnd %></td>
  <td class=xl53 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][6].ToString()%><%=strEnd %> </td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][7].ToString()%><%=strEnd %> </td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][8].ToString()%><%=strEnd %></td>
  <td class=xl54 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][9].ToString()%><%=strEnd %></td>
