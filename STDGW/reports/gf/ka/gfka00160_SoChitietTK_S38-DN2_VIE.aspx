...
<%
   ...
   string SQLB = " SELECT ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','D','TRANS') DR_TRANS, ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','C','TRANS') CR_TRANS,ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','D','BOOK') DR_BOOK, ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','C','BOOK') CR_BOOK FROM DUAL ";
