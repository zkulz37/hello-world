...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Quý <%=quater %> Năm <%=curr_date %></td>
  <td class=xl26></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  none' ><span style='mso-spacerun:yes'> </span>Quý <%=quater %><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt'><b>minh</b></td>
  <td class=xl43 >Quý <%=quater %> Năm <%=curr_date %></td>
  <td class=xl44 >Quý <%=quater %> Năm <%=last_Date %></td>
  <td class=xl45></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
