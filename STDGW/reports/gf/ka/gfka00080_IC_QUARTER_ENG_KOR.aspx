...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1391 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan="2" class=xl32 width=138 style='width:104pt'>Form: B 02 - DN</td>
  <td class=xl33 width=11 style='width:8pt'></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'>Adress: <%= l_cmp_add %></td>
  <td colspan=5 class=xl65>(Issued with Decision No. 15/2006<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl36></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=5 class=xl65>dated March 20, 2006 by Ministry of Finance)</td>
  <td class=xl36></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=6 height=26 class=xl66 style='height:19.5pt'>INCOME STATEMENT/손익계산서</td>
 </tr>
 <tr class=xl27 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 <td colspan=6 height=21 class=xl35 style='height:15.75pt'>Quater <%=quater %> Year <%=curr_date %>(Quý <%=quater %> Năm <%=curr_date %>)</td>
  
  <td class=xl26></td>
 </tr>
 <tr>
    <td colspan=6 height=21 class=xl35 style='height:15.75pt'>Form /부터  <%=fr_dt %>  to/ 까지 <%=to_dt %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td rowspan=2 height=42 class=xl68 style='border-bottom:.5pt solid black;
  height:31.5pt'>항목</td>
  <td rowspan=2 class=xl68 style='border-bottom:.5pt solid black'>Code <br>코드</td>
  <td class=xl41 width=61 style='width:46pt'>Notes<br>비고</td>
  <td colspan=2 class=xl70 style='border-right:.5pt solid black;border-left:
  none' ><span style='mso-spacerun:yes'> </span>Quater/Quý <%=quater %><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt'><b>Thuyết minh</b></td>
  <td class=xl43><span
  style='mso-spacerun:yes'> </span>Year <%=curr_date %><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl44 width=138 style='width:104pt'><span
  style='mso-spacerun:yes'> </span>Year <%=last_Date %><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl45></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  style='mso-spacerun:yes'></span></td>
  <td class=xl40  style="font-weight:700;text-align:center;font-family:Times New Roman;font-size:12pt;vertical-align:middle"><%=l_col2_1%><span style='mso-spacerun:yes'></span></td>
  <td class=xl72 ><span
  style='mso-spacerun:yes'>  </span><span
  style='mso-spacerun:yes'>  </span></td>
  
  <td colspan='3' class=xl61 style="text-align:center"><%=l_col3_1%></td>
 </tr>
 <tr class=xl62 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan= class=xl30 style="font-style:italic;font-family:Times New Roman;font-size:12pt;text-align:center;vertical-align:middle">Sign, Fullname</td>
  <td></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan='' class=xl50 style="text-align:center;border-left:none;border-right:none"><b><%=name2%></b></td>
   <td class=xl64>
  <td colspan=3 class=xl45><%=name3%></td>
 <!-----------------------------><!--END OF OUTPUT FROM EXCEL PUBLISH AS WEB PAGE WIZARD--><!-----------------------------></td>
 </tr>
