...
<table x:str border=0 cellpadding=0 cellspacing=0 width=757 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl67>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
  tr&#432;&#7901;ng B&#7897; Tài chính)</td>
  <td class=xl36></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl68 style='height:19.5pt'>BÁO CÁO L&#431;U
  CHUY&#7874;N TI&#7872;N T&#7878;</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=5 height=23 class=xl69 style='height:17.25pt'>(Theo
  ph&#432;&#417;ng pháp gián ti&#7871;p)(*)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'
  x:str="Cho niên &#273;&#7897; k&#7871;t thúc vào ngày ">Cho niên
  &#273;&#7897; k&#7871;t thúc vào ngày<span style='mso-spacerun:yes'> </span><%=to_dt %></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td class=xl37>(&#272;&#417;n v&#7883; tính: <%=l_ccy%>)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td rowspan=2 class=xl70 style='border-bottom:.5pt solid black'>Mã s&#7889;</td>
  <td class=xl41 width=61 style='width:46pt'>Thuy&#7871;t</td>
  <td rowspan=2 class=xl72 style='border-bottom:.5pt solid black'
  x:str="N&#259;m nay"><span style='mso-spacerun:yes'> </span>N&#259;m nay<span
  style='mso-spacerun:yes'> </span></td>
  <td rowspan=2 class=xl72 style='border-bottom:.5pt solid black'
  x:str="N&#259;m tr&#432;&#7899;c"><span
  style='mso-spacerun:yes'> </span>N&#259;m tr&#432;&#7899;c<span
  style='mso-spacerun:yes'> </span></td>
  <td rowspan=2 class=xl74>&nbsp;</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl43 width=61 style='height:15.75pt;width:46pt'>minh</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl46 width=138 style='width:104pt' x:num>4</td>
 ...
 <tr class=xl47 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl78 x:str><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl48 x:num><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl49 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl49 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <%}
   else
 ...
 <tr class=xl47>
  ...
  <td class=xl53 x:str><%=tag_begin%><%= dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl45 x:num><%=tag_begin%><%= dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl51 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%= dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl51 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%= dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr> 
 <%
        } 
 ...
 <tr class=xl47>
  ...
  <td class=xl57 x:str><%=tag_begin%><%= dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl59 x:num><%=tag_begin%><%= dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl60 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%= dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl60 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%= dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <tr class=xl47 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  Toán Tr&#432;&#7903;ng<span
  style='mso-spacerun:yes'>                                 </span></td>
  <td colspan=2 class=xl75 x:str=" T&#7893;ng Giám &#272;&#7889;c "><span
 ...
 <tr class=xl64 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl76 x:str="(Ký, h&#7885; tên, &#273;óng d&#7845;u)"><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl40 style='height:15.75pt'>NGUY&#7876;N V&#258;N A</td>
  <td colspan=2 class=xl40>NGUY&#7876;N V&#258;N A</td>
  <td colspan=2 class=xl40>LÂM V&#258;N</td>
