...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  none' x:str="Tháng này"><span style='mso-spacerun:yes'> </span>Tháng này<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt'>minh</td>
  <td class=xl43 x:str="N&#259;m nay"><span
  style='mso-spacerun:yes'> </span>N&#259;m nay<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl44 width=138 style='width:104pt' x:str="N&#259;m tr&#432;&#7899;c"><span
 ...
 <tr class=xl49>
  ...
  <td class=xl75 x:str><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl75><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl76 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl76 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <%}
   else
 ...
 %>
 <tr class=xl49>
  <td class=xl50><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl51 x:str><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl51><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl52 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl52 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <%
        } 
 ...
 <tr class=xl49>
  ...
  <td class=xl57 x:num><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl57><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl58 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl58 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  Toán Tr&#432;&#7903;ng<span
  style='mso-spacerun:yes'>                                 </span></td>
  <td colspan=2 class=xl72 x:str=" T&#7893;ng Giám &#272;&#7889;c "><span
 ...
 <tr class=xl62 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl73 x:str="(Ký, h&#7885; tên, &#273;óng d&#7845;u)"><span
