...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-12-01T07:22:09Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1222 style='border-collapse:
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=8 height=30 class=xl45 style='height:22.5pt'>CREDIT CORRESPONDING
  ACCOUNT</td>
 ...
 <tr class=xl26 height=21 style='height:15.75pt'>
  ...
  <td class=xl36 style='border-top:none;border-left:none'>Credit</td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl40 style="mso-number-format:'<%= p_xls_ccy_format %>'"; x:num><%= dt_detail.Rows[i][6].ToString() %></td>
  <td class=xl42 align=right style='border-top:none;border-left:none' x:num><%= dt_detail.Rows[i][7].ToString() %></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl27 height=21 style='height:15.75pt'>
  <td height=21 class=xl32 style='height:15.75pt;border-top:none'><%= strDate_Dsp %></td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl38 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl41 style="mso-number-format:'<%= p_xls_ccy_format %>'"; x:num><%= p_credit_xls %></td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td colspan=2 class=xl29>Date <%=l_report_dd%>/<%=l_report_mm %>/<%=l_report_yy %></td>
  <td class=xl29></td>
  <td colspan=2 class=xl27 style='mso-ignore:colspan'></td>
 </tr>
 <%
