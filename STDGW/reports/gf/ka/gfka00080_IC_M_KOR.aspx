...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1001 style='border-collapse:
 ...
 <tr class=xl28 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl31 style='height:15.0pt'>주소:<%= l_cmp_add %></td>
 ...
 <tr class=xl28 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=6 height=26 class=xl61 style='height:19.5pt'>손익계산서 </td>
  <td class=xl28></td>
 </tr>
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=6 height=21 class=xl34 style='height:15.75pt'> <%=fr_dt %> 부터 <%=to_dt %>까지</td>
  <td class=xl28></td>
 </tr>
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td class=xl35>(단위:<%=l_Scale1%> <%=l_ccy%>)</td>
  <td class=xl28></td>
 </tr>
 <tr class=xl30 height=45 style='mso-height-source:userset;height:33.75pt'>
  <td height=45 class=xl36 width=390 style='height:33.75pt;width:293pt'>항목</td>
  <td class=xl38 width=62 style='width:47pt'>코드</td>
  <td class=xl38 width=71 style='width:53pt'>비고</td>
  <td class=xl39 width=138 style='width:104pt' >이번 달</td>
  <td class=xl39 width=138 style='width:104pt' >작년에</td>
  <td class=xl40 >축적 년</td>
  <td class=xl30></td>
 </tr>
 ...
 %>
 <tr>
  <td class=xl49><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td x:num class=xl46><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl46><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td x:num style="mso-number-format:'<%= p_xls_ccy_format %>';" class=xl47><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td x:num style="mso-number-format:'<%= p_xls_ccy_format %>';" class=xl47><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 ...
 <tr class=xl30 height=22 style='height:16.5pt'>
  <td height=22 class=xl51 style='height:16.5pt'><%=tag_begin%><%=dt.Rows[i][2].ToString()%><%=tag_end%></td>
 ...
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl26></td>
  <td colspan=2 class=xl62>금년<span
