...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1072 style='border-collapse:
 ...
 <tr class=xl28 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td colspan=3 class=xl64 width=414 style='width:312pt'>Mẫu số: B02 - DN</td>
 </tr>
 <tr class=xl28 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl32></td>
  <td colspan=3 class=xl65>(Ban hành theo Quyết định số 15/2006/QĐ-BTC ngày</td>
 </tr>
 <tr class=xl28 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl33 style='height:15.0pt'></td>
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl32></td>
  <td colspan=3 class=xl65>20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
 </tr>
 ...
 <tr class=xl28 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl66 style='height:19.5pt'>BÁO CÁO KẾT QUẢ HOẠT ĐỘNG KINH DOANH</td>
 </tr>
 <tr class=xl28 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl66 style='height:19.5pt'>Quý: <%=quater%>/<%=curr_date %></td>
 </tr>
 <tr class=xl28 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=7 height=20 class=xl67 style='height:15.0pt'>Cho giai đọan từ ngày: <%=fr_dt %> đến ngày  <%=to_dt %></td>
 </tr>
 <tr class=xl28 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl26></td>
  <td class=xl38></td>
  <td class=xl39>(Đơn vị tính:<%=l_Scale1%> <%=l_ccy%>)</td>
 </tr>
 <tr class=xl24 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  height:31.5pt;width:293pt'>Chỉ tiêu</td>
  ...
  width:51pt'>Thuyết minh</td>
  <td colspan=2 class=xl70 style='border-right:.5pt solid black;border-left:
  none'>Qúy  <%=quater%>/<%=curr_date %></td>
  <td colspan=2 class=xl72 style='border-right:.5pt solid black;border-left:
  none'>Lũy kế từ đầu năm  đến cuối quý này</td>
 </tr>
 <tr class=xl40 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl43 width=138 style='height:15.75pt;width:104pt' >Năm nay</td>
  <td class=xl43 width=138 style='width:104pt' >Năm trước</td>
  <td class=xl43 width=138 style='width:104pt' >Năm nay</td>
  <td class=xl43 width=138 style='width:104pt' >Năm trước</td>
 </tr>
 ...
 <tr class=xl28 height=21 style='height:15.75pt'>
  <td height=21 class=xl48><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td x:num class=xl49><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl49><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num class=xl50><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num class=xl50><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 ...
 <%
         ...
         %>
 <tr class=xl30>
  <td class=xl53><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
