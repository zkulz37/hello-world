...
<table x:str border=0 cellpadding=0 cellspacing=0 width=916 class=xl547107
 ...
 <tr class=xl587107 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl857107 style='height:15.0pt'><%=l_cmp_add %></td>
 ...
 <tr height=26 style='height:19.5pt'>
  <td colspan=6 height=26 class=xl1767107 style='height:19.5pt'>대차대조표/B&#7842;NG CÂN &#272;&#7888;I K&#7870; TOÁN</td>
  <td class=xl547107></td>
 </tr>
 <tr class=xl587107 height=22 style='height:16.5pt'>
  <td colspan=6 height=22 class=xl1777107 style='height:16.5pt'><%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%>현재 /T&#7841;i
  ngày</td>
  <td class=xl587107></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl557107></td>
  <td class=xl677107></td>
  <td class=xl687107>(단위/Đơn vị tính : VND)</td>
  <td class=xl547107></td>
 </tr>
 <tr height=42 style='height:31.5pt'>
  <td height=42 class=xl897107 style='height:31.5pt'>자산</td>
  <td class=xl1347107 style='border-left:none'>Tài s&#7843;n</td>
  <td class=xl867107 width=50 style='border-left:none;width:38pt'>코드<br>
    Mã s&#7889;</td>
  <td class=xl877107 width=61 style='border-left:none;width:46pt'>비고
  <br>
   Thuy&#7871;t minh</td>
 ...
 <tr class=xl38 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl77 style='height:19.5pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString() %><%=strEnd%></td>
...
<tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl1577107 style='height:19.5pt'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString() %><%=strEnd%></td>
...
%>
 ...
 <tr height=53 style='page-break-before:always;mso-height-source:userset;
  height:39.75pt'>
  <td height=53 class=xl897107 style='height:39.75pt'>부채 및 자본 </td>
...
%>
 ...
 <td height=37 class=xl102 width=285 style='height:27.75pt;width:214pt'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString()%><%=strEnd%></td>
...
%>
 ...
 <tr class=xl38 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl108 style='height:18.0pt'>부외자산 항목/TÀI KHO&#7842;N
  NGOÀI B&#7842;NG</td>
  <td class=xl81></td>
 ...
 <tr height=43 style='height:32.25pt'>
  <td height=43 class=xl1637107 style='height:32.25pt'>항목</td>
  <td class=xl1647107>Kho&#7843;n m&#7909;c</td>
  <td class=xl1657107>&nbsp;</td>
  <td class=xl1667107>Notes</td>
  <td class=xl1677107 width=110 style='border-left:none;width:83pt'>기말<br>Số Dư Đầu Kỳ
    </td>
  <td class=xl1687107 width=110 style='border-left:none;width:83pt'>기초<br>
    Số Dư Cuối Kỳ</td>
  <td class=xl617107></td>
 </tr>
 <%
 ...
 <%
  ...
  %>
  <tr class=xl38 height=37 style='mso-height-source:userset;height:27.75pt'>
 <td height=37 class=xl77 width=285 style='height:27.75pt;width:214pt;border-bottom:2.0pt double windowtext;'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString()%><%=strEnd%></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=3 class=xl1747107><span style='mso-spacerun:yes'> 
  </span><%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%> 현재/Tại ngày</td>
  <td class=xl617107></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl1307107 style='height:18.0pt'><%=l_colE_1%></td>
  <td class=xl1307107><%=l_colE_2%></td>
  <td class=xl1297107></td>
  <td colspan=3 class=xl1697107 ><%=l_colE_3%><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl627107></td>
 </tr>
 <tr class=xl637107 height=21 style='height:15.75pt'>
  <td height=21 class=xl1317107 style='height:15.75pt'><%=l_colS_1%></td>
  <td class=xl1317107><%=l_colS_2%></td>
  <td colspan=4 class=xl1727107
  ><span
  style='mso-spacerun:yes'> </span><%=l_colS_3%><span style='mso-spacerun:yes'> </span></td>
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl837107 style='height:15.75pt'><%=l_colN_1%></td>
  <td class=xl837107><%=l_colN_2%></td>
  <td class=xl837107></td>
  <td colspan=3 class=xl1707107 ><span
