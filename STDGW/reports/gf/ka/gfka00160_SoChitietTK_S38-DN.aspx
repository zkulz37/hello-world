    ...
    string SQLB = " SELECT ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','D','BOOK') DR_BOOK, ac_get_DRCR_OPENBAL('" + com_pk + "','" + ac_pk + "','','" + d_from + "','" + status + "','C','BOOK') CR_BOOK FROM DUAL ";
            ...
            */
            ...
            = "SELECT TO_CHAR(H.TR_DATE,'DD/MM/YYYY') TRANS_DATE, H.VOUCHERNO, " +
                "r.REMARK, r.REMARK2,"+
				"ac_get_ACCD (R.TAC_ABACCTCODE_PK_DR,'') ACCT_CODE,"+
				//"ac_get_ACCD(DECODE(D.DRCR_TYPE,'D',DECODE(R.DRCR_TYPE,'C',R.TAC_ABACCTCODE_PK_DR,R.TAC_ABACCTCODE_PK_CR), " +
                ...
                " H.PK, DECODE(D.TAC_ABPLCENTER_PK,'','',AC_SF_GET_PL_FROM_PLCD(D.TAC_ABPLCENTER_PK))pl_cd, DECODE(D.TAC_ABPLCENTER_PK,'','',ac_get_PL_FROM_PLCENTER(D.TAC_ABPLCENTER_PK))pl_nm, ac_get_ACCD (R.TAC_ABACCTCODE_PK_CR,'') ACC_cR " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1374 style='border-collapse: collapse;table-layout:fixed;width:1029pt'>
 <col class=xl24 width=83 style='mso-width-source:userset;mso-width-alt:3035; width:62pt'>
 <col class=xl24 width=96 style='mso-width-source:userset;mso-width-alt:3510; width:72pt'>
 ...
 <col class=xl24 width=63 style='mso-width-source:userset;mso-width-alt:2304; width:47pt'>
 <col class=xl24 width=63 style='mso-width-source:userset;mso-width-alt:5000; width:47pt'>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=6 height=20 class=xl76 width=885 style='height:15.0pt;width:663pt'><%=name %></td>
  <td colspan=4 class=xl79 width=426 style='width:319pt'>M&#7851;u s&#7889;
  S38-DN</td>
  <td class=xl24 width=63 style='width:47pt'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=6 height=20 class=xl76 style='height:15.0pt'><%=address %></td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=6 height=20 class=xl76 style='height:15.0pt'>TAX CODE: <%=tax_code %></td>
 ...
 <tr height=35 style='height:26.25pt'>
  <td colspan=14 height=35 class=xl77 style='height:26.25pt'>S&#7892; CHI
  TI&#7870;T TÀI KHO&#7842;N</td>
  <td class=xl24></td>
 </tr>
 <tr height=27 style='height:20.25pt'>
  <td colspan=14 height=27 class=xl80 style='height:20.25pt'>T&#7915; ngày
 ...
 <tr class=xl25 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td colspan=6 class=xl27><%=ac_nm %></td>
  <td class=xl25></td>
 </tr>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  border-top:none;width:56pt'>TK ghi nợ</td>
  <td rowspan=2 class=xl74 width=75 style='border-bottom:.5pt solid black;
  border-top:none;width:56pt'>TK ghi có</td>
  ...
  <td colspan=2 class=xl83 width=212 style='border-right:.5pt solid black;
  border-left:none;width:159pt'>PL</td>
 </tr>
 <tr class=xl25 height=21 style='height:15.75pt'>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl30 id="_x0000_s1029" x:autofilter="all">D</td>
  <td class=xl30 id="_x0000_s1030" x:autofilter="all">E</td>
  <td class=xl30 id="_x0000_s1030" x:autofilter="all">F</td>
  ...
  <td class=xl50 style='border-top:none;border-left:none'>F</td>
  <td class=xl50 style='border-top:none;border-left:none'>G</td>
  <td class=xl50 style='border-top:none;border-left:none'>H</td>
 </tr>
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
 ...
 <tr class=xl25 height=26 style='mso-height-source:auto;'>
  ...
  <td class=xl41 width=271 style='border-top:none;border-left:none;width:203pt'><%=remark%></td>
  <td class=xl59 x:num><%=acc_cor%></td>
  <td class=xl59 x:num><%=dt.Rows[i]["acc_cr"].ToString()%></td>
  ...
  <td class=xl51 style='border-left:none'><%=dt.Rows[i]["pl_cd"].ToString() %></td>
  <td class=xl51 style='border-left:none'><%=dt.Rows[i]["pl_nm"].ToString() %></td>
 </tr>
 <%
         }
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl68 width=271 style='border-top:none;border-left:none;width:203pt'>&nbsp;</td>
