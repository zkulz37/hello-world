...
<%
   ...
   if (dt.Rows.Count >0)
	...
	if(p_bank_ccy=="VND")
	{
		p_xls_ccy_trans_format = "_\\(* \\#\\,\\#\\#0_\\)\\;\\[Red\\]_\\(\\\\ \\\\\\(\\#\\,\\#\\#0\\\\\\)\\;_\\(* \\0022-\\0022??_\\)\\;_\\(\\@_\\)";
		
    }
    else
    {
        p_xls_ccy_trans_format = "_\\(* \\#\\,\\#\\#0\\.00_\\)\\;\\[Red\\]_\\(\\\\ \\\\\\(\\#\\,\\#\\#0\\.00\\\\\\)\\;_\\(* \\0022-\\0022??_\\)\\;_\\(\\@_\\)";
	}
...
SQL = "SELECT TO_CHAR (tr_date, 'DD/MM/YYYY') trans_date, " +
  ...
  */
  SQL = "SELECT TO_CHAR (tr_date, 'DD/MM/YYYY') trans_date,  " +
            ...
            "        AND D.PK = I.TAC_HGTRD_PK " +
            "        AND D.TAC_ABACCTCODE_PK IN ("+l_acc_pk+")" +
            ...
            "        AND B.TAC_ABACCTCODE_PK IN ("+l_acc_pk+")" +
            "        AND B.TAC_ABDEPOMT_PK = " +l_bank_pk+
...
<link rel=File-List href="gfka00160_SotienguiNH_S08DN_files/filelist.xml">
<link rel=Edit-Time-Data href="gfka00160_SotienguiNH_S08DN_files/editdata.mso">
<link rel=OLE-Object-Data href="gfka00160_SotienguiNH_S08DN_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2008-07-31T08:15:23Z</o:LastPrinted>
  <o:Created>2008-02-02T09:03:07Z</o:Created>
  <o:LastSaved>2008-08-06T03:30:15Z</o:LastSaved>
...
<!--[if gte mso 9]><xml>
 ...
 <x:ExcelName>
  ...
  <x:Formula>='Sổ tiền gửi NH (S08-DN)'!$A$10:$M$10</x:Formula>
 </x:ExcelName>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1617 style='border-collapse:
 collapse;table-layout:fixed;width:1216pt'>
 <col class=xl24 width=89 span=3 style='mso-width-source:userset;mso-width-alt:
 3254;width:67pt'>
 <col class=xl24 width=271 span=2 style='mso-width-source:userset;mso-width-alt:
 9910;width:203pt'>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl24 width=110 style='width:83pt'></td>
  <td colspan=5 class=xl51 width=505 style='width:381pt'><span
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td colspan=5 class=xl26>20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
 </tr>
 <tr height=34 style='height:25.5pt'>
  <td colspan=13 height=34 class=xl52 style='height:25.5pt'>SỔ TIỀN GỬI NGÂN
  HÀNG</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td colspan=13 height=21 class=xl26 style='height:15.75pt'>Từ
  ngày&nbsp;&nbsp;<%= p_date_frm %>&nbsp;đến&nbsp;<%= p_date_to %></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl24 colspan=2 style='height:20.1pt;mso-ignore:colspan'>Nơi
  mở tài khoản giao dịch:</td>
  <td class=xl24></td>
  <td colspan=2 class=xl26><%=  p_bank_name %></td>
  <td class=xl24 colspan=2 style='mso-ignore:colspan'
  x:str="Số hiệu tài khoản tại nơi gửi: ">Số hiệu tài khoản tại nơi gửi:<span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=3 class=xl26><%=  p_bank_acc %></td>
  <td class=xl27 x:str="Đơn vị tính: ">Đơn vị tính:</td>
  <td class=xl26><%= l_book_ccy %></td>
  <td class=xl26></td>
 </tr>
 <tr height=14 style='mso-height-source:userset;height:10.5pt'>
  <td height=14 colspan=13 class=xl24 style='height:10.5pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td rowspan=2 height=42 class=xl53 width=89 style='border-bottom:.5pt solid black;
  height:31.5pt;width:67pt'>Ngày tháng ghi sổ</td>
  <td colspan=2 class=xl56 width=178 style='border-right:.5pt solid black;
  border-left:none;width:134pt'>Chứng từ</td>
  <td rowspan=2 class=xl53 width=271 style='border-bottom:.5pt solid black;
  ...
  <td colspan=3 class=xl56 width=330 style='border-right:.5pt solid black;
  border-left:none;width:249pt'>Số phát sinh(<%= p_bank_ccy %>)</td>
  <td colspan=3 class=xl58 width=330 style='border-right:.5pt solid black;
  border-left:none;width:249pt'>Số phát sinh(Tiền Ghi sổ <%= l_book_ccy %>)</td>
  <td rowspan=2 class=xl53 width=65 style='border-bottom:.5pt solid black;
  width:49pt'>Ghi chú</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl29 width=89 style='height:15.75pt;width:67pt'>Số hiệu</td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  x:autofilterrange="$A$10:$M$10" width=89 style='height:20.1pt;width:67pt'>A</td>
  ...
  <td class=xl30 id="_x0000_s1030" x:autofilter="all" width=110
  style='width:83pt' x:num>1</td>
  <td class=xl30 id="_x0000_s1031" x:autofilter="all" width=110
  style='width:83pt' x:num>2</td>
  <td class=xl30 id="_x0000_s1032" x:autofilter="all" width=110
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl36>&nbsp;</td>
  <td class=xl36>&nbsp;</td>
  <td class=xl36 align=right x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= p_open_trans %></td>
  <td class=xl37>&nbsp;</td>
  <td class=xl37>&nbsp;</td>
  <td class=xl37 align=right x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= p_open_books %></td>
  <td class=xl34>&nbsp;</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl33 style='height:15.75pt'>&nbsp;</td>
 ...
 <tr height=42 style='height:31.5pt'>
  <td height=42 class=xl38 style='height:31.5pt' x:str><%= strDate_Dsp %></td>
  <td class=xl39 style='white-space:nowrap;mso-text-control:shrinktofit;' ><%= dt_detail.Rows[i][1].ToString() %></td>
  <td class=xl40 x:str ><%= dt_detail.Rows[i][0].ToString() %></td>
  <td class=xl41 width=271 style='width:203pt'><%= dt_detail.Rows[i][3].ToString() %></td>
  <td class=xl41 width=271 style='width:203pt'><%= dt_detail.Rows[i][2].ToString() %></td>
  <td class=xl39 x:num><%= dt_detail.Rows[i][4].ToString() %></td>
  
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= dt_detail.Rows[i][5].ToString() %></td>
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= dt_detail.Rows[i][6].ToString() %></td>
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= dt_detail.Rows[i][7].ToString() %></td>
  
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= dt_detail.Rows[i][8].ToString() %></td>
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= dt_detail.Rows[i][9].ToString() %></td>
  <td class=xl42 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= dt_detail.Rows[i][10].ToString() %></td>
  <td class=xl60 x:num><%= dt_detail.Rows[i][11].ToString()%></td>
 </tr>
  <%
		}
	}
...
%> 
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl34>&nbsp;</td>
  <td class=xl35>&nbsp;</td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= p_deposit_trans %></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= p_widrawal_trans %></td>
  <td class=xl36>&nbsp;</td>
  <td class=xl44  x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= p_deposit_books %></td>
  <td class=xl44  x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= p_widrawal_books %></td>
  <td class=xl36>&nbsp;</td>
  <td class=xl34>&nbsp;</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl46>&nbsp;</td>
  <td class=xl46>&nbsp;</td>
  <td class=xl46>SỐ TỒN CUỐI KỲ</td>
  <td class=xl46>&nbsp;</td>
  <td class=xl47>&nbsp;</td>
  <td class=xl48>&nbsp;</td>
  <td class=xl48>&nbsp;</td>
  <td class=xl48 align=right x:num style="mso-number-format:'<%= p_xls_ccy_trans_format %>';"><%= p_close_trans %></td>
  <td class=xl48>&nbsp;</td>
  <td class=xl48>&nbsp;</td>
  <td class=xl48 align=right x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%= p_close_books %></td>
  <td class=xl46>&nbsp;</td>
 </tr>
 <tr height=14 style='mso-height-source:userset;height:10.5pt'>
  <td height=14 colspan=13 class=xl24 style='height:10.5pt;mso-ignore:colspan'></td>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  này có ............. trang, đánh số từ trang số 01 đến trang ................</td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.00pt'>
  <td height=25 colspan=2 class=xl24 style='height:18.00pt;mso-ignore:colspan'></td>
  <td class=xl49></td>
  <td colspan=3 class=xl24 style='mso-ignore:colspan'></td>
  <td class=xl50></td>
  <td colspan=6 class=xl59>Ngày &nbsp;&nbsp; tháng &nbsp;&nbsp; năm &nbsp;&nbsp;</td>
 </tr>
<%
    SQL = "SELECT   " +
            "    D.CODE, " +
 ...
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <td class=xl25></td>
  <td colspan=6 class=xl51><%= v3 %></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl59 style='height:17.25pt'><%=g1 %></td>
  <td colspan=3 class=xl59><%=g2 %></td>
  <td class=xl50></td>
  <td colspan=6 class=xl59><%=g3 %></td>
 </tr>
  <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=11 height=23 class=xl59 style='height:17.25pt'></td>
 </tr>
<tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=11 height=23 class=xl59 style='height:17.25pt'></td>
 </tr>
