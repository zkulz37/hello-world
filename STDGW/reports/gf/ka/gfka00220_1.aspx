...
<%
    ...
    string sp3 = "ac_sel_expense_acc_sum";
...
<link rel=File-List href="Copy%20of%20gfka00220_Expense%20PL_files/filelist.xml">
<link rel=Edit-Time-Data
href="Copy%20of%20gfka00220_Expense%20PL_files/editdata.mso">
<link rel=OLE-Object-Data
href="Copy%20of%20gfka00220_Expense%20PL_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2009-10-08T06:03:14Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2645 style='border-collapse:
 ...
 width:86pt'>
 <col class=xl24 width=242 style='mso-width-source:userset;mso-width-alt:8850;
 width:182pt'>
 ...
 <col class=xl24 width=115 style='mso-width-source:userset;mso-width-alt:4205;
 width:86pt'>
 <col class=xl24 width=103 span=12 style='mso-width-source:userset;mso-width-alt:
 3766;width:77pt'>
 ...
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  <td colspan=4 height=26 class=xl44 width=555 style='height:20.1pt;width:417pt'><%=l_cmp_name %></td>
  <td class=xl36 width=239 style='width:179pt'></td>
  <td colspan=2 class=xl45 width=237 style='width:178pt'></td>
  <td class=xl37 width=115 style='width:86pt'></td>
  ...
  <td class=xl35 width=103 style='width:77pt'></td>
  <td class=xl35 width=103 style='width:77pt'></td>
  <td class=xl35 width=71 style='width:53pt'></td>
  <td class=xl35 width=98 style='width:74pt'></td>
  <td class=xl35 width=94 style='width:71pt'></td>
 </tr>
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  <td colspan=5 height=26 class=xl46 style='height:20.1pt'><%=l_cmp_add %></td>
 ...
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  src="Copy%20of%20gfka00220_Expense%20PL_files/image001.gif" v:shapes="_x0000_s1030"></span><![endif]><span
  ...
  <td colspan=19 class=xl35 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr class=xl29 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl27 id="_x0000_s1049" x:autofilter="all" style='border-left:none'>Acc.
  Code</td>
  <td class=xl27 id="_x0000_s1050" x:autofilter="all" style='border-left:none'>Account
  Name</td>
  <td class=xl27 id="_x0000_s1051" x:autofilter="all" style='border-left:none'>P/L
  Unit Code</td>
  <td class=xl27 id="_x0000_s1052" x:autofilter="all" style='border-left:none'>P/L
  Unit Name</td>
  <td class=xl27 id="_x0000_s1053" x:autofilter="all">P/L Center Code</td>
  <td class=xl27 id="_x0000_s1054" x:autofilter="all" style='border-left:none'>P/L
  Center Name</td>
  ...
  <%
      ...
      {
          l_sum_accumulate += decimal.Parse(dt2.Rows[i][2].ToString());
          l_sum_jan += decimal.Parse(dt2.Rows[i][3].ToString());
          l_sum_feb += decimal.Parse(dt2.Rows[i][4].ToString());
          l_sum_mar += decimal.Parse(dt2.Rows[i][5].ToString());
          l_sum_apr += decimal.Parse(dt2.Rows[i][6].ToString());
          l_sum_may += decimal.Parse(dt2.Rows[i][7].ToString());
          l_sum_jun += decimal.Parse(dt2.Rows[i][8].ToString());
          l_sum_jul += decimal.Parse(dt2.Rows[i][9].ToString());
          l_sum_aug += decimal.Parse(dt2.Rows[i][10].ToString());
          l_sum_sep += decimal.Parse(dt2.Rows[i][11].ToString());
          l_sum_oct += decimal.Parse(dt2.Rows[i][12].ToString());
          l_sum_nov += decimal.Parse(dt2.Rows[i][13].ToString());
          l_sum_dec += decimal.Parse(dt2.Rows[i][14].ToString());
          l_ac_cd = dt2.Rows[i][0].ToString();
          
          SQL = "select pk from tac_abacctcode where ac_cd like '" + l_ac_cd + "' ";
          DataTable dt3 = ESysLib.TableReadOpen(SQL);
          l_ac_pk = dt3.Rows[0][0].ToString();
          ...
          l_parameter += "'" + l_parameter6 + "', ";          
          l_parameter += "'" + l_parameter7 + "' ";
          DataTable dt = ESysLib.TableReadOpenCursor("ac_sel_60080190_exp_plunit_acc", l_parameter);
...
%> 
  ...
  <td class=xl31 style='border-top:none;border-left:none'><%= dt.Rows[j][8]%></td>
  <td class=xl32 style='border-top:none;border-left:none'><%= dt.Rows[j][9]%></td>
  <td class=xl33 style='border-top:none'><%= dt.Rows[j][6]%></td>
  <td class=xl31 style='border-top:none;border-left:none'><%= dt.Rows[j][7]%></td>
  <td class=xl33 style='border-top:none;border-left:none'><%= dt.Rows[j][4]%></td>
...
%>
 ...
 <tr class=xl35 height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl47 style='height:20.1pt;border-top:none'></td>
  <td class=xl47 style='border-top:none;border-left:none'>Total</td>
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none'></td>
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none;border-left:none'></td>
 
  <td class=xl47 style='border-top:none;border-left:none' x:num></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][2]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][3]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][4]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][5]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][6]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][7]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][8]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][9]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][10]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][11]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][12]%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= dt2.Rows[i][13]%></td>
  <td colspan=1 class=xl47 style='mso-ignore:colspan'></td>
 </tr>
 <%          
  } // for i
 %>
  ...
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none;border-left:none'></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%= l_sum_accumulate%></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_jan %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_feb %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_mar %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_apr %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_may %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_jun %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_jul %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_aug %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_sep %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_oct %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_nov %></td>
  <td class=xl47 style='border-top:none;border-left:none' x:num><%=l_sum_dec %></td>
  <td colspan=1 class=xl35 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 colspan=23 class=xl24 style='height:20.1pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 colspan=23 class=xl24 style='height:20.1pt;mso-ignore:colspan'></td>
 </tr>
