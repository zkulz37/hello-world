...
<col class=xl25 width=121 span=4 style='mso-width-source:userset;mso-width-alt:
 ...
 <tr height=22 style='height:16.5pt'>
  ...
  <td colspan=3 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl24 colspan="9"><span style='mso-spacerun:yes'>     </span>(Unit:&nbsp;<%=l_scale%> &nbsp;VND)</td>
 </tr>
 <tr height=22 style='height:16.5pt'>
 ...
 <%
     ...
     {         
%>        
  <td height=21 class=xl52 style='height:15.75pt'><%=strBegin %><%= dt.Rows[i][0].ToString()%><%=strEnd%></td>
  <td class=xl53></td>
  ...
  <% 
      ...
      if (color_1 != 3)
         {
  %>
  <td class=xl58><%=strBegin %><%= dt.Rows[i + p][0].ToString()%><%=strEnd%></td>
  <td class=xl54>&nbsp;</td>
  ...
  %>
  <td class=xl58></td>
  <td class=xl54><%=strBegin %><%= dt.Rows[i + p][0].ToString()%><%=strEnd%></td>
  <td class=xl58></td>
  ...
  <td class=xl53><%=strBegin %><%= dt.Rows[i][0].ToString()%><%=strEnd%></td>
