...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'><%=fr_dt %>부터 <%=to_dt %>까지</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 align=right class=xl37>(단위: <%=l_Scale1%>  <%=l_ccy%>)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl43 >금년 (<%=curr_date %>)</td>
  <td class=xl44 >금년 (<%=last_Date %>)</td>
  <td class=xl45></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
