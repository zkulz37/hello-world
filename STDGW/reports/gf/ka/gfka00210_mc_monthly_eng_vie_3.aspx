...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1526 style='border-collapse:
 ...
 Manufaturing Cost Comparison</td>
  <td class=xl24></td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
 ...
 <tr height=21 style='height:15.75pt'>
  <td colspan=3 rowspan=2 height=42 class=xl36 style='height:31.5pt'>Classification</td>
 ...
 <%
  ...
  %>
 <tr height=21 style='height:15.75pt'>
  <td colspan=3 height=21 class=xl43 style='height:15.75pt'><%=strBegin %><%= dt.Rows[i][0].ToString()%><%=strEnd%></td>
  <td colspan=3 height=21 class=xl43 style='height:15.75pt'><%= dt.Rows[i][1].ToString()%><%=strEnd%></td>
  <td class=xl44 style='border-top:none;border-left:none' x:num><%= dt.Rows[i][3].ToString()%><%=strEnd%></td>
  <td class=xl44 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][4].ToString()%><%=strEnd%></td>
  <td class=xl44 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][5].ToString()%><%=strEnd%></td>
  <td class=xl44 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][6].ToString()%><%=strEnd%></td>
  <td class=xl44 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][7].ToString()%><%=strEnd%></td>
  <td class=xl44 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][8].ToString()%><%=strEnd%></td>
  <td class=xl45 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][9].ToString()%><%=strEnd%></td>
  <td class=xl45 align=right style='border-top:none;border-left:none' x:num><%= dt.Rows[i][10].ToString()%><%=strEnd%></td>
