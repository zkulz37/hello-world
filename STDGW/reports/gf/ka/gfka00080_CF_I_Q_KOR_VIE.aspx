...
<%
  ...
  string SQL2= "SELECT   char_1, char_2, char_3, code " +
        ...
        "         AND(code LIKE 'KOR%' OR code LIKE 'VIE%') " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl31 width=138 colspan=2 style='width:104pt'>Form: B 03 - DN</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl32 style='height:15.75pt'>주소: <%= l_cmp_add %></td>
  <td colspan=5 class=xl51>(Issued with Decision No. 15/2006/QĐ-BTC / Ban hành theo Quyết định số 15/2006/QĐ-BTC  </td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=5 class=xl51>dated March 20, 2006 by Ministry of Finance/Ngày 20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl52 style='height:19.5pt'>현금흐름표 / LƯU CHUYỂN TIỀN TỆ</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl34 style='height:15.75pt'>(Indirect method/Theo phương pháp gián tiếp)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'>Quater <%=quater %> Year <%=curr_date %> (Quý <%=quater %> Năm <%=curr_date %>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'><%=fr_dt %> 부터
  <%=to_dt %> 까지(Ngày <%=fr_dt %> đến <%=to_dt %>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
  <td colspan=2 class=xl36>(단위: <%=l_Scale1%> <%=l_ccy%>)</td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  style='mso-spacerun:yes'> </span>코드 <br>
  ...
  style='mso-spacerun:yes'> </span>비고 <br>
    Thuy&#7871;t <br>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl58><span style='mso-spacerun:yes'> 
  </span> <%=to_dt_e%> 현재</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
