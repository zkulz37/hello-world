...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1526 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl25 colspan="7"><span style='mso-spacerun:yes'>     </span>(Unit:&nbsp;<%=l_scale%> &nbsp;VND)</td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl44 style='border-top:none;border-left:none' x:num><%=strBegin %><%= dt.Rows[i][3].ToString()%><%=strEnd%><%=strEnd%></td>
