...
<%
  ...
  string l_acc_month =Request["p_month"].Substring(4,2) + '/' +  Request["p_month"].Substring(0, 4);
  string l_Scale1 = "";
 ...
 /* string SQL3  = "SELECT char_1,char_2,char_3,code " +
  ...
  DataTable dt = ESysLib.TableReadOpenCursor("sp_sel_gfka00080_4", l_parameter);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl34 style='height:15.75pt'>(Indirect method/Theo phương pháp gián tiếp)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl58>At dated<span style='mso-spacerun:yes'> 
  </span> <%=to_dt_e%></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl50 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=4 class=xl60 x:str="(Sign, Fullname, Stamp)"><span
