...
.xl37
	...
	border-bottom:.4pt solid windowtext;
	border-left:none;
	white-space:normal;}
.xl38
	{mso-style-parent:style0;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse: collapse;table-layout:fixed;width:561pt'>
 <col class=xl24 width=355 style='mso-width-source:userset;mso-width-alt:12982; width:266pt'>
 <col class=xl24 width=355 style='mso-width-source:userset;mso-width-alt:12982; width:266pt;display:none'>
 <col class=xl24 width=355 style='mso-width-source:userset;mso-width-alt:12982; width:266pt'>
 <col class=xl25 width=54 style='mso-width-source:userset;mso-width-alt:1974; width:41pt'>
 <col class=xl25 width=61 style='mso-width-source:userset;mso-width-alt:2230; width:46pt'>
 <col class=xl26 width=138 span=2 style='mso-width-source:userset;mso-width-alt: 5046;width:104pt'>
 <col class=xl26 width=138 span=2 style='mso-width-source:userset;mso-width-alt: 5046;width:104pt'>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl31 width=138 colspan=3 style='width:104pt'>Form: B 03 - DN</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=6 class=xl51> Issued with Decision No. 15/2006/QĐ-BTC /Ban hành theo Quyết định số 15/2006/QĐ-BTC  </td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=6 class=xl51>dated March 20, 2006 by Ministry of Finance/Ngày 20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl52 style='height:19.5pt'>CASH FLOWS/LƯU CHUYỂN TIỀN TỆ</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl34 style='height:15.75pt'>(Direct Method/Theo phương pháp trực tiếp)</td>
 </tr>
  <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'>Form <%=fr_dt %> to
  <%=to_dt %> (Ngày <%=fr_dt %> đến <%=to_dt %>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 <td rowspan=3 height=42 class=xl54 style='border-bottom:.5pt solid black;
  height:31.5pt'>Items</td>
  <td rowspan=3 class=xl54 height=160  style='border-bottom:.5pt solid black'>Chỉ tiêu</td>
  <td rowspan=3 height=42 class=xl54 style='border-bottom:.5pt solid black;
  height:31.5pt'>Chỉ tiêu(KOR)</td>
  <td rowspan=3 class=xl66 height=160  width=54 style='border-bottom:.5pt solid black;
  width:41pt' x:str="Code &#10;Mã s&#7889;"><span
  style='mso-spacerun:yes'> </span>Code <br>
    Mã s&#7889;<span style='mso-spacerun:yes'> </span></td>
  <td rowspan=3 class=xl68 width=61 style='border-bottom:.5pt solid black;border-right:.5pt solid black;
  width:46pt' x:str="Note &#10; Thuy&#7871;t &#10;minh"><span
  ...
  none' >This Month/Tháng này</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 rowspan=2 style='height:15.75pt' >Month/Tháng (<%=curr_date %>)</td>
  <td class=xl37 rowspan=2 >Month/Tháng (<%=last_Date %>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <td class=xl62 style="border-bottom:.5pt solid black"><%=tag_begin%><%= dt.Rows[i][0].ToString()%><%=tag_end%></td>
  <td class=xl62 style="border-bottom:.5pt solid black"><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl62 style="border-bottom:.5pt solid black"><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl63 style="border-bottom:.5pt solid black" x:str><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl63 style="border-bottom:.5pt solid black"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl64 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';border-bottom:.5pt solid black"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl64 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';border-bottom:.5pt solid black"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 </tr>
 <%
     }
 %> 
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl59><%=l_col2_1%>/<%=l_col2_3%></td>
  <td colspan=4 class=xl34><%=l_col3_1%>/<%=l_col3_3%></td>
 </tr>
 <tr class=xl50 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl33 style='height:18.0pt'>(Sign, Fullname)/(Ký, họ tên)</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl61 ><%=name2%></td>
