...
<table x:str border=0 cellpadding=0 cellspacing=0 width=757 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=5 class=xl63>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td colspan=3 class=xl39>(&#272;&#417;n v&#7883; tính: <%=l_ccy%>)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td height=21 class=xl47 style='height:15.75pt' x:num>2</td>
  <td class=xl48 x:num>3</td>
  <td class=xl49 width=61 style='width:46pt' x:num>4</td>
  <td class=xl49 width=138 style='width:104pt' x:num>5</td>
  <td class=xl49 width=138 style='width:104pt' x:num>6</td>
  <td class=xl46></td>
 </tr>
 <%
    string tag_begin="";
 ...
 %>
 <tr class=xl50>
 <td class=xl73><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl73><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl74 x:str><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl74><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl75 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl75 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <%}
   else
 ...
 %>
 <tr class=xl50>
 <td class=xl51><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl51><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl52 x:str><%=tag_begin%><%= dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl52><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl53 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl53 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 <%
        } 
  ...
  %>
 <tr class=xl50>
 <td class=xl54><%=tag_begin%><%=dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl54><%=tag_begin%><%=dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl55 x:num><%=tag_begin%><%= dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl55><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl56 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl56 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
  <td class=xl33></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt'><span
  style='mso-spacerun:yes'></span><%=l_col1_3%><span
  style='mso-spacerun:yes'></span></td>
  <td colspan=2 class=xl41><%=l_col2_3%><span
  style='mso-spacerun:yes'></span></td>
  <td colspan=3 class=xl71><span
  style='mso-spacerun:yes'>  </span><%=l_col3_3%><span
  style='mso-spacerun:yes'>  </span></td>
  <td class=xl59></td>
 </tr>
 <tr class=xl60 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=3 class=xl72 x:str="(Ký, h&#7885; tên, &#273;óng d&#7845;u)"><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl42 style='height:15.75pt'><%=name1%></td>
  <td colspan=3 class=xl46><b><%=name2%></b></td>
  <td colspan=2 class=xl72><b><%=name3%></b></td>
