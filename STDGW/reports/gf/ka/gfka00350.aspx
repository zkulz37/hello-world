...
<%
   ...
   // string p_xls_ccy_format = "";
    ...
    //Response.End(); 
    DataTable dt_detail = ESysLib.TableReadOpenCursor("acnt.sp_sel_gfka00350", l_parameter);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1547 style='border-collapse:
  ...
  <%
    ...
    //{
		for(i=1;i<dt_detail.Rows.Count;i++)
		{
			...
			strBegin="";
			strEnd="";
			if (dt_detail.Rows[i][20].ToString()=="I")
			{
				strBegin="<i>";
				strEnd="</i>";
			}
			if (dt_detail.Rows[i][20].ToString()=="B")
			{
				strBegin="<b>";
				strEnd="</b>";
			}
            _color = dt_detail.Rows[i][21].ToString();
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl35 style="height:15.0pt;background-color:<%=_class%>;"><%=dt_detail.Rows[i][22].ToString()%></td>
 
  <td colspan=2 class=xl36 width=490 style="width:368pt;background-color:<%=_class%>;"><%=strBegin%><%=dt_detail.Rows[i][23].ToString()%><%=strEnd%></td>
  <td class=xl36  width=42 style="text-align:right;width:32pt;background-color:<%=_class%>;"><%=strBegin%><%=dt_detail.Rows[i][24].ToString()%><%=strEnd%></td>
  ...
  <td class=xl37 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][5].ToString()%><%=strEnd%></td>
  ...
  <td class=xl37 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][9].ToString()%><%=strEnd%></td>
  <td class=xl37 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][12].ToString()%><%=strEnd%></td>
  <td class=xl38 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][13].ToString()%><%=strEnd%></td>
  <td class=xl37 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][16].ToString()%><%=strEnd%></td>
  <td class=xl38 x:num style='mso-number-format:"<%= p_xls_ccy_format%>";background-color:<%=_class%>;'><%=strBegin%><%=dt_detail.Rows[i][17].ToString()%><%=strEnd%></td>
 </tr>
  <%
		}
    //}
