...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1735 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl26 style='border-left:none'>Acc. Code VAS</td>
 ...
 <tr height=63 style='height:47.25pt'>
  ...
  <td class=xl31 style="mso-number-format:'<%= p_xls_ccy_format %>'" x:num><%=dt.Rows[i][7]%></td>
  <td class=xl28 style='border-top:none;border-left:none'><%=dt.Rows[i][8]%></td>
  <td class=xl30 width=215 style='border-top:none;border-left:none;width:161pt'><%=dt.Rows[i][9]%></td>
  <td class=xl28 style='border-top:none;border-left:none'><%=dt.Rows[i][10]%></td>
  ...
  <td class=xl30 width=215 style='border-top:none;border-left:none;width:161pt'><%=dt.Rows[i][13]%></td>
 </tr>
 <%} %>
