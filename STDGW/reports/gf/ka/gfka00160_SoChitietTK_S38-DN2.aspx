...
<%
    ...
    string SQLAC = "SELECT pk, ac_cd, ac_lnm, drcr_type  FROM tac_abacctcode ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1393 style='border-collapse:
 ...
 <col class=xl24 width=89 style='mso-width-source:userset;mso-width-alt:3254; width:67pt'>
 <col class=xl24 width=264 span=2 style='mso-width-source:userset;mso-width-alt: 9654;width:198pt'>
 <col class=xl24 width=61 style='mso-width-source:userset;mso-width-alt:2230; width:46pt'>
 <col class=xl24 width=62 style='mso-width-source:userset;mso-width-alt:2267; width:47pt'>
 <col class=xl24 width=107 span=2 style='mso-width-source:userset;mso-width-alt: 3913;width:80pt'>
 <col class=xl24 width=105 style='mso-width-source:userset;mso-width-alt:3840; width:79pt'>
 <col class=xl24 width=107 style='mso-width-source:userset;mso-width-alt:3913; width:80pt'>
 ...
 <tr height=35 style='height:26.25pt'>
  <td colspan=15 height=35 class=xl67 style='height:26.25pt'>S&#7892; CHI
  TI&#7870;T TÀI KHO&#7842;N</td>
  <td class=xl24></td>
 </tr>
 <tr height=27 style='height:20.25pt'>
  <td colspan=15 height=27 class=xl68 style='height:20.25pt'>T&#7915; ngày
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td colspan=7 class=xl76 style='border-right:.5pt solid black;border-left:
  none'>S&#7889; ti&#7873;n</td>
  <td rowspan=2 class=xl78 style='width:80pt;border-right:.5pt solid black;border-left:.5pt solid black'>Ghi Chú</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl82 width=212 style='border-right:.5pt solid black;
  border-left:none;width:159pt'>Dư cuối kỳ</td>
  <td rowspan=2 class=xl82 width=212 style='border-right:.5pt solid black;
  border-left:.5pt solid black;width:159pt'>Tỷ giá BQ di động</td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl33 width=105 style='width:79pt;'>Ngo&#7841;i t&#7879;</td>
  <td class=xl33 width=107 style='width:80pt;border-right:.5pt solid black;border-left:.5pt solid black'>Ghi s&#7893;</td>
  
  <td class=xl33 style='width:80pt;border-right:.5pt solid black;border-left:.5pt solid black'>SEQ</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  x:autofilterrange="$A$12:$O$12" style='height:20.1pt'>A</td>
  ...
  <td class=xl35 id="_x0000_s1036" x:autofilter="all" x:num>5</td>
  <td class=xl35 id="_x0000_s1037" x:autofilter="all" x:num>6</td>
  <td class=xl35 id="_x0000_s1038" x:autofilter="all" x:num>7</td>
...
string SQLD = "SELECT TO_CHAR(H.TR_DATE,'DD/MM/YYYY') TRANS_DATE, H.VOUCHERNO, " +
                ...
                "H.PK, TO_CHAR((  TO_NUMBER ('" + dr_openning + "')+ SUM (DECODE (d.drcr_type, 'D', r.tr_bookamt, 0)- DECODE (d.drcr_type, 'C', r.tr_bookamt, 0)) OVER (ORDER BY h.tr_date,h.voucherno, h.pk,D.PK,R.PK) ),sf_get_format ('ACBG0040')) AS book,TO_CHAR((  TO_NUMBER ('" + dr_fopenning + "')+ SUM (DECODE (d.drcr_type, 'D', r.tr_amt, 0)- DECODE (d.drcr_type, 'C', r.tr_amt, 0)) OVER (ORDER BY h.tr_date,h.voucherno, h.pk, D.PK,R.PK)),'9,999,999,999,999.99') AS trans " +
 ...
 //Response.End();
     ...
     if (dt.Rows.Count > 0)
     {
         ...
         for (int i = 0; i < dt.Rows.Count; i++)
         {
			...
			if(dt.Rows[i]["book"].ToString().Trim() != "" && dt.Rows[i]["trans"].ToString().Trim() != "")
			{
				l_exrate = decimal.Parse(dt.Rows[i]["book"].ToString()) / decimal.Parse(dt.Rows[i]["trans"].ToString());
			}
 %> 
 <tr class=xl27 height=42 style='height:31.5pt'>
  ...
  <td class=xl48 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_trans %>';" ><%= dt.Rows[i]["trans"].ToString()%></td>
  <td class=xl48 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ><%= dt.Rows[i]["book"].ToString()%></td>
  <td class=xl48 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ><%=l_exrate%></td>
...
<%
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl52 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
  <td class=xl52 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
  <td class=xl52 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl56 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
  <td class=xl56 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
  <td class=xl56 x:num style="white-space:nowrap;mso-text-control:shrinktofit;mso-number-format:'<%= p_xls_ccy_format_book %>';" ></td>
 ...
 <tr class=xl59 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl85>Ngày …. Tháng .. N&#259;m</td>
  <td class=xl61></td>
  <td class=xl58></td>
 </tr>
<%
 ...
 %>    
 <tr class=xl59 height=21 style='height:15.75pt'>
  <td colspan=4 height=21 class=xl62 style='height:15.75pt'><%= v1 %></td>
  <td class=xl62><%= v2 %></td>
  <td colspan=2 class=xl62 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl86><%= v3 %></td>
  <td class=xl63></td>
  <td class=xl58></td>
 </tr>
 <tr class=xl59 height=21 style='height:15.75pt'>
  <td colspan=4 height=21 class=xl64 style='height:15.75pt'><%=g1 %></td>
  <td class=xl64><%=g2 %></td>
  <td colspan=2 class=xl64 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl87><%=g3 %></td>
  <td class=xl61></td>
  <td class=xl58></td>
 </tr>
...
<tr height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <tr class=xl59 height=21 style='height:15.75pt'>
  <td colspan=4 height=21 class=xl64 style='height:15.75pt'><%= n1 %></td>
  <td class=xl64><%= n2 %></td>
  <td colspan=2 class=xl64 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl87><%= n3 %></td>
  <td class=xl61></td>
  <td class=xl58></td>
 </tr>
