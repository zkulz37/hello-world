...
<link rel=File-List href="60110060_rpt_files/filelist.xml">
<link rel=Edit-Time-Data href="60110060_rpt_files/editdata.mso">
<link rel=OLE-Object-Data href="60110060_rpt_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2008-12-16T03:07:29Z</o:LastSaved>
...
<!--[if gte mso 9]><xml>
 ...
 <x:ExcelName>
  ...
  <x:Formula>='Monthly Partner Balance'!$A$6:$H$7</x:Formula>
 </x:ExcelName>
</xml><![endif]-->
</head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1342 style='border-collapse:
 ...
 width:76pt'>
 <col class=xl24 width=95 span=9 style='mso-width-source:userset;mso-width-alt:
 4053;width:71pt'>
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl32 colspan=2 width=337 style='height:18.75pt;
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl28 colspan=2 style='height:12.75pt;mso-ignore:colspan'>Monthly
  Partner Balance</td>
  <td colspan=11 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl28 style='height:12.75pt'>at</td>
  <td colspan=3 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl26 x:str="Account code : ">Account code :<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl27 x:num><%=p_acc_code %></td>
  <td class=xl28><%=p_acc_name %></td>
  <td colspan=6 class=xl24 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl28 colspan=2 style='height:12.75pt;mso-ignore:colspan'>From <%= p_dt_from %> to <%=p_dt_to %></td>
  <td class=xl25></td>
  <td class=xl24></td>
  <td class=xl26><% if (p_cust_code!="") { %>Partner :<%} %></td>
  <td class=xl27><%=p_cust_code %></td>
  <td class=xl28><%=p_cust_name %></td>
  <td class=xl28></td>
 ...
 <tr class=xl30 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td rowspan=2 class=xl33>Ccy</td>
  <td rowspan=2 class=xl33>Opening Balance</td>
  <td colspan=2 class=xl33 style='border-left:none'>Trans</td>
  <td colspan=2 class=xl33 style='border-left:none'>Books</td>
  <td colspan=2 class=xl33 style='border-left:none'>Acc. Trans</td>
...
SQL = "SELECT N.TCO_BUSPARTNER_PK,N.TAC_ABACCTCODE_PK , B.PARTNER_ID, B.PARTNER_NAME,DECODE('"+l_account_pk+"','',SF_A_GET_ACCD(N.TAC_ABACCTCODE_PK,'"+l_company_pk+"'),'') ACCD, " + 
	...
	{ 
		...
		{
 %>
 <tr class=xl29  style='mso-height-source:auto;'>
  <td height=20 class=xl31 style='border-top:none;font-size:10.0pt;'><%=dt_detail.Rows[i][2].ToString()%></td>
  <td class=xl31 style='border-top:none;border-left:none;white-space:normal;font-size:10.0pt;'><%=dt_detail.Rows[i][3].ToString()%></td>
  <td class=xl35 style='border-top:none;border-left:none;font-size:10.0pt;'><%=dt_detail.Rows[i][5].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][7].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][8].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][9].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][10].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][11].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][12].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][13].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][14].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;" x:num><%=dt_detail.Rows[i][15].ToString()%></td>
  <td class=xl38 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';font-size:9.0pt;mso-text-control:shrinktofit;" x:num><%=dt_detail.Rows[i][17].ToString()%></td>
 </tr>
 <%
    }
}
%>
 ...
 <tr class=xl34 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 rowspan=2 height=40 class=xl33 style='height:30.0pt'>Ccy</td>
  <td rowspan=2 class=xl33 style='border-top:none'>Opening Balance</td>
  <td colspan=2 class=xl33 style='border-left:none'>Trans</td>
  <td colspan=2 class=xl33 style='border-left:none'>Books</td>
  <td colspan=2 class=xl33 style='border-left:none'>Acc. Trans</td>
  <td colspan=2 class=xl33 style='border-left:none'>Acc. Books</td>
...
SQL = "SELECT CCY,OPEN_FBAL,OPEN_BAL,DR_FSUM,CR_FSUM,DR_SUM,CR_SUM, " + 
 ...
 <tr class=xl29 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 height=20 class=xl35 style='height:15.0pt;font-size:10.0pt;'><%=dt_total.Rows[i][0].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][2].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';" x:num><%=dt_total.Rows[i][3].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';" x:num><%=dt_total.Rows[i][4].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][5].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][6].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';" x:num><%=dt_total.Rows[i][7].ToString()%></td>
  <td class=xl36 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_trans %>';" x:num><%=dt_total.Rows[i][8].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][9].ToString()%></td>
  <td class=xl37 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][10].ToString()%></td>
  <td class=xl38 align=right style="border-top:none;border-left:none;mso-number-format:'<%= p_xls_ccy_book %>';" x:num><%=dt_total.Rows[i][12].ToString()%></td>
 </tr>
<%
        }
   }
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 colspan=5 class=xl82 style='height:15.75pt;mso-ignore:colspan'></td>
  <td colspan=4 style='mso-ignore:colspan'></td>
  <td class=xl83 colspan=2 style='mso-ignore:colspan'>Ngày <%= l_report_dd %> tháng <%= l_report_mm %> n&#259;m
  <%= l_report_yy %></td>
  <td class=xl83></td>
  <td></td>
 </tr>
...
SQL = "SELECT   " +
 ...
 %> 
 <tr height=21 style='height:15.75pt'>
  <td colspan=2 height=21 class=xl84 style='height:15.75pt'><%= v1 %></td>
  <td></td>
  <td colspan=4 class=xl84><%= v2 %></td>
  <td colspan=2 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl84><%= v3 %></td>
  <td></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td colspan=2 height=21 class=xl85 style='height:15.75pt'><%=g1 %></td>
  <td></td>
  <td colspan=4 class=xl85><%=g2 %></td>
  <td colspan=2 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl85><%=g3 %></td>
  <td></td>
 </tr>
 ...
 <tr height=21 style='height:15.75pt'>
  <td colspan=2 height=21 class=xl84 style='height:15.75pt'><%= n1 %></td>
  <td></td>
  <td colspan=4 class=xl84><%= n2 %></td>
  <td colspan=2 style='mso-ignore:colspan'></td>
  <td colspan=3 class=xl84><%= n3 %></td>
  <td></td>
 </tr>
