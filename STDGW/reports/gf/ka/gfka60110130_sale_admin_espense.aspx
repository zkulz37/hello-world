...
<link rel=File-List href="60110130_sale%20_admin%20espense_files/filelist.xml">
<link rel=Edit-Time-Data
href="60110130_sale%20_admin%20espense_files/editdata.mso">
<link rel=OLE-Object-Data
href="60110130_sale%20_admin%20espense_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:Author>AA</o:Author>
  <o:LastAuthor>Administrator</o:LastAuthor>
  <o:LastPrinted>2009-01-16T08:13:51Z</o:LastPrinted>
  <o:Created>2008-09-01T06:28:26Z</o:Created>
  <o:LastSaved>2009-01-16T08:22:52Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1961 style='border-collapse:
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl26 colspan=3 width=423 style='mso-ignore:colspan;width:317pt'><%= p_cmp_name %></td>
 ...
 <tr height=27 style='height:20.25pt'>
  ...
  <td colspan=16 class=xl39>B&#7842;NG CHI PHÍ BÁN HÀNG &amp; QU&#7842;N LÝ
  DOANH NGHI&#7878;P/ SALE &amp; ADMIN EXPENSE</td>
  <td class=xl26></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl26 style='height:15.75pt'></td>
  <td colspan=16 class=xl40>T&#7915; <%= p_date_frm %> &#273;&#7871;n <%= p_date_to%></td>
  <td class=xl26></td>
 </tr>
 ...
 <tr height=17 style='height:12.75pt'>
  <td rowspan=2 height=37 class=xl41 style='border-bottom:.5pt solid black;
  height:27.75pt'>&nbsp;</td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black'>Code</td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black'>Kho&#7843;n
  m&#7909;c<span style='mso-spacerun:yes'>  </span>(VIE)</td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black'>Item (ENG)</td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black'>Item (KOR)</td>
  <td rowspan=2 class=xl43 style='border-bottom:.5pt solid black'>Accumlate</td>
  <td colspan=12 class=xl46 style='border-right:.5pt solid black;border-left:
  none'>&nbsp;</td>
 </tr>
 <tr class=xl30 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl31 style='height:15.0pt'>Jan</td>
  <td class=xl31>Feb</td>
  <td class=xl31>Mar</td>
  <td class=xl31>Apr</td>
  <td class=xl31>May</td>
  <td class=xl31>Jun</td>
  <td class=xl31>Jul</td>
  <td class=xl31>Aug</td>
  <td class=xl31>Sep</td>
  <td class=xl31>Oct</td>
  <td class=xl31>Nov</td>
  <td class=xl31>Dec</td>
 </tr>
<%
  ...
  %> 
  <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl32 style='height:15.0pt' style='background:#<%=p_color %>;<%=p_font_type %>'>&nbsp;</td>
  <td class=xl36 x:str style='background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][1].ToString() %></td>
  <td class=xl37 x:str style='background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][2].ToString() %></td>
  <td class=xl37 x:str style='background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][3].ToString() %></td>
  <td class=xl37 x:str style='background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][4].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][9].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][10].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][11].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][12].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][13].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][14].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][15].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][16].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][17].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][18].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][19].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][20].ToString() %></td>
  <td class=xl38 x:num style='background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";'><%=dt_detail.Rows[i][21].ToString() %></td>
 </tr>
  <%
     }
%> 
