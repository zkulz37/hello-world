...
<%
	...
	SQL = " SELECT   TO_CHAR(SUM (NVL (YMD_DRBOOKS, 0)), ac_get_format ('ACBG0040')) deditbookamount ";
	...
	SQL = " SELECT h.voucherno, TO_CHAR (h.tr_date, 'DD/MM/YYYY'), max(r.remark2) remark2, max(r.remark) remark, ";
	SQL += "       ac_get_accd (r.tac_abacctcode_pk_dr,"+l_company_pk+") dr_code, ";
	SQL += "       ac_get_accd (r.tac_abacctcode_pk_cr,"+l_company_pk+") cr_code, ";
	SQL += "       TO_CHAR (sum(tr_bookamt), ac_get_format ('ACBG0040')) book_amt, h.pk,h.tr_date ";
	...
	SQL += "   AND r.tac_abacctcode_pk_dr IN (SELECT     pk ";
	...
	SQL += "    group by h.tr_date,h.pk, h.voucherno,r.tac_abacctcode_pk_dr,r.tac_abacctcode_pk_cr ";
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  <x:ExcelWorksheets>
   <x:ExcelWorksheet>
    <x:Name>S&#7893; NK thu ti&#7873;n(Mau so S03a1-DN)</x:Name>
    <x:WorksheetOptions>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1175 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  style='mso-spacerun:yes'> </span>M&#7851;u s&#7889; S03a1-DN</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl46></td>
  <td colspan=5 class=xl33>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
  tr&#432;&#7901;ng B&#7897; Tài chính)</td>
 </tr>
 <tr height=34 style='height:25.5pt'>
  <td colspan=8 height=34 class=xl66 style='height:25.5pt'>NH&#7852;T KÝ THU
  TI&#7872;N</td>
  <td class=xl47></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=8 height=26 class=xl33 style='height:19.5pt'>T&#7915;
  ngày&nbsp;&nbsp;<%= p_dt_from %>&nbsp;&#273;&#7871;n&nbsp;<%= p_dt_to%></td>
  <td class=xl45></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl48 style='height:15.0pt'>Tài kho&#7843;n:</td>
  <td class=xl49 x:num><%= p_acc_code %></td>
  <td class=xl50>Tên TK:</td>
  <td class=xl51><%= p_acc_name %></td>
  <td colspan=2 class=xl46 style='mso-ignore:colspan'></td>
  <td class=xl52></td>
  <td class=xl51>&#272;&#417;n v&#7883; tính:&nbsp;<%= l_book_ccy %></td>
  <td class=xl46></td>
 </tr>
 <tr class=xl26 height=21 style='height:15.75pt'>
  <td height=21 class=xl25 style='height:15.75pt' x:str="Ngày tháng ">Ngày
  tháng<span style='mso-spacerun:yes'> </span></td>
  <td colspan=2 class=xl57 style='border-right:.5pt solid black;border-left:
  none'>Ch&#7913;ng t&#7915;</td>
  <td rowspan=2 class=xl25 style='border-top:none'>Di&#7877;n gi&#7843;i</td>
  <td class=xl25 style='border-left:none'>Description</td>
  <td rowspan=2 class=xl59 width=68 style='width:51pt'>Ghi N&#7907; <br>
    TK</td>
  <td rowspan=2 class=xl59 width=68 style='width:51pt'>Ghi có các TK</td>
  <td class=xl25 style='border-top:none;border-left:none'>S&#7889; ti&#7873;n</td>
  <td rowspan=2 class=xl67>Ghi Chú</td>
 </tr>
 <tr class=xl26 height=21 style='height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'>ghi s&#7893;</td>
  <td class=xl41 x:str="S&#7889; ">S&#7889;<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl41>Ngày</td>
 ...
 <tr class=xl45 height=21 style='height:15.75pt'>
  <td colspan=3 height=21 class=xl61 style='border-right:.5pt solid black;height:15.75pt'>&nbsp;</td>
  <td class=xl39 width=299 style='width:224pt'>T&#7893;ng c&#7897;ng s&#7889;
  phát sinh</td>
 ...
 <tr class=xl56 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=8 height=23 class=xl31 style='height:17.25pt'>S&#7893; có…. Trang
 ...
 <tr class=xl45 height=31 style='mso-height-source:userset;height:23.25pt'>
  ...
  <td colspan=3 class=xl31>Ngày …. Tháng .... N&#259;m.....</td>
  <td class=xl45></td>
 </tr>
<%
    SQL = "SELECT   " +
 ...
 %>  
 <tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl35 style='height:17.25pt'><%= v1 %></td>
  <td class=xl35><%= v2 %></td>
  <td class=xl35></td>
  <td colspan=3 class=xl35><%= v3 %></td>
  <td class=xl45></td>
 </tr>
 <tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl38 style='height:17.25pt'><%=g1 %></td>
  <td class=xl38><%=g2 %></td>
  <td class=xl38></td>
  <td colspan=3 class=xl38><%=g3 %></td>
  <td class=xl45></td>
 </tr>
 <tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 colspan=9 class=xl45 style='height:17.25pt;mso-ignore:colspan'></td>
 </tr>
 <tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 colspan=9 class=xl45 style='height:17.25pt;mso-ignore:colspan'></td>
 </tr>
...
<tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  <tr class=xl45 height=23 style='mso-height-source:userset;height:17.25pt'>
  <td colspan=3 height=23 class=xl35 style='height:17.25pt'><%= n1 %></td>
  <td class=xl35><%= n2 %></td>
  <td class=xl35></td>
  <td colspan=3 class=xl35><%= n3 %></td>
  <td class=xl45></td>
 </tr>
