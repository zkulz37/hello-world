...
<%
    SQL = "SELECT T.PK, T.AC_CD, T.AC_NM,  " +
        ...
        "WHERE DEL_IF =0 AND TCO_COMPANY_PK = " + l_company_pk + " AND AC_CD = '111000') ";
...
<%
    SQL = " SELECT T.PK, T.AC_CD, T.AC_NM  " +
      ...
      " AND T.LEAF_YN ='Y' " +
      " CONNECT BY pac_pk = PRIOR pk START WITH pk = (SELECT PK FROM TAC_ABACCTCODE  " +
      " WHERE DEL_IF =0 AND TCO_COMPANY_PK = " + l_company_pk + " AND AC_CD = '112100') ";
...
<%
    SQL = " SELECT T.PK, T.AC_CD, T.AC_NM  " +
      ...
      " AND T.LEAF_YN ='Y' " +
      " CONNECT BY pac_pk = PRIOR pk START WITH pk = (SELECT PK FROM TAC_ABACCTCODE  " +
      " WHERE DEL_IF =0 AND TCO_COMPANY_PK = " + l_company_pk + " AND AC_CD = '112200') ";
