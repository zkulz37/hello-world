...
if (l_rpt_Option == "DRCR")
{
    ...
    SQL += " pk, tr_date, sf_get_buspartner_id(tco_buspartner_pk) partner_id, sf_get_buspartner_nm(tco_buspartner_pk) partner_name  ";
    ...
    SQL += "                      and d.pk = r1.tac_hgtrd_pk) tco_buspartner_pk   ";
    ...
    SQL += "                where     d.del_if = 0";
    SQL += "                      and d.tac_hgtrh_pk = h.pk";
    SQL += "                      and d.pk = r2.tac_hgtrd_pk) tco_buspartner_pk   ";
    ...
    SQL += " UNION ALL  SELECT TO_CHAR(h.tr_date, 'DD/MM/YYYY') tr_date_fmt, h.voucherno " +
        ...
        "     , DECODE('" + p_acc_type + "', 'D', 2) order_cond, r2.tco_buspartner_pk tco_buspartner_pk " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1217 style='border-collapse: collapse;table-layout:fixed;width:913pt'>
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=10 height=30 class=xl70 style='height:22.5pt' >GENERAL LEDGER<span style='mso-spacerun:yes'> </span></td>
  <td class=xl25></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=10 height=26 class=xl71 style='height:19.5pt'>To date <%= p_dt_from %>
