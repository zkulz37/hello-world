...
<table x:str border=0 cellpadding=0 cellspacing=0 width=916 class=xl547107
 ...
 <tr class=xl587107 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl857107 style='height:15.0pt'>Address/주소:<%=l_cmp_add %></td>
 ...
 <tr class=xl587107 height=22 style='height:16.5pt'>
  <td colspan=6 height=22 class=xl1777107 style='height:16.5pt'>As at/현재 :  <%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%></td>
  <td class=xl587107></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl557107></td>
  <td class=xl677107></td>
  <td class=xl687107>(Unit/단위 : VND)</td>
  <td class=xl547107></td>
 </tr>
 <tr height=42 style='height:31.5pt'>
  <td height=42 class=xl897107 style='height:31.5pt'>ASSETS</td>
  <td class=xl1347107 style='border-left:none'>자산</td>
  <td class=xl867107 width=50 style='border-left:none;width:38pt'>Code<br>
    코드</td>
  <td class=xl877107 width=61 style='border-left:none;width:46pt'>header
  <br>
    비고</td>
  <td class=xl1587107 width=110 style='border-left:none;width:83pt'>Closing
  <br>
    기말</td>
  <td class=xl1597107 width=110 style='border-left:none;width:83pt'>Openning<br>
   기초</td>
  <td class=xl547107></td>
 </tr>
...
<tr height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl1427107 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString() %><%=strEnd%></td>
...
%>
 ...
 <tr height=53 style='page-break-before:always;mso-height-source:userset;
  ...
  <td class=xl1347107 style='border-left:none'>부채 및 자본</td>
  <td class=xl867107 width=50 style='border-left:none;width:38pt'>Code<br>
    코드</td>
  <td class=xl877107 width=61 style='border-left:none;width:46pt'>Header
  <br>
    비고</td>
  <td class=xl1587107 width=110 style='border-left:none;width:83pt'>Closing<br>
   기말</td>
  <td class=xl1597107 width=110 style='border-left:none;width:83pt'>Openning<br>
    기초</td>
  <td class=xl547107></td>
...
%>
 ...
 <td height=37 class=xl102 width=285 style='height:27.75pt;width:214pt'><%=strBegin%><%= dt_detail.Rows[i]["prn_acnm"].ToString()%><%=strEnd%></td>
  <td height=37 class=xl102 style='height:27.75pt;border-top:none'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString()%><%=strEnd%></td>
...
%>
 ...
 <tr class=xl38 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl108 style='height:18.0pt'>OFF BALANCE SHEET ITEMS/부외자산 항목</td>
  <td class=xl81></td>
 ...
 <tr height=43 style='height:32.25pt'>
  ...
  <td class=xl1647107>항목</td>
  <td class=xl1657107>Code<br>
  코드</td>
  <td class=xl1667107>Notes<br>
  비고</td>
  <td class=xl1677107 width=110 style='border-left:none;width:83pt'>Closing<br>
    기말</td>
  <td class=xl1687107 width=110 style='border-left:none;width:83pt'>Openning<br>
    기초</td>
  <td class=xl617107></td>
 </tr>
 <%
 ...
 <td height=37 class=xl77 width=285 style='height:27.75pt;width:214pt;border-bottom:2.0pt double windowtext;'><%=strBegin%><%= dt_detail.Rows[i]["prn_acnm"].ToString()%><%=strEnd%></td>
  <td height=37 class=xl77 style='height:27.75pt;border-top:none;border-bottom:2.0pt double windowtext;'><%=strBegin%><%= dt_detail.Rows[i]["prn_kacnm"].ToString()%><%=strEnd%></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=3 class=xl1747107>dated/현재<span style='mso-spacerun:yes'> 
