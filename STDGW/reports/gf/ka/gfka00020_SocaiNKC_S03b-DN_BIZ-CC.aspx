...
if (l_rpt_Option == "DRCR")
{
    ...
    SQL += " r1.tr_amt debit_tramt, 0 credit_tramt,  pl_cd||' - '||pl_nm pl_cd ";
    ...
    SQL += " 0 debit_tramt, R2.tr_amt credit_tramt,  pl_cd||' - '||pl_nm pl_cd ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1217 style='border-collapse:
 ...
 <tr class=xl33 height=21 style='height:15.75pt'>
  ...
  <td class=xl36 rowspan='2'>Bộ phận</td>
 </tr>
 <tr class=xl33 height=21 style='height:15.75pt'>
 ...
 <tr class=xl31 height=21 style='height:15.75pt'>
  ...
  <td class=xl62 style='border-top:.5pt solid windowtext;border-right:.5pt solid windowtext'>&nbsp;</td>
  <td class=xl62 style='border-top:.5pt solid windowtext;border-right:.5pt solid windowtext'>&nbsp;</td>
 </tr>
  <%
      //Response.Write(SQL);
