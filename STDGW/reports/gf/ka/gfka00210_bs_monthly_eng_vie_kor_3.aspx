...
<link rel=File-List href="bbbbb_files/filelist.xml">
<link rel=Edit-Time-Data href="bbbbb_files/editdata.mso">
<link rel=OLE-Object-Data href="bbbbb_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>PCVINA002</o:LastAuthor>
  <o:LastPrinted>2009-03-18T01:27:41Z</o:LastPrinted>
  <o:Created>2001-09-01T01:02:36Z</o:Created>
  <o:LastSaved>2009-10-05T08:56:55Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2259 style='border-collapse:
 collapse;table-layout:fixed;width:1699pt'>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl28><span style='mso-spacerun:yes'>     </span>(Unit:&nbsp;<%=l_scale%> &nbsp;VND)</td>
  <td class=xl28></td>
  <td class=xl32></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl28 style='mso-ignore:colspan'></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td colspan=2 class=xl55 style='border-right:1.0pt solid black'>Mục</td>
  <td colspan=2 class=xl55 style='border-right:.5pt solid black;border-left:
  none'>Item_Korean</td>
  <td class=xl35><%=l_lastYear %></td>
  <td class=xl36><%=l_lastMonth %></td>
  <td class=xl36><%=l_date_to %></td>
  <td class=xl36>variance</td>
  <td class=xl37>variance</td>
  <td class=xl38></td>
  <td></td>
 ...
 <%
     ...
     {  
         %>
  <td height=21 class=xl45 style='height:15.75pt'><%=strBegin %><%= dt.Rows[i][0].ToString()%><%=strEnd%></td>
  <td class=xl46></td>
  <td class=xl47><%=strBegin %><%= dt.Rows[i][1].ToString()%><%=strEnd%></td>
  <td class=xl46></td>
  <td class=xl47><%=strBegin %><%= dt.Rows[i][2].ToString()%><%=strEnd%></td>
  <td class=xl46></td>
  <td class=xl48 x:num><%=strBegin %><%= dt.Rows[i][6].ToString()%><%=strEnd%> </td>
  <td class=xl49 x:num><%=strBegin %><%= dt.Rows[i][7].ToString()%> <%=strEnd%> </td>
  <td class=xl49 x:num><%=strBegin %><%= dt.Rows[i][8].ToString()%> <%=strEnd%> </td>
  <td class=xl49 x:num><%=strBegin %><%= dt.Rows[i][9].ToString()%> <%=strEnd%> </td>
  <td class=xl50 align=right x:num><%=strBegin %><%= dt.Rows[i][10].ToString()%><%=strEnd%> </td>
  <td class=xl28></td>
  <td class=xl24></td>
  ...
  <td class=xl46><%=strBegin %><%= dt.Rows[i][0].ToString()%><%=strEnd%></td>
  <td class=xl47></td>
  <td class=xl46><%=strBegin %><%= dt.Rows[i][1].ToString()%><%=strEnd%></td>
  <td class=xl47></td>
  <td class=xl46><%=strBegin %><%= dt.Rows[i][2].ToString()%><%=strEnd%></td>
  <td class=xl48 x:num><span style='mso-spacerun:yes'>                 
  </span><%=strBegin %><%= dt.Rows[i][6].ToString()%> <%=strEnd%></td>
  <td class=xl49 x:num><span style='mso-spacerun:yes'> </span><%=strBegin %><%= dt.Rows[i][7].ToString()%><%=strEnd%>  </td>
  <td class=xl49 x:num><span style='mso-spacerun:yes'> </span><%=strBegin %><%= dt.Rows[i][8].ToString()%> <%=strEnd%> </td>
  <td class=xl49 x:num><span style='mso-spacerun:yes'> </span><%=strBegin %><%= dt.Rows[i][9].ToString()%> <%=strEnd%> </td>
  <td class=xl50 align=right x:num><%=strBegin %><%= dt.Rows[i][10].ToString()%><%=strEnd%> </td>
  <td class=xl28></td>
  <td class=xl24></td>
  <td colspan=4 class=xl28 style='mso-ignore:colspan'></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td colspan=8 class=xl52 style='mso-ignore:colspan'></td>
  <td class=xl53></td>
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 colspan=9 class=xl52 style='height:15.75pt;mso-ignore:colspan'></td>
  <td class=xl53></td>
  <td colspan=5 class=xl28 style='mso-ignore:colspan'></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
