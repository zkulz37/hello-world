...
SQL = " SELECT pk FROM tac_abacctcode  WHERE del_if = 0 AND leaf_yn = 'Y'  CONNECT BY pac_pk = PRIOR pk START WITH pk = " + l_account_pk;
	 ...
	 if (l_rpt_Option == "DRCR")
    {
        ...
        SQL += "TO_CHAR((TO_NUMBER ('" + p_open_bal_xls + "','9,999,999,999,999,999,990.99') + SUM ( NVL (debit_amt, 0) - NVL (credit_amt, 0)) OVER (ORDER BY tr_date,order_cond,voucherno_debit,voucherno_credit, pk,r_pk)),ac_GET_format ('ACBG0040')) AS closingbalance, ";
        ...
        SQL += "     ORDER BY tr_date,order_cond,voucherno_debit,voucherno_credit, PK,r_pk";
         ...
         {
             SQL = "  SELECT  TR_DATE_FMT,voucherno_debit,voucherno_credit,REMARK2,REMARK,ACC_CODE,debit_amt,credit_amt,";
             SQL += "TO_CHAR((TO_NUMBER ('" + p_open_bal_xls + "','9,999,999,999,999,999,990.99') + SUM ( NVL (debit_amt, 0) - NVL (credit_amt, 0)) OVER (ORDER BY tr_date, pk,r_pk)),ac_GET_format ('ACBG0040')) AS closingbalance, ";
             //SQL += " (0 + sum(nvl(debit_amt,0) - nvl(credit_amt,0)) OVER (ORDER BY tr_date, pk,r_pk)) AS closingbalance,";
             SQL += " pk, tr_date  ";
             SQL += " FROM (  SELECT TO_CHAR (h.tr_date, 'DD/MM/YYYY') TR_DATE_FMT, ";
             SQL += "       h.voucherno voucherno_debit, '' voucherno_credit, r1.remark2 REMARK2, ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1290 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  style='mso-spacerun:yes'> </span>Form number: S07a-DN</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl76 colspan=4 style='mso-ignore:colspan'>dated March 20, 2006 by Ministry) </td>
 </tr>
 <tr height=30 style='height:22.5pt'>
  <td colspan=10 height=30 class=xl82 style='height:22.5pt'>CASH BOOK DETAIL</td>
  <td class=xl26></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=10 height=26 class=xl28 style='height:19.5pt'>From date <%= p_dt_from %> to date <%= p_dt_to%></td>
  <td class=xl27></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  <td class=xl72>Account name:</td>
  <td class=xl32><%= p_acc_name %></td>
  <td colspan=4 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl83>Unit: <%= l_book_ccy%></td>
  <td class=xl24></td>
 </tr>
 <tr class=xl30 height=21 style='height:15.75pt'>
  <td height=21 class=xl33 style='height:15.75pt' >Date<span style='mso-spacerun:yes'> </span></td>
  <td class=xl49 style='border-left:none' >Voucher<span
  style='mso-spacerun:yes'> </span></td>
  ...
  width:188pt'>Local Description</td>
  ...
  width:46pt'>Account</td>
  <td colspan=3 class=xl84 style='border-right:.5pt solid black;border-left:
  none'>Amount</td>
  <td class=xl74>Note</td>
 </tr>
 <tr class=xl30 height=21 style='height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'>enterd</td>
  <td class=xl50 style='border-left:none'>date</td>
  <td class=xl36>Received</td>
  <td class=xl37>Paid</td>
  <td class=xl38 width=250 style='border-left:none;width:188pt'>&nbsp;</td>
  <td class=xl36>Received</td>
  <td class=xl36>Paid</td>
  <td class=xl36 >Balance<span
  style='mso-spacerun:yes'> </span></td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl40>&nbsp;</td>
  <td class=xl41>&nbsp;</td>
  <td class=xl42 width=250 style='width:188pt'>Opening Balance</td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl61 width=250 style='border-top:none;border-left:none;width:188pt'>Total Amount Incurred</td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl66 width=250 style='border-top:none;border-left:none;width:188pt'>Closing Balance</td>
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  <td colspan=9 height=21 class=xl80 style='height:15.75pt'>The book are…. pages
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  <td class=xl27></td>
  <td colspan=3 class=xl46>Date <%= l_date_to.Substring(6, 2) %>/<%= l_date_to.Substring(4, 2) %>/<%= l_date_to.Substring(0, 4) %></td>
  <td class=xl47></td>
 </tr>
<%
    SQL = "SELECT   " +
 ...
 <tr class=xl27 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl81 style='height:17.25pt'><%= v4 %></td>
  <td colspan=3 class=xl81><%= v5 %></td>
  <td colspan=3 class=xl81><%= v6 %></td>
  <td class=xl48></td>
 </tr>
 <tr class=xl27 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl79 style='height:17.25pt'><%= g4 %></td>
  <td colspan=3 class=xl79><%= g5 %></td>
  <td colspan=3 class=xl79><%= g6 %></td>
  <td class=xl47></td>
 </tr>
 ...
 <tr class=xl27 height=23 style='height:17.25pt'>
  ...
  <tr class=xl27 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl81 style='height:17.25pt'><%= n4 %></td>
  <td colspan=3 class=xl81><%= n5 %></td>
  <td colspan=3 class=xl81><%= n6 %></td>
  <td class=xl48></td>
 </tr>
