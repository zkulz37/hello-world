...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=5 height=21 class=xl35 style='height:15.75pt'><b><%=fr_dt %> 부터  <%=to_dt %>까지(Ngày <%=fr_dt %> đến <%=to_dt %>)</b></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td colspan="2" class=xl37>(<b>단위:</b> <%=l_Scale1%>  <%=l_ccy%>)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl41 width=61 style='width:46pt'>비고/thuyết minh</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl43><span
  style='mso-spacerun:yes'> </span>월 (<%=curr_date%>)<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl44 width=138 style='width:104pt'><span
  style='mso-spacerun:yes'> </span>월 (<%=last_Date %>)<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl45></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
