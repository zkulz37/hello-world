...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1480 style='border-collapse:
 ...
 <tr class=xl38 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl35 style='height:15.0pt'>주소: <%=l_cmp_add %></td>
  <td class=xl36></td>
 ...
 <tr height=26 style='height:19.5pt'>
  <td colspan=5 height=26 class=xl46 style='height:19.5pt'>대차대조표</td>
  <td class=xl30></td>
  
 </tr>
 <tr class=xl38 height=20 style='height:15.0pt'>
  <td colspan=5 height=20 class=xl48 style='height:15.0pt'>
  <%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%> 현재 </td>
  <td class=xl38></td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl27></td>
  <td class=xl50></td>
  <td class=xl51 x:str="(단위: VND)"><span
  style='mso-spacerun:yes'> </span>(단위: <%=l_ccy%>)<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl30></td>
 
 </tr>
 <tr class=xl38 height=53 style='mso-height-source:userset;height:39.75pt'>
  <td height=53 class=xl53 style='height:39.75pt'>자산</td>
  <td class=xl54 width=54 style='border-left:none;width:41pt'>코드</td>
  <td class=xl55 width=61 style='border-left:none;width:46pt'>비고</td>
  <td class=xl56 style='border-left:none'>기말</td>
  <td class=xl57 style='border-left:none'>기초</td>
...
%>
<tr class=xl38 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl102 style='height:19.5pt'>총자산(270 = 100 + 200)</td>
  <td class=xl103 style='border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
  <td class=xl104 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i][7].ToString() %><%=strEnd%></td>
  <td class=xl105 style="mso-number-format:'<%= p_xls_ccy_format %>';border-left:none" x:num><%=strBegin%><%= dt_detail.Rows[i][8].ToString() %><%=strEnd%></td>
  <td class=xl105 style="mso-number-format:'<%= p_xls_ccy_format %>';border-left:none" x:num><%=strBegin%><%= dt_detail.Rows[i][9].ToString() %><%=strEnd%></td>
  <td class=xl66></td>
...
%>
 ...
 <tr class=xl38 height=53 style='mso-height-source:userset;height:39.75pt'>
  <td height=53 class=xl53 style='height:39.75pt'>부채 및 자본</td>
  <td class=xl54 width=54 style='border-left:none;width:41pt'>코드</td>
  <td class=xl55 width=61 style='border-left:none;width:46pt'>비고</td>
  <td class=xl123 style='border-left:none' x:str="기말"
  x:fmla="=+D8"><span style='mso-spacerun:yes'> </span>기말<span style='mso-spacerun:yes'> </span></td>
  <td class=xl123 style='border-left:none' x:str="기초"
  x:fmla="=+E8"><span style='mso-spacerun:yes'> </span>기초<span style='mso-spacerun:yes'> </span></td>
...
%>
 <tr class=xl38 height=37 style='mso-height-source:userset;height:27.75pt'>
  <td height=37 class=xl102 style='height:27.75pt;border-top:none'>부채 및 자본총계
�(440 = 300 + 400)</td>
  <td class=xl103 style='border-top:none;border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
  <td class=xl104 style='border-top:none;border-left:none'><%=strBegin%><%= dt_detail.Rows[i][7].ToString() %><%=strEnd%></td>
  <td class=xl105 style="mso-number-format:'<%= p_xls_ccy_format %>';border-top:none;border-left:none" x:num><%=strBegin%><%= dt_detail.Rows[i][8].ToString() %><%=strEnd%></td>
  <td class=xl105 style="mso-number-format:'<%= p_xls_ccy_format %>';border-top:none;border-left:none" x:num><%=strBegin%><%= dt_detail.Rows[i][9].ToString() %><%=strEnd%></td>
  <td class=xl81></td>
...
%>
 ...
 <tr class=xl38 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl108 style='height:18.0pt'>부외자산 항목</td>
  <td class=xl81></td>
 ...
 <tr class=xl38 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl146 style='height:18.0pt'>항목</td>
  <td class=xl147>&nbsp;</td>
  <td class=xl148 style='border-left:none'>비고</td>
  <td class=xl149 style='border-left:none' x:str="기말"
  x:fmla="=+D65"><span style='mso-spacerun:yes'> </span>기말<span style='mso-spacerun:yes'> </span></td>
  <td class=xl150 style='border-left:none' x:str="기초"
  x:fmla="=+E65"><span style='mso-spacerun:yes'> </span>기초<span style='mso-spacerun:yes'> </span></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl188><span style='mso-spacerun:yes'> 
  </span><%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%> 현재</td>
  <td class=xl184></td>
 ...
 <%
  ...
  %>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl192 style='height:18.0pt'><%=l_colE_1%></td>
  <td class=xl39 colspan=2 style='mso-ignore:colspan'><%=l_colE_2%></td>
  <td colspan=2 class=xl193 ><%=l_colE_3%></td>
  <td class=xl194></td>
