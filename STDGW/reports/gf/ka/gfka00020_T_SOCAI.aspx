...
<%
	...
	SQL = " SELECT AC_CD,AC_LNM || '  (' || ac_nm ||')' ,DRCR_TYPE, to_char(to_date('" + l_date_from + "','YYYYMMDD'),'DD/MM/YYYY') frm_date, ";
 ...
 <tr class=xl24 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    ...
    style='height:15.0pt;width:93pt'>N&#7907;/DEBIT</td>
   </tr>
  </table>
  </span></td>
  <td class=xl32 x:autofilter="top" x:autofiltervalue="124518400%">Có/CREDIT</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
