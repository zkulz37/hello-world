...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl54>20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl55 style='height:19.5pt'>CASH FLOW STATEMENT</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 %>
 <tr class=xl43>
  <td class=xl61><%=tag_begin%><%= dt.Rows[i][0].ToString()%><%=tag_end%></td>
 ...
 <%
         ...
         %> 
 <tr class=xl43 style='mso-height-source:userset'>
  <td class=xl64 width=355><%=tag_begin%><%= dt.Rows[i][0].ToString()%><%=tag_end%></td>
  <td class=xl65><%=tag_begin%><%= dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl37 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%= dt.Rows[i][6].ToString()%><%=tag_end%></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl57>At dated<span style='mso-spacerun:yes'> 
  </span><%=to_dt %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'>Repairer by</td>
  <td colspan=2 class=xl58
 ...
 <tr class=xl53 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl59 x:str="(Sign, Fullname, Stamp)"><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl60 x:str="LAM VAN"><span
