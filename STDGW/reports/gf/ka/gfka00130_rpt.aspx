...
<%
	 ...
	 */
	 //string l_parameter = "'"+l_company_pk+"','"+l_date_from+"','"+l_status+"','"+l_form_type+"','"+l_rate1+"','"+l_rate2+"','"+l_rate3+"'";
	 DataTable dt_detail = ESysLib.TableReadOpenCursor("ac_sel_expense_inq", "'"+l_company_pk+"','"+l_date_from+"','"+l_status+"','"+l_form_type+"','"+l_rate1+"','"+l_rate2+"','"+l_rate3+"'");
     for (i = 0; i < dt_detail.Rows.Count; i++)
     {
            p_color = dt_detail.Rows[i][5].ToString();
            if (dt_detail.Rows[i][5].ToString() == "R")
            {
                p_font_type = "";
            }
            if (dt_detail.Rows[i][5].ToString() == "B")
            {
                p_font_type = "font-weight:700;";
            }
            if (dt_detail.Rows[i][5].ToString() == "I")
            {
                p_font_type = "font-style:italic;";
            } 
  %> 
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl39 style='height:15.0pt;border-top:none;background:#<%=p_color %>;<%=p_font_type %>' ></td>
  <td class=xl27 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>' ></td>
  <td class=xl28 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>'><%=dt_detail.Rows[i][1].ToString() %></td>
  ...
  <td class=xl31 style='border-top:none;border-left:none;background:#<%=p_color %>;<%=p_font_type %>;mso-number-format:"<%=p_xls_ccy_format %>";' x:num><%=dt_detail.Rows[i][8].ToString() %></td>
