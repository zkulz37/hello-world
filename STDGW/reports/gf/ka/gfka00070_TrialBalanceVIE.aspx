...
<%
    ...
    //Response.End();
    DataTable dt = ESysLib.TableReadOpenCursor("ACNT.SP_SEL_GRD_DTL_GENERAL_LEDGER6", l_parameter);
    l_parameter = "'" + l_compk + "','" + l_lang + "','" + l_date_fr + "','" + l_date_to + "','" + l_status + "','" + l_current + "','" + l_rate + "','" + l_level + "','" + l_possum + "','" + l_accd + "','" + l_check_sum + "','" + l_pacctype + "'";
    DataTable dtTotal = ESysLib.TableReadOpenCursor("acnt.SP_SEL_GRD_DTL_GENERAL_LEDGER6", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1250 style='border-collapse:
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=10 height=26 class=xl28 style='height:19.5pt'>Từ tháng <%=strdt_fr %>-> <%=strdt_to %></td>
 </tr>
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl34 width=245 style='height:15.0pt;width:184pt'><%=tag_begin%><%=dt.Rows[i][25]%><%=tag_end%></td>
