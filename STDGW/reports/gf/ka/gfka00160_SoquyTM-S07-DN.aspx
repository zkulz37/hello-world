...
SQL += "         DECODE (d.drcr_type,'D', TO_CHAR (d.tr_bookamt, ac_get_format ('ACBG0040')), 0) book_amt_debit, ";
SQL += "         DECODE (d.drcr_type,'C', TO_CHAR (d.tr_bookamt, ac_get_format ('ACBG0040')), 0) book_amt_credit, ";
SQL += "         TO_CHAR(TO_NUMBER (" + p_open_bal +") + SUM (  NVL (d.tr_bookamt, 0) * DECODE (drcr_type, 'D', 1, -1) * b.dc) OVER (ORDER BY h.tr_date, d.pk), ac_get_format ('ACBG0040')) AS closingbalance, ";
SQL += "         h.pk, h.tr_date ";
...
SQL = "select TO_CHAR (tr_date, 'DD/MM/YYYY'), " + 
        ...
        " remark2, remark, " +
        " TO_CHAR ( book_amt_debit, ac_get_format ('ACBG0040')) book_amt_debit, " +
        " TO_CHAR (book_amt_credit, ac_get_format ('ACBG0040')) book_amt_credit, " +
        " TO_CHAR(TO_NUMBER (" + p_open_bal + ") + SUM(book_amt_debit*dc - book_amt_credit*dc) OVER (ORDER BY  tr_date,order_cond, voucherno ,pk),ac_get_format ('ACBG0040')) AS closingbalance, " +
        "         pk, tr_date,order_cond " +
        " FROM          " +
        " (     SELECT    " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1247 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl73 colspan=2 width=220 style='mso-ignore:colspan;width:166pt'>M&#7851;u
  s&#7889; S07-DN</td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  B&#7897; Tài chính)<span style='mso-spacerun:yes'>  </span></td>
  <td class=xl38></td>
 </tr>
 <tr height=30 style='height:22.5pt'>
  <td colspan=9 height=30 class=xl76 style='height:22.5pt'>S&#7892; QU&#7928;
  TI&#7872;N M&#7862;T</td>
  <td class=xl39></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=9 height=26 class=xl77 style='height:19.5pt'>T&#7915;
  ngày&nbsp;&nbsp;<%= p_dt_from %>&nbsp;&#273;&#7871;n&nbsp;<%= p_dt_to%></td>
  <td class=xl40></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  <td height=20 class=xl41 style='height:15.0pt'>Tài kho&#7843;n:</td>
  <td class=xl41 x:num><%= p_acc_code%></td>
  <td class=xl55>Tên TK:</td>
  <td class=xl42><%= p_acc_name %></td>
  <td colspan=2 class=xl37 style='mso-ignore:colspan'></td>
  <td class=xl38></td>
  <td colspan=2 class=xl78>&#272;&#417;n v&#7883; tính:<%= l_book_ccy%></td>
  <td class=xl37></td>
 </tr>
 <tr class=xl45 height=21 style='height:15.75pt'>
  <td height=21 class=xl43 style='height:15.75pt' x:str="Ngày tháng ">Ngày
  tháng<span style='mso-spacerun:yes'> </span></td>
  <td class=xl43 style='border-left:none' x:str="Ngày ">Ngày<span
  style='mso-spacerun:yes'> </span></td>
  ...
  width:177pt'>Di&#7877;n gi&#7843;i</td>
  <td class=xl72 width=236 style='border-left:none;width:177pt'>Description</td>
  <td colspan=3 class=xl83>S&#7889; ti&#7873;n</td>
  <td rowspan=2 class=xl44>Ghi Chú</td>
 </tr>
 <tr class=xl45 height=21 style='height:15.75pt'>
  <td height=21 class=xl46 style='height:15.75pt'>ghi s&#7893;</td>
  <td class=xl46 style='border-left:none'>ch&#7913;ng t&#7915;</td>
  <td class=xl47>Thu</td>
  <td class=xl48>Chi</td>
  <td class=xl27 width=236 style='width:177pt'>&nbsp;</td>
  <td class=xl49>THU</td>
  <td class=xl49>CHI</td>
  <td class=xl50 style='border-right:.5pt solid windowtext;' x:str="T&#7890;N ">T&#7890;N<span
  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr class=xl45 height=21 style='height:15.75pt'>
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  ...
  <td class=xl26>&nbsp;</td>
  <td class=xl25>&nbsp;</td>
  <td class=xl27 width=236 style='width:177pt'>S&#7888; D&#431; &#272;&#7846;U
  K&#7922;</td>
  <td class=xl27 width=236 style='width:177pt'>&nbsp;</td>
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  ...
  <td class=xl65 width=236 style='border-top:.5pt solid windowtext;border-left:none;width:177pt'>T&#7893;ng
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  ...
  <td class=xl69 width=236 style='border-top:.5pt solid windowtext;border-left:none;width:177pt'>S&#7888;
  D&#431; CU&#7888;I K&#7922;</td>
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  <td colspan=8 height=21 class=xl86 style='height:15.75pt'>S&#7893; có…. Trang
 ...
 <tr class=xl40 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl87>Ngày …. Tháng .. N&#259;m</td>
  <td class=xl30></td>
 </tr>
 <%
    SQL = "SELECT   " +
 ...
 <tr class=xl40 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl31 style='height:17.25pt'><%= v1 %></td>
  <td class=xl31><%= v2 %></td>
  <td class=xl31></td>
  <td colspan=3 class=xl88><%= v3 %></td>
  <td class=xl32></td>
 </tr>
 <tr class=xl40 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl54 style='height:17.25pt'><%=g1 %></td>
  <td class=xl54><%=g2 %></td>
  <td class=xl54></td>
 ...
 <tr class=xl40 height=23 style='height:17.25pt'>
  ...
  <tr class=xl40 height=23 style='height:17.25pt'>
  <td colspan=4 height=23 class=xl31 style='height:17.25pt'><%= n1 %></td>
  <td class=xl31><%= n2 %></td>
  <td class=xl31></td>
  <td colspan=3 class=xl88><%= n3 %></td>
  <td class=xl32></td>
 </tr>
