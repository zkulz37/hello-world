...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse: collapse;table-layout:fixed;width:561pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'>Quater <%=quater %> of <%=curr_date %> (Quý <%=quater %> Năm <%=curr_date %>)</td>
 </tr>
  <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <td rowspan=3 height=42 class=xl54 style='border-bottom:.5pt solid black;
  ...
  <td rowspan=3 class=xl54 height=160  style='border-bottom:.5pt solid black'>Chỉ tiêu(KOR)</td>
  ...
  none' >Quater/Quý <%=quater %></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 rowspan=2 style='height:15.75pt' >Year/Năm <%=curr_date %></td>
  <td class=xl37 rowspan=2 >Year/Năm <%=last_Date %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
