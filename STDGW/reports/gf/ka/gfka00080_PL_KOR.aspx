...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1560 style='border-collapse:
 ...
 <tr height=25 style='height:18.75pt'>
  ...
  <td class=xl25 width=355 style='width:266pt'><%=l_cmp_name%></td>
  <td class=xl30 width=62 style='width:47pt'></td>
  <td class=xl30 width=71 style='width:53pt'></td>
  <td class=xl31 width=138 style='width:104pt'></td>
  <td class=xl32 width=138 style='width:104pt'>Form: B 02 - DN</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl29></td>
  <td class=xl33>&#272;&#7883;a ch&#7881;:&nbsp;<%=l_cmp_add %></td>
  <td class=xl30></td>
  <td colspan=3 class=xl34
  x:str="(Ban hành theo Quy&#7871;t &#273;&#7883;nh s&#7889; 15/2006/Q&#272;-BTC ngày ">(Ban
  hành theo Quy&#7871;t &#273;&#7883;nh s&#7889; 15/2006/Q&#272;-BTC ngày<span
 ...
 <tr height=26 style='height:19.5pt'>
  ...
  <td class=xl29></td>
  <td colspan=5 class=xl38>INCOME STATEMENT</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl29></td>
  <td colspan=5 class=xl40>For the year ended as of <%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 <tr class=xl50 height=45 style='mso-height-source:userset;height:33.75pt'>
  ...
  style='mso-spacerun:yes'> </span></td>
  <td class=xl50></td>
  <td class=xl48 width=355 style='width:266pt'>Items</td>
  <td class=xl48 width=62 style='border-left:none;width:47pt'>Code</td>
  <td class=xl48 width=71 style='border-left:none;width:53pt'>Notes</td>
  <td class=xl51 width=138 style='border-left:none;width:104pt' x:str="N&#259;m nay"><span
  style='mso-spacerun:yes'> </span>N&#259;m nay<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl51 width=138 style='border-left:none;width:104pt'
 ...
 <tr class=xl50 height=19 style='height:14.25pt'>
  ...
  <td class=xl50></td>
  <td class=xl55 width=355 style='border-top:none;width:266pt' x:num>1</td>
  <td class=xl55 width=62 style='border-top:none;border-left:none;width:47pt'
  x:num>2</td>
  <td class=xl55 width=71 style='border-top:none;border-left:none;width:53pt'
  x:num>3</td>
  <td class=xl56 style='border-top:none;border-left:none' x:num>4</td>
  <td class=xl56 style='border-top:none;border-left:none' x:num>5</td>
 </tr>
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl61 style='height:19.5pt'><%=strBegin%><%= dt_detail.Rows[i][0].ToString() %><%=strEnd%></td>
  ...
  <td class=xl29></td>
  <td class=xl61><%=strBegin%><%= dt_detail.Rows[i][1].ToString() %><%=strEnd%></td>
  <td class=xl62 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i][3].ToString() %><%=strEnd%></td>
  <td class=xl63 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i][4].ToString() %><%=strEnd%></td>
  <td class=xl64 style='border-left:none'x:num><%=strBegin%><%= dt_detail.Rows[i][5].ToString() %><%=strEnd%></td>
  <td class=xl64 style='border-left:none'x:num><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
...
%>
  ...
  <td class=xl50></td>
  <td class=xl76><%=strBegin%><%= dt_detail.Rows[i][1].ToString() %><%=strEnd%></td>
  <td class=xl77 style='border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][3].ToString() %><%=strEnd%></td>
  <td class=xl77 style='border-left:none'><%=strBegin%><%= dt_detail.Rows[i][4].ToString() %><%=strEnd%></td>
  <td class=xl79 style='border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][5].ToString() %><%=strEnd%></td>
  <td class=xl79 style='border-left:none' x:num><%=strBegin%><%= dt_detail.Rows[i][6].ToString() %><%=strEnd%></td>
 </tr>
 <%
    } 
 %>
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl82 align=right x:num="0"><span style='mso-spacerun:yes'>  
  </span></td>
  <td class=xl82 align=right x:num="0"><span style='mso-spacerun:yes'>  
  </span></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl37></td>
  <td colspan=2 class=xl81 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl84>At dated<span style='mso-spacerun:yes'> 
  </span><%=l_date.Substring(6, 2)%>/<%=l_date.Substring(4, 2)%>/<%=l_date.Substring(0, 4)%></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
  ...
  style='mso-spacerun:yes'>  </span></td>
  <td class=xl29></td>
  <td class=xl85>Prepared by</td>
  <td class=xl50 colspan=2 style='mso-ignore:colspan'
  x:str="Chief Accountant                                ">Chief
  Accountant<span style='mso-spacerun:yes'>    </span><span style='display:
 ...
 <tr height=20 style='height:15.0pt'>
  ...
  style='mso-spacerun:yes'> </span></td>
  <td class=xl29></td>
  <td class=xl40>(Sign, Fullname)</td>
  <td colspan=2 class=xl40>(Sign, Fullname)</td>
  <td colspan=2 class=xl88 x:str="(Sign, Fullname, Stamp)"><span
 ...
 <tr class=xl91 height=21 style='height:15.75pt'>
  ...
  <td class=xl92></td>
  <td colspan=2 class=xl89></td>
  <td colspan=2 class=xl93 x:str=""><span
  style='mso-spacerun:yes'> </span><span
  style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
