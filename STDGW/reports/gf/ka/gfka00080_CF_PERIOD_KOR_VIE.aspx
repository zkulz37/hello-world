...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=5 class=xl65>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
 ...
 <td class=xl50><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  ...
  <%      break;
      case "40":
  %>
  <td class=xl52 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_40_1%><%=tag_end%></td>
  <td class=xl52 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=l_amt_40_2%><%=tag_end%></td>
   <%      break;
      case "50":
  %>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  style='mso-spacerun:yes'></span></td>
  <td colspan=2 class=xl39><%=l_col2_3%><span style='mso-spacerun:yes'></span></td>
