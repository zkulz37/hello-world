...
<%
    ...
    string l_report_mm = "";
    string l_report_yy = "";
    string SQL9 = " SELECT TO_CHAR(TO_DATE('" + l_date_from + "','YYYYMMDD'),'DD/MM/YYYY') DT_FR,  TO_CHAR(TO_DATE('" + l_date_to + "','YYYYMMDD'),'DD/MM/YYYY') DT_TO, ";
    SQL9 = SQL9 + "ac_get_format('ACBG0040'), TO_CHAR(LAST_DAY(TO_DATE('" + l_date_to + "','YYYYMMDD')),'DD')  RP_DD,";
    SQL9 = SQL9 + " TO_CHAR(LAST_DAY(TO_DATE('" + l_date_to + "','YYYYMMDD')),'MM')  RP_MM, ";
    SQL9 = SQL9 + " TO_CHAR(LAST_DAY(TO_DATE('" + l_date_to + "','YYYYMMDD')),'YYYY')  RP_YY, ";
    SQL9 = SQL9 + " ac_get_FORMAT ('ACRP0010') ";
    SQL9 = SQL9 + " FROM DUAL ";

    DataTable dt9 = ESysLib.TableReadOpen(SQL9);
    if (dt9.Rows.Count > 0)
    {
        //l_date_fr2 = dt.Rows[0][0].ToString();
        //l_date_to2 = dt.Rows[0][1].ToString();

        l_report_dd = dt9.Rows[0][3].ToString();
        l_report_mm = dt9.Rows[0][4].ToString();
        l_report_yy = dt9.Rows[0][5].ToString();
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1222 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='height:15.75pt'>
  ...
  tháng</td>
  <td class=xl34 style='border-top:none;border-left:none'>Có</td>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  <td class=xl42 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl44  style="mso-number-format:'<%= p_xls_ccy_format %>'" x:num><span style='mso-spacerun:yes'> </span><%= p_open_bal_cr_xls%></td>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  <td class=xl40 style="mso-number-format:'<%= p_xls_ccy_format %>'"; x:num><span style='mso-spacerun:yes'> </span><%= dt_detail.Rows[i][6].ToString() %></td>
...
{ %>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  <td class=xl50 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl51 style="mso-number-format:'<%= p_xls_ccy_format %>'"; x:num><span style='mso-spacerun:yes'> </span><%= p_credit_xls %></td>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  <td class=xl43 width=292 style='border-top:none;border-left:none;width:219pt'>&nbsp;</td>
  <td class=xl47 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl44 style="mso-number-format:'<%= p_xls_ccy_format %>'"; x:num><span style='mso-spacerun:yes'> </span><%= p_close_bal_cr_xls %></td>
  <td class=xl45 style='border-top:none;border-left:none'>&nbsp;</td>
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr class=xl25 height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl55>Ngày <%=l_report_dd%> tháng <%=l_report_mm %> năm <%=l_report_yy %></td>
  <td colspan=2 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <%
    SQL = "SELECT   " +
