...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl52 style='height:19.5pt'>CASH FLOW STATEMENT</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl41>
  ...
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';" x:num><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
 </tr>
 ...
 <tr class=xl50 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl60 x:str="(Sign, Fullname, Stamp)"><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=2 class=xl61 x:str="LAM VAN"><span
