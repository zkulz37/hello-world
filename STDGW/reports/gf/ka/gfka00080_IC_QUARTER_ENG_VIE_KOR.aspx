...
<table x:str border=0 cellpadding=0 cellspacing=0 width=769 style='border-collapse:
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan="3" class=xl32 width=138 style='width:104pt'>M&#7851;u s&#7889;: B03 - DN</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=6 class=xl65>Issued with Decision No. 15/2006/QĐ-BTC(Ban hành theo Quyết định số 15/2006/QĐ-BTC)<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl36></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=6 class=xl65>dated March 20, 2006 by Ministry of Finance(Ngày 20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính)</td>
  <td class=xl36></td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl66 style='height:19.5pt'>INCOME STATEMENT / BÁO CÁO KẾT QUẢ HOẠT ĐỘNG KINH DANH</td>
  <td class=xl26></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Quater <%=quater %> Year <%=curr_date %>(Quý <%=quater %> Năm <%=curr_date %>)</td>
  
  <td class=xl26></td>
 </tr>
 <tr>
    <td colspan=5 height=21 class=xl35 style='height:15.75pt'>Giai đoạn từ ngày <%=fr_dt %> đến <%=to_dt %>(Giai đoạn từ ngày <%=fr_dt %> đến <%=to_dt %>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl38 style='height:15.75pt'></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
  <td class=xl30></td>
  <td colspan="3" class=xl37>(&#272;&#417;n v&#7883; tính: <%=l_Scale1%>  <%=l_ccy%>)</td>
  <td class=xl26></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  style='mso-spacerun:yes'></span></td>
  <td colspan=3 class=xl39><%=l_col2_1%><span style='mso-spacerun:yes'></span></td>
  <td colspan=2 class=xl72 ><span
 ...
 <tr class=xl62 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=2 class=xl30>Sign, Fullname</td>
  <td colspan=5 class=xl73 ><span
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl50><b><%=name2%></b></td>
  <td colspan=4 class=xl45><%=name3%></td>
