...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl51> Ban hành theo Quyết định số 15/2006/QĐ-BTC  </td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=4 class=xl51>Ngày 20 tháng 03 năm 2006 của Bộ trường Bộ Tài chính</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=7 height=26 class=xl52 style='height:19.5pt'> BÁO CÁO LƯU CHUYỂN TIỀN TỆ</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl34 style='height:15.75pt'>(Theo phương pháp trực tiếp)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'>Ngày <%=fr_dt %> đến
  <%=to_dt %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 rowspan=2 style='height:15.75pt' >Tháng (<%=curr_date%>)</td>
  <td class=xl37 rowspan=2 >Tháng (<%=last_Date%>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'><%=l_col1_3%></td>
  <td colspan=2 class=xl59><%=l_col2_3%></td>
  <td colspan=3 class=xl34><%=l_col3_3%></td>
 </tr>
 <tr class=xl50 height=24 style='mso-height-source:userset;height:18.0pt'>
  <td height=24 class=xl33 style='height:18.0pt'>Ký, họ tên</td>
  <td colspan=2 class=xl33>Ký, họ tên</td>
