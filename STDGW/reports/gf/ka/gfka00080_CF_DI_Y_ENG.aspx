...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td colspan=7 height=21 class=xl53 style='height:15.75pt'>End the of year <%=curr_date %></td>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl37 rowspan=2 style='height:15.75pt' >Year <%=curr_date%></td>
  <td class=xl37 rowspan=2 >Year <%=last_Date%></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
