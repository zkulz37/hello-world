...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=4 class=xl51>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
 ...
 <tr class=xl41 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl63 x:str><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl63><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
 ...
 <tr class=xl41>
  ...
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl44 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
 </tr> 
 </tr>
  <%
     }
 ...
 <tr class=xl41>
  ...
  <td class=xl55><%=tag_begin%><%=dt.Rows[i][3].ToString()%><%=tag_end%></td>
  <td class=xl55><%=tag_begin%><%=dt.Rows[i][4].ToString()%><%=tag_end%></td>
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl65 style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl35 style='height:15.75pt'><b><%=l_col1_1%></b></td>
  <td colspan=2 class=xl59><%=l_col2_1%><span
  style='mso-spacerun:yes'></span></td>
