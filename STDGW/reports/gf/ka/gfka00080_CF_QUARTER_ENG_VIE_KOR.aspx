...
<table x:str border=0 cellpadding=0 cellspacing=0 width=746 style='border-collapse:
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=6 class=xl52>(Issued with Decision No. 15/2006/QĐ-BTC</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl24 style='height:15.75pt'></td>
  <td colspan=6 class=xl52>dated March 20, 2006 by Ministry of Finance)</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=5 height=26 class=xl53 style='height:19.5pt'>CASH FLOW /BÁO CÁO LƯU CHUYỂN TIỀN TỆ</td>
 </tr>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td class=xl30></td>
  <td colspan=3 class=xl37>(Unit: <%=l_Scale1 %> <%=l_ccy%>)</td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl36 style='height:15.75pt'></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl39 style='height:15.75pt' x:num>1</td>
   <td height=21 class=xl39 style='height:15.75pt' x:num>2</td>
   <td height=21 class=xl39 style='height:15.75pt' x:num>3</td>
  <td class=xl40 x:num>4</td>
  <td class=xl41 width=61 style='width:46pt' x:num>5</td>
  <td class=xl41 width=138 style='width:104pt' x:num>6</td>
  <td class=xl41 width=138 style='width:104pt' x:num>7</td>
 </tr>
 <%
    string tag_begin="";
    string tag_end="";
 ...
 %>
 <tr class=xl42>
  <td class=xl43><%=tag_begin%><%= dt.Rows[i][0].ToString()%><%=tag_end%></td>
  <td class=xl43><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl43><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl44 x:str><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl44 x:num><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl45 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl45 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 </tr>
 <%
     }
     else
 ...
 %>
 <tr class=xl42>
  <td class=xl63><%=tag_begin%><%= dt.Rows[i][0].ToString()%><%=tag_end%></td>
  <td class=xl63><%=tag_begin%><%= dt.Rows[i][1].ToString()%><%=tag_end%></td>
  <td class=xl63><%=tag_begin%><%= dt.Rows[i][2].ToString()%><%=tag_end%></td>
  <td class=xl46 x:str><%=tag_begin%><%=dt.Rows[i][7].ToString()%><%=tag_end%></td>
  <td class=xl46 x:num><%=tag_begin%><%=dt.Rows[i][6].ToString()%><%=tag_end%></td>
  <td class=xl47 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][9].ToString()%><%=tag_end%></td>
  <td class=xl47 x:num style="mso-number-format:'<%= p_xls_ccy_format %>';"><%=tag_begin%><%=dt.Rows[i][10].ToString()%><%=tag_end%></td>
 </tr>
 <%
     }
 }
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl59>At dated<span style='mso-spacerun:yes'> 
  </span><%=to_dt_e %></td>
 </tr>
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl34 style='height:15.75pt'><%=l_col1_1%>/<%=l_col1_3%></td>
  <td colspan=3 class=xl60><%=l_col2_1%>/<%=l_col2_3%><span
  style='mso-spacerun:yes'></span></td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td colspan=3 class=xl62><span
  style='mso-spacerun:yes'> </span><%=name2%><span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=3 class=xl63><span
