...
SQL = SQL + "    AND ((TRIM('" + l_Seq +"')  IS NULL) OR (H.pk = TRIM('" + l_Seq +"') ))  ";
    ...
    SQL
        = " SELECT  a.pk,   " +
            "        TO_CHAR (a.tr_date, SF_GET_FORMAT ('ACAB0300')) TRDATE, a.voucherno, d.ac_cd,  " +
            ...
            "        DECODE (b.drcr_type,'D', TO_CHAR (b.tr_bookamt, sf_get_format ('ACBG0040')),'') tr_bookD,  " +
            "        DECODE (b.drcr_type,'C', TO_CHAR (b.tr_bookamt, sf_get_format ('ACBG0040')),'') tr_bookC,  " +
            "        b.remark, b.remark2,  " +
            "        SF_A_GET_AGTRITEM(b.pk), TO_CHAR (a.tr_date, 'YYYYMMDD') TRDATE1,  " +
            "        SF_A_GET_AGTRITEM(b.pk), a.tr_enclose ENCLOSE  " +
