...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1056 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td colspan=3 class=xl31>20 tháng 03 n&#259;m 2006 c&#7911;a B&#7897;
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=8 height=26 class=xl60 style='height:19.5pt'>Từ ngày <%=p_dt_from %>
  Đến ngày <%=p_dt_to%></td>
  <td class=xl24></td>
 </tr>
 <tr class=xl29 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=2 height=26 class=xl27 style='height:19.5pt'>hi&#7879;u tài
  kho&#7843;n: :</td>
 ...
 <tr class=xl27 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <td rowspan=2 class=xl55 style='border-bottom:.5pt solid black'>Tỷ Giá</td>
  <td rowspan=2 class=xl53 width=175 style='border-bottom:.5pt solid black;
  width:131pt'>Số Dư Đầu Kỳ</td>
  <td colspan=2 class=xl58 width=246 style='border-left:none;width:184pt'>Giao Dịch</td>
  <td colspan=2 class=xl57 style='border-right:.5pt solid black;border-left:
  none'>Ghi Sổ</td>
  <td rowspan=2 class=xl55 style='border-bottom:.5pt solid black'>Số Dư Cuối Kỳ</td>
  <td class=xl27></td>
 </tr>
 <tr class=xl27 height=21 style='height:15.75pt'>
  <td height=21 class=xl48 width=123 style='height:15.75pt;width:92pt'>Nợ</td>
  <td class=xl48 width=123 style='width:92pt'>Có</td>
  <td class=xl34>Nợ</td>
  <td class=xl34>Có</td>
  <td class=xl27></td>
 </tr>
