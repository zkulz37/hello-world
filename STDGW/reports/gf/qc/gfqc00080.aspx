...
<%
    ...
    string l_pl_pk          =Request["p_tac_abplcenter_pk"];
    string l_partner_pk     =Request["p_tco_buspartner_pk"];
    string l_tco_company_pk = Request["p_company"];
    string l_dtfr = Request["p_dtfr"];
    ...
    " FROM TCO_COMPANY WHERE PK = '" + l_tco_company_pk + "' ";
      ...
      string l_parameter = "'" + l_contr_no + "','" + l_pl_pk + "','" + l_partner_pk + "','" + l_tco_company_pk + "','" + l_dtfr + "','" + l_dtto+ "'";
      DataTable dt_AP = ESysLib.TableReadOpenCursor("acnt.sp_sel_gfqc00030_1_ap", l_parameter);
