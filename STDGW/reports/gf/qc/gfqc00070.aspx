...
<%
    ...
    string l_dtfr = Request["p_dtfrom"];
    ...
    " FROM TCO_COMPANY WHERE PK = '" + l_tco_company_pk + "' ";
      ...
      string l_parameter = "'" + l_tco_company_pk + "','" + l_partner_pk + "','" + l_pl_pk + "','" + l_contr_no + "','" + l_dtfr + "','" + l_dtto + "'";
      DataTable dt = ESysLib.TableReadOpenCursor("ACNT.sp_sel_gfqc00030_1_ar", l_parameter);
      if (dt.Rows.Count == 0)
      {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1161 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl25 style='border-left:none'><%=dt.Rows[i][2].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[i][3].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[i][4].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[i][5].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[i][6].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][7].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][8].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][9].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][10].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][11].ToString()%></td>
  <td class=xl26 style='border-top:none;border-left:none' x:num><%=dt.Rows[i][12].ToString()%></td>
 </tr>
 <%
    }
  %>
