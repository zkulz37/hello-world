...
if(rstotal.Rows.Count > 0)
{
	...
	int i;
SQL
	= " select hr.F_BO_DAU(b.bedefi_nm)bedefi_nm, hr.F_BO_DAU(b.bedefi_bank_nm)bedefi_bank_nm, hr.F_BO_DAU(b.branch)branch, replace(b.account_no,' ','')account_no , c.tco_buspartner_pk, nvl(c.pay_famt, 0) amt, hr.F_BO_DAU(c.partner_id)partner_id, c.pay_ccy , hr.F_BO_DAU(c.remark2)remark2   " + 
        " from tac_bfbeneficiary b,( select a.tco_buspartner_pk, a.pay_ccy, c.partner_id, " +
         " sum(a.pay_famt) pay_famt , max(h.remark2) remark2   " +
         " from tfn_eppaytr a, comm.tco_buspartner c, tfn_eppaytrh h " +
          "  where a.del_if = 0 " +                                                        
           " and a.tac_bfdepomt_pk in ( " + iBankPk + " ) " +
            " and a.tco_buspartner_pk = c.pk " +
          "  and a.pay_type in ('03', '04', '21', '22')  " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1487 style='border-collapse: collapse;table-layout:fixed;width:1117pt'>
 <col class=xl24 width=37 style='mso-width-source:userset;mso-width-alt:1353; width:28pt'>
 <col class=xl24 width=252 style='mso-width-source:userset;mso-width-alt:9216; width:189pt'>
 
 <col class=xl24 width=173 style='mso-width-source:userset;mso-width-alt:6326; width:130pt'>
 
 <col class=xl24 width=250 style='mso-width-source:userset;mso-width-alt:9142; width:188pt'>
 <col class=xl24 width=128 style='mso-width-source:userset;mso-width-alt:4681; width:96pt'>
 <col class=xl24 width=165 style='mso-width-source:userset;mso-width-alt:6034; width:124pt'>
 <col class=xl24 width=184 style='mso-width-source:userset;mso-width-alt:6729; width:138pt'>
 ...
 <tr class=xl37189 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td  rowspan=3 class=xl77189 style='border-right:.5pt solid black;  border-bottom:1.0pt solid black'>Account Number</td>
  <td  rowspan=3 class=xl77189 style='border-right:.5pt solid black;  border-bottom:1.0pt solid black'>Bank</td>
  <td rowspan=3 class=xl63189 style='border-bottom:1.0pt solid black'>Branch</td>
  <td rowspan=3 class=xl66189 style='border-bottom:1.0pt solid black'>Amount (transfer)</td>
 ...
 <tr class=xl38189 height=26 style='height:19.5pt'>
  ...
  <td  class=xl72189><u style='visibility:hidden;mso-ignore:visibility'>&nbsp;</u></td>
  <td  class=xl73189>&nbsp;</td>
  <td class=xl41189>&nbsp;</td>
  <% if(oCCy=="VND") { %>
  <td class=xl48189 style="border-top:1.0pt solid windowtext;border-bottom:1.0pt solid windowtext;font-size:13.5pt;font-weight:700;" x:num><%= oTotal_Pay %></td>
  <% } else { %>
  <td class=xl47189 style="border-top:1.0pt solid windowtext;border-bottom:1.0pt solid windowtext;font-size:13.5pt;font-weight:700;" x:num><%= oTotal_Pay %></td>
  <% } %>
  ...
  string l_acc_no = "";
	if( rs2.Rows.Count > 0 )
	{
		for(i = 0; i < rs2.Rows.Count; i++)
		{
			l_acc_no = rs2.Rows[i]["account_no"].ToString();
			l_acc_no = l_acc_no.Replace("-","");
			l_acc_no = l_acc_no.Replace(".","");
			l_acc_no = l_acc_no.Replace("'","");
...
%>
 <tr class=xl30189 height=75 style='mso-height-source:userset;height:56.25pt'>
  <td height=75 class=xl55189 width=37 style='height:56.25pt;width:28pt; font-weight:700; border-top:1.0pt solid black;font-size:12.5pt;'><%= i + 1 %></td>
  <td class=xl55189 width=328 style='width:246pt;border-right:1pt solid black;font-size:12.5pt;'><%= rs2.Rows[i][0] %></td>
  <td  class=xl55189 style='border-right:1pt solid black;border-top:1.0pt solid black;font-size:13.0pt;'><%= l_acc_no%></td>
  <td  class=xl55189 width=327 style='border-right:1pt solid black;
  border-left:1pt solid black; border-top:1.0pt solid black; width:246pt;font-size:13.0pt;'><%= rs2.Rows[i][1] %></td>
  <td class=xl55189 width=163 style='width:122pt;font-size:13.0pt;border-bottom:1pt solid black'><%= rs2.Rows[i][2] %></td>
  <% if(oCCy == "VND") { %>
  <td class=xl55189 width=165 x:num style='width:124pt;text-align:right;border-top:1.0pt solid black;border-bottom:1.0pt solid black; font-size:13.0pt;font-weight:700;' ><%= rs2.Rows[i][5] %></td>
  <% } else { %>
  <td class=xl55189 width=165 x:num style='width:124pt;text-align:right;border-bottom:1pt solid black;border-top:1.0pt solid black;border-bottom:1.0pt solid black;font-size:13.0pt;font-weight:700;' ><%= rs2.Rows[i][5] %></td>
  <% } %>  
  <td class=xl55189 width=64 style='width:48pt; border-right:1pt solid black;font-size:10.0pt;font-weight:700;'><%=rs2.Rows[i]["remark2"]%></td>
...
%>
<tr class=xl30189 height=75 style='mso-height-source:userset;height:56.25pt'>
  <td height=75 class=xl44189 width=37 style='height:56.25pt;width:28pt; border-top:1pt solid black; font-weight:700;'><%= i + 1 %></td>
  <td class=xl45189 width=328 style='width:246pt; border-right:1pt solid black;border-top:1pt solid black; font-weight:700;font-size:12.5pt;'><%= rs2.Rows[i][0] %></td>
  <td  class=xl59189 style='border-right:1pt solid black;border-left:
  none;border-top:1pt solid black;font-size:13.0pt;'><%= l_acc_no%></td>
  <td  class=xl61189 width=327 style='border-right:.5pt solid black;
  border-left:none; border-top:1pt solid black; width:246pt; font-weight:700;font-size:13.0pt;'><%= rs2.Rows[i][1] %></td>
  <td class=xl46189 width=163 style='width:122pt; border-top:1pt solid black;border-bottom:1pt solid black; font-weight:700;font-size:13.0pt;'><%= rs2.Rows[i][2] %></td>
  <% if(oCCy == "VND") { %>
  <td class=xl55189 width=165 x:num style='width:124pt;text-align:right;border-bottom:1pt solid black; border-top:1pt solid black;font-size:13.0pt;font-weight:700;' ><%= rs2.Rows[i][5] %></td>
  <% } else { %>
  <td class=xl55189 width=165 x:num style='width:124pt;text-align:right;border-bottom:1pt solid black; border-top:1pt solid black;font-size:13.0pt;font-weight:700;' ><%= rs2.Rows[i][5] %></td>
  <% } %>  
  <td class=xl55189 width=64 style='width:48pt; border-top:1pt solid black;font-size:10.0pt;font-weight:700;border-right:1pt solid black'><%=rs2.Rows[i]["remark2"]%></td>
 ...
 <tr height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td >&nbsp;</td>
  <td class=xl71>£ <font class="font6">Beneficiary</font></td>
  <td >&nbsp;</td>
  <td class=xl71>£ <font class="font6">Application</font></td>
  <td class=xl25189></td>
  <td class=xl25189></td>
  <td class=xl25189></td>
  <td class=xl25189></td>
 ...
 <tr height=19 style='mso-height-source:userset;height:26.25pt'>
  <td height=19 class=xl25189 style='height:14.25pt'></td>
