...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1067 style='border-collapse:
 ...
 <tr class=xl24 height=32 style='mso-height-source:userset;height:24.0pt'>
  <td colspan=10 height=32 class=xl32 style='height:24.0pt'>DANH SÁCH TÀI SẢN CỐ ĐỊNH</td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  <td height=22 class=xl27 style='height:16.5pt'>STT</td>
  <td class=xl27 style='border-left:none'>Trạng thái</td>
  <td class=xl27 style='border-left:none'>Mã tài sản</td>
  <td class=xl27 style='border-left:none'>Tên tài sản</td>
  <td class=xl27 style='border-left:none'>Loại</td>
  <td class=xl27 style='border-left:none'>Ngày sử dụng</td>
  <td class=xl27 style='border-left:none'>Nguyên giá</td>
  <td class=xl27 style='border-left:none'>Trị giá khấu hao</td>
  <td class=xl27 style='border-left:none'>Tri giá khấu hao lũy kế</td>
  <td class=xl27 style='border-left:none'>Trị giá còn lại</td>
 </tr>
<%
t1=0;
t2=0;
