...
public partial class gfgf00040_02_VIE_8 : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "gfgf00040_02_VIE_8.xls";
        string TempFile = "../../../system/temp/gfgf00040_02_VIE_8_" + Session["User_ID"].ToString() + ".xls";
	...
	//   
			...
			dtDetail = ESysLib.TableReadOpenCursor("ac_sel_gfgf00040_vie_08_new",para);
			...
			{					
				...
				for (int l_row1 =0 ; l_row1 < dtDetail.Rows.Count ; l_row1++)
				{
					...
					exSheet_1.Cells[l_row1+l_first1, 1].Value = row_num;//l_row1+1;
					exSheet_1.Cells[l_row1+l_first1, 2].Value = dtDetail.Rows[l_row1]["fa_cd"].ToString();
					exSheet_1.Cells[l_row1+l_first1, 3].Value = dtDetail.Rows[l_row1]["inv_no"].ToString();
					exSheet_1.Cells[l_row1+l_first1, 4].Value = dtDetail.Rows[l_row1]["inv_date"].ToString();
					exSheet_1.Cells[l_row1+l_first1, 5].Value = dtDetail.Rows[l_row1]["fa_nm"].ToString();
					if(dtDetail.Rows[l_row1]["qty"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 6].Value = double.Parse(dtDetail.Rows[l_row1]["qty"].ToString());
					}
					//exSheet_1.Cells[l_row1+l_first1, 5].Value = dtDetail.Rows[l_row1]["FA_LNM"].ToString();
					
					if(dtDetail.Rows[l_row1]["months"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 7].Value = double.Parse(dtDetail.Rows[l_row1]["months"].ToString());
					}
					if(dtDetail.Rows[l_row1]["end_org_amt"].ToString()!="")  
					{
						exSheet_1.Cells[l_row1+l_first1, 8].Value = double.Parse(dtDetail.Rows[l_row1]["end_org_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["depr_month_amt"].ToString()!="")//khau hao hang  thang'
					{
						exSheet_1.Cells[l_row1+l_first1, 9].Value = double.Parse(dtDetail.Rows[l_row1]["depr_month_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["depr_period_amt"].ToString()!="")//khau hao den' thang' nay
					{
						exSheet_1.Cells[l_row1+l_first1, 10].Value = double.Parse(dtDetail.Rows[l_row1]["depr_period_amt"].ToString());
					}
					
					if(dtDetail.Rows[l_row1]["end_acc_amt"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 11].Value = double.Parse(dtDetail.Rows[l_row1]["end_acc_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["end_remain_amt"].ToString()!="") 
					{
						exSheet_1.Cells[l_row1+l_first1, 12].Value = double.Parse(dtDetail.Rows[l_row1]["end_remain_amt"].ToString());
					}							
					
					//exSheet_1.Cells[l_row1+l_first1, 13].Value = dtDetail.Rows[l_row1]["org_nm"].ToString();
					//exSheet_1.Cells[l_row1+l_first1, 14].Value = dtDetail.Rows[l_row1]["fa_kind_nm"].ToString();
					//exSheet_1.Cells[l_row1+l_first1, 15].Value = dtDetail.Rows[l_row1]["depr_yn"].ToString();
					...
					if(dtDetail.Rows[l_row1]["ord"].ToString()=="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()=="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="" )
					{
						...
						exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 13].Interior.Color = colorValueFrmHex;//set color grand total
					...
					if(dtDetail.Rows[l_row1]["ord"].ToString()=="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="")
					{
						...
						exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 13].Interior.Color = colorValueFrmHex1;//set color  total
						exSheet_1.Cells[l_row1+l_first1,1].Value="";//ko xuat hien row num
						exSheet_1.Cells[l_row1+l_first1,3].Value="Total:";
						exSheet_1.Cells[l_row1+l_first1,11].Value="";
					}
					if(dtDetail.Rows[l_row1]["ord"].ToString()!="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()!="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="" )//&& dtDetail.Rows[l_row1]["org_nm"].ToString()!=""
					{
						string l_Color3="0X99CCFF";
						Color colorValueFrmHex3 = ColorTranslator.FromHtml(l_Color3);
						exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 13].Interior.Color = colorValueFrmHex3;//set color sub total
						exSheet_1.Cells[l_row1+l_first1,1].Value="";//ko xuat hien row num
						//exSheet_1.Cells[l_row1+l_first1,4].Value="";//xu ly de ko the hien lai kind code.(muon the hien cau truc' giong  voi tree)
						exSheet_1.Cells[l_row1+l_first1,5].Value=dtDetail.Rows[l_row1]["org_nm"].ToString();//xuat' cap' phong ban
						...
						for (int l_grp_nm =0 ; l_grp_nm < dtKindGroupName.Rows.Count ; l_grp_nm++)
							{
								...
								if(dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()==l_code_grp_kind && dtDetail.Rows[l_row1]["org_nm"].ToString()=="")
								{
									exSheet_1.Cells[l_row1+l_first1,4].Value=l_name_grp_kind;
									exSheet_1.Cells[l_row1+l_first1,3].Value="";
								}
							}
					}
