...
public partial class gfgf00040_02_VIE_NEW : System.Web.UI.Page 
{
	...
	//   
			...
			dtDetail = ESysLib.TableReadOpenCursor("ac_sel_gfgf00040_02_vie_new",para);
			...
			{					
				...
				for (int l_row1 =0 ; l_row1 < dtDetail.Rows.Count ; l_row1++)
				{
					...
					{
						exSheet_1.Cells[l_row1+l_first1, 13].Value = double.Parse(dtDetail.Rows[l_row1]["acc_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["remain_amt"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 14].Value = double.Parse(dtDetail.Rows[l_row1]["remain_amt"].ToString());
					}
					...
					{
						exSheet_1.Cells[l_row1+l_first1, 17].Value = double.Parse(dtDetail.Rows[l_row1]["dis_dec_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["dis_dec_acc_amt"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 18].Value = double.Parse(dtDetail.Rows[l_row1]["dis_dec_acc_amt"].ToString());
					}
					if(dtDetail.Rows[l_row1]["depr_peirod"].ToString()!="")
					{
						exSheet_1.Cells[l_row1+l_first1, 19].Value = double.Parse(dtDetail.Rows[l_row1]["depr_peirod"].ToString());
					}
					...
					{
						exSheet_1.Cells[l_row1+l_first1, 22].Value = double.Parse(dtDetail.Rows[l_row1]["end_remain"].ToString());
					}							
					exSheet_1.Cells[l_row1+l_first1, 23].Value = (dtDetail.Rows[l_row1]["depr_acc"].ToString());
					...
					exSheet_1.Cells[l_row1+l_first1, 25].Value = dtDetail.Rows[l_row1]["exp_acc"].ToString();
