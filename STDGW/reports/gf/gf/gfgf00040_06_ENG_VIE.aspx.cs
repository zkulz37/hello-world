...
public partial class gfgf00040_06_ENG_VIE : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {

          ESysLib.SetUser("acnt");
        string TemplateFile = "gfgf00040_06_ENG_VIE.xls";
        string TempFile = "../../../system/temp/gfgf00040_06_ENG_VIE_" + Session["User_ID"].ToString() + ".xls";
					...
					if(dtDetail.Rows.Count > 0)
					{
						...
						*/
						...
						for (int l_row1 =0 ; l_row1 < dtDetail.Rows.Count ; l_row1++)
						{
							...
							exSheet_1.Cells[l_row1+l_first1, 26].Value = dtDetail.Rows[l_row1]["model"].ToString();
							exSheet_1.Cells[l_row1+l_first1, 27].Value = dtDetail.Rows[l_row1]["voucher_no"].ToString();
							exSheet_1.Cells[l_row1+l_first1, 28].Value = dtDetail.Rows[l_row1]["supplier"].ToString();
							exSheet_1.Cells[l_row1+l_first1, 29].Value = dtDetail.Rows[l_row1]["pl_cd"].ToString();
							exSheet_1.Cells[l_row1+l_first1, 30].Value = dtDetail.Rows[l_row1]["pl_nm"].ToString();
							...
							if(dtDetail.Rows[l_row1]["ord"].ToString()=="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()=="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="")
							{
								...
								exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 30].Interior.Color = colorValueFrmHex;//set color grand total
							...
							if(dtDetail.Rows[l_row1]["ord"].ToString()=="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="")
							{
								...
								exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 30].Interior.Color = colorValueFrmHex1;//set color  total
								exSheet_1.Cells[l_row1+l_first1,1].Value="";//ko xuat hien row num
							...
							if(dtDetail.Rows[l_row1]["ord"].ToString()!="" && dtDetail.Rows[l_row1]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row1]["fa_kind_cd"].ToString()!="" && dtDetail.Rows[l_row1]["fa_cd"].ToString()=="")
							{
								...
								exSheet_1.Cells[l_row1+l_first1, 1,l_row1+l_first1, 30].Interior.Color = colorValueFrmHex3;//set color sub total
								exSheet_1.Cells[l_row1+l_first1,1].Value="";//ko xuat hien row num
		...
		{	
			...
			{					
					...
					if(dtDetail.Rows.Count > 0)
					{
						...
						exSheet_1.Range[1,1,12,30].Copy(exSheet.Range[1,1,12,30], XlPasteType.xlPasteAll);//cope sheet
						
						exSheet.Cells[5, 1].Value = dtDetail.Rows[0]["month_from_to"].ToString();
						/*
						...
						*/
						...
						for (int l_row =0 ; l_row < dtDetail.Rows.Count ; l_row++)
						{
							...
							{
								exSheet.Cells[l_row+l_first, 5].Value = double.Parse(dtDetail.Rows[l_row]["qty"].ToString());
							}
							...
							if(dtDetail.Rows[l_row]["begin_acc_amt"].ToString()!="")
							{
								exSheet.Cells[l_row+l_first, 13].Value = double.Parse(dtDetail.Rows[l_row]["begin_acc_amt"].ToString());
							}
							...
							exSheet.Cells[l_row+l_first, 26].Value = dtDetail.Rows[l_row]["model"].ToString();
							exSheet.Cells[l_row+l_first, 27].Value = dtDetail.Rows[l_row]["voucher_no"].ToString();
							exSheet.Cells[l_row+l_first, 28].Value = dtDetail.Rows[l_row]["supplier"].ToString();
							exSheet.Cells[l_row+l_first, 29].Value = dtDetail.Rows[l_row]["pl_cd"].ToString();
							exSheet.Cells[l_row+l_first, 30].Value = dtDetail.Rows[l_row]["pl_nm"].ToString();
							//set color row Total and Sub Total and grand total.
							if(dtDetail.Rows[l_row]["ord"].ToString()=="" && dtDetail.Rows[l_row]["depr_yn"].ToString()=="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color="0XC0C0C0";
								Color colorValueFrmHex = ColorTranslator.FromHtml(l_Color);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 30].Interior.Color = colorValueFrmHex;//set color grand total
							...
							if(dtDetail.Rows[l_row]["ord"].ToString()=="" && dtDetail.Rows[l_row]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color1="0XD8D8D8";
								Color colorValueFrmHex1 = ColorTranslator.FromHtml(l_Color1);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 30].Interior.Color = colorValueFrmHex1;//set color  total
								exSheet.Cells[l_row+l_first,1].Value="";//ko xuat hien row num
							...
							if(dtDetail.Rows[l_row]["ord"].ToString()!="" && dtDetail.Rows[l_row]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()!="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color3="0X99CCFF";
								Color colorValueFrmHex3 = ColorTranslator.FromHtml(l_Color3);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 30].Interior.Color = colorValueFrmHex3;//set color sub total
								exSheet.Cells[l_row+l_first,1].Value="";//ko xuat hien row num
							...
							exSheet.Cells[l_row+l_first, 1,l_row+l_first, 30].RowHeight = 26;
							//end set color row Total and Sub Total and grand total.
						}
						exSheet.Cells[4, 1,4, 30].RowHeight = 36;
						exSheet.Cells[7, 1,7, 30].RowHeight = 21;
						exSheet.Cells[8, 1,8, 30].RowHeight = 30;
						...
						// //Split
						exSheet.SplitColumn = 3;
						exSheet.SplitRow = 2;
						// //Freeze
						exSheet.FreezePanes = true;
					}
