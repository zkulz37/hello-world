...
public partial class gfgf00040_06_VIE_TOOL : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {

        
        string TemplateFile = "gfgf00040_06_VIE_TOOL.xls";
        string TempFile = "../../../system/temp/gfgf00040_06_VIE_TOOL_" + Session["User_ID"].ToString() + ".xls";
					...
					if(dtDetail.Rows.Count > 0)
					{
						...
						*/
						...
						for (int l_row1 =0 ; l_row1 < dtDetail.Rows.Count-1; l_row1++)
						{
							...
							{
								exSheet_1.Cells[l_row1+l_first1, 4].Value = double.Parse(dtDetail.Rows[l_row1]["fa_qty"].ToString());
							}
					...
					if(dtDetail.Rows.Count > 0)
					{
						...
						*/
						...
						for (int l_row =0 ; l_row < dtDetail.Rows.Count-1; l_row++)//-1 ko muon lay dong total cuoi'
						{
							...
							{
								exSheet.Cells[l_row+l_first, 4].Value = double.Parse(dtDetail.Rows[l_row]["fa_qty"].ToString());
							}
							exSheet.Cells[l_row+l_first, 5].Value = dtDetail.Rows[l_row]["FA_LNM"].ToString();
							...
							if(dtDetail.Rows[l_row]["ord"].ToString()=="" && dtDetail.Rows[l_row]["depr_yn"].ToString()=="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color="0XC0C0C0";
								Color colorValueFrmHex = ColorTranslator.FromHtml(l_Color);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 28].Interior.Color = colorValueFrmHex;//set color grand total
							...
							if(dtDetail.Rows[l_row]["ord"].ToString()=="" && dtDetail.Rows[l_row]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()=="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color1="0XD8D8D8";
								Color colorValueFrmHex1 = ColorTranslator.FromHtml(l_Color1);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 28].Interior.Color = colorValueFrmHex1;//set color  total
								exSheet.Cells[l_row+l_first,1].Value="";//ko xuat hien row num
							...
							if(dtDetail.Rows[l_row]["ord"].ToString()!="" && dtDetail.Rows[l_row]["depr_yn"].ToString()!="" && dtDetail.Rows[l_row]["fa_kind_cd"].ToString()!="" && dtDetail.Rows[l_row]["fa_cd"].ToString()=="")
							{
								string l_Color3="0X99CCFF";
								Color colorValueFrmHex3 = ColorTranslator.FromHtml(l_Color3);
								exSheet.Cells[l_row+l_first, 1,l_row+l_first, 28].Interior.Color = colorValueFrmHex3;//set color sub total
								exSheet.Cells[l_row+l_first,1].Value="";//ko xuat hien row num
