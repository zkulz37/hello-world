...
public partial class gfgf00040_02_VIE_NEW_PL : System.Web.UI.Page 
{
    protected void Page_Load(object sender, EventArgs e)
    {

        ESysLib.SetUser(Session["APP_DBUSER"].ToString());  
        string TemplateFile = "gfgf00040_02_VIE_NEW_PL.xls";
        string TempFile = "../../../system/temp/gfgf00040_02_VIE_NEW_PL_" + Session["User_ID"].ToString() + ".xls";
	...
	//   
			...
			{					
				...
				for (int l_row1 =0 ; l_row1 < dtDetail.Rows.Count ; l_row1++)
				{
					...
					exSheet_1.Cells[l_row1+l_first1, 27].Value = dtDetail.Rows[l_row1]["pl_cd"].ToString();
					exSheet_1.Cells[l_row1+l_first1, 28].Value = dtDetail.Rows[l_row1]["pl_nm"].ToString();
				}
