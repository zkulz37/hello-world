...
<%
    ...
    string nam = "";
       ...
       thang = p_month.Substring(4, 2);
       nam = p_month.Substring(0, 4);
 %>
...
<link rel=File-List href="BCTHTSco_No_thang_files/filelist.xml">
<link rel=Edit-Time-Data href="BCTHTSco_No_thang_files/editdata.mso">
<link rel=OLE-Object-Data href="BCTHTSco_No_thang_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2010-06-01T02:07:26Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <tr height=27 style='mso-height-source:userset;height:20.25pt'>
  <td colspan=3 height=27 class=xl81 width=508 style='height:20.25pt;
  width:381pt'>Nơi gửi: <%=l_compa%></td>
  <td colspan=2 class=xl80 width=227 style='width:170pt'>Phụ lục III - Biểu số
  3.4-NHNN</td>
 </tr>
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=3 height=25 class=xl81 width=508 style='height:18.75pt;
  width:381pt'></td>
 ...
 <tr height=25 style='height:18.75pt'>
  <td colspan=5 height=25 class=xl82 style='height:18.75pt'>BÁO CÁO TÌNH HÌNH
  TÀI SẢN CÓ - TÀI SẢN NỢ</td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td colspan=5 height=21 class=xl83 style='height:15.75pt'>Tháng <%=thang%> năm <%=nam%> </td>
 </tr>
 <tr height=21 style='height:15.75pt'>
 ...
 %>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl71 width=284 style='height:15.75pt;width:213pt'><%=tag_begin%><%=dt.Rows[i][0]%><%=tag_end%></td>
 ...
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl79 width=284 style='height:15.75pt;border-top:none;
  width:213pt'>&nbsp;</td>
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  x:str=", ngày  tháng  năm  ">Hà Nội, ngày  tháng  năm
  <span style='mso-spacerun:yes'> </span></td>
 </tr>
 <tr height=21 style='height:15.75pt'>
  <td height=21 class=xl67 width=284 style='height:15.75pt;width:213pt'>LẬP
  BIỂU</td>
  <td colspan=2 class=xl75 width=224 style='width:168pt'>KIỂM SOÁT</td>
  <td colspan=2 class=xl75 width=227 style='width:170pt'>THỦ TRƯỞNG ĐƠN VỊ</td>
 </tr>
 ...
 <tr height=125 style='height:93.75pt'>
  <td height=125 class=xl77 style='height:93.75pt'>1. Đối với báo cáo tháng:
  chậm nhất vào ngày 15 của tháng tiếp<span style='mso-spacerun:yes'>         
  </span>theo ngay sau tháng báo cáo, đơn vị chỉ báo cáo một số chỉ tiêu tại
  biểu<span style='mso-spacerun:yes'>                 </span>số 3.4-NHNN như sau:</td>
  <td colspan=4 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl78 style='height:18.75pt'>- Tài sản có (I): mục (2);</td>
  <td colspan=4 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=25 style='height:18.75pt'>
  <td height=25 class=xl78 style='height:18.75pt'
  x:str="- Tài sản nợ (II): mục (1), (2), (4). ">- Tài sản nợ (II): mục (1),
  (2), (4).<span style='mso-spacerun:yes'> </span></td>
  <td colspan=4 style='mso-ignore:colspan'></td>
 </tr>
