...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1272 style='border-collapse:
 ...
 <tr height=36 style='height:27.0pt'>
  ...
  <td class=xl25 colspan=5 width=417 style='mso-ignore:colspan;width:313pt'>HR
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl29 style='border-left:none'>Num4 Value</td>
  <td class=xl29 style='border-left:none'>Num5 Value</td>
  ...
  <td class=xl29 style='border-left:none'>Cha4 Name</td>
  <td class=xl29 style='border-left:none'>Cha5 Name</td>
 ...
 <tr height=23 style='userset;height:17.25pt'> 
  ...
  <td class=xl27 width=82 style='border-top:none;border-left:none;width:62pt'><%=dt_master.Rows[j][12].ToString() %></td>
  <td class=xl27 width=88 style='border-top:none;border-left:none;width:66pt'><%=dt_master.Rows[j][13].ToString() %></td>
  <td class=xl27 width=83 style='border-top:none;border-left:none;width:62pt'><%=dt_master.Rows[j][14].ToString() %></td>
  <td class=xl27 width=88 style='border-top:none;border-left:none;width:66pt'><%=dt_master.Rows[j][15].ToString() %></td>
  <td class=xl27 style='text-align:center;vertical-align:middle;'><%=dt_master.Rows[j][16].ToString() %></td>
