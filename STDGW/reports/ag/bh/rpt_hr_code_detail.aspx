...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1606 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl29 width=89 style='text-align:center;width:67pt' x:num><%=dt_detail.Rows[j][12].ToString() %></td>
  <td class=xl29 width=89 style='text-align:center;width:67pt' x:num><%=dt_detail.Rows[j][13].ToString() %></td>
  <td class=xl29 width=89 style='text-align:center;width:67pt' x:num><%=dt_detail.Rows[j][14].ToString() %></td>
  <td class=xl29 width=89 style='text-align:center;width:67pt' x:num><%=dt_detail.Rows[j][15].ToString() %></td>
