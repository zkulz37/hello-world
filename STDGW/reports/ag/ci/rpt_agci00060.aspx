...
<%
    ...
    SQL = "select   i.pk, g.grp_nm, i.item_code, i.item_name, i.weight, i.lot_weight,i.uom , decode(i.use_yn,'Y','Yes','No') use_yn,a.AC_CD, a.AC_NM,exp.AC_CD exp_cd, exp.AC_NM exp_nm  " +
        " from tlg_it_itemgrp g, tlg_it_item i ,TAC_ABACCTCODE a,TAC_ABACCTCODE exp " +
        " where i.tlg_it_itemgrp_pk = g.pk  " +
        " and i.del_if = 0  " +
        " and a.DEL_IF(+) =0 and a.PK(+) = i.TAC_ABACCTCODE_PK  " +
		" and exp.DEL_IF(+) =0 and exp.PK(+) = i.tac_abacctcode_pk_expense  " +
        " and (('" + l_item_code + "' is null) or (i.item_code like  '%'||upper('" + l_item_code + "') || '%') or (i.item_name like  '%'||upper('" + l_item_code + "') || '%'))  " +
        " and g.pk in ( " +
        " SELECT pk FROM tlg_it_itemgrp WHERE del_if = 0 CONNECT BY PRIOR pk = p_pk " +
        " START WITH p_pk like DECODE('" + l_item_group + "','','%','" + l_item_group + "') " +
        " OR i.tlg_it_itemgrp_pk LIKE '" + l_item_group + "' ) " +
...
<body link="blue" vlink="purple" class="xl24">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="1084" style='border-collapse: collapse;
        table-layout: fixed; width: 814pt'>
        ...
        <col class="xl24" width="188" style='mso-width-source: userset; mso-width-alt: 6875;
            width: 141pt'>
        <col class="xl24" width="107" span="2" style='mso-width-source: userset; mso-width-alt: 3913;
            width: 80pt'>
        ...
        <tr height="65" style='mso-height-source: userset; height: 48.75pt'>
            <td colspan="12" height="65" class="xl32" width="1020" style='height: 48.75pt; width: 766pt'>
                Item Inquiry
            </td>
        ...
        <tr height="17" style='height: 12.75pt'>
            <td height="17" colspan="10" class="xl25" style='height: 12.75pt'>
        ...
        <tr height="20" style='mso-height-source: userset; height: 15.0pt'>
			...
			<td class=xl27>Expense Account Code</td>
			<td class=xl27>Expense Account Code</td>
            <td class="xl24">
            </td>
        </tr>
        ...
        <tr height="28" style='mso-height-source: userset; height: 21.0pt'>
            <td height="28" class="xl28" style='height: 21.0pt' x:num>
                <%= i + 1 %>
            </td>
            <td class="xl30">
                <%= dt1.Rows[i]["grp_nm"] %>
            ...
            <td class="xl31" width="188" style='width: 141pt'>
            ...
            <td class="xl30"><%= dt1.Rows[i]["AC_NM"]%></td>
			 <td class="xl30"><%= dt1.Rows[i]["exp_cd"]%></td>
            <td class="xl30"><%= dt1.Rows[i]["exp_nm"]%></td>
            <td class="xl24">
            </td>
        </tr>
        <%} %>
        ...
        <tr height="0" style='display: none'>
            ...
            <td width="188" style='width: 141pt'>
            </td>
