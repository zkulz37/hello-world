...
<%
   string l_company;
	...
	string SQL = " select partner_id, partner_name, partner_lname, partner_fname,addr1,phone_no,fax_no,web_site,tax_code from tco_buspartner where del_if =0 and tco_company_pk = '"+l_company+"'";
