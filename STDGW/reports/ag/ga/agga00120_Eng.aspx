...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1297 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  <td colspan=3 height=21 class=xl38 style='height:15.75pt'>Tax code: <%=l_taxcode %></td>
  <td class=xl24></td>
  <td class=xl25></td>
  <td class=xl28></td>
  <td colspan=3 class=xl36></td>
 ...
 <tr height=30 style='height:22.5pt'>
  <td colspan=9 height=30 class=xl37 style='height:22.5pt'>LIST OF EXPENSES</td>
 </tr>
 ...
 <tr class=xl29 height=21 style='height:15.75pt'>
  <td height=21 class=xl44 width=74 style='height:15.75pt;width:56pt'>Month</td>
  <td class=xl45 style='border-left:none'>Account Code</td>
  <td class=xl45 style='border-left:none'>Account Name</td>
  <td class=xl45 style='border-left:none'>Cost Center</td>
  <td class=xl44 width=156 style='border-left:none;width:117pt'>Amount</td>
  <td class=xl44 width=81 style='border-left:none;width:61pt'>Ratio(%)</td>
  <td class=xl45 style='border-left:none' x:str="Amount ">Amount<span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl45 style='border-left:none'>Quantity</td>
  <td class=xl45 style='border-left:none'>Times</td>
 </tr>
 <%
