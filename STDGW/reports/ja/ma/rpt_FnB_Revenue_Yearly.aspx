...
<%
   string  p_year = Request["p_year"];
	DataTable  dt = ESysLib.TableReadOpenCursor("crm.sp_rpt_fnb_revenue_yearly",p_year);
	string l_print_date="";
...
<link rel=File-List href="rpt_FnB_Revenue_Yearly_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_FnB_Revenue_Yearly_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_FnB_Revenue_Yearly_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2011-06-15T12:34:05Z</o:LastPrinted>
  <o:Created>2011-06-15T04:01:43Z</o:Created>
  <o:LastSaved>2011-06-15T12:36:45Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2366 style='border-collapse:
 collapse;table-layout:fixed;width:1792pt'>
 <col width=110 style='mso-width-source:userset;mso-width-alt:2816;width:58pt'>
 <col width=77 style='mso-width-source:userset;mso-width-alt:4022;width:83pt'>
 ...
 <tr height=89 style='mso-height-source:userset;height:66.75pt'>
  <td colspan=4 height=89 width=295 style='height:66.75pt;width:223pt'
  align=left valign=top><!--[if gte vml 1]><v:shapetype id="_x0000_t75"
   ...
   <v:imagedata src="rpt_FnB_Revenue_Yearly_files/image001.jpg" o:title="AMCO"/>
  ...
  src="rpt_FnB_Revenue_Yearly_files/image002.jpg" v:shapes="_x0000_s1025"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=4 height=89 class=xl31 width=295 style='height:66.75pt;
    width:223pt'></td>
   </tr>
  </table>
  </span></td>
  <td colspan=32 class=xl32 width=1728 style='width:1312pt'>FnB Revenue Yearly</td>
  <td colspan=2 class=xl31 width=118 style='width:89pt'></td>
  ...
  align=left valign=top><!--[if gte vml 1]><v:shape id="_x0000_s1026" type="#_x0000_t75"
   ...
   <v:imagedata src="rpt_FnB_Revenue_Yearly_files/image003.png" o:title="Songgia"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
   </x:ClientData>
  ...
  src="rpt_FnB_Revenue_Yearly_files/image004.jpg" v:shapes="_x0000_s1026"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td colspan=2 height=89 class=xl31 width=150 style='height:66.75pt;
    width:112pt'></td>
   </tr>
  </table>
  </span></td>
 ...
 <tr height=34 style='mso-height-source:userset;height:25.5pt'>
  <td rowspan=2 height=54 class=xl37 style='border-bottom:.5pt solid black;
  height:40.5pt'>Material</td>
  <td rowspan=2 class=xl37 style='border-bottom:.5pt solid black'>Point</td>
 ...
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl27><span style='mso-spacerun:yes'> </span>Guest</td>
  <td class=xl27>Avg</td>
  <td class=xl27>Amt</td>
  <td class=xl27><span style='mso-spacerun:yes'> </span>Guest</td>
  <td class=xl27>Avg</td>
...
%>
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl29 style='height:12.75pt' x:str><%=l_begin_bold%><%=dt.Rows[i][0].ToString()%><%=l_end_bold%></td>
  <td class=xl30><%=l_begin_bold%><%=dt.Rows[i][1].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][20].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][23].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][26].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][29].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][32].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 x:num><%=l_begin_bold%><%=dt.Rows[i][35].ToString()%><%=l_end_bold%></td>
  ...
  <td class=xl28 align=right x:num><%=l_begin_bold%><%=dt.Rows[i][40].ToString()%><%=l_end_bold%></td>
 </tr>
 <%}%>
