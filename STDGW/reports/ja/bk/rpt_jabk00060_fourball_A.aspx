...
<%
    ...
    string l_parameter="",l_tournament_name="",l_ranktype_name="",l_print_date="",l_parameter_gross="";
     ...
     DataTable dt = ESysLib.TableReadOpenCursor("CRM.sp_rpt_jabk00060_four_ball_a", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<link rel=File-List href="rpt_jabk00060_fourball_A_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_jabk00060_fourball_A_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_jabk00060_fourball_A_files/oledata.mso">
<!--[if !mso]>
<style>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1022 style='border-collapse:
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  height:73.5pt;width:80pt' align=left valign=top><!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="rpt_jabk00060_fourball_A_files/image001.jpg" o:title="huyndai_amco"/>
  ...
  src="rpt_jabk00060_fourball_A_files/image002.jpg" v:shapes="_x0000_s1031"></span><![endif]><span
  ...
  <td width=30 style='width:23pt' align=left valign=top><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="rpt_jabk00060_fourball_A_files/image003.png" o:title="image001"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
   </x:ClientData>
