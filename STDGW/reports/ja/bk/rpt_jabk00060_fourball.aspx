...
<%
    ...
    string l_parameter="",l_tournament_name="",l_ranktype_name="",l_print_date="",l_parameter_gross="";
     ...
     DataTable dt = ESysLib.TableReadOpenCursor("CRM.sp_rpt_jabk00060_four_ball", l_parameter);
    if (dt.Rows.Count == 0)
    {
    ...
    string SQL2 = "select decode('" + l_rank_type+ "','10','HANDICAP DIVISION','20','CALLAWAY DIVISION','30','BEST GROSS','40','NEAREST PIN','50','LONGEST DRIVE',140,'SYSTEM 36','110','Four Ball') from dual";
...
<link rel=File-List href="rpt_jabk00060_fourball_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_jabk00060_fourball_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_jabk00060_fourball_files/oledata.mso">
<!--[if !mso]>
<style>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1022 style='border-collapse:
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  height:73.5pt;width:80pt' align=left valign=top><!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="rpt_jabk00060_fourball_files/image001.jpg" o:title="huyndai_amco"/>
  ...
  src="rpt_jabk00060_fourball_files/image002.jpg" v:shapes="_x0000_s1031"></span><![endif]><span
  ...
  <td width=30 style='width:23pt' align=left valign=top><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="rpt_jabk00060_fourball_files/image003.png" o:title="image001"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
   </x:ClientData>
 ...
 <%
     ...
     %>
 <tr height=17 style='height:12.75pt'>
  <td colspan=2 height=17 class=xl32 style='height:12.75pt'>Best Gross:</td>
  <td class=xl31 colspan=1 x:str><%=best_gross_name%></td>
  <td class=xl31 x:num><%=best_gross_value%></td>
