...
<%
    ...
    string l_parameter="",l_tournament_name="",l_ranktype_name="",l_print_date="",l_parameter_gross="";
     ...
     DataTable dt = ESysLib.TableReadOpenCursor("CRM.rpt_jabk00060_stableford_bogy", l_parameter);
    if (dt.Rows.Count == 0)
    {
    ...
    string SQL2 = "select decode('" + l_rank_type+ "','10','HANDICAP DIVISION','20','CALLAWAY DIVISION','30','BEST GROSS','40','NEAREST PIN','50','LONGEST DRIVE','90','Stable Ford(Net Bogie)',140,'SYSTEM 36') from dual";
...
<link rel=File-List href="jabk0060_HCDP_Result_Bogie_Net_Par_files/filelist.xml">
<link rel=Edit-Time-Data href="jabk0060_HCDP_Result_Bogie_Net_Par_files/editdata.mso">
<link rel=OLE-Object-Data href="jabk0060_HCDP_Result_Bogie_Net_Par_files/oledata.mso">
<!--[if !mso]>
<style>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1059 style='border-collapse:
 ...
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  ...
  align=left valign=top><!--[if gte vml 1]><v:shapetype id="_x0000_t75"
   ...
   z-index:2'>
   <v:imagedata src="jabk0060_HCDP_Result_Bogie_Net_Par_files/image001.jpg" o:title="huyndai_amco"/>
  ...
  src="jabk0060_HCDP_Result_Bogie_Net_Par_files/image001.jpg" v:shapes="_x0000_s1026"></span><![endif]><span
  ...
  align=left valign=top><!--[if gte vml 1]><v:shape id="_x0000_s1025" type="#_x0000_t75"
   ...
   <v:imagedata src="jabk0060_HCDP_Result_Bogie_Net_Par_files/image002.png" o:title="image001"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
   </x:ClientData>
  ...
  src="jabk0060_HCDP_Result_Bogie_Net_Par_files/image003.jpg" v:shapes="_x0000_s1025"></span><![endif]><span
  style='mso-ignore:vglayout2'>
  <table cellpadding=0 cellspacing=0>
   <tr>
