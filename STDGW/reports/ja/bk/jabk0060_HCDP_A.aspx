...
<%
    ...
    DataTable dt = ESysLib.TableReadOpenCursor("crm.sp_sel_jabk00060_hcdp_a", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<link rel=File-List href="jabk0060_HCDP_A_files/filelist.xml">
<link rel=Edit-Time-Data href="jabk0060_HCDP_A_files/editdata.mso">
<link rel=OLE-Object-Data href="jabk0060_HCDP_A_files/oledata.mso">
<!--[if !mso]>
<style>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=982 style='border-collapse:
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  height:73.5pt;width:80pt' align=left valign=top><!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="jabk0060_HCDP_A_files/huyndai_amco.jpg" o:title="huyndai_amco"/>
  ...
  height:91px'><img width=103 height=91 src="jabk0060_HCDP_A_files/huyndai_amco.jpg"
  ...
  <td width=30 style='width:23pt' align=left valign=top><!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="jabk0060_HCDP_A_files/image001.png" o:title="image001"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
   </x:ClientData>
  ...
  height:77px'><img width=130 height=77 src="jabk0060_HCDP_A_files/image002.jpg"
