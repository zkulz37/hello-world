...
<%
    ...
    = "select E.FULL_NAME c00  " +
        ...
        "        , substr(A.BEGIN_CONTRACT,-2) c13 " +
        "        , substr(A.BEGIN_CONTRACT,5,2) c14 " +
        "        , substr(A.BEGIN_CONTRACT,1,4) c15 " +
        "        , substr(A.END_CONTRACT,-2) c16 " +
        "        , substr(A.END_CONTRACT,5,2) c17 " +
        "        , substr(A.END_CONTRACT,1,4) c18 " +
        ...
        "        , to_char(nvl(A.BASIC_SAL,0),'999,999,999') c21 " +
        "        , to_char(nvl(A.ALLOW_AMT1,0)+nvl( A.ALLOW_AMT2,0)+nvl( A.ALLOW_AMT3,0) " +
        "        +nvl( A.ALLOW_AMT4,0)+nvl( A.ALLOW_AMT5,0)+nvl( A.ALLOW_AMT6,0) " +
        "        +nvl( A.ALLOW_AMT7,0)+nvl( A.ALLOW_AMT8,0),'999,999,999') c22 " +
        "        , substr( to_char(to_date( A.BEGIN_CONTRACT,'yyyymmdd')-1,'yyyymmdd') ,-2) c23 " +
        "        , substr(to_char(to_date( A.BEGIN_CONTRACT,'yyyymmdd')-1,'yyyymmdd'),5,2) c24 " +
        "        , substr(to_char(to_date( A.BEGIN_CONTRACT,'yyyymmdd')-1,'yyyymmdd'),1,4) c25 " +
        "        , case when nvl(E.MONEY_KIND,'01')='01' then 'ĐỒNG' " +
        "                else 'USD' " +
        "         end   c26    " +
        "        ,to_char(decode( nvl(MEAL_YN,'N'),'Y',0,0),'999,999,999') c27    "+ 
        "        , to_char(nvl(A.BASIC_SAL,0)+nvl(A.ALLOW_AMT1,0)+nvl( A.ALLOW_AMT2,0)+nvl( A.ALLOW_AMT3,0) " +
        "        +nvl( A.ALLOW_AMT4,0)+nvl( A.ALLOW_AMT5,0)+nvl( A.ALLOW_AMT6,0) " +
        "        +nvl( A.ALLOW_AMT7,0)+nvl( A.ALLOW_AMT8,0)+decode( nvl(MEAL_YN,'N'),'Y',0,0) ,'999,999,999') c28  " +
        "        , a.contract_no c29   " +
        "        , e.present_addr c30   " +
...
<p class=MsoHeading7><span class=SpellE><span style='font-family:"Times New Roman"'>CJ E & M CORPORATION </span></span><span
style='font-family:"Times New Roman"'> <span class=SpellE></span> 
<o:p></o:p></span></p>

<p class=MsoNormal><span class=SpellE><span style='font-family:"Times New Roman"'></span></span><span
...
style='color:blue'>LEE JOONG HOO <span class=SpellE></span> </span><span
...
style='font-family:"Times New Roman";mso-bidi-font-weight:bold'>Passport</span></i><i
style='mso-bidi-font-style:normal'><span style='font-family:"Times New Roman"'>
No</span></i><span style='font-family:"Times New Roman"'>.: <b><span
...
<p class=MsoNormal style='margin-top:6.0pt;text-align:justify;line-height:150%'><span
style='font-family:"Times New Roman";color:blue'>- <span class=SpellE>Từ</span>
...
health and unemployment insurances</i> (10): Theo qui <span class=SpellE>định</span>
<span class=SpellE>của</span> <span class=SpellE>Nhà</span> <span class=SpellE>nước</span>/
<i>pursuant to the Government’s regulations<o:p></o:p></i></span></p>
...
<span class=SpellE></span><span style='mso-tab-count:1'>                                  </span>LEE JOONG HOO
