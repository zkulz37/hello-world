...
<%
 ...
 string SQL
	= "select ins_type.char_3 " + 
        ...
        ",a.TY_LE/100 as c20 " +
        ",' ' as c21 " +
        ",decode(nvl(a.TRA_THE_YN,'N'),'Y','X','')  as c22 " +
        ",a.DC_TANG_XH as c23 " +
        ",a.DC_GIAM_XH as c24 " +
        ",a.DC_TANG_YT as c25 " +
        ",a.DC_GIAM_YT as c26 " +
        ",'HĐ số ' || A.MA_HOP_DONG || '(' ||  TO_CHAR(TO_DATE(A.NGAY_KY_HD,'YYYYMMDD'),'DD/MM/YYYY') || ')' as c27 " +
        ",a.EMP_ID as c28 " +
        ...
        ",a.DC_TANG_TN as c32 " +
        ",a.DC_GIAM_TN as c33 " +
        ",DECODE(LENGTH(A.BIRTH_DT),4,A.BIRTH_DT,TO_CHAR(TO_DATE(A.BIRTH_DT,'YYYYMMDD'),'DD/MM/YYYY')) as c34 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1718 style='border-collapse:
 ...
 width:62pt'>
 <col class=xl26 width=47 span=4 style='mso-width-source:userset;mso-width-alt:
 1718;width:35pt'>
 <col class=xl26 width=88 style='mso-width-source:userset;mso-width-alt:3218;
 width:66pt'>
 <col class=xl24 width=48 span=4 style='mso-width-source:userset;mso-width-alt:
 1755;width:36pt'>
 <col class=xl24 width=63 span=2 style='mso-width-source:userset;mso-width-alt:
 2304;width:47pt'>
 ...
 width:51pt'>
 <col class=xl27 width=53 style='mso-width-source:userset;mso-width-alt:1938;
 width:40pt'>
 <col class=xl28 width=169 style='mso-width-source:userset;mso-width-alt:6180;
 width:127pt'>
 <col class=xl28 width=67 style='mso-width-source:userset;mso-width-alt:2450;
 width:50pt'>
 <col class=xl28 width=40 style='mso-width-source:userset;mso-width-alt:1462;
 width:30pt'>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl48 style='mso-ignore:colspan'></td>
  <td class=xl84 x:str><span style='mso-spacerun:yes'>  </span></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl48 style='mso-ignore:colspan'></td>
  <td  class=xl41 style='mso-ignore:colspan'></td>
  <td  class=xl41 style='mso-ignore:colspan'></td>
  <td  class=xl41 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl53 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  x:str>Thay đổi chức danh<span style='mso-spacerun:yes'> </span></td>
  <td colspan=3 rowspan=2 class=xl139 width=396 style='border-left:none;width:297pt'>Ghi
  chú</td>
 ...
 <tr class=xl53 height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  tháng<br>
    năm</td>
  <td rowspan=2 class=xl139 width=40 style='border-top:none;width:30pt'>Trả thẻ</td>
  <td rowspan=2 class=xl139 width=76 style='border-top:none;width:57pt'>Nội
  dung</td>
  <td rowspan=2 class=xl139 width=76 style='border-top:none;width:57pt'>Mã số</td>
  <td colspan=3 class=xl53 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr class=xl92 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl107 style='border-left:none' ><%=dt_Emp.Rows[i][2].ToString() %></td>
  <td class=xl107 style='border-left:none' ><%=dt_Emp.Rows[i][33].ToString() %></td>
  ...
  <td class=xl103 style='border-left:none'><%=dt_Emp.Rows[i][20].ToString() %></td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td class=xl66></td>
  <td class=xl71 style='border-top:none'>3. Số phải đóng</td>
  <td class=xl152 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td class=xl66></td>
  <td class=xl71 style='border-top:none'>2. Tổng quỹ lương</td>
  <td class=xl152 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span></td>
