...
public partial class reports_ch_di_rpt_C70a_HD : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_C70a_HD.xls";
        string TempFile = "../../../system/temp/rpt_C70a_HD_" + Session["User_ID"].ToString() + ".xls";
        ...
        "from vhr_hr_code v " +
        "where v.ID='HR0049' and nvl(v.tco_company_pk,'" + p_company_pk + "')=" + "(select a.tco_company_pk from tco_org a where a.del_if=0 and a.pk='" + p_org_pk  + "')";
        //Response.Write(SQL);
        //Response.End();
