...
<%
 ...
 string SQL
	= "select ins_type.char_3 " + 
        ...
        ",DECODE(LENGTH(A.BIRTH_DT),4,A.BIRTH_DT,TO_CHAR(TO_DATE(A.BIRTH_DT,'YYYYMMDD'),'DD/MM/YYYY')) AS NGAYSINH37   " +
        ",decode(nvl(a.TRA_THE_YN,'N'),'Y','X','') " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2076 style='border-collapse:
 ...
 width:59pt'>
 <col class=xl24 width=44 span=4 style='mso-width-source:userset;mso-width-alt:
 1609;width:33pt'>
 <col class=xl24 width=78 style='mso-width-source:userset;mso-width-alt:2852;
 width:59pt'>
 <col class=xl24 width=44 span=4 style='mso-width-source:userset;mso-width-alt:
 ...
 width:31pt'>
 <col class=xl24 width=65 span=5 style='mso-width-source:userset;mso-width-alt:
 2377;width:49pt'>
 ...
 2377;width:49pt'>
 <col class=xl24 width=62 span=2 style='mso-width-source:userset;mso-width-alt:
 2267;width:47pt'>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl44 width=60 style='width:45pt'></td>
  <td class=xl44 width=60 style='width:45pt'></td>
  <td colspan=2 class=xl45 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>Tháng B.Cáo</td>
  <td colspan=2 class=xl45 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>Trần <%=p_old_year %></td>
  <td colspan=2 class=xl45 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>Trần <%=p_cur_year %></td>
  <td colspan=2 class=xl45 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'>Tối thiểu chung</td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl82 colspan=5>Số:..........Tháng <%=p_rpt_month.Substring(4,2) %> Năm <%=p_rpt_month.Substring(0,4) %> </td>
  <td class=xl47></td>
  <td class=xl46 ></td>
  <td class=xl43></td>
  
  <td class=xl84 colspan=5 x:str="(Ban hành kèm theo QĐ số: 1333/QĐ-BHXH  ">(Ban hành kèm
  theo QĐ số: 1333/QĐ-BHXH</td>
  <td  class=xl48 ></td>
  <td  class=xl48 ></td>
  <td colspan=2  style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;'><%="01" + "/" + p_rpt_month.Substring(4,2) + "/" + p_rpt_month.Substring(0,4) %></td>
  <td  colspan=2 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%=dt_Emp.Rows[0][33].ToString()%> </td>
  <td colspan=2 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%=dt_Emp.Rows[0][34].ToString()%> </td>
  <td colspan=2 style='border-left:.5pt solid black;border-bottom:.5pt solid black;border-right:.5pt solid black;border-top:.5pt solid black;mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%=dt_Emp.Rows[0][35].ToString()%> </td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=5 class=xl49 x:str="ngày 21/02/2008 của BHXH VN)"><span
  style='mso-spacerun:yes'> </span>ngày 21/02/2008 của BHXH VN)<span
 ...
 <tr class=xl53 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  <td rowspan=4 class=xl143 width=40 style='width:30pt'>Thay đổi chức vụ</td>
  <td colspan=2 rowspan=2 class=xl143 width=40 style='width:30pt'
 ...
 <tr class=xl53 height=17 style='mso-height-source:userset;height:12.75pt'>
  ...
  tháng<br>
    năm</td>
  <td rowspan=2 class=xl139 width=53 style='border-top:none;width:40pt'>Trả thẻ</td>
  <td rowspan=2 class=xl139 width=53 style='border-top:none;width:40pt'>Nội dung</td>
 ...
 <tr class=xl53 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl54 style='height:19.5pt;border-top:none' x:num>1</td>
  <td height=26 class=xl54 style='height:19.5pt' ></td>
  <td class=xl54 style='border-top:none;border-left:none' x:num >2</td>
  ...
  <td class=xl54 style='border-top:none;border-left:none' x:num>5</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>6</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>7</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>8</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>9</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>10</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>11</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>12</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>13</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>14</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>15</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>16</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>17</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>18</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>19</td>
  <td class=xl54 style='border-top:none;border-left:none' x:num>20</td>
 ...
 <tr class=xl92 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl101 style='border-left:none' ><%=dt_Emp.Rows[i][36].ToString() %></td>
  ...
  <td class=xl103 style='border-left:none'><%=dt_Emp.Rows[i][37].ToString() %></td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  border-bottom:.5pt solid black;width:205pt'>A.Phát sinh kỳ này</td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td colspan=1 class=xl149 width=122 style='border-right:.5pt solid black;
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan=1 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td colspan=2 rowspan=2 class=xl129 width=273 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;width:205pt'>B. Tổng hợp cuối kỳ</td>
  <td class=xl147 align=center width=78 style='border-left:none;width:59pt'>Bảo
  hiểm xã hội</td>
  <td class=xl148 width=44 style='border-left:none;width:33pt'>&nbsp;</td>
  <td class=xl147 width=44 style='border-left:none;width:33pt'>&nbsp;</td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td colspan=1 class=xl149 width=122 style='border-right:.5pt solid black;
  border-left:none;width:92pt'>Kỳ trước</td>
  <td colspan=2 class=xl149 width=132 style='border-right:.5pt solid black;
  border-left:none;width:99pt'>Kỳ này</td>
  <td colspan=2 class=xl149 width=122 style='border-right:.5pt solid black;
  border-left:none;width:92pt'>Kỳ trước</td>
  <td colspan=2 class=xl149 width=132 style='border-right:.5pt solid black;
  border-left:none;width:99pt'>Kỳ này</td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl152 style='border-top:none'>&nbsp;</td>
   <td colspan=1 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][0].ToString()%>  </td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][0].ToString())+Double.Parse(dt_sum.Rows[0][0].ToString()) - Double.Parse(dt_sum.Rows[0][1].ToString()) %></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][1].ToString()%> </td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][1].ToString())+Double.Parse(dt_sum.Rows[0][0].ToString()) - Double.Parse(dt_sum.Rows[0][1].ToString()) %></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][2].ToString()%> </td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][2].ToString())+Double.Parse(dt_sum.Rows[0][0].ToString()) - Double.Parse(dt_sum.Rows[0][1].ToString()) %></td>
 <td colspan=8 class=xl69 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
 ...
 <td colspan=1 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][3].ToString()%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][3].ToString())+Double.Parse(dt_sum.Rows[0][2].ToString()) - Double.Parse(dt_sum.Rows[0][3].ToString()) %></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][4].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][4].ToString())+Double.Parse(dt_sum.Rows[0][4].ToString()) - Double.Parse(dt_sum.Rows[0][5].ToString()) %></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][5].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][5].ToString())+Double.Parse(dt_sum.Rows[0][14].ToString()) - Double.Parse(dt_sum.Rows[0][15].ToString()) %></td>
  <td colspan=8 class=xl69 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  ...
  <td colspan=1 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][6].ToString()%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][6].ToString())+Double.Parse(dt_sum.Rows[0][6].ToString()) - Double.Parse(dt_sum.Rows[0][7].ToString()) %></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][7].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][7].ToString())+Double.Parse(dt_sum.Rows[0][8].ToString()) - Double.Parse(dt_sum.Rows[0][9].ToString()) %></td>
  
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][8].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%= Double.Parse(dt_month.Rows[0][8].ToString())+Double.Parse(dt_sum.Rows[0][16].ToString()) - Double.Parse(dt_sum.Rows[0][17].ToString()) %></td>
  <td colspan=13 class=xl69 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl69 height=17 style='height:12.75pt'>
  <td height=17 colspan=7 class=xl69 style='height:12.75pt;mso-ignore:colspan'></td>
