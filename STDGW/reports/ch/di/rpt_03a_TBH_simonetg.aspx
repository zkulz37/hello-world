...
<%
    ...
    string p_times,p_rpt_month,p_old_year,p_cur_year;
 ...
 string SQL
	= "select ins_type.char_3 " + 
        ...
        ",(SELECT code_fnm FROM VHR_HR_CODE V WHERE V.ID='HR0008' AND V.CODE=A.CHUC_DANH ) c37  " +
...
//Response.End();
    ...
    SQL
	= "select  " + 
        "sum(decode(a.loai_bh,'02',1,'03',1,'01',1,'10',1,0)) as c1t1  " +
        ",sum(decode(a.loai_bh,'04',1,'05',1,'06',1,'07',1,'11',1,'12',1,'13',1,0)) as c1g2 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1951 style='border-collapse:
 ...
 width:49pt;display:none'>
 <col class=xl24 width=43 style='mso-width-source:userset;mso-width-alt:1572;
 width:32pt;display:none'>
 <col class=xl27 width=65 span=2 style='mso-width-source:userset;mso-width-alt:
 2377;width:49pt;display:none'>
 <col class=xl28 width=65 span=3 style='mso-width-source:userset;mso-width-alt:
 2377;width:49pt;display:none'>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl82 colspan=5>Tháng <%=p_rpt_month.Substring(4,2) %> Năm <%=p_rpt_month.Substring(0,4) %> (lần <%=p_times%>)</td>
  <td class=xl47></td>
  <td class=xl46 ></td>
  <td class=xl43></td>
  <td class=xl43></td>
  <td class=xl84 colspan=5 x:str>(Ban hành kèm
  theo CV số: 1615/BHXH</td>
  <td  class=xl48 ></td>
  <td  class=xl48 ></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  style='mso-spacerun:yes'> </span>CSXH ngày 02/06/2009 của BHXH VN)<span
 ...
 <tr class=xl53 height=19 style='mso-height-source:userset;height:14.25pt'>
  ...
  width:45.13pt'>Chức vụ hoặc chức danh nghề</td>
  ...
  <td rowspan=4 class=xl143 width=40 style='width:30pt'>Tỷ lệ đóng</td>
 ...
 <tr class=xl53 height=51 style='height:38.25pt'>
  ...
  <td class=xl139 width=44 style='border-top:none;border-left:none;width:33pt'>TN VK</td>
  <td class=xl139 width=44 style='border-top:none;border-left:none;width:33pt'>TN NG</td>
  <td class=xl139 width=44 style='border-top:none;border-left:none;width:33pt'>Khác</td>
 ...
 <tr class=xl92 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl1011 style='border-left:none' x:num><%=dt_Emp.Rows[i][19].ToString() %></td>
  ...
  <td class=xl101 style='border-left:none;' x:num><%=dt_Emp.Rows[i][29].ToString() %></td>
  <td class=xl101 style='border-left:none' x:num><span
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td height=26 class=xl69 style='height:19.5pt'></td>
  <td colspan=2 rowspan=2 class=xl129 width=273 style='border-right:.5pt solid black;
  border-bottom:.5pt solid black;width:205pt'>Tổng hợp</td>
  <td class=xl147 align=center width=78 style='border-left:none;width:59pt'>Bảo
  hiểm y tế</td>
  <td class=xl148 width=44 style='border-left:none;width:33pt'>&nbsp;</td>
  <td class=xl147 width=44 style='border-left:none;width:33pt'>&nbsp;</td>
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][0].ToString()) - double.Parse(dt_sum.Rows[0][1].ToString()) + double.Parse(dt_sum.Rows[0][0].ToString())%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
 ...
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][3].ToString()) - double.Parse(dt_sum.Rows[0][5].ToString()) + double.Parse(dt_sum.Rows[0][4].ToString())%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][4].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][4].ToString()) - double.Parse(dt_sum.Rows[0][15].ToString()) + double.Parse(dt_sum.Rows[0][14].ToString())%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][5].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][5].ToString()) - double.Parse(dt_sum.Rows[0][3].ToString()) + double.Parse(dt_sum.Rows[0][2].ToString())%></td>
  <td colspan=8 class=xl69 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl69 height=26 style='mso-height-source:userset;height:19.5pt'>
  <td height=26 class=xl69 style='height:19.5pt'></td>
  ...
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][6].ToString()) - double.Parse(dt_sum.Rows[0][9].ToString()) + double.Parse(dt_sum.Rows[0][8].ToString())%></td>
  <td colspan=2 class=xl133 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                  </span><%=dt_month.Rows[0][7].ToString()%></td>
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][7].ToString()) - double.Parse(dt_sum.Rows[0][17].ToString()) + double.Parse(dt_sum.Rows[0][16].ToString())%></td>
  ...
  <td colspan=2 class=xl153 style='border-right:.5pt solid black;border-left:
  none' x:num><span
  style='mso-spacerun:yes'>                                     </span><%=double.Parse(dt_month.Rows[0][8].ToString()) - double.Parse(dt_sum.Rows[0][7].ToString()) + double.Parse(dt_sum.Rows[0][6].ToString())%></td>
  <td colspan=13 class=xl69 style='mso-ignore:colspan'></td>
 </tr>
