...
public partial class reports_ch_ba_rpt_in_out_summary : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {        
        ESysLib.SetUser(Session["APP_DBUSER"].ToString());

        string TemplateFile = "rpt_in_out_summary.xls";
        string TempFile = "../../../system/temp/rpt_in_out_summary_" + Session["User_ID"].ToString() + ".xls";
