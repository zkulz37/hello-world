...
<%
    ...
    = "SELECT D.THR_EMP_PK AS THR_EMP_PK,T.org_NM, E.workGROUP_NM,V.EMP_ID,V.FULL_NAME,S.REMARK  " +
        ...
        "        ,MAX(DECODE(H.OT_TYPE,'OT',NVL(H.OT_TIME,''),'')) AS OT  " +
        "        ,MAX(DECODE(H.OT_TYPE,'OT',NVL(H.PAY_RATE,''),'')) AS OT_RATE  " +
        "        ,MAX(DECODE(H.OT_TYPE,'NT',NVL(H.OT_TIME,''),'')) AS NT  " +
        "        ,MAX(DECODE(H.OT_TYPE,'NT',NVL(H.PAY_RATE,''),'')) AS NT_RATE  " +
        "        ,MAX(DECODE(H.OT_TYPE,'HT',NVL(H.OT_TIME,''),'')) AS HT  " +
        "        ,MAX(DECODE(H.OT_TYPE,'HT',NVL(H.PAY_RATE,''),'')) AS HT_RATE  " +
        "        ,MAX(D.PK) AS WT_PK  " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1137 style='border-collapse:
 ...
 width:70pt'>
 <col class=xl24 width=58 span=7 style='mso-width-source:userset;mso-width-alt:
 2121;width:44pt'>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  ...
  height:58px'><img width=71 height=58 src="..\..\..\system\binary\ViewFile.aspx?img_pk=<%=pk%>&table_name=tco_bpphoto"
 ...
 %>
 <tr >
  <td  style='height:30.0pt;border-top:.5pt  solid black;' x:num></td>
  <td style='border-top:.5pt  solid black;'></td>
  <td  style='border-top:.5pt  solid black;'></td>
  <td  style='border-top:.5pt  solid black;'></td>
  <td  style='border-top:.5pt  solid black;'></td>
  <td  style='border-top:.5pt  solid black;' x:num></td>
  <td  style='border-top:.5pt  solid black;' x:num></td>
  <td  style='border-top:.5pt  solid black;' x:num></td>
  <td  style='border-top:.5pt  solid black;' x:num></td>
  <td  style='border-top:.5pt  solid black;' x:num></td>
