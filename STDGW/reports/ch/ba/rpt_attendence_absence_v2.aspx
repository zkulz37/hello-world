...
<%
    ...
    string p_from_date,p_to_date,p_from_date_text,p_to_date_text,p_date_type,p_nation,p_reg;
   ...
   string SQL
	= "SELECT to_char(sysdate,'dd/mm/yyyy'),C.ORG_NM,GP.WORKGROUP_NM ,A.EMP_ID, A.FULL_NAME " + 
        ...
        "       ,WKD.OVT,WKD.HT,WKD.NT,WKD.NT2,hr_code.code_nm,GP2.WORKGROUP_NM " +
        ...
        "            FROM THR_TIME_MACHINE D,THR_EXTRA_TIME H,THR_WG_SCH_DETAIL G,THR_EMPLOYEE V,THR_WORK_SHIFT U " +
        ...
        "           FROM THR_ABSENCE E,THR_EMPLOYEE F,THR_WG_SCH_DETAIL K " +
        ...
        SQL = SQL + "                 OR '" + p_tco_org_pk + "' = 'ALL') " +
        "        ) ABS " +
        " WHERE A.DEL_IF = 0 AND GP.DEL_IF=0 AND GW.DEL_IF=0 AND WS.DEL_IF=0 AND C.DEL_IF=0 AND GP2.DEL_IF=0 " +
       ...
       SQL = SQL + "                   AND (    a.TCO_ORG_PK IN ( ";
        ...
        "          OR '" + p_search_temp + "' IS NULL " +
        "         ) " +
        "ORDER BY GW.WORK_DT,c.org_nm, gp.workgroup_nm, a.emp_id ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1344 style='border-collapse:
 ...
 width:44pt'>
 <col class=xl24 width=80 style='mso-width-source:userset;mso-width-alt:2450;
 width:50pt'>
 <col class=xl24 width=80 style='mso-width-source:userset;mso-width-alt:2450;
 width:50pt'>
 ...
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl28 style='border-left:none'>Work Group2</td>
 </tr>
 <tr class=xl27 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl32 style='border-top:none;border-left:none'>Gi&#7901; &#273;êm NT</td>
  <td class=xl32 style='border-top:none;border-left:none'>Gi&#7901; &#273;êm NT2</td>
  <td class=xl32 style='border-top:none;border-left:none'>Lo&#7841;i ngh&#7881;</td>
  <td class=xl32 style='border-top:none;border-left:none'>Nhóm theo ngày</td>
 </tr>
 <% 
     string s_format;
 ...
 <tr class=xl29 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl43 style='border-top:none;border-left:none<%=s_format%>'><% = dt_total.Rows[i][14].ToString()%></td>
  <td class=xl43 style='border-top:none;border-left:none<%=s_format%>'><% = dt_total.Rows[i][15].ToString()%></td>
 </tr>
 <%
    }
  %>
