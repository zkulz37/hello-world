...
<%
	...
	= "select to_char(sysdate,'dd/mm/yyyy') ,org_nm,workgroup_nm,emp_id,full_name,w_date " + 
        ...
        ",HR.TIME_IN,HR.TIME_OUT,HR.WORK_TIME,HR.OVT,HR.HT,HR.NT,HR.NT2,HR.workgroup_nm2 " +
        ...
        "         MAX (a.workgroup_nm) workgroup_nm2 " +
        "   FROM thr_time_machine d, " +
        "         thr_extra_time h, " +
        "         THR_WG_SCH_DETAIL g, " +
        "         thr_employee v, " +
        "         thr_work_group a,thr_work_group a2, " +
        "         tco_org t " +
        "   WHERE d.del_if = 0 " +
        "     AND g.del_if = 0 " +
        "     AND v.del_if = 0 " +
        ...
        "     AND g.del_if = 0 " +
        "     AND t.del_if = 0 and a2.del_if=0 and g.thr_wg_pk=a2.pk" +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1262 style='border-collapse:
 ...
 <col class=xl24 width=67 style='mso-width-source:userset;mso-width-alt:2450;
 width:50pt'>
 <col class=xl24 width=67 style='mso-width-source:userset;mso-width-alt:4450;
 width:50pt'>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl30 style='border-left:none'>NT2</td>
  <td class=xl30 style='border-left:none'>WGROUP2</td>
  <td class=xl25></td>
 </tr>
 <tr class=xl25 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl31 style='border-top:none;border-left:none'>Giờ làm đêm</td>
  <td class=xl31 style='border-top:none;border-left:none'>Giờ t/c đem</td>
  <td class=xl31 style='border-top:none;border-left:none'>Nhóm theo ngày</td>
  <td class=xl25></td>
 </tr>
 <% 
     string s_format;
 ...
 <tr class=xl26 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl27 style='border-top:none;border-left:none<%=s_format%>' x:num><% = dt_total.Rows[i][13].ToString()%></td>
  <td class=xl27 style='border-top:none;border-left:none<%=s_format%>' x:num><% = dt_total.Rows[i][14].ToString()%></td>
  <td class=xl26></td>
 </tr>
  <%
    }
