...
<%
   ...
   string SQL
    = "SELECT HR.T1,HR.T5,count( distinct hr.t2) " + 
        "    FROM( " +
        "    SELECT 'Posco VN' as t1 " +
        ...
        "        AND (DECODE('" + p_search + "','1',UPPER(B.ID),'2',B.ID,'3',UPPER(B.FULL_NAME)) LIKE '%'||UPPER('" + p_input + "') " +
        "                        OR '" + p_input + "' IS NULL)  " +
        "    )HR group by hr.t1,hr.t5 order by hr.t1,hr.t5    " ;
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=863 style='border-collapse:
 ...
 <tr height=43 style='mso-height-source:userset;height:32.25pt'>
  <td colspan=4 height=43 class=xl31 width=863 style='height:32.25pt;
  width:649pt'>ROLLING GATE INFOR - SUMMARY</td>
 </tr>
 <tr class=xl32 height=29 style='mso-height-source:userset;height:21.75pt'>
  <td  style='height:21.75pt' class=xl45>Work Date:</td>
 ...
 <tr class=xl25 height=44 style='mso-height-source:userset;height:33.0pt'>
  ...
  width:32pt'>No.</td>
  <td class=xl30 width=130 style='border-top:none;border-left:none;width:98pt'>Information Type</td>
  <td class=xl30 width=121 style='border-top:none;border-left:none;width:91pt'>Check Date</td>
  <td class=xl30 width=199 style='border-top:none;border-left:none;width:149pt'>Sum of Emp</td>
 </tr>
