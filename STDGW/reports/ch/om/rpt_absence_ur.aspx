...
<%
    string p_user,p_tco_org_pk,p_thr_wg_pk,p_work_shift,p_search_by,p_search_temp;
    ...
    SQL = SQL + "                   nvl(b.insurance_pay_rate,0) /100 ,act_absence.code_nm";
    SQL = SQL + "              FROM thr_employee a, thr_absence_ur b, thr_work_group c, comm.tco_org d ";
    SQL = SQL + "                ,(select code,code_nm,num_1,num_2,num_3 from vhr_hr_code where id='HR0003') absence ";
    SQL = SQL + "                ,(select code,code_nm,num_1,num_2,num_3 from vhr_hr_code where id='HR0003') act_absence "; 
    SQL = SQL + "             WHERE a.del_if = 0 ";
    SQL = SQL + "               AND c.del_if = 0 ";
    SQL = SQL + "               AND b.del_if = 0 ";
    SQL = SQL + "               AND d.del_if = 0 ";
    SQL = SQL + "               AND b.absence_type=absence.code AND b.actual_absence_type=act_absence.code ";
    SQL = SQL + "               AND b.thr_emp_pk=a.pk ";
    SQL = SQL + "               AND a.thr_wg_pk = c.pk ";
    SQL = SQL + "               AND d.pk = a.tco_org_pk ";
    SQL = SQL + "               AND DECODE ('" + p_thr_wg_pk + "', 'ALL', 'ALL', a.thr_wg_pk) = ";
    SQL = SQL + "                                                                    '" + p_thr_wg_pk  + "'";
    ...
    SQL = SQL + "          ORDER BY b.absence_dt, nvl(d.seq,0),nvl( c.seq,0), a.emp_id, a.full_name,b.absence_type ";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1374 style='border-collapse:
 ...
 width:116pt'>
 <col class=xl24 width=111 span=3 style='mso-width-source:userset;mso-width-alt:
 4059;width:83pt'>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl30 style='border-left:none'>Actual Absence Type</td>
 ...
 <tr class=xl25 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl31 style='border-top:none;border-left:none'>Lo&#7841;i ngh&#7881; đúng</td>
 ...
 <tr class=xl26 height=26 style='mso-height-source:userset;height:19.5pt'>
  ...
  <td class=xl43 style='border-top:none;border-left:none<%=s_format%>'><% = dt_total.Rows[i][11].ToString()%></td>
