...
<%
   ...
   string SQL
	= "SELECT  to_char(sysdate,'dd/mm/yyyy'),t.org_nm org_nm, a.workgroup_nm group_nm, v.emp_id emp_id, v.full_name, " + 
        ...
        "        thr_employee v, " +
        "         thr_work_group a, " +
        "         comm.tco_org t,thr_work_shift w " +
        "   WHERE d.del_if = 0 " +
        "     AND v.del_if = 0 " +
        "     and w.del_if=0  " +
        ...
        "     order by d.work_dt,nvl(t.seq,0),nvl(a.seq,0),v.emp_id " ;
