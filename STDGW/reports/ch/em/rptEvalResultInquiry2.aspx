...
<%
    ...
    string l_parameter = "";
    l_parameter = "'" + l_eva_master_pk + "','" + l_org_pk + "','" + l_eva_group + "','" + l_empployee + "','" + l_eva_status + "'";
    string sp = "sp_sel_chem00120_4";
    DataTable emp_list = ESysLib.TableReadOpenCursor(sp, l_parameter);
...
<%
    ...
    for ( k = 0; k < emp_list.Rows.Count; k++)
    {
        sp = "sp_sel_chem00120_3";
        l_parameter = emp_list.Rows[k][0].ToString();
        ...
        sp = "sp_sel_chem00120_1";
        dt1 = ESysLib.TableReadOpenCursor(sp, l_parameter);
        if (dt1.Rows.Count == 0)
        {
            Response.Write("There is no data");
            Response.End();
        }
        sp = "sp_sel_chem00120_2";
        dt2 = ESysLib.TableReadOpenCursor(sp, l_parameter);
 %>
