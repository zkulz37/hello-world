...
public partial class rpt_safe_behaviour_vst : System.Web.UI.Page
{
    ...
    = "SELECT  " + 
        ...
        ",NVL((select NVL(EV.POINT,0) from thr_eva_emp_other ev where ev.del_if =0 and EV.GROUP_TYPE ='HR0172' and EV.POINT_TYPE ='01'AND EV.THR_EVA_EMP_PK = A.PK),0) as TC01 " +
        ",NVL((select NVL(EV.POINT,0) from thr_eva_emp_other ev where ev.del_if =0  and EV.GROUP_TYPE ='HR0172' and EV.POINT_TYPE ='02'AND EV.THR_EVA_EMP_PK = A.PK),0) as TC02 " +
        ...
        ",nvl(A.OTHER_SCORE3,0) OTHER_SCORE3 " +
		...
		string TemplateFile = "rpt_safe_behaviour_vst.xls";
        string TempFile = "../../../system/temp/rpt_safe_behaviour_vst" + Session["User_ID"].ToString() + ".xls";
