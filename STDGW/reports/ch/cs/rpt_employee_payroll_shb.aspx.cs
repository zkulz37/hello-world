...
public partial class reports_ch_cs_rpt_employee_payroll_shb : System.Web.UI.Page
{
    ...
    = "select null,null, " +
        ...
        "       round( nvl( a.severance_amt, 0 ) + nvl( a.return_resign_allow, 0 ), 5 ) severance_amt, " +
        "       round( nvl( a.ale_stop, 0 ), 5 ) ale_stop, " +
        "       round( nvl( a.ale_stop_amt, 0 ), 5 ) ale_stop_amt, " +
		
		
		
        "         round( nvl( a.return_wt_salary, 0 ), 5 ) return_wt_salary, " +
        "         round( nvl( a.deduct_wt_salary, 0 ), 5 ) deduct_wt_salary, " +
        "         round( nvl( a.return_position_allow, 0 ), 5 ), " +
        "         round( nvl( a.deduct_position_allow, 0 ), 5 ), " +
        "         round( nvl( a.return_ot_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_st_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_ht_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_nt_30_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_nt_45_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_nt_45_2_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_nt_60_hour, 0 ), 5 ), " +
        "         round( nvl( a.return_nt_90_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_ot_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_st_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_ht_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_nt_30_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_nt_45_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_nt_45_2_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_nt_60_hour, 0 ), 5 ), " +
        "         round( nvl( a.deduct_nt_90_hour, 0 ), 5 ), " +
        "         round " +
        "         ( " +
        "              nvl( a.return_ot_hour_amt, 0 ) " +
        "            + nvl( a.return_st_hour_amt, 0 ) " +
        "            + nvl( a.return_ht_hour_amt, 0 ) " +
        "            + nvl( a.return_nt_30_hour_amt, 0 ) " +
        "            + nvl( a.return_nt_45_hour_amt, 0 ) " +
        "            + nvl( a.return_nt_45_2_hour_amt, 0 ) " +
        "            + nvl( a.return_nt_60_hour_amt, 0 ) " +
        "            + nvl( a.return_nt_90_hour_amt, 0 ), " +
        "            5 " +
        "         ) " +
        "            total_return_ot_amt, " +
        "         round " +
        "         ( " +
        "              nvl( a.deduct_ot_hour_amt, 0 ) " +
        "            + nvl( a.deduct_st_hour_amt, 0 ) " +
        "            + nvl( a.deduct_ht_hour_amt, 0 ) " +
        "            + nvl( a.deduct_nt_30_hour_amt, 0 ) " +
        "            + nvl( a.deduct_nt_45_hour_amt, 0 ) " +
        "            + nvl( a.deduct_nt_45_2_hour_amt, 0 ) " +
        "            + nvl( a.deduct_nt_60_hour_amt, 0 ) " +
        "            + nvl( a.deduct_nt_90_hour_amt, 0 ), " +
        "            5 " +
        "         ) " +
        "            total_deduct_ot_amt, " +
        "         round( nvl( a.return_meal_amt, 0 ), 5 ) return_meal_amt, " +
        "         round( nvl( a.deduct_meal_amt, 0 ), 5 ) deduct_meal_amt, " +
        "         round( nvl( return_amt, 0 ) , 5 ) add_back_amt, " +
        "         round( nvl( nvl( a.advance_amt, 0 ), 0 ), 5 ) deduct_amt, " +
        "         round( nvl( a.gross_amt, 0 ), 5 ) gross_amt, " +
        "         round( nvl( a.total_ot_no_tax_amt, 0 ) , 5 ) ot_no_tax_amt, " +
        ...
        "         round( nvl( a.social_amt, 0 ) + nvl( a.adj_social_amt, 0 ), 5 ) social_amt, " +
        "         round( nvl( a.health_amt, 0 ) + nvl( a.adj_health_amt, 0 ), 5 ) health_amt, " +
        "         round( nvl( a.unemp_ins, 0 ) + nvl( a.adj_unemp_amt, 0 ), 5 ) unemp_ins, " +
        "         round( nvl( a.social_amt, 0 ) + nvl( a.health_amt, 0 ) + nvl( a.unemp_ins, 0 ) + nvl( a.adj_social_amt, 0 ) + nvl( a.adj_health_amt, 0 ) + nvl( a.adj_unemp_amt, 0 ), 5 ) total_ins_amt, " +
        ...
        "         round( nvl( a.social_company, 0 ) + nvl( a.adj_social_com_amt, 0 ) , 5 ) social_company, " +
        "         round( nvl( a.health_company, 0 )+ nvl( a.adj_health_com_amt, 0 ), 5 ) health_company, " +
        "         round( nvl( a.unemp_com_ins, 0 )+ nvl( a.adj_unemp_com_amt, 0 ), 5 ) unemp_com_ins, " +
        "         round( nvl( a.social_company, 0 ) + nvl( a.health_company, 0 ) + nvl( a.unemp_com_ins, 0 )+ nvl( a.adj_social_com_amt, 0 )+ nvl( a.adj_health_com_amt, 0 )+ nvl( a.adj_unemp_com_amt, 0 ), 5 ) ins_com_amt, " +
