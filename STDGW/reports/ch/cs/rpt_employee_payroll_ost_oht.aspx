...
<%
   ...
   string SQL
	= "select a.THR_GROUP_NM,  " +                                  //1
        ...
        "ROUND(NVL(A.SOCIAL_AMT,0) + NVL(A.UNEMP_INS,0)  ,10),  " +           //56
        "ROUND(NVL(A.RETURN_NO_PIT,0),10)," + //57
        "ROUND(NVL(A.ADVANCE_NO_PIT,0),10)," + //58 
        "DECODE('" + p_m_type + "','ALL',round(NVL(A.NET_AMT,0),0),'01',round(NVL(A.NET_AMT,0),0),round(NVL(A.NET_AMT,0),10)),  " + //59
        ...
        "ROUND(nvl(A.INC_AMT,0),10), " +                //64
        "ROUND( nvl(A.OST_L1,0),10), " +                       //65
        "ROUND(nvl(A.OST_L2,0),10), " +                       //66
        "ROUND( nvl(A.OHT_L1,0),10), " +                       //67
        "ROUND(nvl(A.OHT_L2,0),10) " +                       //68
        "from thr_month_salary a, tco_dept b, thr_group c " +         
        ...
        " order by nvl(b.seq,0),nvl(c.seq,0),a.THR_GROUP_NM,a.emp_id";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=4065 style='border-collapse:
 ...
 <tr class=xl63 height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  <td colspan=2 class=xl47 width=94 style='border-left:none;width:70pt'>ST,HT
  Hours<br>
    <font class="font8">CN và Lễ</font></td>
  <td colspan=2 class=xl47 width=94 style='border-left:none;width:70pt'>OST
  Hours<br>
    <font class="font8">T.C CN</font></td>
  <td colspan=2 class=xl47 width=94 style='border-left:none;width:70pt'>OHT
  Hours<br>
 ...
 <%
  ...
  <td rowspan=2 class=xl47 width=100 style='width:75pt'>Insurance (SI & UI 6%)<br>
    <font class="font8">Ti&#7873;n b&#7843;o hi&#7875;m</font></td>
   <td rowspan=2 class=xl47 width=100 style='width:75pt'>Insurance (HI 1%)<br>
    <font class="font8">Ti&#7873;n b&#7843;o hi&#7875;m</font></td> 
 ...
 <%
    ...
    double[] Group_GTotal = new double[icol_emp];
    int ino=0;
 ...
 <tr class=xl36 height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  <td class=xl35 style='border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][66].ToString()%></td>
  <td class=xl35 style='border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][67].ToString()%></td>
  <td class=xl35 style='border-left:none' x:num><span
...
<td class=xl59 x:num><%=Group_Total[7] %></td>
 ...
 <td class=xl60  x:num><%=Group_Total[12] %></td>
  ...
  <td class=xl60 x:num><%=Group_Total[58] %></td>
  <td class=xl60 x:num><%=Group_Total[59] %></td>
  <td class=xl60 x:num><%=Group_Total[60] %></td>
  <td class=xl60 x:num><%=Group_Total[61] %></td>
...
<td class=xl59 x:num><%=Group_GTotal[7] %></td>
 ...
 <td class=xl60  x:num><%=Group_GTotal[12] %></td>
  ...
  <td class=xl60 x:num><%=Group_GTotal[58] %></td>
  <td class=xl60 x:num><%=Group_GTotal[59] %></td>
  <td class=xl60 x:num><%=Group_GTotal[60] %></td>
  <td class=xl60 x:num><%=Group_GTotal[61] %></td>
