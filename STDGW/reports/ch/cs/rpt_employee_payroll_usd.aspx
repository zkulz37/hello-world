...
<%
   ...
   /* p_menu_id="10030007"; //menu salary report form (ko lay tu form truyen vao nhe)
    ...
    string p_dept,p_group,p_status,p_type,p_pay_type,p_emp_id,p_work_mon, p_m_type,p_emp_type;
   ...
   string SQL
	= "select a.THR_GROUP_NM,  " +                                  //1
        ...
        "A.POS_NM,  " +                                             //6
        "ROUND(NVL(A.SALARY_LEVEL1,0),10),  " +                               //7
        ...
        "ROUND(NVL(A.ST_L1,0) + nvl(A.HT_L1,0)+ nvl(A.OHT_L1,0),10), " +                       //26
        "ROUND(NVL(A.ST_L2,0) + nvl(A.HT_L2,0)+ nvl(A.OHT_L2,0),10), " +                       //27
        ...
        "ROUND(NVL(A.RETURN_AMT,0) + nvl(A.INC_AMT,0),10), " +                //45
        ...
        "ROUND(NVL(A.SOCIAL_AMT,0) + nvl(A.HEALTH_AMT,0) ,10),  " +           //56
        "ROUND(NVL(A.RETURN_NO_PIT,0) + NVL(A.ADJ_FOR_TAX,0),10)," + //57
        "ROUND(NVL(A.ADVANCE_NO_PIT,0),10)," + //58 
        "round(NVL(A.NET_AMT,0),2),  " +                               //57
        "NVL(A.EXCHANGE_RATE,0),  " +                               //58
         "ROUND(NVL(A.OT_TAX_L1_AMT,0)+NVL(A.OT_TAX_L2_AMT,0),10)," + //59
         "ROUND(NVL(A.DEDUCT_PIT,0),10)," + //60
         "ROUND(NVL(A.INCOME_AMT,0),10)," + //61
         "ROUND(NVL(A.UNEMP_INS,0),10)" + //62
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=4003 style='border-collapse:
 collapse;table-layout:fixed;width:3005pt'>
...
<col class=xl25 width=67 style='mso-width-source:userset;mso-width-alt:2450;
 ...
 <tr height=21 style='height:15.75pt'>
  ...
  <td class=xl28>EMPLOYEE'S PAYROLL IN <%=dt_Com.Rows[0][4].ToString()%></td>
  <td class=xl29 width=49 style='width:37pt'></td>
  <td class=xl29 width=49 style='width:37pt'></td>
  <td class=xl29 width=49 style='width:37pt'></td>
  <td class=xl29 width=49 style='width:37pt'></td>
 ...
 <tr height=34 style='height:25.5pt'>
  ...
  <td class=xl55>B&#7842;NG L&#431;&#416;NG NHÂN VIÊN THÁNG <%=dt_Com.Rows[0][5].ToString()%></td>
  <td colspan=20 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl25 style='mso-ignore:colspan'><%if (p_m_type!="01") 
                                            Response.Write("Tỉ giá:");  %></td>
  <td  class=xl25 colspan=2 style='mso-number-format:"_\(* \#\,\#\#0_\)\;_\(* \\\(\#\,\#\#0\\\)\;_\(* \0022-\0022_\)\;_\(\@_\)";' x:num><%if (p_m_type!="01") 
                                            Response.Write(dt_Emp.Rows[0][58].ToString());  %></td>
  <td class=xl29></td>
 </tr>
 ...
 <%
  ...
  <td colspan=2 class=xl47 width=136 style='border-left:none;width:102pt'>Remaining
  ALE<br>
  ...
  <td rowspan=2 class=xl46 width=72 style='width:54pt'>VND Exchange<br>
    <font class="font12">Quy đổi VND</font></td>      
  <td rowspan=2 class=xl47 width=85 style='width:64pt'>Union AMT<br>
    <font class="font8">Ti&#7873;n công &#273;oàn</font></td>
  <td rowspan=2 class=xl47 width=100 style='width:75pt'>Insurance (6%)<br>
    <font class="font8">Ti&#7873;n b&#7843;o hi&#7875;m</font></td>
  <td rowspan=2 class=xl47 width=100 style='width:75pt'>Unemployee Ins(1%)<br>
    <font class="font8">BH Thất nghiệp</font></td>  
 ...
 <%
    int i;
    double[] Group_Total=new double[65];
    double[] Group_GTotal=new double[65];
    double grp = 0, grand = 0; 
    int ino=0;
    ...
    {
        ino+=1;
        grp += double.Parse(dt_Emp.Rows[i][52].ToString())*int.Parse(dt_Emp.Rows[i][56].ToString()) ;
        grand += double.Parse(dt_Emp.Rows[i][52].ToString())*int.Parse(dt_Emp.Rows[i][56].ToString()) ;
        for (int j=6;j<icol_emp;j++)
        {
 ...
 <tr class=xl36 height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  <td class=xl32  x:num><%=dt_Emp.Rows[i][1].ToString()%></td>
  ...
  <td class=xl35 style='border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][59].ToString()%></td><!--ot 100 -->
  <%
        if (dt_Allowk.Rows[0][0].ToString()!="") //kiem tra xem co cac loai tro cap khong co dinh khong?
        {
    %>  
 ...
 <td class=xl35 style='border-left:none' x:num><span
  ...
  <td class=xl35 style='border-left:none' x:num><span style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][60].ToString()%></td>
  <td class=xl35 style='border-left:none' x:num><span style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][61].ToString()%></td>
  <td class=xl35 style='border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=dt_Emp.Rows[i][52].ToString()%> </td>
  <td class=xl35 style='border-left:none' x:num><span
  style='mso-spacerun:yes'> </span><%=Double.Parse(dt_Emp.Rows[i][52].ToString())*int.Parse(dt_Emp.Rows[i][56].ToString()) %> </td>
  <td class=xl35 style='border-left:none' x:num><span
 ...
 <tr class=xl30 height=46 style='mso-height-source:userset;height:34.5pt'>
  ...
  <%} %>
  <td class=xl56>&nbsp;</td>
  <td class=xl60  x:num><%=Group_Total[0] %></td>
  
  <td class=xl60  x:num><%=Group_Total[1] %></td>
  <%
        if (dt_Allow.Rows[0][8].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_Total[2] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][9].ToString()=="1")
        {
    %>
<td class=xl60 x:num><%=Group_Total[3] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][10].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_Total[4] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][11].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_Total[5] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][12].ToString()=="1")
        {
    %>
    <td class=xl60 x:num><%=Group_Total[6] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][13].ToString()=="1")
        {
    %>
<td class=xl60 x:num><%=Group_Total[7] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][14].ToString()=="1")
        {
    %>
 <td class=xl60 x:num><%=Group_Total[8] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][15].ToString()=="1")
        {
    %>
   <td class=xl60 x:num><%=Group_Total[9] %></td>
  <%} %>
 ...
 <td class=xl60  x:num><%=Group_Total[12] %></td>
  ...
  <td class=xl60  x:num><%=Group_Total[16] %></td>
  ...
  <td class=xl60  x:num><%=Group_Total[29] %></td>
  <td class=xl60  x:num><%=Group_Total[53] %></td>
    <%
        if (dt_Allowk.Rows[0][0].ToString()!="")
        {
    %>
    <td class=xl60 x:num><%=Group_Total[30] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][1].ToString()!="")
        {
    %>
   <td class=xl60  x:num><%=Group_Total[31] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][2].ToString()!="")
        {
    %>
  <td class=xl60 x:num><%=Group_Total[32] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][3].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_Total[33] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][4].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_Total[34] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][5].ToString()!="")
        {
    %>
  <td class=xl60 x:num><%=Group_Total[35] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][6].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_Total[36] %></td>
  <%} %>
  <%
        if (dt_Allowk.Rows[0][7].ToString()!="")
        {
    %>
   <td class=xl60 x:num><%=Group_Total[37] %></td>
  <%} %>
  <td class=xl60  x:num><%=Group_Total[38] %></td>
 
  <td class=xl60  x:num><%=Group_Total[39] %></td>
  <td class=xl60 x:num><%=Group_Total[40] %></td>
  <%
    if (p_status!="A")
    {
   %>
    <td class=xl60 x:num><%=Group_Total[41] %></td>
   <td class=xl60 x:num><%=Group_Total[42] %></td>
   
  <%}
   %>
   <td class=xl60  x:num><%=Group_Total[43] %></td>
  <%
    if (p_status!="A")
    {
   %>
   <td class=xl60  x:num><%=Group_Total[44] %></td>
 
  <%} %>
   <td class=xl60 x:num><%=Group_Total[45] %></td>
   <td class=xl60 x:num><%=Group_Total[54] %></td>
   <td class=xl60 x:num><%=Group_Total[55] %></td>
  <td class=xl60 x:num><%=Group_Total[46] %></td>
  <td class=xl60 x:num><%=grp %></td>
  <td class=xl60 x:num><%=Group_Total[47] %></td>
  <td class=xl60  x:num><%=Group_Total[48] %></td>
  <td class=xl60  x:num><%=Group_Total[56] %></td>
  <td class=xl60  x:num><%=Group_Total[49] %></td>
  <td class=xl60  x:num><%=Group_Total[50] %></td>
  <td class=xl60  x:num><%=Group_Total[51] %></td>
  <td class=xl60></td>
 </tr>
 <%
     grp = 0;        
...
<%
  ...
  <%} %>
  <td class=xl56>&nbsp;</td>
  <td class=xl60  x:num><%=Group_GTotal[0] %></td>
  
  <td class=xl60  x:num><%=Group_GTotal[1] %></td>
  <%
        if (dt_Allow.Rows[0][8].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_GTotal[2] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][9].ToString()=="1")
        {
    %>
<td class=xl60 x:num><%=Group_GTotal[3] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][10].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_GTotal[4] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][11].ToString()=="1")
        {
    %>
  <td class=xl60 x:num><%=Group_GTotal[5] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][12].ToString()=="1")
        {
    %>
    <td class=xl60 x:num><%=Group_GTotal[6] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][13].ToString()=="1")
        {
    %>
<td class=xl60 x:num><%=Group_GTotal[7] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][14].ToString()=="1")
        {
    %>
 <td class=xl60 x:num><%=Group_GTotal[8] %></td>
  <%} %>
  <%
        if (dt_Allow.Rows[0][15].ToString()=="1")
        {
    %>
   <td class=xl60 x:num><%=Group_GTotal[9] %></td>
  <%} %>
 ...
 <td class=xl60  x:num><%=Group_GTotal[12] %></td>
  ...
  <td class=xl60  x:num><%=Group_GTotal[16] %></td>
  ...
  <td class=xl60  x:num><%=Group_GTotal[29] %></td>
  <td class=xl60  x:num><%=Group_GTotal[53] %></td>
    <%
        if (dt_Allowk.Rows[0][0].ToString()!="")
        {
    %>
    <td class=xl60 x:num><%=Group_GTotal[30] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][1].ToString()!="")
        {
    %>
   <td class=xl60  x:num><%=Group_GTotal[31] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][2].ToString()!="")
        {
    %>
  <td class=xl60 x:num><%=Group_GTotal[32] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][3].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_GTotal[33] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][4].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_GTotal[34] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][5].ToString()!="")
        {
    %>
  <td class=xl60 x:num><%=Group_GTotal[35] %></td>
  <%} %>
    <%
        if (dt_Allowk.Rows[0][6].ToString()!="")
        {
    %>
 <td class=xl60  x:num><%=Group_GTotal[36] %></td>
  <%} %>
  <%
        if (dt_Allowk.Rows[0][7].ToString()!="")
        {
    %>
   <td class=xl60 x:num><%=Group_GTotal[37] %></td>
  <%} %>
  <td class=xl60  x:num><%=Group_GTotal[38] %></td>
  
  <td class=xl60  x:num><%=Group_GTotal[39] %></td>
  <td class=xl60 x:num><%=Group_GTotal[40] %></td>
  <%
    if (p_status!="A")
    {
   %>
   <td class=xl60 x:num><%=Group_GTotal[41] %></td>
   <td class=xl60 x:num><%=Group_GTotal[42] %></td>
   
  <%}
   %>
   <td class=xl60  x:num><%=Group_GTotal[43] %></td>
  <%
    if (p_status!="A")
    {
   %>
   <td class=xl60  x:num><%=Group_GTotal[44] %></td>
 
  <%} %>
   <td class=xl60 x:num><%=Group_GTotal[45] %></td>
   <td class=xl60 x:num><%=Group_GTotal[54] %></td>
   <td class=xl60 x:num><%=Group_GTotal[55] %></td>
   <td class=xl60 x:num><%=Group_GTotal[46] %></td>
   <td class=xl60 x:num><%=grand%></td>
  <td class=xl60 x:num><%=Group_GTotal[47] %></td>
  <td class=xl60  x:num><%=Group_GTotal[48] %></td>
  <td class=xl60  x:num><%=Group_GTotal[56] %></td>
  <td class=xl60  x:num><%=Group_GTotal[49] %></td>
  <td class=xl60  x:num><%=Group_GTotal[50] %></td>
  <td class=xl60  x:num><%=Group_GTotal[51] %></td>
