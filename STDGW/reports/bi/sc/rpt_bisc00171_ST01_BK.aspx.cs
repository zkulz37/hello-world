...
public partial class rpt_bisc00171_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dtInfo   = ESysLib.TableReadOpenCursor("LG_RPT_BISC00171_ST01", "'" + Session["User_ID"].ToString() + "'");
		
		string para = "'" + p_date + "'";		
		DataTable dtMaster = ESysLib.TableReadOpenCursor("LG_RPT_BISC00171_ST01_1", para);
		
		para = "'" + p_lang + "','" + p_wh_pk + "','" + p_item_group_pk + "','" + p_item + "','" + p_date + "'";		
        DataTable dtDetail = ESysLib.TableReadOpenCursor("LG_RPT_BISC00171_ST01_2", para);
