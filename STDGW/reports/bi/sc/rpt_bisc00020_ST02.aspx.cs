...
public partial class reports_bi_sc_rpt_bisc00020_ST02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dt  = ESysLib.TableReadOpenCursor("lg_rpt_bisc00020_ST02_1", "'" + Session["User_ID"].ToString() + "'");
        DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_bisc00020_ST02_2", para);
