...
public partial class rpt_bisc00020_ST05 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bisc00020_ST05_1", "'" + Session["User_ID"].ToString() + "'");
	 	 
		string para = "'" + p_wh_pk + "','" + p_from_date + "','" + p_to_date + "'";	
		
        DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_bisc00020_ST05_2", para);
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_type + "','" + p_wh_pk + "','" + p_item_group_pk + "','" + p_item + "','" + p_lang + "'";	
		
        DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bisc00020_ST05_3", para);
