...
public partial class rpt_bimc00040_FOSE02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bimc00040_FOSE02.xls";
        string TempFile = "../../../system/temp/rpt_bimc00040_FOSE02_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bimc00040_FOSE02_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bimc00040_FOSE02_2" , para);
