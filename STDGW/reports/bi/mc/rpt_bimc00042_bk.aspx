...
<body link="blue" vlink="purple">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="1168" style='border-collapse: collapse;
        ...
        <col width=190 style='mso-width-source:userset;mso-width-alt:6948;width:100pt'>
        ...
        <tr height="27" style='height: 20.25pt'>
            <td colspan="10" height="27" class="xl24" width="912" style='height: 20.25pt; width: 684pt'>
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td colspan="6" class="xl40" style=' border-left: none'>
                <%= dt.Rows[i]["wh_name"] %>
            </td>
            <td >
                Date: 
        ...
        <tr height="17" style='height: 12.75pt'> 
            ...
            <td class="xl29"  width="109" style='border-top: none; border-left: none; width: 82pt'>
                <%= dt1.Rows[y]["group_nm"]%><span style='mso-spacerun: yes'> </span>
            </td>     
