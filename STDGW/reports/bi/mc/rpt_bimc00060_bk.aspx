...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1030 style='border-collapse:
 ...
 <tr height=17 style='mso-height-source:userset;height:12.75pt'>
  <td colspan=15 rowspan=2 height=38 class=xl29 width=1030 style='height:28.5pt;
  width:774pt'>W/H Monthly Closing</td>
 </tr>
 ...
 <tr height=19 style='height:14.25pt'>
  ...
  <td class=xl24 colspan=3 style='mso-ignore:colspan'>Stock Date: <%= System.DateTime.ParseExact(p_stock_date, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture).ToString("MM/yyyy")%></td>
  <td colspan=8 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=18 colspan=15 style='height:12.75pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl31>U/Price</td>
  <td class=xl31>Out Amount</td>
  <td class=xl31>End Amount</td>
 </tr>
     <%
            string para = "'" + p_tin_warehouse_pk + "','" + p_stock_date + "'" ;
            DataTable dt = ESysLib.TableReadOpenCursor("INV.sp_rpt_bimc00060", para);
...
%> 
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl35 x:num><%= dt.Rows[i]["begin_qty"]%></td>
  ...
  <td class=xl35 x:num><%= dt.Rows[i]["out_amount"]%></td>
  <td class=xl35 x:num><%= dt.Rows[i]["amount"]%></td>
 </tr>
   <%
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl37 x:num><span style='mso-spacerun:yes'></span><%= TotalInQty%></td>
  <td class=xl28>&nbsp;</td>
  <td class=xl28>&nbsp;</td>
  <td class=xl28>&nbsp;</td>
  <td class=xl28>&nbsp;</td>
  ...
  <td class=xl28>&nbsp;</td>
  <td class=xl37 x:num><span style='mso-spacerun:yes'></span><%= TotalOutAmount%></td>
  <td class=xl37 x:num><span style='mso-spacerun:yes'></span><%= TotalAmount%></td>
 </tr>
