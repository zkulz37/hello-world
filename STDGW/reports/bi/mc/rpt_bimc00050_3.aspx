...
<body link="blue" vlink="purple">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="1168" style='border-collapse: collapse;
        ...
        <%
            ...
            DataTable dt,dt1;
            dt = ESysLib.TableReadOpenCursor("INV.SP_RPT_BIMC00051", para);
            
            para = " '" + p_tin_wh + "','" + p_from_date + "','" + p_to_date + "','" + p_item + "' ";           
            dt1 = ESysLib.TableReadOpenCursor("INV.SP_RPT_BIMC00051_1", para);
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl27" style='border-left: none' colspan=2 >
                Item Name
            </td>            
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl29" width="109" style='border-top: none; border-left: none; width: 82pt' colspan=2 >
                <%= dt1.Rows[y]["item_name"]%><span style='mso-spacerun: yes'> </span>
            </td>
            <td class="xl31" align="right" style='border-top: none; border-left: none' x:num>
                <%= dt1.Rows[y]["uom"]%>
            </td>
