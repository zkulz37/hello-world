...
<table x:str border=0 cellpadding=0 cellspacing=0 width=917 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 class=xl24 style='height:12.75pt'></td> <!--W/H: -->
  <td colspan=3 class=xl38></td>
  <td class=xl25></td><!--Stock Date: -->
  <td colspan=2 class=xl38></td>
  <td class=xl25></td><!--Charger: -->
  <td colspan=4 class=xl38 style='border-right:.5pt solid blue'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
