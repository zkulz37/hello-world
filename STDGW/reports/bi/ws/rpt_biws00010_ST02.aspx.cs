...
public partial class rpt_biws00010_ST02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_biws00010_ST02.xls";
        string TempFile = "../../../system/temp/rpt_biws00010_ST02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_biws00010_ST02_3", para);
		
		para = "'" + p_storage_pk + "','" + p_stock_date + "'";	
		DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_biws00010_ST02_2", para);
		
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_biws00010_ST02_1", "'" + Session["User_ID"].ToString() + "'");
        ...
        exSheet.Cells["E1"].Value = "Tell: " + dtInfo.Rows[0]["phone_no"].ToString();

        exSheet.Cells["E2"].Value = "Fax: " + dtInfo.Rows[0]["fax_no"].ToString();
        ...
        exSheet.Cells["F5"].Value = dtMaster.Rows[0]["range_date"].ToString() ;
        //---------
        ...
        {            		
			...
			exSheet.Cells[l_pos + i, 6].Value = dtDetail.Rows[i]["inv_qty"];		
        }

        exSheet.Cells[dtDetail.Rows.Count + 7, 6].Value = "=SUM(G7:G" + (dtDetail.Rows.Count + 6) + ")";       
