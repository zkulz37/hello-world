...
<table x:str border=0 cellpadding=0 cellspacing=0 width=917 style='border-collapse:
 ...
 <tr height=31 style='height:23.25pt'>
  ...
  height:23.25pt;width:690pt'>W/H Stock Closing</td>
              <% string para = " '" + p_pk + "'";
                  DataTable dt, dt1; 
                  dt = ESysLib.TableReadOpenCursor("INV.SP_RPT_BISA00050",para); 
 ...
 <% 
     para = " '" + p_pk + "'";
     dt1 = ESysLib.TableReadOpenCursor("INV.SP_RPT_BISA00050_1", para); 
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  height:12.75pt'>&nbsp;</td>
  <td class=xl33>&nbsp;</td>
  <td class=xl34 align=right x:num x:fmla="=SUM(F5:F<%= dt1.Rows.Count + 4 %>)"></td>
  <td class=xl33>&nbsp;</td>
  <td class=xl34 align=right x:num x:fmla="=SUM(H5:H<%= dt1.Rows.Count + 4 %>)"></td>
  <td class=xl33>&nbsp;</td>
  <td class=xl34 align=right x:num x:fmla="=SUM(J5:J<%= dt1.Rows.Count + 4 %>)"></td>
  <td class=xl33>&nbsp;</td>
  <td class=xl34 align=right x:num x:fmla="=SUM(L5:L<%= dt1.Rows.Count + 4 %>)"></td>
 </tr> 
