...
public partial class reports_rpt_bisa00011 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_sa_stock_eval_m_pk = Request["p_sa_stock_eval_m_pk"];
        string p_item                 = Request["p_item"];        

        string TemplateFile = "rpt_bisa00011.xls";
        string TempFile = "../../../system/temp/rpt_bisa00011_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_sa_stock_eval_m_pk + "','" + p_item + "'";
		
        DataTable dtInfo = ESysLib.TableReadOpenCursor("LG_RPT_bisa00011_1", "'" + Session["User_ID"].ToString() + "'");
		
        DataTable dtDetail = ESysLib.TableReadOpenCursor("LG_RPT_bisa00011", para);
