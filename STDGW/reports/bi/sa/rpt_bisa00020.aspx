...
<%    
    ...
    dt = ESysLib.TableReadOpenCursor("LG_RPT_BISA00020", para);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1030 style='border-collapse:
 ...
 <tr height=45 style='mso-height-source:userset;height:33.75pt'>
  ...
  width:773pt'>STOCK ADJUST ENTRY</td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl28 width=80 style='border-top:none;width:60pt'>Adjust Qty</td>
  <td class=xl28 width=95 style='border-top:none;width:71pt'>Adjust Amount</td>
  <td class=xl28 width=125 style='border-top:none;width:94pt'>Description</td>
 </tr>
 <%
