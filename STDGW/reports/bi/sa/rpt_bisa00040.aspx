    ...
    <table x:str border="0" cellpadding="0" cellspacing="0" width="1207" style='border-collapse: collapse;
        ...
        <tr height="31" style='height: 23.25pt'>
            <td colspan="12" height="31" class="xl30" width="1207" style='border-right: .5pt solid blue;
                ...
                W/H Stock Opening</td>
        </tr>
        <%
            string para = " '" + p_pk + "'";
            DataTable dt,dt1;
            dt = ESysLib.TableReadOpenCursor("INV.SP_RPT_BISA00040_1", para);
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl40">
                ...
                <%
            dt1 = ESysLib.TableReadOpenCursor("INV.SP_RPT_BISA00040_2", para);
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl29" align="right" x:num>
                <%= dt1.Rows[y]["open_qty"] %></td>
            <td class="xl28" align="right" x:num>
                <%= dt1.Rows[y]["open_amount"] %></td>
            <td class="xl28">
