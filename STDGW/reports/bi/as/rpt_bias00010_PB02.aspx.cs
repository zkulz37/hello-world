...
public partial class rpt_bias00010_PB02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bias00010_PB02.xls";
        string TempFile = "../../../system/temp/rpt_bias00010_PB02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_PB02", "'" + Session["User_ID"].ToString() + "'");
        ...
        DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_PB02_1", "'" + l_po_pk + "'");
        DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_PB02_2", "'" + l_po_pk + "'");
        if (dt2.Rows.Count == 0)
        {
            return;
        }
                ...
                for (int l_row = 0; l_row < dt2.Rows.Count; l_row++)
                {
                   ...
                   // exSheet.Cells.Rows[temp_row].RowHeight = 30;
                    ...
                    exSheet.Cells[temp_row, PRICE].Value =  dt2.Rows[l_row]["unit_price"];// unit price
                    exSheet.Cells[temp_row, TOTAL_AMT].Value = dt2.Rows[l_row]["total_amount"];// total amount
                ...
                exSheet.Cells[dt2.Rows.Count + 11, 6].Value = dt1.Rows[0]["vat_amount"]   ;
                exSheet.Cells[dt2.Rows.Count + 12, 6].Value = dt1.Rows[0]["total_amount"] ;
                */
