...
public partial class rpt_bias00010_ST02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bias00010_ST02.xls";
        string TempFile = "../../../system/temp/rpt_bias00010_ST02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_ST02", "'" + Session["User_ID"].ToString() + "'");
        ...
        DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_ST02_1", "'" + l_po_pk + "'");
        DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_ST02_2", "'" + l_po_pk + "'");
        if (dt2.Rows.Count == 0)
        {
            return;
        }
