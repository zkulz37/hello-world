...
<link rel=File-List href="rpt_bias00010_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bias00010_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bias00010_files/oledata.mso">
<!--[if gte mso 9]><xml>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=720 style='border-collapse:
 ...
 <col width=73 style='mso-width-source:userset;mso-width-alt:2669;width:55pt'>
        <%
            DataTable dt2 = ESysLib.TableReadOpenCursor("INV.sp_rpt_bias00010_2", "'" + master_pk + "'");
            DataTable dt;
            dt = ESysLib.TableReadOpenCursor("INV.sp_rpt_bias00010", "'" + master_pk + "'");            
 ...
 <tr height=22 style='mso-height-source:userset;height:16.5pt'>
  ...
  <td colspan=8 rowspan=3 class=xl35 width=455 style='width:343pt'>PHI&#7870;U
  CHUYỂN KHO <br>
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=6 height=25 class=xl37 style='height:18.75pt'>Kho xuất: <font
  class="font10"><%= dt.Rows[0]["out_name"]%><span
  style='mso-spacerun:yes'> </span></font></td>
  <td colspan=6 class=xl37>Kho nhận: <font class="font10"><%= dt.Rows[0]["in_name"]%><span
  style='mso-spacerun:yes'> </span></font></td>
 </tr>
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
 ...
 <tr class=xl58 height=16 style='height:12.0pt'>
  ...
  none'>S&#7889; l&#432;&#7907;ng</td>
  <td rowspan=2 class=xl38 style='border-bottom:.5pt solid black'>&#272;&#417;n
  giá</td>
  <td rowspan=2 class=xl38 style='border-bottom:.5pt solid black'>Thành
  ti&#7873;n</td>
 ...
 <%
            DataTable dt1;
            dt1 = ESysLib.TableReadOpenCursor("INV.sp_rpt_bias00010_1", "'" + master_pk + "'");
 ...
 <tr class=xl58 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl53 width=48 style='width:36pt'><%=dt1.Rows[i]["req_uom"]%></td>
  <td class=xl54 width=36 style='width:27pt' x:num><%=dt1.Rows[i]["req_qty"]%></td>
  <td class=xl55 width=37 style='width:28pt' x:num><%=dt1.Rows[i]["tr_qty"] %></td>
