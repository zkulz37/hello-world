...
public partial class reports_rpt_bias00100 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_line_pk   = Request["p_line_pk"];
        string p_item      = Request["p_item"];

        string TemplateFile = "rpt_bias00100.xls";
        string TempFile = "../../../system/temp/rpt_bias00100_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_pk + "','" + p_line_pk + "','" + p_item + "'";
		
        DataTable dtInfo = ESysLib.TableReadOpenCursor("LG_RPT_BIAS00100_1", "'" + Session["User_ID"].ToString() + "','" + p_from_date + "','" + p_to_date + "','" + p_wh_pk + "'");
        DataTable dtDetail = ESysLib.TableReadOpenCursor("LG_RPT_BIAS00100", para);
    ...
    xxx:
        ...
        {                        
			...
			exSheet.Cells[8 + l_row, 9 ].Value = dtDetail.Rows[l_row - 1]["t_line"].ToString(); 	
