...
public partial class rpt_bias00060_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bias00060_ST01.xls";
        string TempFile = "../../../system/temp/rpt_bias00060_ST01_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + po_pk + "'";		
		DataTable dt = ESysLib.TableReadOpenCursor("lg_rpt_bias00060_st01" , para);		
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bias00060_st01_1" , para);		  
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bias00060_st01_2", "'" + Session["User_ID"].ToString() + "'");	
        // MASTER   
		...
		{			
			...
			exSheet.Cells["H5"].Value = dt.Rows[0]["slip_no"];
			exSheet.Cells["H6"].Value = dt.Rows[0]["re_date"];
			exSheet.Cells["G8"].Value = dt.Rows[0]["ref_no"];
			exSheet.Cells["G7"].Value = dt.Rows[0]["wh_name"];
		}
        ...
        {								
			...
			exSheet.Cells[pos + i, 5 ].Value = dtDetail.Rows[i]["return_uom"]; 			
			exSheet.Cells[pos + i, 6 ].Value = dtDetail.Rows[i]["return_qty"];
			//exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["return_qty"];
