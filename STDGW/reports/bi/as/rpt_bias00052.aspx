...
<%  
    ...
    DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_bias00050", "'" + master_pk + "'");
    DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_bias00050_1", "'" + master_pk + "'");  
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="rpt_bias00052_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bias00052_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bias00052_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2011-11-25T03:38:41Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1049 style='border-collapse:
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:51px'><img width=107 height=51 src="rpt_bias00052_files/image002.jpg"
 ...
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td class=xl38 style='border-top:none;border-left:none'><%=dt1.Rows[0]["re_date"] %></td>
  <td colspan=2 class=xl33 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl66 width=120 style='height:22.5pt;width:91pt'>T&#7915;
  Line <font class="font7">From Line</font></td>
  <td colspan=2 class=xl73><%=dt1.Rows[0]["line_name"]%></td>
  <td colspan=2 class=xl75>Nh&#7853;p kho<font class="font7"> In W/H</font><font
  class="font5"><span style='mso-spacerun:yes'> </span></font></td>
  <td colspan=2 class=xl72><%=dt1.Rows[0]["wh_name"]%></td>
  <td class=xl39></td>
  <td class=xl29></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=2 class=xl74><%=dt1.Rows[0]["description"]%></td>
  <td colspan=2 class=xl76>S&#7889; &#273;&#7889;i chi&#7871;u <font
  class="font7">Ref No</font></td>
  <td colspan=2 class=xl77><%=dt1.Rows[0]["ref_no"]%></td>
 ...
 <tr height=45 style='mso-height-source:userset;height:33.75pt'>
  <td height=45 class=xl41 width=30 style='height:33.75pt;width:23pt' x:num><%=i+1 %></td>
  ...
  <td class=xl44 width=280 style='border-left:none;width:210pt'><%=dt2.Rows[i]["item_name"] %><br>
    <font class="font7"><%=dt2.Rows[i]["item_lname"] %></font></td>
  <td class=xl43 width=50 style='border-left:none;width:38pt'><%=dt2.Rows[i]["return_uom"] %></td>
  <td class=xl45 width=95 style='border-top:none;border-left:none;width:71pt'
  x:num><%=dt2.Rows[i]["return_qty"] %></td>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  colspan-rowspan;height:110.25pt;width:465pt'><!--[if gte vml 1]><v:shape
   ...
   <v:imagedata src="rpt_bias00052_files/image003.gif" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=421 height=127 src="rpt_bias00052_files/image003.gif"
