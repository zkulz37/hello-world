...
<table x:str border=0 cellpadding=0 cellspacing=0 width=720 style='border-collapse:
 ...
 <col width=73 style='mso-width-source:userset;mso-width-alt:2669;width:55pt'>
        <%
            DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_bias00010_2", "'" + master_pk + "'");
            DataTable dt;
            dt = ESysLib.TableReadOpenCursor("lg_rpt_bias00120_AMB", "'" + master_pk + "'");            
 ...
 <%
            DataTable dt1;
            dt1 = ESysLib.TableReadOpenCursor("lg_rpt_bias00120_1_AMB", "'" + master_pk + "'");
