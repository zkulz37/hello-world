...
<link rel=File-List href="rpt_bias00012_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bias00012_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bias00012_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2011-11-23T02:56:53Z</o:LastPrinted>
  <o:Created>2011-11-15T06:42:07Z</o:Created>
  <o:LastSaved>2011-11-23T08:07:58Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1049 style='border-collapse:
 ...
 <col class=xl41 width=30 style='mso-width-source:userset;mso-width-alt:1097;
 width:23pt'>
 <col class=xl41 width=90 span=2 style='mso-width-source:userset;mso-width-alt:
 3291;width:68pt'>
 <col class=xl41 width=280 style='mso-width-source:userset;mso-width-alt:10240;
 width:210pt'>
 <col class=xl41 width=50 style='mso-width-source:userset;mso-width-alt:1828;
 width:38pt'>
 <col class=xl41 width=95 span=2 style='mso-width-source:userset;mso-width-alt:
 3474;width:71pt'>
 <col class=xl41 width=100 style='mso-width-source:userset;mso-width-alt:3657;
 width:75pt'>
 <col class=xl41 width=110 style='mso-width-source:userset;mso-width-alt:4022;
 width:83pt'>
 <col class=xl41 width=109 style='mso-width-source:userset;mso-width-alt:3986;
 width:82pt'>
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:51px'><img width=107 height=51 src="rpt_bias00012_files/image002.jpg"
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl26></td>
  <td colspan=4 class=xl76 width=515 style='width:387pt'><%=dt.Rows[0]["addr1"] %></td>
  <td class=xl25></td>
 ...
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=6 rowspan=2 height=50 class=xl77 style='border-right:.5pt hairline black;
  height:37.5pt'>PHI&#7870;U CHUY&#7874;N KHO<font class="font9"> </font><font
  class="font14">(TRANSFER SLIP)</font></td>
  <td class=xl61 style='border-left:none'>S&#7889; <font class="font7">Slip No</font></td>
  <td class=xl39 style='border-left:none' x:num><%=dt1.Rows[0]["slip_no"]%></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl61 style='height:18.75pt;border-top:none;border-left:
  none'>Ngày<font class="font5"> </font><font class="font7">Date</font></td>
  <td class=xl39 style='border-top:none;border-left:none'><%=dt1.Rows[0]["dd"] %>/<%=dt1.Rows[0]["mm"] %>/<%=dt1.Rows[0]["yyyy"] %></td>
  <td colspan=2 class=xl33 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl73 width=120 style='height:22.5pt;width:91pt'>Kho
  xu&#7845;t <font class="font7">Out W/H</font></td>
  <td colspan=2 class=xl68><%=dt1.Rows[0]["out_name"]%></td>
  <td colspan=2 class=xl69>Kho nh&#7853;p<font class="font7"> In W/H</font><font
  class="font5"><span style='mso-spacerun:yes'> </span></font></td>
  <td colspan=2 class=xl64><%=dt1.Rows[0]["in_name"]%></td>
  <td class=xl40></td>
  <td class=xl29></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl73 width=120 style='height:22.5pt;width:91pt'>Di&#7877;n
  gi&#7843;i <font class="font7">Description</font></td>
  <td colspan=2 class=xl70><%=dt1.Rows[0]["description"]%></td>
  <td colspan=2 class=xl71>S&#7889; P/O <font class="font7">PO No</font></td>
  <td colspan=2 class=xl72><%=dt1.Rows[0]["ref_no"]%></td>
  <td colspan=2 class=xl40 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=55 class=xl79 width=30 style='border-bottom:.5pt solid black;
  ...
  <td rowspan=2 class=xl67 width=280 style='border-bottom:.5pt solid black;
  ...
  <td colspan=2 class=xl67 width=190 style='border-left:none;width:142pt'>S&#7889;
  l&#432;&#7907;ng<font class="font7"> Quantity</font></td>
  <td rowspan=2 class=xl65 width=100 style='border-bottom:.5pt solid black;
 ...
 <tr height=35 style='mso-height-source:userset;height:26.25pt'>
  <td height=35 class=xl42 width=95 style='height:26.25pt;border-top:none;
  border-left:none;width:71pt'>Yêu c&#7847;u<br>
    <font class="font7">Req</font></td>
  <td class=xl42 width=95 style='border-top:none;border-left:none;width:71pt'>Th&#7921;c
  xu&#7845;t<br>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl43 width=30 style='height:30.0pt;border-top:none;
  width:23pt' x:num><%=i+1 %></td>
  <td class=xl44 width=90 style='border-top:none;border-left:none;width:68pt'><%=dt2.Rows[i]["ref_no"]%></td>
  <td class=xl45 width=90 style='border-top:none;border-left:none;width:68pt'
  x:num><%=dt2.Rows[i]["item_code"]%></td>
  <td class=xl46 width=280 style='border-top:none;border-left:none;width:210pt'><%=dt2.Rows[i]["item_name"]%></td>
  <td class=xl45 width=50 style='border-top:none;border-left:none;width:38pt'><%=dt2.Rows[i]["req_uom"]%></td>
  <td class=xl47 width=95 style='border-top:none;border-left:none;width:71pt'
  x:num><%=dt2.Rows[i]["req_qty"]%></td>
  <td class=xl47 width=95 style='border-top:none;border-left:none;width:71pt'
  x:num><%=dt2.Rows[i]["tr_qty"]%></td>
  <td class=xl48 width=100 style='border-top:none;border-left:none;width:75pt'><%=dt2.Rows[i]["description"]%></td>
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  <td colspan=5 height=38 class=xl74 width=540 style='height:28.5pt;width:407pt'>T&#7893;ng
  c&#7897;ng<span style='mso-spacerun:yes'>  </span><font class="font12">Total</font></td>
  <td class=xl62 width=95 style='border-top:none;width:71pt' x:num><%=total1 %></td>
  <td class=xl63 style='border-top:none;border-left:none' x:num><%=total2 %></td>
  <td class=xl38>&nbsp;</td>
  <td colspan=2 class=xl37 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  <td height=28 colspan=3 class=xl41 style='height:21.0pt;mso-ignore:colspan'></td>
  <td colspan=5 rowspan=8 height=147 class=xl41 width=620 style='mso-ignore:
  colspan-rowspan;height:110.25pt;width:465pt'><!--[if gte vml 1]><v:shape
   id="_x0000_s8195" type="#_x0000_t75" style='position:absolute;margin-left:137.25pt;
   margin-top:10.5pt;width:315.75pt;height:95.25pt;z-index:2' fillcolor="windowText [64]"
   strokecolor="window [65]" strokeweight="3e-5mm" o:insetmode="auto">
   <v:fill color2="window [65]"/>
   <v:imagedata src="rpt_bias00012_files/image003.gif" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    <td width=183 height=14></td>
   </tr>
   <tr>
    <td></td>
    <td><img width=421 height=127 src="rpt_bias00012_files/image003.gif"
 ...
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=3 class=xl41 style='height:12.75pt;mso-ignore:colspan'></td>
  <td colspan=2 class=xl41 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=3 class=xl41 style='height:12.75pt;mso-ignore:colspan'></td>
