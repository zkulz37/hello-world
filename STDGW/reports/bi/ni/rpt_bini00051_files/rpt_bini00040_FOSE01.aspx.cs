...
public partial class rpt_bini00040_FOSE01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00040_FOSE01.xls";
        string TempFile = "../../../system/temp/rpt_bini00040_FOSE01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bini00040_FOSE01_1" , "'" + Session["User_ID"].ToString() + "'");	
		
		para = "'" + p_wh_type + "','" + p_wh_pk + "','" + p_from_dt + "','" + p_to_dt + "','" + p_po_vendor + "','" + p_itemgrp_pk + "','" + p_item + "'";	
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bini00040_FOSE01_2" , para);	
