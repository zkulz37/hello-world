...
<%    
    ...
    DataTable dt;
    dt = ESysLib.TableReadOpenCursor("lg_rpt_bini00094", para); 
...
<body link="blue" vlink="purple">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="1038" style='border-collapse: collapse;
        ...
        <tr height="17" style='height: 12.75pt'>
            ...
            <td class="xl30" align="right" x:num x:fmla="=SUM(D3:D<%= dt.Rows.Count > 0 ? dt.Rows.Count + 2:3 %>)">
            </td>
            <td class="xl29">
                &nbsp;
            </td>
            <td class="xl30" align="right" x:num x:fmla="=SUM(F3:F<%= dt.Rows.Count > 0 ? dt.Rows.Count + 2:3 %>)">
            </td>
            <td class="xl30" align="right" x:num x:fmla="=SUM(G3:G<%= dt.Rows.Count > 0 ? dt.Rows.Count + 2:3 %>)">
            </td>
            <td>
            </td>
        </tr>
