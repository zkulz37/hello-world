...
<% 
    ...
    DataTable dt2 = ESysLib.TableReadOpenCursor("INV.sp_rpt_bini00030_1", "'" + master_pk + "'");
    DataTable dt = ESysLib.TableReadOpenCursor("INV.sp_rpt_bini00030", "'" + master_pk + "'");
...
<link rel=File-List href="rpt_bini00032_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bini00032_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bini00032_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2011-11-23T04:12:54Z</o:LastPrinted>
  <o:Created>2011-11-15T06:42:07Z</o:Created>
  <o:LastSaved>2011-11-23T04:13:10Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1249 style='border-collapse:
 ...
 <col class=xl77 width=43 style='mso-width-source:userset;mso-width-alt:1572;
 width:32pt'>
 <col class=xl77 width=97 style='mso-width-source:userset;mso-width-alt:3547;
 width:73pt'>
 <col class=xl77 width=90 style='mso-width-source:userset;mso-width-alt:3291;
 width:68pt'>
 <col class=xl77 width=250 style='mso-width-source:userset;mso-width-alt:9142;
 width:188pt'>
 <col class=xl77 width=50 style='mso-width-source:userset;mso-width-alt:1828;
 width:38pt'>
 <col class=xl77 width=90 span=2 style='mso-width-source:userset;mso-width-alt:
 3291;width:68pt'>
 <col class=xl77 width=80 style='mso-width-source:userset;mso-width-alt:2925;
 width:60pt'>
 <col class=xl77 width=100 span=3 style='mso-width-source:userset;mso-width-alt:
 3657;width:75pt'>
 <col class=xl77 width=95 style='mso-width-source:userset;mso-width-alt:3474;
 width:71pt'>
 <col class=xl77 width=64 style='width:48pt'>
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:56px'><img width=94 height=56 src="rpt_bini00032_files/image002.jpg"
  ...
  <td colspan=3 class=xl72 width=390 style='width:294pt'><%=dt1.Rows[0]["partner_name"]%></td>
  ...
  <td width=80 style='width:60pt' align=left valign=top><!--[if gte vml 1]><v:shape
   id="_x0000_s3074" type="#_x0000_t75" style='position:absolute;margin-left:35.25pt;
   margin-top:3pt;width:294.75pt;height:93pt;z-index:2' fillcolor="windowText [64]"
   strokecolor="window [65]" strokeweight="3e-5mm" o:insetmode="auto">
   <v:fill color2="window [65]"/>
   <v:imagedata src="rpt_bini00032_files/image003.png" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  position:absolute;z-index:2;margin-left:47px;margin-top:4px;width:393px;
  height:124px'><img width=393 height=124 src="rpt_bini00032_files/image004.jpg"
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl26></td>
  <td colspan=3 class=xl71 width=390 style='width:294pt'><%=dt1.Rows[0]["addr1"]%></td>
  <td class=xl59></td>
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl25 style='height:15.0pt'></td>
  <td class=xl26></td>
  <td colspan=3 class=xl73>Tax No: <%=dt1.Rows[0]["tax_code"]%></td>
  <td class=xl25></td>
 ...
 <tr class=xl28 height=74 style='mso-height-source:userset;height:55.5pt'>
  <td colspan=7 height=74 class=xl75 style='height:55.5pt'>PHI&#7870;U
  NH&#7852;P KHO<font class="font9"> </font><font class="font17">(INCOMING
  SLIP)</font> Liên 2: Kế toán</td>
  <td class=xl28></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
  <td class=xl28></td>
 </tr>
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl62 width=140 style='height:22.5pt;width:105pt'>Nhà
  cung c&#7845;p <font class="font7">Supplier</font></td>
  <td colspan=3 class=xl61><%=dt.Rows[0]["supplier_name"]%></td>
  <td class=xl30>Kho<font class="font7"> In WH</font></td>
  <td colspan=3 class=xl76><%=dt.Rows[0]["wh_name"]%></td>
  <td colspan=2 class=xl70>S&#7889; phi&#7871;u <font class="font13">Slip No</font></td>
  <td class=xl60 style='border-left:none' x:num><%=dt.Rows[0]["slip_no"]%></td>
  <td class=xl28></td>
 </tr>
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl62 width=140 style='height:22.5pt;width:105pt'>Di&#7877;n
  gi&#7843;i <font class="font7">Description</font></td>
  <td colspan=3 class=xl74><%=dt.Rows[0]["description"]%></td>
  <td class=xl30>S&#7889; P/O <font class="font7">PO No</font></td>
  <td colspan=3 class=xl76><%=dt.Rows[0]["ref_no"]%></td>
  <td colspan=2 class=xl70>Ngày<font class="font14"> </font><font class="font13">Date</font></td>
  <td class=xl60 style='border-top:none;border-left:none'><%=dt.Rows[0]["dd"]%>/<%=dt.Rows[0]["mm"]%>/<%=dt.Rows[0]["yyyy"]%></td>
  <td class=xl28></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=13 class=xl77 style='height:12.75pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td rowspan=2 class=xl65 width=97 style='border-bottom:.5pt solid black;
  width:73pt'>S&#7889; &#272;&#7889;i chi&#7871;u<br>
    <font class="font7">Ref No</font></td>
  <td rowspan=2 class=xl65 width=90 style='border-bottom:.5pt solid black;
  width:68pt'>Mã hàng<br>
    <font class="font7">Item Code</font></td>
  <td rowspan=2 class=xl65 width=250 style='border-bottom:.5pt solid black;
  width:188pt'>Tên hàng<br>
    <font class="font7">Item Description</font></td>
  <td rowspan=2 class=xl65 width=50 style='border-bottom:.5pt solid black;
  width:38pt'>&#272;VT<br>
    <font class="font7">Unit</font></td>
  <td colspan=2 class=xl65 width=180 style='border-left:none;width:136pt'>S&#7889;
  l&#432;&#7907;ng<font class="font7"> Quantity</font></td>
  <td rowspan=2 class=xl65 width=80 style='border-bottom:.5pt solid black;
  ...
  <td rowspan=2 class=xl68 width=95 style='border-bottom:.5pt solid black;
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl36 width=43 style='height:30.0pt;border-top:none;
  ...
  <td class=xl39 width=250 style='border-top:none;border-left:none;width:188pt'><%=dt2.Rows[i]["item_name"]%></td>
  ...
  <td class=xl40 width=90 style='border-top:none;border-left:none;width:68pt'
  x:num><%=dt2.Rows[i]["in_qty"]%></td>
  <td class=xl41 width=80 style='border-top:none;border-left:none;width:60pt'
  ...
  <td class=xl40 width=100 style='border-top:none;border-left:none;width:75pt'
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td colspan=5 height=40 class=xl63 width=530 style='height:30.0pt;width:399pt'>T&#7893;ng
  ...
  <td class=xl57 style='border-top:none;border-left:none' x:num><%=total2 %></td>
  <td class=xl78 style='border-top:none'>&nbsp;</td>
  <td class=xl58 width=100 style='border-top:none;width:75pt' x:num><%=total3 %></td>
  <td class=xl58 width=100 style='border-top:none;border-left:none;width:75pt'
  x:num><%=total4 %></td>
  <td class=xl58 width=100 style='border-top:none;border-left:none;width:75pt'
  x:num><%=total5 %></td>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  <td height=28 colspan=13 class=xl77 style='height:21.0pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=13 class=xl77 style='height:12.75pt;mso-ignore:colspan'></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
  <td height=17 colspan=2 class=xl77 style='height:12.75pt;mso-ignore:colspan'></td>
