...
<link rel=File-List href="rpt_bini00034_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bini00034_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bini00034_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastPrinted>2011-11-23T04:28:57Z</o:LastPrinted>
  <o:Created>2011-11-15T06:42:07Z</o:Created>
  <o:LastSaved>2011-11-23T04:29:14Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1049 style='border-collapse:
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  height:51px'><img width=107 height=51 src="rpt_bini00034_files/image002.jpg"
  ...
  <td class=xl26 colspan=2 width=370 style='mso-ignore:colspan;width:278pt'><%=dt1.Rows[0]["partner_name"]%></td>
  <td class=xl25 width=50 style='width:38pt'></td>
  <td class=xl25 width=95 style='width:71pt'></td>
  <td class=xl25 width=95 style='width:71pt'></td>
  <td class=xl27 width=100 style='width:75pt'>Tel: <%=dt1.Rows[0]["phone_no"]%></td>
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl26></td>
  <td colspan=4 class=xl70 width=515 style='width:387pt'><%=dt1.Rows[0]["addr1"]%></td>
  <td class=xl25></td>
 ...
 <tr class=xl25 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td class=xl33>&nbsp;</td>
  <td class=xl32 colspan=2 style='mso-ignore:colspan'>Tax No: <%=dt1.Rows[0]["tax_code"]%></td>
  <td class=xl32>&nbsp;</td>
  <td class=xl32>&nbsp;</td>
  <td class=xl32>&nbsp;</td>
 ...
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=6 rowspan=2 height=50 class=xl71 style='border-right:.5pt hairline black;
  height:37.5pt'>PHI&#7870;U NH&#7852;P KHO<font class="font9"> </font><font
  class="font14">(INCOMING SLIP)</font></td>
  <td class=xl62 style='border-left:none'>S&#7889; <font class="font7">Slip No</font></td>
  <td class=xl40 style='border-left:none' x:num><%=dt.Rows[0]["slip_no"]%></td>
  <td colspan=2 class=xl29 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl62 style='height:18.75pt;border-top:none;border-left:
  none'>Ngy<font class="font5"> </font><font class="font7">Date</font></td>
  <td class=xl40 style='border-top:none;border-left:none'><%=dt.Rows[0]["dd"]%>/<%=dt.Rows[0]["mm"]%>/<%=dt.Rows[0]["yyyy"]%></td>
  <td colspan=2 class=xl34 style='mso-ignore:colspan'></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl73 width=120 style='height:22.5pt;width:91pt'>NCC
  <font class="font7">Supplier</font></td>
  <td colspan=3 class=xl76><%=dt.Rows[0]["supplier_name"]%></td>
  <td class=xl30>Kho<font class="font7"> In WH</font><font class="font5"><span
  style='mso-spacerun:yes'></span></font></td>
  <td colspan=2 class=xl78><%=dt.Rows[0]["wh_name"]%></td>
  <td class=xl41></td>
  <td class=xl29></td>
 </tr>
 <tr class=xl29 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=3 class=xl77><%=dt.Rows[0]["description"]%></td>
  <td class=xl30>S&#7889; P/O <font class="font7">PO No</font></td>
  <td colspan=2 class=xl79><%=dt.Rows[0]["ref_no"]%></td>
  <td colspan=2 class=xl41 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=20 style='mso-height-source:userset;height:15.0pt'>
  <td rowspan=2 height=55 class=xl74 width=30 style='border-bottom:.5pt solid black;
  ...
  border-top:none;width:75pt'>Ghi ch�<br>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl44 width=30 style='height:30.0pt;border-top:none;
  ...
  <td class=xl47 width=280 style='border-top:none;border-left:none;width:210pt'><%=dt2.Rows[i]["item_name"]%></td>
  <td class=xl46 width=50 style='border-top:none;border-left:none;width:38pt'><%=dt2.Rows[i]["in_uom"]%></td>
 ...
 <tr height=38 style='mso-height-source:userset;height:28.5pt'>
  <td colspan=5 height=38 class=xl68 width=540 style='height:28.5pt;width:407pt'>T&#7893;ng
  ...
  <td class=xl64 style='border-top:none;border-left:none' x:num><%=total2 %></td>
  <td class=xl39>&nbsp;</td>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  ...
  colspan-rowspan;height:110.25pt;width:465pt'><!--[if gte vml 1]><v:shape
   id="_x0000_s8194" type="#_x0000_t75" style='position:absolute;margin-left:147.75pt;
   margin-top:11.25pt;width:302.25pt;height:93pt;z-index:2' fillcolor="windowText [64]"
   strokecolor="window [65]" strokeweight="3e-5mm" o:insetmode="auto">
   <v:fill color2="window [65]"/>
   <v:imagedata src="rpt_bini00034_files/image003.png" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=403 height=124 src="rpt_bini00034_files/image004.gif"
