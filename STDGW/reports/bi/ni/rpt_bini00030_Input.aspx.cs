...
public partial class rpt_bini00030_Input : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00030_Input.xls";
        string TempFile = "../../../system/temp/rpt_bini00030_Input_" + Session["User_ID"].ToString() + ".xls";
		...
		//DataTable dt = ESysLib.TableReadOpenCursor("lg_rpt_epbp00010_st01" , para);		
		//DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_epbp00010_st01_1" , para);		  
	//	DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00010_st01_2", "'" + Session["User_ID"].ToString() + "'");	
		...
		if( dt.Rows.Count >0)
		{
			exSheet.Cells["A5"].Value = "  Date : " +dt.Rows[0]["pr_no"];
			exSheet.Cells["D5"].Value = "P/R No : "+dt.Rows[0]["req_date"];
			exSheet.Cells["C6"].Value = dt.Rows[0]["dept_name"];
			exSheet.Cells["C7"].Value = dt.Rows[0]["full_name"];
			exSheet.Cells["G7"].Value = dt.Rows[0]["etd_from"];
		}
        ...
        */// END MASTER
		...
		//	exSheet.Cells[pos + i, 2 ].Value = dtDetail.Rows[i]["item_name"]+" "+dtDetail.Rows[i]["item_lname"];
			//exSheet.Cells[pos + i, 4 ].Value = dtDetail.Rows[i]["pr_no"];
