...
public partial class rpt_bini00150_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00150_ST01.xls";
        string TempFile = "../../../system/temp/rpt_bini00150_ST01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bini00150_ST01_1", "'" + Session["User_ID"].ToString() + "'");			
		DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_bini00150_ST01_2" , para);		
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bini00150_ST01_3" , para);		
		...
		if( dtMaster.Rows.Count >0)
		{
			...
			exSheet.Cells["C6"].Value = dtMaster.Rows[0]["line_name"];
        ...
        {								
			...
			total_sub += Convert.ToDouble(dtDetail.Rows[i]["out_qty"]);			 
