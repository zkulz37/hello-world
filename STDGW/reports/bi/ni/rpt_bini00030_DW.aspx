...
<link rel=File-List href="rpt_epfm00030_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_epfm00030_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_epfm00030_files/oledata.mso">
<!--[if gte mso 9]><xml>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=711 style='border-collapse:
 ...
 <col width=80 style='mso-width-source:userset;mso-width-alt:2925;width:60pt'>
        <%
            DataTable dt2 = ESysLib.TableReadOpenCursor("INV.sp_rpt_epfm00030_2", "'" + master_pk + "'");
            DataTable dt;
            dt = ESysLib.TableReadOpenCursor("INV.sp_rpt_epfm00030", "'" + master_pk + "'");            
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=6 height=25 class=xl61 style='height:18.75pt'>Lo&#7841;i ti&#7873;n : <%=dt.Rows[0]["ccy"] %></td>
  <td colspan=6 class=xl61>T&#7881; gi&#225; : <font class="font14"> <%=dt.Rows[0]["ex_rate"]%><span
  style='mso-spacerun:yes'> </span></font></td>
 </tr>
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=6 height=25 class=xl61 style='height:18.75pt'>Ghi chú: <%=dt.Rows[0]["description"]%></td>
  <td colspan=6 class=xl61>S&#7889; Ref No : <font class="font14"><%=dt.Rows[0]["ref_no"]%><span
  style='mso-spacerun:yes'> </span></font></td>
 </tr>
...
<%
            DataTable dt1;
            dt1 = ESysLib.TableReadOpenCursor("INV.sp_rpt_epfm00030_1", "'" + master_pk + "'");
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td></td>
  <td class=xl33 colspan=3 align=left style='mso-ignore:colspan'>
  </td>
  <td></td>
