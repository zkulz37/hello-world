...
public partial class rpt_bini00030_kb01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00030_kb01.xls";
        string TempFile = "../../../system/temp/rpt_bini00030_kb01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt = ESysLib.TableReadOpenCursor("lg_rpt_bini00030_kb01" , para);		
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bini00030_kb01_1" , para);		  
	//	DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00010_st01_2", "'" + Session["User_ID"].ToString() + "'");	
        ...
        {									
			...
			exSheet.Cells[pos + i, 4 ].Value = dtDetail.Rows[i]["in_item_name"];
			exSheet.Cells[pos + i, 6 ].Value = dtDetail.Rows[i]["in_uom"]; 
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["in_qty"];	
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["unit_price"];			
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["total_amount"]; 			
        }
		exSheet.Cells["i30"].Value =dtDetail.Rows[0]["item_amount"];
		exSheet.Cells["i31"].Value =dt.Rows[0]["tax_amt"];
		exSheet.Cells["i32"].Value =dtDetail.Rows[0]["total_amount"];
		exSheet.Cells["i28"].Value =dt.Rows[0]["ex_rate"];
			exSheet.Cells["d30"].Value =dtDetail.Rows[0]["total_amount"];
		//---------
