...
public partial class rpt_bini00090_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_bini00090_ST01.xls";
        string TempFile = "../../../system/temp/rpt_bini00090_ST01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_bini00090_ST01_1", "'" + Session["User_ID"].ToString() + "'");			
			
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_bini00090_ST01_3" , para);		
        ...
        {								
			...
			exSheet.Cells[ pos + i, 4 ].Value = dtDetail.Rows[i]["out_type"];					
			exSheet.Cells[ pos + i, 5 ].Value = dtDetail.Rows[i]["ref_no"];		
			exSheet.Cells[ pos + i, 6 ].Value = dtDetail.Rows[i]["seq"];
			exSheet.Cells[ pos + i, 7 ].Value = dtDetail.Rows[i]["item_code"];
			exSheet.Cells[ pos + i, 8 ].Value = dtDetail.Rows[i]["item_name"]; 
			exSheet.Cells[ pos + i, 9 ].Value = dtDetail.Rows[i]["out_uom"];
			exSheet.Cells[ pos + i,10 ].Value = dtDetail.Rows[i]["lot_no"];
			exSheet.Cells[ pos + i,11 ].Value = dtDetail.Rows[i]["out_qty"];
			exSheet.Cells[ pos + i,12 ].Value = dtDetail.Rows[i]["unit_price"];
			exSheet.Cells[ pos + i,13 ].Value = dtDetail.Rows[i]["item_amount"];
			exSheet.Cells[ pos + i,14 ].Value = dtDetail.Rows[i]["vat_rate"];
			exSheet.Cells[ pos + i,15 ].Value = dtDetail.Rows[i]["vat_amount"];
			exSheet.Cells[ pos + i,16 ].Value = dtDetail.Rows[i]["total_amount"];
			exSheet.Cells[ pos + i,17 ].Value = dtDetail.Rows[i]["ccy"];
			exSheet.Cells[ pos + i,18 ].Value = dtDetail.Rows[i]["dis_amount"];
			exSheet.Cells[ pos + i,19 ].Value = dtDetail.Rows[i]["dept_name"];
			exSheet.Cells[ pos + i,20 ].Value = dtDetail.Rows[i]["line_name"];
			exSheet.Cells[ pos + i,21 ].Value = dtDetail.Rows[i]["pl"];
			exSheet.Cells[ pos + i,22 ].Value = dtDetail.Rows[i]["charger"];
			exSheet.Cells[ pos + i,23 ].Value = dtDetail.Rows[i]["description"];
		...
		exSheet.Cells[pos + i, 15].Value = "=sum(O6:O"+t+")";
		exSheet.Cells[pos + i, 16].Value = "=sum(P6:P"+t+")";
		exSheet.Cells[pos + i, 18].Value = "=sum(R6:R"+t+")";
