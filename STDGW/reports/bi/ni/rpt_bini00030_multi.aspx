...
<link rel=File-List href="rpt_bini00030_multi_language_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bini00030_multi_language_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bini00030_multi_language_files/oledata.mso">
<!--[if gte mso 9]><xml>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=683 style='border-collapse:
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=7 height=25 class=xl43 style='height:18.75pt'>Nhà cung c&#7845;p:
  <font class="font10"><%= dt.Rows[0]["supplier_name"] %><span
  style='mso-spacerun:yes'> </span></font></td>
  <td colspan=5 class=xl43>Nh&#7853;p Kho : <font class="font10"><%= dt.Rows[0]["wh_name"] %><span
  style='mso-spacerun:yes'> </span></font></td>
 </tr>
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=7 height=25 class=xl43 style='height:18.75pt'>Ghi chú: <%=dt.Rows[0]["description"] %></td>
  <td colspan=5 class=xl43>S&#7889; P/O : <font class="font10"><%=dt.Rows[0]["ref_no"]%><span
  style='mso-spacerun:yes'> </span></font></td>
 </tr>
 <tr height=20 style='height:15.0pt'>
...
<%
 ...
 <tr height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td class=xl29 width=50 style='border-top:none;width:38pt'><%=dt1.Rows[i]["in_uom"]%></td>
  <td class=xl30 width=36 style='width:27pt' x:num><%=dt1.Rows[i]["req_qty"] %></td>
  <td class=xl31 width=37 style='width:28pt' x:num><%=dt1.Rows[i]["in_qty"] %></td>
