...
<% 
    string master_pk = Request.QueryString["master_pk"];
                DataTable dt1;
            dt1 = ESysLib.TableReadOpenCursor("INV.sp_rpt_bini00050_1", "'" + master_pk + "'");
    string str_sql = @"SELECT partner_name, addr1, phone_no, fax_no, tax_code, tco_bpphoto_pk
        ...
        DataTable dt =                                           ESysLib.TableReadOpenCursor("INV.sp_rpt_bini00050", "'" + master_pk + "'");         
    DataTable dt3 = ESysLib.TableReadOpen(str_sql);        
    DataTable dt2 = ESysLib.TableReadOpenCursor("INV.sp_rpt_bini00050_2", "'" + master_pk + "'");    
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="rpt_bini00050_ENG_VN_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_bini00050_ENG_VN_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_bini00050_ENG_VN_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2011-10-11T06:21:59Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=851 style='border-collapse:
 ...
 <tr class=xl27 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl28 width=30 style='height:18.75pt;width:23pt' x:num><%=dt1.Rows[i]["seq"]%></td>
  <td colspan=3 class=xl44 width=235 style='border-right:.5pt solid black;
  border-left:none;width:177pt'><%=dt1.Rows[i]["item_name"]%></td>
