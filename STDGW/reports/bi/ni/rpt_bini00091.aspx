...
<% 
    ...
    dt = ESysLib.TableReadOpenCursor("lg_rpt_bini00091", "'" + wh_pk + "','" + dt_from + "','" + dt_to + "','" + ccy+"'");
    if (dt.Rows.Count > 0)
    {
...
<link rel=File-List href="bini00021_files/filelist.xml">
<link rel=Edit-Time-Data href="bini00021_files/editdata.mso">
<link rel=OLE-Object-Data href="bini00021_files/oledata.mso">
<!--[if gte mso 9]><xml>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1055 style='border-collapse:
 ...
 <tr height=31 style='height:23.25pt'>
  <td colspan=9 height=31 class=xl25 width=991 style='border-right:.5pt solid black;
  height:23.25pt;width:743pt'>Report Stock Incoming Checking</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl28 style='border-top:none;border-left:none'>Total <%=ccy%> Amount</td>
  <td class=xl24></td>
 </tr>
 <%
     double tot_qty = 0, tot_amt = 0, tot_vat_amt = 0, tot_total_amt = 0, tot_dis_amt=0;
     for (int i = 1; i < dt.Rows.Count; i++)
     {
         tot_qty = tot_qty + CommondLib.ConvertToDbl(dt.Rows[i]["out_qty"].ToString());
         ...
         tot_dis_amt = tot_dis_amt + CommondLib.ConvertToDbl(dt.Rows[i]["dis_amount"].ToString());
         %>
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl41 style='border-top:none;border-left:none'><%=dt.Rows[i]["out_uom"]%></td>
  <td class=xl41 style='border-top:none;border-left:none'><%=dt.Rows[i]["ccy"]%></td>
  <td class=xl39 style='border-top:none;border-left:none'x:num><%=dt.Rows[i]["out_qty"]%></td>
  ...
  <td class=xl40 style='border-top:none;border-left:none'x:num><%=dt.Rows[i]["dis_amount"]%></td>
  <td class=xl24></td>
 </tr>
         <% 
     }
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl30 style='border-top:none;border-left:none'x:num><%=tot_dis_amt %></td>
  <td></td>
 </tr>
