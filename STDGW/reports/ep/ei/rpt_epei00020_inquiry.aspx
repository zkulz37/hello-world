...
<%
    ...
    SQL = SQL + "  from tim_cinv_mst_a v, tim_cinv_mst_b v1 ";
    SQL = SQL + "      , tim_contr_mst v2, tim_order v3, tco_buspartner v4 ";
    ...
    SQL = SQL + "       and v.pk=v1.tim_cinv_mst_a_pk ";
    SQL = SQL + "       and v1.tim_contr_mst_pk=v2.pk ";
    SQL = SQL + "       and v1.tim_order_pk=v3.pk(+) ";
   ...
   dt = ESysLib.TableReadOpen(SQL);    
    ...
    SQL = SQL + "      from tim_cinv_mst_a v, tim_cinv_mst_b v1 ";
    SQL = SQL + "          , tim_contr_mst v2, tim_order v3 ";
    SQL = SQL + "  where  v.del_if=0 and v1.del_if=0  ";
    SQL = SQL + "       and v2.del_if=0 and v3.del_if(+) =0  ";
    SQL = SQL + "       and v.pk=v1.tim_cinv_mst_a_pk ";
    SQL = SQL + "       and v1.tim_contr_mst_pk=v2.pk ";
