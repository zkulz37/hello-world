...
<%
    ...
    SQL = " select a.decl_no, to_char(to_date(a.decl_date,'yyyymmdd'),'dd/mm/yyyy') decl_date  " +
        "       , a.annex, a.license " +
    ...
    SQL = "select  v5.grp_nm, v5.grp_cd, v.item_name, v4.hs_code, v2.country_cd3 country_nm " +
        "     , comm.sf_get_item_attribute(a.tco_item_pk )     " +
        "     , to_char(a.qty,'999,999,999') qty, a.UNIT_WEIGHT uom_nm     " +
        ...
        "        and  upper(a.item_origin) = upper(v2.country_cd3(+))  " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=758 style='border-collapse:
 ...
 <tr class=xl82 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl170 colspan=2 style='mso-ignore:colspan;border-right:.5pt solid black'>Đại diện doanh nghiệp</td>
 </tr>
