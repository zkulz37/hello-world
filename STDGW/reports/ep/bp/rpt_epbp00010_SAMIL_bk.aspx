...
<table x:str border=0 cellpadding=0 cellspacing=0 width=853 style='border-collapse:
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  ...
  <td colspan=2 class=xl85 width=140 style='border-left:none;width:106pt'><%= dt1.Rows[i]["item_lname"]%></td>
  <td class=xl81 width=107 style='border-top:none;border-left:none;width:80pt'><%= dt1.Rows[i]["item_lname"]%></td>
  <td class=xl81 width=100 style='border-top:none;border-left:none;width:75pt'><%= dt1.Rows[i]["spec01_nm"]%><font
  class="font12"><sup>0</sup></font><font class="font11">C</font></td>
 ...
 <tr height=33 style='mso-height-source:userset;height:24.75pt'>
  ...
  <td class=xl54 style='border-left:none'>&nbsp;</td>
  <td class=xl54 style='border-left:none'>&nbsp;</td>
  <td class=xl55 style='border-left:none' x:num x:fmla="=<%if(dt1.Rows.Count==0){ %>SUM(I10:I10)<%}else{ %>SUM(I9:I<%= dt1.Rows.Count+8 %>)<%} %>"><span
  style='mso-spacerun:yes'></span></td>
  <td class=xl56 style='border-left:none' x:num x:fmla="=<%if(dt1.Rows.Count==0){ %>I9/20800<%}else{ %>I<%= dt1.Rows.Count+9 %>/20800<%} %>"><span style='mso-spacerun:yes'></span>$<span
  style='mso-spacerun:yes'></span></td>
 </tr>
 <tr height=17 style='height:12.75pt'>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  height:102.0pt;width:426pt'><!--[if gte vml 1]><v:shapetype id="_x0000_t75"
   ...
   margin-left:38.25pt;margin-top:2.25pt;width:387pt;height:94.5pt;z-index:1'
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=516 height=126 src="rpt_epbp00010_SAMIL_files/image001.gif"
