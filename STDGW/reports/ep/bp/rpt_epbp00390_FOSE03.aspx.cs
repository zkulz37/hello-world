...
public partial class rpt_epbp00390_FOSE03 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00390_FOSE03.xls";
        string TempFile = "../../../system/temp/rpt_epbp00390_FOSE03_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00390_FOSE03_1" , "'" + Session["User_ID"].ToString() + "'");	
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_pk + "'";	
		DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_epbp00390_FOSE03_2" , para);	
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_type + "','" + p_wh_pk + "','" + p_group_pk + "','" + p_item + "','" + p_partner_pk + "'";	
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_epbp00390_FOSE03_3" , para);
		...
		{
			exSheet.Cells["G4"].Value = dtMaster.Rows[0]["dept_name"];
			exSheet.Cells["G5"].Value = dtMaster.Rows[0]["req_date"];					
		}
        ...
        {
			exSheet.Cells[pos + i, 1 ].Value = dtDetail.Rows[i]["wh_name"];
			...
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["po_uom"];
			
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["req_qty"];
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["po_unit_price"]; 			
			exSheet.Cells[pos + i,10 ].Value = dtDetail.Rows[i]["req_amount"]; 				 		
			
			exSheet.Cells[pos + i,11 ].Value = dtDetail.Rows[i]["deli_date"]; 
			exSheet.Cells[pos + i,12 ].Value = dtDetail.Rows[i]["deli_time"]; 
						
			exSheet.Cells[pos + i,13 ].Value = dtDetail.Rows[i]["partner_id"]; 
			exSheet.Cells[pos + i,14 ].Value = dtDetail.Rows[i]["pr_status"]; 
        }
		//---------
