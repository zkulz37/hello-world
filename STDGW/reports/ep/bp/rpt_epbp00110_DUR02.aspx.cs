...
public partial class rpt_epbp00110_DUR02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00110_DUR02.xls";
        string TempFile = "../../../system/temp/rpt_epbp00110_DUR02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_dur02_1");
		...
		if ( dtInfo.Rows.Count > 0 )
		{
			...
			exSheet.Cells[3, 8].Value = "Print Date: " + DateTime.Now.ToString("dd/MMM/yyyy");
		}	
        //-----------------------------------

        DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_dur02_2", "'" + l_master_pk + "'");
        DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_dur02_3", "'" + l_master_pk + "'");
		...
		if ( dt1.Rows.Count > 0 )
		{
			...
			exSheet.Cells[5, 7].Value = dt1.Rows[0]["full_name"].ToString();
		}
        // end title
        int pos = 13;
        ...
        {	
			exSheet.Cells[12, 9].Value = "(9)=(8)*(" + dt2.Rows[l_row]["vat_rate"] + "%)" ;	
			...
			exSheet.Cells[l_row+pos, 6].Value = dt2.Rows[l_row]["bef_unit_price"];	
			exSheet.Cells[l_row+pos, 7].Value = dt2.Rows[l_row]["unit_price"];
			exSheet.Cells[l_row+pos, 8].Value = dt2.Rows[l_row]["po_amt"];
			exSheet.Cells[l_row+pos, 9].Value = dt2.Rows[l_row]["vat_amount"];
			exSheet.Cells[l_row+pos,10].Value = dt2.Rows[l_row]["total_amt"];
			
			exSheet.Cells[l_row+pos,11].Value = dt2.Rows[l_row]["etd_from"];
		...
		exSheet.Cells[l_row+pos, 6].Value = total_item_amount + total_discount; 	
		exSheet.Cells[l_row+pos, 8].Value = total_item_amount; 	
        exSheet.Cells[l_row+pos, 9].Value = total_vat_amount;   
		exSheet.Cells[l_row+pos,10].Value = total_amount;		
				
		exSheet.Cells[l_row+pos+1,10].Value = total_discount;
		exSheet.Cells[l_row+pos+1,11].Value = total_discount / (total_discount + total_item_amount );			
