...
<%
    ...
    dt = ESysLib.TableReadOpenCursor("lg_rpt_epbp00115");
	string p_po_pk	=	Request.QueryString["p_po_pk"];
    dt1 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00115_1", "'" + p_po_pk + "'");
    dt2 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00115_2", "'" + p_po_pk + "'");
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="rpt_epbp00115_files/filelist.xml">
<link rel=Edit-Time-Data href="rpt_epbp00115_files/editdata.mso">
<link rel=OLE-Object-Data href="rpt_epbp00115_files/oledata.mso">
<!--[if !mso]>
<style>
...
<![endif]--><!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2012-07-20T01:50:47Z</o:LastSaved>
...
<!--[if gte mso 9]><xml>
 <x:ExcelWorkbook>
  ...
  <x:WindowHeight>8085</x:WindowHeight>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1217 style='border-collapse:
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td colspan=5 class=xl27 width=560 style='width:421pt'><%= dt.Rows[0]["partner_name"] %></td>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl29 style='height:18.0pt'><%= dt.Rows[0]["addr1"] %></td>
  <td class=xl29></td>
  <td colspan=2 class=xl29>Fax: <%= dt.Rows[0]["fax_no"] %></td>
  <td colspan=4 class=xl30 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td colspan=5 height=24 class=xl31 style='height:18.0pt'>MST: <%= dt.Rows[0]["tax_code"] %></td>
  <td class=xl31>&nbsp;</td>
 ...
 <tr height=70 style='mso-height-source:userset;height:52.5pt'>
  <td colspan=10 height=70 class=xl53 width=961 style='height:52.5pt;
  width:724pt'>ĐƠN MUA HÀNG<br>
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=10 height=30 class=xl54 style='height:22.5pt'>P/R No :<font
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=8 class=xl57 style='border-right:.5pt solid black'><%=dt1.Rows[0]["partner_name"]%></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl59 style='height:22.5pt'>Địa chỉ <font
  class="font10">Address</font></td>
  <td colspan=8 class=xl61 style='border-right:.5pt solid black'><%=dt1.Rows[0]["addr1"]%></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=2 height=30 class=xl56 style='height:22.5pt'>Ngày giao <font
  class="font10">ETD</font></td>
  <td colspan=2 class=xl36 style='mso-ignore:colspan'><%=dt1.Rows[0]["etd_to"]%></td>
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=8 class=xl64><%=dt1.Rows[0]["description"]%></td>
  <td colspan=4 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr class=xl37 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl39 width=120 style='width:90pt'>Barcode<br>
    <font class="font18">Mã vạch</font></td>
  <td class=xl39 width=50 style='width:38pt'>ĐVT<font class="font17"><br>
    </font><font class="font18">UOM</font></td>
  <td class=xl39 width=90 style='width:68pt'>Số lượng<font class="font17"><br>
    </font><font class="font18">Qty</font></td>
  <td class=xl39 width=90 style='width:68pt'>Đơn giá<font class="font17">
  (VND)<br>
    </font><font class="font18">U/Price</font></td>
  <td class=xl39 width=90 style='width:68pt'>Thành tiền<font class="font17"><br>
 ...
 <tr class=xl33 height=50 style='mso-height-source:userset;height:37.5pt'>
  ...
  <td class=xl41 width=120 style='width:90pt' x:str><%=dt2.Rows[i]["spec"]%><span
  style='mso-spacerun:yes'> </span></td>
  <td class=xl41 width=120 style='width:90pt'><%=dt2.Rows[i]["spec02_name"]%></td>
  ...
  <td class=xl43 width=90 style='width:68pt' x:num><%=dt2.Rows[i]["unit_price"]%></td>
  <td class=xl43 width=90 style='width:68pt' x:num><span
  style='mso-spacerun:yes'>                 </span><%=dt2.Rows[i]["po_amt"]%><span
  style='mso-spacerun:yes'>   </span></td>
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=2 class=xl71>Sub Total</td>
  <td colspan=2 class=xl72 x:num><span
  style='mso-spacerun:yes'>                                       </span><% if(dt1.Rows.Count > 0){%><%= dt1.Rows[0]["po_amt"] %><%}%><span
  style='mso-spacerun:yes'>   </span></td>
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=2 class=xl72 x:num><span
  style='mso-spacerun:yes'>                                       </span><% if(dt1.Rows.Count > 0){%><%= dt1.Rows[0]["vat_amt"] %><%}%><span
  style='mso-spacerun:yes'>   </span></td>
  <td class=xl46 x:str="VND"><span style='mso-spacerun:yes'> </span>VND<span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=4 class=xl28 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td colspan=2 class=xl74 x:num><span
  style='mso-spacerun:yes'>                                       </span><% if(dt1.Rows.Count > 0){%><%= dt1.Rows[0]["total_amt"] %><%}%><span
  style='mso-spacerun:yes'>   </span></td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  colspan-rowspan;height:102.0pt;width:272pt'><!--[if gte vml 1]><v:shapetype
   ...
   <v:imagedata src="rpt_epbp00115_files/image001.gif" o:title=""/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=236 height=123 src="rpt_epbp00115_files/image001.gif"
