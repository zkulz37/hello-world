...
<%
    ...
    dt = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00114");
	string p_po_pk	=	Request.QueryString["p_po_pk"];
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00114_1", "'" + p_po_pk + "'");
    dt2 = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00114_2", "'" + p_po_pk + "'");
%>
...
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  ...
  <o:LastSaved>2012-05-01T09:22:46Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1097 style='border-collapse:
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  2.0pt double black;height:54.0pt;width:99pt'>
 ...
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  <td class=xl29></td>
  <td colspan=2 class=xl29>8>Fax: <%= dt.Rows[0]["fax_no"] %></td>
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=9 height=30 class=xl54 style='height:22.5pt'>P/O No :<span
  style='mso-spacerun:yes'><font
  class="font15"><%= dt1.Rows[0]["po_no"]%></font>
  </span><font class="font8">Date :</font><font class="font5"> </font><font
 ...
 <tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl36  ><%= dt1.Rows[0]["etd_to"]%></td>
 ...
 <tr class=xl37 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  class="font17"> <%= dt1.Rows[0]["TR_CCY"]%><br>
 ...
 <tr class=xl33 height=41 style='mso-height-source:userset;height:30.75pt'>
  <td height=41 class=xl40 width=30 style='height:30.75pt;width:23pt'><%= dt2.Rows[i]["seq"]%></td>
  <td colspan=2 class=xl74 width=281 style='border-right:.5pt dashed black;
  border-left:none;width:211pt' ><%= dt2.Rows[i]["po_item_name"]%></td>
  <td class=xl41 width=120 style='width:90pt'><%= dt2.Rows[i]["spec"]%></td>
  <td class=xl42 width=50 style='width:38pt'><%= dt2.Rows[i]["po_uom"]%></td>
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl26></td>
  <td colspan=2 class=xl68>Sub Total</td>
  <td colspan=2 class=xl69 x:num  x:fmla="=<%if(dt1.Rows.Count==0){ %>SUM(F13:F13)<%}else{ %>SUM(F12:F<%= dt2.Rows.Count+11 %>)<%} %>" ><span
  style='mso-spacerun:yes'>                </span> <%= dt1.Rows[0]["PO_AMT"]%> </td>
  <td colspan=2 class=xl69 x:num ><span
  style='mso-spacerun:yes'>                          </span><%= dt1.Rows[0]["PO_AMT"]%> </td>
  <td class=xl46  ><span style='mso-spacerun:yes'> </span><%= dt1.Rows[0]["TR_CCY"]%><span
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td height=30 class=xl45 style='height:22.5pt'>&nbsp;</td>
  <td class=xl26></td>
  <td colspan=2 class=xl70>VAT</td>
  <td colspan=2 class=xl71>&nbsp;</td>
  <td colspan=2 class=xl71 x:num ><span
  style='mso-spacerun:yes'>                          </span><%= dt1.Rows[0]["VAT_AMT"]%> </td>
  <td class=xl46  ><span style='mso-spacerun:yes'> </span><%= dt1.Rows[0]["TR_CCY"]%><span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=4 class=xl28 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl48>&nbsp;</td>
  <td colspan=2 class=xl72>Total Amount</td>
  <td colspan=2 class=xl73>&nbsp;</td>
  <td colspan=2 class=xl73 x:num><span
  style='mso-spacerun:yes'>                          </span><%= dt1.Rows[0]["total_amt"]%></td>
  <td class=xl49  ><span style='mso-spacerun:yes'> </span><%= dt1.Rows[0]["TR_CCY"]%><span
  style='mso-spacerun:yes'> </span></td>
  <td colspan=4 class=xl28 style='mso-ignore:colspan'></td>
 </tr>
 ...
 <tr height=28 style='mso-height-source:userset;height:21.0pt'>
  <td height=28 colspan=4 class=xl25 style='height:21.0pt;mso-ignore:colspan'></td>
  <td colspan=2 class=xl75>Applicant By</td>
  <td colspan=2 class=xl75 style='border-left:none'>Approved By</td>
  <td colspan=5 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=92 style='mso-height-source:userset;height:69.0pt'>
  <td height=92 colspan=4 class=xl25 style='height:69.0pt;mso-ignore:colspan'></td>
  <td colspan=2 class=xl76 style='border-right:.5pt solid black'><%= dt1.Rows[0]["PO_CHARGER"]%></td>
  <td colspan=2 class=xl76 style='border-right:.5pt solid black;border-left:
  none'>KIM JONG MYUNG</td>
  <td colspan=5 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
 <tr height=23 style='mso-height-source:userset;height:17.25pt'>
  <td height=23 colspan=4 class=xl25 style='height:17.25pt;mso-ignore:colspan'></td>
  <td class=xl75 style='border-top:none'>Date</td>
  <td class=xl75 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl75 style='border-top:none;border-left:none'>Date</td>
  <td class=xl75 style='border-top:none;border-left:none'>&nbsp;</td>
  <td colspan=5 class=xl25 style='mso-ignore:colspan'></td>
 </tr>
