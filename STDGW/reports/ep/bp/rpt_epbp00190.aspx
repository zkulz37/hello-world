...
<%    
    ...
    dt  = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00190_2");
    dt1 = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00190", para);
    dt2 = ESysLib.TableReadOpenCursor("prod.sp_rpt_epbp00190_1", para);
    if(dt1.Rows.Count==0)
    {
...
<table border=0 cellpadding=0 cellspacing=0 width=1308 style='border-collapse:
 ...
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  2.0pt double black;height:15.0pt;width:116pt'><!--[if gte vml 1]> </v:shapetype><v:shape id="_x0000_s1025" type="#_x0000_t75" style='position:absolute;
   margin-left:10.5pt;margin-top:1.5pt;width:90.75pt;height:40.5pt;z-index:1'>
  ...
  <td class=xl79 width=247 style='width:185pt'><%= dt.Rows[0]["partner_name"]%></td>
  ...
  <td class=xl40 width=120 style='width:90pt'></td>
  <td class=xl40></td>
  <td class=xl40 width=120 style='width:90pt'>Tel: <%= dt.Rows[0]["phone_no"]%></td>
  <td class=xl40 width=74 style='width:56pt'></td>
  <td class=xl81 width=80 style='width:60pt'></td>
  <td class=xl26 width=64 style='width:48pt'></td>
 </tr>
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td height=20 class=xl26 colspan=4 style='height:15.0pt;mso-ignore:colspan'><%= dt.Rows[0]["addr1"]%></td>
  <td colspan=2 class=xl40 style='mso-ignore:colspan'></td>
  <td class=xl40></td>
  <td class=xl40 width=120 style='width:90pt'>Fax: <%= dt.Rows[0]["fax_no"]%></td>
  <td class=xl40></td>
  <td class=xl81 width=80 style='width:60pt'></td>
  <td class=xl26></td>
 </tr>
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 height=20 class=xl80 style='height:15.0pt'>MST: <%= dt.Rows[0]["tax_code"]%></td>
 ...
 <tr class=xl26 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  x:str="Phòng ban: (Department) ">Phòng ban: (Department)<span
 ...
 <tr class=xl26 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td colspan=2 height=25 class=xl77 style='height:18.75pt'>Ghi chú (Remark)</td>
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  colspan-rowspan;height:102.0pt;width:524pt'><!--[if gte vml 1]><v:shapetype
   ...
   margin-left:87pt;margin-top:0;width:392.25pt;height:95.25pt;z-index:2'>
   <v:imagedata src="epbp00190_files/image002.gif" o:title="untitled"/>
   <x:ClientData ObjectType="Pict">
    <x:SizeWithCells/>
    <x:CF>Bitmap</x:CF>
    <x:AutoPict/>
  ...
  <table cellpadding=0 cellspacing=0>
   ...
   <tr>
    <td></td>
    <td><img width=523 height=127 src="epbp00190_files/image002.gif" v:shapes="_x0000_s1030"></td>
    <td width=59></td>
   </tr>
   <tr>
    <td height=9></td>
