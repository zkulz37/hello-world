...
public partial class rpt_epbp00400_FOSE01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00400_FOSE01.xls";
        string TempFile = "../../../system/temp/rpt_epbp00400_FOSE01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE01_1" , "'" + Session["User_ID"].ToString() + "'");	
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_pk + "'";	
		DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE01_2" , para);	
		
		para = "'" + p_from_date + "','" + p_to_date + "','" + p_wh_type + "','" + p_wh_pk + "','" + p_group_pk + "','" + p_item + "','" + p_partner_pk + "'";	
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE01_3" , para);
        ...
        {
			exSheet.Cells[pos + i, 1 ].Value = dtDetail.Rows[i]["grp_nm"];
			...
			exSheet.Cells[pos + i,10 ].Value = dtDetail.Rows[i]["in_uom"]; 
			exSheet.Cells[pos + i,11 ].Value = dtDetail.Rows[i]["in_unit_price"]; 	
			exSheet.Cells[pos + i,12 ].Value = dtDetail.Rows[i]["in_qty"]; 			
			exSheet.Cells[pos + i,13 ].Value = dtDetail.Rows[i]["in_amount"]; 
			
			exSheet.Cells[pos + i,14 ].Value = dtDetail.Rows[i]["diff_qty"]; 			
			exSheet.Cells[pos + i,15 ].Value = dtDetail.Rows[i]["diff_amount"]; 
        }
		//---------
