...
<body link="blue" vlink="purple">
    <table x:str border="0" cellpadding="0" cellspacing="0" width="979" style='border-collapse: collapse;
        table-layout: fixed; width: 735pt'>
        ...
        <tr height="27" style='height: 20.25pt'>
            <td colspan="14" height="27" class="xl25" width="979" style='height: 20.25pt; width: 735pt'>
                Report Purchase Order By Group
            </td>
        </tr>
        ...
        <%
            /*
             c.partner_name, po_date, a.po_no, b.seq, e.grp_nm,
               d.item_name, b.po_qty_01, b.po_uom_01, b.unit_price, b.po_amt,
               b.vat_rate, b.vat_amount, b.total_amt, a.po_ccy,
             */
            string para = "'" + p_from_date + "','" + p_to_date + "','" + p_po_vendor + "','" + p_item + "' ";
            DataTable dt;
            dt = ESysLib.TableReadOpenCursor("prod.sp_sel_epbp00040_2", para);
        ...
        %>
        <tr height="17" style='height: 12.75pt; '>
            <td colspan="5" height="17" class="xl32" style='border-right: .5pt solid black; height: 12.75pt'>
                Total
                <%= dt.Rows[i-1]["grp_nm"]%>
            </td>
            <td class="xl35" align="right" style='border-top: none; border-left: none' x:num>
                <%= PoQty%>
            </td>
        ...
        <tr height="64" style='height: 48.0pt'>
            <td height="64" class="xl27" align="left" width="64" style='height: 48.0pt; border-top: none;
                width: 48pt'>
                <%= dt.Rows[i]["partner_name"]%>
            </td>
            <td class="xl28" align="left" style='border-top: none; border-left: none'>
