...
public partial class rpt_epbp00110_ST02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00110_ST02.xls";
        string TempFile = "../../../system/temp/rpt_epbp00110_ST02_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST02_1");
        ...
        {
            DataTable dt1 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST02_2", "'" + arrPK[i] + "'");
            DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST02_3", "'" + arrPK[i] + "'");
            if (i == 0)
            {      
                ...
                for (int l_row = 1; l_row <= dt2.Rows.Count; l_row++)
                {
                    for (int col = SEQ; col <= REMARK; col++)
                    {
                        ...
                        {
                            exSheet.Cells[9 + l_row, col + 1].Value = dt2.Rows[l_row - 1]["description"];
                        }
                    }
                }
