...
public partial class rpt_epbp00110_ST03 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00110_ST03.xls";
        string TempFile = "../../../system/temp/rpt_epbp00110_ST03_" + Session["User_ID"].ToString() + ".xls";
        ...
        string para = "'" + po_pk + "'";		
		DataTable dt       = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST03_2" , para);		
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST03_3" , para);		  
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00110_ST03_1", "'" + Session["User_ID"].ToString() + "'");	
        // MASTER   
		...
		if( dt.Rows.Count >0)
		{
			...
			exSheet.Cells["C8"].Value = dt.Rows[0]["etd_to"];
