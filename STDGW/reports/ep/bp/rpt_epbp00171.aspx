...
<%
    ...
    dt = ESysLib.TableReadOpenCursor("PROD.sp_rpt_epbp00171");
    dt1 = ESysLib.TableReadOpenCursor("PROD.sp_rpt_epbp00171_1", para);
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=735 style='border-collapse:
 ...
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  ...
  <td colspan=2 class=xl36 width=250 style='width:188pt'>Tel: <%= dt.Rows[0]["phone_no"]%></td>
 </tr>
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 height=20 class=xl37 style='height:15.0pt'><%= dt.Rows[0]["addr1"]%></td>
  <td colspan=2 class=xl36 width=250 style='width:188pt'>Fax: <%= dt.Rows[0]["fax_no"]%></td>
 </tr>
 <tr class=xl26 height=20 style='mso-height-source:userset;height:15.0pt'>
  <td colspan=3 height=20 class=xl38 style='height:15.0pt'>MST: <%= dt.Rows[0]["tax_code"]%></td>
  <td colspan=2 class=xl39 width=250 style='width:188pt'>Print date : <%= DateTime.Now.ToString("dd/MM/yyyy HH:mm") %></td>
 </tr>
 <tr height=75 style='mso-height-source:userset;height:56.25pt'>
 <% if (p_f_out_type != p_t_out_type)
    {%>
  <td colspan=7 height=75 class=xl40 width=735 style='height:56.25pt;
 ...
 <tr class=xl28 height=30 style='mso-height-source:userset;height:22.5pt'>
  <td colspan=3 height=30 class=xl54 width=385 style='height:22.5pt;width:290pt'>Total</td>
