...
<%    
    ...
    string p_pur_type       = Request.QueryString["p_pur_type"];
    ...
    string para = "'" + p_report_type + "','" + p_from_date + "','" + p_to_date + "','" + p_group_pk + "','" + p_item + "'";
    
    DataTable dt, dt1, dt2;
    
    dt   = ESysLib.TableReadOpenCursor("LG_SEL_EPBP00270_DEPT_SAMIL","''");
    dt1  = ESysLib.TableReadOpenCursor("LG_SEL_EPBP00270_DATA_SAMIL",para);
    if(dt1.Rows.Count==0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1418 style='border-collapse:
 ...
 <tr height=45 style='mso-height-source:userset;height:33.75pt'>
  ...
  hàng) - <%=System.DateTime.ParseExact(p_to_date, "yyyyMMdd", System.Globalization.CultureInfo.InvariantCulture).ToString("MM/yyyy")%></td>
