...
public partial class rpt_epbp00112_YJ01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00112_YJ01.xls";
        string TempFile = "../../../system/temp/rpt_epbp00112_YJ01_" + Session["User_ID"].ToString() + ".xls";
		...
		if( dt.Rows.Count >0)
		{
			...
			//exSheet.Cells["C7"].Value = dt.Rows[0]["Addr2"];			
			...
			exSheet.Cells["H5"].Value = dt.Rows[0]["po_date"];
			
			exSheet.Cells["H7"].Value = dt.Rows[0]["fax_no"];
			
			exSheet.Cells["C15"].Value = dt.Rows[0]["payment_term"];
			
			exSheet.Cells["G19"].Value = dt.Rows[0]["po_amt"];//sub total
			exSheet.Cells["G20"].Value = dt.Rows[0]["vat_amt"];
			exSheet.Cells["G21"].Value = dt.Rows[0]["total_amt"];
			
			exSheet.Cells["I19"].Value = dt.Rows[0]["PO_CCY"];//ccy
			exSheet.Cells["I20"].Value = dt.Rows[0]["PO_CCY"];
        ...
        {								
			...
			exSheet.Cells[pos + i, 4 ].Value = dtDetail.Rows[i]["spec02_nm"];
