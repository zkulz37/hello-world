...
public partial class rpt_epbp00111_DURING : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string p_po_pk = Request["p_po_pk"];
       
        string TemplateFile = "rpt_epbp00111_DURING.xls";
        string TempFile = "../../../system/temp/rpt_epbp00111_DURING" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dt2 = ESysLib.TableReadOpenCursor("lg_rpt_epbp00111_during", "'" + p_po_pk + "'");
