...
public partial class rpt_epbp00400_FOSE04 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epbp00400_FOSE04.xls";
        string TempFile = "../../../system/temp/rpt_epbp00400_FOSE04_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE04_1" , "'" + Session["User_ID"].ToString() + "'");	
		
		para = "'" + p_from_date + "','" + p_to_date + "'";	
		DataTable dtMaster = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE04_2" , para);	
		
		para = "'" + p_from_date + "','" + p_to_date + "'";	
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_epbp00400_FOSE04_3" , para);
