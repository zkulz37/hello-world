...
public partial class reports_rpt_epex00030_DORCO_CI : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epex00030_DORCO_CI.xls";
        string TempFile = "../../../system/temp/rpt_epex00030_DORCO_CI_" + Session["User_ID"].ToString() + ".xls";
