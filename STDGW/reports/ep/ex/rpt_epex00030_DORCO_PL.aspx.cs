...
public partial class reports_rpt_epex00030_DORCO_PL : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_epex00030_DORCO_PL.xls";
        string TempFile = "../../../system/temp/rpt_epex00030_DORCO_PL_" + Session["User_ID"].ToString() + ".xls";
        ...
        DataTable dtInfo = ESysLib.TableReadOpenCursor("rpt_epex00030_DORCO_PL_1", "'" + p_master_pk + "'");
		
        DataTable dtDetail = ESysLib.TableReadOpenCursor("rpt_epex00030_DORCO_PL_2", "'" + p_master_pk + "'");
