...
function onPrint(index)
{
    ...
    {
        case "1": // 2 ben
            var  url= System.RootURL + "/reports/ep/ac/rpt_epac00030_saleContract.aspx?" + "contract_pk=" + contract_pk + "&Curr=USD"+ "&com_pk=" + com_pk ;
	        System.OpenTargetPage( url, "_blank" ); 
        break;
        case "2": //3 ben
            var  url= System.RootURL + "/reports/ep/ac/rpt_epac00030_3part_E_V.aspx?" + "contract_pk=" + contract_pk + "&com_pk=" + com_pk;
	        System.OpenTargetPage( url, "_blank" ); 
        break;
        case "3": //4 ben
            var  url= System.RootURL + "/reports/ep/ac/rpt_epac00030_4part_V_E.aspx?" + "contract_pk=" + contract_pk + "&com_pk=" + com_pk;
	        System.OpenTargetPage( url, "_blank" ); 
        break;
    }
}    
