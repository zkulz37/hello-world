...
<%    
    string l_contract_pk, l_curr, SQL, l_curr_nm="";
	...
	SQL = "select CONTR_NO, to_char(to_date(CONTR_DATE,'yyyymmdd'),'dd/mm/yyyy') as contr_date    " + 
        ...
        "                    , s3.code_nm ITEM_ORGIN,  s1.code_nm pay_method   " +
        "                    , vendor.partner_name seller_name, vendor.addr1 seller_add, v.bank_account     " +
        "                    , nvl(ship.partner_name,comp.partner_name) buyer_name, nvl(ship.addr1,comp.addr1) buy_add  " +
        ...
        "                    ,(  SELECT code, code_nm      " +
        "                        FROM comm.tco_abcode a, comm.tco_abcodegrp b      " +
        "                        WHERE a.tco_abcodegrp_pk = b.pk  AND b.ID = 'COAB0080'     " +
        "                             AND a.use_if = 1 AND a.del_if = 0 AND b.del_if = 0     " +
        "                    ) s3           " +
        "             where v.del_if=0     " +
        ...
        "                and upper(ITEM_ORGIN) = upper(s3.code)" +
    ...
    SQL = " select item_code, item_name,  v3.uom_nm   " +
        ...
        "  from imex.tim_contr_dtl v, comm.tco_item v2, comm.tco_uom v3  " +
        "  where v.del_if=0   " +
...
<p class=MsoNormal><span style='font-size:11.0pt'>After discusion, both parties
...
<table class=MsoTableGrid border=1 cellspacing=0 cellpadding=0 width=643
 style='width:6.7in;border-collapse:collapse;border:none;mso-border-top-alt:
 ...
 <tr style='mso-yfti-irow:0;mso-yfti-firstrow:yes;height:13.9pt'>
  <td width=43 style='width:.45in;border:solid windowtext 1.0pt;mso-border-alt:
  ...
  <td width=120 style='width:90.3pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0in 5.4pt 0in 5.4pt;height:13.9pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:10.0pt'>SPECIFICATION<o:p></o:p></span></b></p>
  </td>
  <td width=88 style='width:66.3pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0in 5.4pt 0in 5.4pt;height:13.9pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
  style='mso-bidi-font-weight:normal'><span style='font-size:10.0pt'>QUANTITY<o:p></o:p></span></b></p>
  </td>
  <td width=101 style='width:76.05pt;border:solid windowtext 1.0pt;border-left:
  none;mso-border-left-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0in 5.4pt 0in 5.4pt;height:13.9pt'>
  <p class=MsoNormal align=center style='text-align:center'><b
...
%>
 <tr style='mso-yfti-irow:1;height:16.6pt'>
  <td width=43 valign=bottom style='width:.45in;border:solid windowtext 1.0pt;
  border-top:none;mso-border-top-alt:solid windowtext .5pt;mso-border-alt:solid windowtext .5pt;
  padding:0in 5.4pt 0in 5.4pt;height:16.6pt'><%=i+1 %>
  </td>
  <td width=204 valign=bottom style='width:153.0pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:16.6pt'>
  <st1:place w:st="on"><st1:City w:st="on"><%=dtDetail.Rows[i][1] %>
  </td>
  <td width=120 valign=bottom style='width:90.3pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:16.6pt'>
  <span style='font-size:10.0pt'><%=dtDetail.Rows[i][0] %><o:p></o:p></span>
  </td>
  <td width=88 valign=bottom align=right style='width:66.3pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:16.6pt'>
  <span style='font-size:10.0pt;text-align:right' ><%=dtDetail.Rows[i][3] %> &nbsp;<%=dtDetail.Rows[i][2] %><o:p></o:p></span>
  </td>
  <td width=101 valign=bottom align=right  style='width:76.05pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:16.6pt'>
  <span style='font-size:10.0pt;text-align:right'><%=dtDetail.Rows[i][4]%>/<%=dtDetail.Rows[i][6]%> <o:p></o:p></span>
  </td>
  <td width=86 valign=bottom align=right  style='width:64.35pt;border-top:none;border-left:
  none;border-bottom:solid windowtext 1.0pt;border-right:solid windowtext 1.0pt;
  mso-border-top-alt:solid windowtext .5pt;mso-border-left-alt:solid windowtext .5pt;
  mso-border-alt:solid windowtext .5pt;padding:0in 5.4pt 0in 5.4pt;height:16.6pt;text-align:right'>
  <span style='font-size:10.0pt;text-align:right'><%=dtDetail.Rows[i][5]  %><o:p></o:p></span>
  </td>
 </tr>
 <%} %> 
 <tr style='mso-yfti-irow:3;mso-yfti-lastrow:yes;height:16.6pt'>
  <td width=456 colspan=4 valign=bottom style='width:4.75in;border-top:none;
...
style='font:7.0pt "Times New Roman"'>&nbsp;&nbsp;&nbsp;&nbsp; </span></span></span></b><![endif]><b
style='mso-bidi-font-weight:normal'><span style='font-size:11.0pt'><u>COMPLIANT</u><o:p></o:p></span></b></p>
...
<p class=MsoNormal style='tab-stops:center 1.5in 5.0in'><span style='font-size:
11.0pt'><span style='mso-tab-count:1'>                             </span>Mr.
Sung<span style='mso-tab-count:1'>                                                                      </span>Mr.
Sung<o:p></o:p></span></p>
