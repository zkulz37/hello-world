...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1423 style='border-collapse:
 ...
 <col class=xl27 width=64 span=8 style='width:48pt'>
   <%
        DataTable dt1 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dscd00030_st", "'" + master_pk + "'");
        DataTable dt;
        dt = ESysLib.TableReadOpenCursor("sale.sp_rpt_dscd00030_stm", "'" + master_pk + "','"+print_time+"'");  
 %>
