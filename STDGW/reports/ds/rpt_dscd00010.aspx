...
<%    
    ...
    dt1 = ESysLib.TableReadOpenCursor("SALE.sp_rpt_dscd00010", "'" + date + "','" + searchno + "'");
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1307 style='border-collapse:
 ...
 <tr height=17 style='height:12.75pt'>
  ...
  <td class=xl83 colspan=3 style='mso-ignore:colspan'>Print date: 04/08/2011
  08:42</td>
 </tr>
 <tr height=17 style='height:12.75pt'>
...
<tr class=xl74 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  <td class=xl88 width=64 style='width:48pt'><%=dt1.Rows[i]["day02"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day03"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day04"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day05"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day06"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day07"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day08"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day09"]%></td>
  <td class=xl89 width=64 style='width:48pt'><%=dt1.Rows[i]["day10"]%></td>
 </tr>
 <%
     }
      %>
 ...
 <tr class=xl77 height=39 style='mso-height-source:userset;height:29.25pt'>
  ...
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a4 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a5 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a6 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a7 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a8 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a9 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a10 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a11 %></td>
  <td class=xl86 width=64 style='border-top:none;border-left:none;width:48pt' x:num><%=a12 %></td>
 </tr>
