...
<%    
    ...
    string p_from_dt = Request.QueryString["from_dt"];
    string p_to_dt = Request.QueryString["to_dt"];
    string p_partner = Request.QueryString["partner"];
    string para = "'" + p_from_dt + "','" + p_to_dt + "','" + p_partner + "'";
    DataTable dt, dt1;
    dt = ESysLib.TableReadOpen(strSQL);
    dt1 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsap00050_1", para);
%>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=711 style='border-collapse:
 ...
 <tr height=70 style='mso-height-source:userset;height:52.5pt'>
  ...
  CÁO THANH TOÁN<br>
    <font class="font10">( MONTHLY PAYMENT BALANCE )</font></td>
 </tr>
