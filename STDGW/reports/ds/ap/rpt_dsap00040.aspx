...
<%    
    ...
    dt = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsap00040");
    dt1 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsap00040_1", para);
    dt2 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsap00040_2", para);
...
<tr height=30 style='mso-height-source:userset;height:22.5pt'>
  ...
  <td class=xl47 width=137 style='border-top:none;width:103pt'><%=dt2.Rows[i]["payment_desc"]%></td>
 </tr>
            <% 
     }
  %>
