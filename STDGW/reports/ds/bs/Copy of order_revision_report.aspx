...
<%
  ...
  string SQL
     = "SELECT   note_columns, re_so_item_no, re_item_code, " +
         ...
         "         comm.sf_get_partnerloc_nm (c.deli_loc_pk), sf_get_dsbs00010_1 ('PEARL', a.re_tco_item_pk), " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=2017 style='border-collapse:
 ...
 width:107pt'>
 <col class=xl27 width=156 style='mso-width-source:userset;mso-width-alt:5705;
 width:117pt'>
 ...
 width:72pt'>
 <col class=xl29 width=59 style='mso-width-source:userset;mso-width-alt:2157;
 width:44pt'>
 <col class=xl27 width=187 style='mso-width-source:userset;mso-width-alt:6838;
 width:140pt'>
 <col class=xl27 width=139 style='mso-width-source:userset;mso-width-alt:5083;
 width:104pt'>
 <col class=xl30 width=187 style='mso-width-source:userset;mso-width-alt:6838;
 width:140pt'>
 <col class=xl30 width=213 style='mso-width-source:userset;mso-width-alt:7789;
 width:160pt'>
 ...
 <tr class=xl46 height=31 style='mso-height-source:userset;height:23.25pt'>
  ...
  <td class=xl41 style='border-left:none'>BASE COLOR</td>
  <td class=xl43 style='border-left:none'>Q'TY</td>
...
<% if (dt.Rows.Count > 0)
   {
       ...
       for (i = 1; i < dt.Rows.Count; i=i+2)
       {
           ...
           for (j = 1; j < arr.Length; j++)
           {
             ...
             %> 
                  <tr class=xl24 height=53 style='mso-height-source:userset;height:39.75pt'>
                  <td height=53 class=xl47 style='height:39.75pt'><%=count%></td>
                  ...
                  <td class=xl53 style='border-left:none'><%=dt.Rows[i-1][36].ToString()%></td>
                 </tr>                  
               <%
