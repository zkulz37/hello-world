...
public partial class rpt_dsos00010_ST01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
		...
		DataTable dtSaleOrd = ESysLib.TableReadOpenCursor("lg_rpt_dsos00010_st01_1" , para); 
		DataTable dtDetail  = ESysLib.TableReadOpenCursor("lg_rpt_dsos00010_st01_2" , para);	
		
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_dsos00010_st01_3", "'" + Session["User_ID"].ToString() + "'");	
        // MASTER   
