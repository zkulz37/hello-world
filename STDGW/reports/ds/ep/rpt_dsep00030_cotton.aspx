...
<%
    ...
    dt3 = ESysLib.TableReadOpenCursor("SALE.sp_rpt_dsep00030_cotton_3", "'" + sopk + "'");
    dt4 = ESysLib.TableReadOpenCursor("SALE.sp_rpt_dsep00030_cotton_4", "'" + sopk + "'");

    shipRow = 17 + dt3.Rows.Count ;
    totalRow = 17 + dt3.Rows.Count + dt4.Rows.Count + (dt4.Rows.Count / 4) + 4;
 %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1002 style='border-collapse:
 ...
 <tr class=xl53 height=37 style='mso-height-source:userset;height:27.75pt'>
  ...
  <%
    ...
    {
    %>
        <td class=xl61 width=53 style='width:40pt'><%=dt2.Rows[i]["spec_nm"] %></td>
    <%
   ...
   {
   %>
        <td class=xl61 width=53 style='width:40pt'>&nbsp;</td>
   <%
   }
    %>
 ...
 <%
     string _school_name = "", _style="", _po_no="";
  ...
  %>
  <%
      if (_school_name != dt4.Rows[i]["school_name"].ToString())
      {
          _school_name = dt4.Rows[i]["school_name"].ToString();
   %>
 <tr class=xl25 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl25 style='height:15.75pt'></td>
  <td class=xl29>&nbsp;</td>
  <td class=xl167 style='border-top:none'><%=_style%></td>
  <td class=xl170 align=right style='border-top:none;border-left:none' x:num><%=_po_no%></td>
  <td class=xl167 style='border-top:none;border-left:none' ><%=dt4.Rows[i]["school_name"]%></td>
  <td class=xl173 align=right style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["sc"]%></td>
  <td class=xl173 style='border-top:none;border-left:none'><%=dt4.Rows[i]["licence_code"]%></td>
  <td colspan=3 class=xl185 style='border-right:.5pt solid black;border-left:
  none'><%=dt4.Rows[i]["boxtype"]%></td>
  <td class=xl92 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size1_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size2_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size3_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size4_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size5_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size6_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size7_qty"]%></td>
  <td class=xl93 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl94 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["total_qty"]%></td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <%}
   else
 ...
 %>
  ...
  <td class=xl170 align=right style='border-top:none;border-left:none' x:num></td>
  <td class=xl167 style='border-top:none;border-left:none'></td>
  <td class=xl173 align=right style='border-top:none;border-left:none' x:num></td>
  <td class=xl173 style='border-top:none;border-left:none'></td>
  <td colspan=3 class=xl185 style='border-right:.5pt solid black;border-left:
  none'><%=dt4.Rows[i]["boxtype"]%></td>
  <td class=xl92 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl93 style='border-top:none;border-left:none' x:num><%=dt4.Rows[i]["size1_qty"]%></td>
  ...
  <%} %>
  <% 
      if (dt4.Rows[i]["box_ord"].ToString() == "4")
      {
  %>
 <tr class=xl25 height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl25 style='height:15.75pt'></td>
  ...
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size1_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size1_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size2_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size2_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size3_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size3_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size4_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size4_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size5_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size5_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size6_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size6_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["size7_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["size7_qty"]) )%></td>
  <td class=xl89 style='border-top:none;border-left:none'>&nbsp;</td>
  <td class=xl90 style='border-top:none;border-left:none' x:num><%=( CommondLib.ConvertToDbl( dt4.Rows[i-3]["total_qty"]) - CommondLib.ConvertToDbl( dt4.Rows[i]["total_qty"]) )%></td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <% }
    }%>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl222 style='height:15.75pt'></td>
  <td class=xl222>&nbsp;</td>
  <td colspan=5 rowspan=5 class=xl223 style='border-right:1.0pt solid black;
  border-bottom:1.0pt solid black; border-left:none'>G.TOTAL:</td>
  <td colspan=3 class=xl223 style='border-right:.5pt solid black;border-left:
  none'>ORDER QTY</td>
  <td class=xl222>&nbsp;</td>
  <td class=xl222 x:num="1340"    
  x:fmla="=SUMIF($H<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,L$<%=shipRow %>:L$<%=totalRow %>)">1,340</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,M$<%=shipRow %>:M$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,N$<%=shipRow %>:N$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,O$<%=shipRow %>:O$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,P$<%=shipRow %>:P$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,Q$<%=shipRow %>:Q$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,R$<%=shipRow %>:R$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,S$<%=shipRow %>:S$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;ORDER QTY&quot;,T$<%=shipRow %>:T$<%=totalRow %>)">0</td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl222 style='height:15.75pt'></td>
  <td class=xl222>&nbsp;</td>
  <td colspan=3 class=xl223 style='border-right:.5pt solid black;border-left:
  none'>PAST SHIPPED QTY</td>
  <td class=xl222>&nbsp;</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J<%=shipRow %>,&quot;PAST SHIPPED QTY&quot;,L$<%=shipRow %>:L$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,M$<%=shipRow %>:M$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,N$<%=shipRow %>:N$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,O$<%=shipRow %>:O$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,P$<%=shipRow %>:P$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,Q$<%=shipRow %>:Q$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,R$<%=shipRow %>:R$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,S$<%=shipRow %>:S$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;PAST SHIPPED QTY&quot;,T$<%=shipRow %>:T$<%=totalRow %>)">0</td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl222 style='height:15.75pt'></td>
  <td class=xl222>&nbsp;</td>
  <td colspan=3 class=xl223 style='border-right:.5pt solid black;border-left:
  none'>CURRENTSHIPPED QTY</td>
  <td class=xl222>&nbsp;</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,L$<%=shipRow %>:L$<%=totalRow %>)">206</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,M$<%=shipRow %>:M$<%=totalRow %>)">210</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,N$<%=shipRow %>:N$<%=totalRow %>)">210</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,O$<%=shipRow %>:O$<%=totalRow %>)">218</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,P$<%=shipRow %>:P$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,Q$<%=shipRow %>:Q$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,R$<%=shipRow %>:R$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,S$<%=shipRow %>:S$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;CURRENTSHIPPED QTY&quot;,T$<%=shipRow %>:T$<%=totalRow %>)">844</td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl222 style='height:15.75pt'></td>
  <td class=xl222>&nbsp;</td>
  <td colspan=3 class=xl223 style='border-right:.5pt solid black;border-left:
  none'>TTL SHIPPED QTY</td>
  <td class=xl222>&nbsp;</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,L$<%=shipRow %>:L$<%=totalRow %>)">206</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,M$<%=shipRow %>:M$<%=totalRow %>)">210</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,N$<%=shipRow %>:N$<%=totalRow %>)">210</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,O$<%=shipRow %>:O$<%=totalRow %>)">218</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,P$<%=shipRow %>:P$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,Q$<%=shipRow %>:Q$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,R$<%=shipRow %>:R$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,S$<%=shipRow %>:S$<%=totalRow %>)">0</td>
  <td class=xl222 x:num
  x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;TTL SHIPPED QTY&quot;,T$<%=shipRow %>:T$<%=totalRow %>)">844</td>
  <td class=xl141>&nbsp;</td>
 </tr>
 <tr height=21 style='mso-height-source:userset;height:15.75pt'>
  <td height=21 class=xl222 style='height:15.75pt'></td>
  ...
  none'>BALANCE</td>
  <td class=xl222>&nbsp;</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,L$<%=shipRow %>:L$<%=totalRow %>)">-206</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,M$<%=shipRow %>:M$<%=totalRow %>)">-210</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,N$<%=shipRow %>:N$<%=totalRow %>)">-210</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,O$<%=shipRow %>:O$<%=totalRow %>)">-218</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,P$<%=shipRow %>:P$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,Q$<%=shipRow %>:Q$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,R$<%=shipRow %>:R$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,S$<%=shipRow %>:S$<%=totalRow %>)">0</td>
  <td class=xl222 x:num x:fmla="=SUMIF($H$<%=shipRow %>:$J$<%=totalRow %>,&quot;BALANCE&quot;,T$<%=shipRow %>:T$<%=totalRow %>)">-844</td>
  <td class=xl141>&nbsp;</td>
 </tr>
