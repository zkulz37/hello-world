...
<%
    ...
    dt = ESysLib.TableReadOpenCursor("SALE.sp_rpt_dsep00030", "'" + sopk + "'");
    if (dt.Rows.Count > 0)
    {
    ...
    dt2 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsep00030_1", "'" + sopk + "'");
    dt3 = ESysLib.TableReadOpenCursor("sale.sp_rpt_dsep00030_2", "'" + sopk + "'");   
 %>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=9627 style='border-collapse:
 ...
 <tr class=xl49 height=27 style='mso-height-source:userset;height:20.25pt'>
  <td height=27 class=xl55 colspan=4 style='height:20.25pt;mso-ignore:colspan'><%= l_cust_nm %></td>
  <td class=xl57>&nbsp;</td>
 ...
 <tr class=xl49 height=27 style='mso-height-source:userset;height:20.25pt'>
  <td height=27 class=xl64 colspan=4 style='height:20.25pt;mso-ignore:colspan'><%=l_addr %></td>
  <td class=xl66>&nbsp;</td>
 ...
 <tr class=xl49 height=21 style='mso-height-source:userset;height:15.75pt'>
  ...
  <table cellpadding=0 cellspacing=0>
   <tr>
    ...
    height:15.75pt;border-left:none;width:229pt' ></td>
   </tr>
  </table>
  </span></td>
 ...
 <tr class=xl49 height=27 style='mso-height-source:userset;height:20.25pt'>
  ...
  <td class=xl130 style='border-top:none;border-left:none'x:num  ><%= dt3.Rows[i]["qty_02"]%></td>
  <%
     if (delimethod == "03")
     {
          %>
          <td class=xl130 style='border-top:none;border-left:none'x:num ><%= Convert.ToDouble(dt3.Rows[i]["qty_02"])*36/24 %></td>
          <% 
     }
     else
     {
          %>
          <td class=xl130 style='border-top:none;border-left:none'x:num ><%= Convert.ToDouble(dt3.Rows[i]["qty_02"])*1.3 %></td>
          <% 
     }
   %>
