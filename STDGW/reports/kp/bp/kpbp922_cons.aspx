...
<%
    ...
    string l_Chk_WkngUP = Request["p_Chk_WkngUP"];
    string l_Chk_BCWS = Request["p_Chk_BCWS"];
    string l_WkngUP_Fr = Request["p_WkngUP_Fr"];
    string l_WkngUP_To = Request["p_WkngUP_To"];
    string l_PriceRange = Request["p_PriceRange"];
    string l_BCWS_Fr = Request["p_BCWS_Fr"];
    string l_BCWS_To = Request["p_BCWS_To"];
    ...
    l_parameter += "'" + l_Chk_WkngUP + "',";
    l_parameter += "'" + l_Chk_BCWS + "',";
    l_parameter += "'" + l_WkngUP_Fr + "',";
    l_parameter += "'" + l_WkngUP_To + "',";
    l_parameter += "'" + l_PriceRange + "',";
    l_parameter += "'" + l_BCWS_Fr + "',";
    l_parameter += "'" + l_BCWS_To + "'";
    DataTable dt = ESysLib.TableReadOpenCursor("EC111.sp_sel_kpbp922_cons", l_parameter);
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1566 style='border-collapse:
 ...
 <tr class=xl26 height=25 style='mso-height-source:userset;height:18.75pt'>
  ...
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][16].ToString()%></td>
  ...
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][22].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][23].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][24].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][25].ToString()%></td>
 </tr>
 <%
	}
 %>
