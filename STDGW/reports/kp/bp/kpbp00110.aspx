...
<% 
    ...
    string SQL = "select B.PROJECTCODE, A.REQUEST_DT , A.TCO_BUSPARTNER_PK, A.TECPS_PROJECTSUMM_PK, C.PARTNER_NAME, to_char(to_date(A.REQUEST_DT, 'YYYYMMDD'), 'DD MON YYYY') REQUEST_DT, " +
        ...
        "FROM TECPS_MCTREQUEST a, TECPS_PROJECTSUMM b, comm.TCO_BUSPARTNER c, acnt.TAC_ABDEPOMT d, acnt.TAC_ABDEPOMT e, comm.TCO_BUSPARTNER f " +
        " WHERE     a.del_if = 0    " +
        "       AND b.del_if = 0    " +
        "       and c.del_if(+) = 0   " +
        "       and d.del_if(+) = 0 " +
    ...
    string VAT_Rate = "";
    string ReadNum = "";
    DataTable dt_Detail = ESysLib.TableReadOpenCursor("EC111.rpt_sel_kpbp128", l_parameter);
    if (dt_Detail.Rows.Count > 0)
    {
        Net_Amt = decimal.Parse(dt_Detail.Rows[0][1].ToString());
        VAT_Amt = decimal.Parse(dt_Detail.Rows[1][1].ToString());
        TotalWorkdone_Amt = decimal.Parse(dt_Detail.Rows[2][1].ToString());
        AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][1].ToString());
        Retention_Amt = decimal.Parse(dt_Detail.Rows[4][1].ToString());
        Deduct_AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][1].ToString());
        Deduct_Retention = decimal.Parse(dt_Detail.Rows[4][1].ToString());
        TotalDeducting_Amt = decimal.Parse(dt_Detail.Rows[5][1].ToString());
        ThisPay_Amt = decimal.Parse(dt_Detail.Rows[6][1].ToString());

        Remark = dt_Detail.Rows[0][3].ToString();
        VAT_Rate = dt_Detail.Rows[1][4].ToString();
        
        if (p_Req_Times > 0)
        {
            Pre_Net_Amt = decimal.Parse(dt_Detail.Rows[0][2].ToString());
            Pre_VAT_Amt = decimal.Parse(dt_Detail.Rows[1][2].ToString());
            Pre_TotalWorkdone_Amt = decimal.Parse(dt_Detail.Rows[2][2].ToString());
            Pre_AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][2].ToString());
            Pre_Retention_Amt = decimal.Parse(dt_Detail.Rows[4][2].ToString());
            Pre_Deduct_AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][2].ToString());
            Pre_Deduct_Retention = decimal.Parse(dt_Detail.Rows[4][2].ToString());
            Pre_TotalDeducting_Amt = decimal.Parse(dt_Detail.Rows[5][2].ToString());
            Pre_ThisPay_Amt = decimal.Parse(dt_Detail.Rows[6][2].ToString());
        }
        else
        {
            Pre_Net_Amt = 0;
            Pre_VAT_Amt = 0;
            Pre_TotalWorkdone_Amt = 0;
            Pre_AdvPay_Amt = 0;
            Pre_Retention_Amt = 0;
            Pre_Deduct_AdvPay_Amt = 0;
            Pre_Deduct_Retention = 0;
            Pre_TotalDeducting_Amt = 0;
            Pre_ThisPay_Amt = 0;
        }

        This_Net_Amt = decimal.Parse(dt_Detail.Rows[0][2].ToString());
        This_VAT_Amt = decimal.Parse(dt_Detail.Rows[1][2].ToString());
        This_TotalWorkdone_Amt = decimal.Parse(dt_Detail.Rows[2][2].ToString());
        This_AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][2].ToString());
        This_Retention_Amt = decimal.Parse(dt_Detail.Rows[4][2].ToString());
        This_Deduct_AdvPay_Amt = decimal.Parse(dt_Detail.Rows[3][2].ToString());
        This_Deduct_Retention = decimal.Parse(dt_Detail.Rows[4][2].ToString());
        This_TotalDeducting_Amt = decimal.Parse(dt_Detail.Rows[5][2].ToString());
        This_ThisPay_Amt = decimal.Parse(dt_Detail.Rows[6][2].ToString());

         Accum_Net_Amt = Pre_Net_Amt + This_Net_Amt;
         Accum_VAT_Amt = Pre_VAT_Amt + This_VAT_Amt;
         Accum_TotalWorkdone_Amt = Pre_TotalWorkdone_Amt + This_TotalWorkdone_Amt;
         Accum_AdvPay_Amt = Pre_AdvPay_Amt + This_AdvPay_Amt;
         Accum_Retention_Amt = Pre_Retention_Amt + This_Retention_Amt;
         Accum_Deduct_AdvPay_Amt = Pre_Deduct_AdvPay_Amt + This_Deduct_AdvPay_Amt;
         Accum_Deduct_Retention = Pre_Deduct_Retention + This_Deduct_Retention;
         Accum_TotalDeducting_Amt = Pre_TotalDeducting_Amt + This_TotalDeducting_Amt;
         Accum_ThisPay_Amt = Pre_ThisPay_Amt + This_ThisPay_Amt;

          Bal_Net_Amt = Net_Amt - Accum_Net_Amt;
          Bal_VAT_Amt = VAT_Amt - Accum_VAT_Amt;
          Bal_TotalWorkdone_Amt = TotalWorkdone_Amt - Accum_TotalWorkdone_Amt;
          Bal_AdvPay_Amt = AdvPay_Amt - Accum_AdvPay_Amt;
          Bal_Retention_Amt = Retention_Amt - Accum_Retention_Amt;
          Bal_Deduct_AdvPay_Amt = Deduct_AdvPay_Amt - Accum_Deduct_AdvPay_Amt;
          Bal_Deduct_Retention = Deduct_Retention - Accum_Deduct_Retention;
          Bal_TotalDeducting_Amt = TotalDeducting_Amt - Accum_TotalDeducting_Amt;
          Bal_ThisPay_Amt = ThisPay_Amt - Accum_ThisPay_Amt;

          ReadNum = CommondLib.Num2EngText(dt_Detail.Rows[6][2].ToString(), p_Ccy);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=846 style='border-collapse:
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=2 class=xl99 width=123 style='border-right:.5pt solid black; border-left:none;width:92pt' x:num><%=Net_Amt%></td>
  <td colspan=3 class=xl115 width=112 style='border-left:none;width:85pt'  x:num><%=Pre_Net_Amt%></td>
  <td colspan=2 class=xl99 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_Net_Amt%></td>
  <td colspan=2 class=xl99 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_Net_Amt%></td>
  <td colspan=2 class=xl99 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_Net_Amt%></td>
  <td class=xl76 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td rowspan=2 height=52 class=xl116 width=37 style='border-bottom:.5pt solid black;  height:40.2pt;width:28pt'>&nbsp;</td>
  <td colspan=2 class=xl118 width=141 style='border-right:.5pt solid black;  border-left:none;width:106pt'>VAT (<%=VAT_Rate%>%)</td>
  <td colspan=2 class=xl120 width=123 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num><%=VAT_Amt%></td>
  <td colspan=3 class=xl122 width=112 style='border-left:none;width:85pt' x:num><%=Pre_VAT_Amt %></td>
  <td colspan=2 class=xl120 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_VAT_Amt %></td>
  <td colspan=2 class=xl120 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_VAT_Amt %></td>
  <td colspan=2 class=xl120 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_VAT_Amt %></td>
  <td class=xl77 width=114 style='border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=2 class=xl123 width=123 style='border-right:.5pt solid black;  width:92pt' x:num><%=TotalWorkdone_Amt %></td>
  <td colspan=3 class=xl125 width=112 style='border-left:none;width:85pt'  x:num><%=Pre_TotalWorkdone_Amt %></td>
  <td colspan=2 class=xl123 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_TotalWorkdone_Amt %></td>
  <td colspan=2 class=xl123 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_TotalWorkdone_Amt %></td>
  <td colspan=2 class=xl123 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_TotalWorkdone_Amt %></td>
  <td class=xl80 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr class=xl85 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl82 style='border-top:none' x:str="Advance Payment  ">Advance Payment</td>
  <td class=xl83 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl129 width=123 style='border-right:.5pt solid black;  width:92pt' x:num><%=AdvPay_Amt %></td>
  <td colspan=3 class=xl129 width=112 style='border-right:.5pt solid black;  border-left:none;width:85pt' x:num><%=Pre_AdvPay_Amt %></td>
  <td colspan=2 class=xl129 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_AdvPay_Amt %></td>
  <td colspan=2 class=xl129 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_AdvPay_Amt %></td>
  <td colspan=2 class=xl126 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_AdvPay_Amt %></td>
  <td class=xl84 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr class=xl85 height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl81 width=37 style='height:20.1pt;width:28pt' x:num>3</td>
  <td class=xl82 style='border-top:none' x:str="Retention ">Retention</td>
  <td class=xl83 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl126 width=123 style='border-right:.5pt solid black;  width:92pt' x:num><%=Retention_Amt %></td>
  <td colspan=3 class=xl126 width=112 style='border-right:.5pt solid black;  border-left:none;width:85pt' x:num><%=Pre_Retention_Amt %></td>
  <td colspan=2 class=xl126 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_Retention_Amt %></td>
  <td colspan=2 class=xl126 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_Retention_Amt %></td>
  <td colspan=2 class=xl126 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_Retention_Amt %></td>
  <td class=xl84 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=2 class=xl134 width=123 style='border-right:.5pt solid black;  width:92pt' x:num><%=Deduct_AdvPay_Amt %></td>
  <td colspan=3 class=xl136 width=112 style='border-left:none;width:85pt' x:num><%=Pre_Deduct_AdvPay_Amt %></td>
  <td colspan=2 class=xl134 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_Deduct_AdvPay_Amt %></td>
  <td colspan=2 class=xl134 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_Deduct_AdvPay_Amt %></td>
  <td colspan=2 class=xl134 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_Deduct_AdvPay_Amt %></td>
  <td class=xl89 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  <td height=26 class=xl90 style='height:20.1pt;border-left:none'>Retention</td>
  <td class=xl91 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl147 width=123 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num><%=Deduct_Retention %></td>
  <td colspan=3 class=xl147 width=112 style='border-right:.5pt solid black;  border-left:none;width:85pt' x:num><%=Pre_Deduct_Retention %></td>
  <td colspan=2 class=xl147 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_Deduct_Retention %></td>
  <td colspan=2 class=xl150 width=105 style='border-right:.5pt solid black;  border-left:none;width:79pt' x:num><%=Accum_Deduct_Retention %></td>
  <td colspan=2 class=xl152 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_Deduct_Retention %></td>
  <td class=xl92 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl145 width=123 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num><%=TotalDeducting_Amt %></td>
  <td colspan=3 class=xl156 width=112 style='border-left:none;width:85pt'  x:num><%=Pre_TotalDeducting_Amt %></td>
  <td colspan=2 class=xl145 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_TotalDeducting_Amt %></td>
  <td colspan=2 class=xl156 width=105 style='border-left:none;width:79pt'  x:num><%=Accum_TotalDeducting_Amt %></td>
  <td colspan=2 class=xl145 width=106 style='border-right:.5pt solid black;  border-left:none;width:80pt' x:num><%=Bal_TotalDeducting_Amt %></td>
  <td class=xl93 width=114 style='border-top:none;border-left:none;width:86pt'><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=2 class=xl160 width=123 style='border-right:.5pt solid black;  width:92pt' x:num><%=ThisPay_Amt %></td>
  <td colspan=3 class=xl160 width=112 style='border-right:.5pt solid black;  border-left:none;width:85pt' x:num><%=Pre_ThisPay_Amt %></td>
  <td colspan=2 class=xl163 width=108 style='border-right:.5pt solid black;  border-left:none;width:81pt' x:num><%=This_ThisPay_Amt %></td>
  <td colspan=2 class=xl165 style='border-right:.5pt solid black;border-left:  none' x:num><%=Accum_ThisPay_Amt %></td>
  <td colspan=2 class=xl165 style='border-right:.5pt solid black;border-left:  none' x:num><%=Bal_ThisPay_Amt %></td>
  <td class=xl97 width=114 style='border-top:none;border-left:none;width:86pt'  ><%=Remark%></td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td>:</td>
  <td colspan=8 style='mso-ignore:colspan' x:str="POSCO ENGINEERING &amp; CONSTRUCTION VIET NAM CO. LTD ">POSCO ENGINEERING &amp; CONSTRUCTION VIET NAM CO. LTD<span
