...
<%
    ...
    string l_parameter = "";
    l_parameter = "'" + l_project_pk + "',";
    l_parameter += "'" + l_work + "',";
    l_parameter += "'" + l_order_work + "'";
    //l_parameter += "'" + l_lst_filter + "',";
    //l_parameter += "'" + l_filter + "'";
    //Response.Write(l_parameter);
    //Response.End();
    DataTable dt = ESysLib.TableReadOpenCursor("EC111.sp_sel_kpbp922_cm", l_parameter);
%>
<head>
<meta http-equiv=Content-Type content="text/html; charset=utf-8">
<meta name=ProgId content=Excel.Sheet>
<meta name=Generator content="Microsoft Excel 11">
<link rel=File-List href="kpbm00050_cm_files/filelist.xml">
<link rel=Edit-Time-Data href="kpbm00050_cm_files/editdata.mso">
<link rel=OLE-Object-Data href="kpbm00050_cm_files/oledata.mso">
<!--[if gte mso 9]><xml>
 <o:DocumentProperties>
  <o:LastAuthor>ISA_SERVER</o:LastAuthor>
  <o:LastPrinted>2011-04-19T08:57:03Z</o:LastPrinted>
  <o:Created>1996-10-14T23:33:28Z</o:Created>
  <o:LastSaved>2011-04-19T08:57:09Z</o:LastSaved>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1599 style='border-collapse:
 ...
 <tr height=43 style='mso-height-source:userset;height:32.25pt'>
  <td colspan=18 height=43 class=xl32 width=1599 style='height:32.25pt;
  width:1198pt'>BCWS Details Registration - CM,Sprv</td>
 </tr>
 <tr height=24 style='mso-height-source:userset;height:18.0pt'>
  <td rowspan=2 height=48 class=xl29 width=64 style='border-bottom:.5pt solid black;
  height:36.0pt;border-top:none;width:48pt'>No</td>
  <td rowspan=2 class=xl29 width=159 style='border-bottom:.5pt solid black;
  border-top:none;width:119pt'>Description</td>
  <td rowspan=2 class=xl29 width=64 style='border-bottom:.5pt solid black;
  border-top:none;width:48pt'>Name</td>
  <td rowspan=2 class=xl29 width=64 style='border-bottom:.5pt solid black;
  border-top:none;width:48pt'>UOM</td>
  <td rowspan=2 class=xl29 width=101 style='border-bottom:.5pt solid black;
  border-top:none;width:76pt'>Quantity</td>
  <td colspan=4 class=xl31 style='border-left:none'>Direct Management</td>
  <td colspan=4 class=xl31 style='border-left:none'>Outsrc.</td>
  <td rowspan=2 class=xl29 width=64 style='border-bottom:.5pt solid black;
 ...
 <tr class=xl24 height=24 style='mso-height-source:userset;height:18.0pt'>
  ...
  border-left:none;width:48pt'>CCY</td>
  <td class=xl28 width=103 style='border-top:none;border-left:none;width:77pt'>MM</td>
 ...
 <tr class=xl26 height=25 style='mso-height-source:userset;height:18.75pt'>
  <td height=25 class=xl25 style='height:18.75pt;border-top:none'><%=dt.Rows[row][1].ToString()%></td>
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][2].ToString()%></td>
  ...
  <td class=xl27 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row][6].ToString()%></td>
  ...
  <td class=xl25 style='border-top:none;border-left:none'><%=dt.Rows[row][11].ToString()%></td>
  <td class=xl27 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row][12].ToString()%></td>
  <td class=xl27 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row][13].ToString()%></td>
  <td class=xl27 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row][14].ToString()%></td>
  <td class=xl27 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row][15].ToString()%></td>
  <td class=xl27 style='border-top:none;border-left:none'><%=dt.Rows[row][17].ToString()%></td>
