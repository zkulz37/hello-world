...
<%
	...
	DataTable dt = ESysLib.TableReadOpenCursor("EC111.sp_rpt_kpbm00050_cons", l_parameter);
%>
<head>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1566 style='border-collapse:
 ...
 <col width=64 style='width:48pt'>
 <col width=64 style='mso-width-source:userset;mso-width-alt:3500;width:48pt'>
 <col width=64 style='width:48pt'>
 ...
 <tr class=xl26 height=25 style='mso-height-source:userset;height:30pt' >
  ...
  <td class=xl36 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col06"].ToString()%></td>
  <td class=xl37 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col07"].ToString()%></td>
  <td class=xl37 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col08"].ToString()%></td>
  <td class=xl37 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col09"].ToString()%></td>
  <td class=xl37 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col10"].ToString()%></td>
 ...
 <%
  ...
  <td class=xl38 align=right style='border-top:none;border-left:none' x:num><%=dt.Rows[row]["col11"].ToString()%></td>
