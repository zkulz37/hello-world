...
<% 
    ...
    string SQL = "SELECT a.VOUCHER_NO,   " +
        ...
        "  FROM tecps_expense_req a, TECPS_PROJECTSUMM b, acnt.TAC_BFBENEFICIARY c, TECPS_ORDERINGCONTTYPE d   " +
        " WHERE     a.del_if = 0   " +
        "       AND b.del_if = 0   " +
        "       and c.del_if(+) = 0  " +
        "       and d.del_if = 0 " +
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1441 style='border-collapse:
 ...
 <%
     ...
     dt1 = ESysLib.TableReadOpenCursor("ec111.sp_pro_kpde415_detail", p_Pk);
     int i = 0;
     decimal _Total = 0;
 ...
 <%
     ...
     dt2 = ESysLib.TableReadOpenCursor("ec111.sp_pro_kpde415_report", p_Pk);	
     string p_Budget_VND = "";
     string p_Budget_USD = "";
     string p_Pre = "";
     string p_This = "";
