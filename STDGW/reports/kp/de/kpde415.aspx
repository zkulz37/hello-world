...
<%
    ...
    //============================================================================================
    DataTable dt_Sign = ESysLib.TableReadOpenCursor("EC111.sp_sel_kpac1014_1", l_parameter);
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=963 style='border-collapse:
 ...
 <%
        int i =0;
        int k = 0;
        DataTable dt_detail = ESysLib.TableReadOpenCursor("ec111.sp_sel_kpde00050_dr",p_Pk);
 ...
 <%
        ...
        "       a.NET_FAMT, " +
        "       a.DESCRIPTION " +
        "  FROM tecps_expense_reqd a, acnt.TAC_ABACCTCODE d " +
        " WHERE     a.del_if = 0 " +
        "       AND D.DEL_IF(+) = 0 " +
