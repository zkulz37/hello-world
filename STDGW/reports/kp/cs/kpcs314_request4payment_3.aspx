...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1840 style='border-collapse:
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl96 style='height:30.0pt'>&nbsp;</td>
  <td></td>
  <td class=xl97 colspan=2 style='mso-ignore:colspan'>2. Project name: </td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td class=xl97 style='mso-ignore:colspan' x:num><%=dt.Rows[0]["ccy"].ToString()%></td>
  <td colspan=9 class=xl97 style='mso-ignore:colspan' x:num></td>
  <td style='mso-ignore:colspan;border-right:1pt solid black'></td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl96 style='height:30.0pt'>&nbsp;</td>
  <td class=xl114>&nbsp;</td>
  <td colspan=2 class=xl160>VAT (10%)</td>
  ...
  <td colspan=3 class=xl116 style='border-left:none' x:num x:fmla="=G32+I32"></td>
 ...
 <tr class=xl112 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl119 x:num ><%=dt.Rows[0]["total_cont"].ToString()%></td>
  <td colspan=2 class=xl119 style='border-left:none' x:num ><%=dt.Rows[0]["total_pre"].ToString()%></td>
  <td colspan=2 class=xl119 style='border-left:none' x:num ><%=dt.Rows[0]["total_this"].ToString()%></td>
  <td colspan=3 class=xl119 style='border-left:none' x:num x:fmla="=G33+I33"></td>
 ...
 <tr class=xl112 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl119 style='border-left:none' x:num><%=dt.Rows[0]["adv_cont_pre"].ToString()%></td>
  <td colspan=2 class=xl119 style='border-left:none' x:num>0</td>
  <td colspan=3 class=xl119 style='border-left:none' x:num x:fmla="=G34+I34"></td>
 ...
 <tr class=xl112 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl119 style='border-left:none' x:num>0</td>
  <td colspan=2 class=xl119 style='border-left:none' x:num>0</td>
  <td colspan=3 class=xl119 style='border-left:none' x:num>0</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl116 x:num ><%=dt.Rows[0]["adv_cont"].ToString()%></td>
  ...
  <td colspan=3 class=xl116 style='border-left:none' x:num x:fmla="=G37+I37">0</td>
 ...
 <tr height=40 style='mso-height-source:userset;height:30.0pt'>
  <td height=40 class=xl96 style='height:30.0pt'>&nbsp;</td=G32+I312
  <td class=xl114 style='border-top:none'>&nbsp;</td>
  <td colspan=2 class=xl160>Retention (<%=dt.Rows[0]["reten"].ToString()%>%)</td>
  <td colspan=2 class=xl116 x:num><%=dt.Rows[0]["reten_deduct_cont"].ToString()%></td>
  ...
  <td colspan=3 class=xl116 style='border-left:none' x:num x:fmla="=G39+I39"></td>
 ...
 <tr class=xl112 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=2 class=xl119 x:num><%=dt.Rows[0]["total_deduct_cont"].ToString()%></td>
  <td colspan=2 class=xl119 style='border-left:none' x:num x:fmla="=G37+G38+G39">I40</td>
  <td colspan=2 class=xl119 style='border-left:none' x:num x:fmla="=I37+I38+I39">I40</td>
  <td colspan=3 class=xl119 style='border-left:none' x:num x:fmla="=K37+K38+K39">0</td>
 ...
 <tr class=xl112 height=40 style='mso-height-source:userset;height:30.0pt'>
  ...
  <td colspan=3 class=xl110 style='border-left:none' x:num x:fmla="=K33+K34+K35-K40">K41</td>
 ...
 <tr height=36 style='mso-height-source:userset;height:27.0pt'>
  ...
  <td colspan=3 class=xl127 style='border-right:.5pt solid black' x:num ><%=dt.Rows[0]["total_cont"].ToString() %></td>
  <td colspan=2 class=xl127 style='border-left:none' x:fmla="=G41">0</td>
