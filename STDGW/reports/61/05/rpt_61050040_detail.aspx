...
<%
    ...
    DataTable dt = ESysLib.TableReadOpenCursor("pm_rpt_61050040_progressm", p_Pk);
    if (dt.Rows.Count == 0)
    {
...
<link rel=File-List href="312_printoutprogress_files/filelist.xml">
<link rel=Edit-Time-Data href="312_printoutprogress_files/editdata.mso">
<link rel=OLE-Object-Data href="312_printoutprogress_files/oledata.mso">
<!--[if gte mso 9]><xml>
    ...
    <x:WorksheetOptions>
     ...
     <x:Print>
      ...
      <x:HeaderPicture>
       ...
       <x:Source>312_printoutprogress_files/image001.jpg</x:Source>
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=1136 style='border-collapse:
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl79 colspan="2" x:num><%=dt.Rows[0]["orgin_ctr_amt"].ToString()%></td>
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl79 x:num colspan="2"><%=dt.Rows[0]["final_ctr_amt"].ToString()%></td>
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl84 style='border-left:none'>Net Payment</td>
  <td class=xl84 style='border-left:none'>Total Payment</td>
  <td rowspan=2 class=xl114 style='border-bottom:.5pt hairline black'>Remark</td>
 </tr>
 <%
     DataTable dt_Detail_Sum = ESysLib.TableReadOpenCursor("pm_rpt_61050040_progressd_sum", p_Pk);
 ...
 <%
     ...
     decimal p_F15 = 0;
     decimal p_J15 = 0;
     DataTable dt_Detail = ESysLib.TableReadOpenCursor("pm_rpt_61050040_progressd", p_Pk);
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl91 colspan=2>Total</td>
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl83></td>
  <td class=xl92 x:num colspan="2"><%=dt.Rows[0]["final_ctr_amt"]%></td>
 
  <td class=xl79 x:num ><%=dt.Rows[0]["final_vat_famt"]%></td>
  <td class=xl92 x:num colspan=2><%=dt.Rows[0]["final_contract_famt"]%></td>
  <td colspan=3 class=xl68 style='mso-ignore:colspan'></td>
  <td class=xl77>&nbsp;</td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl69></td>
  <td class=xl92 x:num colspan="2"><%= dt_Detail_Sum.Rows[0]["inv_net"].ToString()%></td>
 
  <td class=xl92 x:num><%=p_Sum1%></td>
  <td class=xl92 x:num colspan=2><%=dt_Detail_Sum.Rows[0]["issue_inv_famt"].ToString()%></td>
  <td colspan=3 class=xl68 style='mso-ignore:colspan'></td>
  <td class=xl77>&nbsp;</td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl69></td>
  <td class=xl92 x:num colspan="2"><%= decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString()) - decimal.Parse(dt_Detail_Sum.Rows[0]["inv_net"].ToString()) %></td>

  <td class=xl92 x:num><%= decimal.Parse(dt.Rows[0]["final_vat_famt"].ToString()) - decimal.Parse(p_Sum1)%></td>
  <td class=xl92 x:num colspan=2><%=  decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString()) - decimal.Parse(dt_Detail_Sum.Rows[0]["inv_net"].ToString())  + decimal.Parse(dt.Rows[0]["final_vat_famt"].ToString()) - decimal.Parse(p_Sum1) %> </td>
  <td colspan=3 class=xl68 style='mso-ignore:colspan'></td>
  <td class=xl77>&nbsp;</td>
 </tr>
  <%
      ...
      DataTable dt_PaidAmt = ESysLib.TableReadOpenCursor("pm_rpt_61050040_progd_paidamt", p_Pk);
 ...
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  <td height=22 class=xl68 style='height:17.1pt'></td>
  <td class=xl78>Payment Amount</td>
  <td class=xl93 x:num><%=  decimal.Parse(p_Sum5)/ decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString())%></td>
  <td class=xl92 x:num colspan=2><%=p_Sum5%></td>
 
  <td class=xl92 x:num><%=p_Sum1%></td>
  <td class=xl92 x:num colspan=2><%=decimal.Parse(p_Sum5) + decimal.Parse(p_Sum1)%></td>
  <td colspan=3 class=xl68 style='mso-ignore:colspan'></td>
  <td class=xl77>&nbsp;</td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
  ...
  <td class=xl95 x:num><%= (decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString()) - decimal.Parse(p_Sum5))/ decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString()) %></td>
  <td class=xl96 x:num colspan="2"><%= decimal.Parse(dt.Rows[0]["final_ctr_amt"].ToString()) -  decimal.Parse(p_Sum5)  %></td>
 
  <td class=xl96 x:num><%= decimal.Parse(dt.Rows[0]["final_vat_famt"].ToString()) - decimal.Parse(p_Sum1)%></td>
  <td class=xl96 x:num colspan=2><%= decimal.Parse(dt.Rows[0]["final_contract_famt"].ToString()) - decimal.Parse(p_Sum6)%></td>
  <td colspan=3 class=xl68 style='mso-ignore:colspan'></td>
  <td class=xl77>&nbsp;</td>
 </tr>
 <tr height=22 style='mso-height-source:userset;height:17.1pt'>
