...
<%
        ...
        "and a.pk = '" + p_Pk + "' ";
            ...
            DataTable dt_Sign = ESysLib.TableReadOpenCursor("pm_rpt_61060060", p_Project_Pk);
            string p_Prepared = "";
            string p_Checked = "";
            string p_Reviewed_1 = "";
            string p_Reviewed_2 = "";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=963 style='border-collapse:
 ...
 <%
     ...
     DataTable dt_SumDt = ESysLib.TableReadOpenCursor("pm_rpt_61060060_amt_sum", p_Pk);
 ...
 <%
        int i =0;
        int k = 0;
        DataTable dt_detail = ESysLib.TableReadOpenCursor("pm_rpt_61060060_amt", p_Pk);
 ...
 <%
     ...
     DataTable dt_SumVAT = ESysLib.TableReadOpenCursor("pm_rpt_61060060_vat_sum", p_Pk);
 ...
 <%
        int j = 0;
     int f=0;
        DataTable dt_VAT = ESysLib.TableReadOpenCursor("pm_rpt_61060060_vat", p_Pk);
