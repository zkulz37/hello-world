...
<%
        ...
        "b.projectname       , " +
        "I.BEDEFI_NM   , " +
        "I.ACCOUNT_NO, I.BEDEFI_BANK_NM, a.TECPS_PROJECTSUMM_PK  " +
        "from tecps_expense_req a, " +
        "TECPS_PROJECTSUMM b, " +
        "TAC_BFBENEFICIARY i  " +
        "where a.del_if = 0 " +
        "and b.del_if(+) = 0 " +
        ...
        string l_Req_Dt = Request.QueryString["Req_dt"];
     	string l_parameter = "";
       l_parameter = "'" + p_Project_Pk + "','" + l_Req_Dt  + "'";
    //============================================================================================
    DataTable dt_Sign = ESysLib.TableReadOpenCursor("pm_rpt_61060050_1", l_parameter);

       //     DataTable dt_Sign = ESysLib.TableReadOpenCursor("pm_rpt_61060050", p_Project_Pk);
            string p_Prepared = "";
            string p_Checked = "";
            string p_Reviewed_1 = "";
            string p_Reviewed_2 = "";
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=963 style='border-collapse:
 ...
 <tr height=26 style='mso-height-source:userset;height:19.5pt'>
  <td colspan=3 rowspan=7 height=169 class=xl68 width=147 style='border-right:.5pt solid black;border-bottom:.5pt solid black;height:128.55pt;width:110pt'>PROPOSAL SHEET</td>
  <td colspan=2 class=xl78 style='border-right:.5pt solid black;border-left:  none'>Prepared by</td>
  <td colspan=3 class=xl78 style='border-right:.5pt solid black;border-left:  none'>Checked by</td>
  <td colspan=3 class=xl78 style='border-right:.5pt solid black;border-left:  none'>Review by</td>
 ...
 <tr height=26 style='mso-height-source:auto;height:20.1pt'>
  <td height=26 colspan="2" class=xl43 style='height:20.1pt'>Name: <%=p_Prepared%></td>
 ...
 <%
     decimal p_Plan = 0;
     string SQL_SumDt = "SELECT SUM (nvl(a.NET_FAMT,0)) " +
        "  FROM tecps_expense_reqd a " +
        " WHERE a.del_if = 0 AND A.TECPS_EXPENSE_REQ_PK = '"+p_Pk+"' AND A.DRCR_TYPE = 'D' ";
     DataTable dt_SumDt = ESysLib.TableReadOpen(SQL_SumDt);
     if (dt_SumDt.Rows[0][0].ToString() != "")
     {
 ...
 <tr class=xl48 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=2 class=xl95 width=122 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num></td>
  <td colspan=2 class=xl95 width=122 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num></td>
  <td colspan=2 class=xl95 width=122 style='border-right:.5pt solid black;  border-left:none;width:92pt' x:num></td>
 ...
 <%
        int i =0;
        int k = 0;
        DataTable dt_detail = ESysLib.TableReadOpenCursor("pm_rpt_61060050_dr",p_Pk);
 ...
 <tr class=xl48 height=33 style='mso-height-source:userset;height:24.95pt'>
  ...
  <td class=xl52 ><%=dt_detail.Rows[i][4] %></td>
  <td colspan=2 class=xl97 style='border-right:.5pt solid black;border-left:  none;border-top:.5pt hairline windowtext'><%=dt_detail.Rows[i][5] %></td>
  <td colspan=2 class=xl99 width=122 style='border-right:.5pt solid black;  border-left:none;width:92pt;border-top:.5pt hairline windowtext' x:num><%=dt_detail.Rows[i][8] %></td>
  <td colspan=2 class=xl101 style='border-right:.5pt solid black;border-left:  none;border-top:.5pt hairline windowtext' x:num></td>
  <td colspan=2 class=xl101 style='border-right:.5pt solid black;border-left:  none;border-top:.5pt hairline windowtext' x:num></td>
  <td colspan=2 class=xl103 style='border-right:.5pt solid black;border-left:  none;border-top:.5pt hairline windowtext' x:num></td>
  <td colspan=2 class=xl105 style='border-right:.5pt solid black;border-left:  none;border-top:.5pt hairline windowtext'><%=dt_detail.Rows[i][10] %></td>
  <td class=xl51>&nbsp;</td>
 </tr>
 <%k += 1;
        } %>
 <%
     ...
     string SQL_SumVAT = "SELECT SUM (nvl(a.NET_FAMT,0)) " +
        "  FROM tecps_expense_reqd a " +
        " WHERE a.del_if = 0 AND A.TECPS_EXPENSE_REQ_PK = '"+p_Pk+"' AND A.DRCR_TYPE = 'D' and a.VAT_YN = 'Y' ";
     DataTable dt_SumVAT = ESysLib.TableReadOpen(SQL_SumVAT);
     if (dt_SumVAT.Rows[0][0].ToString().Trim() != "")
     {
 ...
 <%
        int j = 0;
        string SQL_VAT = "SELECT rownum, " + 
        "       d.AC_CD, " +
        "       d.AC_NM, " +
        "       a.NET_FAMT, " +
        "       a.DESCRIPTION " +
        "  FROM tecps_expense_reqd a, TAC_ABACCTCODE d " +
        " WHERE     a.del_if = 0 " +
        "       AND D.DEL_IF(+) = 0 " +
        "       AND A.TAC_ABACCTCODE_PK = d.pk(+) " +
        "       AND A.TECPS_EXPENSE_REQ_PK = '" + p_Pk + "' "+
        "       AND A.DRCR_TYPE = 'D' " +
        "       AND A.VAT_YN = 'Y' order by rownum ";
        DataTable dt_VAT = ESysLib.TableReadOpen(SQL_VAT);
 ...
 <tr class=xl53 height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td class=xl121 style='border-left:none;border-top:.5pt hairline windowtext;' x:num><%=dt_VAT.Rows[j][0]%></td>
  <td class=xl122 style='border-top:.5pt hairline windowtext;'><%=dt_VAT.Rows[j][1]%></td>
  <td colspan=2 class=xl97 style='border-right:.5pt solid black;border-left: none;border-top:.5pt hairline windowtext;'><%=dt_VAT.Rows[j][2]%></td>
  <td colspan=2 class=xl99 width=122 style='border-right:.5pt solid black; border-left:none;width:92pt;border-top:.5pt hairline windowtext;' x:num><%=dt_VAT.Rows[j][3]%></td>
  <td colspan=2 class=xl124 style='border-right:.5pt solid black;border-left: none;border-top:.5pt hairline windowtext;' x:num></td>
  <td colspan=2 class=xl124 style='border-right:.5pt solid black;border-left: none;border-top:.5pt hairline windowtext;' x:num></td>
  <td colspan=2 class=xl124 style='border-right:.5pt solid black;border-left: none;border-top:.5pt hairline windowtext;' x:num></td>
  <td colspan=2 class=xl126 style='border-right:.5pt solid black;border-left: none;border-top:.5pt hairline windowtext;'><%=dt_VAT.Rows[j][4]%></td>
  <td class=xl56>&nbsp;</td>
 </tr>
  <%} %>
 ...
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
  ...
  <td colspan=3 class=xl119 style='border-right:.5pt solid black;border-left:  none' x:num></td>
  <td colspan=6 class=xl31 style='mso-ignore:colspan'></td>
  <td class=xl32>&nbsp;</td>
 </tr>
 <tr height=26 style='mso-height-source:userset;height:20.1pt'>
