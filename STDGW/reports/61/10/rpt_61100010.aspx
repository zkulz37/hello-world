...
<%
	...
	string l_parameter="",l_budgetno="",l_project_name="",l_total="";
     ...
     DataTable dt = ESysLib.TableReadOpenCursor("pm_rpt_61100010", l_parameter);
    if (dt.Rows.Count == 0)
    {
...
<table x:str border=0 cellpadding=0 cellspacing=0 width=949 style='border-collapse:
 ...
 <tr height=21 style='height:15.75pt'>
  <td colspan=4 height=21 class=xl34 style='height:15.75pt'>M s&#7889;
  thu&#7871;:</td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl26 style='mso-ignore:colspan'></td>
  <td colspan=2 class=xl24 style='mso-ignore:colspan'></td>
 ...
 <tr class=xl27 height=47 style='mso-height-source:userset;height:35.25pt'>
  ...
  Gross Profit<span style='mso-spacerun:yes'>㠠 </span>Rate(%)</td>
  <td class=xl29></td>
