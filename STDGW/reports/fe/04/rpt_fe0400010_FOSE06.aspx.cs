...
public partial class rpt_fe0400010_FOSE06 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400010_FOSE06.xls";
        string TempFile = "../../../system/temp/rpt_fe0400010_FOSE06_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400010_FOSE06_1", "'" + from_dt + "','" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400010_FOSE06_2" , para);
