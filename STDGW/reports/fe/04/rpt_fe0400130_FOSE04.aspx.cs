...
public partial class rpt_fe0400130_FOSE04 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400130_FOSE04.xls";
        string TempFile = "../../../system/temp/rpt_fe0400130_FOSE04_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400130_FOSE04_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400130_FOSE04_2" , para);
        ...
        {								
			...
			exSheet.Cells[pos + i, 2 ].Value = dtDetail.Rows[i]["in_date"];		
			
			exSheet.Cells[pos + i, 3 ].Value = dtDetail.Rows[i]["dieuvan_tp_amount"];							
			exSheet.Cells[pos + i, 4 ].Value = dtDetail.Rows[i]["dieuvan_ptp_amount"];			
			exSheet.Cells[pos + i, 5 ].Value = dtDetail.Rows[i]["dieuvan_total_amount"];				
			exSheet.Cells[pos + i, 6 ].Value = dtDetail.Rows[i]["sx_tp_amount"];	
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["sx_ptp_amount"];	
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["sx_total_amount"];	 
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["ncc_tp_amount"];	
			exSheet.Cells[pos + i,10 ].Value = dtDetail.Rows[i]["ncc_ptp_amount"];	
			exSheet.Cells[pos + i,11 ].Value = dtDetail.Rows[i]["ncc_total_amount"];
