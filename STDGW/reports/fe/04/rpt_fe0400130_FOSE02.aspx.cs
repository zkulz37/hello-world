...
public partial class rpt_fe0400130_FOSE02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400130_FOSE02.xls";
        string TempFile = "../../../system/temp/rpt_fe0400130_FOSE02_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400130_FOSE02_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400130_FOSE02_2" , para);
        ...
        {								
			...
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["outgo_amount"];
			
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["mat_outgo_amount"];
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["ptp_outgo_amount"];
