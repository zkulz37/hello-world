...
public partial class rpt_fe0400040_FOSE02 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400040_FOSE02.xls";
        string TempFile = "../../../system/temp/rpt_fe0400040_FOSE02_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400040_FOSE02_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400040_FOSE02_2" , para);
        ...
        {								
			...
			exSheet.Cells[pos + i, 2 ].Value = dtDetail.Rows[i]["code_nm"];
							
			exSheet.Cells[pos + i, 5 ].Value = dtDetail.Rows[i]["sale_qty"];			
			exSheet.Cells[pos + i, 6 ].Value = dtDetail.Rows[i]["sale_amount"];	
			
			exSheet.Cells[pos + i, 7 ].Value = dtDetail.Rows[i]["income_amount"];	
			exSheet.Cells[pos + i, 8 ].Value = dtDetail.Rows[i]["income_ratio"];	
			exSheet.Cells[pos + i, 9 ].Value = dtDetail.Rows[i]["outgo_amount"];	 
