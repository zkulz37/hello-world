...
public partial class rpt_fe0400010_FOSE03 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400010_FOSE03.xls";
        string TempFile = "../../../system/temp/rpt_fe0400010_FOSE03_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400010_FOSE03_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400010_FOSE03_2" , para);
