...
public partial class rpt_fe0400040_FOSE01 : System.Web.UI.Page
{
    protected void Page_Load(object sender, EventArgs e)
    {
        ...
        string TemplateFile = "rpt_fe0400040_FOSE01.xls";
        string TempFile = "../../../system/temp/rpt_fe0400040_FOSE01_" + Session["User_ID"].ToString() + ".xls";
		...
		DataTable dtInfo   = ESysLib.TableReadOpenCursor("lg_rpt_fe0400040_FOSE01_1", "'" + Session["User_ID"].ToString() + "'");				
		...
		DataTable dtDetail = ESysLib.TableReadOpenCursor("lg_rpt_fe0400040_FOSE01_2" , para);
