    ...
    var obj_lst;
       ...
       else if (obj.id=="datWorkGroup_info")
       {
            if(tabMain.GetCurrentPageNo()==0)
            {
                //if(lstOrg.value=='ALL')
                //{                
                    lstWG0.SetDataText(txtwg_tmp.text+'|ALL|Select All');
                    lstWG0.value='ALL';
                //}
                //else
       ...
       {
            lstOrg0.SetDataText(txtdept_temp.text);
       ...
       else if (obj.id=="datTime_summary0")
       {
           idRecord0.text=idGrid0.rows-1+" Records."; 
       ...
       else if (obj.id=="datFind_Report")
       {
           var url;
            ...
            {
                if (idPrint2.value==1)
                    url =System.RootURL + '/reports/ch/ba/'+txtReport_tmp.text+'?p_user=' + user + '&p_wg=' + lstWG2.value + '&p_search=' + idSearch2.value + '&p_input=' + idtxtTmp2.text + '&p_tco_org_pk=' + lstOrg2.value   + '&p_from=' +  FromDT2.value + '&p_to=' + ToDT2.value + '&p_opt=' + idLstWT2.value + '&p_wt_ot=' + idtxtWT2.text + "&p_nation=" + lstNation2.value ;
                else if (idPrint2.value==2)
                    url =System.RootURL + '/reports/ch/ba/'+txtReport_tmp.text+'?p_user=' + user + '&p_wg=' + lstWG2.value + '&p_search=' + idSearch2.value + '&p_input=' + idtxtTmp2.text + '&p_tco_org_pk=' + lstOrg2.value   + '&p_from=' +  FromDT2.value + '&p_to=' + ToDT2.value + '&p_opt=' + idLstWT2.value + '&p_wt_ot=' + idtxtWT2.text + '&p_month=' + (lstMonthOnly.GetText()  + '/' + idYear2.value ) + '&p_week=' + lstWeek.value + "&p_nation=" + lstNation2.value  ;
                else
                    url =System.RootURL + '/reports/ch/ba/'+txtReport_tmp.text+'?p_user=' + user + '&p_wg=' + lstWG2.value + '&p_search=' + idSearch2.value + '&p_input=' + idtxtTmp2.text + '&p_tco_org_pk=' + lstOrg2.value   + '&p_from=' +  FromDT2.value + '&p_to=' + ToDT2.value + '&p_opt=' + idLstWT2.value + '&p_wt_ot=' + idtxtWT2.text + '&p_month=' + (lstMonthOnly.GetText()  + '/' + idYear2.value ) + "&p_nation=" + lstNation2.value ;
            }
            else if (rpt_no==3)
...
function OnReport(obj)
{
    ...
    if (obj==1)
        txtReport_tmp.text="rpt_time_summary_v2.aspx";
    else if (obj==2)
    {
        if (idPrint2.value==1)
            txtReport_tmp.text="rpt_working_time_total_v2.aspx";
        else if (idPrint2.value==2)
        ...
        txtReport_tmp.text="rpt_time_summary_year.aspx";
    else if (obj==4)    
        txtReport_tmp.text="rpt_time_group_v2.aspx";
    datFind_Report.Call();
}
...
<gw:data id="datTime_summary0" onreceive="OnDataReceive(this)"  > 
        <xml> 
           <dso  type="grid"  function="hr_SEL_10020003_time_terminal" procedure="" parameter="1"> 
                <input bind="idGrid0"> 
                    <input bind="lstOrg0" /> 
                    <input bind="lstWG0" /> 
                    <input bind="idWorkdt" /> 
                    <input bind="lstWS0" /> 
                    <input bind="idSearch0" />
                    <input bind="idtxtTmp0" />
                    <input bind="lstNation0" />
...
<gw:data id="datTime_summary1" onreceive="OnDataReceive(this)"  > 
        <xml> 
           <dso  type="grid"  function="hr_SEL_70030002_TIME_SUM_v2" procedure="" parameter="1"> 
                <input bind="idGrid1"> 
                    <input bind="lstOrg" /> 
                    <input bind="lstWG" /> 
                    <input bind="FromDT" /> 
...
<table name="Terminal Time" id="Table2" class="itable" width="100%" cellpadding="0"  cellspacing="0" border=1 style="height:100%;">
     <tr style="width:100%;height:100%" valign="top">
        <td>
            <table width="100%;height:12%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                    <td colspan=5 align=right style="width:6%;border:0" ><a title="Click here to show department" onclick="OnShowPopup(0)" href="#tips" >Organization</a></td>
		            <td colspan=8 align=right style="width:20%;border:0"><gw:list  id="lstOrg0" value="ALL"  maxlen = "100" styles='width:100%' onchange="onChange_org()" >
                        <data>
		            ...
		            <td colspan=8 align=right style="width:16%;border:0"><gw:list  id="lstWG0" value="ALL"  maxlen = "100" styles='width:100%' >
                    ...
                    <td colspan=5 align=right style="width:10%;border:0"><gw:datebox id="idWorkdt"  maxlen = "10" text="" styles='width:100%'lang="<%=Session("Lang")%>" /></td>
		            <td align=right style="width:2%;border:0">&nbsp;</td>
		            <td colspan=5 align=right style="width:10%;border:0">&nbsp;</td>
		            <td align=right colspan=3 style="width:6%;border:0">Nation</td>
                    <td align=left colspan=4 style="width:8%;border:0">
                    <gw:list id="lstNation0" value='01' styles="width:100%">
				        <data>
                    ...
                    <td align=right style="width:2%;border:0"><gw:imgBtn id="ibtnSearch0" alt="Search" img="search" text="Search" onclick="OnSearch(datTime_summary0)" /></td>
                    <td align=right style="width:2%;border:0"></td>
                    <td align=right style="width:2%;border:0">&nbsp;</td>
              ...
              <tr>
                    ...
                    <td colspan=19 align=right style="width=38%"><gw:list  id="lstWS0" value="ALL"  maxlen = "100" styles='width:100%' onchange="">
		            ...
		            <td colspan=5 align=right style="width:10%"><gw:list  id="idSearch0" value="1" styles="width:96%" >
                            <data>|1|Emp ID|2|Card ID|3|Name</data></gw:list></td>
                    <td align=right style="width:2%;border:0"></td>
		            <td colspan=5 align=right style="width:10%"><gw:textbox id="idtxtTmp0" maxlen = "20" styles="width:96%" onenterkey="OnSearch(datTime_summary0)" /></td>
		            <td colspan=11 align=right style="width:22%"style="color=#FF00CC"><gw:label id="idRecord0" text="0 record(s)" styles="width:100%" ></gw:label></td>
              </tr>
            </table>
            <table cellspacing=0 cellpadding=0 style="height:88%" width=100% border=1>
                    <tr style="border:1;height:100%" valign="top">
                        <td  style="width:100%"> 
                            <gw:grid   
	                            id="idGrid0"  
	                            header="Organization|WGroup|Date|Emp ID|Name|Work Shift|TIME IN|TIME OUT"   
	                            format="0|0|0|0|0|0|0|0"  
	                            aligns="0|0|0|1|0|0|1|1"  
	                            defaults="|||||||"  
	                            editcol="0|0|0|0|0|0|0|0"  
	                            widths="3000|2000|1200|2000|2000|4000|1000|1000"  
     ...
     <tr style="width:100%;height:100%" valign="top">
        <td>
            <table width="100%;height:12%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
                    <td colspan=5 align=right style="width=10%">Work Shift</td>
                    <td colspan=19 align=right style="width=38%"><gw:list  id="lstWS" value="ALL"  maxlen = "100" styles='width:100%' onchange="">
                            <data><%=ESysLib.SetListDataSQL("SELECT pk,shift||'-'||remark FROM thr_work_shift WHERE DEL_IF = 0 and use_yn='Y'  order by shift")%>|ALL|WS-Select All</data></gw:list>
                    </td>
                    <td colspan=4 align=right style="width:8%">Search by</td>
		            ...
		            <td colspan=11 align=right style="width:22%"style="color=#FF00CC"><gw:label id="idRecord" text="0 record(s)" styles="width:100%" ></gw:label></td>
              </tr>
              <tr>
        ...
        <td>
            <table width="100%;height:12%" border="0" cellspacing="0" cellpadding="0">
              <tr>
                    ...
                    <td colspan=5 align=right style="width:10%"><gw:textbox id="idtxtWT2" maxlen = "20" styles="width:95%" onenterkey="OnSearch(datTime_summary2)" /></td>
		            ...
		            <td colspan=5 align=center style="width:10%"><gw:textbox id="idtxtTmp2" maxlen = "20" styles="width:90%" onenterkey="OnSearch(datTime_summary2)" /></td>
		            <td align=right style="width:2%;border:0"></td>
                    <td align=right style="width:2%;border:0"><gw:imgBtn id="ibtnSearch2" alt="Search" img="search" text="Search" onclick="OnSearch(datTime_summary2)" /></td>
              </tr>
              <tr>
		            ...
		            <td colspan=5 align=right style="width:10%"><b style="color=#FF00CC"><gw:label id="idRecord2" text="0 rec(s)" styles="width:100%" ></gw:label></b></td>
              </tr>
            </table>
            <table cellspacing=0 cellpadding=0 style="height:88%" width=100% border=1>
                    <tr style="border:1;height:100%" valign="top">
        ...
        <td>
            <table width="100%;height:12%" border="0" cellspacing="0" cellpadding="0">
              ...
              <tr>
		            ...
		            <td colspan=14 align=right style="width:28%"><b style="color=#FF00CC"><gw:label id="idRecord3" text="0 record(s)" styles="width:100%" ></gw:label></b></td>
              </tr>
            </table>
            <table cellspacing=0 cellpadding=0 style="height:88%" width=100% border=1>
                    <tr style="border:1;height:100%" valign="top">
