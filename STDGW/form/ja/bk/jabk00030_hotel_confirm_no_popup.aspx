...
<body>
    ...
    <gw:data id="dsoRoom" onreceive="OnDataReceive(this)">
        <xml>
           <dso  type="grid"  function="CRM.sp_sel_jabk00030_popup" >
                <input  bind="grdRoom">
                    <input bind="dtFrom" />
					<input bind="dtTo" />
    ...
    <table style="width: 100%; height: 100%" border="1">
        ...
        <tr style="height: 95%">
            <td>
                <gw:grid id='grdRoom' header="_PK|Arrival|Departure Date|Last Name|First Name|Rooms|Pax|RSV No|Company Name"
                                format="0|0|0|0|0|0|0|0|0" aligns="0|0|0|0|0|0|3|0|0" defaults="||||||||" editcol="0|0|0|0|0|0|0|0|0"
								autosize="true"
