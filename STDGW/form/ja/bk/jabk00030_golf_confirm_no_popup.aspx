...
function Bingding()
{	var data;
	data ="data|10|CONFIRMED|30|CANCEL|40|WAITING"  
...
<body>
    ...
    <gw:data id="dsoRoom" onreceive="OnDataReceive(this)">
        <xml>
           <dso  type="grid"  function="CRM.sp_sel_jabk00030_golf_popup" >
                <input  bind="grdRoom">
                    <input bind="dtFrom" />
					<input bind="dtTo" />
    ...
    <table style="width: 100%; height: 100%" border="1">
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
						...
						<td style="width: 10%; white-space: nowrap" align='right'>RSV#/Guest Name</td>
						<td style="width: 20%; white-space: nowrap">
						...
						<td style="width: 20%; white-space: nowrap">
							<gw:list id="lstSearchStatus"   onchange="OnSearch()" />
						</td>
						<td style="width: 10%; white-space: nowrap">
						</td>
        ...
        <tr style="height: 95%">
            <td>
                <gw:grid id='grdRoom' header="_PK|Member Type|Palyer Name|Book Time|Book Date|RSV No|Company Name|Contact Person"
                                format="0|0|0|0|0|0|0|0" aligns="0|1|0|1|0|0|0|0" defaults="||||||||" editcol="0|0|0|0|0|0|0|0"
								autosize="true"
