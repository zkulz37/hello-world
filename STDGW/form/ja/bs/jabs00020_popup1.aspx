...
function BodyInit()
{
	...
	idcode3.SetDataText("Biz Code" + "&nbsp;");
	idname3.SetDataText("Biz Name" + "&nbsp;");
    
    if(idDsql != "ACNT.SP_SEL_PL_POPUP" && idDsql != "ACNT.SP_SEL_PL_POPUP_PLPK" && idDsql != "ACNT.SP_SEL_PL_POPUP_CENTERPK" && idDsql != "CRM.sp_sel_jabs00020_popup1" )	 
    {
	...
	else
	{
	    ...
	    ctrl.Cell(0, 0, 3, 0, 3) = "Biz Code";
	    ctrl.ColWidth(3) = "1500";
	    ctrl.Cell(0, 0, 4, 0, 4) = "Biz Name";
