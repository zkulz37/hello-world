...
function Select()
{
	...
	for(j=0;j<idGrid.cols;j++)
	{
		aValue[j] = idGrid.GetGridData(ctrl.row,j);
	}
	//aValue[aValue.length]=tmp; 
                ...
                <tr height="15%">
	                <td > 
		                ...
		                <tr>
							...
							<td width="5%" align="left"><gw:icon id="btnCheck" img="in" text="Chk All" onclick="OnCheck()" style="display:none"/></td>
						</tr>  
				        </table>
		            </td>
	    	    </tr>
	    	    <tr height="80%"> 
	    		    <td>
	    				...
	    				<tr>
							...
							<gw:grid   
							    id="idGrid"  
							    header  ="_Acc_pk|_CHK|Account Code|Account Name"
                                format  ="0|3|0|0"
                                aligns  ="0|1|1|0"
                                defaults="|||"
                                editcol ="0|1|1|0"
