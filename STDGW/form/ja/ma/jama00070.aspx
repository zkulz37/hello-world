...
function BuildGrid()
{
	...
	grd_con.TextMatrix(0, 0)  = 'Administrative & General Expenses';
	grd_con.TextMatrix(0, 1)  = 'Account Code';
	grd_con.TextMatrix(0, 2)  = 'Dept Code';
	grd_con.TextMatrix(0, 3)  = 'Executive Office';
	grd_con.TextMatrix(0, 4)  = 'Accounting & Control, & IT';
	grd_con.TextMatrix(0, 5)  = 'Purchasing, Receiving & Inventory Control';
...
function OnClick(obj)
{
    ...
    {
        case "ibtnSearch":
			dso_sp_sel_jama00070.Call('SELET');
        break;
        case "ibtnUpdate":
            alert("Update");
        break;
        ...
        break;
        case "ibtnReport":
            var fpath = System.RootURL+ '/reports/ja/ma/rpt_jama00070.aspx?p_Month=' + idMonth.GetData();
            window.open(fpath);
        break;
    }
}
...
{	
    ...
    for (i = 3; i < ctrl.Rows; i++)
	{
        ...
        else if (grdData.GetGridData(i, 7)== "I")
        {
	        grdData.SetCellBold(i, 0, i, 5, false);
	        ctrl.Cell(14, i, 0, i, 5) = true; // Chu nghieng
	    }
	    else
	    {
	        ctrl.Cell(14, i, 0, i, 5) = false;
		...
		grdData.GetGridControl().TextMatrix(1, 3)  = 'Executive Office';
		grdData.GetGridControl().TextMatrix(1, 4)  = 'Accounting & Control, & IT';
		grdData.GetGridControl().TextMatrix(1, 5)  = 'Purchasing, Receiving & Inventory Control';
...
<body>
<!--------------------------------------------------------------------------------------->
<gw:data id="dso_sp_sel_jama00070" onreceive="OnDataReceive()">
    <xml>                                                               
        <dso id="1" type="grid" user="prod" function="acnt.sp_sel_jama00070"> 
            <input> 
                <input bind="idMonth" />
            </input> 
            <output bind="grdData" /> 
				 ...
				 <tr style="width:100%; height:95%">
                	<td colspan="4" style="padding-top:4px;background: #BDE9FF">
                    	<gw:grid id="grdData"
							 ...
							 sorting	="F"
                             widths		="3200|1200|1200|3000|3000|3000|0|0|0"
