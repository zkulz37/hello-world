...
function BuildGrid()
{
	...
	grd_con.TextMatrix(0, 0)  = 'Security Expenses';
...
function OnClick(obj)
{
    ...
    {
        case "ibtnSearch":
			dso_sp_sel_jama00110.Call('SELET');
        break;
        case "ibtnUpdate":
            alert("Update");
        break;
        ...
        break;
        case "ibtnReport":
            var fpath = System.RootURL+ '/reports/ja/ma/rpt_jama00110.aspx?p_Month=' + idMonth.GetData();
            window.open(fpath);
        break;
    }
}
...
<body>
<!--------------------------------------------------------------------------------------->
<gw:data id="dso_sp_sel_jama00110" onreceive="OnDataReceive()">
    <xml>                                                               
        <dso id="1" type="grid" user="prod" function="acnt.sp_sel_jama00110"> 
            <input> 
                <input bind="idMonth" />
            </input> 
            <output bind="grdData" /> 
