...
function BuildGrid()
{
	...
	grd_con.TextMatrix(0, 0)  = 'Human Resources Expenses';
	grd_con.TextMatrix(0, 1)  = 'Account Code';
	grd_con.TextMatrix(0, 2)  = 'Dept Code';
	grd_con.TextMatrix(0, 3)  = 'Personnel';
	grd_con.TextMatrix(0, 4)  = 'Training';
...
function OnClick(obj)
{
    ...
    {
        case "ibtnSearch":
			dso_sp_sel_jama00080.Call('SELET');
        break;
        case "ibtnUpdate":
            alert("Update");
        break;
        ...
        break;
        case "ibtnReport":
            var fpath = System.RootURL+ '/reports/ja/ma/rpt_jama00080.aspx?p_Month=' + idMonth.GetData();
            window.open(fpath);
        break;
    }
}
...
{	
    ...
    for (i = 3; i < ctrl.Rows; i++)
	{
		...
		grdData.GetGridControl().TextMatrix(1, 3)  = 'Personnel';
		grdData.GetGridControl().TextMatrix(1, 4)  = 'Training';
...
<body>
<!--------------------------------------------------------------------------------------->
<gw:data id="dso_sp_sel_jama00080" onreceive="OnDataReceive()">
    <xml>                                                               
        <dso id="1" type="grid" user="prod" function="acnt.sp_sel_jama00080"> 
            <input> 
                <input bind="idMonth" />
            </input> 
            <output bind="grdData" /> 
				 ...
				 <tr style="width:100%; height:95%">
                	<td colspan="4" style="padding-top:4px;background: #BDE9FF">
                    	<gw:grid id="grdData"
							 ...
							 sorting	="F"
                             widths		="3200|1200|1200|3000|3000|3000|0|0"
