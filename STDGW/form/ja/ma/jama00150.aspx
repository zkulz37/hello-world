			...
			if(arrOp[idx].checked)
				switch(arrOp[idx].id){   
					case "opArrivalList"://arrival
						var url = '/reports/ht/fo/htfo00010.aspx?p_dt_frm='+ dtArrivalListFrom.value+'&p_dt_departure='+dtArrivalListTo.value+'&p_guest_name='+""+'&p_count_RM='+"";
					...
					case "opfinalrevenueusd"://usd 
							var url = '/reports/ja/ma/rpt_jama00010_monthly_revenue_a3_usd_new.aspx?p_month='+dtMonthUSD.value;  
							System.OpenTargetPage( System.RootURL+url , "newform" );	
					...
					case "opWeeklyRevenue":
						...
						System.OpenTargetPage( System.RootURL+url , "newform" );*/
						var url = '/reports/ja/ma/rpt_jama00150_WeeklyRevenue_new.aspx?p_Month='+dtWeeklyRevenue.GetData()+'&p_week='+lstWeekly.value;  
						System.OpenTargetPage( System.RootURL+url , "newform" );
					break; 	
					...
					case "opFnBSession"://FnB Session    	                                     
						  url = System.RootURL + '/reports/ja/rt/FNBReport1108.aspx?dtfr='+dtFnBSessionFrm.value+'&dtTo='+dtFnBSessionTo.value;
							System.OpenTargetPage(url); 
					break;	
