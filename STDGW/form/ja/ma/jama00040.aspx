...
function BuildGrid()
{
	...
	grd_con.TextMatrix(0, 0)  = 'Golf Pro shop Statement of Income & Expenses';
	grd_con.TextMatrix(0, 1)  = 'Account Code';
	grd_con.TextMatrix(0, 2)  = 'Dept Code';
	grd_con.TextMatrix(0, 3)  = 'Amount';
	grd_con.TextMatrix(0, 4)  = '1';
	grd_con.TextMatrix(0, 5)  = '2';
	grd_con.TextMatrix(0, 6)  = '3';
}
//======================================================================
function OnClick(obj)
{
    ...
    {
        case "ibtnSearch":
			dso_sp_sel_jama00040.Call('SELET');
        break;
        case "ibtnUpdate":
            alert("Update");
        break;
        ...
        break;
        case "ibtnReport":
            var fpath = System.RootURL+ '/reports/ja/ma/rpt_jama00040.aspx?p_Month=' + idMonth.GetData();
            window.open(fpath);
        break;
    }
}
...
{	
	...
	{
	    if(grdData.GetGridData(i, 5)== "B")
        {
	        ctrl.Cell(14, i, 0, i, 3) = false;
	        grdData.SetCellBold(i, 0, i, 3, true);
        }
	    else
	    {
	        ctrl.Cell(14, i, 0, i, 3) = false;
	        grdData.SetCellBold(i, 0, i, 3, false);
	    }
		...
		grdData.GetGridControl().TextMatrix(1, 3)  = 'Amount';

		grdData.SetCellBgColor(i, 0, i, 3, Number(grdData.GetGridData(i, 5)));
	}
...
<body>
<!--------------------------------------------------------------------------------------->
<gw:data id="dso_sp_sel_jama00040" onreceive="OnDataReceive()">
    <xml>                                                               
        <dso id="1" type="grid" user="prod" function="acnt.sp_sel_jama00040"> 
            <input> 
                <input bind="idMonth" />
            </input> 
            <output bind="grdData" /> 
                ...
                <tr width="100%">
				 ...
				 <tr style="width:100%; height:95%">
                	<td colspan="4" style="padding-top:4px;background: #BDE9FF">
                    	<gw:grid id="grdData"
						 header		="0|1|_2|3|_4|_5|_6"
						 format		="0|0|0|-0|0|0|0"
						 aligns		="0|1|1|3|0|0|0"
						 defaults	="||||||"
						 editcol	="0|0|0|0|0|0|0"
						 sorting	="F"
						 widths		="4000|3000|3000|3000|0|0|0"
