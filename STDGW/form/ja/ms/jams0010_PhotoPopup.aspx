...
function OnDownload(){
  var url = System.RootURL + "/system/binary/ViewFile.aspx?img_pk="+grdPhoto.GetGridData(grdPhoto.row,0)+"&table_name=crm.TGM_MEMBER_file";
  window.open(url);
}
</script>
...
<body>
    ...
    <xml> 
        <dso  type="grid" parameter="0,7"  function="CRM.sp_sel_attach_file" procedure="CRM.sp_delete_file" > 
            <input bind="grdPhoto">                    
    ...
    <gw:image id="imgMember" table_name="CRM.TGM_MEMBER_file" procedure="CRM.sp_upd_attach_file"
