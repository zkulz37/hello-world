...
function Control_OnClick(obj){
    switch(obj){
        case "Report1":
            var url = System.RootURL + "/system/ReportEngine.aspx?export_pdf=Y&file=ja/ps/japs00050.rpt&procedure=CRM.sp_sel_japs00050_rptmt|CRM.sp_sel_japs00050_rptdt&parameter=" + dtMonth.GetData() +"|"+ dtMonth.GetData();
        ...
        case "dsoListInvoices":
            ...
            if(grdInvoices.rows > 1){
                for ( var i=1; i < grdInvoices.rows; i++){
                    ...
                    if(grdInvoices.GetGridData( i, COL_LOC) == 'POINT-16')
...
<body bgcolor='#F5F8FF'>
    <gw:data id="dsoListInvoices" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00050" procedure="">
    ...
    <gw:data id="dsoListSell" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00051" procedure="">  
                <input bind="grdSell">  
                    <input bind="dtMonth" />
                    <input bind="lstLocation" />
                </input> 
                             ...
                             <fieldset>
						        <table style="width: 100%; height: 100%">
							        <tr>
								        ...
								        <td style="width:3%">
								            <gw:imgbtn id="ibtnReport" img="printer" alt="Driving Range Monthly Report" onclick="Control_OnClick('Report1');" styles='width:100%'/>
								        </td>
                    ...
                    <tr style=" height: 98%">
                         <td style="width:70%" rowspan="2">
                            <table style="width: 100%; height: 100%">
                                <tr style="height: 98%">
                                    <td>
                                        <gw:grid id='grdInvoices' header='_PK|Invoice ID|Time|AMT|_Discout|Location|Staff|Locker No|Customer Name|_Loc'
                                            format  ='0|0|0|-2|0|0|0|0|0|0' 
                                ...
                                <tr>
                                    <td valign="top" style="background-color:#33CCFF">
                                        <table style="height: 100%; width: 100%;border:0px;" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr style="height:17px">
                                                <td style="padding-left:5px;background-color:White" width="35%">Driving Range Academy</td>
