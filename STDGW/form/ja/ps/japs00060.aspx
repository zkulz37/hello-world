...
function BodyInit()
{
    ...
    txtTotalTeaching.SetReadOnly(true);
	txtDistcTeaching.SetReadOnly(true);
...
function Control_OnClick(obj){
    switch(obj){
        case "Report1":
            var url = System.RootURL + "/system/ReportEngine.aspx?export_pdf=Y&file=ja/ps/japs00060.rpt&procedure=CRM.sp_sel_japs00060_rptmt|CRM.sp_sel_japs00060_rptdt&parameter=" + dtDate.GetData() + "|" + dtDate.GetData();
...
function OnDataReceive(obj)
{
    switch(obj.id){
        case "dsoListInvoices":
            var sum_amt=0, sum_ClubHouse=0;
			var dis_amt=0, dis_ClubHouse=0;
            ...
            txtTotalTeaching.SetDataText("" + sum_ClubHouse);
			txtDistcTeaching.SetDataText("" + dis_ClubHouse);
...
<body bgcolor='#F5F8FF'>
    <gw:data id="dsoListInvoices" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00060" procedure="">  
    ...
    <gw:data id="dsoListSell" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00061" procedure="">  
                <input bind="grdSell">  
                    <input bind="dtDate" />
                    <input bind="lstLocation" />
                </input> 
                                    ...
                                    <td valign="top" style="background-color:#33CCFF">
                                        <table style="height: 100%; width: 100%;border:0px;" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr style="height:17px">
                                                ...
                                                <td style="background-color:White"><gw:textbox id="txtTotalTeaching" type="number" format="###,###,###,###.##" styles="width:100%;border:0px;"  /></td>
												<td style="background-color:White"><gw:textbox id="txtDistcTeaching" type="number" format="###,###,###,###.##" styles="width:100%;border:0px;"  /></td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
