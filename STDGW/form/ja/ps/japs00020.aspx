...
<head id="Head1" runat="server">
    <title>Proshop Monthly Report</title>
</head>
...
function Control_OnClick(obj){
    switch(obj){
        case "Report1":
            var url = System.RootURL + "/system/ReportEngine.aspx?export_pdf=Y&file=ja/ps/japs00020.rpt&procedure=CRM.sp_sel_japs00020_rptmt|CRM.sp_sel_japs00020_rptdt&parameter=" + dtMonth.GetData() +"|"+ dtMonth.GetData();
            ...
            if(grdInvoices.rows > 1){
                for ( var i=1; i < grdInvoices.rows; i++){
                    ...
                    if(grdInvoices.GetGridData( i, COL_LOC) == 'POINT-07'){
						...
						dis_Proshop  += Number(grdInvoices.GetGridData( i, COL_DISC));
					}
...
<body bgcolor='#F5F8FF'>
    <gw:data id="dsoListInvoices" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00020" procedure="">
    ...
    <gw:data id="dsoListSell" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="crm.sp_sel_japs00021" procedure="">  
                <input bind="grdSell">  
                    <input bind="dtMonth" />
                    <input bind="lstLocation" />
                </input> 
                                ...
                                <tr>
                                    <td valign="top" style="background-color:#33CCFF">
                                        <table style="height: 100%; width: 100%;border:0px;" cellspacing="1" cellpadding="1">
                                            ...
                                            <tr style="height:17px">
                                                <td style="padding-left:5px;background-color:White">Golf Academy</td>
