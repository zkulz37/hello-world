...
function OnReport()
{
//    var url = System.RootURL + "/system/ReportEngine.aspx?export_pdf=Y&file=ja/rt/jart00090.rpt&procedure=CRM.sp_sel_jart00090&parameter="+idMonth.GetData();   
...
<body>
    ...
    <gw:data id="dso_grdCashSummaryDaily" onreceive="ShowData()"> 
        <xml> 
            <dso  type="grid" function="CRM.sp_sel_jart00100" >  
                ...
                <table style="height: 100%; width: 100%;">
                    <tr style="height: 100%;">
                        ...
                        <td style="width: 10%; background-color:White" align="left">
                             <gw:datebox id="idMonth" maxlen="10" text="" styles='width:50%' lang="1" type="month" onchange="OnSearch()" />
                        </td>
                        <td style="width: 2%;">
                        </td>
                        <td style="width: 3%;">
