...
function OnShowPopup(index)
{
    switch (index)
    {
        ...
        break;
        case '1':
            fpath  = System.RootURL + "/form/gf/ka/gfka00220_plunit.aspx?"
...
<gw:data id="dat_gfqc00030_AP" onreceive="OnDataReceive(this)" > 
    <xml> 
        <dso id="1" type="grid"  function="acnt.sp_sel_gfqc00030_AP"   > 
            <input bind="grdAP">   
		            ...
		            <td width="45%">
		                <table style="width:100%" cellpadding="0" cellspacing="0">
		                    <tr>
		                        ...
		                        <td><gw:imgbtn id="reset" img="Reset" alt="Reset" onclick="txtPL_Nm.text='';txtPL_PK.text='';txtPL_ID.text=''" /></td>
		                    </tr>
		                </table>
		            </td>
