...
{
	var path    = System.RootURL + '/form/gf/da/gfda00170_Clear_Adv_Popup.aspx?tfn_eradv_ven=' + idGrid.GetGridData(idGrid.row, 11);
...
<body style="margin:0; padding:0;">
    <gw:data id="dso_adv_list" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfda00170" >
                <input bind="idGrid">
