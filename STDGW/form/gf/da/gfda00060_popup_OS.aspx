...
function BindingDataList()
{
    ...
    ls_Book_ccy     = "<%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACBG0040','04','') FROM DUAL")%>";
...
<!------------------------------------------------------------------------------------------------------->
    ...
    <gw:data id="dso_upd_grd_dtl_ap_imp_tax" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,5,6,7,8" function="acnt.SP_SEL_GRD_DTL_AP_IMP_TAX" procedure="ACNT.SP_UDP_GRD_DTL_AP_IMP_TAX">
    ...
    <gw:data id="dso_upd_grd_dtl_ap_exc_tax" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,5,6,7,8" function="acnt.SP_SEL_GRD_DTL_AP_EXC_TAX" procedure="ACNT.SP_UDP_GRD_DTL_AP_EXC_TAX">
    ...
    <gw:data id="dso_upd_grd_dtl_ap_allocation" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.SP_SEL_GRD_DTL_AP_ALLOCATE">
    ...
    <gw:data id="dso_upd_grd_dtl_ap_taxvat" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,5,6,7,8,9,10" function="acnt.SP_SEL_GRD_DTL_AP_TAXVAT" procedure="ACNT.SP_UDP_GRD_DTL_AP_TAXVAT">
    ...
    <gw:data id="dso_sel_ctl_cust" onreceive="onSeachItem()"> 
        <xml> 
            <dso type="control" function="ACNT.SP_SEL_MST_AP_CUST">
            <inout> 
                <inout bind="txt_pk"/>
    ...
    <gw:data id="dso_upd_grd_dtl_ap_domestic_item" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,1,4,5,6,7,8,9" function="acnt.SP_SEL_GRD_AP_DO_ITEM" procedure="ACNT.SP_UPD_GRID_AP_ITEM">
                <input bind="grdInfor">
                    <input bind="txt_pk"/>
                </input>
