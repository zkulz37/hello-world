...
<body style="margin:0; padding:0;">
    <gw:data id="dso_search" onreceive="OnSum()"> 
        <xml> 
            <dso id="1" type="grid"  function="acnt.sp_sel_gfda00040"  > 
                <input bind="idGrid" >   
