...
function OnPrint()
{
    ...
    {
        var url = System.RootURL + '/reports/gf/hg/gfhg00040_DailyAggregate.aspx?prps_fr=' + dtPropos_fr.GetData() + '&prps_to=' + dtPropos_to.GetData() + '&Company=' + lstCompany.GetData() + '&status='+ rbstatus.GetData() + '&bccy=' + txtbookccy.GetData() + '&lang=' + lstLanguage.value;
        window.open(url); 
    }
...
function OnPopup()
{
	...
	if (rownum > 0)		 
	{
		if (event.col >= 1)
		{
			...
			var fpath   = System.RootURL + '/form/gf/ka/gfka00020_popup.aspx?acc_pk=' + acc_pk + '&ac_cd=' + ac_cd + '&ac_nm=' + ac_nm + '&from_date=' + dtPropos_fr.GetData() + "&to_date=" + dtPropos_to.GetData() + "&company_pk=" + lstCompany.GetData() + "&status=" + rbstatus.GetData()  ;
			var wWidth  = 950;
			var wHeight = 600;
