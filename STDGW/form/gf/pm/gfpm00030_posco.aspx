...
function OnExport()
{
    if(confirm("Are you sure to make slip to ERP?"))
    {
        status = 'Exporting data...';
        btnSplip.SetEnable(0);
...
<gw:data id="datSearchAPInvoice" onreceive="OnDataReceive(this)"  onerror="OnDataError(this)" > 
        <xml>
            <dso type="grid"  function="ACNT.SP_SEL_AP_INVOICE_MASTER" procedure="ACNT">
...
<gw:data id="dataDel" onreceive="OnDataReceive(this)"  onerror="OnDataError(this)" > 
        <xml>
            <dso type="process"   procedure="ACNT.sp_Inv_Master_Del">
                <input >
                <input bind="txtPK"/>
               </input>
               <output>
...
<gw:data id="datSearchAPInvoiceDetail" onreceive="OnDataReceive(this)"  onerror="OnDataError(this)" > 
        <xml>
            <dso type="grid" function="ACNT.SP_SEL_AP_INVOICE_Detail">
...
<gw:data id="datSearchAPInvoiceInfo" onreceive="OnDataReceive(this)">
    <xml>
        <dso type ="process" procedure="ACNT.SP_SEL_AP_INV_MASTER_INF">
            <input >
                <input bind="txtPK"/>
                <input bind="txtAP_type"/>
            </input >
...
<gw:data id="dsoExportInvoices" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="process" procedure="HR.SP_EXPORT_INVOICES_TXT" onerror="OnDataError(this)" > 
                <input>
                    <input bind="txt1" />
                    <input bind="txtAP_type"/>
                </input>
...
<gw:data id="dsoExportInvoicesd" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="process" procedure="HR.SP_EXPORT_INVOICESD_TXT" onerror="OnDataError(this)" > 
                 <input>
                    <input bind="txt1" />
                    <input bind="txtAP_type"/>
                </input>
    ...
    <td width="40%" height="100%"style="border:2">
        <table style="height:100%" width="100%">
            ...
            <td colspan="3" align="right" >
                    <gw:icon id="btnDel" img="in" text="DELETE" styles="width:100" onclick="OnDelete()" /></td>
            </tr>
            <tr >
            ...
            <table style="height:100%" width="100%">
                  ...
                  <tr   >
					...
					<td colspan="3" style="border:0" align="right">
                        <gw:imgBtn img="excel" id="ibtnSumPrinter"    alt="Report"  onclick="OnReport()"/>
                    </td>
