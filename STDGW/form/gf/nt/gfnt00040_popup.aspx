...
function OnSelect()
{
   var obj=new Array();
    ...
    if (GridDetail.row >0)
    {
        obj[1] = GridDetail.GetGridData(GridDetail.row, 0);
        obj[2] = GridDetail.GetGridData(GridDetail.row, 1);
        obj[3] = GridDetail.GetGridData(GridDetail.row, 2);
        obj[4] = GridDetail.GetGridData(GridDetail.row, 3);
    }
    else
        obj[1]=0;
			    ...
			    <td colspan="2">
				    ...
				    <table border="0" width="100%" cellpadding="0" cellspacing="0"  id="table2">
					    <tr>
							...
							<td style="width:31%"><gw:list id="lstCompany" styles="width:100%;" /></td>
