...
{ 
    ...
    //
    data = "<%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACAB0070','','') FROM DUAL")%>";
...
function onRowDoubleclk(index)
{
    switch(index)
    {
        case 0:
            ...
            {
                var fpath = System.RootURL + "/form/gf/nt/gfnt00070_1.aspx?TAC_ABTRTYPE_pk=" + txtMaster_pk.GetData();
...
<!------------------------------------------------------------------------------->
 ...
 <!----------------------------------------------------------------------------->
   <gw:data id="data_gfnt00070_2" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" parameter="0,1,5,6" function="acnt.sp_sel_gfnt00070_2" procedure="acnt.sp_upd_gfnt00070_1">
