...
function BindingDataList()
{
    ...
    var data = "";
    data = "<%=ESysLib.SetListDataSQL("SELECT b.code, b.code_nm FROM tac_commcode_master a, tac_commcode_detail b WHERE a.pk = b.tac_commcode_master_pk AND a.del_if = 0 AND a.ID = 'EACAB036' AND b.del_if = 0 order by b.ORD")%>";    
    ...
    data = "<%=ESysLib.SetListDataFUNC("SELECT acnt.SF_A_GET_COMMONCODE('EACBK018') FROM DUAL")%>";
    ...
    if (txtFinancialType.GetData() == '80')
    {
        ...
        else if (lstLang.GetData() == 'ENG')
        {
            ...
            if (lstReportType.value=='1')
                 ...
                 else if (lstReportType.value == '2')
                 {
                    ...
                    //url = '/reports/gf/ka/gfka00210_bs_monthly_eng_2.aspx?p_kind=' + txtFinancialType.GetData() + '&p_status='+ rbstatus.GetData() +'&p_tco_company_pk=' + lstCompany.GetData() + '&p_date_fr=' + dtfrdate.GetData() + '&p_date_to=' + dttodate.GetData() +  '&p_date_type=' + txtDateType.GetData() + '&p_scale=' + txtScale.GetData();
                    System.OpenTargetPage( System.RootURL+url , "newform" );   
                 }  
             else if (lstReportType.value == '3')
             {
         ...
         else if (lstLang.GetData() == 'ENG-VIE-KOR')
        {
            ...
            if (lstReportType.value=='1')
             ...
             {
                    url = '/reports/gf/ka/gfka00210_bs_monthly_eng_01.aspx?p_kind=' + txtFinancialType.GetData() + '&p_status='+ rbstatus.GetData() +'&p_tco_company_pk=' + lstCompany.GetData() + '&p_date_fr=' + dtfrdate.GetData() + '&p_date_to=' + dttodate.GetData() +  '&p_date_type=' + txtDateType.GetData() + '&p_scale=' + txtScale.GetData();
                 //url = '/reports/gf/ka/gfka00210_bs_monthly_eng_vie_kor_2.aspx?p_kind=' + txtFinancialType.GetData() + '&p_status='+ rbstatus.GetData() +'&p_tco_company_pk=' + lstCompany.GetData() + '&p_date_fr=' + dtfrdate.GetData() + '&p_date_to=' + dttodate.GetData() +  '&p_date_type=' + txtDateType.GetData() + '&p_scale=' + txtScale.GetData();
                       System.OpenTargetPage( System.RootURL+url , "newform" ); 
              }  
              else if (lstReportType.value == '3')
             {
        ...
        else if (lstLang.GetData() == 'KOR')
        {
            ...
            {
                url = '/reports/gf/ka/gfka00210_bs_monthly_kor_01.aspx?p_kind=' + txtFinancialType.GetData() + '&p_status='+ rbstatus.GetData() +'&p_tco_company_pk=' + lstCompany.GetData() + '&p_date_fr=' + dtfrdate.GetData() + '&p_date_to=' + dttodate.GetData() +  '&p_date_type=' + txtDateType.GetData() + '&p_scale=' + txtScale.GetData();
        ...
        {
            var url = '/reports/gf/ka/gfka00080_BS.aspx?p_company_pk=' + lstCompany.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_date=' + dttodate.GetData();
            System.OpenTargetPage( System.RootURL+url , "newform" );
        }
    }
    else if (txtFinancialType.GetData() == '81')
...
<body style="margin: 0; padding: 0;">
    ...
    <gw:data id="dso_sel_grd_balance_sheet" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00210_3">
                <input bind="grid_bs">
    ...
    <gw:data id="dso_sel_grd_cf" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00210">
                <input bind="grid_cf">
                    <input bind="txtFinancialType"/>
                    <input bind="rbstatus"/>
                    <input bind="lstCompany"/>
    ...
    <gw:data id="dso_sel_grd_balance_sheet_2" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00210_5">
