...
//	} 
	...
	if (rownum > 0) 
	{
		var fpath = System.RootURL + '/form/gf/hg/gfhg00020_popup.aspx?PK_ROW=' + pk + '&ROW=' + rownum + '&ROWS=' + rows + '&APPRCANCEL=' + status + "&ARRAY_PK=";
		var wWidth = 950;
		var wHeight = 600;
...
<gw:data id="datGetAccountInfo" onreceive="OnDataReceive(this)" onerror="OnDataError(this)" > 
	<xml> 
		<dso type="process" user="acnt" parameter="0,1,2,3"   procedure = "ACNT.SP_SEL_POPUP_OBJECT" > 
			<input >
...
<xml>
<dso type="grid" function="ACNT.SP_SELECT_CUST_BAL_VOUCHER">
<input bind="grdDate">
<input bind="lstCOMPANY"/>
<input bind="txtFROM_DATE"/>
<input bind="txtTO_DATE"/>
