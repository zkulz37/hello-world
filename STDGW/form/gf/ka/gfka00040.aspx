...
function OnReport()
{
	...
	{
	 var url = '/reports/gf/ka/gfka60110040_daily_detail.aspx?company_pk='+lstCompany.value+'&dtbFrom=' +dtbFrom.value+ '&dtbTo=' + dtbTo.value+'&status='+rdoSlipStatus.value+'&bookccy='+lstBookCcy.value;
            System.OpenTargetPage( System.RootURL+url , "newform" );
	}
...
<gw:data id="datDepositAccount" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
    <xml>
        <dso type="grid" function="ACNT.SP_SEL_MONTH_BANK_DEP_BAL">
...
<gw:data id="datBankAccount" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
    <xml>
        <dso type="grid" function="ACNT.SP_SEL_MONTH_BANK_BAL">
...
<gw:data id="dso_gridbottom" onreceive="OnDataReceive(this)" >
    <xml>
        <dso type="grid" function="ACNT.SP_SEL_gfka00040">
