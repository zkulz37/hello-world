...
function BodyInit()
{
    ...
    var ls_type    = "<%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACBG0020','08','') FROM DUAL")%>";
...
function onReport()
{
    var url = '/reports/gf/ka/gfka00100.aspx?company_pk='+ lstCompany.value + '&dtfrom=' + dtfrmonth.value;
...
<body style="margin:0; padding:0;">
    ...
    <gw:data id="dso_sel_trial_balance" onreceive="onSetColor()">
        <xml>
            <dso type="grid" function="acnt.SP_SEL_GRD_DTL_TRIAL_BALANCE" >
                <input bind="idGrid">
...
<tr>
    <td width="100%">
	    ...
	    <tr>
            ...
            <td><gw:list id="lstFinancial" onChange="OnChangeList()"  styles='width:100%'></gw:list></td>
            <td align="right">Language&nbsp;</td>
            <td><gw:list id="lstLang" onChange="OnChangeList()"  styles='width:100%'></gw:list></td>
	    ...
	    <tr>
            ...
            <td align="center">
                ...
                <tr>
                    ...
                    <td><gw:datebox id="dtfrmonth" type="month" styles="width:100%"/></td>
                    <td><gw:datebox id="dttomonth" type="month" styles="width:100%"/></td>
	    ...
	    <tr>
	        ...
	        <td align="center">
	            <table border="0" cellpadding="0" cellspacing="0" width="100%">
                <tr>
                    <td width="45%"><gw:list id="lstLevel" onChange="OnChangeList()"  styles='width:100%'></gw:list></td>
                    <td width="10%">Posting/Summary&nbsp;</td>
                    <td width="45%"><gw:list id="lstPostSum" onChange="OnChangeList()"  styles='width:100%'></gw:list></td>
                </tr>
                </table>
	        </td>
	...
	<td width="100%">
        ...
        <tr>
            <td>
                <gw:grid   
				    id="idGrid"  
				    header="Ctrl|_PK|Account Name|Begin Bal(Debt)|Begin Bal(Cret)|Debit|Credit|cal bal(Debt)|cal bal(Cret)|Ending bal(Debt)|Ending bal(Cret)|_B|_COLOR"
