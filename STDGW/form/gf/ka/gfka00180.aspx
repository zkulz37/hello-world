...
{
	var fpath = System.RootURL + "/form/gf/co/ffco001000.aspx?col_nm=Account Name&col_code=Account Code&company=" + lstCompany.value + '&comm_code=&comm_nm=&'+"&val1=" + txtItem_CD.text + "&val2=" + '' + "&val3=" + '' + "&dsqlid=ACNT.SP_SEL_SLITEM_ACC";
...
function onGetItem()
{	
	var fpath = System.RootURL + "/form/gf/co/ffco001000.aspx?col_nm=Item Local Alias&col_code=Item Alias&company=" + lstCompany.value + '&comm_code=&comm_nm=&'+"&val1=" + '' + "&val2=" + '' + "&val3=" + '' + "&dsqlid=ACNT.SP_SEL_SLITEM_ITEM";
	var aValue = System.OpenModal( fpath , 550 , 550 , 'resizable:yes;status:yes'); 
	if (aValue != null)
	{
		if (aValue[0]!="")
...
<gw:data id="datSLControlItem" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" user="acnt"  function="ACNT.SP_SEL_SL_CTRITEM_INQ" > 
...
<gw:data id="datSLSum" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ACNT.SP_SEL_SL_CTRITEM_SUM">
                <input bind="grdSLSum">
                    <input bind="lstCompany" />
					<input bind="dtbFromDate" />
					<input bind="dtbToDate" />
