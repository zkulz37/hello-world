...
function OnChangeDateType(){
    ...
    if(idTab_Child.GetCurrentPageNo() == 0){
        ...
        if(rdoType.GetData() == 1){ 
            ...
            dtYear.style.display = "none";
            lstQuater.style.display = "none";
            grid_cf.SetGridText(0,9,"Month("+mmyyyy+")");//this period        
            grid_cf.SetGridText(0,10,"Month("+acc_mmyyyy+")");//this period of previous year
            grid_cf.SetGridText(0,11,"Acc Month("+mmyyyy+")");//accumulate from beginning of year to this period
            grid_cf.SetGridText(0,12,"Acc Month("+acc_mmyyyy+")");//accumulate from beginning of previous year to this period - 1 year
        }
        else if(rdoType.GetData() == 2){
            txtDateType.text = "Q";
            lblDateType.text = "Quater:";
            ...
            dtYear.style.display = "";
            lstQuater.style.display = "";
            grid_cf.SetGridText(0,9,"Quater "+quater+ " of " + yyyy);//this period        
            grid_cf.SetGridText(0,10,"Quater "+quater+ " of " + (yyyy-1));//this period of previous year
            grid_cf.SetGridText(0,11,"Acc of Quater "+quater+ " of " + yyyy);//accumulate from beginning of year to this period
            grid_cf.SetGridText(0,12,"Acc of Quater "+quater+ " of " + (yyyy-1));//accumulate from beginning of previous year to this period - 1 year
        }
        else if(rdoType.GetData() == 3){
            txtDateType.text = "Y";
            lblDateType.text = "Year:";
            ...
            dtYear.style.display = "";
            lstQuater.style.display = "none";
            grid_cf.SetGridText(0,9,"This Year("+yyyy+")");//this period        
            grid_cf.SetGridText(0,10,"Last Year("+(yyyy-1)+")");//this period of previous year
            grid_cf.SetGridText(0,11,"");//accumulate from beginning of year to this period
            grid_cf.SetGridText(0,12,"");//accumulate from beginning of previous year to this period - 1 year
        }
     }
...
function onReport(lang)
{
    ...
    if (txtFinancialType.GetData() == '21')
    {
        ...
        {
            var url = '/reports/gf/ka/gfka00080_BS_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
            System.OpenTargetPage( System.RootURL+url , "newform" );
        }    
        else if (lstLang.GetData() == 'ENG')
        {
            var url = '/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
            System.OpenTargetPage( System.RootURL+url , "newform" );
        }
        else if (lstLang.GetData() == 'KOR')
        {
            var url = '/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
            System.OpenTargetPage( System.RootURL+url , "newform" );
        }
        else
        {
            var url = '/reports/gf/ka/gfka00080_BS.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
            System.OpenTargetPage( System.RootURL+url , "newform" );
        }*/
    }
    else if (txtFinancialType.GetData() == '22')
    {
       ...
       if (rdoType.value=='1')//Monthly
       {
            if (lstLang.GetData()=='VIE')//mo file tieng viet
            {
             ...
             {
                f_nm='gfka00080_IC_PERIOD_ENG.aspx';  
              }
               else 
               {
    ...
    else if (txtFinancialType.GetData() == '23')
    {
       ...
       if (rdoType.value=='1')//Monthly
       {
            if (lstLang.GetData()=='VIE')//mo file tieng viet
            {
                f_nm='gfka00080_CF_PERIOD_VIE.aspx';
            }
             else if (lstLang.GetData() == 'ENG') //mo file tieng anh
             {
                f_nm='gfka00080_CF_PERIOD_ENG.aspx';  
              }
               else 
               {
       ...
       {   
        r=r+"&p_quarter="+lstQuater.GetData(); 
            if (lstLang.GetData()=='VIE')//mo file tieng viet
                f_nm='gfka00080_CF_QUARTER_VIE.aspx';               
             else if (lstLang.GetData() == 'ENG') //mo file tieng anh
                f_nm='gfka00080_CF_QUARTER_ENG.aspx';               
               else 
       ...
       {
            if (lstLang.GetData()=='VIE')//mo file tieng viet
                    f_nm='gfka00080_CF_VIE.aspx';                    
                 else if (lstLang.GetData() == 'ENG') //mo file tieng anh                    
                    f_nm='gfka00080_CF_ENG.aspx';  
                   else 
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23_1": // Cash Flow(Indirect method)
                    switch(rdoType.value)
                    {
                        ...
                        case "2"://Quarter
                            r=r+"&p_quarter="+lstQuater.GetData(); 
                            f_nm='gfka00080_CF_I_Q_vie.aspx';  
                        break;
                        case "3"://Year
                             f_nm='gfka00080_CF_I_Y_vie.aspx'; 
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                    System.OpenTargetPage( System.RootURL+url , "newform" );
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23_1": // Cash Flow(Indirect method)
                    switch(rdoType.value)
                    {
                        ...
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_I_Q_ENG.aspx';    
                        break;
                        case "3"://Year
                            f_nm='gfka00080_CF_I_Y_ENG.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
        ...
        case "ENG-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
                ...
                break;
                 case "24": // Cash Flow (Direct method)
                    ...
                    {
                        case "1"://Monthly
                            f_nm='gfka00080_CF_DI_M_vie_eng.aspx';
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_DI_Q_vie_eng.aspx';    
                        break;
                        case "3"://Year
                            f_nm='gfka00080_CF_DI_Y_vie_eng.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
        ...
        case "KOR-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_KOR_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
                ...
                case "24": // Cash Flow (Direct method)
                    ...
                    {
                        case "1"://Monthly
                            f_nm='gfka00080_CF_DI_M_Vie_KOR.aspx';
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_DI_Q_Vie_KOR.aspx';    
                        break;
                        case "3"://Year
                            f_nm='gfka00080_CF_DI_Y_Vie_KOR.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
        ...
        case "ENG-VIE-KOR":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
...
function onSetDataList()
{
    ...
    {
        txtFinancialType.SetDataText('23');
    }
    else if (idTab_Child.GetCurrentPageNo() == 3)
    {
...
function OnChangeLang()
{
    switch(lstLang.GetData())
    {
        case "VIE":
            ...
            grid_cf.GetGridControl().ColHidden(3) = true;
            grid_cf.GetGridControl().ColHidden(4) = true;
            grid_cf.GetGridControl().ColHidden(5) = true;
            
            grid_cf.GetGridControl().ColWidth(0)  = "0";
            grid_cf.GetGridControl().ColWidth(1)  = "8000";
            grid_cf.GetGridControl().ColWidth(2)  = "0";
            grid_cf.GetGridControl().ColWidth(3)  = "0";
            grid_cf.GetGridControl().ColWidth(4)  = "0";
            grid_cf.GetGridControl().ColWidth(5)  = "0";
            grid_cf.GetGridControl().Cell(0, 0, 1, 0, 1) = "Item Local";
        ...
        case "ENG":
           // income statement
            ...
            // cash flow
            grid_cf.GetGridControl().ColHidden(0) = false;
            grid_cf.GetGridControl().ColHidden(1) = true;
            grid_cf.GetGridControl().ColHidden(2) = true;
            grid_cf.GetGridControl().ColHidden(3) = true;
            grid_cf.GetGridControl().ColHidden(4) = true;
            grid_cf.GetGridControl().ColHidden(5) = true;
            grid_cf.GetGridControl().ColWidth(0)  = "8000";
            grid_cf.GetGridControl().ColWidth(1)  = "0";
            grid_cf.GetGridControl().ColWidth(2)  = "0";
            grid_cf.GetGridControl().ColWidth(3)  = "0";
            grid_cf.GetGridControl().ColWidth(4)  = "0";
            grid_cf.GetGridControl().ColWidth(5)  = "0";
            grid_cf.GetGridControl().Cell(0, 0, 0, 0, 0) = "Item";
        ...
        case "KOR":
           // income statement
            ...
            grid_cf.GetGridControl().ColWidth(0)  = "0";
            grid_cf.GetGridControl().ColWidth(1)  = "0";
            grid_cf.GetGridControl().ColWidth(2)  = "8000";
            grid_cf.GetGridControl().ColWidth(3)  = "0";
            grid_cf.GetGridControl().ColWidth(4)  = "0";
            grid_cf.GetGridControl().ColWidth(5)  = "0";
            grid_cf.GetGridControl().Cell(0, 0, 2, 0, 2) = "Item Korean";
        ...
        case "ENG-VIE":
           // income statement
            ...
            grid_cf.GetGridControl().ColHidden(3) = false;
            grid_cf.GetGridControl().ColHidden(4) = true;
            grid_cf.GetGridControl().ColHidden(5) = true;
            ...
            grid_cf.GetGridControl().ColWidth(1)  = "0";
            grid_cf.GetGridControl().ColWidth(2)  = "0";
            grid_cf.GetGridControl().ColWidth(3)  = "8000";
            grid_cf.GetGridControl().ColWidth(4)  = "0";
            grid_cf.GetGridControl().ColWidth(5)  = "0";
            grid_cf.GetGridControl().Cell(0, 0, 3, 0, 3) = "English-Vietnamese";
        ...
        case "KOR-VIE":
            ...
            grid_cf.GetGridControl().ColHidden(3) = true;
            grid_cf.GetGridControl().ColHidden(4) = false;
            grid_cf.GetGridControl().ColHidden(5) = true;
            ...
            grid_cf.GetGridControl().ColWidth(2)  = "0";
            grid_cf.GetGridControl().ColWidth(3)  = "0";
            grid_cf.GetGridControl().ColWidth(4)  = "8000";
            grid_cf.GetGridControl().ColWidth(5)  = "0";
            grid_cf.GetGridControl().Cell(0, 0, 4, 0, 4) = "Korean-Vietnamese";
        ...
        break;
         ...
         case "ENG-VIE-KOR":
            ...
            grid_cf.GetGridControl().ColHidden(3) = true;
            grid_cf.GetGridControl().ColHidden(4) = true;
            grid_cf.GetGridControl().ColHidden(5) = false;
            ...
            grid_cf.GetGridControl().ColWidth(3)  = "0";
            grid_cf.GetGridControl().ColWidth(4)  = "0";
            grid_cf.GetGridControl().ColWidth(5)  = "8000";
            grid_cf.GetGridControl().Cell(0, 0, 5, 0, 5) = "English-Vietnamese-Korean";
...
function onSetFont(p_oData)
{
    switch(p_oData.id)
    {
        ...
        break;
        case "dso_sel_grd_cf":
            var ctrl = grid_cf.GetGridControl();
            var l_amt_08_1 = 0;
            var l_amt_08_2 = 0;
            var l_amt_20_1 = 0;
            var l_amt_20_2 = 0;
            ...
            for (i = 1; i < ctrl.Rows; i++)
	        {
	            if(grid_cf.GetGridData(i,8)== "B")
                {
	                ctrl.Cell(14, i, 0, i, 11) = false;
	                grid_cf.SetCellBold(i, 0, i, 11, true);
                }
                else if (grid_cf.GetGridData(i,8)== "I")
                {
	                grid_cf.SetCellBold(i, 0, i, 11, false);
	            ...
	            //set color
	            grid_cf.SetCellBgColor(i, 0, i, 13, Number(grid_cf.GetGridData(i, 13)));
	            
	          if( Number(grid_cf.GetGridData(i,7)) < 8)
	            {
	                
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_08_1 = Number(l_amt_08_1) + Number(tmp);
	             
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_08_2 = Number(l_amt_08_2) +  Number(tmp);
	            } 
	             
	            //if( Number(grid_cf.GetGridData(i,7)) >= 8 && Number(grid_cf.GetGridData(i,7)) < 20)
	            if( Number(grid_cf.GetGridData(i,7)) < 20 &&  Number(grid_cf.GetGridData(i,7)) != 8)
	            {
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_20_1 = Number(l_amt_20_1) + Number(tmp);
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_20_2 = Number(l_amt_20_2) +  Number(tmp);
	            }  
	           // if( Number(grid_cf.GetGridData(i,7)) > 20 && Number(grid_cf.GetGridData(i,7)) <= 27)
	            if( Number(grid_cf.GetGridData(i,7)) < 30 && Number(grid_cf.GetGridData(i,7)) > 20)
	            {
	                
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_30_1 = Number(l_amt_30_1) + Number(tmp);
	             
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_30_2 = Number(l_amt_30_2) +  Number(tmp);
	            }  
	            if( Number(grid_cf.GetGridData(i,7)) < 40  && Number(grid_cf.GetGridData(i,7)) > 30)
	            {
	                
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_40_1 = Number(l_amt_40_1) + Number(tmp);
	             
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_40_2 = Number(l_amt_40_2) +  Number(tmp);
	            } 
	        ...
	        for (i = 1; i < ctrl.Rows; i++)
	        {
	            if( grid_cf.GetGridData(i, 7) == '08')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_08_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_08_2);
	            }
	            if( grid_cf.GetGridData(i, 7) == '20')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_20_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_20_2);
	            }
	            if( grid_cf.GetGridData(i, 7) == '30')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_30_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_30_2);
	            }
	            if( grid_cf.GetGridData(i, 7) == '40')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_40_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_40_2);
	            }
	            
	            if( Number(grid_cf.GetGridData(i,7)) == 20 || Number(grid_cf.GetGridData(i,7)) == 30 || Number(grid_cf.GetGridData(i,7)) == 40)
	            {
	                
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_50_1 = Number(l_amt_50_1) + Number(tmp);
	             
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_50_2 = Number(l_amt_50_2) +  Number(tmp);
	            } 
	            
	            if( grid_cf.GetGridData(i, 7) == '50')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_50_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_50_2);
	            }
	            if( Number(grid_cf.GetGridData(i,7)) == 50 || Number(grid_cf.GetGridData(i,7)) == 60 || Number(grid_cf.GetGridData(i,7)) == 61)
	            {
	                
	                tmp = grid_cf.GetGridData(i,9);
	                l_amt_70_1 = Number(l_amt_70_1) + Number(tmp);
	             
	                tmp = grid_cf.GetGridData(i, 10) ;
	                l_amt_70_2 = Number(l_amt_70_2) +  Number(tmp);
	            }
	            if( grid_cf.GetGridData(i, 7) == '70')
	            {
	              grid_cf.SetGridText(i,9,' ' + l_amt_70_1);
	              grid_cf.SetGridText(i,10,' ' + l_amt_70_2);
	            }
	        }
        break;
        case "dso_gfka00080_1":
            ...
            for (i = 1; i < ctrl.Rows; i++)
	        {
	         ...
	         if( Number(grid_cf_in.GetGridData(i,7)) < 8)
	            {
	                
	                tmp = grid_cf_in.GetGridData(i,9);
	                l_amt_08_1 = Number(l_amt_08_1) + Number(tmp);
	             
	                tmp = grid_cf_in.GetGridData(i, 10) ;
	                l_amt_08_2 = Number(l_amt_08_2) +  Number(tmp);
	            } 
	             
	            //if( Number(grid_cf.GetGridData(i,7)) >= 8 && Number(grid_cf.GetGridData(i,7)) < 20)
	            if( Number(grid_cf_in.GetGridData(i,7)) < 20 &&  Number(grid_cf_in.GetGridData(i,7)) != 8)
	            {
	                tmp = grid_cf_in.GetGridData(i,9);
	                l_amt_20_1 = Number(l_amt_20_1) + Number(tmp);
	                tmp = grid_cf_in.GetGridData(i, 10) ;
	           ...
	           // if( Number(grid_cf.GetGridData(i,7)) > 20 && Number(grid_cf.GetGridData(i,7)) <= 27)
	            if( Number(grid_cf_in.GetGridData(i,7)) < 30 && Number(grid_cf_in.GetGridData(i,7)) > 20)
	            {
	            ...
	            if( Number(grid_cf_in.GetGridData(i,7)) < 40  && Number(grid_cf_in.GetGridData(i,7)) > 30)
	            {
	        ...
	        for (i = 1; i < ctrl.Rows; i++)
	        {
	            if( grid_cf_in.GetGridData(i, 7) == '08')
	            {
	              grid_cf_in.SetGridText(i,9,' ' + l_amt_08_1);
	              grid_cf_in.SetGridText(i,10,' ' + l_amt_08_2);
	            }
	            if( grid_cf_in.GetGridData(i, 7) == '20')
	            {
	              grid_cf_in.SetGridText(i,9,' ' + l_amt_20_1);
	              grid_cf_in.SetGridText(i,10,' ' + l_amt_20_2);
                }
                if( grid_cf_in.GetGridData(i, 7) == '30')
                {
                  grid_cf_in.SetGridText(i,9,' ' + l_amt_30_1);
                  grid_cf_in.SetGridText(i,10,' ' + l_amt_30_2);
                }
                if( grid_cf_in.GetGridData(i, 7) == '40')
                {
                  grid_cf_in.SetGridText(i,9,' ' + l_amt_40_1);
                  grid_cf_in.SetGridText(i,10,' ' + l_amt_40_2);
                }
                
                if( Number(grid_cf_in.GetGridData(i,7)) == 20 || Number(grid_cf_in.GetGridData(i,7)) == 30 || Number(grid_cf_in.GetGridData(i,7)) == 40)
                {
                ...
                if( grid_cf_in.GetGridData(i, 7) == '50')
                {
                  grid_cf_in.SetGridText(i,9,' ' + l_amt_50_1);
                  grid_cf_in.SetGridText(i,10,' ' + l_amt_50_2);
                }
                if( Number(grid_cf_in.GetGridData(i,7)) == 50 || Number(grid_cf_in.GetGridData(i,7)) == 60 || Number(grid_cf_in.GetGridData(i,7)) == 61)
                {
                ...
                if( grid_cf_in.GetGridData(i, 7) == '70')
                {
                  grid_cf_in.SetGridText(i,9,' ' + l_amt_70_1);
                  grid_cf_in.SetGridText(i,10,' ' + l_amt_70_2);
                }
            }
        break;
        case "dso_gfka00080_2":
            ...
            for (i = 1; i < ctrl.Rows; i++)
            {
             ...
             if( Number(grid_cf_di.GetGridData(i,7)) < 8)
                {
                    
                    tmp = grid_cf_di.GetGridData(i,9);
                    l_amt_08_1 = Number(l_amt_08_1) + Number(tmp);
                 
                    tmp = grid_cf_di.GetGridData(i, 10) ;
                    l_amt_08_2 = Number(l_amt_08_2) +  Number(tmp);
                } 
                 
                //if( Number(grid_cf.GetGridData(i,7)) >= 8 && Number(grid_cf.GetGridData(i,7)) < 20)
                if( Number(grid_cf_di.GetGridData(i,7)) < 20 &&  Number(grid_cf_di.GetGridData(i,7)) != 8)
                {
                    tmp = grid_cf_di.GetGridData(i,9);
                    l_amt_20_1 = Number(l_amt_20_1) + Number(tmp);
                    tmp = grid_cf_di.GetGridData(i, 10) ;
               ...
               // if( Number(grid_cf.GetGridData(i,7)) > 20 && Number(grid_cf.GetGridData(i,7)) <= 27)
                if( Number(grid_cf_di.GetGridData(i,7)) < 30 && Number(grid_cf_di.GetGridData(i,7)) > 20)
                {
                ...
                if( Number(grid_cf_di.GetGridData(i,7)) < 40  && Number(grid_cf_di.GetGridData(i,7)) > 30)
                {
               ...
               if( grid_cf_di.GetGridData(i,7) == '61.1' || grid_cf_di.GetGridData(i,7) == '61.2')
                {
                    tmp = grid_cf_di.GetGridData(i,9);
                    l_amt_61_1 = Number(l_amt_61_1) + Number(tmp);
                 
                    tmp = grid_cf_di.GetGridData(i, 10) ;
                    l_amt_61_2 = Number(l_amt_61_2) +  Number(tmp);
                }
               
            }
            for (i = 1; i < ctrl.Rows; i++)
            {
                if( grid_cf_di.GetGridData(i, 7) == '08')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_08_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_08_2);
                }
                if( grid_cf_di.GetGridData(i, 7) == '20')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_20_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_20_2);
                }
                if( grid_cf_di.GetGridData(i, 7) == '30')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_30_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_30_2);
                }
                if( grid_cf_di.GetGridData(i, 7) == '40')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_40_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_40_2);
                }
                
                if( Number(grid_cf_di.GetGridData(i,7)) == 20 || Number(grid_cf_di.GetGridData(i,7)) == 30 || Number(grid_cf_di.GetGridData(i,7)) == 40)
                {
                ...
                if( grid_cf_di.GetGridData(i, 7) == '50')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_50_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_50_2);
                }
                if( Number(grid_cf_di.GetGridData(i,7)) == 50 || Number(grid_cf_di.GetGridData(i,7)) == 60 || Number(grid_cf_di.GetGridData(i,7)) == 61)
                {
                ...
                if( grid_cf_di.GetGridData(i, 7) == '70')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_70_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_70_2);
                }
                
                
                if( grid_cf_di.GetGridData(i, 7) == '61')
                {
                  grid_cf_di.SetGridText(i,9,' ' + l_amt_61_1);
                  grid_cf_di.SetGridText(i,10,' ' + l_amt_61_2);
                }
            }
        break;
    }
...
<body style="margin: 0; padding: 0;">
    ...
    <gw:data id="dso_trial_balance" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="process" procedure="ACNT.SP_PRO_TRIAL_BALANCE"> 
                <input> 
                     <input bind="rbstatus"/>
                     <input bind="lstCompany"/>
                     <input bind="dtfrdate" />
    ...
    <gw:data id="dso_sel_grd_balance_sheet" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.SP_SEL_GRD_FINANCE_STATEMENT">
                <input bind="grid_bs">
                    <input bind="txtFinancialType"/>
                    <input bind="txtScale"/>
                </input>
    ...
    <gw:data id="dso_sel_grd_income" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.SP_SEL_GRD_FINANCE_STATEMENT2">
                <input bind="grid_ic">
                    <input bind="txtFinancialType"/>
                    <input bind="rbstatus"/>
                    <input bind="lstCompany"/>
    ...
    <!---------------------------------------------------------------------------->
    <gw:data id="dso_sel_grd_cf" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.SP_SEL_GRD_FINANCE_STATEMENT2">
                <input bind="grid_cf">
                    <input bind="txtFinancialType"/>
    ...
    <gw:data id="dso_gfka00080_1" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00080_1">
    ...
    <gw:data id="dso_gfka00080_2" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00080_2">
        ...
        <tr>
            <td width="100%">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <table name="Cash Flows(QD15)"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:380;" >    
                        <tr valign="top">
