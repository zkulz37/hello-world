...
function onGetAcc()
{
    var fpath = System.RootURL + "/form/gf/co/ffco002000.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=SP_SEL_ACCT_SUM_PARENT";
...
function RowClick()
{
   var rows =0;
    ...
    if (rownum > 0) 
    {
        var fpath = System.RootURL + '/form/gf/hg/gfhg00020_popup.aspx?PK_ROW=' + pk + '&ROW=' + rownum + '&ROWS=' + rows + '&APPRCANCEL=' + status;
        var wWidth = 950;
        var wHeight = 600;
...
<body style="margin:0; padding:0;">
   ...
   <gw:data id="datSLSum" onreceive="OnDataReceive(this)" onerror="">
        <xml>
            <dso type="grid"  function="ac_SEL_60080050_DAILY_SL_SUM">
                <input bind="grdSLSum">
   ...
   <gw:data id="datSLByDate" onreceive="OnDataReceive(this)" onerror="">
        <xml>
...
<gw:textbox id="txtVoucher_No" styles="display:none;" /> 
