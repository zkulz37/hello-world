...
function RowClick()
{
        ...
        {
            var fpath   = System.RootURL + "/form/gf/ka/gfka00010_cf_acc.aspx?comm_code=Account Code&comm_nm=Account Name&val1=&val2=&val3=" + lstCompany.value + "&dsqlid=ACNT.SP_SEL_ALL_ACCOUNT";	    
...
{
        var fpath = System.RootURL + "/form/gf/co/ffco002000.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=ACNT.SP_SEL_ACCT_SUM_PARENT";
...
<gw:data id="datCFMasterInfo" onreceive="OnDataReceive(this)" onerror="OnDataError(this)" > 
    <xml> 
        <dso id="1" type="grid" user="acnt" parameter="0"   function = "ACNT.SP_SEL_CASHFLOW_MASTER"> 
...
<gw:data id="datCFDetail" onreceive="OnDataReceive(this)"  > 
        <xml>
            <dso type="grid"  function="ACNT.SP_SEL_DESIGNFORM_CF" procedure="ACNT.SP_UPD_DESIGNFORM_CF">
...
<gw:data id="datCFDetailSearch" onreceive="OnDataReceive(this)" onerror="OnDataError(this)" > 
        <xml>
            <dso type="grid" parameter="0,1,2,3,4,7,10,11,12" function="ACNT.SP_SEL_SEARCH_DESIGNFORM_CF" >
                <input bind="grdCFData">
                    <input bind="lstCompany"/>
