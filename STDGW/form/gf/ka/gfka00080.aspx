                ...
                case "22": // Income statement
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                           ...
                           // D:\WebProject\ESYS\reports\gf\ka\gfka00080_IC_M_VIE.aspx
                        break;
                        case "2"://Quarter
                            //r=r+"&p_quarter="+lstQuater.GetData(); 
        ...
        case "ENG":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21": // balance sheet
                    ...
                    url= url + "&p_Scale="+txtScale.GetData()
                    System.OpenTargetPage( System.RootURL+url , "newform" );
                break;
                case "22": // Income statement
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                           ...
                           //D:\WebProject\ESYS\reports\gf\ka\gfka00080_IC_M_ENG.aspx
                           f_nm='gfka00080_IC_M_ENG.aspx';
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_IC_QUARTER_ENG.aspx';  
                           f_nm='gfka00080_IC_Q_ENG.aspx';  
        ...
        case "ENG-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23":
                    ...
                    {
                        case "1"://Monthly
                            f_nm='gfka00080_CF_PERIOD_ENG_VIE.aspx';
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_QUARTER_ENG_VIE.aspx';    
                        break;
                        case "3"://Year
                             f_nm='gfka00080_CF_Y_ENG_VIE.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
        ...
        case "KOR-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23":
                    ...
                    {
                        case "1"://Monthly
                            f_nm='gfka00080_CF_PERIOD_KOR_VIE.aspx';
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_QUARTER_KOR_VIE.aspx';    
                        break;
                        case "3"://Year
                             f_nm='gfka00080_CF_Y_KOR_VIE.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
        ...
        case "ENG-VIE-KOR":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23":
                    ...
                    {
                        case "1"://Monthly
                            f_nm='gfka00080_CF_PERIOD_ENG_VIE_KOR.aspx';
                        break;
                        case "2"://Quarter
                            f_nm='gfka00080_CF_QUARTER_ENG_VIE_KOR.aspx';    
                        break;
                        case "3"://Year
                             f_nm='gfka00080_CF_Y_ENG_VIE_KOR.aspx';  
                        break;
                    }
                     var url='/reports/gf/ka/'+f_nm+r;       
                     System.OpenTargetPage( System.RootURL+url , "newform" );
