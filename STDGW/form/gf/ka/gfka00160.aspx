...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 {   
       ...
       var ls_data3 = "<%=ESysLib.SetListDataSQL(" SELECT 'ALL' C1,'<All>' C2  FROM DUAL union SELECT C1,C2 FROM ( SELECT TRIM(A.CODE) C1, A.CODE C2 FROM COMM.TCO_ABCODE A, COMM.TCO_ABCODEGRP B WHERE A.DEL_IF = 0 AND B.DEL_IF = 0 AND A.TCO_ABCODEGRP_PK = B.PK AND B.ID = 'ACAB0110' AND A.USE_IF = 1 ORDER BY NUM_VALUE1)")%>";
...
<gw:data id="datGetDepositAccount" onreceive="OnDataReceive(this)" > 
	<xml> 
		<dso id="1" type="grid"  function="acnt.SP_SEL_BOOKING_BANKD" > 
...
<gw:data id="datGetDepositAccount2" onreceive="OnDataReceive(this)" > 
	<xml> 
		<dso id="1" type="grid"  function="acnt.SP_SEL_BOOKING_BANKL" > 
		<input bind="grdDepositTmp">
			<input bind="lstCompany" />
		</input>
		<output bind="grdDepositTmp"/>
