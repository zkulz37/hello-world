...
function OnReport()
{
    ...
    {
         var url = '/reports/gf/ka/rpt_gfka00260.aspx?p_tco_company_pk=' + lstCompany.GetData()+ '&p_date_fr=' + dtSMonth.GetData() + '&p_date_to=' + dtEMonth.GetData();
...
<gw:data id="dso_gfka00260_1" onreceive="MergeHeaderGrid()">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfka00260_1">
