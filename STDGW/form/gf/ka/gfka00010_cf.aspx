...
function RowClick()
{
        ...
        {
            var fpath   = System.RootURL + "/form/gf/ka/gfka00010_cf_acc.aspx?comm_code=Account Code&comm_nm=Account Name&val1=&val2=&val3=" + txtCompany.text + "&dsqlid=ACNT.SP_SEL_ALL_ACCOUNT";	    
...
<gw:data id="datCFMasterDetail" onreceive="OnDataReceive(this)" onerror="OnDataError(this)" > 
    <xml> 
        <dso id="1" type="process" user="acnt" parameter="0"   procedure = "ACNT.SP_SEL_DESIGNFORM_CF_MT"> 
            <input >
...
<gw:data id="datCFDetail" onreceive="OnDataReceive(this)" onerror="OnDataError(this)" > 
        <xml>
            <dso type="grid" parameter="0,1,2,3,4,7,10,11,12,13" function="ACNT.SP_SEL_DESIGNFORM_CF" procedure="ACNT.SP_UPD_DESIGNFORM_CF">
