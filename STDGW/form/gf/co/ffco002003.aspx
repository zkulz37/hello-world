...
<gw:data id="datEmployeePopup"> 
    <xml> 
        <dso  type="grid" function="sp_sel_employee_popup"> 
            <input> 
                <input bind="lstDept" /> 
                <input bind="lstGroup" /> 
                <input bind="chkTemp" /> 
				        ...
				        <table   border="0" CELLSPACING="0" CELLPADDING="0" >
					        <tr>   
						        ...
						        <td width="15%"><gw:list id="lstGroup" styles="color:black;width:100%" value="ALL" onchange=""> 
	                                            <data><%=Esyslib.SetListDataSQL("SELECT PK,WORKGROUP_NM FROM THR_WORK_GROUP WHERE DEL_IF = 0 order by seq, WORKGROUP_NM" )%>|ALL|Select All</data>
	                                            </gw:list > 
						        </td>
