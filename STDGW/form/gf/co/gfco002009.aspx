...
<gw:data id="datGetBeneBankList"> 
    <xml> 
        <dso  type="grid" function="ac_sel_BFBENEFICIARY_popup"> 
	    ...
	    <td width="100%">
	     <fieldset style="width: 100%; height: 100%; padding: 2">
	        <table border="0" width="100%" cellpadding="0" cellspacing="2"  id="table1">
              ...
              <td width="37%"><gw:textbox id="txtcustid" onenterkey="OnSearch()" styles="width:30%" /><gw:textbox id="txtcustnm" onenterkey="OnSearch()" styles="width:69%"/></td>
