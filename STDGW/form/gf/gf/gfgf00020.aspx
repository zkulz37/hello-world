...
<!------------------------------------------------------------------------>
 <gw:data id="dso_pro_fa_depreciation" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1,2" procedure="ACNT.SP_PROCESS_FA_DEPRECIATION" > 
                <input> 
                     <input bind="txtType"/>
  ...
  <gw:data id="dso_pro_fa_generate" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1" procedure="ACNT.SP_PROCESS_FA_GENERATE" > 
                <input> 
                     <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
                </input>
    ...
    <gw:data id="dso_pro_fa_cancelslip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" parameter="0,1" procedure="ACNT.SP_PROCESS_FA_CANCELSLIP" > 
                <input> 
                     <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
                </input>
    ...
    <gw:data id="dso_sel_fa_depreciation" onreceive="OnDataReceive(this)" >
        <xml>
            <dso type="grid" function="ACNT.SP_SEL_FA_DEPRECIATED">
                <input bind="grid">
                    <input bind="lstCOMPANY"/>
                     <input bind="txtMonth"/>
