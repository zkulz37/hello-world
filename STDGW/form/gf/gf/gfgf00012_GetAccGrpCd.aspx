...
function InitData() 
{ 
    var ls_data     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0070','','') FROM DUAL")%>";
...
function AccountRowClick()
{
    ...
    if( event.col == 3 || event.col == 4 || event.col == 5)
	{
        ...
        var fpath   = System.RootURL + "/form/gf/co/ffco002001.aspx?comm_code=" + sNm + "&val1=" + txtGrpCode_pk.GetData() + "&val3=" + lstCompany.GetData() + "&dsqlid=ACNT.SP_SEL_POPUP_ACCOUNT";	    
...
<body>
	...
	<gw:data id="DSO_GET_ACC_GRP_NM"  onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="SP_SEL_ACCOUNT_GRP_NAME">
                <input>
	...
	<gw:data id="dsoAccounGroupCode" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" parameter="0,1,2,7" function="SP_SEL_ACCOUNT_GROUP_CODE" procedure="SP_UDP_ACCOUNT_GROUP_D" > 
