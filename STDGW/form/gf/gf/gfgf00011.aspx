...
<body style="margin:0; padding:0;">
    <gw:data id="dso_sel_grd_fa_inquiry">
        <xml>
            <dso type="grid" function="ACNT.SP_SEL_FA_INQUIRY">
                <input bind="grid">
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td><gw:list  id="lstEODEPT_NM" value='ALL' maxlen = "100" styles='width:100%'onchange="OnSearch()" >
                        <data><%=ESysLib.SetListDataSQL("select PK, ORG_NM from comm.tco_org a where del_if=0 order by a.ORG_ID")%>|ALL|Select All
                        </data></gw:list></td>
                    <td></td>    
                ...
                <tr>
                    ...
                    <td ><gw:list id="lstSTATUS" value = 'A' styles='width:30%' onchange="OnSearch()">
                        <data><%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACDF0070','01','') FROM DUAL")%>
                        </data></gw:list></td> 
