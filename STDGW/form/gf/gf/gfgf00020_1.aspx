...
{ 
    ...
    { 
        var ls_data     = "<%=ESysLib.SetListDataSQL("SELECT TRIM(A.CODE), A.CODE_NM FROM COMM.TCO_ABCODE A, COMM.TCO_ABCODEGRP B WHERE A.DEL_IF = 0 AND B.DEL_IF = 0  AND A.TCO_ABCODEGRP_PK = B.PK AND B.ID = 'ACAB0070' AND A.USE_IF = 1  AND a.code = 'A' ORDER BY ORD")%>";
    }
...
<body>
    <gw:data id="dso_sel_trans">
        <xml>
            <dso type="grid" parameter="0,1,2,3,4" function="acnt.SP_SEL_TRANSGROUP1">
                <input bind="idGrid" >
