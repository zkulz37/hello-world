...
function BindingDataList()
{
    ...
    var ls_kind_cd = "<%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACDF0010','01','') FROM DUAL")%>|ALL|Select All"; 
   ...
   var data = "<%=ESysLib.SetListDataFUNC("SELECT acnt.SF_A_GET_DEFAULT('ACBG0040') FROM DUAL")%>";
	 ...
	 data =   "<%=ESysLib.SetListDataFUNC("SELECT acnt.SF_A_GET_COMMONCODE('ACDF0070') FROM DUAL")%>";
...
function OnReport(obj)
{
    ...
    switch(obj)
    {
        ...
        break;
        case 2:
       var rqt1 = "?company_pk="+lstCompany.value+'&KindCode='+lstKindCode.value+'&DeptPK='+txtDepartmentPK.text+'&Status='+lstStatus.value+'&AssetNo='+txtAssetNo.text+'&AssetName='+txtAssetName.text+'&dtFrom='+dtFromMonth.value+'&dtTo='+dtToMonth.value+'&ccy='+lblBookccy.text+'&unit='+txtScale.text;
...
<gw:data id="datFAList" onreceive="OnDataReceive(this)" >
        <xml>
            <dso type="grid" function="ACNT.SP_SEL_FA_LIST">
                <input bind="grdFA">
 ...
 <gw:data id="dso_sel_change_ccy" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_fa_list_1">
                <input bind="grid_bs">
                    <input bind="lstCompany"/>
                     <input bind="lstKindCode"/>
                     <input bind="txtDepartmentPK"/>
        ...
        <td align="right">
            <table border="0" cellpadding="0" cellspacing="0">
                    <tr>
                        ...
                        <td>&nbsp;</td>
                        <td><gw:imgBtn id="btnPrint"     img="printer"    alt="Danh Sách Tài Sản Cố Định"          onclick="OnReport(1)" /></td>
                        <td><gw:imgBtn id="btnPrint1"     img="printer"    alt="Print Biên bản kiểm kê"          onclick="OnReport(2)" /></td>
                    </tr>
            </table>
        </td>
    </tr>
        ...
        <td>
             <table border="0" cellpadding="0" cellspacing="0" width="100%">
                    ...
                    <tr>
                        ...
                        <td><gw:textbox id="txtAssetNo" styles='width:100%'></gw:textbox></td>
