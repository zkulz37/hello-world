...
<body>
	...
	<gw:data id="DSO_GET_ACC_GRP_NM"  onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="ACNT.SP_SEL_ACCOUNT_GRP_NAME">
                <input>
	...
	<gw:data id="dsoAccounGroupCode" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" parameter="0,1,2,7" function="ACNT.SP_SEL_ACCOUNT_GROUP_CODE" procedure="ACNT.SP_UDP_ACCOUNT_GROUP_D" > 
