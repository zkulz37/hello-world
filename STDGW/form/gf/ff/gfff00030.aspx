...
function onGetAcc()
{
var fpath = System.RootURL + "/form/gf/ff/gfff00020_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=ACNT.sp_sel_gfff00020_Popup";
...
<body>
   <gw:data id="datSLSum" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ACNT.sp_sel_gfff00020_1">
                <input bind="grdSLSum">
   ...
   <gw:data id="datSLByDate" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ACNT.sp_sel_gfff00020">
      ...
      <gw:data id="datSLByVoucher" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
        <xml>
            <dso type="grid"  function="ACNT.Sp_Sel_gfff00020_2">
