...
<body style="margin:0; padding:0;">
 ...
 <gw:data id="dso_get_company_name"> 
        <xml> 
            <dso type="process" procedure="ACNT.SP_GET_COMPANY_NAME" > 
                <input> 
    ...
    <gw:data id="dso_sel_grd_vat_sumary"  onreceive="ChangeColor()">
        <xml>
            <dso type="grid" function="ACNT.SP_SEL_GRD_VAT_SUMARY">
                <input bind="grid">
                    <input bind="lstCompany"/>
                    <input bind="txtMonth"/>
        ...
        <td>
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
                    ...
                    <td width="2%"><gw:imgBtn id="ibtnReport" img="printer"   alt="Print"         onclick="OnReport()"/></td>
		        </tr>
		        ...
		        <tr>
                    ...
                    <td ><gw:textarea id="txtADDRESS"  styles='width=100%'></gw:textarea></td>
                    <td></td>
                    <td></td>
		        </tr>
		        <tr>
