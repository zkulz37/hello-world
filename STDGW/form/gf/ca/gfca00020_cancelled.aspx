...
<gw:data id="dso_get_rate" onreceive="SetExRate()"> 
    ...
    <gw:data id="dso_ar_list" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_tac_crca_lst_os_1" >
	...
	<gw:data id="grdMst" onreceive="OnDataReceive(this)"> 
		<xml> 
			<dso type="control" parameter="0,1,2,3,4,6,7,8,11,14,17,20,23,24,25,26,29,30,32,34,35,36,37,40,41,42,44" function="acnt.sp_sel_tac_crca_os" procedure="acnt.sp_upd_tac_crca_os" > 				
				<inout>
