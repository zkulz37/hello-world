...
function Popup_WH()
{
    var fpath = System.RootURL + "/form/gf/ca/PopUpGetWareHouse.aspx" ;
    var o = System.OpenModal( fpath , 550 , 550 , 'resizable:yes;status:yes;toolbar=no;location:no;directories:no;menubar:no;scrollbars:no;'); 
    if (o != null)
    {
        if(o[0] != 0)
...
<gw:data id="dso_get_rate" onreceive="SetExRate()"> 
    ...
    <gw:data id="dso_init_form" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso type="process" procedure="acnt.sp_sel_acnt_code_ar_os" >
                <input> 
                     <input bind="lstCompany"/>
                </input>  
                <output>
    ...
    <gw:data id="dso_ar_list" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_tac_crca_lst_os" >
	...
	<gw:data id="grdMst" onreceive="OnDataReceive(this)"> 
		<xml> 
			<dso type="control" parameter="0,1,2,3,4,6,7,8,11,14,17,20,23,24,25,26,29,30,32,34,35,36,37,40,41,42,44,46,47,48" function="acnt.sp_sel_tac_crca_os" procedure="acnt.sp_upd_tac_crca_os" > 				
				<inout>
    ...
    <gw:data id="dso_ar_confirm" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso type="process" procedure="acnt.sp_pro_crca_confirm_os" >
                <input> 
						...
						<td colspan="14" >
	                        ...
	                        <tr>
                                <td width ="100%" >
                                    <gw:grid
                                        id      ="grdDtl"  
                                        header  ="_tac_crcad_pk|_tac_crca_pk|Order No|_tco_item_pk|Item Code|Item Name|HS Code|Unit|U/Price|Q'ty|Extended Price|Net Trans. Amt|Net Books. Amt|Ac. Code|Account Name|_tac_abacctcode_pk|WH|Description|Local Desc|_tin_wh_pk|_tex_decl_dtl_pk|_tac_mattakein_ap_pk|Order UPrice|Order Amount"
