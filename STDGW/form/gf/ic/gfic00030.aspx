...
<gw:data id="datClosingEntry" onreceive="OnDataReceive(this)" onerror="OnDataError(this)">
	<xml>
	<dso type="grid" function="acnt.SP_SEL_CLOSING_ENTRY_CN">
...
<gw:data id="datCancelClosing" onreceive="OnDataReceive(this)" onerror="OnDataError(this)"> 
	<xml> 
		<dso id="1" type="process" user="acnt" parameter="0" procedure="acnt.Sp_Pro_Closing_Cancel_CN" > 
			<input >
			<input bind="dtb_MM" />
			<input bind="lstCompany" />
...
<gw:data id="datProcessClosing" onreceive="OnDataReceive(this)" onerror="OnDataError(this)"> 
	<xml> 
		<dso id="1" type="process" user="acnt" parameter="0" procedure="acnt.Sp_Pro_Closing_Entrys_CN" > 
			<input >
			<input bind="dtb_MM" />
			<input bind="lstCompany" />
			<input bind="txtDEP_PK" />
