...
function onReport()
{
     var url = '/reports/gf/rv/gfrv00010_TrialBalance.aspx?p_compk='+ lstCompany.value;
...
function Popup_Acc()
{
    var fpath = System.RootURL + "/form/gf/rv/gfrv00010_1.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ACNT.sp_sel_gfrv00010_11";
...
function OnPopupDailySL()
{
	...
	if (rownum > 1)		 
	{
		if (event.col > 1)
		{
			...
			var fpath   = System.RootURL + '/form/gf/rv/gfrv00010_popup.aspx?ac_pk='+ ac_pk + '&ac_nm=' + ac_nm + '&compk=' + lstCompany.GetData() + '&status=' + lstStatus.GetData() + '&lang='+ lstLang.GetData() + '&cur=' + lstCurrent.GetData() + '&date_fr=' + dtfrmonth.GetData() + '&date_to=' + dttomonth.GetData() + '&type_month=' + lstBalance.GetData();
...
<body style="margin:0; padding:0;">
    ...
    <gw:data id="dso_sel_trial_balance" onreceive="onSetColor()">
        <xml>
            <dso type="grid" function="acnt.gfrv00010_1" >
                <input bind="idGrid">
