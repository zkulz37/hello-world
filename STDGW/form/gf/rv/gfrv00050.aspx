            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "24": // Cash Flows
                    switch(rdoType.value)
                    {
                        ...
                        break;
                        case "3"://Year
                            var url = '/reports/gf/rv/gfrv00050_CF_Y_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
        ...
        case "ENG":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/rv/gfrv00050_CF_M_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/reports/gf/rv/gfrv00050_CF_Q_ENG.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/gf/rv/gfrv00050_CF_Y_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
         ...
         case "KOR":
            ...
            switch(txtFinancialType.GetData())
            {
               ...
               case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/rv/gfrv00050_CF_M_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                             var url = '/reports/gf/rv/gfrv00050_CF_Q_KOR.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/gf/rv/gfrv00050_CF_Y_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
        ...
        case "ENG-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
               ...
               case "24": // Cash Flow (Direct method)
                    ...
                    {
                        case "1"://Monthly
                            var url = '/reports/gf/rv/gfrv00050_CF_M_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                             var url = '/reports/gf/rv/gfrv00050_CF_Q_ENG_VIE.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                           var url = '/reports/gf/rv/gfrv00050_CF_Y_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
        ...
        case "KOR-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/rv/gfrv00050_CF_M_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/gf/rv/gfrv00050_CF_Q_KOR_VIE.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/gf/rv/gfrv00050_CF_Y_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
        ...
        case "ENG-VIE-KOR":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/rv/gfrv00050_CF_M_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                         var url = '/reports/gf/rv/gfrv00050_CF_Q_ENG_VIE_KOR.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/gf/rv/gfrv00050_CF_Y_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
        ...
        case "ENG-KOR":
                            ...
                            switch(txtFinancialType.GetData())
                            {
                                            case "21":
                                                                ...
                                                                {
                                                                    case "1"://Monthly
                                                                         var url = '/reports/gf/rv/gfrv00050_BS_ENG_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                                                                          System.OpenTargetPage( System.RootURL+url , "newform" );
                                                                    break;
                                                                    case "2"://Quarter
                                                                       var url = '/reports/gf/rv/gfrv00050_BS_ENG_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
