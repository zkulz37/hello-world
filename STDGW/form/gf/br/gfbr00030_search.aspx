...
function BodyInit()
{
    ...
    txtAc_level.text= "<%=session("ACNT_LEVEL")%>";
     ...
     if(txtAc_level.text=='6')
     {
        ...
        lst_compk.SetDataText(_company);
...
function OnRecv(obj)
{
    switch(obj.id)
    {
        case 'dso_sel_grd_slip_entry_search':
	        var ctrl = grid_search.GetGridControl();
	        var i = ctrl.rows - 1;
...
<body>
<gw:data id="datCompany" onreceive="OnRecv(this)"  > 
        <xml>
            <dso  type="list" procedure="ac_lst_gfbr00030_get_company"  > 
                <input>
                    <input bind="txtSesion_company" />
                </input> 
                <output>
                    <output bind="lst_compk" />
                </output>
            </dso> 
        </xml> 
</gw:data>
<gw:data id="dso_sel_grd_slip_entry_search" onreceive="OnRecv(this)">
    <xml>
	            ...
	            <td width="100%">
			        <table cellpadding="0" cellspacing="0" width="100%" height="100%" align="left" border="0">
							...
							<td width="40%">
								<table width="100%">
									<tr>
                                        ...
                                        <td width="30%" ><gw:list id="lst_vouchertype" onenterkey="OnSearch()"></gw:list></td>
                                       <!--<data><%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('ACBG0130','','') FROM DUAL")%></data>--> 
									</tr>
								</table>
                            </td>
		                ...
		                <tr>
							...
							<td width="5%" align="left">vouchers</td> 							
