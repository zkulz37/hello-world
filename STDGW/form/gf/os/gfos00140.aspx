...
function onReport(lang)
{
    ...
    switch(lang)
    {
        case "VIE":
          if(lstLoai.value == '95')
          {
            var  url='/reports/gf/os/gfos00140.aspx?kind='+lstLoai.GetData()+'&status='+rbstatus.value+'&company='+lstCompany.GetData()+'&from='+dtfrdate.GetData() + '&to='+ dttodate.GetData()+ '&date_type='+txtDateType.GetData()+"&scale="+txtScale.GetData()+ '&month=' + dtMonth.GetData() + '&user=' + txtuser.text + '&quy=' + lstThang.value + '&donvi=' + lblBookccy.text + '&nam=' + dtYear.GetData();  
...
<body style="margin: 0; padding: 0;">
    ...
    <gw:data id="dso_sel_grid" onreceive="ChangeColor()">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfos00140_1">
                <input bind="grid_bs">
                    <input bind="lstLoai"/>
                    <input bind="rbstatus"/>
    ...
    <tr style="width:100%;height:75%">
                            ...
                            <!-- header  ="0.Chỉ tiêu|1.Số dư đầu kỳ|2.Phát sinh tăng trong kỳ|3.Phát sinh giảm trong kỳ|4.Số dư cuối kỳ|5._font_stype|6._prn_color|7._GRP_ACCD"-->
                                <gw:grid   
								        id="grid_bs"
						                header  ="Chỉ tiêu|Số dư đầu kỳ|Phát sinh tăng trong kỳ|Phát sinh giảm trong kỳ|Số dư cuối kỳ|_font_stype|_prn_color|_GRP_ACCD"
						                format  ="0|0|0|0|0|0|0|0"  
						                aligns   ="0|3|3|3|3|0|0|0"  
						                defaults="|||||||"  
						                editcol ="0|0|0|0|0|0|0|0"  
						                widths  ="8000|2200|2200|2200|2200|1000|0|0"  
