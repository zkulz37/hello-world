...
function onSearch()
{
   ...
   // alert(txtFinancialType.GetData());
    if(txtFinancialType.GetData() == '90'){
        dso_trial_balance.Call();
    }
    else if(txtFinancialType.GetData() == '91'){
        dso_sel_grd_income.Call("SELECT");
    }
    else if(txtFinancialType.GetData() == '92'){
...
function onReport(lang)
{
    ...
    switch(lang)
    {
        case "VIE":
            ...
            switch(x)
            {
                case 90: // balance sheet
                    switch(rdoType.GetData())
                    {
                       case "1"://Monthly
                               var url = '/reports/gf/os/gfos00010_bs_vie.aspx?p_kind='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData();
                               url= url + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                ...
                break;
                case 91: // Income statement
					//alert(rdoType.GetData());
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                            // f_nm='gfos00010_IC_M_VIE.aspx.aspx';
							   var url = '/reports/gf/os/gfos00010_IC_M_VIE.aspx?p_kind='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData();
                               url= url + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                               System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            //f_nm='gfka00080_IC_QUARTER_VIE.aspx';  
                             var url = '/reports/gf/os/gfos00010_IC_Q_VIE.aspx?p_kind='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData();
                               url= url + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData() + '&p_quarter=' + lstQuater.GetData() + '&p_year=' + dtYear.GetData();
                               System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
...
function onSetDataList()
{
    ...
    {
        txtFinancialType.SetDataText('91');
    }
    else if (idTab_Child.GetCurrentPageNo() == 2)
    {
        txtFinancialType.SetDataText('92');
    }
...
<body style="margin: 0; padding: 0;">
    ...
    <gw:data id="dso_trial_balance" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="process" procedure="ACNT.SP_PRO_TRIAL_BALANCE_90"> 
                <input> 
                     <input bind="rbstatus"/>
                     <input bind="lstCompany"/>
                     <input bind="dtfrdate" />
    ...
    <gw:data id="dso_sel_grd_balance_sheet" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfos00010_1">
                <input bind="grid_bs">
                    <input bind="txtFinancialType"/>
                    <input bind="rbstatus"/>
                    <input bind="lstCompany"/>
    ...
    <gw:data id="dso_sel_grd_cf" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="acnt.sp_sel_gfos00020_1">
        ...
        <tr>
            <td width="100%">
                ...
                <table width="100%" cellpadding="0" cellspacing="0" border="0">
                    ...
                    <table name="Balance Sheet(TT0895)"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:380;" >
                        <tr valign="top">
                    ...
                    <table name="Income Statement(TT0895)"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:380;" >    
                        <tr valign="top">
                    ...
                    <table name="Cash Flows Direct(TT0895)"  align ="top"  cellspacing=0 cellpadding=0 border=0 style="width:100%;height:380;" >    
                        <tr valign="top">
