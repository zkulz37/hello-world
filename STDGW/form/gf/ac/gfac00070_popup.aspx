...
<body style="margin:0; padding:0;">
 <gw:data id="datSlipPopup" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" function="ACNT.SP_SEL_GET_ACCOUNT_GROUP" > 
   ...
   <gw:data id="datAccountInGroup" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" function="ACNT.SP_SEL_ACCOUNT_IN_GROUP" > 
   ...
   <gw:data id="datAllAccount" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" function="ACNT.SP_SEL_GET_ACCOUNT_CODE" > 
