	...
	<tr>
		<td width="25%">
			<table  id="LeftTopTB" height="20">
				<tr>
					<td width="35%" align="center">Item name</td>
					<td width="45%"><gw:textbox id="txt_ItemName"   csstype="filter" maxlen="30" onenterkey="OnSearch()" onkeypress="Upcase()"/></gw:textbox></td>					
		...
		<td width="75%">
			<table id="RightTopTB" height="20" >
				<tr>
					<td width="10%">Code</td>
					<td width="30%"><gw:textbox id="txtItemcd"   csstype="filter" maxlen="30" onenterkey="OnRowClick_Master()" onkeypress="Upcase()" /></td>
					<td width="20%" align="right">Sub Item name</td>
