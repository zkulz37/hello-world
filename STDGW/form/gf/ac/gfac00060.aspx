...
{ 
    ...
    {        
        var ls_data     = "<%=ESysLib.SetListDataFUNC("SELECT SUBSTR(comm.F_COMMONCODE('ACAB0070','',''), 1, INSTR(comm.F_COMMONCODE('ACAB0070','',''), '|Y|SYSTEM') -1) || SUBSTR(comm.F_COMMONCODE('ACAB0070','',''), INSTR(comm.F_COMMONCODE('ACAB0070','',''), '|Y|SYSTEM') + LENGTH('|Y|SYSTEM')) FROM DUAL")%>";
    }
...
function AccountRowClick()
{
    ...
    if( event.col == 3 || event.col == 4 || event.col == 5)
	{
       ...
       // var fpath   = System.RootURL + "/form/gf/co/ffco002001.aspx?comm_code=" + sNm + "&val1=" + txtInput_PK.GetData() + "&val3=" + lstCompany.GetData() + "&dsqlid=ACNT.SP_SEL_POPUP_ACCOUNT";	  20090206  
      var fpath   = System.RootURL + "/form/gf/co/ffco002001.aspx?comm_code=&val1=" + txtInput_PK.GetData() + "&val3=" + lstCompany.GetData() + "&dsqlid=ACNT.SP_SEL_POPUP_ACCOUNT";	    
...
<body style="margin:0; padding:0;">
	...
	<gw:data id="dsoAccountGroupEntry"  onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" function="ACNT.SP_SEL_ACCOUNT_GROUP" parameter="0,1,2,3,4,5,6,7,8" procedure="ACNT.SP_UDP_ACCOUNT_GROUP"> 
    ...
    <gw:data id="dsoAccounGroupDetail" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso type="grid" parameter="0,1,2,7" function="ACNT.SP_SEL_ACCOUNT_GROUP_DETAI" procedure="ACNT.SP_UDP_ACCOUNT_GROUP_D" > 
                ...
                <td width="45%" valign="top">
                    <table border="0" cellpadding="0" cellspacing="4" width="100%">
						...
						<tr>
							<td colspan="4" align="right">
								<table border=0 cellpadding="0" cellspacing="0" width="100%">
									...
									<td width="5%"><gw:imgBtn img="new"     alt="New"      id="btnAddM"      onclick="onMasterAddClick()"/></td>
									<td width="5%"><gw:imgBtn img="save"    alt="Save"     id="btnSaveM"     onclick="onMasterSaveClick();return false;"/></td>
									<td width="5%"><gw:imgBtn img="delete"  alt="Delete"   id="btnDeleteM"   onclick="onMasterDeleteClick()"/></td>
									</tr>
								</table>
							</td>
						</tr>
						<tr>
							...
							<gw:grid   
						    id="grdAGCode"  
						    header  ="_PK|_COMPANY|_APP_GRP|Acc. Grp Code|Acc. Grp Name|Acc. Grp Name (LC)|Acc. Grp Name (KOR)|Description|_User"   
