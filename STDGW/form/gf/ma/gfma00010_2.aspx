...
function BodyInit()
{
    ...
    var ls_data1  = ("<%=ESysLib.SetListDataSQL("select pk,org_nm from comm.tco_org a where  del_if=0")%>"); 
    ...
    var advpk       = "<%=Request.querystring("advpk")%>"; 
    ...
    txt_option.SetDataText(option);
    txt_advpk.SetDataText(advpk);
...
<gw:textbox id="txt_advpk"            style="display:none"/>
<gw:textbox id="txt_option"            style="display:none"/>
