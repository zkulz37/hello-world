...
<gw:data id="datDeptTree"   > 
        <xml> 
            <dso id="1" type="tree" function="acnt.sp_sel_gfma00040_1" > 
                <input>
    ...
    <tr>
	    <td > 
	        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                <tr>
                    <td>
	                    <gw:tree  id="treDept" onclicknode="treeItemOnclick()" style="width:100%; height:370;overflow:auto;"  >
		                </gw:tree>  
		           </td>
		       </tr>
