...
<gw:data id="dso_Subcont"  onreceive="" > 
    <xml> 
        <dso id="1" type="grid"   function="ec111.sp_sel_kpar30_subcontract" > 
...
<table style="width:100%;height:100%">
    ...
    <tr style="height:98%">
    	<td width="100%">
            <gw:grid   
            id="Grid_Asset"  
            header="_PK|No|Subcontract No|Subcontract Name|Request No|Order Work Code|Order Work Name"   
            format  ="0|0|0|0|0|0|0"  
            aligns  ="0|1|0|0|0|0|0"  
            defaults="||||||"  
            editcol ="0|0|0|0|0|0|0"  
            widths  ="0|600|2000|3000|1500|1500|2000"  
