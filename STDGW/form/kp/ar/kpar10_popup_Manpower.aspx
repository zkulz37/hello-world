...
<body>
    ...
    <xml> 
           <dso id="1" type="grid" function="ec111.sp_sel_kpar10_popup" parameter="0,1,2,3,4,5,6" procedure="ec111.sp_upd_kpar10_popup"> 
                  <input bind="idGrid" > 
    ...
    <table style="width: 100%; height: 100%" cellpadding="0" cellspacing="0">
        ...
        <tr style="height: 49%">
            <td colspan="6">
                 <gw:grid id='idGrid2' 
				header='_PK|Category|Category Name|Unit|Align. Seq.|Use Y/N|_Project_Pk' 
				format='0|0|0|0|0|0|0' 
				aligns='0|0|0|0|0|0|0'
                check='||||||' 
