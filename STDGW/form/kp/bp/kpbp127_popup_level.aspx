...
//    var p_version_pk = "<%=Request.querystring("version_pk")%>";
//	txtversion_pk.SetDataText(p_version_pk);
	OnSearch();
}
//-------------------------------------------------------------------------------------------------------------------------------------
...
//        if(Grid_Search.GetGridData( ctrl.row , 4 ) == '0')
//		{
...
<gw:data id="dso_Search" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid"  function="ec111.sp_sel_kpbp127_popup" >
            ...
            <table cellpadding="0" cellspacing="0" style="width:100%;height:100%">
                           ...
                           <tr style="height: 48%;width:100%">
                                      <td  valign="top" width="100%">
                                            <gw:grid   
                                            id="Grid_Search"  
                                            header="Level Code|Work Name|_pk|_TECPS_UNDERTAKECTRTRMRK_pk"   
                                            format  ="0|0|0|0"  
                                             aligns ="0|0|0|0"  
                                            defaults="|||"  
                                            editcol ="0|0|0|0"  
                                            widths  ="3000|3000|0|0"  
                         ...
                         <tr style="height: 48%;width:100%">
                                      <td  valign="top" width="100%">
                                            <gw:grid   
                                            id="Grid_Bottom"  
                                            header="Level Code|Work Name|_level_pk|_TECPS_UNDERTAKECTRTRMRK_pk"   
                                            format  ="0|0|0|0"  
                                             aligns ="0|0|0|0"  
                                            defaults="|||"  
                                            editcol ="0|0|0|0"  
