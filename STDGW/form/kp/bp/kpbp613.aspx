...
function OnPrint() {
    if (txtProject_Pk.text != '') {
        var url = System.RootURL + "/reports/kp/bp/RPT_KPBP613.aspx?Project_pk=" + txtProject_Pk.GetData() + "&Year=" + lstYear.GetData() ;
...
function DBPopupClick(){
	 var fpath   = System.RootURL + "/form/kp/bp/kpbp613_p1.aspx?p_year=" + lstYear.GetData() + '&order_pk=' + Grid_Mst.GetGridData(Grid_Mst.row,19) + '&p_tac_abplcenter_pk=' + txttac_abplcenter_pk.GetData() + '&p_tac_plpk=' + txttac_abpl_pk.GetData() + '&project_pk=' + txtProject_Pk.GetData();
...
<gw:data id="dso_year" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="list" procedure="EC111.sp_pro_kpbp612_year1"> 
                <input> 
...
<gw:data id="dso_kpbp612" onreceive="OnDataReceive(this)">    
	<xml> 
		<dso type="grid"  function="ec111.sp_sel_kpbp613" > 
			<input bind="Grid_Mst">
				<input bind="txtProject_Pk" />
				<input bind="lstYear" />
...
<!-------------------------------------------------------------------------->		
	<table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0">
		...
		<tr height:96%>
			...
			<td>
				<gw:grid id="Grid_Mst" 
				header="Content|Work code|Work name|Budget (A)|Accu. cost(B)|Balance(A-B)|This year|01/2011|02/2011|03/2011|04/2011|05/2011|06/2011|07/2011|08/2011|09/2011|10/2011|11/2011|12/2011|_order_pk" 
				format="0|0|0|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|-2|0"
