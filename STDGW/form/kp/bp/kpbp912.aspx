...
function OnPrint()
{
	if(Grid_Detail.rows > 1)                                                 
	 {
		 var url = '/reports/kp/bp/rpt_kpbp912.aspx?p_tecps_projectsumm_pk='+ txtProject_Pk.text+'&p_dtfrm='+dtPeriod_Fr.value +'&p_dtto='+dtPeriod_To.value;
...
<body>
    ...
    <xml> 
        <dso id="1" type="grid"  function="ec111.sp_sel_kpbp912"  > 
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
        ...
        <tr style="height: 98%">
            <td colspan="4">
                ...
                header="S/No|Bdgt Statement No.|_Descrip.|_Appr. Date|Cont. Amt(A)|BCWS(B)|Sales Gross Prft(A-B)|Sales Gross Prft Rate(%)"
                    format="0|0|0|0|1|1|1|1" 
                    aligns="1|1|3|1|3|3|3|3"
                    defaults="|||||||" 
                    editcol="1|1|1|1|1|1|1|1" 
                    widths="1000|2000|1000|1200|2000|2000|2000|2000"
