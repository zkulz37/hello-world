...
function BodyInit()
{
   ...
   var data = ""; 
	...
	txtVersion.text     = "<%=Request.querystring("p_version")%>" ; 
}
...
<body>
    ...
    <xml> 
           <dso id="1" type="grid" function="ec111.sp_sel_kpsh511_item" > 
                  <input bind="idGrid" > 
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 5%">
            ...
            <td style="width: 50%"  colspan="2"><gw:textbox id="txtItem" styles="width:100%" onenterkey="OnSearch(2)" /></td>
        ...
        <tr style="height: 45%">
            <td colspan="7">
                <gw:grid id="idGrid"
				    header="_PK|Item Code|Item Name|UOM"
                    format='0|0|0|0' 
					aligns='0|0|0|0' 
                    defaults='|||' 
					editcol='0|0|0|0' 
                    widths='0|3500|5500|1000' 
	...
	<gw:textbox id="txtVersion" styles="display: none" />
