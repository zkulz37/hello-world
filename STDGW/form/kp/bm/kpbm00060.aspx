...
<gw:data id="dso_CONTAMT" onreceive="OnReceiveData(this)"> 
	<xml>                                                               
		<dso id="1" type="process" procedure="ec111.sp_pro_kpbm00060_contamt"  > 
			<input> 
...
<gw:data id="dso_BudgetNo" onreceive="OnReceiveData(this)"> 
    <xml> 
        <dso id="2" type="list" procedure="ec111.sp_sel_kpbm00060_budgetno" > 
			<input> 
				<input bind="txtProjectPK" />
			</input> 
			<output>
...
<gw:data id="dso_grdLaborCost" onreceive="OnReceiveData(this)"> 
    <xml> 
        <dso id="2" type="grid" function="EC111.sp_sel_kpbm00060_labor_cost" > 
                                ...
                                <table cellpadding="0" cellspacing="0" width="100%">
                                    <tr>
                                        ...
                                        <td align="right" width="40%">Budget No</td> 
                                            ...
                                            <td>
                                                <gw:imgbtn id="ibtUDelete" img="udelete" alt="UnDelete" onclick="OnUnDelete()" />
                                            </td>
                                            <td>
                                                <gw:imgbtn id="ibtDelete" img="delete" alt="Delete" onclick="OnDelete()" />
                                            </td>
                                    </tr>
                                </table>
                            </td>
