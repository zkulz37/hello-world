...
function OnDataReceive(obj)
{
	 switch(obj.id)
	 {
		...
		case 'dso_search_bottom':
		        if(Grddetail.rows > 0)
		        {
		            txtContract_Amt.SetDataText(Grddetail.GetGridData(Grddetail.rows-1, 2));
		        }
		        if((Grid_Mst.rows > 1) && (Grddetail.rows > 0))
		        {
		            txtBCWS.SetDataText(Math.round(Number(Grid_Mst.GetGridData(Grid_Mst.rows-1, 5)) + Number(Grddetail.GetGridData(Grddetail.rows-1, 4)) + Number(Grid_Mst.GetGridData(Grid_Mst.rows-1, 3))     ));
		        }
		break;
	 }
}
...
<gw:data id="dso_search_bottom" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso id="1" type="grid" function="ec111.sp_sel_kpbm219_1" parameter="0,1,2,3,4,5" procedure="EC111.sp_upd_kpbm219_1" > 
...
<!------------------------------------------------------------------------------------------------->    
    <table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0">
				...
				<fieldset style="width:100%;padding:0">
					<table  style="width: 100%" cellpadding="0" cellspacing="0">
						<tr>
							...
							<td width="20%" align="right"><a title="Budget Statement No." style="color:#333">*Bdgt Statement No.&nbsp;</a>s</td>
						...
						<tr>
							<td  align="right" ><a title="Budgeted Cost of Work Scheduled" style="color:#333">BCWS(a+c+f)&nbsp;</a></td>
		...
		<tr height="46%" style="display:">
			...
			<gw:grid 
				id="Grddetail"  
				header="Description|Applied Criteria|Applied Subj.Amt (d)|Applied Rate (e)|Calc.Amount (f=d*e)|_pk"   
				format  ="0|0|1|1|1|0"  
				aligns   ="0|0|0|0|0|0"  
				defaults="|||||"  
				editcol ="1|1|1|1|1|0"  
				widths  ="3000|2500|2500|2000|2000|0"  
				styles="width:100%; height:100%"   
				sorting="T"   
