...
<head>
    <title>Construction working details search by conditions</title>
</head>
                            ...
                            <table style="width: 100%; height: 100%">
                                <tr style="height: 1%">
                                    <td align="right" width="10%">
                                     ...
                                     <td align="right" width="15%"><a href="#"  title="Click here to show Work Division"  onClick="" style="text-decoration:none">Budget Statement No.</a></td>
                                     <td width="25%"><gw:list id="lstBudget_No"  styles='width:100%' /></td>
                                ...
                                <tr>
                                        	...
                                        	<td >
                                            			<table cellpadding="0" cellspacing="0">
                                                        		<tr>
                                                                			<td width="20%"><gw:list id="lstWork_Breakdown" styles="width:100%" /></td>
                                                                			<td align="right" width="20%"><a title="Click here to show Order Work Division" href="#" style="text-decoration: none" onClick="OnPopUp('')">Order W. Div&nbsp;</a></td>
                                                                            <td width="25%">
                                    		...
                                    		<td style="width: 15%" align="right">Cont. (Y/N)</td>
                                            <td colspan="2">
                                            		<table width="100%" cellpadding="0" cellspacing="0">
                                                    		<tr>
                                                            			<td width="20%"><gw:list id="lstContract_YN" styles='width:100%' /></td>
                                            ...
                                            <td width="50%">
                                                <table cellpadding="0" cellspacing="0" width="100%">
                                                    <tr>
                                                        ...
                                                        <td align="right" width="20%"><a title="Standard Code" style="text-decoration: none;color:#333" >Std Code&nbsp;</td>
                                                        <td width="50%">
                                                            <gw:textbox id="txttandardCode" readonly="true" styles='width:100%' />
                                                        </td>
                                                    </tr>
