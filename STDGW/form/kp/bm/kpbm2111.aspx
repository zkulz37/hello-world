...
function BodyInit()
{
	...
	var data ;
	data = "<%=ESysLib.SetListDataFUNC("SELECT acnt.SF_A_GET_COMMONCODE('E250') FROM DUAL")%>";
...
function OnPrint()
{
	var url = '/reports/kp/bm/rpt_kpbm2111.aspx?p_project_pk='+ txtProject_Pk.text + '&p_version=' + lstBudget.value + '&p_searchdes=' + lstsearch.value;
...
<gw:data id="dso_Search" onreceive="OnDataReceive(this)">
	  <xml>
		<dso type="grid"  function="ec111.sp_sel_kpbm2111" >
		  <input bind="idGrid">
			  <input bind="txtProject_Pk"/>
