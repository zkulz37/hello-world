...
function DblClick()
{
	...
	code_data[3] = Grid_Mst.GetGridData( ctrl.row , 5 ); // Start Date
	code_data[4] = Grid_Mst.GetGridData( ctrl.row , 6 ); // End Date
...
<body>
 <gw:data id="dso_search" >
	<xml>
		<dso type="grid" function="ec111.sp_sel_kpbm00060_1" >
			<input bind="Grid_Mst">
...
<table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0">
	...
	<tr style="height: 99%;width:100%">
	   ...
	   <td width="100%">
		   <gw:grid   
			id="Grid_Mst"  
			header="_PK|No|Project Code|Project Name|Representative Customer|Starting Date|End Date"   
			format  ="0|0|0|0|0|0|0"  
			aligns  ="2|2|2|2|2|1|1"  
			defaults="||||||"  
			editcol ="0|0|0|0|0|0|0"  
			widths  ="0|800|1500|2500|3000|1500|1500"  
