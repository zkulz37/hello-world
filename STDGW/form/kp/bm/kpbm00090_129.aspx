    ...
    <table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0">
			...
			<td>
				<fieldset style="width:100%;padding:0">
					<table  style="width: 100%" cellpadding="1" cellspacing="0">
						<tr>
							<td align="right" width="13%" style="padding-right:5px">
								<a title="Click here to show Project" href="#" style="text-decoration: none" onClick="OnPopUp('Project')">*PJT</a>
							</td>
							<td width="38%">
							...
							<td width="20%" align="right">*Bdgt Statement No.</td>
							<td width="20%"><gw:list id="lstBudgetNo" styles='width:100%' /></td>
							<td align="right" style="padding-right:5px"><gw:imgbtn id="btSve2" img="search" alt="Search"  onclick="OnSearch()" /></td>
							<td><gw:imgbtn id="btSve2" img="save" alt="Save"  onclick="" /></td>
						</tr>  
						<tr>
							<td  align="right" style="padding-right:5px">Wkng Per.</td>
							<td>
								<table cellpadding="0" cellspacing="0">
									<tr>
										<td><gw:datebox id="dtWorking_Fr" lang="1" /></td>
										<td style="padding-left:5px; padding-right:5px">~</td>
										<td><gw:datebox id="dtWorking_To" lang="1" /></td>
									</tr>
								</table>
							</td>
							<td  align="right"><a title="Main Contract Amount" style="color:#000; padding-right:5px">Cont. Amt</a></td>
							<td><gw:textbox id="txtContract_Amt"  styles='width:100%' /></td>
							<td colspan="2"></td>
						</tr>
						<tr>
							<td  align="right" style="padding-right:5px">BCWS</td>
							<td><gw:textbox id="txtContract_Amt"  styles='width:44%' /></td>
							<td></td>
							<td  align="right" colspan="2">Actual Result  - Received Month &nbsp;</td>
		...
		<tr height="30%">
					<td width="100%">
										...
										<gw:grid 
													id="Grddetail"  
													header="Description|Applied Criteria|Applied Subj.Amt (g)|Applied Rate(h)|Calc.Amount(g*h)"   
													format  ="0|0|0|0|0"  
													aligns   ="0|0|0|0|0"  
													defaults="||||"  
													editcol ="0|0|0|0|0"  
