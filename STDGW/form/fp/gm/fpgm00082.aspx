...
<head id="Head1" runat="server">
    <title>Preparation Report</title>
</head>
...
//===============================================================================================
 function OnSearch(pos)
 {
      switch(pos)
        {
			case 'header':
				data_fpgm00082_header.Call('SELECT');
			break;
            
            case 'Detail':
                data_fpgm00082.Call('SELECT');
            break;
        }        
 }
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_fpgm00082_header" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_fpgm00082_header"> 
    ...
    <!----------------------------------------------------------------------->
    <gw:data id="data_fpgm00082" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso type="grid" user="prod"   function="<%=l_user%>lg_sel_fpgm00082"   >
                <input >
                    ...
                    <tr style="height: 98%">
                        <td colspan="7">
                            <gw:grid id='grdDetail' 
								header='_Comp_PK|Comp ID|Comp Name|_Spec01_PK|Spec 01|_Spec02_PK|Spec 02|_Spec03_PK|Spec 03|_Spec04_PK|Spec 04|_Spec05_PK|Spec 05|Plan Qty|Req Qty|Prod Qty|(%)'
