...
//===============================================================================================
 function OnDataReceive(po_oData)
 {
    switch (po_oData.id)
    {
		...
		case 'data_fpgm00150_2' :
			SetHeader();
			
			data_fpgm00150_1.Call("SELECT");
		break;
				
        case 'data_fpgm00150_1' :            
            if ( grdDetail.rows > 1 )
            {
...
//===============================================================================================
 function OnSearch(pos)
 {
        ...
        {
			case 'header':
				data_fpgm00150_header.Call('SELECT');
			break;
			
            case 'OrdPlan':
                data_fpgm00150.Call('SELECT');
            break;
            
            case 'Detail':
                data_fpgm00150_2.Call('SELECT');
            break;
        }        
 }
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="pro_fpgm00150" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="list" procedure="<%=l_user%>lg_pro_fpgm00150" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="data_fpgm00150_header" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_fpgm00150_header"> 
    ...
    <!----------------------------------------------------------------------->
    <gw:data id="data_fpgm00150" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso  type="grid" user="prod" parameter='0,3,6' function="<%=l_user%>lg_sel_fpgm00150" >
                <input >
					<input bind="lstFactory" />
    ...
    <!----------------------------------------------------------------------->
    <gw:data id="data_fpgm00150_1" onreceive="OnDataReceive(this)"> 
        <xml>
           <dso type="grid" user="prod"   function="<%=l_user%>lg_sel_fpgm00150_1"   >
                <input >
	...
	<!------------------------------------------------------------------>
    <gw:data id="data_fpgm00150_2" onreceive="OnDataReceive(this)"> 
        <xml>                                                               
            <dso id="1" type="grid" user="prod" function="<%=l_user%>lg_sel_fpgm00150_2"  > 
                <input> 
                    <input bind="dtDate" /> 
                </input> 
                <output bind="grdTmp" /> 
                    ...
                    <tr style="height: 98%">
                        <td colspan="11">
                            <gw:grid id='grdDetail' 
								header='Group|_Comp_PK|_Comp ID|In Comp|_Spec01_PK|Spec 01|_Spec02_PK|Spec 02|_Spec03_PK|Spec 03|_Spec04_PK|Spec 04|_Spec05_PK|Spec 05|Plan Qty|Req Qty|Prod Qty|(%)|D1 Qty|D2 Qty|D3 Qty|D4 Qty|D5 Qty|_Group'
