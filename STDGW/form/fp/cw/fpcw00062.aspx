...
<body>
    <!------------------------------------------------------------------>
    <gw:data id="data_fpcw00062" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="sale"  parameter="0,1,2" function="<%=l_user%>lg_sel_fpcw00062" > 
                <input> 
    ...
    <!------------------------------------------------------------------>
    <gw:data id="pro_fpcw00062" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpcw00062" > 
                <input>
                    <input bind="txtWIPK" /> 
                </input> 
                <output>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_fpcw00062_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpcw00062_1" > 
                <input>
                    <input bind="txtWIPK" /> 
                </input> 
                <output>
        ...
        <tr id='top' style="height: 99%">
            <td colspan="8">
                <gw:grid id="grdDetail" header='_pk|W/I Date|W/I No|Status|P/O No|Style|Pattern|Description'
                    ...
                    widths='0|1200|1500|1200|1500|3000|2000|1000' styles="width:100%; height:100%" sorting="T"
