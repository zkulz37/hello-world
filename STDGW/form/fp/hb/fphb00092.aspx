...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_fphb00092" onreceive="OnReceiveData(this)"> 
    <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_fphb00092" > 
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 49%">
            <td colspan="7">
                <gw:grid id="idGrid" header="Group|_PK|Item Code|Item Name|UOM" format="0|0|0|0|0"
                    aligns="0|0|0|0|1" editcol="0|0|0|0|0" widths="2000|0|2000|4500|800" styles="width:100%; height:100%"
        ...
        <tr style="height: 49%">
            <td colspan="7">
                <gw:grid id="idGrid2" header="Group|_PK|Item Code|Item Name|UOM" format="0|0|0|0|0"
                    aligns="0|0|0|0|1" editcol="0|0|0|0|0" widths="2000|0|2000|4500|800" styles="width:100%; height:100%"
                    sorting="T" />
            </td>
        </tr>
