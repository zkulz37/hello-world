...
{	
	...
	{	    
		...
		case 'REPORT':
			var path = System.RootURL + '/form/fp/hb/fphb00051.aspx';
    ...
    {   
        case 'data_fphb00100':         
             for (var i = 1; i < grdSearch.rows; i++) {
                if(grdSearch.GetGridData( i, G0_NULL) != '')
                {
...
function OnReport(pos)
{
	switch(pos)
	{
		...
		case 'ST01':
			var url =System.RootURL + '/reports/fp/hb/rpt_fphb00100_ST01.aspx?p_parent_pk='+ txtProdPK.text ;
			window.open(url); 			
		break;
	}
        ...
        <tr>
            <td id="left" valign="top" style="width: 30%">
                <table style="height: 100%; width: 100%" border="0">
                    ...
                    <tr style="height: 97%">
                        <td colspan="3">
                            <gw:grid id="grdSearch" header="_PK|Code|Name|UOM|_NULL" format="0|0|0|0|0" aligns="0|0|0|1|0"
                                defaults="||||" editcol="0|0|0|0|0" widths="0|1500|2500|800|0" styles="width:100%; height:100%"
