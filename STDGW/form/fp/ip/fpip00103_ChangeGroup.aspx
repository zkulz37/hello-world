...
function BodyInit()
{
    ...
    fpip00103_SearchGroup.Call("SELECT");
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        case 'fpip00103_SearchGroup':
            fpip00103_Spec.Call("SELECT");
        break;
    }
}
//--------------------------------------------------------
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="fpip00103_SearchGroup" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="control" function="<%=l_user%>lg_sel_fpip00103_group" > 
             <inout> 
    ...
    <!---------------------------------------------------------------->
    <gw:data id="fpip00103_Spec" onreceive="OnDataReceive(this)"> 
        <xml>                                   
             <dso id="1" type="grid"   function="<%=l_user%>lg_sel_fpip00103_spec" > 
              <input  bind="idGrid">
