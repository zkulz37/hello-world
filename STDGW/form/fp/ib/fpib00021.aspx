...
function BodyInit()
{
    ...
    var data = "<%=ESysLib.SetGridColumnDataSQL("SELECT a.CODE, a.CODE_NM FROM SALE.LG_CODE a, SALE.LG_CODE_GROUP b WHERE  b.GROUP_ID='LGPC0340' AND a.LG_CODE_GROUP_PK=b.PK and a.use_if = 'Y' and a.del_if = 0 and b.del_if = 0 ORDER BY a.CODE , a.CODE_NM " ) %>|| ";       
...
<body>
    <!--------------------------------------------->
    <gw:data id="data_fpib00021" onreceive=""> 
    <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_fpib00021" > 
