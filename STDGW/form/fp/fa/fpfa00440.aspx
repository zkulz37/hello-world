...
function OnSearch(id)
{
    ...
    {
        case 'grdConfirm':
            data_fpfa00440.Call('SELECT');
        break;
        
        case 'grdApprove':
            data_fpfa00440_1.Call('SELECT');
        break;
    }
}
...
{    
    ...
    var url =System.RootURL + "/reports/bi/ni/rpt_fpfa00440.aspx?dtFrom="+txtDateFrom.text+"&dtTo="+txtDateTo.text ;
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        ...
        case 'pro_fpfa00440_1' :
            alert(txtReturnValue.text);
            data_fpfa00440.Call('SELECT')   
        break;
        
        case'pro_fpfa00440_2':
            alert(txtReturnValue.text);
            data_fpfa00440_1.Call('SELECT');
        break;
    }
...
<body>
    <!--------------------------------------------------------------------->
    <gw:data id="data_fpfa00440" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_fpfa00440"  >
    ...
    <!--------------------------------------------------------------------->
    <gw:data id="data_fpfa00440_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_fpfa00440_1"  >
    ...
    <!--------------------------------------make plan------------------------------->
    <gw:data id="pro_fpfa00440_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpfa00440" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_fpfa00440_2" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpfa00440_1" > 
                <input>
                    <input bind="txtMasterPK" />
                </input> 
                <output>
        ...
        <tr style="height: 50%" id="tab_top">
            <td>
                <table style="width: 100%; height: 100%">
                    ...
                    <tr style="height: 99%">
                        <td colspan="11">
                            <gw:grid id='grdConfirm' header='SELECT|_PK|Status|Doc Date|Slip No|PL Center|Item Name|Approve|Cancel'
        ...
        <tr style="height: 50%" id="tab_bottom">
            <td>
                <table style="width: 100%; height: 100%">
                    ...
                    <tr style="height: 99%">
                        <td colspan="13">
                            <gw:grid id='grdApprove' header='_PK|Status|Doc Date|Slip No|PL Center|Item Name|Approve|Cancel'
