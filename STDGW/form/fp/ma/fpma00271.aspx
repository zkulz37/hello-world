...
%>
<head>
    <title>Attach file(s) list of Liquidation Slip</title>
</head>
...
<body>
	<!---------------------------------------------------------------->
    <gw:data id="data_fpma00271" onreceive="OnDataReceive(this)"> 
    	<xml> 
	        <dso  id="1" type="grid" parameter="0,4,5" function="<%=l_user%>lg_sel_fpma00271"  procedure="<%=l_user%>lg_upd_fpma00271">
	            <input>
...
<!---------------------------------------------------------------------->
<gw:image id="imgFile" table_name="<%=l_user %>TLG_MA_ADJ_SLIP_FILES" procedure="<%=l_user %>lg_upd_fpma00271_files" view="/binary/ViewFile.aspx"
