...
<head id="Head1" runat="server">
    <title>LIQUIDATION SLIP APPROVE</title>
</head>
...
function OnSearch(id)
{
    ...
    {
        case 'grdConfirm':
            data_fpma00280.Call('SELECT');
        break;
        
        case 'grdApprove':
            data_fpma00280_1.Call('SELECT')
        break;
    }
}
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        ...
        case 'pro_fpma00280_3' :
            alert(txtReturnValue.text);
            OnSearch('grdConfirm');   
        break;
        case'pro_fpma00280_4':
            alert(txtReturnValue.text);
            OnSearch('grdConfirm');
        break;
    }
...
<body>
    <!--------------------------------------------------------------------->
    <gw:data id="data_fpma00280" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_fpma00280"  >
    ...
    <!--------------------------------------------------------------------->
    <gw:data id="data_fpma00280_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_fpma00280_1"  >
    ...
    <!-------------------------------------Approve------------------------------>
    <gw:data id="pro_fpma00280_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpma00280" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_fpma00280_4" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_fpma00280_1" > 
                <input>
                    <input bind="txtArrayPOPK" /> 
                </input> 
                <output>
