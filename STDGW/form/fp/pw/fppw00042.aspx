...
<body>
	 <!------------------------------------------------------------------>
    <gw:data id="data_fppw00042" onreceive="OnDataReceive(this)"> 
	    <xml> 
		    <dso type="grid" parameter="0,1,2,3,4,5,6,7" function="<%=l_user%>lg_sel_fppw00042" procedure="<%=l_user%>lg_upd_fppw00042" > 
                                ...
                                <tr style="height: 1%">     
			 					...
			 					<tr style="height: 99%">
			                        <td colspan=11>			                          											
											...
											header='_PK|Date|Line|P/O No|Style Code|Style Name|W/I Qty|Spec'
