...
{	
    ...
    data = "<%=ESysLib.SetListDataSQL("select pk, grp_cd || ' - ' || grp_name from tlg_ie_item_group where del_if = 0  order by grp_cd ")%>||Select ALL";     
...
<body>
    ...
    <gw:data id="data_epcs00011" onreceive="OnReceiveData(this)"> 
        <xml> 
           <dso id="1" type="grid" function="lg_sel_epcs00011" > 
                  <input bind="idGrid" > 
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
                  </input> 
