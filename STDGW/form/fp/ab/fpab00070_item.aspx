...
<body>
    ...
    <gw:data id="data_fpab00070" onreceive="OnReceiveData(this)"> 
        <xml>                                                               
            <dso id="1" type="control" user="prod" function="<%=l_user%>lg_sel_fpab00070"  > 
                <inout> 
	 ...
	 <gw:data id="data_fpab00070_item" onreceive="OnReceiveData(this)"> 
        <xml>                                                               
            <dso id="1" type="list" user="prod" procedure="lg_lst_fpab00070_item"  > 
                <input> 
                    <input bind="txtUser" />  
                </input>
				<output> 
    ...
    <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_fpab00070_1" > 
                  <input bind="idGrid" >
				  	<input bind="lstLang" /> 
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
