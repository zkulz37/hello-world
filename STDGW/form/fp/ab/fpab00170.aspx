...
function BindingDataList()
{
    var data 
    //---------------------------------
    data = "<%=ESysLib.SetListDataSQL("select pk, grp_cd || '-' || grp_nm from tlg_it_itemgrp where del_if = 0 and use_yn = 'Y' order by grp_cd ")%>|ALL|Select ALL"; 
    lstGroup.SetDataText(data);
    lstGroup.value = 'ALL';
    //---------------------------------
    data = "<%=ESysLib.SetListDataSQL("select pk, wh_id || '-' || wh_name from tlg_IN_WAREHOUSE where del_if = 0 and use_yn='Y' order by wh_id ")%>|ALL|Select ALL"; 
