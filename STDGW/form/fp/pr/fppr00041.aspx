...
var G1_COMP_PK          = 0,
 ...
 function BodyInit()
 {
    System.Translate(document); 
     ...
     var p_pb_work_process_pk = "<%=Request.querystring("pb_work_process_pk")%>";
     
     txtOrdPlanPK.text = Number(p_pp_ordplan_pk);
     txtWPPK.text      = Number(p_pb_work_process_pk);
     //----------------------
     FormatGrid();
     //----------------------      
 } 
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_fppr00041" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="prod" function="<%=l_user%>lg_sel_fppr00041" > 
                <input> 
