...
<body  >
<gw:data id="dso_Color"   > 
        <xml> 
            <dso id="1" type="grid" function="prod.sp_sel_shim00011" > 
                <input>
                    <input bind="txtColor" />
                </input> 
                <output bind="idgrid" /> 
                                            ...
                                            <table border="0" width="100%" id="table2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="5%">
                                                        Color</td>
                                                    <td width="95%">
                                                        <gw:textbox id="txtColor" onenterkey="OnSearch()" text="" styles="width:100%" />
                                                    </td>
                ...
                <table align="top" cellspacing="0" cellpadding="0" border="0" style="width: 100%;
                    ...
                    <tr valign="top">
                        <td width="100%">
                            ...
                            <gw:grid id="idgrid" header="_No|Color Code|Color Name"
                                format="0|0|0" aligns="1|0|0" defaults="||" editcol="0|0|0"
                                widths="500|1500|2000" styles="width:100%; height:100%"
...
<gw:textbox id="txtaaa" styles="display:none; " />
</body>
</html>
