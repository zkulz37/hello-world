...
function OnPrint()
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/cl/rpt_shcl00050.rpt&export_pdf=Y&procedure=inv.sp_rpt_shcl00050&parameter=" + txtresult1.text+","+dtFromDate.value+","+dtToDate.value;                            
...
<body>
    <!--------------------------------------------------------------------------------------->
    <gw:data id="shcl00050_pro" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="inv.sp_pro_shcl00050" > 
                <input>
