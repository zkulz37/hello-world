...
function OnPrint()
{
     var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/pp/rpt_shpp00110.rpt&export_pdf=Y&procedure=prod.sp_rpt_shpp00110&parameter=" + lstSizeFrom.value + "," + lstSizeTo.value + "," + lsTypeCode.value + "," + rdType.value  ;                            
	 System.OpenTargetPage(url);
