...
<head id="Head1" runat="server">
    <title>Unprinted Products Stock Overview(Tr/Op)</title>
</head>
...
function BodyInit()
{
    var data="";
        ...
        data = "<%=ESysLib.SetListDataFUNC("SELECT COMM.f_logistic_code4('LGMF0040') FROM DUAL" )%>";    
        lsTransparentCode.SetDataText(data);
}

//==============================================================
function OnPrint()
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/pp/rpt_shpp00130.rpt&export_pdf=Y&procedure=prod.sp_rpt_shpp00130&parameter=" + lstSizeFrom.value + "," + lstSizeTo.value + "," +  lsTypeCode.value + "," + lsTypeCode.GetText().substring(lsTypeCode.GetText().indexOf("-")+1) + "," + lsTransparentCode.value + "," + lsTransparentCode.GetText().substring(lsTransparentCode.GetText().indexOf("-")+1) + "," + rdType.value;                            
                        ...
                        <td valign="middle" align="center">
                            <fieldset style="padding: 2; width: 50%">
                                ...
                                <table width="100%" cellpadding="1" cellspacing="2" border="0">
                                    ...
                                    <tr>
                                        <td style="width: 25%;white-space: nowrap" align="right">
                                            <b>Transparent/Opaque</b>
                                        </td>
                                        <td style="width: 60%" align="left">
                                            <gw:list id="lsTransparentCode" styles='width:100%' />
                                        </td>
                                    </tr>
                                    <tr>
                                        <td style="width: 25%" align="right">
