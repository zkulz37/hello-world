...
function OnPrint()
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/pp/rpt_shpp00230.rpt&export_pdf=Y&procedure=sale.sp_rpt_shpp00230&parameter="+ dtFromDate.value + "," + dtToDate.value  ;                            
	System.OpenTargetPage(url);
}
 //==============================================================
