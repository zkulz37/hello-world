...
function OnPrint()
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/pp/rpt_shpp00240.rpt&export_pdf=Y&procedure=prod.sp_rpt_shpp00240&parameter=" + dtFromDate.value + "," + dtToDate.value ;                            
	System.OpenTargetPage(url);
}
 //==============================================================
