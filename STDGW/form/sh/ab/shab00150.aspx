...
function BodyInit()
{
    ...
    idDeptRetric  ="<%=Request.QueryString("dept_condition")%>";
    txtDeptRetrict.text = idDeptRetric
...
function OnSelect()
{
    ...
    if (obj!=null)
    {
       var item = obj.text;
       rtnArr[0] = obj.oid;
       rtnArr[1] = item.substring(0,item.indexOf(" "));
       rtnArr[2] = item.substr(item.indexOf(" "));
...
<gw:data id="datDeptTree"   > 
        <xml> 
            <dso id="1" type="tree" function="prod.sp_sel_shab00150_org_tree" > 
                <input>
                    <input bind="lstCompany" /> 
                    <input bind="txtDept" /> 
                    <input bind="iduser_pk" /> 
                    <input bind="txtDeptRetrict" /> 
                </input> 
                <output bind="treDept" /> 
            </dso> 
        </xml> 
        ...
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                <tr>
                    ...
                    <td width="1%" align="right"><gw:imgBtn id="btnSearch" img="search"  alt="search" onclick="OnSearch()" /> </td>
                    <td width="1%" align="right"><gw:imgBtn id="btnSelect" img="select"  alt="Select" onclick="OnSelect()" /></td>
                </tr>
                <tr>
                    <td width="20%" align="left"><font color="black" ><b>Dept&nbsp;</b></font></td>
                    <td width="50%">
    ...
    <tr>
	    <td > 
	        <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                <tr>
                    <td>
	                    <gw:tree  id="treDept" ondblclick="treeItemOnclick()" style="width:100%; height:100%;overflow:auto;"  >
		                </gw:tree>  
		           </td>
		       </tr>
...
<gw:textbox id="txtDeptRetrict" styles="display:none"/>
</body>
</html>
