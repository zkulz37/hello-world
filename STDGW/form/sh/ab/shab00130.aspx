...
<body>
    <!------------------------------------------------------------------>
    <gw:data id="shab00130"> 
        <xml>                                                               
            <dso id="1" type="grid" user="prod" function="prod.sp_sel_shab00130_1"> 
                <input bind="grdLotNo" > 
                    <input bind="txtColor" /> 
                </input> 
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 98%">
            <td colspan="10">
                <gw:grid id='grdLotNo' header='Lot No|Inv Qty.'
