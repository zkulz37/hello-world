...
<gw:data id="datDeptTree"   > 
        <xml> 
            <dso id="1" type="tree" function="prod.sp_sel_shab00170_pl_tree" > 
                <input>
    ...
    <tr>
        <td>
            <table cellpadding="0" cellspacing="0" border="0" width="100%" >
                ...
                <tr>
                    <td width="20%" align="left"><font color="black" ><b>Cost center&nbsp;</b></font></td>
                    <td width="50%">
                         <gw:textbox id="txtPL" styles='width:100%' />
                    </td>
...
<gw:textbox id="txtPLPk" maxlen=100 styles='width:100%;display:none'   csstype=""/>
