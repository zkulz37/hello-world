...
{ 
    var datalstType = "<%=ESysLib.SetListDataSQLPara("select   code, code_nm from sale.lg_code a, sale.lg_code_group b where a.lg_code_group_pk = b.pk and b.group_id = 'LGMF0030' and a.use_if = 'Y' and a.del_if = 0 and b.del_if = 0 and a.CHA_VALUE1 = {0} order by a.def_yn desc, ord",request.QueryString("type") )%>";  
...
<body>
    <!--------------------------------------------------------------------------------------->
   <gw:data id="data_shab00070" onreceive="OnDataReceive(this)">
        <xml>
            <dso id="1" type="grid" function="PROD.sp_sel_shab00070">
        ...
        <tr>
            <td style="width: 100%" align="left" id="left">
                <table style="height: 100%; width: 100%"> 
                    ...
                    <tr style="height: 98%">
                        <td colspan="3">
                            <gw:grid id="grdSearch" header="_PK|Type No|Type Name|To Code|Tr/OP" format="0|0|0|0|0" aligns="0|0|0|0|0"
                                defaults="||||" editcol="0|0|0|0|0" widths="0|2000|2000|1500|2000" styles="width:100%;height:100%" autosize='T'
                                oncelldblclick="OnSelect()" param="0,1,2,3,4" />
                        </td>
                    </tr>
                </table>
            </td>
