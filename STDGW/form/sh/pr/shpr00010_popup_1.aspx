...
function OnSelect()
{
    ...
    {
        alert("Please select an Charger.");
        return ;
    }
    else
	{
...
<body  >
<gw:data id="dso_Charger"   > 
        <xml> 
            <dso id="1" type="grid" function="prod.sp_sel_shpr00010_1_popup" > 
                <input>
                                            ...
                                            <table border="0" width="100%" id="table2">
                                                <tr>
                                                    ...
                                                    <td align="right" width="5%">
                                                        Charger</td>
                                                    <td width="95%">
                                                        <gw:textbox id="txtCharger" onenterkey="OnSearch()" text="" styles="width:100%" />
                                                    </td>
                ...
                <table align="top" cellspacing="0" cellpadding="0" border="0" style="width: 100%;
                    ...
                    <tr valign="top">
                        <td width="100%">
                            ...
                            <gw:grid id="idgrid" header="No|Charger Id|Charger Name|_pk"
                                format="0|0|0|0" aligns="1|0|0|0" defaults="|||" editcol="0|0|0|0"
                                widths="500|1500|2000|0" styles="width:100%; height:100%"
