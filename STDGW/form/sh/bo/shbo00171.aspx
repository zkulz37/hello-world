...
<body>
    <!------------------------------------------------------------------>
    <gw:data id="shbo00171"> 
        <xml>                                                               
            <dso id="1" type="grid" user="prod" function="prod.sp_sel_shbo00171" > 
                <input> 
                    <input bind="txtBatch" /> 
            ...
            <td style="width: 100%" id="left">
                <table style="width: 100%; height: 100%">
                    ...
                    <tr style="height: 98%">
                        <td colspan="4">
                            <gw:grid id='grdBatch'
                                header='_pk|Date|Batch No|Batch Desc|Gelatin Qty.|Batch Qty'
                                format='0|4|0|0|0|0' aligns='0|0|0|0|3|3' defaults='|||||' editcol='0|0|0|0|0|0'
                                widths='0|1200|1500|2000|1500|1500' sorting='T' styles='width:100%; height:100%'
