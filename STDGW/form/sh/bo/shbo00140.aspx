...
function OnPrint()
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/bo/rpt_shbo00140.rpt&export_pdf=Y&procedure=PROD.sp_rpt_shbo00140&parameter=" + dtFrom.value + "," + dtTo.value ;              
...
<body>
    <!------------------------------------------------------------------>
    <gw:data id="shbo00140"> 
        <xml>                                                               
            <dso id="1" type="grid" user="prod" function="prod.sp_sel_shbo00140" > 
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 98%">
            <td colspan="10">
                <gw:grid id='grdDetail' header='_PK|Issue Date|Instructed Date|Batch No|Batch Qty|Batch Desc|Remark'
                    format='0|4|4|0|0|0|0' aligns='0|0|0|0|0|0|0' defaults='||||||' editcol='0|0|0|0|0|0|0'
                    widths='1000|1500|2000|1500|1500|2000|1000' sorting='T' styles='width:100%; height:100%' />
            </td>
        </tr>
    </table>
    <!------------------------------------------->
