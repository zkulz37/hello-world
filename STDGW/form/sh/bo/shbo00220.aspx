...
var l_box	    = "<%=Request.querystring("box_gu")%>";
...
function OnPopUp()
{
	var fpath = System.RootURL + "/form/sh/bo/shbo00220_popup.aspx?box_gu=" + rdoSTATUS.value;
	...
	if (object != null)
	{
		...
		dtFromDate.value		= object[1];	// inst_date
		dtToDate.value			= object[1];	// inst_date
		lstMachineNo.value		= object[2];	// machine_no
		dtIssuDate.value		= object[3];	// issu date
...
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/bo/rpt_shbo00220.rpt&export_pdf=Y&procedure=prod.sp_rpt_shbo00220&parameter=" + txtMasterPK.text+"," +rdoSTATUS.value;
...
<body>
    <gw:data id="data_shbo00220_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="prod.sp_pro_shbo00220" > 
                <input>
                    <input bind="txtLotNo"/> 
