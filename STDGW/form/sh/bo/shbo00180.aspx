...
<head id="Head1" runat="server">
    <title>TiO2 Solution Preparation Instruction and Record Issue</title>
</head>
...
{
    var url = System.RootURL + "/system/ReportEngine.aspx?file=sh/bo/rpt_shbo00180.rpt&export_pdf=Y&procedure=prod.sp_rpt_shbo00180&parameter=" + txtBatchNo.text + "," + dtIssueDate.value + "," + emp_pk + "," + user_id ;              
	System.OpenTargetPage(url); 
}
//===============================================================
function OnPrint()
{   
    data_shbo00180_1.Call();
}
//==============================================================
 function OnPopUp(obj)
{
    ...
    { 
        case 'BatchNo':
            var fpath = System.RootURL + "/form/sh/bo/shbo00181.aspx";
...
<body>
    <!--------------------------------------------------------------------------------------->
     <gw:data id="data_shbo00180_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="prod.sp_pro_shbo00180" > 
                <input>
