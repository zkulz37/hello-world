...
function BodyInit()
{
    ...
    dso_shbo00070_colpack.Call("SELECT");
	//-------------------------
...
<body>
    <gw:data id="dso_shbo00070_colpack" onreceive="OnReceiveData(this)"> 
    <xml> 
           <dso id="1" type="grid" function="PROD.sp_sel_shbo00070_colpack" > 
                  <input bind="idGrid" > 
