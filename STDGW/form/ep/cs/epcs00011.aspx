...
{	
    ...
    data = "<%=ESysLib.SetListDataSQL("select pk, grp_cd || ' - ' || grp_name from imex.tie_item_group where del_if = 0 and group_type = 2 order by grp_cd ")%>||Select ALL";     
...
<body>
    ...
    <gw:data id="data_epcs00011" onreceive="OnReceiveData(this)"> 
        <xml> 
           <dso id="1" type="grid" function="IMEX.sp_sel_epcs00011" > 
                  <input bind="idGrid" > 
                    <input bind="lstGroup" />
                    <input bind="txtItem" />
                  </input> 
