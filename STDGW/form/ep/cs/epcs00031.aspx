...
<head>
    <title>Pop Up Get Many MAT</title>
</head>
<%  
...
//    cboStatus.value = "";
    ...
    idGrid.SetComboFormat(G1_MAT_STATUS,data);
    idGrid2.SetComboFormat(G1_MAT_STATUS,data);
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_fpab00031" onreceive="OnReceiveData(this)"> 
        <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_epcs00031" > 
                  <input bind="idGrid" > 
                    <input bind="txt_CusCode" />
                    <input bind="txt_ComCode" />
                    <input bind="txt_MatCode" />
                    <input bind="txt_MatName" />
                  </input> 
                <output bind="idGrid" /> 
            </dso> 
        </xml> 
    ...
    <table style="height: 100%; width: 100%">
        <tr style="height: 1%">
            ...
            <td style="width: 20%">
                <gw:textbox id="txt_MatCode" styles="width:100%" onenterkey="OnSearch(1)" csstype="mandatory" />
            </td>
            <td style="width: 5%" align="right">
               Name
            </td>
            <td style="width: 20%">
                <gw:textbox id="txt_MatName" styles="width:100%" onenterkey="OnSearch(1)" />
            </td>
