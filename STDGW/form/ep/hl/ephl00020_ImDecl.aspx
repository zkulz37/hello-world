...
//        <%=ESysLib.SetGridColumnComboFormat("grdDeclList", 14, "select a.CODE,  a.CODE_NM from TCO_ABCODE a, TCO_ABCODEGRP b where TCO_ABCODEGRP_PK=b.pk and b.id='ACCR0020' and a.del_if=0 and b.del_if=0 order by a.CODE ")%>; 
    ...
    function OnDataReceive(obj)
    {
        switch(obj.id)
        {
            case 'dat_ephl00020_1':
               // dat_ephl00020_2.Call('SELECT');
            break;
...
<body>
<!------------------------Get Contract List -------------------------------------->
<gw:data id="dat_ephl00020_1"  onreceive="OnDataReceive(this)" > 
    <xml> 
        <dso id="1" type="grid" parameter="0,2,8" function="imex.sp_sel_ephl00020_1" > 
    ...
    <form id="form1" runat="server">
        <table cellpadding=0 cellspacing=0 style="width: 100%; height: 100%" border=0>
            <tr style="height: 1%">
                ...
                <td width="1%" ><gw:imgbtn id="btnSearch" img="search" alt="Search" text="Search" onclick="dat_ephl00020_1.Call('SELECT');" /></td>        
            ...
            <tr style="height: 1%">
                <td>Status</td>
                <td colspan="3">
                    <gw:radio id="radStatus" value="0" styles="width:100%" onchange="dat_ephl00020_1.Call('SELECT');"> 
            ...
            <tr style="height: 96%">
                <td colspan="16">
                    ...
                    <gw:grid id='grdDeclList'
                        header='_Pk|No|Select|Customer|Decl. Type|Decl. No|Reg. Date|Import Date|Close Y/N|Close Date|Trans. Curr|Ex. Rate|Trans. Amt|Booking Amt|Description|_bus_partner_pk'
