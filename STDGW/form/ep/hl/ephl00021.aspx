...
<script language="javascript" type="text/javascript">
   ...
   function BodyInit()
     ...
     {   
         ...
         var data2 = "<%=ESysLib.SetListDataFUNC("SELECT COMM.f_logistic_code('LGCM0100') FROM DUAL")%>|ALL|Select All";  //currency 
         var data3 = "<%=ESysLib.SetListDataFUNC("SELECT COMM.f_logistic_code('IEEX0030') FROM DUAL")%>|ALL|Select All";  
...
<body>
<!------------------------Get Contract List -------------------------------------->
<gw:data id="dat_ephl00021_1"  onreceive="OnDataReceive(this)" > 
    <xml> 
        <dso id="1" type="grid" function="IMEX.sp_sel_ephl00021"  > 
    ...
    <form id="form1" runat="server">
        <table cellpadding=0 cellspacing=0 style="width: 100%; height: 100%" border=0>
            <tr style="height: 1%" >
                ...
                <td width="1%" ><gw:imgbtn id="btnSearch" img="search" alt="Search" text="Search" onclick="dat_ephl00021_1.Call('SELECT');" /></td>        
            ...
            <tr style="height: 1%">
                <td>Status</td>
                <td colspan="3">
                    <gw:radio id="radStatus" value="0" styles="width:100%" onchange="dat_ephl00021_1.Call('SELECT');"> 
