...
<body>
    ...
    <gw:data id="data_epap00020" onreceive="OnDataReceive(this)"> 
	    <xml> 
		    <dso type="grid" function="<%=l_user%>lg_sel_epap00020" parameter="0,1,2,3,4,5" procedure="<%=l_user%>lg_upd_epap00020"   > 
			    <input  > 
    ...
    <gw:data id="pro_epap00020" onreceive="OnDataReceive(this)"> 
        <xml>                                                               
             <dso id="1" type="process"  procedure="<%=l_user%>lg_pro_epap00020"> 
                <input> 
			        <input bind="lstTranStyle" />
			        <input bind="dtFrom" />
			        <input bind="dtTo" />  		
