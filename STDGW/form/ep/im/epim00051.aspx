...
<head runat="server">
    <title>Pop Up Import Declaration List</title>
</head>
...
<body>
    <!----------------------------------------------------------------------------------------->
    <gw:data id="data_epim00051" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" parameter="0,3,9" function="<%=l_user%>lg_sel_epim00051" > 
    ...
    <!------------------------------------------------------------------>
    <gw:data id="pro_epim00051" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epim00051" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_epim00051_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epim00051_1" > 
                <input>
                    <input bind="txtMasterPK" /> 
                </input> 
                <output>
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 98%">
            <td colspan="10">
                <gw:grid id='grdDetail' header='_PK|_Supplier ID|Supplier Name|Decla Date|Decla Seq|Decla No|Contract No|Invoice No|Tr CCY|Tr Amount|Book CCY|Ex. Rate|Book Amount'
