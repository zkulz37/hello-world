...
var G2_3_DEPT_NAME       	= 0,
 ...
 function OnReport(pos)
 {
	...
	{
		case 'FOSE01':		 
				var url = System.RootURL + '/reports/ep/bp/rpt_epbp00390_FOSE01.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 		 	
		break;
		
		case 'FOSE02':		 
				var url = System.RootURL + '/reports/ep/bp/rpt_epbp00390_FOSE02.aspx?p_from_dt='+ dtFromTab2.value +'&p_to_dt='+dtToTab2.value +'&p_wh_type=' + lstWHTypeTab2.value +'&p_wh_pk=' + lstWarehouseTab2.value +'&p_item=' + txtItemTab2.text +'&p_partner_pk=' + txtPartnerPKTab2.text +'&p_partner_group_pk=' + txtPartnerGroupTab2.text;
		   
				System.OpenTargetPage(url); 		 	
		break;

		case 'FOSE03':		 
				var url = System.RootURL + '/reports/ep/bp/rpt_epbp00390_FOSE03.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 			 	
		break; 	

		case 'FOSE04':		 
				var url = System.RootURL + '/reports/ep/bp/rpt_epbp00390_FOSE04.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
		   
				System.OpenTargetPage(url); 	 		 	
		break;

		case 'FOSE05':		 
				var url = System.RootURL + '/reports/ep/bp/rpt_epbp00390_FOSE05.aspx?p_from_dt='+ dtFromTab1.value +'&p_to_dt='+dtToTab1.value +'&p_wh_type=' + lstWHTypeTab1.value +'&p_wh_pk=' + lstWarehouseTab1.value +'&p_group_pk=' + lstGroupTab1.value +'&p_item=' + txtItemTab1.text +'&p_partner_pk=' + txtPartnerPKTab1.text ;
...
function OnPopUp(pos)
{
	...
	{		 
		case 'Report_Tab1':			 			
			var path = System.RootURL + '/form/ep/bp/epbp00393.aspx';
			var object = System.OpenModal( path ,400, 300 ,  'resizable:yes;status:yes',this);					 
		break; 

		case 'Report_Tab2':			 			
			var path = System.RootURL + '/form/ep/bp/epbp00394.aspx';
			var object = System.OpenModal( path ,400, 300 ,  'resizable:yes;status:yes',this);					 
		break; 		
	}	 
} 
...
<body>   
    ...
    <gw:data id="data_epbp00390_1_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_epbp00390_1_1" > 
    ...
    <gw:data id="data_epbp00390_1_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_epbp00390_1_2" > 
    ...
    <gw:data id="pro_epbp00390_1_3" onreceive="OnDataReceive(this)">
        <xml>
            <dso  type="list" procedure="<%=l_user%>lg_pro_EPBP00390_1_3" >
                <input>
                    <input bind="lstWHTypeTab1" />
                </input>
                <output>
    ...
    <gw:data id="data_epbp00390_2_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_epbp00390_2_1" > 
    ...
    <gw:data id="data_epbp00390_2_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_epbp00390_2_2" > 
    ...
    <gw:data id="data_epbp00390_2_3" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_epbp00390_2_3" > 
