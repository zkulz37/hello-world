...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POApprove':
            if ( grdApprove.row > 0 )
            {
                var path = System.RootURL + '/form/ep/bp/epbp00251.aspx?trans_pk=' + grdApprove.GetGridData( grdApprove.row, G1_PK)+'&action=APPROVE';
         ...
         case 'POCancel':
            if ( grdCancel.row > 0 )
            {
                var path = System.RootURL + '/form/ep/bp/epbp00251.aspx?trans_pk=' + grdCancel.GetGridData( grdCancel.row, G2_PK)+'&action=CANCEL';
                var object = System.OpenModal( path, 800, 600, 'resizable:yes;status:yes', this);
                if ( object != null )                    
                {                
			    OnSearch('grdApprove');
...
{    
    ...
    var url =System.RootURL + "/reports/ds/re/rpt_epbp00250.aspx?dtFrom="+txtDateFrom.text+"&dtTo="+txtDateTo.text ;
...
<body>
    ...
    <gw:data id="data_epbp00250" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_epbp00250"  >
    ...
    <gw:data id="data_epbp00250_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_epbp00250_1"  >
    ...
    <gw:data id="pro_epbp00250" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epbp00250" > 
                <input>
    ...
    <gw:data id="pro_epbp00250_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epbp00250_3" > 
                <input>
                    <input bind="txtInComePK" />
    ...
    <gw:data id="pro_epbp00250_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epbp00250_1" > 
                <input>
                    <input bind="txtInComePK" /> 
                </input> 
                <output>
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:icon id="btnViewDetail" img="2" text="View Detail" onclick="OnPopUp('POApprove')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="10">
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:icon id="btnViewDetail1" img="2" text="View Detail" onclick="OnPopUp('POCancel')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="12">
