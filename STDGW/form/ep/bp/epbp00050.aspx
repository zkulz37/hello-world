...
%>
 ...
 { 
   ...
   <%=ESysLib.SetGridColumnComboFormat("grdBLContainer", 6, "SELECT   a.code, a.code_nm FROM sale.lg_code a, sale.lg_code_group b WHERE b.GROUP_ID = 'LGCM0130' AND a.lg_code_group_pk = b.pk AND a.use_if = 'Y' AND a.del_if = 0 AND b.del_if = 0 ORDER BY a.code")%>; 
...
<body>
 ...
 <gw:data id="datBLContainerMaster"  onreceive="" > 
        <xml>                                   
             <dso id="1" type="grid"  parameter="0,1,2,3,4,5,6,11,12,13"  function="<%=l_user%>lg_sel_blcontainer"  procedure="<%=l_user%>lg_upd_blcontainer"> 
...
<!-- function="comm.sp_sel_blcontainer"  procedure="comm.sp_upd_blcontainer" -->
 <gw:data id="datBLContainerDetail"  onreceive="" > 
        <xml>                                   
             <dso id="1" type="grid"  parameter="0,1,2,3,9,14,15,16,17"  function ="<%=l_user%>lg_sel_blcontainerd" procedure="<%=l_user%>lg_upd_blcontainerd"> 
                            ...
                            <tr>
                                    ...
                                    <table border="0" cellpadding="0" cellspacing="0">
                                        <tr>
                                            ...
                                            <td width="5%"><gw:imgBtn id="ibtnResetVendor" img="reset" alt="Reset Supplier" text="Reset Supplier" onclick="onResetVendor()" /></td>
                                        </tr>
                                    </table>
                                    <td width="10%"></td>
                                    <td width="20%">&nbsp;</td>
