...
<head>
    <title>Pop Up Export Invoice List</title>
</head>
<%  
...
//=============================================================================
 ...
 {    
        ...
        dtToDate.SetDataText(System.AddDate(dtToDate.GetData(),+30));
...
<body>
    <!----------------------------------------------------------------------------------------->
    <gw:data id="data_epex00031" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" parameter="0,3,9" function="<%=l_user%>lg_sel_epex00031" > 
    ...
    <!------------------------------------------------------------------>
    <gw:data id="pro_epex00031" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epex00031" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_epex00031_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epex00031_1" > 
                <input>
                    <input bind="txtMasterPK" /> 
                </input> 
                <output>
    ...
    <table style="width: 100%; height: 100%">
        ...
        <tr style="height: 1%">
            <td style="width: 5%" align="right">
				<gw:list id="idList" styles="color:blue;width:100%" value="I" />
			</td>
