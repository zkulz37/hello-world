...
<script>
 ...
 function BodyInit()
 {
	 ...
	 txtPartnerPK.text = callerWindowObj.txtCustPK.text;
     lblPartner.text   = callerWindowObj.txtCustID.text + " - " + callerWindowObj.txtCustName.text;
 ...
 function OnDataReceive(po_oData)
 {
      ...
      switch (po_oData.id)         
      {
        case "pro_epex00039" :
		    ...
		    {
		        data_epex00039.StatusUpdate();
		        data_epex00039_1.Call('SELECT');
		    }
			else
		    {
		        data_epex00039.Call('SELECT')
		    }
        break;       		        
    }
 }
...
<body> 
     <!-------------------------------------check exist------------------------------->
    <gw:data id="pro_epex00039" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epex00039" > 
                <input>
     ...
     <!------------------------------------------------------------------>
    <gw:data id="data_epex00039" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="control" function="<%=l_user%>lg_sel_epex00039" parameter="0,1,2,3,4,5,6,7" procedure="<%=l_user%>lg_upd_epex00039" > 
                <input>
     ...
     <!------------------------------------------------------------------>
    <gw:data id="data_epex00039_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="control" function="<%=l_user%>lg_sel_epex00039_1" > 
                <input>
                    <inout bind="txtItemPK" />
                    <inout bind="txtItemCode" />
                    <inout bind="txtItemName" />
