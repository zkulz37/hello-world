    ...
    switch(pos)
    {
         case 'item':
            if(grdItem.row>0)
            {
                ...
                {
                    var path = System.RootURL + '/form/ep/ex/epex00091.aspx';
...
<body>
    <!--------------------------------------------------------------------->
    <gw:data id="data_epex00090" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="lg_sel_epex00090" parameter="0,1,2,3" procedure="lg_upd_epex00090" >
                <input bind="grdDecl" >
                    <input bind="dtFrom1" />
                    <input bind="dtTo1" />                
    ...
    <gw:data id="data_epex00090_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="lg_sel_epex00090_1" parameter="0,1,2,3,4,5,6,7,8" procedure="lg_upd_epex00090_1" >
                <input bind="grdItem" >
        ...
        <tr style="height: 50%" id="tab_bottom">
            <td>
                <table style="width: 100%; height: 100%">
                    ...
                    <tr style="height: 99%">
                        <td colspan="4">
                            <gw:grid id='grdItem' header='_PK|_TLG_IE_EX_DECL_M_PK|_ITEM_PK|Item Code|Item Name|Qty|Uom|Price|Amount'
