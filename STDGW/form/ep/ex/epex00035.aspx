...
<body>
    <!-------------------------------------------------------------------->
    <gw:data id="data_epex00035" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_epex00035"  > 
                <input bind="grdSO" >
			        <input bind="dtFrom" />
			        <input bind="dtTo" />
    ...
    <!--------------------------------------------------------------------->
    <gw:data id="data_epex00035_2" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid"  function="<%=l_user%>lg_sel_epex00035_2"  > 
    ...
    <!--------------------------------------------------------------------->
    <gw:data id="pro_epex00035" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="<%=l_user%>lg_pro_epex00035" > 
                <input>
                    <input bind="txtSOPK" /> 
                </input>                 
                <output>                 
