...
//        <%=ESysLib.SetGridColumnComboFormat("grdDeclList", 14, "select a.CODE,  a.CODE_NM from TCO_ABCODE a, TCO_ABCODEGRP b where TCO_ABCODEGRP_PK=b.pk and b.id='ACCR0020' and a.del_if=0 and b.del_if=0 order by a.CODE ")%>; 
    ...
    function OnDataReceive(obj)
    {
        switch(obj.id)
        {
            case 'dat_epgd00040_1':
                dat_epgd00040_2.Call('SELECT');
            break;
            case 'dat_epgd00040_2':
...
<body>
<!------------------------Get Contract List -------------------------------------->
<gw:data id="dat_epgd00040_1"  onreceive="OnDataReceive(this)" > 
    <xml> 
        <dso id="1" type="grid" parameter="0,2,9" function="imex.sp_sel_ex_declaration_inquiry"   procedure="imex.sp_upd_tex_decl_inquiry "> 
...
<!------------------------Total -------------------------------------->
<gw:data id="dat_epgd00040_2"  onreceive="OnDataReceive(this)" > 
    <xml> 
    ...
    <form id="form1" runat="server">
        <table cellpadding=0 cellspacing=0 width="100%" border=0>
            <tr>
                ...
                <td width="2%" ><gw:imgbtn id="btnSearch" img="search" alt="Search" text="Search" onclick="dat_epgd00040_1.Call('SELECT');" /></td>        
            ...
            <tr>
                <td>Status</td>
                <td colspan="3">
                    <gw:radio id="radStatus" value="0" styles="width:100%" onchange="dat_epgd00040_1.Call('SELECT');"> 
            ...
            <tr>
                <td colspan="16">
                    <gw:grid id='grdDeclList'
                        ...
                        widths='0|600|1200|2500|1500|1500|1200|1000|1200|1200|1500|1500|2000|2000|2000'
                        sorting='T'
