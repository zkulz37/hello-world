...
<body>
    <!----------------------------------------------------------------------------------------->
    <gw:data id="data_epex00101" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" parameter="0,3,9" function="<%=l_user%>lg_sel_epex00101" > 
    ...
    <!------------------------------------------------------------------>
    <gw:data id="pro_epex00101" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epex00101" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_epex00101_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_epex00101_1" > 
                <input>
                    <input bind="txtMasterPK" /> 
                </input> 
                <output>
