...
<script language="javascript" type="text/javascript">
   function BodyInit()
    ...
    function OnDataReceive(obj)
    {
        switch(obj.id)
        {
            case 'dat_epei00040_1':
                dat_epei00040_2.Call('SELECT');
            break;
            case 'dat_epei00040_2':
    ...
    function onPrint()
    {
        var  url= System.RootURL + "/reports/ep/ei/rpt_epei00040_inquiry.aspx?" + "company_pk=" + cboCompany.value + "&vendor_pk=" + txtCusPK.text 
...
<!------------------------Total -------------------------------------->
<gw:data id="dat_epei00040_2"  onreceive="OnDataReceive(this)" > 
    <xml> 
    ...
    <form id="form1" runat="server">
        <table cellpadding=0 cellspacing=0 width="100%" border=0>
            <tr>
                ...
                <td width="2%"></td>
                <td width="6%" align="right"><gw:imgbtn id="btnSearch" img="search" alt="Search" text="Search" onclick="dat_epei00040_1.Call('SELECT');" /></td>        
            ...
            <tr>
                <td>Status</td>
                <td colspan="3">
                    <gw:radio id="radStatus" value="1" styles="width:100%" onchange="dat_epei00040_1.Call('SELECT');"> 
