...
//-----------------------------------------------------------------------------------
    ...
    {	
	    var t=new Date()
	    var url =  System.RootURL + "/form/ep/hd/ephd00010_searchidcode.aspx?id=" + scode;
	    ajax_test = null;
...
<gw:data id="dat_epac00010_1"  onreceive="OnDataReceive(this)" > 
    <xml> 
        <dso type="control" parameter="0,1,2,5,6,7,8,9,10,11,12,15,16,17,18,19,20,21,22,23" function="imex.sp_sel_tex_order_ship_paid"  procedure="imex.sp_upd_tex_order_ship_paid"> 
            <inout>     
