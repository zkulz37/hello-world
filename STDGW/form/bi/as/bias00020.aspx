...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POConfirm':
            if ( grdConfirm.row > 0 )
            {
                var path = System.RootURL + '/form/bi/as/bias00021.aspx?type=APPROVE&trans_pk=' + grdConfirm.GetGridData( grdConfirm.row, G1_TRANS_PK);
         ...
         case 'POApprove':
            if ( grdApprove.row > 0 )
            {
                    var path = System.RootURL + '/form/bi/as/bias00021.aspx?type=CANCEL&trans_pk=' + grdApprove.GetGridData( grdApprove.row, G2_TRANS_PK);
                    var object = System.OpenModal( path, 1000, 600, 'resizable:yes;status:yes', this);
...
<body>
    ...
    <gw:data id="pro_bias00020_out_lst" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="<%=l_user%>lg_sel_bias00020_3" > 
                <input>
    ...
    <gw:data id="pro_bias00020_in_lst" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="list" procedure="<%=l_user%>lg_sel_bias00020_4" > 
                <input>
                    <input bind="txtUser_PK" /> 
                </input> 
                <output>
    ...
    <gw:data id="data_bias00020" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_bias00020"  >
    ...
    <gw:data id="data_bias00020_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_bias00020_1"  >
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:checkbox id="chkUser2" styles="color:blue" defaultvalue="Y|N" value="Y" onchange="OnSearch('grdConfirm')">User</gw:checkbox>
                        </td>
