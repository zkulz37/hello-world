...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POConfirm':
            if ( grdConfirm.row > 0 )
            {
                var path = System.RootURL + '/form/bi/as/bias00071.aspx?type=APPROVE&trans_pk=' + grdConfirm.GetGridData( grdConfirm.row, G1_TRANS_PK);
         ...
         case 'POApprove':
            if ( grdApprove.row > 0 )
            {
                    var path = System.RootURL + '/form/bi/as/bias00071.aspx?type=CANCEL&trans_pk=' + grdApprove.GetGridData( grdApprove.row, G2_TRANS_PK);
                    var object = System.OpenModal( path, 1000, 600, 'resizable:yes;status:yes', this);
...
<body>
    ...
    <gw:data id="data_bias00070" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_bias00070"  >
    ...
    <gw:data id="data_bias00070_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_bias00070_1"  >
