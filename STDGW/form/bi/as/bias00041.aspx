        ...
        <tr style="height: 70%">
            <td style="width: 100%" align="center">
                <gw:radio id="radType" value="0" styles="width:100%"> 
                    ...
                    <span value="1">Stock Exchange (Type 2)</span> <br/>
                    <span value="2">Stock Exchange (Type 3)</span> <br/>
                    <span value="3">Stock Exchange (Type 4)</span> <br/>                                              
                    <span value="4">Stock Exchange (Type 5)</span> <br/>
                </gw:radio>
            </td>
        </tr>
    </table>
