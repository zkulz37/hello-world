...
<body>  
    ...
    <gw:data id="pro_bimc00110" onreceive="OnDataReceive(this)"> 
        <xml>                                                               
             <dso id="1" type="process"  procedure="<%=l_user%>lg_pro_bimc00110"> 
                <input>
					<input  bind="lstWH" />
					<input  bind="lstDept" />
			        <input	bind="dtFrom"	/>	
    ...
    <gw:data id="data_bimc00110" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" parameter ="0,1,2,3,4" function="<%=l_user%>lg_sel_bimc00110" procedure="<%=l_user%>lg_upd_bimc00110"> 
