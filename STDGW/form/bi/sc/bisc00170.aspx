...
function OnPopUp(pos)
{
	switch(pos)
	{
		case 'Report':
		        ...
		        var path = System.RootURL + '/form/bi/sc/bisc00171.aspx';
...
{    
	 ...
	 {
	 	case 'DR01' :
			 var url = System.RootURL + "/reports/bi/sc/rpt_bisc00171.aspx?p_lang=" + lstLang.value + "&p_wh_name=" + lstWarehouse.GetText() + "&p_wh_pk=" + lstWarehouse.value + "&p_item_group_pk=" + lstGroup.value + "&p_item=" + txtItem.text + "&p_date=" + txtDate.value + "&p_type=" + lstType.value ;
		     System.OpenTargetPage(url); 			
		break;
		
		case 'SG01' :
			 var url = System.RootURL + "/reports/bi/sc/rpt_bisc00171_SG01.aspx?p_lang=" + lstLang.value + "&p_wh_name=" + lstWarehouse.GetText() + "&p_wh_pk=" + lstWarehouse.value + "&p_item_group_pk=" + lstGroup.value + "&p_item=" + txtItem.text + "&p_date=" + txtDate.value + "&p_type=" + lstType.value ;
		     System.OpenTargetPage(url); 		
		break;
		
		case 'ST01' :
			 var url = System.RootURL + "/reports/bi/sc/rpt_bisc00171_ST01.aspx?p_lang=" + lstLang.value + "&p_wh_name=" + lstWarehouse.GetText() + "&p_wh_pk=" + lstWarehouse.value + "&p_item_group_pk=" + lstGroup.value + "&p_item=" + txtItem.text + "&p_date=" + txtDate.value + "&p_type=" + lstType.value ;
		     System.OpenTargetPage(url); 		
		break;
		
		case 'ST02' :
			 var url = System.RootURL + "/reports/bi/sc/rpt_bisc00171_ST02.aspx?p_lang=" + lstLang.value + "&p_wh_name=" + lstWarehouse.GetText() + "&p_wh_pk=" + lstWarehouse.value + "&p_item_group_pk=" + lstGroup.value + "&p_item=" + txtItem.text + "&p_date=" + txtDate.value + "&p_type=" + lstType.value ;
		     System.OpenTargetPage(url); 		
		case 'ST03' :
			 var url = System.RootURL + "/reports/bi/sc/rpt_bisc00171_ST03.aspx?p_lang=" + lstLang.value + "&p_wh_name=" + lstWarehouse.GetText() + "&p_wh_pk=" + lstWarehouse.value + "&p_item_group_pk=" + lstGroup.value + "&p_item_group_nm=" + encodeURI(lstGroup.GetText()) + "&p_item=" + txtItem.text + "&p_date=" + txtDate.value + "&p_type=" + lstType.value + "&p_wh_type=" + lstWHType.value ;
		     System.OpenTargetPage(url); 	
		break;		
	 }
...
<body>
    ...
    <gw:data id="pro_bisc00170" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="list" procedure="<%=l_user%>lg_pro_bisc00170" > 
                <input>
    ...
    <gw:data id="data_bisc00170_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" parameter="1,2,3,4,5,6,7,8,9" function="<%=l_user%>lg_SEL_bisc00170_1"  >
                <input bind="grdINOUT" >
					<input bind="lstLang" />					
					<input bind="lstWHType" />               
    ...
    <gw:data id="data_bisc00170" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" parameter="1,2,3,4,5,6,7,8,9" function="<%=l_user%>lg_SEL_bisc00170"  >
