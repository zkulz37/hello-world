  ...
  if(check_init==1)
    {
        switch(pos)
        {
		    ...
		    case 'SLIP_SEQ':	
			    var path = System.RootURL + '/form/fp/ab/fpab00740.aspx?table_name=TLG_ST_INCOME_M';
...
function OnGridCellDoubleClick(oGrid)
{
      ...
      {		        
            case "grdDetail" :
                 ...
                 {
                      var path = System.RootURL + '/form/fp/ab/fpab00770.aspx?p_table_pk=' + grdDetail.GetGridData( event_row, G1_DETAIL_PK ) + '&p_table_name=TLG_ST_INCOME_D&p_io_type=I'  ;
                      var object = System.OpenModal( path , 800 , 600,  'resizable:yes;status:yes');                      					  
                 }
            break;             
      }         
...
function OnReport(pos)
{
    switch(pos)
    {
		...
		case 'ST02':
            var url =System.RootURL + '/reports/bi/ni/rpt_bini00030_ST02.aspx?master_pk=' + txtMasterPK.text ;
	        window.open(url, "_blank"); 
        break;
		...
		case '6':
            var url =System.RootURL + '/reports/bi/ni/rpt_bini00030_kb01.aspx?master_pk=' + txtMasterPK.text ;
	        window.open(url, "_blank"); 
        break;
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="dat_lg_pro_get_ext_rate" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_get_ext_rate" > 
                <input>
                    <input bind="dtVoucherDate" />
                    <input bind="lstCurrency" />
                    <input bind="txtExtType" />    
                </input> 
                <output>
                ...
                <table style="width: 100%; height: 100%">
                    <tr style="height: 1%">
                        <td align="right" style="width: 5%; white-space: nowrap">
							<a title="Slip No" onclick="OnPopUp('SLIP_SEQ')" href="#tips" style="color: #0000ff">
                                <b>Slip No</b></a>								                            
                        </td>
                        <td style="width: 30%">
                    ...
                    <tr style="height: 1%">
                        ...
                        <td>
                            <gw:list id="lstCurrency" styles="width:100%" value="USD" onchange="onGetRate()" />
                        </td>
                        <td colspan="10">
                            ...
                            <table style="width: 100%; height: 100%">
                                <tr>
                                    ...
                                    <td align="right" style="width: 1%">
									 ...
									 <td align="right" style="width: 1%">
                                        <gw:icon id="idBtnFreeItem" img="2" text="ITEM/SPEC" styles='width:100%' onclick="OnAddNew('ITEM_SPEC')" />
                                    </td>
                                    <td align="right" style="width: 1%">
...
<!--------------------------------------------------------------------------------->
 ...
 <gw:textbox id="txtExtType"  styles='width:100%;display:none'/> 
