...
//===============================================================================
function On_Change(){
	data_bico20071_wdays.Call();
}

function OnProcess(){
	if(confirm('Are you sure to process!')){
		data_bico20071_dat.Call();
	}
}
</script>
...
<body>
    ...
    <gw:data id="data_bico20070" onreceive="OnDataReceive(this)"> 
        <xml>                                                               
            <dso id="1" type="grid"  parameter="" function="<%=l_user%>lg_sel_bico20071"> 
                <input> 
                    <input bind="dtFrom" />
    ...
    <!------------------------------------------------------------------>
	<gw:data id="data_bico20071_wdays" onreceive="OnDataReceive(this)"> 
		<xml> 
			<dso type="process" procedure="lg_sel_bico20071_wdays" > 
				<input>
					<input bind="dtFrom" /> 
					<input bind="txtCompanyPK" />
				</input> 
				<output>
					<output bind="txtWDays" />
				</output>
			</dso> 
		</xml> 
	</gw:data>
	<!------------------------------------------------------------------>
	<gw:data id="data_bico20071_dat" onreceive="OnDataReceive(this)"> 
		<xml> 
			<dso type="process" procedure="lg_sel_bico20071_dat" > 
				<input>
					<input bind="dtFrom" /> 
					<input bind="txtCompanyPK" />
				</input> 
    ...
    <table style="width: 100%; height: 100%">
        <tr style="height: 2%">
            ...
            <td style="width: 15%" align="left">
                <gw:datebox id="dtFrom" lang="1" type="month" onchange="On_Change()" />               
            </td>
			<td style="width: 10%" align="left">
				<gw:textbox id="txtWDays" />
			</td>	
            <td style="width: 10%;white-space:nowrap" align="left">Working Days</td>            
			<td style="width:40%">&nbsp;</td>
			<td style="width: 10%" align="right">
				<td><gw:icon id="btnProcess" text="Process" onclick="OnProcess()" /></td>
			</td>
            <td style="width: 1%" align="right">
                <gw:imgbtn img="search" alt="Search" id="btnSearch" onclick="data_bico20070.Call('SELECT')" />
            </td>
            <td style="width: 1%" align="right">
                <gw:imgbtn img="new" alt="New" id="btnAddNew" onclick="OnAddNew('grdDetail')" style="display:none;" />
            </td>
            <td style="width: 1%" align="right">
