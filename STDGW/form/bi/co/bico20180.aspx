...
function OnClick(obj){
	switch(obj){
		case "new":
			...
			var aValue  = System.OpenModal(  fpath ,750 , 500 , 'resizable:yes;status:yes');
		break;
	}
}
    ...
    <table style="width: 100%; height: 100%">
        <tr style="height: 2%">
            ...
            <td style="width: 30%" align="left">
			   <gw:datebox id="dtFrom" type="month" lang="1" />~<gw:datebox id="dtTo" type="month" lang="1" />
            </td>
            <td style="width: 15%" align="right">
				<table style="height: 100%;width:1%" border="0">
					<tr>
						...
						<td width="1%"><gw:button img="new"     	alt="New"     		id="btnNew"  			onclick="OnClick('new')" /> </td>
						<td width="1%"><gw:button img="delete"     	alt="Delete"     	id="btnDelete"  		onclick="OnClick('delete')" /> </td>
						<td width="1%"><gw:button img="save"     	alt="Save"     		id="btnSave"  			onclick="OnClick('save')" /> </td>
					</tr>
				</table>
            </td>
        </tr>
