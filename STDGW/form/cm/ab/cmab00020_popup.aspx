...
function ViewDataList()
{
	...
	str = str  + "<td align='right'><gw:imgbtn id='ibtnReport' img='printer' alt='Print Acct' onclick='OnClick()'/></td></tr>";
	...
	str = str  + "<td id ='data_1' >" + grdSearch.GetGridData(1, 18) + "</td>";
	...
	str = str  + "<td id='title'>Hight of cut</td></tr>";

	str = str  + "<tr style='width: 80%; height: 1%'>";
	str = str  + "<td align='left'>";
	str = str  + "<table style='width: 100%; height: 100%' border='0'>";
	str = str  + "<tr>";
	str = str  + "<td id ='data_0'>Greens</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 5) + "</td>";
	str = str  + "<td id ='data_0'>Tee Box</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 6) + "</td>";
	str = str  + "</tr>";
	str = str  + "<tr>";
	str = str  + "<td id ='data_0'>Collar</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 7) + "</td>";
	str = str  + "<td id ='data_0'>Fairway</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 8) + "</td>";
	str = str  + "</tr>";
	str = str  + "<tr>";
	str = str  + "<td id ='data_0'>Apron</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 9) + "</td>";
	str = str  + "<td id ='data_0'>Rough</td>";
	str = str  + "<td id ='data_1'>" + grdSearch.GetGridData(1, 10) + "</td>";
	str = str  + "</tr>";
	str = str  + "</table></td></tr>";

	str = str  + "<tr style='width: 80%; height: 8%'><td></td></tr>";
	...
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 12) + "</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_2'>TEE BOX</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 13) + "</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_2'>FAIRWAY</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 14) + "</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_2'>ROUGH/SEMI ROUGH</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 15) + "</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_2'>BUNKER</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 16) + "</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_2'>GENERAL</td></tr>";
	str = str  + "<tr style='width: 100%'>";
	str = str  + "<td id ='data_3'>" + grdSearch.GetGridData(1, 17) + "</td></tr>";
	str = str  + "</table></td></tr>";
...
<body>
<gw:data id="dso_cmab00020_search" onreceive="OnDataReceive(this)"> 
    <xml>                                                               
        <dso id="1" type="grid" user="prod" function="CRM.sp_sel_cmab00020"> 
            <input> 
