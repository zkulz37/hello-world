...
function OnFormatGrid()
{
	...
	fg.ColFormat(g_Beginning_Qty) = "###,###,###,###,###.#####R"; 
	fg.ColFormat(g_ReceiptQty) = "###,###,###,###,###.#####R"; 
	fg.ColFormat(g_IssueQty) = "###,###,###,###,###.#####R"; 
	fg.ColFormat(g_EndingQty) = "###,###,###,###,###.#####R"; 
...
<tr style="height:4%">
	<td colspan="8" >
		<table width="100%" cellpadding="0" cellspacing="0" border="0" style="height:100%">
			<tr>
				<td width="25%" align="right"><a title="Click here to select item" onclick="OnPopUp('Item')" href="#tips">Item&nbsp;</a></td>
				<td width="20%" align="letf" ><gw:textbox id="txtItemCode" text="" styles="width:100%" /></td>
				<td width="30%" align="left" ><gw:textbox id="txtItemName" text="" styles="width:100%" /></td>
				<td width="5%" align="left" ><gw:imgBtn id="btnReset" img="reset" alt="Reset" onclick="OnReset()" /></td>
