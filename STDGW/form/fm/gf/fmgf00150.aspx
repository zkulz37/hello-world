...
function BindingData()
{
    ...
    var ls_tr_type		= "<%=ESysLib.SetListDataFUNC("SELECT comm.F_COMMONCODE('CODC0120','01','') FROM DUAL ")%>|ALL|Select all";
...
<body>
    <gw:data id="dat_fmgf00150" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,5,6,7,8,9,10,11" function="ACNT.sp_sel_fmgf00150"  > 
                <input bind="idGridVC" >
    ...
    <!--------------------------------------------------------------->
     <gw:data id="dat_fmgf00150_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,5,6,7,8,9,10,11" function="ACNT.sp_sel_fmgf00150_1"  > 
    ...
    <!--------------------------------------------------------------->
     <gw:data id="dat_fmgf00150_2" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="acnt.sp_pro_ar_costing" > 
                <input>
                   <input bind="dbMonth" />
                    <input bind="lstCompany" />					
                 </input>
    ...
    <!--------------------------------------------------------------->
     <gw:data id="dat_fmgf00150_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="acnt.sp_pro_ar_costing_2" > 
                <input>
                    <input bind="lstCompany" />
                    <input bind="txtTacHgtrh" />
                    <input bind="dbMonth" />
                 </input>
                <output>
                    <output bind="txtReturn"/>
    ...
    <table style="width: 100%; height:100%" border="1"   >
        <tr style="height:10%" >
            <td>
                ...
                <tr style="height:50%" >
                    ...
                    <td style="width:1%" align="right"><gw:icon id="idBtnProcess" text="Update Price" onclick="OnUpdate()" /></td>                   
                </tr>
                <tr style="height:50%" >
                    ...
                    <td colspan="4" style="width:15%"></td>
        ...
        <tr style="height:45%" >
            ...
            <td>
                <gw:grid id="idGridVC"                 
                    header="No.|_Pk|Seq|Voucher no|Voucher date|Serial no|Invoice date|Invoice no|CCY|Rate|_Trans. Amt|Book amt|Description|Local Description|_Status"
