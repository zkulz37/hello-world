...
<head id="Head1"  runat="server">
    <title>Takeout Mat Slip (Yearly Accumulated)</title>
</head>
...
function BindingDataList()
{
    ...
    var l_book_ccy = "<%=ESysLib.SetDataSQL("select a.code from comm.tco_abcode a, comm.TCO_ABCODEGRP b where a.del_if = 0 and b.del_if = 0 and a.TCO_ABCODEGRP_PK = b.PK and B.ID = 'ACBG0040' and a.def_yn = 'Y' ")%>";
...
<gw:data id="dso_get_data" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="grid" function="acnt.SP_SEL_FMGF00450" > 
...
<!-------------------------------------------------------->
<gw:data id="dso_get_detail" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="grid" function="acnt.SP_SEL_FMGF00450_1"  > 
...
<!-------------------------------------------------------->
 <gw:data id="dso_make_slip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="acnt.sp_pro_fmgf00450">
                <input> 
                     <input bind="lstCompany" />
...
<!-------------------------------------------------------->
 <gw:data id="consum_cancelslip" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="acnt.sp_pro_fmgf00450_1">
                <input>                      
                     <input bind="txtTac_hgtrh_pk" />
                </input>
                <output>
                        ...
                        <td style="width:22%; ">
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" >
                                ...
                                <tr style="height:5%" >
                                    ...
                                    <td align="left"><gw:datebox id="dtFrom" lang="1" type="month" /></td>
                                </tr>
                                <tr style="height:5%" >
                        ...
                        <td style="width:78%; ">			                        
                            <table border="0" cellpadding="0" cellspacing="0" width="100%" height="100%" >
                                ...
                                <tr style="height:5%">
									...
									<td align="right">Voucher No</td>									
									<td align="right"><gw:checkbox id="chkAuto_YN" value='F' styles="width:100%" /></td>
