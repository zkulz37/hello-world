...
<gw:data id="detail"  onreceive="" > 
        <xml> 
            <dso id="1" type="grid" parameter="0" function="comm.sp_search_cispecgrp" > 
                <input> 
                    <input bind="idInput1" /> 
                </input> 
                <output bind="idGrid" /> 
...
<tr>
	<td>
		...
		<tr> <td width="20%">	  
			 ...
			 <td width="20%">	  
			 <gw:textbox id="idInput1"  text="" onenterkey="detail.Call('SELECT')" /> 				
			 </td>
			 <td width="10%">	  
			 <gw:icon id="idBtnSelect" img="in" text="Search" onclick="detail.Call('SELECT')" /> 				
			 </td>
			 <td width="60%" align="right">  
			  <gw:icon id="idBtnReset" img="in" text="Close" onclick="RowDbClick(0)" /> 	
			 </td>						
