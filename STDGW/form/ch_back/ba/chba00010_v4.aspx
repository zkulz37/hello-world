...
<gw:data id="process_1" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_pro_10020001_1_v4" > 
                <input>
                    <input bind="txdt_tmp" />
                     <input bind="lstOrg1" />
                     <input bind="lstCompany" />
...
<gw:data id="process_2" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_pro_10020001_2_v4" > 
                <input>
                    <input bind="txdt_tmp" />
                     <input bind="lstOrg1" />
                     <input bind="lstCompany" />
...
<gw:data id="process_3" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_pro_10020001_3_v4" > 
                <input>
                    <input bind="txdt_tmp" />
                     <input bind="lstOrg1" />
                     <input bind="lstCompany" />
...
<gw:data id="process_4" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_pro_10020001_4_v4" > 
                <input>
                    <input bind="txdt_tmp" />
                     <input bind="lstOrg1" />
                     <input bind="lstCompany" />
...
<gw:data id="process_5" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10020001_pro_5_v4" > 
                <input>
                    <input bind="txdt_tmp" />
                     <input bind="lstOrg1" />  
                     <input bind="txt_emp_pk" />                   
...
<gw:data id="process_del" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_pro_10020001_del_v4" > 
                <input>
