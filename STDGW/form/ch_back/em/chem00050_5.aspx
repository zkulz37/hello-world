...
<gw:data id="datUser_info" onreceive="OnDataReceive(this)"  > 
        <xml>
            <dso  type="list" procedure="sp_sel_chem00050_51"  > 
                <input>
...
<gw:data id="datDeptData" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="list" procedure="sp_sel_chem00050_52" > 
                <input>
...
<gw:data id="datGroupData" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="list" procedure="sp_sel_chem00050_53" > 
                <input>
                    <input bind="lstDept" /> 
                </input> 
                <output>
...
<gw:data id="datEmployeePopup"> 
    <xml> 
        <dso  type="grid" function="sp_sel_chem00050_54"> 
            <input> 
                <input bind="lstDept" /> 
                <input bind="lstGroup" /> 
                <input bind="chkTemp" /> 
