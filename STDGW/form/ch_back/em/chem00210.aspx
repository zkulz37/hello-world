...
<gw:data id="datchem000210_2" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="" function="hr.sp_pro_chem000210_2"> 
                <input bind="grdEmp" >
...
<gw:data id="datchem000210_1" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="hr.sp_pro_chem000210_1" > 
            <input>
                <input bind="lstYear" />
...
<gw:data id="datchem000210_3" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="hr.sp_pro_chem000210_3" > 
            <input>
...
<gw:data id="datchem000210_4" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,3,4,5,6" function="hr.sp_pro_sel_chem000210_4"   procedure="sp_pro_upd_chem000210_4"> 
                                    ...
                                    <table style="width:100%;height:100%" border="0">
                                        <tr valign="top">
                                            <td style="width:100%; height:100%" valign="top">
                                                <table style="width:100%;height:100%" border="0">
                                                    <tr valign="top">
                                                        <td style="width:10%; height:5%" align="right" valign="middle"> <a title="Click here to show Organization" onclick="OnShowPopup()" href="#tips" >Oganization</a></td>
