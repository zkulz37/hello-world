...
<gw:data id="datchem000220_2" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="" function="SP_SEL_CHEM00220_2"> 
                <input bind="grdEmp" >
...
<gw:data id="datchem000220_1" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="sp_pro_chem000220_1" > 
            <input>
                <input bind="lstYear" />
...
<gw:data id="datchem000220_3" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="SP_SEL_CHEM00220_3" > 
            <input>
...
<gw:data id="datchem000220_4" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,3,4,5,6" function="SP_SEL_CHEM00220_4"   procedure="SP_UPD_CHEM00220_3"> 
