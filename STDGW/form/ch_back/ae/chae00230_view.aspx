...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 var iNum_Page=10;
    ...
    function OpenPopup(obj)
    {
        ...
        {
            var strcom
            var fpath = System.RootURL + "/form/ch/ae/chae00230_popup.aspx?p_header=" + txtHeader.text + "&p_thr_announcement_pk="  +  txtNewsPK.text + '&p_search_key=' + txtSearch_Key.text;
    ...
    function OnExport()
    {
        var url =System.RootURL + '/reports/ch/ae/rpt_announce_view.aspx?p_header=' + txtHeader.text  + '&p_thr_announcement_pk=' + txtNewsPK.text + '&p_title=' + lbTitle.text  ;
        window.open(url); 
    }
</script>
<body>
