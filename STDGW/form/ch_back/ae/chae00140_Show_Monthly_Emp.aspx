...
function BodyInit()
{
	...
	txtMonth.text="<%=request.QueryString("smonth")%>";
	...
	datMonthlyEmpDetail.Call("SELECT");
}
...
<body>
<gw:data id="datMonthlyEmpDetail" onreceive="OnDataReceive()" > 
        <xml> 
            <dso  type="grid"  function="HR_SEL_10010014_MLY_EMP_DTL"> 
		...
		<table width="100%" height=93% border=1 cellspacing=0 cellpadding=0 >		
			<tr>
				<td align = top height=100% >					
					<gw:grid   
                        id="grdEmployee"  
                        header="Department|Group|Emp Id|Full Name|Join Date"
                        format="0|0|0|0|4"  
                        aligns="0|0|1|0|1"  
                        defaults="||||"  
                        editcol="0|0|0|0|0"  
