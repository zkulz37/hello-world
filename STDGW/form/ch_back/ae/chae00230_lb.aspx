    ...
    function BindGrid(gridname,typename){
        ...
        var strHTML='<table border="0" cellpadding="0" cellspacing="0" width="100%">';
            for(i=1;i<grdNews.rows;i++)
            {
                ...
                strHTML += "<td align='left' style='padding-left:2px'><a href='#' onclick='OnRedirect(\"chae00230_view_lb.aspx?tp="+typename+"&pk=" + grdNews.GetGridData(i,1) + '")\'>' + grdNews.GetGridData(i,5) +"</a>"+ grdNews.GetGridData(i,3) + "</td>";
