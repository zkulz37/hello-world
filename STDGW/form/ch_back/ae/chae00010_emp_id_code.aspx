...
function BodyInit()
{
    ...
    {
        maxid="<%=ESysLib.SetDataSQL("select 1 from thr_employee where del_if=0 and rownum=1")%>";
...
<gw:data id="datCharacters" onreceive="OnDataReceive(this)"  > 
    <xml> 
        <dso type="grid" parameter="0,1,3,4,5,7" function="HR_SEL_10010001_CHARACTERS" procedure="HR_UPD_10010001_CHARACTERS" > 
...
<gw:data id="datEmp_ID_Code"   onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="control" parameter="0,1,2,3,4"  function="HR_SEL_10010001_EMP_ID_CODE" procedure="HR_UPD_10010001_EMP_ID_CODE"> 
            <input> 
...
<gw:data id="datTemplates" onreceive="OnDataReceive(this)"  > 
    <xml> 
        <dso type="grid" parameter="0,1,3,4" function="HR_SEL_10010001_TEMPLATES"  > 
