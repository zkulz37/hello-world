...
case "datMonth_summary_resign":  
	  ...
	  case "datDel_salary": 
	   ...
	   case "datBonus":
	        if(txtResult.text=='0')
		    {
		        alert("Process bonus successful.\nHệ thống tính bonus đã hoàn thành.")
                txtResult.text='';
                clear_Interval(idInterval2);
	            idInterval2.text="Successful.";  
		    }
		    else
		    {
		        alert("Error.\nĐã có lỗi xảy ra.")
...
function on_Process(n)
{
    ...
    {
        if(confirm("Bonus is processing...do you want to continous?\nHệ thống tính thưởng bắt đầu...Bạn có muốn tiếp tục?"))
        {
            set_Interval2(1000);
            txtResult.text="";
            datBonus.Call();
...
<gw:data id="datProcess_WT" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_PROCESS_MONTH_WT" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_OT" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_PROCESS_MONTH_OT" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_ABS" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_PROCESS_MONTH_ABS" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datMonth_summary" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_MONTH_SUMMARY" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Allowance" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_MONTH_ALLOWANCE" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s1" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PROCESS_SALARY_S1" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s2" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PROCESS_SALARY_S2" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s3" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PROCESS_SALARY_S3" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_WT_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_MONTH_WT_RESIGN" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_OT_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_MONTH_OT_RESIGN" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_ABS_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR.SP_PRO_MONTH_ABS_RESIGN" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datMonth_summary_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_MONTH_SUMMARY_RESIGN" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datDel_salary" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PRO_DEL_SALARY" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datBonus" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr.SP_PROCESS_BONUS" > 
                <input>
                    <input bind="idYear" />
                    <input bind="lstTimes" />
                    <input bind="lstLocation_dept" />
                    <input bind="txtExRate2" />
                </input> 
                <output>
                    <output bind="txtResult" />
                </output>
...
<tr>
	<td width="100%">
		<table class="itable"  style="width:60%;height:70%" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >
		        <tr style="height:9%">
		        ...
		        <tr style="height:9%">
					<td colspan=8 class="topleftright" width="100%" align="center"><b style="font-size=14"><i>Bonus Process Information (13th Month salary)</i></b></td>
				</tr>
				<tr style="height:9%">
					<td class="topleft" width="20%" align="right">Location</td>
					<td class="topleft" width="2%" align="right">&nbsp;</td>
					<td class="topright" colspan=6 width="78%" align="left" ><gw:list  id="lstLocation_dept2" value='ALL' maxlen = "100" styles='width:30%' >
                            <data>|ALL|Select All</data></gw:list></td>
				</tr>	
				<tr style="height:9%">
				    <td class="topleft" align="right">Year</td>
				    <td class="topleft" width="2%" align="right">&nbsp;</td>
				    <td width=15% class="top"><gw:datebox id="idYear" lang="<%=Session("Lang")%>" styles="width:90%" onchange="" type=year></gw:datebox></td>			
				    <td width=15% class="top" align="right">Times</td>
				    <td class="top" ><gw:list  id="lstTimes"  maxlen = "100" styles='width:100%' >
                                        <data><%=ESysLib.SetListDataSQL("SELECT code,code_nm FROM vhr_hr_code WHERE id='HR0057'  order by code")%></data></gw:list>
                    </td>			
                    <td class="top" align="right" >Ex Rate</td>
                    <td class="top" align="left" ><gw:textbox id="txtExRate2"  styles='width:50%' text=""/></td>        
				    <td width=10% class="topright" align="right">&nbsp;</td>
			    </tr>
			    <tr style="height:9%">
					<td class="bottomtopleft" align="right" >&nbsp;</td>
					...
					<td class="bottomtop" align="center"><gw:icon id="idBtnProcess2" img="in" text="Process" onclick="on_Process(2)" /></td>
					<td class="bottomtop" align="center">&nbsp;</td>
					<td class="bottomtopright" align="center"><b style="color=#FF3300"><gw:label id="idInterval2" text="" styles="width:100%" ></gw:label></b></td>
				</tr>
		    </table>
		</td>
	</tr>
