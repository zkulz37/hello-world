...
<gw:data id="datEmployeePopup"> 
    <xml> 
        <dso  type="grid" function="hr.sp_sel_employee_popup"> 
            <input> 
                <input bind="lstDept" /> 
                <input bind="txtGroup" /> 
                <input bind="chkTemp" /> 
...
<gw:textbox id="iduser_pk" styles="display:none"/>
	...
	<gw:textbox id="txtGroup" text="ALL" styles="display:none"/>
	<gw:textbox id="txtNation" text="ALL" styles="display:none"/>
</body>
</html>
