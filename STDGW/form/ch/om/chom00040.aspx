    ...
    switch (obj.id)
    {
		...
		case "datGet_from_to":
            //alert(txtProcess.text);
		      ...
		      // thuba date: 20140521 ko kiem tra close yn đe get data old for first 
//		      if(txtResult.text=='Y')
//		      {
...
<gw:data id="datProcess_holiday" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_Holiday_Man_ur" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Allowance" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_SP_PRO_MONTH_ALLOWANCE_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s1" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_1015003_SALARY_S1_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s2" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_1015003_SALARY_S2_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s3" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_1015003_SALARY_S3_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datDel_salary" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_1015003_DEL_SALARY_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_holiday_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_Hol_Man_R_ur" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Allowance_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_SP_PRO_MONTH_R_ALLOWANCE_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s1_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_SAL_R_S1_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s2_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_SAL_R_S2_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s3_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_SAL_R_S3_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datDel_salary_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_1015003_DEL_SAL_R_UR" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
	...
	<td width="100%">
		<table class="itable"  style="width:80%;height:70%;border-left:0;border-top:0" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >
				...
				<tr style="height:12%">
					...
					<td class="topleft" width="2%" align="right">&nbsp;</td>
					<td class="top" colspan=4 align="right"><gw:list  id="lstSalaryKind" value='' maxlen = "100" styles='width:100%' onchange="ChangeSalaryKind()">
					...
					<td  colspan=2 class="top" width="50%" align="right" ><b ><gw:label id="idSAL_KIND" styles="width:100%" ></gw:label></b></td>
