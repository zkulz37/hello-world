...
<html xmlns="http://www.w3.org/1999/xhtml">
 ...
 <script>
    ...
    {
        txtNewsPK.text='01';
        txtNewsQuantity.text = "10";
        dsoNews.Call("SELECT");
    }
    function BindGridTitle(gridname,typename){
        //alert(grdNews.GetGridData(1,7));        
        var strHTML='<table border="0" cellpadding="0" cellspacing="0" width="100%" >';
            
        strHTML += "<tr>";
        strHTML += "<td style='font-family:Tahoma;font-size:14px;font-weight:normal;padding-left:10px;padding-top:3px' valign='middle'><img src='../../../system/images/sin_btn_more03.gif' border='0' valign='absbottom' /> <span style='color:#326da7'>WHAT'S</span> <span style='color:#a9a9a9'>"+ grdNews.GetGridData(1,7) +"</span></td>";
        strHTML += "<td width='36px' valign='bottom'><a href='#' onclick='OnRedirect(\"chae00230_list_ict.aspx?tp="+typename+"&announce_nm="+grdNews.GetGridData(1,7)+"" + '");\'>' + "<img src='../../../system/images/more_btn.gif' border='0' alt='MORE'></a> </td>";
        strHTML += "</tr>";
        strHTML += "<tr><td style='height:1px solid;background-color:#0363b2' valign='absbottom' colspan='2'></td></tr>";
        strHTML += "<tr><td style='height:5px' colspan='2'></td></tr>";          
        strHTML += "</table>";
    ...
    function BindGrid(gridname,typename){
        ...
        var strHTML='<table border="0" cellpadding="0" cellspacing="0" width="100%">';
            for(i=1;i<grdNews.rows;i++)
            {
                ...
                strHTML += "<td align='left' style='padding-left:2px'><a href='#' onclick='OnRedirect(\"chae00230_view_ict.aspx?tp="+typename + "&announce_nm="+grdNews.GetGridData(1,7)+""+"&pk=" + grdNews.GetGridData(i,1) + '")\'>' + grdNews.GetGridData(i,5) +"</a>"+ grdNews.GetGridData(i,3) + "</td>";
...
//                else
//                {
//                    BindGridTitle("contractTitle","02");
//                    BindGrid("contract","02");
//                }
//                txtNewsPK.text='03';
                                ...
                                <tr>
							        <td colspan="3" valign="top">
								        <%--<table border="0" cellpadding="0" cellspacing="0" width="100%" >
								            <tr>
								                <td style="font-family:Tahoma;font-size:14px;font-weight:normal;padding-left:10px;padding-top:3px" valign="middle"><img src='../../../system/images/sin_btn_more03.gif' border="0" valign="absbottom" /> <span style="color:#326da7">WHAT'S</span> <span style="color:#a9a9a9">EMPLOYEES' BIRTHDAY</span></td>
                            ...
                            <table cellpadding="0" cellspacing="0" width="100%" border="0" id="tblrecruit">
                                <tr>
							        <td colspan="3" valign="top">
								        <%--<table border="0" cellpadding="0" cellspacing="0" width="100%">
								            <tr>
								                <td style="font-family:Tahoma;font-size:14px;font-weight:normal;padding-left:10px;padding-top:3px" valign="middle"><img src='../../../system/images/sin_btn_more03.gif' border="0" valign="absbottom" /> <span style="color:#326da7">WHAT'S</span> <span style="color:#a9a9a9">LABOUR CONTRACT</span></td>
