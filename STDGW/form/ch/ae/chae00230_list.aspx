    ...
    function BindGrid(){
        ...
        var strHTML='<table border="0" cellpadding="0" cellspacing="0" width="100%">';
            for(i=pgSize*(pgCurr-1)+1;i<=ttRecord;i++){
                ...
                strHTML += "<td style='width:1px' valign='top'><table cellpadding='0' cellspacing='0' width='1px' style='height:24px'><tr><td bgcolor='#10438A'></td></tr></table></td>";
                strHTML += "<td style='width:51px' align='center' class='normals'>" + grdNews.GetGridData(i,0) + "</td>";
                strHTML += "<td align='left' style='padding-left:2px'><a href='#' onclick='OnRedirect(\"chae00230_view.aspx?tp="+'<%=request.QueryString("tp")%>' + '&pk=' + grdNews.GetGridData(i,1) + '")\'>' + grdNews.GetGridData(i,5) +"</a>"+ grdNews.GetGridData(i,3) + "</td>";
...
<body>
    <gw:data id="dsoNews" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" parameter="0,1,2,3,4,5,7" function="hr_10010023_announcement_list">  
    ...
    <table cellpadding="0" cellspacing="0" width="100%" border="0">
        <tr>
            <td align="center" style="padding-top:2px;padding-right:0px">
                                ...
                                <tr>
							        <td colspan="3" valign="top">
								        <table border="0" cellpadding="0" cellspacing="0" width="100%">
								            <tr>
								                <td style="font-family:Tahoma;font-size:14px;font-weight:normal;padding-left:10px;padding-top:3px" valign="middle"><img src='../../../system/images/sin_btn_more03.gif' border="0" valign="absbottom" /> <span style="color:#326da7">WHAT'S</span> <span style="color:#a9a9a9"> <%if (Request.QueryString("tp").ToUpper() = "01") Then
								                                                                                                                                                                                                                                                                                 Response.Write("EMPLOYEES' INFORMATION")
								                                                                                                                                                                                                                                                                             ElseIf (Request.QueryString("tp").ToUpper() = "02") Then
								                                                                                                                                                                                                                                                                                 Response.Write("RECRUITMENT")
								                                                                                                                                                                                                                                                                                                    ElseIf (Request.QueryString("tp").ToUpper() = "03") Then
								                                                                                                                                                                                                                                                                                                        Response.Write("EMPLOYEES' SALARY")
								                                                                                                                                                                                                                                                                                                    Else
								                                                                                                                                                                                                                                                                                                        Response.Write("TIME MACHINE")
								                                                                                                                                                                                                                                                                                                        
								                                                                                                                                                                                                                                                                             End If%></span></td>
								                <td style="padding-left:5px;padding-bottom:5px" align="right" valign="middle"><gw:imgbtn id="btnCancel" img="cancel" alt="Close" text="Cancel" onclick="OnRedirect('chae00230.aspx')" /></td>
								            ...
								            <tr>
								                <td height="23px" valign="top" colspan="2">
								                    <table cellpadding="0" cellspacing="0" border="0" width="100%">
								                        <td style="width:1px" valign="top"><table cellpadding="0" cellspacing="0" width="1px" style="height:24px"><tr><td bgcolor="#10438A"></td></tr></table></td>
