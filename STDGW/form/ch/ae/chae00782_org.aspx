...
function BodyInit()
{
	...
	lstCompany.SetDataText("<%=ESysLib.SetListDataSQL("select PK,PARTNER_NAME from TES_TCO_COMPANY where DEL_IF = 0 AND ACTIVE_YN='Y'")%>");
...
<gw:data id="datDeptTree"   > 
        <xml> 
            <dso id="1" type="tree" function="hr_chae00782_sel_org_tree" > 
                <input>
