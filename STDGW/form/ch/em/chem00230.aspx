...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        case 'datchem000230_2':
          //  imgEmp.SetDataText(txtPhoto_PK.text);
			auto_resize_column(grdEmp,0,grdEmp.cols-1,9);    
            //datchem000230_4.Call("SELECT");
           
        break;
		case 'datchem000230_3':
            imgEmp.SetDataText(txtPhoto_PK.text);
			//auto_resize_column(grdEmp,0,grdEmp.cols-1,9);    
            datchem000230_4.Call("SELECT");
           
        break;
		case 'datchem000230_4':
...
function OnSearch()
{//alert("sdfds");
datchem000230_2.Call('SELECT');
}
function OnSave()
{
	if(confirm("Do you want to save?"))
	{datchem000230_4.Call();
	}
...
{    
	...
	var url=System.RootURL + '/reports/ch/em/rpt_safe_behaviour_vst.aspx?p_thr_eva_master_pk='+ lstYear.value + '&P_TCO_ORG_PK='+ lstOrg.value + '&P_SEARCH_BY='+ lstTemp.value + '&P_SEARCH_TEMP='+ txtTemp.text+'&p_work_group='+lstGrp_Code.value;
    window.open(url);    
...
<gw:data id="datchem000230_1" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="hr.sp_sel_chem000230_1" > 
            <input>
                <input bind="lstYear" />
...
<gw:data id="datchem000230_2" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="" function="hr.SP_SEL_CHEM00230_2"> 
                <input bind="grdEmp" >
...
<gw:data id="datchem000230_3" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="process" procedure="hr.SP_SEL_CHEM00230_3" > 
            <input>
...
<gw:data id="datchem000230_4" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,3,4,5,6" function="hr.SP_SEL_CHEM00230_4"   procedure="SP_UPD_CHEM00230_3"> 
