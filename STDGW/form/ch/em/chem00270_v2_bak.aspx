...
<table id="main" cellpadding="0" cellspacing="0" border="0" style="width:100%;height:100%; margin-left:0; margin-top:0">
    <tr  >
        <td colspan=40 width="40%"  valign="top" id="left">
            <table style="width:100%; height:100%" border="0">
                <tr style="height:20%">
                    <td colspan=40 width="100%">
                        <table border="0" style="width:100%;height:100%; margin-left:0; margin-top:0;border-bottom: solid 1 Black; border-left: solid 1 Black; border-right: solid 1 Black; border-top: solid 1 Black" style="background-color:#BDE9FF">
                            <tr>
                                <td colspan=12 width="30%" align="right">Evaluation #</td>
                                <td colspan=28 width="70%" style="">
                                    <gw:list  id="lstYear" styles='width:100%' onchange="OnClickChange()" ></gw:list>
                                </td>
                            </tr>
                            <tr>
                                <td colspan=12 width="30%" align="right">Evaluation Period</td>
                                <td colspan=28 width="70%" style="width:100%; font-size:larger" nowrap colspan="4"><gw:label id="lblPeriod" text=""/></td>
                            </tr>
                            <tr>
                                <td colspan=12 width="30%" align="right">Schedule</td>
                                <td colspan=28 width="70%" style="width:100%; font-size:larger" nowrap colspan="4" ><gw:label id="txtSchedule" text="" /></td>
                            </tr>
                        </table>  
                    </td>
                </tr>
                <tr style="height:80%">
					...
					<td colspan="1" width="30%" valign="top" style="border-bottom: solid 1 Black; border-left: solid 1 Black; border-right: solid 1 Black; border-top: solid 1 Black;background-color:#BDE9FF">
						<table width="100%" height="100%" style="background-color:#BDE9FF">
							<tr height="30%" >
								<td width="40%" valign="top" align="center" >
									<gw:image id="imgEmp" view="/binary/ViewFile.aspx" post="/binary/PostFile.aspx" styles="width:160;height:155"  />
								</td>								
							</tr>
							<tr height="6%"><td valign="top"></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblEmpID" text="EmpID" styles="font-weight: bold;"/></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblName" text="Name" styles="font-weight: bold;" /></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblOrg" text="Org" styles="font-weight: bold;" /></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblWg" text="WG" styles="font-weight: bold;" /></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblJoinDt" text="JoinDt" styles="font-weight: bold;" /></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblPos" text="Position" styles="font-weight: bold;" /></td></tr>
							<tr height="6%"><td valign="top"><gw:label id="lblJob" text="Job" styles="font-weight: bold;" /></td></tr>		
        ...
        <td colspan=60 width="60%"  valign="top" id="right">
            <table width="100%" cellpadding="0" cellspacing="1" border="0" style="height:100%;border-bottom: solid 1 Black; border-left: solid 1 Black; border-right: solid 1 Black; border-top: solid 1 Black" >
                <tr style="height:5%">						
                    <td colspan=91 width ="91%"  align=right style="border:0"></td>
                    <td colspan=3 width ="3%" align=center style="border:0"><gw:imgBtn id="ibtnSearch" alt="Search" img="search" text="Search" onclick="OnSearch(datApprover_mapping)" /></td>
                    <td colspan=3 width ="3%" align=center style="border:0"><gw:imgBtn id="ibtnSave" alt="Save" img="save" text="Save" onclick="OnSave(idGrid)" /></td>
                    <td colspan=3 width ="3%" align=center style="border:0"><gw:imgBtn id="ibtnDelete" alt="Delete" img="delete" text="Delete" onclick="OnDelete(idGrid)" /></td>    
				</tr>
				<tr style="height:50%"  >
                    <td colspan="100" width ="100%" style="">
                        <gw:grid id="grid2" 
					...
					<td colspan="100" style="width:100%">
						<table style="height:100%;width:100%; background-color:#BDE9FF">
							<tr style="height:50%"> 
								...
								<td colspan=5 width ="5%" align="right" valign="top">1st</td>
								<td colspan=95 width ="95%" ="right"><gw:textarea id="txt1st" text="" rows="6" styles="width:100%" /></td>
							
							</tr>
							<tr style="height:50%"> 
							
								<td colspan=5 width ="5%" align="right" valign="top">2nd</td>
								<td colspan=95 width ="95%" align="right"><gw:textarea id="txt2nd" text="" rows="6" styles="width:100%" /></td>
