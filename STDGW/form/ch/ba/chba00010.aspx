			...
			switch (opt[i].value)
			{
			    ...
			    case '4': //full time 
					if(confirm("Do you want to process full time?"))
					{
                        ...
                        idStaus1.text="Full time task 1...";
                        idStaus2.text="";
					    process_flag=1;
					    set_Interval(100);
					    process_ft_1.Call();
...
function OnDataReceive(obj)
{
    switch (obj.id)
    {
		...
		case "process_ft_1":
		    ...
		    {
                txtResult.text=="";
                idStaus1.text="Full time task 2...";
			    txtResult.text=="";
			    clear_Interval(idInterval);
			    //alert("Step 1 success, Step 2 will continous...\n Bước 1 thành công, bước 2 được tiếp tục... ");
			    set_Interval(100);
...
<gw:data id="process_M" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10020001_pro_M1" > 
                <input>
                    <input bind="idFrom" />
                    <input bind="idTo" />
                    <input bind="idEmp_id" />
...
<tr>
	<td width="100%">
		...
		<table  style="width:80%;height:6%" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >	
			<tr >
                <td class="topleft" width="10%" align="left"><input type="radio" name="option_Q" value="1" onclick="onClickOptionQ(1)" style="color=Black"><font size=2>Work Date</font></td>
		...
		<table style="width:80%;height:30%" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >	
			...
			<tr >
				...
				<td colspan=3 class="right" width="40%"><gw:list  id="lst_wg1"  value="ALL" styles='width:100%' onchange="onChange_location()" >
			...
			<tr >
				...
				<td colspan=3 class="right" width="40%"><gw:list  id="lst_wg2"  value="ALL" styles='width:100%' onchange="onChange_location()" >
                            <data><%=ESysLib.SetListDataSQL("SELECT PK,WORKGROUP_NM FROM thr_work_group WHERE DEL_IF=0 ORDER BY WORKGROUP_NM")%>|ALL|Select All</data></gw:list></td>
			</tr>	
			<tr >
				<td class="left" width="10%" align="left">&nbsp;</td>
				...
				<td colspan=3 class="right" width="40%"><gw:list  id="lst_wg3"  value="ALL" styles='width:100%' onchange="onChange_location()" >
                            <data><%=ESysLib.SetListDataSQL("SELECT PK,WORKGROUP_NM FROM thr_work_group WHERE DEL_IF=0 ORDER BY WORKGROUP_NM")%>|ALL|Select All</data></gw:list></td>
			</tr>	
			<tr >
		...
		<table id="table_M1"  style="width:80%;height:6%" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >	
			<tr >
		...
		<table id="table_M2" style="width:80%;height:18%" cellpadding="0" cellspacing="0" valign="center" align="center" border="0" >	
			<tr >
				<td class="left" width="30%" align="left">&nbsp;</td>
				<td  width="30%" align="left"><input type="radio" name="option_P2" value="1" style="color=Black" onclick="onClickOption(2)"><font size=2>Process data</font></td>
				<td class="right" colspan="2" width="70%" align="left">&nbsp;</td>
			</tr>	
			<tr >
				<td class="left"  width="30%" align="left">&nbsp;</td>
				<td  width="30%" align="left"><input type="radio" name="option_P2" value="2" style="color=Black" onclick="onClickOption(2)"><font size=2>Delete data</font></td>
				<td class="right" colspan="2" width="70%" align="left">&nbsp;</td>
			</tr>	
			<tr >
				<td  class="left" width="30%" align="left">&nbsp;</td>
				<td  width="30%" align="left"><input type="radio" name="option_P2" value="3" style="color=Black" onclick="onClickOption(2)"><font size=2>Full Time</font></td>
				<td class="right" colspan="2" width="70%" align="left">&nbsp;</td>
			</tr>	
			<tr >
				<td class="left" align="right">&nbsp;</td>			
				<td  align="center" style="width:30%"><gw:icon id="idBtnProcess_M" img="in" text="Process" onclick="on_Process_M();return false;" /></td>
				<td   style="width:50%" align="right"><gw:label id="idStaus_M" text="" styles="width:100%;color:blue" ></gw:label></td>
				<td class="right"  style="width:20%" style="color=#FF3300" align="right"><gw:label id="idInterval_M" text="" styles="width:100%" ></gw:label></td>
			</tr>
	        <tr >
				<td class="bottomleft" align="right">&nbsp;</td>			
				<td class="bottom" align="center" style="width:30%">&nbsp;</td>
				<td class="bottom"  style="width:50%" align="right">&nbsp;</td>
				<td class="bottomright"  style="width:20%" style="color=#FF3300" align="right">&nbsp;</td>
			</tr>
		</table>
		</td>
	</tr>
