...
<head id="Head1" runat="server">
    <title>Application No formula</title>
</head>
<script>
...
function BodyInit()
{
    ...
    var maxid;
    if (txtIDCode.text=="Training")
    {
        maxid="<%=ESysLib.SetDataSQL("select 1 from thr_train_req where del_if=0 and rownum=1")%>";
...
<gw:data id="datCharacters" onreceive="OnDataReceive(this)"  > 
    <xml> 
        <dso type="grid" parameter="0,1,3,4,5,7" function="HR_CHKR10200003_sel_characters" procedure="HR_CHKR10200003_upd_characters" > 
...
<gw:data id="datEmp_ID_Code"   onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso type="control" parameter="0,1,2,3,4"  function="HR_CHKR10200003_sel_Code" procedure="HR_CHKR10200003_UPD_Code"> 
            <input> 
...
<gw:data id="datTemplates" onreceive="OnDataReceive(this)"  > 
    <xml> 
        <dso type="grid" parameter="0,1,3,4" function="HR_CHKR10200003_sel_templates"  > 
