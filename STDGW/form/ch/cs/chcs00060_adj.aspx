...
<gw:data id="datGet_from_to" onreceive="OnDataReceive(this)"  > 
        <xml> 
                    <dso  type="process" procedure="hr_pro_10060002_org_adj" > 
                <input>
...
<gw:data id="datProcess_Sal_s1" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_10060002_SAL_S1_ADJ_ICT" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s2" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_10060002_SAL_S2_ADJ_ICT" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s3" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_10060002_SAL_S3_ADJ_ICT" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datDel_salary" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="HR_PRO_10060002_DEL_SAL_ADJ" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s1_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10060002_SAL_RESIGN_S1" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s2_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10060002_SAL_RESIGN_S2" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datProcess_Sal_s3_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10060002_SAL_RESIGN_S3" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
...
<gw:data id="datDel_salary_resign" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10060002_DEL_SAL_RESIGN" > 
                <input>
                    <input bind="idWorkMon" />
                    <input bind="idFrom" />
                    <input bind="idTo" />
