...
function BodyInit()
{
    ...
    <%=ESysLib.SetGridColumnComboFormat( "idGridT2_1" , 3 , "select code,code||'-'||CODE_NM from vhr_hr_code where id='HR0094' order by seq " ) %>; 
...
function OnSave(obj)
{
    ...
    if (CheckNullViewName()==1) // KIEM TRA VIEW NAME CO NULL HAY KHONG
     ...
     {
        var count =0;
            for(var i =1 ;i< idGridT3_1.rows ; i++)
            {
                if(idGridT3_1.GetGridData(i,2)=="")
                {
                    count = 1; 
                    alert("Please input name for all selected column!")
                    break;
                }
            }
            if(count ==0)
...
<gw:data id="dsoViewSalary"  onreceive="OnDataReceive(this)" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_view_exists"  > 
...
<gw:data id="dsoShowColumNameView"  onreceive="OnDataReceive(this)" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_column_view"  > 
...
<gw:data id="dsoViewInfor"  onreceive="" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_view_column" parameter="0,1,2,3,4,5,6"  procedure = "hr_upd_10030010_view_column" > 
...
<gw:data id="dsoColumNameSalaryT2"  onreceive="" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_col_name_2"  > 
			<input bind="idGridT2" >	
			    <input bind="txtColum"/>
			</input> 
...
<gw:data id="dsoColumNameSalaryT4"  onreceive="" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_col_name_3" parameter="0,1,2,3" procedure="hr_upd_10030010_col_name_sal" > 
...
<gw:data id="dsoSalaryCol"  onreceive="" > 
	<xml> 
		<dso type="grid" function="hr_sel_10030010_mon_sal_cols"  > 
			<input bind="idGridT3" >	
...
<gw:data id="process" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_10030010_auto_view_sal" > 
                <input>
                    <input bind="txtQuery" />
                </input> 
                <output>
		...
		<table width="100%" style="height:100%" border="0" cellspacing="1" cellpadding="1">
		  ...
		  <tr style="height:95%" >
		   <td width="100%" colspan=4 >
				<gw:grid
					id="idGridT2"
					 header="_PK|_Column|Salary Name|_Description"
			        format="0|0|0|0"
			        aligns="0|0|0|0"
			        defaults="||||"
			        editcol="0|0|1|1"
			        widths="0|0|2500|2500"
			        styles="width:100%;height:100%"
			        sorting="T"
			        onafteredit=""
			        oncellclick = ""
		...
		<table width="100%" style="height:100%" border="0" cellspacing="1" cellpadding="1">
		  <tr>
                ...
                <gw:list  id="lstViewCols"  maxlen = "100" value='ALL' styles='width:100%'onchange="OnSearchTable(2)" >
                    <data>
                                <%=ESysLib.SetListDataSQL("select code,code||'-'||CODE_NM from vhr_hr_code where id='HR0094' order by code ")%>|ALL|Select All
                            </data>
                     </gw:list>
                </td>
		  ...
		  <tr  style="height:100%">
			<td style="height:100%" colspan=6>
				<gw:grid
					id="idGridT2_1"
					header="_PK|_Column Name|Salary Cols|View Name|Seq|Format|Align"
					format="0|0|0|0|0|0|0"
					aligns="0|0|0|0|0|0|0"
					defaults="|||||||"
					editcol="0|0|0|1|1|1|1"
					widths="0|2000|2000|2500|500|1000|1000"
					styles="width:100%;height:100%"
					sorting="T"
					onafteredit=""
					oncellclick = ""
                ...
                <table width="100%"   style="height:100%" border="0" cellspacing="1" cellpadding="1">
		          ...
		          <tr style="height:95%" >
		           <td width="100%" colspan=4 >
				        <gw:grid
					        id="idGridT3"
					        header="_Order|Column Name|_Data Type|_Length|_Description"
					        format="0|0|0|0|0"
					        aligns="1|0|1|1|0"
					        defaults="||||"
					        editcol="0|0|0|0|0"
                ...
                <table width="100%" style="height:100%" border="0" cellspacing="1" cellpadding="1">
		          ...
		          <tr  style="height:100%">
			        <td style="height:100%" colspan=5>
				        <gw:grid
					        id="idGridT3_1"
					        header="_PK|Column|Name|Description"
					        format="0|0|0|0"
					        aligns="0|0|0|0"
					        defaults="||||"
					        editcol="0|0|1|1"
