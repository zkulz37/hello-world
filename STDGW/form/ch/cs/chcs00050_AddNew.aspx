...
<gw:data id="datSalary_Adjust_popup" onreceive="OnDataReceive(this)" > 
        <xml> 
            <dso  type="grid"  parameter="2,3,4,5,6,7,8" function="hr_sel_10030005_sal_adj_pop"> 
                <input bind="idGrid" >
                    <input bind="lstOrg" />
                    <input bind="lstwg" />
	    ...
	    <td>
	        <table style="width:100%;height:12%" cellpadding="0" cellspacing="0" valign="top" border="0" >	
                ...
                <tr style="height:6%;border:0">	
		            ...
		            <td align=left colspan=2 style="width:10%"><gw:datebox id="Adj_DT"  maxlen = "10" text="" styles='width:100%'lang="<%=Session("Lang")%>" nullaccept /></td>
