    ...
    switch (obj)         
      {		        
            case 'Master' :
                    ...
                    if(grdBeverage.rows-1>0)
                    {
                        grdBeverage.ClearData();
                    }
                    if(grdF_B_Other.rows-1>0) 
                    {
                        grdF_B_Other.ClearData();
                    }
                    if(grdPromotion.rows-1>0)
                    {
                                                    ...
                                                    <fieldset>
                                                        <table style="width: 100%; height: 100%">
                                                            <tr style="height: 1%">
								                                ...
								                                <td style="width: 3%" align="right">
									                                <gw:imgbtn img="save" alt="Save" id="btnSaveFood" onclick="OnSave('Food')" />
								                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                    ...
                                                    <fieldset>
                                                        <table style="width: 100%; height: 100%">
                                                            <tr style="height: 1%">
								                                ...
								                                <td style="width: 3%" align="right">
									                                <gw:imgbtn img="save" alt="Save" id="btnSaveBever" onclick="OnSave('Beverage')" />
								                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                    ...
                                                    <fieldset>
                                                        <table style="width: 100%; height: 100%">
                                                            <tr style="height: 1%">
								                                ...
								                                <td style="width: 3%" align="right">
									                                <gw:imgbtn img="save" alt="Save" id="btnSaveOther" onclick="OnSave('Other')" />
								                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
                                                    ...
                                                    <fieldset>
                                                        <table style="width: 100%; height: 100%"> 
                                                            <tr style="height: 1%">
								                                ...
								                                <td style="width: 3%" align="right">
									                                <gw:imgbtn img="save" alt="Save" id="btnSavePromotion" onclick="OnSave('Promotion')" />
								                                </td>
                                                            </tr>
                                                        </table>
                                                    </fieldset>
