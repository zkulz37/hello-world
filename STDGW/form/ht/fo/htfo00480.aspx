...
function OnReport()
 {
	 ...
	 {
		 var url = '/reports/ht/fo/rpt_htfo00480_room.aspx?p_dt_from='+ dtFromDate.value+'&p_dt_to='+dtToDate.value+'&p_fee_type='+txtRoomLastFirstName.text+'&p_room_no='+lstFeeType.value;
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="crm.sp_sel_htfo00480"> 
