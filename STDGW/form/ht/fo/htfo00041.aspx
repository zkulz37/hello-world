...
<body>
    ...
    <gw:data id="dso_htfo00041" onreceive="OnDataReceive(this)">
	    <xml> 
		    <dso type="grid" parameter="" function="CRM.sp_sel_htfo00041">
			    <input bind="idGrid">
				    <input bind="TABLE_PK" />
			    </input> 
			    <output bind="idGrid" /> 
    ...
    <table style="height: 100%; width: 100%">
        <tr>
            <td style="height:5%" align="center">
                Slip No: <%= Request.QueryString("sn") %> - Room\Locker: <%=Request.QueryString("room")%> - Date: <%=Request.QueryString("date")%> 
            </td>
        </tr>
        <tr style="height: 95%">
            <td colspan="7">
