...
<gw:data id="dsoGrdData" onreceive="OnDataReceive(this)"> 
	<xml> 
		<dso  type="grid"  parameter="" function="crm.sp_sel_htfo00290" procedure="">  
			<input bind="grdData" >  
				<input bind="dtDate" />
...
<gw:data id="dso_process" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="process" procedure="crm.SP_PRO_THT_GUEST_INVOICE" > 
            <input>
                <input bind="dtDate" />
            </input> 
            <output>
...
<gw:data id="dso_process_send" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="process" procedure="crm.sp_pro_send_hotel_slip" > 
            <input>
                <input bind="dtDate" />
            </input> 
            <output>
...
<gw:data id="dso_process_cancel" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="process" procedure="crm.sp_pro_cancel_hotel_slip" > 
            <input>
                <input bind="dtDate" />
            </input> 
            <output>
    ...
    <table width="100%" style="height: 100%" border="0">
        ...
        <tr style="width: 100%; height: 48%">
            <td colspan="10">
                <gw:grid id="grdData" 
                    header  ="_PK|Invoice No|Invoice Date|Full Name|Debit|Credit|Credit Advance|Trans AMT|Ex Rate|CCY|Book Amount|Cost Center|Description|Description (Local)|_VoucherNo"
