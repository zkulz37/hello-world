...
//-------------------------------------------------
    function BodyInit()
    {
        var data1 = "<%=ESysLib.SetListDataSQL("select CODE, NAME from  comm.TCO_COMMCODE where del_if=0 and PARENT_CODE='RSTA'" )%>|ALL|Select All"; 
...
<body>
    <!----------------------------------------------------->
    <gw:data id="data_htfo00201" onreceive=""> 
        <xml> 
           <dso id="1" type="grid" function="crm.sp_sel_htfo00200_pop_room" > 
                  <input bind="idGrid" > 
    ...
    <table style="height: 100%; width: 100%">
        ...
        <tr style="height: 99%">
            <td colspan="7">
                <gw:grid id="idGrid" header="_PK|Room No|Building|Area|Floor|Type|_Code_Status|Status|Active"
                    format  ="0|0|0|0|0|0|0|0|3" 
                    aligns  ="0|1|1|1|1|0|0|0|1" 
                    defaults="||||||||" 
                    editcol ="0|0|0|0|0|0|0|0|"
                    widths  ="0|1500|2000|2000|2000|2000|0|2000|2000" 
