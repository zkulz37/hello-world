...
function OnSearch()
{
    dso_WimmingPoolRevenue.Call("SELECT");
}
function OnReport()
 {
	 if(grdSwimmingPoolRevenue.rows > 1)
	 {
		 var url = '/reports/ht/fo/rpt_htfo00400_swimming_revenue.aspx?p_dtfrom='+ dtFromDate.value+'&p_dtto='+dtToDate.value+'&p_invoice='+txtInvoiceNo.text+'&p_roomno='+txtRoomNo.text+'&p_delete='+cbDelete.value;
 ...
 {
	if(obj.id=='dso_WimmingPoolRevenue')
	{
		if (grdSwimmingPoolRevenue.rows > 1)	
		{
			grdSwimmingPoolRevenue.Subtotal( 1, 2, -1, '5!6!7!8!9!11');
		}
	}
}
</script>
...
<body>
    <!----------------------------------------------------------------------------------------------->
    <gw:data id="dso_WimmingPoolRevenue" onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso  type="grid" function="crm.sp_sel_htfo00400"> 
            <input bind="grdSwimmingPoolRevenue">                    
            ...
            <output bind="grdSwimmingPoolRevenue" />
        </dso> 
    </xml> 
</gw:data>
    <!----------------------------------------------------------------------------------------------->
        ...
        <tr style="width: 100%; height: 95%">
            <td width="100%">
                <table align="top" cellspacing="0" cellpadding="0" border="0" style="width: 100%;
                    ...
                    <tr valign="top">
                        <td width="100%">
                            <gw:grid id="grdSwimmingPoolRevenue" 
                                ...
                                format="4|0|0|0|0|-0|-0|-2|-2|-2|-0|-0|0|0|4|0|4"
