...
<body>
    ...
    <gw:data id="data_htfo00110_in" onreceive="">
        <xml>
           <dso  type="grid"  function="crm.sp_sel_htfo00110_in" >
                <input  bind="grdData">
    ...
    <table style="width: 100%; height: 100%" border="1">
        <tr style="height: 100%">
            <td>
                <gw:grid id='grdData' header='Guest Name|Nation|Adult|Child|Total Amt|From Date|To Date|Reservation#'
                    format='0|0|0|0|0|0|0|0' 
					aligns='0|0|3|3|3|0|0|0'
