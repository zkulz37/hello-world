...
//-------------------------------------------------
 ...
 //------------------------------------------------
    ...
    function OnSearch()
    {
        data_htfo00260_popup.Call("SELECT")    
    }
    //-------------------------------------------------
...
<body>
    <!----------------------------------------------------->
    <gw:data id="data_htfo00260_popup" onreceive=""> 
        <xml> 
           <dso id="1" type="grid" function="CRM.sp_sel_htfo00260_popup" > 
                  <input bind="idGrid" > 
    ...
    <table style="height: 100%; width: 100%">
        ...
        <tr style="height: 99%">
            <td colspan="7">
                <gw:grid id		="idGrid" 
					header		="_PK|Floor No|Room No|Room Type|Guest Name"
                    format		="0|0|0|0|0" 
					aligns		="1|1|1|0|0" 
					defaults	="||||" 
					editcol		="0|0|0|0|0"
                    widths		="0|1500|2000|2000|2000|2000" 
