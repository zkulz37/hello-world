...
function OnReport()
 {
	 ...
	 {
		 var url = System.RootURL + "/system/ReportEngine.aspx?export_pdf=Y&file=ht/fo/htfo00080_minibar.rpt&procedure=CRM.sp_rpt_htfo00080&parameter="+dtFromDate.value+","+dtToDate.value+","+txtInvoiceNo.text+","+txtRoomNo.text;      
...
<body>
    ...
    <xml> 
        <dso  type="grid" function="crm.sp_sel_htfo00080"> 
