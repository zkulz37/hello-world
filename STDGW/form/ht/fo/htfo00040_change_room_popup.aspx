...
function OnPopup()
{
	var path = System.RootURL + '/form/ht/fo/htfo00040_popup_receive_change_room.aspx';
...
<gw:data id="dso_htfo00040_changed_room" onreceive="OnDataReceive(this)"> 
	<xml> 
		<dso  type="control" parameter="0,5"  function="crm.sp_sel_htfo00040_changed_room" procedure="crm.sp_upd_htfo00040_changed_room">
			<inout>
