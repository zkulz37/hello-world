   ...
   var ctrl=grdHistory.GetGridControl();
    switch(obj){
		...
		case "OOO":
			if(grdHistory.row != '-1')
			{
				 var path = System.RootURL + '/form/ht/fo/htfo00200_popup_OOO.aspx?p_room_pk=' + grdHistory.GetGridData(grdHistory.row, 0);
...
<body bgcolor='#F5F8FF'>
    <gw:data id="dsoListHistory" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="grid" parameter="0,1,2,3,4,5,6,7,8" function="crm.sp_sel_htfo00200" procedure="crm.sp_upd_htfo00200">  
