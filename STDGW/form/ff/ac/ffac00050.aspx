...
<body>
    ...
    <gw:data id="dsoAccountGroupEntry"  onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" function="ACNT.SP_SEL_ACCOUNT_GROUP" parameter="0,1,2,3,4,5" procedure="ACNT.SP_UDP_ACCOUNT_GROUP"> 
...
<form id="form1" runat="server">
				...
				<tr>
					<td width="95%">
						<table border=0 cellpadding="0" cellspacing="0" width="100%">
							<tr>
							    <td width="6%" align="center"><font color="black" ><b>Company</b></font></td>	
							    <td width="15%"><gw:list id="lstCompany" value="" onchange="Search()" styles='width:100%'></gw:list >
								</td>				
								<td width="10%" align="center"><font color="black" ><b>Trans Group</b></font></td>					
								<td width="15%">
									<gw:list id="lstTransGroup" value="" onchange="Search()" styles='width:100%'> </gw:list >
								</td>
								<td width="10%" align="center"><font color="black" ><b>Acc Group Code</b></font></td>					
								<td width="15%"><gw:textbox id="txtAccGrpID" styles='width:100%' onenterkey="Search()" /> </td>
							    
							    <td width="10%" align="center"><font color="black" ><b>Acc Group Name</b></font></td>					
								<td width="15%"><gw:textbox id="txtAccGrpName" styles='width:100%' onenterkey="Search()" /> </td>
    ...
    <gw:textbox id="txtInput_PK"    text="" style="display" />
