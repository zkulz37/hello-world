...
function OnSave(pos)
{
    ...
    {
        case 'Item':
            data_dsmt00010_2.Call();   
        break;        
        case 'Group':
            data_dsmt00010_1.Call();
        break;     
    }   
}
//------------------------------------------------------------ 
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        case "data_dsmt00010_3":
             data_dsmt00010_2.Call("SELECT");
        break;
        
        case 'data_dsmt00010_2':
            lblRecord.text = grdItem.rows-1 + ' row(s)';
        break;
                
        case 'data_dsmt00010_1':
            OnSearch('Group');
        break;  
...
function OnSearch(pos)
{
    ...
    {
        case 'Group':
            data_dsmt00010.Call("SELECT");
        break;
        
        case 'ItemList': 
            txtGroup_PK.SetDataText(oTree.GetCurrentNode().oid);
            
            data_dsmt00010_3.Call("SELECT");                              
        break;    
    }
}
//===========================================================
...
function OnReport()
{
    var url =System.RootURL + "/reports/ds/mt/rpt_dsmt00010.aspx?p_item="+txtItem.text+"&p_grp_pk="+txtGroup_PK.text; 
...
<body>
    <!------------------------------------------------------------------------------->
    <gw:data id="data_dsmt00010" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="tree" function="<%=l_user%>lg_sel_dsmt00010" > 
                <input>
    ...
    <!------------------------------------------------------------------------------->
    <gw:data id="data_dsmt00010_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="control" parameter="0,1,2,3,4" function="<%=l_user%>lg_sel_dsmt00010_1"  procedure="<%=l_user%>lg_upd_dsmt00010_1"> 
                <inout> 
    ...
    <!------------------------------------------------------------------------------->
    <gw:data id="data_dsmt00010_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="control" parameter="0,1,2" function="<%=l_user%>lg_sel_dsmt00010_3"> 
                <inout> 
    ...
    <!------------------------------------------------------------------------------->
    <gw:data id="data_dsmt00010_2" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" parameter="0,1,2,3,4,5,6,7,8" function="<%=l_user%>lg_sel_dsmt00010_2" procedure="<%=l_user%>lg_upd_dsmt00010_2" > 
                <input bind="grdItem" > 
                    <input bind="txtItem" /> 
