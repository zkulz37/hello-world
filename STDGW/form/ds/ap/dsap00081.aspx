...
<head>
    <title>Pop Up Get From Collection Request</title>
</head>
<%  
...
function BodyInit()
{
    ...
    txtCustNM.text = callerWindowObj.txtCustomerName.text ;        
...
<body>
    <!---------------------------------------------------------------->
    <gw:data id="data_dsap00081" onreceive="OnReceiveData(this)"> 
    <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsap00081" > 
    ...
    <table style="width: 100%; height: 100%">
        <tr style="height: 1%">
            ...
            <td colspan="4">
                ...
                <gw:textbox id="txtCustNM" styles="width:100%" csstype="mandatory" />
            </td>			 
            <td style="width: 1%">
        ...
        <tr style="height: 48%">
            <td colspan="8">
                <gw:grid id='grdDetail' header='_PK|Chk|Req Date|No|Req Amt|Pay Amt|Bal Amt|Sel Amt|Tr CCY|Ex Rate|Req Emp|Collect Desc|_OutType_CD|Out Type'
