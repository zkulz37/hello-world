...
<head id="Head1" runat="server">
    <title>Payment Slip Approve</title>
</head>
...
function OnSearch(id)
{
    ...
    {
        case 'grdApprove':
            data_dsap00030.Call('SELECT');
        break;
        
        case 'grdCancel':
            data_dsap00030_1.Call('SELECT')
        break;
    }
}
//==================================================================
...
function OnPopUp(pos)
{
    switch(pos)
    {
        case'up':
            if ( grdApprove.row > 0 )
            {			                
                var path = System.RootURL + '/form/ds/ap/dsap00031.aspx?MasterPK=' + grdApprove.GetGridData( grdApprove.row, G1_PK );
        ...
        case'down':
            if ( grdCancel.row > 0 )
            {
                ...
                var path = System.RootURL + '/form/ds/ap/dsap00032.aspx?MasterPK=' + grdCancel.GetGridData( grdCancel.row, G2_PK );
...
{    txtDateFrom.text=dtFrom2.value;
    txtDateTo.text=dtTo2.value;
     var url =System.RootURL + "/reports/fp/ip/rpt_dsap00030.aspx?dtFrom="+txtDateFrom.text+"&dtTo="+txtDateTo.text ;
...
function OnDataReceive(obj)
{
    switch(obj.id)
    {
        ...
        case 'pro_dsap00030_1' :
            alert(txtReturnValue.text);
            
            OnSearch('grdCancel') ;
        break;   
        case 'pro_dsap00030_3' :
            alert(txtReturnValue.text);
            OnSearch('grdApprove') ;
        break;
...
<body>
    <!--------------------------------------------------------------------->
    <gw:data id="data_dsap00030" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_dsap00030"  >
    ...
    <!--------------------------------------------------------------------->
    <gw:data id="data_dsap00030_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_dsap00030_1"  >
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_dsap00030" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsap00030" > 
                <input>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_dsap00030_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsap00030_1" > 
                <input>
                    <input bind="txtArraySOPK" /> 
                </input> 
                <output>
        ...
        <tr style="height: 50%" id="tab_top">
            <td>
                <table style="width: 100%; height: 100%">
                    ...
                    <tr style="height: 99%">
                        <td colspan="10">
							<gw:grid id='grdApprove' header='Chk|_pk|Slip Date|Slip No|Status|Partner Name|Pay Amount|CCY|Ex Rate|In Type|Pay Desc'
            ...
            <td>
                <table style="width: 100%; height: 100%" border="0">
                    <tr>
                        ...
                        <td style="width: 20%">
                            <gw:textbox id="txtSlipRefNo2" maxlen="100" styles='width:100%' onenterkey="OnSearch('grdCancel')" />
                        </td>
                    ...
                    <tr style="height: 99%">
                        <td colspan="14">
							<gw:grid id='grdCancel' header='_pk|Slip Date|Slip No|Status|Partner Name|Pay Amount|CCY|Ex Rate|In Type|Pay Desc'
