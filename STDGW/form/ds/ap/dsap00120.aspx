...
<head id="Head1" runat="server">
    <title>Collection Closing </title>
</head>
  ...
  function OnPopUp(pos)
 {
	switch(pos)
	{
		...
		case 'View_Detail':
		    ...
		    {
			var path = System.RootURL + '/form/ds/ap/dsap00121.aspx?master_pk=' + grdReqDetail.GetGridData(grdReqDetail.row,iColMPK) ;
...
<body style="margin:0 0 0 0; padding:0 0 0 0;">   
    <gw:data id="dsap00120" onreceive="OnDataReceive(this)"> 
            <xml> 
                <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsap00120" parameter="0,1" procedure="<%=l_user%>lg_upd_dsap00120"> 
    ...
    <!------------------------------------------------------------------>
     <gw:data id="dsap00120_1" onreceive="OnDataReceive(this)"> 
            <xml> 
                <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsap00120" parameter="0,1" procedure="<%=l_user%>lg_upd_dsap00120_1"> 
                    <input bind="grdReqDetail" > 
                        <input bind="dtFrom" /> 
                        <input bind="dtTo" />  
                        <input bind="txtOrderNo" />
    ...
    <table style="width: 100%; height: 100%" border="1">
        ...
        <tr style="height: 40%">
            <td style="width: 100%">
                <gw:grid id='grdReqDetail' header='Select|_pc_collect_req_m_pk|Partner ID|Partner Name|Req Date|Ref No|Slip No|Item Amt|Vat Amt|Total Amt|Collection Amt|Bal Amt|CCY|Ex Rate|Desc'
