...
<head>
    <title>Payment Balance Checking Popup</title>
</head>
<%  
...
var G_SLIP_NO		= 0,
	...
	{        
	    ...
	    txtPaymentReqPK.text =  callerWindowObj.txtPaymentReqPK.text ;
...
<body>
    <!------------------------------------------------------------------>
    <gw:data id="data_dsap00051" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="sale"   function="<%=l_user%>lg_sel_dsap00051" > 
                <input> 
                    <input bind="txtPaymentReqPK" /> 
                </input> 
    ...
    <table style="width: 100%; height: 100%" border="0">
        ...
        <tr style="height: 99%">
            <td colspan="9">
                <gw:grid id='grdDetail' header='Slip No|Slip Date|Seq|Pay Amount|CCY|Ex Rate|Payment Desc'
