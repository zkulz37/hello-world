...
<body>
    ...
    <!---------------------------------------------------------------->
    <gw:data id="pro_dsap00031" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsap00031" > 
                <input>
                    <input bind="txtMasterPK" /> 
                </input> 
                <output>
            ...
            <td id="t-right" style="width: 70%">
                <table style="width: 100%; height: 100%">
                    <tr style="height: 1%">
                        ...
                        <td style="width: 1%">
                            <gw:icon id="idBtnSubmit" img="2" text="Approve" styles='width:100%' onclick="OnProcess('approve')" />
                        </td>
                    </tr>
                    <tr style="height: 1%">
