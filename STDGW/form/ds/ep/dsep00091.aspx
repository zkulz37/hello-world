...
<head>
    <title>Stock Incoming List</title>
</head>
<%  
...
<body>
     <!-------------------------------------------------------------------->
     <gw:data id="pro_dsep00091" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="<%=l_user%>lg_pro_dsep00091" > 
                <input>
      ...
      <!--------------------------------------------------------------------------->
      <gw:data id="data_dsep00091" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsep00091" > 
            ...
            <tr>
                ...
                <td style="width: 1%">
                  <gw:icon id="btnCancelIncome" img="2" text="Cancel" alt="Auto Take In"
                                    styles='width:100%' onclick="OnProcess('INCOME')" />
                </td>
            </tr>
            <tr style="height: 90%">
                <td colspan="12">
                 <gw:grid id='grdPackages'
                    header='_PR_PROD_INCOME_M_PK|Slip No|Partner Name|SO/PO No|Style ID|Item BC|Pack Seq|Line|Item Code|Item Name|UOM|In Qty'
