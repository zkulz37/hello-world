...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'POApprove':
            if ( grdApprove.row > 0 )
            {
                var path = System.RootURL + '/form/ds/re/dsre00011.aspx?trans_pk=' + grdApprove.GetGridData( grdApprove.row, G1_PK);
         ...
         case 'POCancel':
            if ( grdCancel.row > 0 )
            {
                    var path = System.RootURL + '/form/ds/re/dsre00012.aspx?trans_pk=' + grdCancel.GetGridData( grdCancel.row, G2_PK);
...
{    
    ...
    var url =System.RootURL + "/reports/ds/re/rpt_dsre00010.aspx?dtFrom="+txtDateFrom.text+"&dtTo="+txtDateTo.text ;
...
<body>
    ...
    <gw:data id="data_dsre00010" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_SEL_dsre00010"  >
    ...
    <gw:data id="data_dsre00010_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_SEL_dsre00010_1"  >
    ...
    <gw:data id="pro_dsre00010" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsre00010" > 
                <input>
    ...
    <gw:data id="pro_dsre00010_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsre00010_3" > 
                <input>
                    <input bind="txtInComePK" />
    ...
    <gw:data id="pro_dsre00010_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsre00010_1" > 
                <input>
                    <input bind="txtInComePK" /> 
                </input> 
                <output>
