...
function OnReport()
{           
      var url =System.RootURL + '/reports/ds/re/rpt_dsre00040.aspx?p_from_date='+ dtFrom.value + '&p_to_date=' + dtTo.value + '&p_status=' + lstStatus.value +'&p_item=' + txtSearchNo.text ;
...
<body>
    ...
    <gw:data id="data_dsre00040" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsre00040" > 
