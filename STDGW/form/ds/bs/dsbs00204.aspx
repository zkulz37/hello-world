...
<body> 
    ...
    <gw:data id="pro_dsbs00204" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dsbs00204" > 
                <input>
    ...
    <gw:data id="data_dsbs00204" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="control" function="<%=l_user%>lg_sel_dsbs00204" parameter="0,1,2,3,4,5,6,7" procedure="<%=l_user%>lg_upd_dsbs00204" > 
                <input>
    ...
    <gw:data id="data_dsbs00204_1" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="control" function="<%=l_user%>lg_sel_dsbs00204_1" > 
                <input>
                    <inout bind="txtItemPK" />
                    <inout bind="txtItemCode" />
                    <inout bind="txtItemName" />
