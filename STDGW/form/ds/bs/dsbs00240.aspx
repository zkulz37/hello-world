...
<script>
 ...
 function OnReport(pos)
 {
	...
	{
		case 'SALE_SUM':
			var url = System.RootURL + '/reports/ds/bs/rpt_dsbs00241.aspx?p_f_out_type='+ dtFMonTab2.value +'&p_t_out_type='+dtTMonTab2.value +'&p_partner=' + txtCustTab2.text ;
		   
           System.OpenTargetPage(url); 		
		break;
		
		case 'DEBIT':
			var url = System.RootURL + '/reports/ds/bs/rpt_dsbs00240.aspx?p_partner_pk='+ txtPartnerPK.text 
		...
		case 'SALE_SUM_T4':
			var url = System.RootURL + '/reports/ds/bs/rpt_dsbs00242.aspx?p_f_out_type='+ dtFMonTab4.value +'&p_t_out_type='+dtTMonTab4.value +'&p_partner=' + txtCustTab4.text ;		   
            System.OpenTargetPage(url); 				
		break;
	}
 }
...
<body>   
    ...
    <gw:data id="data_dsbs00240_2" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsbs00240_2" > 
    ...
    <gw:data id="data_dsbs00240_3" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsbs00240_3" > 
    ...
    <gw:data id="data_dsbs00240" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsbs00240" > 
    ...
    <gw:data id="data_dsbs00240_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsbs00240_1" > 
    ...
    <gw:data id="pro_dsbs00240" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="<%=l_user%>lg_pro_dsbs00240" > 
                <input>
                     <input bind="txtPartnerPK" /> 
					 <input bind="dtYearTab1" />
					 <input bind="lstMonthTab1" />
            ...
            <td style="width: 70%" id='right'>
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%"> 
						...
						<td style="width: 9%">
							<gw:icon id="idBtnCollection" img="2" text="Collection Req" styles='width:100%' onclick="OnProcess('COLLECT_REQ')" />
						</td>
						...
						<td>
							<table style="width: 100%; height: 100%">
								<tr>	
									...
									<td style="width: 1%">
			                            <gw:imgbtn id="ibtnExcel3" img="excel" alt="Report" text="Report" onclick="OnReport('AR_BAL')" />
			                        </td>								
								</tr>
							</table>
						</td>                       
