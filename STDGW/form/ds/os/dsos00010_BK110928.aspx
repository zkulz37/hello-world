...
<script>
    ...
    //===============================================================
    function OnPrint() {
        var url = System.RootURL + '/reports/ds/os/rpt_dsos00010.aspx?p_tsa_saleorder_pk=' + txtOrderPK.text;
        window.open(url);
    }
</script>
...
<body>
    ...
    <gw:data id="data_dsos00010" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso id="1" type="grid" user="sale"   parameter="0,1,2,3" function="<%=l_user%>lg_sel_dsos00010" > 
                <input> 
                    <input bind="dtFrom" /> 
                    <input bind="dtTo" /> 
    ...
    <gw:data id="data_dsos00010_2" onreceive="OnDataReceive(this)"> 
        <xml> 
           <dso id="1" type="grid" function="<%=l_user%>lg_sel_dsos00010_2" > 
                  <input > 
    ...
    <gw:data id="pro_dsos00010_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="process" procedure="<%=l_user%>lg_pro_dsos00010_3" > 
                <input>
                     <input bind="txtOrderListPK" /> 
                </input> 
                <output> 
                            ...
                            <table style="width: 100%; height: 100%; background-color: #B4E7FF">
                                <tr style="height: 1%">
                                    ...
                                    <td style="width: 1%; white-space: nowrap">
                                        <gw:icon id="idBtnTOReq" img="2" text="Make Outgoing Req" styles='width:100%' onclick="OnProcess('TOReq')" />
                                    </td>
                                    <td style="width: 1%">
                                        <gw:icon id="idBtnMR" img="2" text="Make P/R" styles='width:100%' onclick="OnProcess('MR')" />
                                    </td>
                                    <td style="width: 1%">
                                        <gw:icon id="idBtnCancelMR" img="2" text="Cancel P/R" styles='width:100%' onclick="OnProcess('Cancel_MR')" />
                                    </td>
                                </tr>
                            </table>
                        </td>
