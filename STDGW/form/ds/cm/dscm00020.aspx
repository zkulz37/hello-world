...
function OnPopUp(pos)
{
    switch(pos)
    {
         case 'CMConfirm':
            if ( grdConfirm.row > 0 )
            {
                var path = System.RootURL + '/form/ds/cd/dscd00091.aspx?type=APPROVE&OUTGO_PK=' + grdConfirm.GetGridData( grdConfirm.row, G1_CLAIM_PK);
         ...
         case 'CMApprove':
            if ( grdApprove.row > 0 )
            {
                    var path = System.RootURL + '/form/ds/cd/dscd00091.aspx?type=CANCEL&OUTGO_PK=' + grdApprove.GetGridData( grdApprove.row, G2_CLAIM_PK);
...
<body>
    ...
    <gw:data id="data_dscm00020" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="1" type="grid"  function="<%=l_user%>lg_sel_dscm00020"  >
    ...
    <gw:data id="data_dscm00020_1" onreceive="OnDataReceive(this)">
        <xml> 
            <dso id="2" type="grid"  function="<%=l_user%>lg_sel_dscm00020_1"  >
    ...
    <gw:data id="pro_dscm00020_3" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dscm00020_3" > 
                <input>
    ...
    <gw:data id="pro_dscm00020_4" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso type="process" procedure="<%=l_user%>lg_pro_dscm00020_4" > 
                <input>
                    <input bind="txtOutGoPK" /> 
                </input> 
                <output>
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:icon id="btnViewDetail" img="2" text="View Detail" onclick="OnPopUp('CMConfirm')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="11">
            ...
            <td>
                <table style="width: 100%; height: 100%">
                    <tr>
                        ...
                        <td style="width: 1%">
                            <gw:icon id="btnViewDetail1" img="2" text="View Detail" onclick="OnPopUp('CMApprove')" />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="13">
