...
function OnPopupDailySL()
{
        ...
        if (rownum > 0) 
        {
	        if ( ac_pk!='')
	        {
		        ...
		        var fpath = System.RootURL + '/form/60/08/60080140_popup_3.aspx?ac_pk='+ ac_pk + '&ac_nm=' + ac_nm + '&compk=' + lstCompany.GetData() + '&status=' + rbstatus.GetData() + '&lang='+ lstLanguage.GetData() + '&cur=' + lstCurrency.GetData() + '&date_fr=' + dtbMonth.GetData() + '&date_to=' + dtbMonth.GetData() + '&type_month=1';
		        var wWidth = 950;
		        var wHeight = 500;
