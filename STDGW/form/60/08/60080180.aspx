...
//                    {
//                        case "1"://Monthly
                              var url = '/reports/gf/ka/gfka00080_BS_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() + '&p_exrate=' +  txtrate1.text;
							 // alert(url);
                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                        break;
//                        case "2"://Quarter
//                            var url = '/reports/gf/ka/gfka00080_BS_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData();
//                              System.OpenTargetPage( System.RootURL+url , "newform" ); 
//                        break;
//                        case "3"://Year
//                             var url = '/reports/gf/ka/gfka00080_BS_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()+"&p_Scale="+txtScale.GetData();
...
//                    {
//                        case "1"://Monthly
                              var url = '/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                        break;
//                        case "2"://Quarter
//                            var url = '/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() ;
//                              System.OpenTargetPage( System.RootURL+url , "newform" ); 
//                        break;
//                        case "3"://Year
//                             var url = '/reports/gf/ka/gfka00080_BS_ENG.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() ;
...
//                    {
//                        case "1"://Monthly
                              var url = '/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                        break;
//                        case "2"://Quarter
//                            var url = '/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() ;
//                              System.OpenTargetPage( System.RootURL+url , "newform" ); 
//                        break;
//                        case "3"://Year
//                             var url = '/reports/gf/ka/gfka00080_BS_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() ;
...
//                    {
//                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()  + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                        break;
//                        case "2"://Quarter
//                        var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData() ;
//                              System.OpenTargetPage( System.RootURL+url , "newform" );
...
//                    {
//                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()  +"&p_Scale="+txtScale.GetData()  + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                        break;
//                        case "2"://Quarter
//                        var url = '/reports/gf/ka/gfka00080_BS_ENG_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()  +"&p_Scale="+txtScale.GetData() ;
//                              System.OpenTargetPage( System.RootURL+url , "newform" );
//                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
//                        break;
//                        case "3"://Year
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    switch(rdoType.value)
                    {
						...
						case "3"://Year
						case "4":
                             var url = '/reports/gf/ka/gfka00080_BS_KOR_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData()  +"&p_Scale="+txtScale.GetData() + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    switch(rdoType.value)
                    {
						...
						case "3"://Year
						case "4":
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData()  + '&p_exrate=' +  txtrate1.text;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
