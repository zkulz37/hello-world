         ...
         case "KOR":
            ...
            switch(x)
            {
                ...
                case 25: // Income statement
                    ...
                    {
                        case "1"://Monthly
                             f_nm='/reports/gf/ka/gfka00080_IC_M_KOR.aspx'+r;
...
p= p + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();  
            p=p+"&p_quarter="+lstQuater.GetData(); 
                            f_nm='/reports/gf/ka/gfka00080_IC_QUARTER_KOR.aspx'+p;  
                             System.OpenTargetPage( System.RootURL+f_nm , "newform" );
                        break;
                        case "3"://Year
                             f_nm='/reports/gf/ka/gfka00080_IC_YEAR_KOR.aspx'+r;   
                              System.OpenTargetPage( System.RootURL+f_nm , "newform" );
                        break;
                    }
                break;
        ...
        case "KOR-VIE":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_KOR_VIE.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
        ...
        case "ENG-VIE-KOR":
            ...
            switch(x)
            {
                case 21:
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/gf/ka/gfka00080_BS_ENG_VIE_KOR.aspx?p_status='+ rbstatus.GetData() +'&p_company_pk=' + lstCompany.GetData() + '&p_date_f=' + dtfrdate.GetData() + '&p_date_t=' + dttodate.GetData() + '&p_kind=' + txtFinancialType.GetData() + '&p_crt_by=' + emp_id+"&p_ccy="+lstCurrent.GetData() +"&p_Scale="+txtScale.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           // f_nm='gfka00080_CF_QUARTER_KOR.aspx';    
...
function OnPrint()
{
			...
			if(txtFinancialType.GetData()=="21" && lstLang.GetData()=='ENG-VIE-KOR'||lstLang.GetData()=='ENG-KOR'||lstLang.GetData()=='ENG-VIE'||lstLang.GetData()=='KOR-VIE')
					{
						var url = System.RootURL + "/reports/60/08/rpt_60081336_eng_vie_kor.aspx?p_tco_company_pk=" + lstCompany.value+"&p_from_month="+ dtfrdate.value+ "&p_to_month="+ dttodate.value+"&p_status="+rbstatus.value+"&p_scale="+txtScale.text+"&p_from_text="+dtfrdate.text+"&p_to_text="+dttodate.text+"&p_ccy="+lstCurrent.GetData()+'&p_lang='+lstLang.value+"&p_text_company="+lstCompany.GetData();
						System.OpenTargetPage(url); 
					}
			...
			if(txtFinancialType.GetData()=="25")
					{
						var url = System.RootURL + "/reports/60/08/rpt_60081336_IC.aspx?p_form_type=" + txtFinancialType.GetData()+"&p_status="+ rbstatus.value+ "&p_tco_company_pk="+ lstCompany.value+"&p_date_fr="+dtfrdate.value+"&p_date_to="+dttodate.value+
			...
			if(txtFinancialType.GetData()=="24"&& lstLang.GetData()=='ENG-VIE-KOR'||lstLang.GetData()=='ENG-KOR'||lstLang.GetData()=='ENG-VIE'||lstLang.GetData()=='KOR-VIE')					{
						var url = System.RootURL + "/reports/60/08/rpt_60081336_CF_DI.aspx?p_kind=" + txtFinancialType.GetData()+"&p_status="+ rbstatus.value+ "&p_tco_company_pk="+ lstCompany.value+"&p_date_fr="+dtfrdate.value+"&p_date_to="+dttodate.value+
						"&p_date_type="+txtDateType.value+"&p_scale="+txtScale.text+"&p_ccy="+lstCurrent.value+"&p_exrate="+txtrate1.GetData()+"&p_month="+dtMonth.value+						
						"&p_from_text="+dtfrdate.text+"&p_to_text="+dttodate.text+"&p_text_ccy="+lstCurrent.GetData()+'&p_lang='+lstLang.value;
						System.OpenTargetPage(url); 																								
			...
			if(txtFinancialType.GetData()=="24"&& lstLang.GetData()=='VIE')				
					{
						var url = System.RootURL + "/reports/60/08/rpt_60081336_CF_DI_VIE.aspx?p_kind=" + txtFinancialType.GetData()+"&p_status="+ rbstatus.value+ "&p_tco_company_pk="+ lstCompany.value+"&p_date_fr="+dtfrdate.value+"&p_date_to="+dttodate.value+
						"&p_date_type="+txtDateType.value+"&p_scale="+txtScale.text+"&p_ccy="+lstCurrent.value+"&p_exrate="+txtrate1.GetData()+"&p_month="+dtMonth.value+						
						"&p_from_text="+dtfrdate.text+"&p_to_text="+dttodate.text+"&p_text_ccy="+lstCurrent.GetData()+'&p_lang='+lstLang.value;
						System.OpenTargetPage(url); 																								
