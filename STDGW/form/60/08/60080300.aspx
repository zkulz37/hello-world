...
function onReport()
{
    ...
    {     
      var url = '/reports/60/08/60080300_TrialBalanceENG.aspx?p_compk='+ lstCompany.value;
	 ...
	 {
	    var url = '/reports/60/08/60080300_TrialBalance_VIE.aspx?p_compk='+ lstCompany.value;
	        url =   url + '&p_lang=' + lstLang.value + '&p_date_fr='+ dtfrmonth.value + '&p_date_to=' + dttomonth.value + '&p_status=';
	        url =   url + lstStatus.value + '&p_current=' + lstCurrent.value + '&p_rate=' + txtrate1.text+ '&p_level=' + lstLevel.value + '&p_possum=' + lstPostSum.value  + '&p_accd=' + txtac_cd.text + '&p_check=' + txt_check.text + '&p_pacctype=' + lstAccType.value;
	        System.OpenTargetPage( System.RootURL+url , "newform" );
	 }
	 ...
	 {
	    var url = '/reports/60/08/60080300_TrialBalanceKOR.aspx?p_compk='+ lstCompany.value;
	        url =   url + '&p_lang=' + lstLang.value + '&p_date_fr='+ dtfrmonth.value + '&p_date_to=' + dttomonth.value + '&p_status=';
	        url =   url + lstStatus.value + '&p_current=' + lstCurrent.value + '&p_rate=' + txtrate1.text+ '&p_level=' + lstLevel.value + '&p_possum=' + lstPostSum.value  + '&p_accd=' + txtac_cd.text + '&p_check=' + txt_check.text + '&p_pacctype=' + lstAccType.value;
	        System.OpenTargetPage( System.RootURL+url , "newform" );
	 }
    /* var url = '/reports/60/08/60080300_TrialBalance.aspx?p_compk='+ lstCompany.value;
	        url =   url + '&p_lang=' + lstLang.value + '&p_date_fr='+ dtfrmonth.value + '&p_date_to=' + dttomonth.value + '&p_status=';
	        url =   url + lstStatus.value + '&p_current=' + lstCurrent.value + '&p_rate=' + txtrate1.text+ '&p_level=' + lstLevel.value + '&p_possum=' + lstPostSum.value  + '&p_accd=' + txtac_cd.text + '&p_check=' + txt_check.text + '&p_pacctype=' + lstAccType.value;
	        System.OpenTargetPage( System.RootURL+url , "newform" );*/
