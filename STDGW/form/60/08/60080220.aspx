...
function OnPopUp(pname)
{
    if (pname=='ACCT')
   {
        var fpath = System.RootURL + "/form/gf/co/ffco002000.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=AC_SEL_ACCD_PL";
...
function OnPrint()
{
    var url ='/reports/60/08/60080220_1.aspx?kind=' + lstReport.value +'&status=' + lstStatus.value + '&tco_company_pk=' + lstCompany.value + '&date_fr='+txtFROM_DATE.value + '&user=' + txtUser.text + '&Acc_pk=' + txtACPK.text + '&date_to=' + txtTO_DATE.value;
