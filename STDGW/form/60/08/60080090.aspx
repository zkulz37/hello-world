...
function OnReport()
{
	...
	{
		var url = '/reports/gf/ka/gfka00160_SotienguiNH_S08DN2_Cust.aspx?company_pk='+lstCompany.value+'&bank_pk='+bankpk+'&dtbFrom=' +dtbFrom.value+ '&dtbTo=' + dtbTo.value+'&ccy=ALL&status='+rdoSlipStatus.value+'&bookccy='+lstBookCcy.value+'&account_pk='+txtAC_PK.text;
		System.OpenTargetPage( System.RootURL+url , "newform" );
	}
}
</script>
