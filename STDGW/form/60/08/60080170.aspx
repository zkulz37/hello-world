...
function onReport(lang)
{
    ...
    switch(lang)
    {
        case "VIE":
             ...
             r= r + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData()+'&p_lang='+lstLang.value;  
...
p= p + '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();  
            p=p+"&p_quarter="+lstQuater.GetData()+'&p_lang='+lstLang.value;
                            f_nm='/reports/gf/ka/gfka00080_IC_QUARTER_KOR.aspx'+p;  
							//f_nm='/reports/60/08/rpt_60080170_IC_QUARTER_KOR.aspx'+p;
                             System.OpenTargetPage( System.RootURL+f_nm , "newform" );
                        break;
                        case "3"://Year
