    ...
    switch(lang)
    {
        case "VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "23": // Cash Flow(Indirect method)
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                    ...
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                            ...
                            //f_nm='gfka00080_CF_I_M_KOR_VIE.aspx';
                             f_nm='gfka00080_CF_I_M_ENG_KOR.aspx';  
                        break;
                        case "2"://Quarter
                            //f_nm='gfka00080_CF_I_Q_KOR_VIE.aspx';   
                             f_nm='gfka00080_CF_I_Q_ENG_KOR.aspx';   
                        break;
                        case "3"://Year
...
<body style="margin: 0; padding: 0;">
  ...
  <gw:data id="dso_getCompany" onreceive="OnDataReceive(this)"> 
    ...
    <gw:data id="dso_sel_grd_balance_sheet" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="AC_sel_60080250_1">
                <input bind="grid_bs">
                    <input bind="txtFinancialType"/>
                    <input bind="txtScale"/>
				    <input bind="lstCompany"/>
    ...
    <gw:data id="dso_sel_grd_income" onreceive="onSetFont(this)">
        <xml>
            <dso type="grid" function="ac_sel_60080240_statement2">
                <input bind="grid_ic">
                    <input bind="txtFinancialType"/>
                    <input bind="rbstatus"/>
                    <input bind="lstCompany"/>
