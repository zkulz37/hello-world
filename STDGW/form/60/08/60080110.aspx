...
function BindingDataList()
{
	...
	var ls_data3 = "<%=ESysLib.SetListDataSQL("SELECT D.CODE, D.CODE_LNM  FROM TAC_COMMCODE_MASTER M, TAC_COMMCODE_DETAIL D WHERE M.DEL_IF =0 AND D.DEL_IF =0 AND M.PK = TAC_COMMCODE_MASTER_PK AND M.ID='EACBK035'  ORDER BY D.DEF_YN DESC, D.ORD")%>";	
