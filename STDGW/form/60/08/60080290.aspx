...
function GetAccount()
{
    var fpath = System.RootURL + "/form/gf/co/ffco002000.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=AC_SEL_ACCT_BANK";
...
function OnReport()
{
	...
	{
	 var url = '/reports/60/08/60080290.aspx?company_pk='+lstCompany.value+'&dtbFrom=' +dtbFrom.value+ '&dtbTo=' + dtbTo.value+'&status='+rdoSlipStatus.value+'&bookccy='+lstBookCcy.value;
            System.OpenTargetPage( System.RootURL+url , "newform" );
	}
	
	if(lstReportType.value=='CHB')
	{
	 var url = '/reports/60/08/60080290_daily.aspx?company_pk='+lstCompany.value+'&dtbFrom=' +dtbFrom.value+ '&dtbTo=' + dtbTo.value+'&status='+rdoSlipStatus.value+'&bookccy='+lstBookCcy.value;
            System.OpenTargetPage( System.RootURL+url , "newform" );
	}
	if(lstReportType.value=='DCR')
	{
	 var url = '/reports/60/08/60080290_DailyCashReport.aspx?Company_pk='+lstCompany.value+'&From=' +dtbFrom.value+ '&To='  + dtbTo.value+ '&Bank_pk=' + lstDepositAccount.value +'&Status='+rdoSlipStatus.value+'&Ccy='+lstCurrency.value;
            System.OpenTargetPage( System.RootURL+url , "newform" );
	}
