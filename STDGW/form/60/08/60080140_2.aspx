...
function Popup_Acc()
{
    var fpath = System.RootURL + "/form/60/08/60080050_popup_Acc.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_SEL_60080140_ACCT_POPUP";
...
function Popup_Cur()
{
    var fpath = System.RootURL + "/form/60/08/60080140_popup_1.aspx";
...
function OnPopupDailySL()
{
	...
	if (rownum > 1)		 
	{
		if (event.col > 1)
		{
			...
			var fpath   = System.RootURL + '/form/60/08/60080140_popup_3.aspx?ac_pk='+ ac_pk + '&ac_nm=' + ac_nm + '&compk=' + lstCompany.GetData() + '&status=' + lstStatus.GetData() + '&lang='+ lstLang.GetData() + '&cur=' + lstCurrent.GetData() + '&date_fr=' + dtfrmonth.GetData() + '&date_to=' + dttomonth.GetData() + '&type_month=' + lstBalance.GetData();
