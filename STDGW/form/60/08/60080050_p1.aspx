...
function RowClick()
{
   var rows =0;
    ...
    if (rownum > 0) 
    {
        var fpath = System.RootURL + '/form/60/08/60080040_popup.aspx?PK_ROW=' + pk + '&ROW=' + rownum + '&ROWS=' + rows + '&APPRCANCEL=' + status;
        var wWidth = 950;
        var wHeight = 600;
...
<body style="margin:0; padding:0;">
   ...
   <gw:data id="datSLByDate" onreceive="OnDataReceive(this)" onerror="">
      ...
      <gw:data id="datSLByVoucher" onreceive="OnDataReceive(this)" onerror="">
        <xml>
