...
function Popup_PL()
{
    var fpath = System.RootURL + "/form/60/08/60080030_popup_bank.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=ac_sel_60110120_pl_popup&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";
...
function Popup_Acc()
{
    var fpath = System.RootURL + "/form/60/03/60030010_popup_ifrs.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60120170_acct_popup";
