...
function Popup_Cust()
{
    ...
    var fpath    = System.RootURL + '/form/60/09/60090010_vendor_popup.aspx?com_pk=' + lstCompany.GetData()+'&AR=Y'+'&company=Y';
...
function Popup_Acc()
{
    var fpath = System.RootURL + "/form/60/08/60080050_popup_Acc.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ACNT.AC_SEL_ACCT_POPUP";
