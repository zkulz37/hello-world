...
function BodyInit()
{
    ...
    //var ls_type     = "<=ESysLib.SetListDataSQL("SELECT TRIM(A.CODE), A.CODE_NM FROM TCO_ABCODE A, TCO_ABCODEGRP B WHERE A.DEL_IF = 0 AND B.DEL_IF = 0  AND A.TCO_ABCODEGRP_PK = B.PK AND B.ID = 'ACBG0020' AND A.USE_IF = 1 AND CODE IN ('21', '22', '23') ORDER BY ORD")%>";
                ...
                case "22": // Income statement
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                             ...
                             var url = '/reports/60/18/60180150_IS_M_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/reports/60/18/60180150_IS_Q_VIE.aspx'+r;//?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                            var url = '/reports/60/18/60180150_IS_Y_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
                ...
                case "24": // Cash Flows
                    switch(rdoType.value)
                    {
                        case "1"://Monthly
                             ...
                             var url = '/reports/60/18/60180150_CF_M_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();;
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/reports/gf/rv/gfrv00050_CF_Q_VIE.aspx'+r;//?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                            var url = '/reports/60/18/60180150_CF_Y_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
        ...
        case "ENG":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21": // balance sheet
                    ...
                    {
                        case "1"://Monthly
                              var url = '/reports/60/18/60180150_BS_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/60/18/60180150_BS_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                ...
                case "22": // Income statement
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_IS_M_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/reports/60/18/60180150_IS_Q_ENG.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_IS_Y_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_CF_M_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                            var url = '/reports/60/18/60180150_CF_Q_ENG.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_CF_Y_ENG.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
         ...
         case "KOR":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21": // balance sheet
                    ...
                    {
                        case "1"://Monthly
                              var url = '/reports/60/18/60180150_BS_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                               var url = '/reports/60/18/60180150_BS_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                ...
                case "22": // Income statement
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_IS_M_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                             var url = '/reports/60/18/60180150_IS_Q_KOR.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_IS_Y_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
               ...
               case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_CF_M_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                             var url = '/reports/60/18/60180150_CF_Q_KOR.aspx'+r;
                            System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_CF_Y_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
        ...
        case "ENG-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_BS_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/60/18/60180150_BS_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                ...
                break;
                 case "22": // Cash Flow (Direct method)
                    ...
                    {
                        case "1"://Monthly
                            var url = '/reports/60/18/60180150_IS_M_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                             var url = '/reports/60/18/60180150_IS_Q_ENG_VIE.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                           var url = '/reports/60/18/60180150_IS_Y_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                break;
               ...
               case "24": // Cash Flow (Direct method)
                    ...
                    {
                        case "1"://Monthly
                            var url = '/reports/60/18/60180150_CF_M_ENG_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
        ...
        case "KOR-VIE":
            ...
            switch(txtFinancialType.GetData())
            {
                case "21":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_BS_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/60/18/60180150_BS_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                ...
                case "22":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_IS_M_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/60/18/60180150_IS_Q_KOR_VIE.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_IS_Y_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_CF_M_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                           var url = '/reports/60/18/60180150_CF_Q_KOR_VIE.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_CF_Y_KOR_VIE.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
        ...
        case "ENG-VIE-KOR":
            ...
            switch(txtFinancialType.GetData())
            {
                ...
                case "22":
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_IS_M_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                         var url = '/reports/60/18/60180150_IS_Q_ENG_VIE_KOR.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_IS_Y_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
                ...
                case "24": // Cash Flows
                    ...
                    {
                        case "1"://Monthly
                             var url = '/reports/60/18/60180150_CF_M_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                        case "2"://Quarter
                         var url = '/reports/60/18/60180150_CF_Q_ENG_VIE_KOR.aspx'+r;
                             System.OpenTargetPage( System.RootURL+url , "newform" );   
                        break;
                        case "3"://Year
                             var url = '/reports/60/18/60180150_CF_Y_ENG_VIE_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                              System.OpenTargetPage( System.RootURL+url , "newform" );
                        break;
                    }
                     //var url='/reports/gf/ka/'+f_nm+r;       
        ...
        case "ENG-KOR":
                            ...
                            switch(txtFinancialType.GetData())
                            {
                                            case "21":
                                                                ...
                                                                {
                                                                    case "1"://Monthly
                                                                         var url = '/reports/60/18/60180150_BS_ENG_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
                                                                          System.OpenTargetPage( System.RootURL+url , "newform" );
                                                                    break;
                                                                    case "2"://Quarter
                                                                       var url = '/reports/60/18/60180150_BS_ENG_KOR.aspx?p_form_type='+txtFinancialType.GetData()+'&p_status='+rbstatus.value+'&p_tco_company_pk='+lstCompany.GetData()+'&p_date_fr='+dtfrdate.GetData() + '&p_date_to='+ dttodate.GetData()+ '&p_date_type='+txtDateType.GetData()+"&p_Scale="+txtScale.GetData()+"&p_ccy="+lstCurrent.GetData()+ '&p_rate=' + txtrate1.GetData() + '&p_month=' + dtMonth.GetData();
