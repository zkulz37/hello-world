...
function onGetAcc()
{
var fpath = System.RootURL + "/form/60/18/60180130_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=AC_SEL_60180130_11";
...
//		                }
    ...
    case "KOR":
               ...
               if (lstReportType.value=="S03a2-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/18/60180130_SoNKchitienS03a2-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                 ...
                 if (lstReportType.value=="S01-DN-DR")
               {
                    var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/18/60180130_TKDUPSN.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
                  ...
                  if (lstReportType.value=="S01-DN-CR")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/18/60180130_TKDUPSC.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
              ...
              //Tai khoan doi ung tong phat sinh no
                if (lstReportType.value=="TGL-DR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/18/60180130_taikhoan_doiung_tongphatsinh_1.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                          }
                         else
