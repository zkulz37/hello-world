...
function OnPopUp(pname)
{
    if (pname=='ACCT')
   {
         var fpath = System.RootURL + "/form/60/18/60180140_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=AC_SEL_60180110_11";
    ...
    if (pname=='CENTER')
   {
        var fpath   = System.RootURL + "/form/gf/co/gfco002005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=ac_sel_60080140_pp_centerpk&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";            
    ...
    switch(lang)
    {
        case "ENG":
            ...
            if(confirm("Are you sure you want to report ?" ))
            {
                ...
                {
                    case "AS":
                        url = '/reports/60/18/60180140_DailyEntryInq_ENG.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                    ...
                    break;
                    case "S03a-DN":
                        url ='/reports/60/18/60180140_SoNKC_S03a-DN_ENG.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                     case "S03a-DN-TNDN":
                        url ='/reports/60/18/60180140_SoNKC_S03a-DN-TNDN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                    case "S03a-DN-PHT":
                         url ='/reports/60/18/60180140_SoNKC_S03a-DN_phieuHToan.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                         url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                    case "tmp":
                         url ='/reports/60/18/60180140_SoNKC_S03a-DN-TNDN(Invalid).aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                         url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                   break;
                }
         ...
         if(confirm("Are you sure you want to report ?" ))
            {
                ...
                {
                    case "AS":
                        url = '/reports/60/18/60180140_DailyEntryInq_VN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value+'&Lang='+lstLanguage.value;
                    break;
                    case "S03a-DN":
                        url ='/reports/60/18/60180140_SoNKC_S03a-DN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
                        url= url+'&Seq='+txtSeq.text+'&Company='+lstCompany.value+'&Status='+rdoSlipStatus.value+'&BookCcy='+lstBookCcy.value;
                    break;
                     case "S03a-DN-TNDN":
                        url ='/reports/60/18/60180140_SoNKC_S03a-DN-TNDN.aspx?DateFrom=' + dtbFrom.value+'&DateTo=' +dtbTo.value+'&Voucher='+txtVoucher_No.text;
