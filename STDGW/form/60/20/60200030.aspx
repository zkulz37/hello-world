...
function onReport()
{
   if(lstLang.value=="VIE")
	{
		var url = System.RootURL + '/reports/60/26/rpt_602630_yearly_fc_vie.aspx?p_year='+dtYear.value+'&p_tco_company_pk='+lstCompany.value+'&p_scale='+txtScale.text+'&p_ccy='+lstCurrent.value+'&p_exrate='+txtrate1.text+'&p_status='+rbstatus.value+'&p_language='+lstLang.value;
		System.OpenTargetPage(url); 
	}
	else
	{
		var url = System.RootURL + '/reports/60/26/rpt_602630_yearly_fc_eng_vie_kor.aspx?p_year='+dtYear.value+'&p_tco_company_pk='+lstCompany.value+'&p_scale='+txtScale.text+'&p_ccy='+lstCurrent.value+'&p_exrate='+txtrate1.text+'&p_status='+rbstatus.value+'&p_language='+lstLang.value;
		System.OpenTargetPage(url); 
	}
}
