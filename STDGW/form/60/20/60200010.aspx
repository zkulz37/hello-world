        ...
        case 'DailySL':
	        ...
	        if (rownum > 1)		 
	        {
		        if (event.col > 1)
		        {
			        ...
			        var fpath   = System.RootURL + '/form/60/08/60080050_p1.aspx?ac_pk='+ ac_pk + '&ac_nm=' + ac_nm + '&compk=' + lstCompany.GetData() + '&status=' + lstStatus.GetData() + '&lang='+ lstLang.GetData() + '&cur=' + lstCurrent.GetData() + '&date_fr=' + _col_fr + '&date_to=' + _col_to + '&type_month=' ;
