...
function onGetAcc()
{
	...
	var fpath = System.RootURL + "/form/60/19/gfff00020_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + '' + "&val2=" + '' + "&val3=" + lstCompany.value+'' + "&dsqlid=ac_sel_60190110_popup2";
...
//                            {
	                            ...
	                            var url =System.RootURL + '/reports/60/19/60190110_DateFormUp_ENG_DateFormUp_VIE.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
//                            }
//                            else
//                            {
//                                var url =System.RootURL + '/reports/60/19/60190110_Date_BookTrans.aspx'+rqt;
//                                System.OpenTargetPage( url , 'newform' );
//                            }
//		                }
//		                else
...
//	                           if(rdoAmountType.value == 2)
//	                           {
//	                                var url =System.RootURL + '/reports/60/19/60190110_GiongTrenForm_Voucher.aspx'+rqt;
//                                    System.OpenTargetPage( url , 'newform' );
//                               }
//                               else
//                               {
//                                     var url =System.RootURL + '/reports/60/19/60190110_GiongTrenForm_Vouche_Book_Trans.aspx'+rqt;
//                                    System.OpenTargetPage( url , 'newform' );
//                               }
//		                }
               ...
               if (lstReportType.value=="S03a2-DN")
               {
		                ...
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoNKchitienS03a2-DN_VIE.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S03a1-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoNKthutienS03a1-DN_VIE.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S07-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_Soquy_S07-DN.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="S07a-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoKToanCTquy_S07a-DN.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="TSQCTTM")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_T_SCTQT.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S01-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SoCaiNKC_So3b-DN.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
                ...
                if (lstReportType.value=="TGL")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_T_SOCAI.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
               ...
               /*if (lstReportType.value=="AS")
               {
                    ...
                    {
                        url =System.RootURL + '/reports/60/19/60190110_DailySL.aspx'+rqt;
                     }
                     else
                     {
                            url =System.RootURL + '/reports/60/19/60190110_DailySL_CCY.aspx'+rqt;
                     }
                    System.OpenTargetPage( url , 'newform' );
                    return;
               }*/
                 ...
                 if (lstReportType.value=="S01-DN-DR")
               {
                    var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_TKDUPSN.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
                  ...
                  if (lstReportType.value=="S01-DN-CR")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_TKDUPSC.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
              ...
              //Tai khoan doi ung tong phat sinh no
                if (lstReportType.value=="TGL-DR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_taikhoan_doiung_tongphatsinh_1.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                          }
                         else
                ...
                if (lstReportType.value=="TGL-CR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_taikhoan_doiung_tongphatsinh_2.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
              ...
              //so tien gui ngan hang
                if (lstReportType.value=="S08DN2")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_NH_S07-DN.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
              ...
              //so chi tiet tai khoan
                if (lstReportType.value=="S38-DN")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SoChitietTK_S38-DN_VIE.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
               ...
               if (lstReportType.value=="S38-DN2")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SoChitietTK_S38-DN2_VIE.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
               ...
               if (lstReportType.value=="S01-DN-CT")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SocaiNKC_S03b-DN_CostCenter.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
              ...
              if (lstReportType.value=="S01-DN-BIZ-CC")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SocaiNKC_S03b-DN_BIZ-CC.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
    ...
    case "KOR":
               ...
               if (lstReportType.value=="AS")
               {
                        if(rdoInquiryType.value == 1)
                        {
	                            var url =System.RootURL + '/reports/60/19/60190110_DateFormUp_ENG.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
		                }
		                else
		                {
	                           //var url =System.RootURL + '/reports/60/19/60190110_SoCaiNKC_So3b-DN.aspx'+rqt;
	                            var url =System.RootURL + '/reports/60/19/60190110_GiongTrenForm_Voucher_ENG.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
		                }
               ...
               if (lstReportType.value=="S03a2-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoNKchitienS03a2-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S03a1-DN")
               {
                       ...
                       rqt = "?p_company_pk="+lstCompany.value+'&p_acc_pk='+txtAccPK.text+'&p_date_from='+dtbFrom.value+'&p_date_to='+dtbTo.value+'&p_ccy='+lstCurrency.value + '&p_status='+rdoSlipStatus.value+ '&bookccy='+lstBookCcy.value;  
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoNKthutienS03a1-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="S07-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_Soquy_S07-DN.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="TSQCTTM")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_T_SCTQT.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="TGL")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_T_SOCAI.aspx'+rqt;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
...
//		                }
                ...
                if(lstReportType.value=="S01-DN")
              {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                                var url =System.RootURL + '/reports/60/19/60190110_SoCaiNKC_So3b-DN_ENG.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' ); 
                                return;
                         }
                         else
         ...
         //Nhat ky thu tien
                if (lstReportType.value=="S03a1-DN")
               {
                      ...
                      var p = "?p_company_pk="+lstCompany.value+'&p_acc_pk='+txtAccPK.text+'&p_date_from='+dtbFrom.value+'&p_date_to='+dtbTo.value+'&p_status='+rdoSlipStatus.value+'&p_ccy='+lstCurrency.value+'&p_openbal='+txtOpenBalance.text; 
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoNKthutienS03a1-DN_Eng.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="S03a2-DN")
               {
                   ...
                   if(rdoInquiryType.value == 1)
                   {
                        ...
                        if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                    {
                                var url =System.RootURL + '/reports/60/19/60190110_SoNKchitienS03a2-DN_Eng.aspx'+rqt;
                                System.OpenTargetPage( url , 'newform' );
                                return;
                            }
                         else
...
//            	}	 
                ...
                if (lstReportType.value=="S07-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_Soquy_S07-DN_ENG.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
               ...
               if (lstReportType.value=="S07a-DN")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_SoKToanCTquy_S07a-DN_Eng.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                ...
                if (lstReportType.value=="TGL")
               {
                    var s = new String (txtAccCode.text)
                      if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {   
                            var url =System.RootURL + '/reports/60/19/60190110_T_SOCAI_Eng.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                        else
               ...
               if (lstReportType.value=="TSQCTTM")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
		                        var url =System.RootURL + '/reports/60/19/60190110_T_SCTQT_Eng.aspx'+p;
                                System.OpenTargetPage( url , 'newform' );
                                return;
		                }
		                else
                 ...
                 if (lstReportType.value=="S01-DN-DR")
               {
                    var s = new String(txtAccCode.text)
                     if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_TKDUPSN_Eng.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                    else
                  ...
                  if (lstReportType.value=="S01-DN-CR")
               {
		                ...
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_TKDUPSC_Eng.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                        }
                         else
                ...
                if (lstReportType.value=="TGL-DR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_taikhoan_doiung_tongphatsinh_1_Eng.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                          }
                         else
                ...
                if (lstReportType.value=="TGL-CR")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_taikhoan_doiung_tongphatsinh_2_Eng.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
           ...
           if (lstReportType.value=="S08DN2")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_NH_S07-DN_ENG.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
                ...
                if (lstReportType.value=="S38-DN")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SoChitietTK_S38-DN_ENG.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
                ...
                if (lstReportType.value=="S38-DN2")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SoChitietTK_S38-DN2_ENG.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
              ...
              if (lstReportType.value=="S01-DN-CT")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SocaiNKC_S03b-DN_CostCenter_ENG.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
               ...
               if (lstReportType.value=="S01-DN-BIZ-CC")
               {
                     var s = new String(txtAccCode.text)
		                if ((s.substr(0,3)=="111")||(s.substr(0,3)=="112"))
		                {
                            var url =System.RootURL + '/reports/60/19/60190110_SocaiNKC_S03b-DN_BIZ-CC_ENG.aspx'+p;
                            System.OpenTargetPage( url , 'newform' );
                            return;
                         }
                         else
