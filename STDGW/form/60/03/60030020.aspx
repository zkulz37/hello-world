...
{ 
    var ls_data     = "<%=ESysLib.SetListDataFUNC("SELECT ac_f_commoncode('ACAB0050','','') FROM DUAL")%>";
    var ls_data1    = "<%=ESysLib.SetListDataFUNC("SELECT ac_f_commoncode('ACAB0180','01','') FROM DUAL")%>";
    var ls_data2    = "<%=ESysLib.SetListDataFUNC("SELECT ac_f_commoncode('ACAB0190','','') FROM DUAL")%>";
