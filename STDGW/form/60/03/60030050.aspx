...
var ls_data3 = "<%=ESysLib.SetListDataFUNC("SELECT ac_f_commoncode('ACAB0040','01','') FROM DUAL")%>";
var ls_data4 = "<%=ESysLib.SetListDataFUNC("SELECT ac_f_commoncode('ACAB0060','','') FROM DUAL")%>";
...
{ 
		var ls_data2 = "<%=ESysLib.SetListDataFUNC("SELECT SUBSTR(ac_f_commoncode('ACAB0070','',''), 1, INSTR(ac_f_commoncode('ACAB0070','',''), '|Y|SYSTEM') -1) || SUBSTR(ac_f_commoncode('ACAB0070','',''), INSTR(ac_f_commoncode('ACAB0070','',''), '|Y|SYSTEM') + LENGTH('|Y|SYSTEM')) FROM DUAL")%>";
}
...
{
    var fpath = System.RootURL + "/form/60/03/60030050_popup.aspx?company_pk="+lstCompany.value+'&transaction_pk='+lsttrangrp_search.value+'&slip_pk='+txt_PK.text+'&drcr_type='+drcr_type;
