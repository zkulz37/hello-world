...
{
	var data;
	data = "<%=ESysLib.SetListDataSQL("SELECT A.* FROM (SELECT CODE, NAME FROM tco_commcode WHERE PARENT_CODE = 'POINT' and del_if=0 and use_yn='Y' and code in ('POINT-01','POINT-02','POINT-03','POINT-04','POINT-05','POINT-06','POINT-07','POINT-08','POINT-09','POINT-16','POINT-17','POINT-18','POINT-19','POINT-21') UNION SELECT '','ALL' FROM DUAL ) A ORDER BY A.NAME")%>";
