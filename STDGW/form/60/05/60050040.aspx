...
function BindingDataList()
{
    ...
    var ls_data4    = "<%=ESysLib.SetDataSQL("SELECT CODE FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'ACBG0130' AND B.CHAR_3 = 'BN' AND A.DEL_IF = 0 AND B.DEL_IF = 0")%>";
    var ls_data5    = "<%=ESysLib.SetDataSQL("SELECT NUM_2 FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'ACBG0130' AND B.CHAR_3 = 'BN' AND A.DEL_IF = 0 AND B.DEL_IF = 0")%>";
    var ls_data6    = "<%=ESysLib.SetDataSQL("SELECT NVL(NUM_3, '0') FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'ACBG0130' AND B.CHAR_3 = 'BN' AND A.DEL_IF = 0 AND B.DEL_IF = 0")%>";
   ...
   var ls_data8    = "<%=ESysLib.SetListDataSQL("SELECT b.CODE, b.CODE_NM FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'GFQC0016' AND A.DEL_IF = 0 AND B.DEL_IF = 0 and b.use_YN = 'Y' order by b.CODE_NM")%>";
...
function Popup_OnSelect_Acc(p_payrec, p_drcr)
{
    ...
    var fpath   = System.RootURL + "/form/60/05/60050010_popup_new.aspx?comm_nm="+ '' + "&comm_code=" + '' + "&comm_nm2=" + txttransaction_code.GetData() + '' + "&val1=" + "&val2=" + p_drcr + "&val3=" + lstCompany.GetData() + "&dsqlid=AC_SEL_ACC_DRCR_PAYREC";    
    aValue      = System.OpenModal(  fpath , 550 , 550 , 'resizable:yes;status:yes');	
    if (aValue != null)
    {
        if (aValue.length > 0)
...
{    
	...
	{
	    var fpath   = System.RootURL + "/form/gf/co/gfco002005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=AC_SEL_BUDGET_POPUP&col_code=' + "BUDGET CODE" + '&col_nm=' + "BUDGET NAME&val1="  + txtacpk.GetData() ;
        var object  = System.OpenModal(fpath , 600 , 500 , 'resizable:yes;status:yes'); 
        if ( object != null )  
        {
            if (object[0] != 0)
    ...
    if (lstPayment.value =="1")//Payment voucher - Phieu Chi
	{
		...
		{ 
		        ...
		        switch (lstReportLocation.value)
		        {
		           ...
		           case "20":
	                    ...
	                    if ((lstVoucherTypePrint.GetText()!="1")&&(lstVoucherTypePrint.GetText()!="2"))
	                    {
		                    ...
		                    return;
		                        ...
		                        { 
		                            var    url =System.RootURL + '/reports/gf/br/gfbr00030_PaymentVoucher.aspx'+rqt;  
		                        }
		                        if(lstVoucherType.value=='1')
		                        {
		                              var  url =System.RootURL + '/reports/gf/br/gfbr00030_ReceiptVoucher.aspx'+rqt;          
		                        }    
		          break;
		          case "30":
		                        if (txtStatus.text =="")
		          ...
		          break;  
		            case "160"://ACCOUNTING
		                url =System.RootURL + '/reports/gf/br/gfbr00030_PaymentVoucher_General_Bank.aspx'+rqt; 
		             break;
		            case "170"://OTHER
		                url =System.RootURL + '/reports/gf/br/gfbr00030_PaymentVoucher_Other.aspx'+rqt; 
		                break;
		            case "180"://FACOTRY
		                url =System.RootURL + '/reports/gf/br/gfbr00030_PaymentVoucher_Fact.aspx'+rqt; 
		            break;
                    case "190":
                  ...
                  break;  
	               case "200":
		                    ...
		                    var  url =System.RootURL + '/reports/gf/br/gfbr00030_Payment_Order.aspx?seq='+txtseq.text ;		
	             ...
	             break; 
	            case "310":
	                        var url =System.RootURL + '/reports/60/06/60060010_envn.aspx?seq='+txtseq.text;
	            break; 
	            ...
	            case "380":
                  ...
                  case "410":
                        ...
                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_VCB.aspx?Seq='+ txtseq.text;
	              break;   
                  case "420":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_LenhChuyenTien.aspx?Seq='+ txtseq.text   + '&Seq1=' + txtseq1.text; 
	              break;  
                  case "430":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_GiayNopTien.aspx?Seq='+ txtseq.text+ '&Seq1=' + txtseq1.text; 
	              break;  
                  case "440":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_LenhChi_new.aspx?Seq='+ txtseq.text; 
	              break;  
                  case "450":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_PhieuRutTien.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "460":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Woori_PhieuGuiTien_Full.aspx?Seq='+ txtseq.text; 
	              break;  
                  case "470":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Vietcom_GiayNopTien.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "480":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Vietcom_GiayRutTien.aspx?Seq='+ txtseq.text; 
	              break;    
                  case "490":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Woori_PhieuRutTien_Full.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "500":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Shinhan_GiayChuyenTien_Full.aspx?Seq='+ txtseq.text; 
	              break;  
                  case "510":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_KEB_BankTransfer.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "520":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_VIB_GiayNopTien.aspx?Seq='+ txtseq.text; 
	              break;  
                  case "530":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_KEB_GiayLinhTienMat.aspx?Seq='+ txtseq.text; 
	              break;  
                  case "540":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_ShinhanBankVietnam.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "550":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_SVB_DT.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "560":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Woori_DonXinGiaoDichNgoaiTe.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "570":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_ShinhanBankVietnam_2.aspx?Seq='+ txtseq.text; 
	              break;    
                  case "580":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_LenhChi_Limit.aspx?Seq='+ txtseq.text; 
	              break;   
                  break;   
				  case "590":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_GiayNopTienVaoNganSachNhaNuoc.aspx?Seq='+ txtseq.text+ '&Seq1=' + txtseq1.text; 
	              break;  
				  case "600":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Thue_TNCN.aspx?Seq='+ txtseq.text+ '&Seq1=' + txtseq1.text;
	              break; 
                  case "610":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Shinhan_GiayChuyenTien_Full_2.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "620":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_HSBC_CashWithDrawalForm_Full.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "630":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_HSBC_Transfer_Full.aspx?Seq='+ txtseq.text; 
	              break; 
				  case "640_v2":
		                var url =System.RootURL + '/reports/gf/br/gfbr00030_PaymentVoucher_General_Bank_pdf.aspx'+rqt; 
				  break;
				  case "650_v2":

	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Woori_PhieuGuiTien_Full_pdf.aspx?Seq='+ txtseq.text; 
	              break;  
				  case "660_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Woori_PhieuRutTien_Full_pdf.aspx?Seq='+ txtseq.text; 
	              break; 
				  case "670_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_WooriBank_DonXinChuyenTien_pdf.aspx?Seq='+ txtseq.text; 
	              break; 
				  case "680_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_WooriBank_DonXinChuyenTien_2_pdf.aspx?Seq='+ txtseq.text; 
	              break;
				  case "690_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Woori_PhieuGuiTien_pdf.aspx?Seq='+ txtseq.text; 
	              break;
				  case "700_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_MB_LenhChuyenTien_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "710_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_ShinhanBankVietnam_2.aspx?Seq='+ txtseq.text; 
	              break;
				  case "720_v2":
							var url = System.RootURL + '/reports/gf/hg/60080010_envn_v2.aspx?seq=' + txtseq.text;
				  break;
				  case "730":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_VietinBank_LenhChi_HpCook.aspx?Seq='+ txtseq.text; 
	              break;
				  case "740":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Vietcombank_PaymentOrder_HpCook.aspx?Seq='+ txtseq.text; 
	              break;
				  case "750_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_KEB_BankTransfer_excel.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "760_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Vietcombank_PaymentOrder_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "770_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Vietcombank_giay_nop_tien_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "780_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Vietcombank_giayruttien_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "790_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Woori_DonXinGiaoDichNgoaiTe_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "800_v2":
					 var url = System.RootURL + '/reports/gf/br/gfbr00040_VietinBank_LenhChi_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "810_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_VIB_GiayNopTien_excel.aspx?p_Seq='+ txtseq.text;
	              break;
				  case "820_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_ShinhanBankVietnam_excel.aspx?p_Seq='+ txtseq.text;
				  break;
				  case "830_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_KEB_GiayLinhTienMat_excel.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case "840_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_HSBC_Transfer_excel.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case "850_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_SVB_Domestic_transfer_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "860_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Shinhan_GiayChuyenTien_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "870_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Shinhan_GiayChuyenTien2_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "880_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_HSBC_CashWithDrawal_excel.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "890_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_GiayNopTienVaoNganSachNhaNuoc_excel.aspx?p_Seq='+ txtseq.text+ '&p_Seq1=' + txtseq1.text;
				  break;
				  case "900_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Shinhan_GiayChuyenTien2_excel_pattern.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "910_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_VietinBank_LenhChi_excel_pattern.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "920_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_KEB_GiayLinhTienMat_excel_pattern.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case "930_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_eximbank_PaymentOrder_excel.aspx?p_Seq='+ txtseq.text; 
	              break;  
				  case "940_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_Standard_chartered_PaymentOrder.aspx?p_Seq='+ txtseq.text; 
	              break;  
				  case "950":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_UNC_TCB.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "950_v2":
	                        var url = System.RootURL + '/reports/gf/br/rpt_gfbr00040_VCB_lenhchuyentien_nuocngoai_excel.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "960_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_MB_LenhChuyenTien_pdf.aspx?p_Seq='+ txtseq.text; 
	              break;
				  case "970_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00030_UNC_OceanBank_GRT_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 	
				  
				  case "1040_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_KIB_GiayChuyenTien.aspx?p_Seq='+ txtseq.text; 
	              break;  
				  case "1050_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_KIB_GiayRutTien_pdf.aspx?p_Seq='+ txtseq.text; 
	              break;  
				  case "1060_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_KIB_GiayChuyenTien_2.aspx?Seq='+ txtseq.text; 
	              break;  
				  case "1070_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_ShinhanBank_DRVV.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case '1080_v2':
							var url = System.RootURL + '/reports/gf/br/gfbr00040_Techcombank_UNC_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1090_v2':
							var url = System.RootURL + '/reports/gf/br/gfbr00040_ABBank_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1100_v2':
							var url = System.RootURL + '/reports/gf/br/gfbr00040_ACB_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case '1110_v2':
							var url = System.RootURL + '/reports/gf/br/gfbr00040_Kookminbank_Payment_Order_pdf.aspx?p_Seq='+ txtseq.text; 
				  break;
				  case "1120_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00030_UNC_OceanBank_PaymentOrder_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1130_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00030_UNC_BIDV_PaymentOrder_pdf.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  case "1150_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00030_UNC_DONGA_Bank_Payment.aspx?p_Seq='+ txtseq.text; 
	              break; 
				  
				  case "1160_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_HD_bank_UNC_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 

				  case "1210_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_HSBC_bank_UNC_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 

				  break; case "1220_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Seabank_Payment_Order_EXCEL.aspx?p_Seq='+ txtseq.text; 
	              break; 
            ...
            <td colspan='2'>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
									...
									<td width='100%'colspan="6">
										<table width='100%' cellpadding='1' cellspacing='1'>
											<tr>	
													...
													<td width="2%"><gw:button id="ibtnReport" img="excel" text="Print"alt="Print Acct" onclick="OnReportAcct()" /></td>
													<td width="2%"><gw:button id="btnReportRV" img="excel" text="Print"alt="Print RV" onclick="OnReportRV()" /></td>
											</tr>
										</table>
                                    </td>
								</tr>
								<tr>
									...
									<td width="30%" ><gw:list id="lstCompany" value="" onchange="dso_get_exrate_list.Call();"/></td>
									...
									<td width='25%'>
											<table width='100%' cellpadding='1' cellspacing='1'>
													<tr>
															...
															<td width=""><gw:button id="ibtnPopup" img="popup" alt="View T Account" onclick="onViewTAccount()" /></td>
															<td width=""><gw:button id="ibtnSearch" img="search" alt="Search" onclick="onSearch()" /></td>
													</tr>
											</table>
									</td>
                                                ...
                                                <td>
                                                        <table width='100%' cellpadding='1' cellspacing='1'>
                                                                <tr>
                                                                        ...
                                                                        <td width="25%"><gw:button id="btnConfirm" img="confirm" text="Confirm" onclick="OnConfirm()" styles="width:100%" /></td>
                                                                        <td width="25%"><gw:button id="btnCancel" img="cancel" text="Cancel" onclick="OnConfirmCancel()" styles="width:100%" /></td>
                                                                        <td width="25%"><gw:button id="btnReplicate" img="Replicate" text="Replicate" onclick="OnReplicate()" styles="width:100%" /></td>
                                                                        <td width="25%"><gw:button id="btnCopy" img="copy" text="Copy" onclick="OnCopy()"  styles="width:100%"/></td>
                                                                </tr>
                                                        </table>
                                                </td>
                                </tr>
                                ...
                                <tr>
                                        ...
                                        <td width="" align="right"><a title="Nh?p vào dây d? hi?n th? nhân viên" onclick="onEmpPopUp()" href="#tips" >Receipt Person&nbsp;</a></td>
                                        <td colspan='2'>
                                                <table width='100%' cellpadding='0' cellspacing='0'>
                                                        <tr>
