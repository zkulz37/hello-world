...
function BindingDataList()
{
    ...
    var ls_data8    = "<%=ESysLib.SetListDataSQL("SELECT b.CODE, b.CODE_NM FROM tac_commcode_master a, tac_commcode_detail b WHERE a.pk = b.tac_commcode_master_pk AND a.ID = 'GFQC0016' AND a.del_if = 0 AND b.del_if = 0 and b.remark = 'P' ORDER BY B.DEF_YN DESC,B.ORD")%>";
...
function OnReport()
{
	if(txtseq.text!='')
	{
		...
		{
			rqt = "?company_pk=" + lstCompany.GetData() + '&seq=' + txtseq.GetData()+'&pv_pk=' + txtseq1.GetData();
			url =System.RootURL + '/reports/gf/br/gfbr00030_Payment_Expenditure_Cash_Adv.aspx' + rqt; 
		}
		else if(lstReportLocation.value=='1010_v2')
		{
			rqt = "?company_pk=" + lstCompany.GetData() + '&seq=' + txtseq.GetData()+'&pv_pk=' + txtseq1.GetData();
			url =System.RootURL + '/reports/gf/br/gfbr00030_Payment_Expenditure_Cash.aspx' + rqt; 
		}
		System.OpenTargetPage( url , 'newform' );
	}
}
            ...
            <td colspan='2'>
                ...
                <table width="100%" border="0" cellspacing="1" cellpadding="0">
									...
									<td width='100%' colspan='5' align='right'>
										<table width='100%' cellpadding='1' cellspacing='1'>
												<tr>
														...
														<td width="" style='display:'><gw:button id="ibtnReport" img="excel" alt="Print Acct" onclick="OnReportAcct()" /></td>
														<td width=""><gw:button id="btnReport1" img="excel" alt="Print PV" onclick="OnReport()" /></td>
												</tr>
										</table>
									</td>
								</tr>
                                ...
                                <tr>
                                        ...
                                        <td width="" align="right"><a title="Nhấp vào đây để hiển thị nhân viên" onclick="onEmpPopUp()" href="#tips" >Receipt Person&nbsp;</a></td>
                                        <td colspan='2'>
                                                <table width='100%' cellpadding='0' cellspacing='0'>
                                                        <tr>
