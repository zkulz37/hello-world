	    ...
	    <td width="100%">
	     <fieldset style="width: 100%; height: 100%; padding: 2">
	        <table border="0" width="100%" cellpadding="0" cellspacing="2"  id="table1">
              <td width="15%" align=Right><a href="#" onClick="onCustPopUp()">Partner</a></td>
              <td width="22%"><gw:textbox id="txtcustid" /><gw:textbox id="txtcustnm" /></td>
              <td width="5%"><gw:imgbtn id="btnResetCust" img="reset" alt="Reset" onclick="onCustReset()" /></td>
