...
function BindingDataList()
{
   ...
   var ls_data8    = "<%=ESysLib.SetListDataSQL("SELECT b.CODE, b.CODE_NM FROM TAC_COMMCODE_MASTER A, TAC_COMMCODE_DETAIL B WHERE A.PK = B.TAC_COMMCODE_MASTER_PK AND A.ID = 'GFQC0016' AND A.DEL_IF = 0 AND B.DEL_IF = 0 and b.use_YN = 'Y' order by CODE_NM ")%>";
				...
				else
				{
					...
					else
					{
						...
						if (idGridItem.GetGridData( ctrl.row, 8 )== "EMPLOYEE NAME")
						{
							...
							var fpath   = System.RootURL + "/form/60/08/60080100_popup_2.aspx";
    ...
    if (lstPayment.value =="1")//Payment voucher - Phieu Chi
	{
		...
		{ 
	            ...
	            case "380":
	              ...
	              break;  
                  case "700_v2":
	                        var url = System.RootURL + '/reports/gf/br/gfbr00040_Shinhan_GiayChuyenTien_2.aspx?Seq='+ txtseq.text; 
	              break; 
                  case "710_v2":
