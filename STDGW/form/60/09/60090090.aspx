...
{  
		...
		if(lstReportsType.value=='1')
		{
			...
			/*var url = System.RootURL + '/reports/60/09/60090090_G_ARHistory_Details.aspx?tco_company_pk=' + lstCompany.value + '&tr_date_fr=' + dtTransFr.value + '&tr_date_to=' + dtTransTo.value + '&tr_type=' + lstTrType.value + '&tco_buspartner_pk=' + txtPartner_PK.text + '&tr_status=' + lstStatus.value + "&tac_hgtrh_pk=" + txtSeq.text + "&voucherno=" + txtVoucherNo.text + "&invoice_no=" + txtInvNo.text ; 
			System.OpenTargetPage(url);  */ 
		}				
		if(lstReportsType.value=='2')
		{
			var url = System.RootURL + "/reports/60/09/rpt_60090090_2.aspx?std_ym=" + dtTransFr.value + "&ac_cd=" + txtACC_PK.GetData() + "&tin_warehouse_pk=ALL&tco_company_pk=" + lstCompany.value + "&item_pk=" + txtItem_pk.GetData() + "&cust_pk=" + txtCust_PK.GetData() + "&voucherno=" + txtVoucherNo.GetData() + "&takein_no=" + txtDelivery.GetData() + "&std_ym_to=" + dtTransTo.value ;
			System.OpenTargetPage(url);  
			/*var url = System.RootURL + '/reports/60/09/60090090_G_ARHistory_Details.aspx?tco_company_pk=' + lstCompany.value + '&tr_date_fr=' + dtTransFr.value + '&tr_date_to=' + dtTransTo.value + '&tr_type=' + lstTrType.value + '&tco_buspartner_pk=' + txtPartner_PK.text + '&tr_status=' + lstStatus.value + "&tac_hgtrh_pk=" + txtSeq.text + "&voucherno=" + txtVoucherNo.text + "&invoice_no=" + txtInvNo.text ; 
			System.OpenTargetPage(url);  */      			
		}
...
function OnPopUp(obj)
{
    ...
    {
        case 'Project':
             fpath  = System.RootURL + "/form/60/09/60090010_CtrItem2.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=AC_SEL_PL_POPUP&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";
        ...
        case 'Account':
            ...
            /*var fpath   = System.RootURL + "/form/60/09/60090090_popup.aspx?comm_nm="+ '' + "&comm_code=" + '' + "&comm_nm2=YAPD&val1=A/P Domestic&val2=D&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60090090_acc_drcr";
