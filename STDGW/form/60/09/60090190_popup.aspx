...
function BodyInit()
{
    ...
    var ls_data1    = "<%=ESysLib.SetListDataSQL("SELECT A.PK, A.ORG_NM FROM TCO_ORG A WHERE A.ORG_TYPE = '06' AND A.TCO_COMPANY_PK = 1 AND (A.END_DATE >= '20080101' OR A.END_DATE IS NULL)")%>";
    var ls_data2    = "<%=ESysLib.SetListDataFUNC("SELECT ac_A_GET_COMMONCODE('ACBG0130') FROM DUAL")%>";
