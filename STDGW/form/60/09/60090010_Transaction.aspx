...
{ 
    ...
    { 
        var ls_data     = "<%=ESysLib.SetListDataSQL("SELECT TRIM(A.CODE), A.CODE_NM FROM TCO_ABCODE A, TCO_ABCODEGRP B WHERE A.DEL_IF = 0 AND B.DEL_IF = 0  AND A.TCO_ABCODEGRP_PK = B.PK AND B.ID = 'ACAB0070' AND A.USE_IF = 1 AND A.SYS_YN = 'N' ORDER BY ORD")%>";
    }
