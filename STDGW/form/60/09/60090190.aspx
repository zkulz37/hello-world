...
function OnPrint()
{
    ...
    {
        var  url= System.RootURL + "/reports/60/09/rpt_60090190.aspx?p_com_pk="+lstCompany.value+"&p_date_fr="+dtPay_duefr.value
	...
	{
        var  url= System.RootURL + "/reports/60/09/rpt_60090190_AgedPay_Over_DueDate.aspx?p_com_pk="+lstCompany.value+"&p_from_date="+dtPay_duefr.value
        +"&p_to_date="+dtPay_dueto.value+"&p_tco_buspartner_pk="+txtcust_pk.text+"&p_acc_pk="+txtac_pk.text ;
        System.OpenTargetPage( url, "_blank" );	
	}	
	else if(lstReport_Type.value=="02")
	{
        var  url= System.RootURL + "/reports/60/09/rpt_60090190_AgingPayment.aspx?p_com_pk="+lstCompany.value+"&p_from_date="+dtPay_duefr.value
        +"&p_to_date="+dtPay_dueto.value+"&p_tco_buspartner_pk="+txtcust_pk.text+"&p_acc_pk="+txtac_pk.text ;
        System.OpenTargetPage( url, "_blank" );	
	}	
...
function OnPopup()
{
    ...
    if(lstType.value == "PAY")
    {
        ...
        var fpath = System.RootURL + '/form/60/09/60090190_popup.aspx?PK_ROW=' + pk + '&APPRCANCEL=' + status;
        var wWidth = 950;
        var wHeight = 565;
