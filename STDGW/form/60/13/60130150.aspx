...
function BindingDataList()
{
    ...
    var ls_kind_cd  = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACDF0010','01','') FROM DUAL")%>||Select All"; 
    var ls_kind_cd  = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACDF0010','01','') FROM DUAL")%>||Select All"; 
    var lststatus      = "<%=ESysLib.SetListDataFUNC("SELECT SF_A_GET_COMMONCODE('ACDF0070') FROM DUAL")%>||Select All"; 
    ...
    lstKIND_CODE.value=""; 
	data =    "<%=ESysLib.SetListDataFUNC("SELECT SF_A_GET_COMMONCODE('ACDF0071') FROM DUAL")%>"; 
	...
	data = "<%=ESysLib.SetListDataFUNC("SELECT SF_A_GET_DEFAULT('COAB0070') FROM DUAL")%>";
    arr  = data.split("|");
       ...
       // window.open(url); 
        ...
        switch(lstReportType.GetData())
        {
            ...
            case "2":
			   switch(lstLanguage.GetData())
			   {
					case "VIE":
						 ...
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW.aspx'+rqt;
					 break;
					 case "ENG":
							// url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE.aspx'+rqt;
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW.aspx'+rqt;
			...
			case "6":
						...
						{
							url =System.RootURL + '/reports/gf/gf/gfgf00040_06_TOOL_ENG_VIE_1.aspx'+rqt;
						}
						if(lstAsset_Type.value=="A")
						{
							url =System.RootURL + '/reports/gf/gf/gfgf00040_06_ENG_VIE.aspx'+rqt;
						}
            break;
			case "7":
			   switch(lstLanguage.GetData())
			   {
					case "VIE":
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_7.aspx'+rqt;
					 break;
					 case "ENG":
			...
			case "8":
			   ...
			   {
					case "VIE":
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_8.aspx'+rqt;
					 break;
				}
			break;
			case "10":
			  switch(lstLanguage.GetData())
			   {
					case "VIE":
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW_PL.aspx'+rqt;
					 break;
			   }
            break;
			case "11":
			  
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW_model.aspx'+rqt;
            break;
			case "12":
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW_picture.aspx'+rqt;
            break;
			case "13":
			  switch(lstLanguage.GetData())
			   {
					case "VIE":
						 url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW_More_PL.aspx'+rqt;
					 break;
			   }
            break;
			case "15":
				url =System.RootURL + '/reports/gf/gf/gfgf00040_02_VIE_NEW_PL_2.aspx'+rqt;
			break;
            ...
            <table width="100%" cellpadding="0" cellspacing="0" border="0">
                ...
                <tr>
				  ...
				  <tr>
                    ...
                    <td style="width: " colspan='3'><gw:list id="lstAsset_Type" styles="width: 100%" onchange="OnSearch()" /></td>
