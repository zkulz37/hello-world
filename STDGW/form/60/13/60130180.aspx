...
function OnShowProject(pos)
{
    ...
    {
    case 'Unit':  
        var fpath = System.RootURL + "/form/60/13/60130120_pl_popup.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCOMPANY.GetData() + '&dsqlid=ACNT.SP_SEL_PL_POPUP&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";
        ...
        break;
        case 'Charger': 
            var fpath = System.RootURL + "/form/60/08/60080030_popup_emp_3.aspx";
        ...
        break;
        case 'Asset':
                var path    = System.RootURL + '/form/60/13/60130180_popup_Asset.aspx?company_pk=' + lstCompany1.value;
			   var object  = System.OpenModal( path, 800, 550,'resizable:yes;status:yes');
			   if ( object != null )
				{
					if (object[0] != 0)
