...
function OnShowPopup(index)
{
    ...
    {
        case 0:
            var fpath = System.RootURL + "/form/60/05/60050010_popup_4.aspx?partner_type=AR"; //customs
                ...
                break;
        case 1:
            fpath  = System.RootURL + "/form/60/05/60050010_popup_2005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstComp.GetData() + '&dsqlid=ACNT.SP_SEL_PL_POPUP&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";
