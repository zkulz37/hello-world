...
function BodyInit()
{
    ...
    <%=ESysLib.SetGridColumnComboFormat("gridD", 15,"SELECT A.CODE, A.CODE_NM FROM TCO_ABCODE A, TCO_ABCODEGRP B WHERE A.DEL_IF = 0 AND B.DEL_IF = 0  AND A.TCO_ABCODEGRP_PK = B.PK AND B.ID = 'ACCR0110' AND A.USE_IF = 1 ORDER BY A.CODE")%>;
...
{
    var fpath   = System.RootURL + "/form/60/05/60050010_popup_2005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=AC_SP_SEL_POPUP_TRANS&col_code=' + '' +"Transaction code" + '&col_nm=' + '' + "Transaction name";
