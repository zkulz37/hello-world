...
function OnGetAccount(){
    var fpath = System.RootURL + "/form/gf/lv/gflv00020_vas_popup.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60120150pp";
