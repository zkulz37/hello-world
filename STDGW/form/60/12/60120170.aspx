...
{
	var path = System.RootURL + '/form/60/05/60050010.aspx';
            ...
            switch (lstLang.GetData())
            {
                case "VIE":
                    //var url = '/reports/gf/lv/gflv00020_rpt_VAT_Out.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ txtTaxRate.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text;
                     var url = '/reports/gf/lv/gflv00020_rpt_VAT_Out.aspx?compk=' + lstCompany.GetData();
                     url = url + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.GetData();
                     url = url + '&vat_rate='+ txtTaxRate.GetData() +  '&ccy=' + lstCurrent.GetData();
                     url = url + '&status=' + lstStatus.GetData() + '&custpk=' + txtCUST_PK.GetData();
                     url = url + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text;
...
function OnReport2()
{
      ...
      //  var url = '/reports/gf/lv/gflv00400_import_VAT_in.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text + '&voucher_type=' + lstvoucher.GetData(); 
          var url = '/reports/gf/lv/gflv00040_ExciseTaxesInquiry_In.aspx?compk=' + lstCompany.GetData() + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.value + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&status=' + lstStatus.GetData()   + '&custpk=' + txtCUST_PK.GetData() + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text + '&tac_hgtrh_pk=' + txtSeq.text + '&voucherno=' + txtVoucherNo.text + '&balance_type=' + rdoType.value +'&dtfr=' + dtfrdate.value + '&dtto=' + dttodate.value;    
        }
        else
        {
           // var url = '/reports/gf/lv/gflv00400_import_VAT_Out.aspx?com=' + lstCompany.GetData() + '&yyyymm=' + dtMonth.GetData() + '&status=' + lstStatus.GetData() + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&cust_pk=' + txtCUST_PK.GetData()+'&acc_pk='+txtac_pk.text;
              var url = '/reports/gf/lv/gflv00040_ExciseTaxesInquiry_Out.aspx?compk=' + lstCompany.GetData() + '&month=' + dtMonth.GetData() + '&vat_type=' + lstTypeINOUT.value + '&vat_rate='+ lstRATE.GetData() + '&ccy=' + lstCurrent.GetData() + '&status=' + lstStatus.GetData()   + '&custpk=' + txtCUST_PK.GetData() + '&invoiceno=' + txtINVOICENO.text + '&ac_cd=' + txtAC_CD.text + '&tac_hgtrh_pk=' + txtSeq.text + '&voucherno=' + txtVoucherNo.text + '&balance_type=' + rdoType.value +'&dtfr=' + dtfrdate.value + '&dtto=' + dttodate.value;
        }
...
function OnGetAccount(){
    var fpath = System.RootURL + "/form/60/03/60030010_popup_ifrs.aspx?comm_nm=" + "" + "&comm_code=" + "" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lstCompany.GetData() + "&dsqlid=ac_sel_60120170_acct_popup";    o = System.OpenModal( fpath , 550 , 550 , 'resizable:yes;status:yes');	
    if (o != null)
	{
		if(o[0] != 0)
		{
