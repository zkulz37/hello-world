...
function OnReport()
{
	...
	{
		var url =System.RootURL + '/reports/60/08/60080010_envn.aspx?seq='+txtseq.text;
...
{
	var path = System.RootURL + '/form/60/06/60060020_1.aspx?com_pk='+ lstCompany.GetData() + '&seq=' + txtseq.GetData() + '&status=' + txtStatus.GetData() + '&userid=' + txtProposedByUserID.GetData() + '&usernm=' + txtProposedByUserName.GetData() + '&userpk=' + txtProposedByUserPk.GetData() + '&dsqlid=AC_PRO_60060020_CONFIRM_CANCEL' + '&table=TAC_HGTRH';
