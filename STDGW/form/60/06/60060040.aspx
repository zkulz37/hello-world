...
function BodyInit()
{
    ...
    ls_data = "<%=ESysLib.SetListDataFUNC("SELECT AC_SF_GET_COMMONCODE_ord('EACAB030') FROM DUAL")%>";
...
{
    var fpath   = System.RootURL + "/form/gf/co/gfco002005.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=AC_SP_SEL_POPUP_TRANS&col_code=' + '' +"Transaction code" + '&col_nm=' + '' + "Transaction name";
