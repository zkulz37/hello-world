...
function OnPrint2()
{
	var url =System.RootURL + '/reports/60/28/rpt_60280060_Invoice_List.aspx?p_month='+idMonth.value+'&p_crt_by='+txtCreateBy.text;
                                        ...
                                        <fieldset style="padding: 2; width: 100%; height: 100%">
                                            <table border="0" width="100%" id="table2">
                                                ...
                                                <td width="20%" id='rbt_date'>
													...
													<td style="width: 3%" align="right">
														<gw:imgbtn id="ibtnReport2" img="excel" alt="Invoice List New" onclick="OnPrint2()" />
													</td>
                                                    <td width="1%"></td>
                                                </tr>
                                            </table>
