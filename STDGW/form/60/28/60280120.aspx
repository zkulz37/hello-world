...
function OnReport()
{
		...
		var url = '/reports/60/28/rpt_60280120_payment_report.aspx?p_date='+dtDate.value+'&p_date_to='+dtDateTo.value+'&p_room='+txtRoom.text+'&p_payment_method='+lstPaymentMethod.value+'&p_partner_PK='+txtCompany_PK.text +"&p_time_frm=" +  txtFromTime.text+"&p_time_to=" +  txtToTime.text+"&p_cashier=" +  txtCashier.text;
		 System.OpenTargetPage( System.RootURL+url , "newform" );  		 
}

function OnReport_new()		 
{		var url = '/reports/60/28/rpt_60280120_payment_report.aspx?p_date='+dtDate.value+'&p_date_to='+dtDateTo.value+'&p_room='+txtRoom.text+'&p_payment_method='+lstPaymentMethod.value+'&p_partner_PK='+txtCompany_PK.text +"&p_time_frm=" +  txtFromTime.text+"&p_time_to=" +  txtToTime.text+"&p_cashier=" +  txtCashier.text;
		 System.OpenTargetPage( System.RootURL+url , "newform" );  		 
}
		...
		<td style="width: 100%; background: white" valign="top" >			
			<table style="width: 100%" border="0">
				<tr >
					...
					<td width="3%" align="right">
                            <gw:imgbtn id="ibtnReport" img="excel" alt="Print" onclick="OnReport_new()" />
                    </td>	
				</tr>
				<tr>
				    <td colspan="4">
