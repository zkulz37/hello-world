...
{   
 ...
 lstDept.value = "ALL";
 data = "<%=ESysLib.SetListDataFUNC("SELECT AC_GET_COMMONCODE_2('ACBG0130') FROM DUAL")%>|ALL|Select All";
 ...
 <%=ESysLib.SetGridColumnComboFormat("grdUserList",6,"select pk,org_nm from tco_org a where  del_if=0")%>;
 <%=ESysLib.SetGridColumnComboFormat("grdUserList",4,"SELECT pk, PARTNER_NAME FROM TCO_company  where del_if=0")%>;
...
{
     var path = System.RootURL + '/form/ag/ga/agga00010_search_emp.aspx?company_pk='+lstCompany.value;
...
function OnsearchPL()
{
    fpath  = System.RootURL + "/form/60/01/60010080_popup_plcenter.aspx?comm_code="+ "" + "&comm_nm=" + '' + "&company=" + lstCompany.GetData() + '&dsqlid=ac_SEL_60010060_PL_POPUP&col_code=' + "PL CODE" + '&col_nm=' + "PL NAME";
