...
<script>
    ...
    function BindingDataList() {
            ...
            var ls_data1     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0150','','') FROM DUAL")%>";
            lst_PLC_TYPE.SetDataText(ls_data1);    
            
            var ls_data2     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('COAB0080','','') FROM DUAL")%>";
            lst_NATION.SetDataText(ls_data2);
            
            
            var ls_data4     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('COEO0010','','') FROM DUAL")%>";
            lst_COM_GRP.SetDataText(ls_data4);
            
            var ls_data5     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0120','','') FROM DUAL")%>";
            lst_PLC_GRP1.SetDataText(ls_data5);
            
            var ls_data6     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0130','','') FROM DUAL")%>";
            lst_PLC_GRP2.SetDataText(ls_data6);
            
            var ls_data7     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0140','','') FROM DUAL")%>";
    ...
    function Popup_Search() {
        var fpath = System.RootURL + "/form/60/01/60010020_popup.aspx?company_pk=" + lst_TCO_COMPANY_PK.GetData() + "&plc_pk=" + txt_PLC_PK.text;
