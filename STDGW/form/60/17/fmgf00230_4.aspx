...
function BindingDataList()
{
	...
	ls_data = "<%=ESysLib.SetListDataSQL("select TRIM(A.CODE) code, A.code_nm FROM TAC_COMMCODE_DETAIL A, TAC_COMMCODE_MASTER B WHERE A.DEL_IF=0 and b.del_if = 0 and a.TAC_COMMCODE_MASTER_PK = b.pk AND TRIM(b.ID) = 'EACBK054' and A.use_yn = 'Y' and a.code = '2' " )%>";	
