...
function OnPopUp(iObj)
{
    ...
    case 'Account':
            ...
            var path = System.RootURL + "/form/gf/co/ffco002000.aspx?comm_code=&comm_nm=&dsqlid=AC_SEL_fmgf00050_3&val1=&val2=&val3=Yval4=" + lstCompany.value + "&val5=" + lstWH.value + "&val6=Y&val7=ENG&val8=" + g_user_id ;
...
{
    var url = System.RootURL + "/reports/fm/gf/rpt_fmgf00250.aspx?comp_pk=" + lstCompany.value + "&from_date=" + dtFrom.value + "&to_date=" + dtTo.value + "&wh_pk=" + lstWH.value ;
