...
function OnPopUp(iObj)
{
    ...
    case 'PL':
            ...
            var path = System.RootURL + "/form/60/05/60050010_popup_2005.aspx?dsqlid=SP_SEL_fmgf00050_2&company=" + lstCompany.value + "&col_code=PL Code&col_nm=PL Name&comm_nm=" +  + "&val1=" + lstWH.value ;
            var object = System.OpenModal( path ,800 , 600 ,  'resizable:yes;status:yes');        
            if(object != null)
            {
