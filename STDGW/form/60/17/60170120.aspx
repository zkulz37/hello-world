...
function BindingDataList()
{
    ...
    var data = "<%=ESysLib.SetListDataSQL("SELECT pk, wh_id || '-' || wh_name wh_name FROM tlg_in_warehouse  WHERE del_if = 0 and use_yn = 'Y' and acc_yn = 'Y' ORDER BY wh_name ASC" )%>|ALL|ALL";    
...
{
    var url = System.RootURL + "/reports/60/17/60170120.aspx?stdym_fr=" + dtFrom.value + "&stdym_to=" + dtTo.value + "&tco_company_pk=" + lstCompany.value ;
