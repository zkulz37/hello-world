...
//-----------------------------------------------------
 function BindingDataList()
 {
	...
	ls_data     = "<%=ESysLib.SetListDataSQL("select pk, wh_id ||'-' || WH_NAME from tlg_in_warehouse where del_if = 0 and use_yn = 'Y' order by wh_id ")%>|0|ALL";
	...
	switch(n)
	{
		case 1:
			if(lstRptType.value == "I")
				{
					var url = System.RootURL + "/reports/60/17/rpt_ac6013_6070230_tab_in.aspx?p_compk=" + lstCompany.value +
