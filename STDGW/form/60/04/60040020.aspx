...
{ 
    ...
    var ls_data1     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('FUAB0020','','') FROM DUAL")%>";
    var ls_data2     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('ACAB0110','','') FROM DUAL")%>";
    var ls_data3     = "<%=ESysLib.SetListDataFUNC("SELECT F_COMMONCODE('FUAB0030','','') FROM DUAL")%>";
    var ls_data4     = "<%=ESysLib.SetListDataSQL("SELECT PK, PARTNER_NAME FROM TCO_BUSPARTNER WHERE DEL_IF=0 AND PARTNER_TYPE = '50'")%>";
    var ls_Branch    = "<%=ESysLib.SetListDataFUNC("SELECT SF_A_GET_COMMONCODE('GFQC0020') FROM DUAL")%>";
    var ls_Province    = "<%=ESysLib.SetListDataFUNC("SELECT SF_A_GET_COMMONCODE('GFQC0021') FROM DUAL")%>";
...
function GetAccount()
{
    var fpath = System.RootURL + "/form/60/09/60090020_account_popup.aspx?comm_nm=" + "" + "&comm_code=" + "112" + "&comm_nm2=" + "" + "&val1=" + 'Y' + "&val2=" + 'Y' + "&val3=" + lst_TCO_COMPANY_PK.value + "&dsqlid=ac_sel_60090010_acn_ap_popup";
