...
<gw:data id="datCheck" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_AGIO0060_p_ch_move_org" > 
                <input>
...
<gw:data id="datMove" onreceive="OnDataReceive(this)"  > 
        <xml> 
            <dso  type="process" procedure="hr_pro_AGIO0060_p_smove_org" > 
                <input>
                    <input bind="txtDeptPk" /> 
                      <input bind="txtDeptP_PK" /> 
                      <input bind="txtType" /> 
...
<gw:data id="datDeptTree"   > 
        <xml> 
            <dso id="1" type="tree" function="COMM_pro_AGIO0060_p_org_tree" > 
                <input>
