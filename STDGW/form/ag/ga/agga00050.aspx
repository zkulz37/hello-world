 ...
 {   
    ...
    txtAc_level.text= "<%=session("ACNT_LEVEL")%>";
     ...
     if(txtAc_level.text=='6')
     {
        ...
        lst_TCO_COMPANY_PK_L.SetDataText(_company);
...
<gw:data id="DSO_Grid_PL_Info"  onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso id="1" type="grid" parameter="0,1,2,3,4,5,6,7" function="ACNT.SP_SEL_ABPLC_INFO">
...
<gw:data id="DSO_Grid_Plcenter_List"  onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso id="1" type="grid" parameter="0,1,2,3,4,5,6,7" function="ACNT.SP_SEL_PLCL_INFO" procedure="ACNT.SP_UPD_PLCL_INFO">
...
<gw:data id="DSO_Grid_PLC_List"  onreceive="OnDataReceive(this)"> 
    <xml> 
        <dso id="1" type="grid" parameter="0,1,2,3,4,5,6,7" function="ACNT.SP_SEL_PLCL_LIST">
...
<gw:data id="datCompanyL" onreceive="OnDataReceive(this)"  > 
        <xml>
            <dso  type="list" procedure="acnt.sp_lst_get_company"  > 
                <input>
                    <input bind="txtSesion_company" />
