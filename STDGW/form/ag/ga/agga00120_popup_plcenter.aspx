...
function BodyInit()
{
    ...
    if(idDsql != "ACNT.SP_SEL_PL_POPUP" && idDsql != "ACNT.SP_SEL_PL_POPUP_PLPK" && idDsql != "ACNT.SP_SEL_PL_POPUP_CENTERPK" )	 
    {
...
function Select()
{
	...
	else
	{
		...
		//code_data[6] = iGrid.GetridData(code_data[0] + "" + code_data[1]) ;	
