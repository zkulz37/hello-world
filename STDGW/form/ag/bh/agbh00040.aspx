...
<gw:data id="datSalaryRate" onreceive="OnDataReceive(this)"> 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,3,4,5" function="HR_sel_80020003_rate" procedure="HR_upd_80020003_rate">
                <input bind="grdRate" >
                    <input bind="txtPos_Grp_PK" />
                </input>
                <output  bind="grdRate" />
					    ...
					    <td height="100%">
							<table id="tblRate" border=1 style="width:100%; height:100%" cellpadding=0 cellspacing=0>
								            ...
								            <tr height="90%">
								                <td colspan=5>
								                    <gw:grid id='grdRate'
                                                    header='RATE|PERCENT|SALARY|REMARK|_RATE_PK|_POSGRP_PK'
                                                    format='0|0|1|0|0|0'
                                                    aligns='1|1|0|0|0|0'
                                                    defaults='|||||'
                                                    editcol='1|1|1|1|1|1'
