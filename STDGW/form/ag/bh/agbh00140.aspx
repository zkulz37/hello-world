...
<!--------------------main table--------------------------------->
<gw:data id="datWork_Group_Entry" onreceive="" > 
        <xml> 
            <dso  type="grid"  parameter="0,1,2,3,4,5" function="HR_sel_80020012_workgroup" procedure="HR_upd_80020012_workgroup">
                <input bind="idGrid"> 
    ...
    <table style="width:100%;height:100%" cellpadding="0" cellspacing="0" align="top" border="1" >
		...
		<tr style="height:95%">
			<td colspan=7  id="master" width="100%">
				<gw:grid
					id="idGrid"
					header="WorkGroup ID|Work Group Name|Remark|Seq|_pk|_p_company_pk"
					format="0|1|0|0|0|0"
					aligns="1|2|0|0|0|0"
					defaults="||||||"
					editcol="1|1|1|1|0|0"
					widths="2000|3000|8000|1000|0|100"
