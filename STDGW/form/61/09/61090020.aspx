...
function OnPrint() {
    if (txtProject_Pk.text != '') {
        var url = System.RootURL + "/reports/61/09/rpt_61090020.aspx?Project_pk=" + txtProject_Pk.text + "&Year=" + lstYear.value + "&Budget_Pk=" + txtbudget_pk.text;
...
<body>
    <gw:data id="dso_date" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="process" procedure="pm_pro_61090020"> 
                <input> 
    ...
    <gw:data id="dso_year" onreceive="OnDataReceive(this)">
        <xml> 
            <dso type="list" procedure="pm_pro_61090020_year"> 
                <input> 
                     <output bind="dtBudFromDate"/>
                     <output bind="dtBudToDate"/>
                </input>
	...
	<xml> 
		<dso type="grid"  function="pm_sel_61090020" > 
			<input bind="Grid_Mst">
				<input bind="txtProject_Pk" />
				<input bind="lstYear" />
    ...
    <table style="height: 100%; width: 100%" cellpadding="0" cellspacing="0">
                ...
                <fieldset style="padding: 0">
                    <table style="width: 100%; height: " border="0" cellpadding="1" cellspacing="1">
                        ...
                        <tr>
                            ...
                            <td>
                                <gw:button id="ibtnSearch" img="excel"text="Print" alt="Print Report" onclick="OnPrint()" />
                            </td>
                        </tr>
                    </table>
                </fieldset>
        ...
        <tr style="height: 96%">
            <td>
                <gw:grid id="Grid_Mst" header="Budget Item|Budget name|Budget Amt.(A)|Accu. Amt. (B)|Balance(A-B)|This year|01/2011|02/2011|03/2011|04/2011|05/2011|06/2011|07/2011|08/2011|09/2011|10/2011|11/2011|12/2011|_acc_pk"
