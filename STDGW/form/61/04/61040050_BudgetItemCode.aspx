                ...
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%">
                        ...
                        <td style="width: 30%" align="center">
                            <gw:textbox id="txtBudgetItem" styles='width:100%' />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="2">
                            <gw:grid id="idGrid" header="_Budget_item_pk|Budget Item Code|Budget Item Name"
                                format="0|0|0" aligns="0|0|0" defaults="||" editcol="0|0|0"
                                widths="1000|2200|2500" styles="width:100%; height:100%"
                                sorting="T" />
                        </td>
                    </tr>
                </table>
