...
<head>
    <title>Inquiry Standard PBS Code</title>
</head>
                ...
                <table style="width: 100%; height: 100%" border="0">
                    <tr style="height: 1%">
                        ...
                        <td style="width: 30%" align="center">
                            <gw:list id="lstPBSCategory" styles='width:100%' />
                        </td>
                        <td style="width: 5%; white-space: nowrap" align="right">
                            PBS</td>
                        <td style="width: 30%" align="center">
                            <gw:textbox id="txtPBS" styles='width:100%' />
                        </td>
                    </tr>
                    <tr style="height: 99%">
                        <td colspan="4">
                            <gw:grid id="idGrid" header="_PBS_PK|Code|Name"
                                format="0|0|0" aligns="0|0|0" defaults="||" editcol="0|0|0"
                                widths="1000|1500|2000" styles="width:100%; height:100%"
                                sorting="T" />
                        </td>
                    </tr>
                </table>
