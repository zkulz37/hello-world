...
<body style="margin:0; padding:0;">
	...
	<xml>
		<dso type="grid" function="pm_sel_61050020_popup2" >
			<input bind="idGrid">
	...
	<tr>
		...
		<td width=50%>
		    ...
		    <tr>
		        <td width='90%'><gw:textbox id="txtCustomerID"    	csstype="mandatory"   styles="width:100%" onenterkey="OnSearch1()"  /></td>	  
...
<gw:textbox id="txtCustomerName"   csstype="mandatory"  styles="width:100%;; display:none" onenterkey="OnSearch1()"  />
<gw:textbox id="txtTaxCode"    	styles="width:100%;; display:none" onenterkey="OnSearch1()" />
</body>
</html>
