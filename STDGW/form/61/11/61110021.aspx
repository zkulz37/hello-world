...
-->
    <gw:data id="dso_Search" onreceive="OnDataReceive(this)">
        <xml>
            <dso type="grid"  function="pm_sel_61110021_4" >
    ...
    <table cellpadding="0" cellspacing="0" style="width: 100%; height: 100%">
                ...
                <fieldset style="padding: 0">
                    <table cellpadding="0" cellspacing="0" width="100%">
                        <tr>
                            ...
                            <td width="55%">
                                <gw:textbox id="txtLevel" onenterkey="OnSearch()" styles="width:100%;" />
                            </td>
                            <td width="40%">
                            </td>
                        </tr>
        ...
        <tr style="height: 99%; width: 100%">
            <td valign="top" width="100%">
                <gw:grid id="Grid_Search" header="Level Code|Work Name|_pk|_Level|_LEAF|Local Name|Foreign Name"
                    format="0|0|0|0|0|0|0" aligns="0|0|0|0|0|0|0" defaults="||||||" editcol="0|0|0|0|0|0|0"
                    widths="3000|3000|0|0|0|3000|3000" styles="width:100%; height:100%" sorting="T"
