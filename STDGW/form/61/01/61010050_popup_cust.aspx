...
<body style="margin:0; padding:0;">
	...
	<xml>
		<dso type="grid" function="SP_SEL_GET_PARTNER_POPUP" >
			<input bind="idGrid">
	...
	<tr>
		...
		<td width=40%>
		    ...
		    <tr>
		        <td width=35%><gw:textbox id="txtCustomerID"    	csstype="mandatory"   styles="width:100%" onenterkey="OnSearch1()"  /></td>
				  <td width=55%><gw:textbox id="txtCustomerName"    	csstype="mandatory"  styles="width:100%"  /></td>
