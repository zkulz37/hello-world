...
<body>
    ...
    <table width="100%" height="100%">
        <tr height="5%">
            ...
            <td width="30%">
                <gw:textbox id="txtStyleColor"  styles="width:100%" onenterkey="OnSearch()" />
            </td>
            <td width="40%">
            </td>
            <td width="3%">
        ...
        <tr border="1" height="95%">
            <td colspan="12">
                        <gw:grid id='grdStyle'
                        header='_PK|SEQ|Color Id|Color Name |Remark '
                        format='0|0|0|0|0'
                        aligns='0|0|0|0|0'
                        defaults='|||||'
                        editcol='0|0|0|0|0'
                        widths='0|1500|1500|1500|2500'
                        sorting='T'
