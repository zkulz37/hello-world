...
<table width="100%" height="100%" border="0" cellpadding="0" cellspacing="0">
  <tr>
    <td align="center"><table width="779" height="443" border="0" cellpadding="0" cellspacing="0">
        <tr>
                                          ...
                                          <table width="100%" border="0" cellspacing="1" cellpadding="1">
                                            <tr>
                                              ...
                                              <td width="81%" align="left" bgcolor="#FFFFFF"> 
                                                <input name=txtUserID type="text"  style="width:99%"> 
                                              </td>
                                            </tr>
                                            <tr>
                                              <td width="19%" bgcolor="#FFFFFF"><img src="system/images/login/title_2.gif" width="107" height="30"></td>
                                              <td width="81%" align="left" bgcolor="#FFFFFF">
                                                <input type=password name=txtPassword style="width:99%">
                                               </td>
                                            </tr>
                                          </table>
                                        </td>
